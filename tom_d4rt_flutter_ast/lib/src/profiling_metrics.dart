import 'package:tom_d4rt_ast/d4rt.dart' show D4rtProfiler;

/// Shared compile-time profiling switch for the flutter-ast test harness.
///
/// Both the HTTP test app (`test/tom_d4rt_flutter_ast_app`) and the test
...
///
/// Profiling requires flipping `D4rtProfiler.enabled` to `true` in `tom_d4rt_ast`
