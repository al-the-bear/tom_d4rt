...
// Source: /home/alexis/.pub-cache/hosted/pub.dev/vector_math-2.2.0/lib/vector_math_64.dart
// Generated: 2026-07-18T01:05:38.335668
...
class VectorMath64Bridge {
  ...
  static Map<String, String> classSourceUris() {
    return {
      'Aabb2': 'package:vector_math/vector_math_64.dart',
      'Aabb3': 'package:vector_math/vector_math_64.dart',
      'Colors': 'package:vector_math/vector_math_64.dart',
      'Frustum': 'package:vector_math/vector_math_64.dart',
      'IntersectionResult': 'package:vector_math/vector_math_64.dart',
      'Matrix2': 'package:vector_math/vector_math_64.dart',
      'Matrix3': 'package:vector_math/vector_math_64.dart',
      'Obb3': 'package:vector_math/vector_math_64.dart',
      'Plane': 'package:vector_math/vector_math_64.dart',
      'Quad': 'package:vector_math/vector_math_64.dart',
      'Quaternion': 'package:vector_math/vector_math_64.dart',
      'Ray': 'package:vector_math/vector_math_64.dart',
      'Sphere': 'package:vector_math/vector_math_64.dart',
      'Triangle': 'package:vector_math/vector_math_64.dart',
      'Vector': 'package:vector_math/vector_math_64.dart',
      'Vector2': 'package:vector_math/vector_math_64.dart',
      'Vector3': 'package:vector_math/vector_math_64.dart',
      'Vector4': 'package:vector_math/vector_math_64.dart',
    };
  }
  ...
  static Map<String, String> globalFunctionSourceUris() {
    return {
      'relativeError': 'package:vector_math/vector_math_64.dart',
      'absoluteError': 'package:vector_math/vector_math_64.dart',
      'setRotationMatrix': 'package:vector_math/vector_math_64.dart',
      'setModelMatrix': 'package:vector_math/vector_math_64.dart',
      'setViewMatrix': 'package:vector_math/vector_math_64.dart',
      'makeViewMatrix': 'package:vector_math/vector_math_64.dart',
      'setPerspectiveMatrix': 'package:vector_math/vector_math_64.dart',
      'makePerspectiveMatrix': 'package:vector_math/vector_math_64.dart',
      'setInfiniteMatrix': 'package:vector_math/vector_math_64.dart',
      'makeInfiniteMatrix': 'package:vector_math/vector_math_64.dart',
      'setFrustumMatrix': 'package:vector_math/vector_math_64.dart',
      'makeFrustumMatrix': 'package:vector_math/vector_math_64.dart',
      'setOrthographicMatrix': 'package:vector_math/vector_math_64.dart',
      'makeOrthographicMatrix': 'package:vector_math/vector_math_64.dart',
      'makePlaneProjection': 'package:vector_math/vector_math_64.dart',
      'makePlaneReflection': 'package:vector_math/vector_math_64.dart',
      'unproject': 'package:vector_math/vector_math_64.dart',
      'pickRay': 'package:vector_math/vector_math_64.dart',
      'degrees': 'package:vector_math/vector_math_64.dart',
      'radians': 'package:vector_math/vector_math_64.dart',
      'mix': 'package:vector_math/vector_math_64.dart',
      'smoothStep': 'package:vector_math/vector_math_64.dart',
      'catmullRom': 'package:vector_math/vector_math_64.dart',
      'dot2': 'package:vector_math/vector_math_64.dart',
      'dot3': 'package:vector_math/vector_math_64.dart',
      'cross3': 'package:vector_math/vector_math_64.dart',
      'cross2': 'package:vector_math/vector_math_64.dart',
      'cross2A': 'package:vector_math/vector_math_64.dart',
      'cross2B': 'package:vector_math/vector_math_64.dart',
      'buildPlaneVectors': 'package:vector_math/vector_math_64.dart',
    };
  }
  ...
  static String getImportBlock() {
    return "import 'package:vector_math/vector_math_64.dart';";
  }
...
BridgedClass _createColorsBridge() {
  return BridgedClass(
    ...
    staticGetters: {
      ...
      'antiqueWhite': (visitor) => $vector_math_1.Colors.antiqueWhite,
      'aqua': (visitor) => $vector_math_1.Colors.aqua,
      'aquamarine': (visitor) => $vector_math_1.Colors.aquamarine,
      'azure': (visitor) => $vector_math_1.Colors.azure,
      'beige': (visitor) => $vector_math_1.Colors.beige,
      'bisque': (visitor) => $vector_math_1.Colors.bisque,
      'black': (visitor) => $vector_math_1.Colors.black,
      'blanchedAlmond': (visitor) => $vector_math_1.Colors.blanchedAlmond,
      'blue': (visitor) => $vector_math_1.Colors.blue,
      'blueViolet': (visitor) => $vector_math_1.Colors.blueViolet,
      'brown': (visitor) => $vector_math_1.Colors.brown,
      'burlyWood': (visitor) => $vector_math_1.Colors.burlyWood,
      'cadetBlue': (visitor) => $vector_math_1.Colors.cadetBlue,
      'chartreuse': (visitor) => $vector_math_1.Colors.chartreuse,
      'chocolate': (visitor) => $vector_math_1.Colors.chocolate,
      'coral': (visitor) => $vector_math_1.Colors.coral,
      'cornflowerBlue': (visitor) => $vector_math_1.Colors.cornflowerBlue,
      'cornsilk': (visitor) => $vector_math_1.Colors.cornsilk,
      'crimson': (visitor) => $vector_math_1.Colors.crimson,
      'cyan': (visitor) => $vector_math_1.Colors.cyan,
      'darkBlue': (visitor) => $vector_math_1.Colors.darkBlue,
      'darkCyan': (visitor) => $vector_math_1.Colors.darkCyan,
      'darkGoldenrod': (visitor) => $vector_math_1.Colors.darkGoldenrod,
      'darkGray': (visitor) => $vector_math_1.Colors.darkGray,
      'darkGreen': (visitor) => $vector_math_1.Colors.darkGreen,
      'darkKhaki': (visitor) => $vector_math_1.Colors.darkKhaki,
      'darkMagenta': (visitor) => $vector_math_1.Colors.darkMagenta,
      'darkOliveGreen': (visitor) => $vector_math_1.Colors.darkOliveGreen,
      'darkOrange': (visitor) => $vector_math_1.Colors.darkOrange,
      'darkOrchid': (visitor) => $vector_math_1.Colors.darkOrchid,
      'darkRed': (visitor) => $vector_math_1.Colors.darkRed,
      'darkSalmon': (visitor) => $vector_math_1.Colors.darkSalmon,
      'darkSeaGreen': (visitor) => $vector_math_1.Colors.darkSeaGreen,
      'darkSlateBlue': (visitor) => $vector_math_1.Colors.darkSlateBlue,
      'darkSlateGray': (visitor) => $vector_math_1.Colors.darkSlateGray,
      'darkTurquoise': (visitor) => $vector_math_1.Colors.darkTurquoise,
      'darkViolet': (visitor) => $vector_math_1.Colors.darkViolet,
      'deepPink': (visitor) => $vector_math_1.Colors.deepPink,
      'deepSkyBlue': (visitor) => $vector_math_1.Colors.deepSkyBlue,
      'dimGray': (visitor) => $vector_math_1.Colors.dimGray,
      'dodgerBlue': (visitor) => $vector_math_1.Colors.dodgerBlue,
      'firebrick': (visitor) => $vector_math_1.Colors.firebrick,
      'floralWhite': (visitor) => $vector_math_1.Colors.floralWhite,
      'forestGreen': (visitor) => $vector_math_1.Colors.forestGreen,
      'fuchsia': (visitor) => $vector_math_1.Colors.fuchsia,
      'gainsboro': (visitor) => $vector_math_1.Colors.gainsboro,
      'ghostWhite': (visitor) => $vector_math_1.Colors.ghostWhite,
      'gold': (visitor) => $vector_math_1.Colors.gold,
      'goldenrod': (visitor) => $vector_math_1.Colors.goldenrod,
      'gray': (visitor) => $vector_math_1.Colors.gray,
      'green': (visitor) => $vector_math_1.Colors.green,
      'greenYellow': (visitor) => $vector_math_1.Colors.greenYellow,
      'honeydew': (visitor) => $vector_math_1.Colors.honeydew,
      'hotPink': (visitor) => $vector_math_1.Colors.hotPink,
      'indianRed': (visitor) => $vector_math_1.Colors.indianRed,
      'indigo': (visitor) => $vector_math_1.Colors.indigo,
      'ivory': (visitor) => $vector_math_1.Colors.ivory,
      'khaki': (visitor) => $vector_math_1.Colors.khaki,
      'lavender': (visitor) => $vector_math_1.Colors.lavender,
      'lavenderBlush': (visitor) => $vector_math_1.Colors.lavenderBlush,
      'lawnGreen': (visitor) => $vector_math_1.Colors.lawnGreen,
      'lemonChiffon': (visitor) => $vector_math_1.Colors.lemonChiffon,
      ...
      'lightSalmon': (visitor) => $vector_math_1.Colors.lightSalmon,
      'lightSeaGreen': (visitor) => $vector_math_1.Colors.lightSeaGreen,
      'lightSkyBlue': (visitor) => $vector_math_1.Colors.lightSkyBlue,
      'lightSlateGray': (visitor) => $vector_math_1.Colors.lightSlateGray,
      'lightSteelBlue': (visitor) => $vector_math_1.Colors.lightSteelBlue,
      'lightYellow': (visitor) => $vector_math_1.Colors.lightYellow,
      'lime': (visitor) => $vector_math_1.Colors.lime,
      'limeGreen': (visitor) => $vector_math_1.Colors.limeGreen,
      'linen': (visitor) => $vector_math_1.Colors.linen,
      'magenta': (visitor) => $vector_math_1.Colors.magenta,
      'maroon': (visitor) => $vector_math_1.Colors.maroon,
      'mediumAquamarine': (visitor) => $vector_math_1.Colors.mediumAquamarine,
      'mediumBlue': (visitor) => $vector_math_1.Colors.mediumBlue,
      'mediumOrchid': (visitor) => $vector_math_1.Colors.mediumOrchid,
      'mediumPurple': (visitor) => $vector_math_1.Colors.mediumPurple,
      'mediumSeaGreen': (visitor) => $vector_math_1.Colors.mediumSeaGreen,
      'mediumSlateBlue': (visitor) => $vector_math_1.Colors.mediumSlateBlue,
      'mediumSpringGreen': (visitor) => $vector_math_1.Colors.mediumSpringGreen,
      'mediumTurquoise': (visitor) => $vector_math_1.Colors.mediumTurquoise,
      'mediumVioletRed': (visitor) => $vector_math_1.Colors.mediumVioletRed,
      'midnightBlue': (visitor) => $vector_math_1.Colors.midnightBlue,
      'mintCream': (visitor) => $vector_math_1.Colors.mintCream,
      'mistyRose': (visitor) => $vector_math_1.Colors.mistyRose,
      'moccasin': (visitor) => $vector_math_1.Colors.moccasin,
      'navajoWhite': (visitor) => $vector_math_1.Colors.navajoWhite,
      'navy': (visitor) => $vector_math_1.Colors.navy,
      'oldLace': (visitor) => $vector_math_1.Colors.oldLace,
      'olive': (visitor) => $vector_math_1.Colors.olive,
      'oliveDrab': (visitor) => $vector_math_1.Colors.oliveDrab,
      'orange': (visitor) => $vector_math_1.Colors.orange,
      'orangeRed': (visitor) => $vector_math_1.Colors.orangeRed,
      'orchid': (visitor) => $vector_math_1.Colors.orchid,
      'paleGoldenrod': (visitor) => $vector_math_1.Colors.paleGoldenrod,
      'paleGreen': (visitor) => $vector_math_1.Colors.paleGreen,
      'paleTurquoise': (visitor) => $vector_math_1.Colors.paleTurquoise,
      'paleVioletRed': (visitor) => $vector_math_1.Colors.paleVioletRed,
      'papayaWhip': (visitor) => $vector_math_1.Colors.papayaWhip,
      'peachPuff': (visitor) => $vector_math_1.Colors.peachPuff,
      'peru': (visitor) => $vector_math_1.Colors.peru,
      'pink': (visitor) => $vector_math_1.Colors.pink,
      'plum': (visitor) => $vector_math_1.Colors.plum,
      'powderBlue': (visitor) => $vector_math_1.Colors.powderBlue,
      'purple': (visitor) => $vector_math_1.Colors.purple,
      'red': (visitor) => $vector_math_1.Colors.red,
      'rosyBrown': (visitor) => $vector_math_1.Colors.rosyBrown,
      'royalBlue': (visitor) => $vector_math_1.Colors.royalBlue,
      'saddleBrown': (visitor) => $vector_math_1.Colors.saddleBrown,
      'salmon': (visitor) => $vector_math_1.Colors.salmon,
      'sandyBrown': (visitor) => $vector_math_1.Colors.sandyBrown,
      'seaGreen': (visitor) => $vector_math_1.Colors.seaGreen,
      'seaShell': (visitor) => $vector_math_1.Colors.seaShell,
      'sienna': (visitor) => $vector_math_1.Colors.sienna,
      'silver': (visitor) => $vector_math_1.Colors.silver,
      'skyBlue': (visitor) => $vector_math_1.Colors.skyBlue,
      'slateBlue': (visitor) => $vector_math_1.Colors.slateBlue,
      'slateGray': (visitor) => $vector_math_1.Colors.slateGray,
      'snow': (visitor) => $vector_math_1.Colors.snow,
      'springGreen': (visitor) => $vector_math_1.Colors.springGreen,
      'steelBlue': (visitor) => $vector_math_1.Colors.steelBlue,
      'tan': (visitor) => $vector_math_1.Colors.tan,
      'teal': (visitor) => $vector_math_1.Colors.teal,
      'thistle': (visitor) => $vector_math_1.Colors.thistle,
      'tomato': (visitor) => $vector_math_1.Colors.tomato,
      'turquoise': (visitor) => $vector_math_1.Colors.turquoise,
      'violet': (visitor) => $vector_math_1.Colors.violet,
      'wheat': (visitor) => $vector_math_1.Colors.wheat,
      'white': (visitor) => $vector_math_1.Colors.white,
      'whiteSmoke': (visitor) => $vector_math_1.Colors.whiteSmoke,
      'yellow': (visitor) => $vector_math_1.Colors.yellow,
      'yellowGreen': (visitor) => $vector_math_1.Colors.yellowGreen,
    },
    staticMethods: {
...
BridgedClass _createQuaternionBridge() {
  return BridgedClass(
    ...
    methodSignatures: {
      ...
      'setRandom': 'void setRandom(Random rn)',
...
BridgedClass _createVectorBridge() {
  return BridgedClass(
    nativeType: $vector_math_1.Vector,
    name: 'Vector',
...
BridgedClass _createVector2Bridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      ...
      'random': 'factory Vector2.random([Random? rng])',
    },
    methodSignatures: {
...
BridgedClass _createVector3Bridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      ...
      'random': 'factory Vector3.random([Random? rng])',
    },
    methodSignatures: {
...
BridgedClass _createVector4Bridge() {
  return BridgedClass(
    ...
    constructorSignatures: {
      ...
      'random': 'factory Vector4.random([Random? rng])',
    },
    methodSignatures: {
      'setValues': 'void setValues(double x, double y, double z, double w)',
      'setZero': 'void setZero()',
