...
// Sources: 27 files
// Generated: 2026-09-14T19:32:09.261676 by tom_d4rt_generator 1.26.0
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'invokeCallback': (visitor, target, positional, named, typeArgs) {
        ...
        return t.invokeCallback<Object?>(name, () { return D4.castCallbackResult<dynamic>(D4.callInterpreterCallback(visitor!, callbackRaw, [])); }, debugReport: debugReportRaw == null ? null : (() { return D4.callInterpreterCallback(visitor!, debugReportRaw, []) as String; }) as String Function());
      },
      'debugFillProperties': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$flutter_12.EagerGestureRecognizer>(target, 'EagerGestureRecognizer');
        D4.requireMinArgs(positional, 1, 'debugFillProperties');
