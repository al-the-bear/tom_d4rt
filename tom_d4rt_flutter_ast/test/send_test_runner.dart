...
// headroom), so the inner cap never pre-empts the outer timeout. The AST test
// app enforces the same 45s budget (see main.dart), so a slow build gets the
// full window while a genuinely wedged transport still fails before 65s.
