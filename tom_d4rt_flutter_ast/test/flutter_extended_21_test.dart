...
void main() {
  ...
  group('widgets/', () {
    ...
    // 20260602 TODO C.175: removed the 50 s httpBuildTimeout override +
    // 60 s dart-test Timeout wrapper. Isolated retest builds in ~2.6 s
    // (httpMs=2128, sourceChars=71147, bundleJsonBytes=956564,
    // frameworkErrors=0) — the historical §1.10/E39 cold-start padding
    // masked nothing. Defaults now apply (25 s httpBuildTimeout + 30 s
    // dart-test timeout) — ~22 s headroom over the build.
