        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                'Tiny',
                style: TextStyle(fontSize: 10, color: Color(0xFF66BB6A)),
              ),
            ],
          ),
        ),
...
Widget _buildIconsWithTextRow() {
  ...
  print(
    'Icons do not have alphabetic baselines - ignoring them prevents misalignment',
  );
  return _buildCard(
    Column(
      crossAxisAlignment: CrossAxisAlignment.start,
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                'Likes',
                style: TextStyle(fontSize: 18, color: Color(0xFF7B1FA2)),
              ),
            ],
          ),
        ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Text(
                'Abc',
                style: TextStyle(fontSize: 36, color: Color(0xFF2E7D32)),
              ),
              SizedBox(width: 8),
              Text(
                'xyz',
                style: TextStyle(fontSize: 20, color: Color(0xFF388E3C)),
              ),
              SizedBox(width: 8),
              Baseline(
                baseline: 0,
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Text(
                'Abc',
                style: TextStyle(fontSize: 36, color: Color(0xFF1565C0)),
              ),
              SizedBox(width: 8),
              Text(
                'xyz',
  ...
  return _buildCard(
    Column(
      ...
      children: [
        ...
        _buildTakeawayItem(
          '1',
          'IgnoreBaseline prevents a child from participating in baseline alignment',
        ),
        SizedBox(height: 6),
        _buildTakeawayItem(
          '2',
          'Useful for decorative elements (icons, badges, avatars) in text rows',
        ),
        SizedBox(height: 6),
        _buildTakeawayItem(
          '3',
          'Baseline widget with baseline=0 achieves similar effect',
        ),
        SizedBox(height: 6),
        _buildTakeawayItem(
          '4',
          'Works with both alphabetic and ideographic baselines',
        ),
        SizedBox(height: 6),
        _buildTakeawayItem(
          '5',
          'Essential for mixed content rows (text + non-text widgets)',
        ),
        SizedBox(height: 6),
        _buildTakeawayItem(
          '6',
          'RenderIgnoreBaseline is the render object behind IgnoreBaseline widget',
        ),
      ],
    ),
  );
  ...
  return _buildCard(
    Column(
      ...
      children: [
        ...
        _buildTakeawayItem(
          'A',
          'Confirm baseline alignment is intentional for this row/column',
        ),
        SizedBox(height: 6),
        _buildTakeawayItem(
          'B',
          'Ignore decorative children that should not align with text glyph baselines',
        ),
        SizedBox(height: 6),
        _buildTakeawayItem(
          'C',
          'Compare alphabetic vs ideographic behavior with localized content',
        ),
        SizedBox(height: 6),
        _buildTakeawayItem(
          'D',
          'Verify baseline stability under large text scale factors',
        ),
      ],
    ),
  );
...
dynamic build(BuildContext context) {
  ...
  print(
    'Common use case: Decorative elements in CrossAxisAlignment.baseline rows',
  );
  print('');
    ...
    child: Column(
      ...
      children: [
        ...
        _buildSectionTitle(
          ...
          '1. Baseline Alignment: With vs Without',
        ),
        _buildBaselineComparisonRow(),
        _buildSectionTitle(
          Icons.format_size,
          '2. Mixed Font Sizes with Baseline Ignored',
        ),
        ...
        _buildSectionTitle(
          Icons.table_chart,
          '5. Table Rows with Baseline Alignment',
        ),
        _buildTableBaselineDemo(),
        _buildSectionTitle(
          Icons.auto_awesome,
          '6. Practical: Decorative Elements Pattern',
        ),
        _buildDecorativeElementsRow(),
        _buildSectionTitle(
          Icons.swap_vert,
          '7. Alphabetic vs Ideographic Baselines',
        ),
