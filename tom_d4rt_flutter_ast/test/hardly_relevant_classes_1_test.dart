    ...
    test(
      ...
      () async {
        final result = await SendTestRunner.send(
          ...
          // 20260523-1056 baseline §1.4/E10: TimeoutException after
          // 30s — cold-start contention. This 1723-line / 70 KB
          // script (861 KB bundle) takes ~3.4 s in both variants.
          // Same family as §1.3 E1/E2/E4/E6/E7/E8/E9: 50 s leaves
