...
dynamic build(BuildContext context) {
  ...
  final heroHeader = Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [Color(0xFFB71C1C), Color(0xFFD84315), Color(0xFFFF6F00)],
  ...
  final fieldCards = <Widget>[
    ...
    _fieldCard(
      ...
      sample:
          detailsTap.hitTestEntry?.toString() ?? '<null - hover/add/remove>',
      description:
    ...
    _fieldCard(
      ...
      sample: detailsTap.informationCollector == null
          ? '<null>'
          : '() => [...]',
      description:
    ...
    child: Column(
      ...
      children: [
        ...
        _scenarioCard(
          ...
          collectorBullets: ['Event  -> the PointerEvent (no Target line)'],
        ),
      ],
    ),
  );
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          description,
          style: TextStyle(fontSize: 13.0, color: Colors.black87, height: 1.35),
        ),
        ...
        SizedBox(
          ...
          child: Text(
            ...
            style: TextStyle(
              fontFamily: 'monospace',
              fontSize: 12.0,
              color: source == 'subclass'
                  ? Colors.red.shade800
                  : Colors.indigo.shade700,
              fontWeight: source == 'subclass'
                  ? FontWeight.bold
                  : FontWeight.normal,
            ),
          ),
