...
dynamic build(BuildContext context) {
  ...
  final bfGallerySection = bfCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Same wide-landscape source in a square container with each fit',
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.grey.shade200,
              border: Border.all(
                color: bfDark.withValues(alpha: 0.3),
                width: 1.5,
              ),
            ),
            child: ClipRect(
  ...
  final bfFittedLandscape = bfCard(
    Column(
      children: [
        Text(
          'FittedBox: Wide Source in Square Box',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bfDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'Source 120×60 in a 90×90 container — observe scaling behavior',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  final bfFittedPortrait = bfCard(
    Column(
      children: [
        Text(
          'FittedBox: Tall Source in Wide Box',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bfDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'Source 50×100 in a 120×70 container — portrait in landscape frame',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  final bfBigThree = bfCard(
    Column(
      children: [
        Text(
          'The Big Three: fill vs contain vs cover',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bfDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'The three most commonly used BoxFit values',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
  ...
  final bfScaleDownSection = bfCard(
    Column(
      children: [
        Text(
          'scaleDown vs none',
        ...
        SizedBox(height: 4.0),
        Text(
          'Both center the source, but scaleDown will shrink if needed; '
  ...
  final bfDimensionSection = bfCard(
    Column(
      children: [
        Text(
          'fitWidth vs fitHeight',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bfDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'Each locks one dimension and lets the other vary freely',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
  ...
  final bfWidgetData = [
    {
      'widget': 'Image',
      'prop': 'fit',
      'note': 'Primary consumer — controls image scaling',
    },
    {
      'widget': 'FittedBox',
      'prop': 'fit',
      'note': 'Scales any child widget, not just images',
    },
    {
      'widget': 'DecorationImage',
      'prop': 'fit',
      'note': 'Background/foreground images in BoxDecoration',
    },
    {
      'widget': 'Ink.image',
      'prop': 'fit',
      'note': 'Material ripple over an image',
    },
    {
      'widget': 'FadeInImage',
      'prop': 'fit',
      'note': 'Crossfade placeholder → final with same fit',
    },
    {
      'widget': 'ExactAssetImage',
      'prop': 'Used with fit',
      'note': 'Provides image at exact scale',
    },
  ];
  ...
  final bfWidgetTable = bfCard(
    Column(
      children: [
        Text(
          'Widgets Using BoxFit',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bfDark,
  ...
  Widget bfClipIndicator(BoxFit fit) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Icon(clips ? Icons.content_cut : Icons.check, color: c, size: 20.0),
          SizedBox(height: 4.0),
          Text(
            fit.name,
            style: TextStyle(
  ...
  final bfClipSection = bfCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Which modes may clip source content outside the container',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  final bfDecoSection = bfCard(
    Column(
      children: [
        Text(
          'DecorationImage Pattern',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bfDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'BoxDecoration.image uses BoxFit to position a background image',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Container(
  ...
  final bfEqualitySection = bfCard(
    Column(
      children: [
        Text(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Yes → $yes${yesFit != null ? " (${yesFit.name})" : ""}',
  ...
  final bfFlowSection = bfCard(
    Column(
      children: [
        ...
        SizedBox(height: 10.0),
        bfFlowStep(
          'Must the box be fully covered with no gaps?',
          'Use',
          BoxFit.cover,
          'Continue…',
        ),
        bfFlowStep(
          'Must the full source be visible?',
          'Use',
          BoxFit.contain,
          'Continue…',
        ),
        ...
        bfFlowStep(
          'Should it never scale up?',
          'Use',
          BoxFit.scaleDown,
          'Use fitWidth / fitHeight',
        ),
      ],
    ),
  );
  ...
  final bfAlignSection = bfCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'FittedBox.alignment controls where the scaled child sits inside the box',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
