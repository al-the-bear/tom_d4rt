...
dynamic build(BuildContext context) {
        ...
        child: Column(
          children: [
            Container(
              ...
              child: FlutterLogo(size: 50.0, style: style),
            ),
            SizedBox(height: 8.0),
            Text(
              style.name,
  ...
  final flThreeValues = flCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Live FlutterLogo widgets with each style',
  ...
  final flSizeGallery = flCard(
    Column(
      children: [
        Text(
          'Size Gallery — markOnly',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: flDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'FlutterLogo.size controls the rendered size',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
          ...
          children: [
            ...
            80.0,
            100.0,
          ].map((s) => flSizeItem(s, FlutterLogoStyle.markOnly)).toList(),
        ),
        ...
        Wrap(
          ...
          children: [
            ...
            60.0,
            80.0,
          ].map((s) => flSizeItem(s, FlutterLogoStyle.horizontal)).toList(),
        ),
        SizedBox(height: 16.0),
        Text(
          'Size Gallery — stacked',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: flDark,
        ...
        Wrap(
          ...
          children: [
            ...
            60.0,
            80.0,
          ].map((s) => flSizeItem(s, FlutterLogoStyle.stacked)).toList(),
        ),
      ],
    ),
  );
  ...
  final flAspectSection = flCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Each style has its own natural aspect ratio within the size box',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
  ...
  final flBgSection = flCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'FlutterLogo on various background colors and shades',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Text(
  ...
  final flDecoSection = flCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'FlutterLogoDecoration uses FlutterLogoStyle to paint the logo '
  ...
  final flTextColorSection = flCard(
    Column(
      children: [
        Text(
          'textColor Property',
        ...
        SizedBox(height: 4.0),
        Text(
          'FlutterLogoDecoration.textColor only affects horizontal and '
  ...
  final flContainerSection = flCard(
    Column(
      children: [
        Text(
        ...
        SizedBox(height: 4.0),
        Text(
          'FlutterLogo respects its size parameter but also responds '
  ...
  final flSwitchSection = flCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Conditional logic based on FlutterLogoStyle value',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Container(
  ...
  final flGridSection = flCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Same size (60px) across all 3 styles — see the proportional differences',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
  ...
  final flEqualitySection = flCard(
    Column(
      children: [
        Text(
        ...
        ...FlutterLogoStyle.values.map(
          (s) => flInfoRow('${s.name}.index', '${s.index}'),
        ),
  ...
  final flPatternsSection = flCard(
    Column(
      children: [
        Text(
