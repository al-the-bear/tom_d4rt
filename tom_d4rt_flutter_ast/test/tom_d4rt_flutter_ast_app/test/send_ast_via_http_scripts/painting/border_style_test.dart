...
dynamic build(BuildContext context) {
  ...
  final bsValuesSection = bsCard(
    Column(
      children: [
        Text(
          'The Two BorderStyle Values',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bsDark,
  ...
  Widget bsDemoBox(BorderStyle style, double width, Color color, String label) {
    final borderSide = BorderSide(color: color, width: width, style: style);
    return Container(
      width: 100.0,
      height: 80.0,
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 2.0),
            Text(
              'side.style: ${borderSide.style.name}',
  ...
  final bsComparisonSection = bsCard(
    Column(
      children: [
        Text(
          'Visual Comparison',
        ...
        SizedBox(height: 4.0),
        Text(
          'Identical boxes, same color and width — only BorderStyle differs',
  ...
  final bsSolidSide = BorderSide(
    color: bsSolid,
    width: 3.0,
    style: BorderStyle.solid,
  );
  final bsNoneSide = BorderSide(
    color: bsNone,
    width: 3.0,
    style: BorderStyle.none,
  );

  final bsPerSideSection = bsCard(
    Column(
      children: [
        Text(
        ...
        SizedBox(height: 4.0),
        Text(
          'Each side of a Border can independently have solid or none style',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  print(
    '  solid side: color=${bsSide1.color}, width=${bsSide1.width}, style=${bsSide1.style}',
  );
  print(
    '  none side: color=${bsSide2.color}, width=${bsSide2.width}, style=${bsSide2.style}',
  );

  final bsBorderSideSection = bsCard(
    Column(
      children: [
        Text(
        ...
        SizedBox(height: 4.0),
        Text(
          'BorderSide is the carrier of BorderStyle — each side has its own style',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'BorderSide(color: indigo, width: 2.0, style: solid)',
                style: TextStyle(
                  fontSize: 11.0,
                  fontWeight: FontWeight.bold,
                  color: bsSolid,
  ...
  final bsWidthSection = bsCard(
    Column(
      children: [
        Text(
          'Border Width Gallery',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bsDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'All use BorderStyle.solid — only the width changes',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  final bsColorSection = bsCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'BorderStyle.solid with different border colors',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
              ...
              TableRow(
                children: [
                  Padding(
                    ...
                    child: Text('A1', style: TextStyle(fontSize: 11.0)),
                  ),
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text('B1', style: TextStyle(fontSize: 11.0)),
                  ),
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text('C1', style: TextStyle(fontSize: 11.0)),
                  ),
                ],
              ),
              TableRow(
                children: [
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text('A2', style: TextStyle(fontSize: 11.0)),
                  ),
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text('B2', style: TextStyle(fontSize: 11.0)),
                  ),
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text('C2', style: TextStyle(fontSize: 11.0)),
                  ),
                ],
              ),
              TableRow(
                children: [
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text('A3', style: TextStyle(fontSize: 11.0)),
                  ),
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text('B3', style: TextStyle(fontSize: 11.0)),
                  ),
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text('C3', style: TextStyle(fontSize: 11.0)),
                  ),
                ],
              ),
            ],
  ...
  final bsTableSection = bsCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'TableBorder uses BorderSide (and thus BorderStyle) for each edge',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        bsTableSample(
          'TableBorder.all(style: solid)',
  ...
  Widget bsShapeBox(BoxShape shape, BorderStyle style, String label) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: hasBorder
            ? bsSolid.withValues(alpha: 0.06)
            : bsNone.withValues(alpha: 0.06),
        shape: shape,
        border: Border.all(
  ...
  final bsShapeSection = bsCard(
    Column(
      children: [
        Text(
          'BoxShape + BorderStyle',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bsDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'BorderStyle applies equally to rectangle and circle shapes',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  final bsInputSection = bsCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'OutlineInputBorder and UnderlineInputBorder accept borderSide '
          'which carries BorderStyle',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        bsInputSample(
          'OutlineInputBorder (solid)',
          OutlineInputBorder(
  ...
  Widget bsConditionalCard(String label, bool isEnabled) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8.0),
        border: Border.all(color: borderColor, width: 2.0, style: borderStyle),
      ),
      child: Column(
        children: [
          Icon(
  ...
  final bsConditionalSection = bsCard(
    Column(
      children: [
        Text(
          'Conditional Borders',
        ...
        SizedBox(height: 4.0),
        Text(
          'A common pattern: toggle BorderStyle based on enabled/selected state',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  final bsStrokeSection = bsCard(
    Column(
      children: [
        Text(
          'StrokeAlign (only with solid)',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bsDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'strokeAlign shifts the border line inward, centered, or outward — '
  ...
  print(
    '  lerp(none→solid, 0.5): style=${bsLerpResult.style}, width=${bsLerpResult.width}',
  );

  final bsMergeSection = bsCard(
    Column(
      children: [
        Text(
          'BorderSide.merge & lerp',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bsDark,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.0),
              Text(
                'Combines two sides into one by adding widths',
                style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
              ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.0),
              Text(
                'Interpolates between two sides — style appears at t > 0',
                style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
              ),
              bsInfoRow(
                'lerp(none→solid, 0.5)',
                'style = ${bsLerpResult.style}',
              ),
  ...
  final bsEqualitySection = bsCard(
    Column(
      children: [
        Text(
