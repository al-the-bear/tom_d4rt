...
dynamic build(BuildContext context) {
  ...
  final bxTwoValuesSection = bxCard(
    Column(
      children: [
        Text(
          'The Two Values',
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 6.0),
                    Text(
                      'Takes the full bounds of the container. '
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 6.0),
                    Text(
                      'Inscribes a circle within the bounds. '
  ...
  final bxDecoSection = bxCard(
    Column(
      children: [
        Text(
          'BoxDecoration with Both Shapes',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'Same 80×80 container with different colors, rectangle vs circle',
        ...
        Wrap(
          ...
          spacing: 8.0,
          runSpacing: 8.0,
          children: bxDecoColors
              .map((c) => bxDecoSample(BoxShape.rectangle, c, 'rect'))
              .toList(),
        ),
        ...
        Wrap(
          ...
          runSpacing: 8.0,
          children: bxDecoColors
              .map((c) => bxDecoSample(BoxShape.circle, c, 'circle'))
              .toList(),
        ),
      ],
    ),
  ...
  final bxRadiusSection = bxCard(
    Column(
      children: [
        Text(
          'borderRadius Restriction',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'borderRadius is only allowed with BoxShape.rectangle. '
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.0),
              Text(
                'radius 0 → 40: progressively more circular appearance',
                style: TextStyle(fontSize: 10.0, color: Colors.grey.shade600),
              ),
            ],
          ),
  ...
  final bxShadowSection = bxCard(
    Column(
      children: [
        Text(
          'Shadow Shape Follows BoxShape',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'BoxShadow is clipped to the decoration shape automatically',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: bxRect.withValues(alpha: 0.4),
                          blurRadius: 12.0,
                          offset: Offset(4, 4),
                        ),
                      ],
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: bxCirc.withValues(alpha: 0.4),
                          blurRadius: 12.0,
                          offset: Offset(4, 4),
                        ),
                      ],
  ...
  final bxGradientSection = bxCard(
    Column(
      children: [
        Text(
          'Gradient Clipping by Shape',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'The same gradient paints differently in each shape',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
  ...
  final bxAvatarSection = bxCard(
    Column(
      children: [
        Text(
          'Avatar Patterns (BoxShape.circle)',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'Circular containers are the standard avatar shape in Flutter',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
        ...
        SizedBox(
          ...
          child: Stack(
            children: [
              Positioned(
                left: 0,
                child: bxAvatarSample('A', Color(0xFF1565C0), 40.0),
              ),
              Positioned(
                left: 24,
                child: bxAvatarSample('B', Color(0xFFE53935), 40.0),
              ),
              Positioned(
                left: 48,
                child: bxAvatarSample('C', Color(0xFF43A047), 40.0),
              ),
              Positioned(
                left: 72,
                child: bxAvatarSample('D', Color(0xFFFB8C00), 40.0),
              ),
              Positioned(
                left: 96,
                child: Container(
  ...
  final bxNonSquareSection = bxCard(
    Column(
      children: [
        Text(
          'Circle in Non-Square Containers',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'When width ≠ height, circle inscribes using the smaller dimension. '
  ...
  final bxCompareSection = bxCard(
    Column(
      children: [
        Text(
          'Rectangle vs Circle Comparison',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
  ...
  final bxWidgetData = [
    {
      ...
      'prop': 'shape',
      'note': 'Primary consumer — paints shape',
    },
    {
      'widget': 'Container',
      'prop': 'via decoration',
      'note': 'Wrapper around BoxDecoration',
    },
    {
      'widget': 'CircleAvatar',
      'prop': 'implicit',
      'note': 'Always uses circle internally',
    },
    {
      'widget': 'AnimatedContainer',
      'prop': 'via decoration',
      'note': 'Animates shape transition',
    },
    {
      'widget': 'PhysicalModel',
      'prop': 'clipBehavior',
      'note': 'Uses shape for clipping',
    },
    {
      'widget': 'DecoratedBox',
      'prop': 'via decoration',
      'note': 'Low-level decoration widget',
    },
  ];
    ...
    bxWidgetRows.add(
      TableRow(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(w['prop']!, style: TextStyle(fontSize: 11.0)),
          ),
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(
  ...
  final bxWidgetTable = bxCard(
    Column(
      children: [
        Text(
          'Widgets Using BoxShape',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
  ...
  Widget bxStyleForShape(BoxShape shape) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isCircle ? bxCirc : bxRect, width: 2.0),
  ...
  final bxSwitchSection = bxCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Conditional rendering based on BoxShape value',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Container(
  ...
  final bxGallerySection = bxCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Which shape is typical for each UI component',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  final bxEqualitySection = bxCard(
    Column(
      children: [
        Text(
          'Enum Equality & Properties',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
  ...
  final bxAnimSection = bxCard(
    Column(
      children: [
        Text(
          'AnimatedContainer Shape Transition',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: bxDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'AnimatedContainer supports animating between shapes. '
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Icon(Icons.crop_square, color: bxRect),
                    ),
                  ),
                ],
              ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Icon(Icons.circle_outlined, color: bxCirc),
                    ),
                  ),
                ],
              ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 6.0),
              Text(
                '• Content must fill a non-square area',
                style: TextStyle(fontSize: 11.0, color: bxDark, height: 1.5),
              ),
              Text(
                '• You need borderRadius for rounded corners',
                style: TextStyle(fontSize: 11.0, color: bxDark, height: 1.5),
              ),
              Text(
                '• Building cards, containers, buttons, tiles',
                style: TextStyle(fontSize: 11.0, color: bxDark, height: 1.5),
              ),
              Text(
                '• Default shape — use unless circle is needed',
                style: TextStyle(fontSize: 11.0, color: bxDark, height: 1.5),
              ),
            ],
          ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 6.0),
              Text(
                '• Rendering user avatars or profile images',
                style: TextStyle(fontSize: 11.0, color: bxDark, height: 1.5),
              ),
              Text(
                '• Creating FABs or circular action buttons',
                style: TextStyle(fontSize: 11.0, color: bxDark, height: 1.5),
              ),
              Text(
                '• Status indicators and notification dots',
                style: TextStyle(fontSize: 11.0, color: bxDark, height: 1.5),
              ),
              Text(
                '• Any element that should be perfectly round',
                style: TextStyle(fontSize: 11.0, color: bxDark, height: 1.5),
              ),
            ],
          ),
