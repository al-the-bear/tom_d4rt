...
Widget body(String text, {Color color = kInkMuted, double size = 13.0}) {
  return Text(
    text,
    style: TextStyle(fontSize: size, color: color, height: 1.45),
  );
}
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              if (note != null) ...[gap(2.0), subheading(note)],
            ],
          ),
        ),
      ],
  ...
  return card(
    child: Column(
      ...
      children: [
        ...
        compareRow(
          'typography',
          'SF Pro Display / Text, tight letter-spacing',
          'Roboto, looser spacing',
        ),
        compareRow(
          'icons',
          'CupertinoIcons font, line style',
          'Icons, filled/outlined glyphs',
        ),
        compareRow(
          'navigation',
          'CupertinoNavigationBar / SliverNavigationBar',
          'AppBar / SliverAppBar',
        ),
        compareRow(
          'gestures',
          'edge swipe back, sheet drag-to-dismiss',
          'OS back button, slide-up sheets',
        ),
        compareRow(
          'colors',
          'system* tokens that resolve to dynamic colors',
          'ColorScheme tokens',
        ),
        compareRow(
          'controls',
          'sliding segments, picker wheel, switch',
          'segments, dropdown, switch',
        ),
        compareRow(
          'feedback',
          'subtle, white-on-blur',
          'ink ripple, elevation',
        ),
        compareRow(
          'motion',
          'spring-based, slide-from-right route',
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CupertinoColors', color: kAccent),
            hgap(8.0),
            pill('TOKENS', color: kIndigo),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'Tints, legacy actives, labels (4 tiers), fills (4 tiers) and backgrounds. '
      ...
      children: [
        ...
        Row(
          children: [
            pill(
              t.brightness.name,
              color: t.brightness == Brightness.light ? kWarning : kIndigo,
            ),
            hgap(6.0),
...
Widget dynamicColorShowcase() {
  final blueLight = Trait(
    'light, normal',
    Brightness.light,
    false,
    const Color(0xFF007AFF),
  );
  final blueDark = Trait(
    'dark, normal',
    Brightness.dark,
    false,
    const Color(0xFF0A84FF),
  );
  final blueLightHC = Trait(
    'light, high-contrast',
    Brightness.light,
    true,
    const Color(0xFF0040DD),
  );
  final blueDarkHC = Trait(
    'dark, high-contrast',
    Brightness.dark,
    true,
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CupertinoDynamicColor', color: kPurple),
            hgap(8.0),
            pill('TRAIT-DEPENDENT', color: kInkSoft),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'CupertinoDynamicColor encodes up to six color variants that resolve via '
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              gap(4.0),
              body(
                'Without resolveFrom you get the *light/normal* variant only. '
                'Always pass a BuildContext that lives under a CupertinoTheme.',
                color: kInkSoft,
              ),
            ],
          ),
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CupertinoIcons', color: kAccent),
            hgap(8.0),
            pill('FONT GLYPHS', color: kInkSoft),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'CupertinoIcons is a static class of IconData constants backed by the '
...
Widget themeAnatomy() {
  final slots = <List<String>>[
    [
      'brightness',
      'Brightness?',
      'Drives all dynamic-color resolution downstream.',
    ],
    [
      'primaryColor',
      'Color',
      'Tint for active controls (buttons, switches, links).',
    ],
    [
      'primaryContrastingColor',
      'Color',
      'Foreground color when placed atop primaryColor.',
    ],
    [
      'scaffoldBackgroundColor',
      'Color',
      'Default page background for CupertinoPageScaffold.',
    ],
    [
      'barBackgroundColor',
      'Color',
      'Background of nav/tab bars; blurred behind in iOS.',
    ],
    [
      'textTheme',
      'CupertinoTextThemeData',
      'Family of typed text styles (see section 7).',
    ],
    [
      'applyThemeToAll',
      'bool',
      'When true, descendant Material widgets adopt these slots too.',
    ],
  ];
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CupertinoTheme', color: kAccent),
            hgap(8.0),
            pill('CupertinoThemeData', color: kIndigo),
          ],
        ),
        gap(10.0),
        ...
        gap(6.0),
        body(
          'CupertinoTheme is an InheritedWidget exposing a CupertinoThemeData. '
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        body(
                          'nested CupertinoTheme primaryColor: systemPurple',
                          color: kInkSoft,
                        ),
                        gap(6.0),
                        Container(
...
List<TextSlot> _textSlots() {
  return [
    TextSlot(
      'textStyle',
      'Default body text',
      const TextStyle(fontSize: 17.0, color: kInk),
      'Brevity is the soul of wit.',
    ),
    TextSlot(
      'actionTextStyle',
      'Tappable links / actions',
      const TextStyle(fontSize: 17.0, color: kAccent),
      'Open settings',
    ),
    TextSlot(
      'tabLabelTextStyle',
      'Tab bar labels',
      const TextStyle(fontSize: 10.0, color: kInkSoft, letterSpacing: -0.24),
      'Library',
    ),
    TextSlot(
      'navTitleTextStyle',
    ...
    TextSlot(
      'pickerTextStyle',
      'CupertinoPicker wheel item',
      const TextStyle(fontSize: 21.0, color: kInk, letterSpacing: -0.41),
      'Tuesday',
    ),
    TextSlot(
      'dateTimePickerTextStyle',
      'Date/time picker columns',
      const TextStyle(fontSize: 21.0, color: kInk, letterSpacing: -0.6),
      '14 : 32',
    ),
  ];
}
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CupertinoTextThemeData', color: kIndigo),
            hgap(8.0),
            pill('TYPOGRAPHY', color: kAccent),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'CupertinoTextThemeData groups the typography slots Cupertino widgets pick up. '
  ...
  return Container(
    ...
    child: Row(
      children: [
        ...
        hgap(10.0),
        Expanded(
          child: Text(title, style: TextStyle(fontSize: 15.0, color: fg)),
        ),
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('Brightness', color: kIndigo),
            hgap(8.0),
            pill('LIGHT vs DARK', color: kAccent),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'A mocked Settings page rendered under Brightness.light then Brightness.dark. '
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      pill('light', color: kWarning),
                      hgap(6.0),
                      subheading('Brightness.light'),
                    ],
                  ),
                  gap(8.0),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      pill('dark', color: kIndigo),
                      hgap(6.0),
                      subheading('Brightness.dark'),
                    ],
                  ),
                  gap(8.0),
...
Widget localizationsAnatomy() {
  ...
  final entries = <List<String>>[
    ...
    [
      'alertDialogLabel',
      loc.alertDialogLabel,
      'Semantic label for CupertinoAlertDialog',
    ],
    [
      'modalBarrierDismissLabel',
      loc.modalBarrierDismissLabel,
      'Semantic label for tapping the modal barrier',
    ],
    [
      'datePickerHourSemanticsLabel(14)',
      loc.datePickerHourSemanticsLabel(14),
      'Semantic readout for picker hour',
    ],
    [
      'datePickerMinuteSemanticsLabel(7)',
      loc.datePickerMinuteSemanticsLabel(7),
      'Semantic readout for picker minute',
    ],
    [
      'datePickerMediumDate(now)',
      loc.datePickerMediumDate(DateTime(2026, 1, 1)),
      'Formatted medium date for picker',
    ],
    [
      'datePickerDateOrder',
      loc.datePickerDateOrder.name,
      'Order of month/day/year columns',
    ],
    [
      'datePickerDateTimeOrder',
      loc.datePickerDateTimeOrder.name,
      'Order of date/time blocks',
    ],
    ['timerPickerHour(2)', loc.timerPickerHour(2), 'Timer hour column label'],
    [
      'timerPickerMinute(15)',
      loc.timerPickerMinute(15),
      'Timer minute column label',
    ],
    [
      'timerPickerSecond(30)',
      loc.timerPickerSecond(30),
      'Timer second column label',
    ],
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CupertinoLocalizations', color: kPurple),
            hgap(8.0),
            pill('DEFAULTS', color: kInkSoft),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'DefaultCupertinoLocalizations is the en-US fallback. For other locales add '
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CupertinoActivityIndicator', color: kAccent),
            hgap(8.0),
            pill('SPINNER', color: kInkSoft),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'CupertinoActivityIndicator renders a rotating spoke spinner. '
      ...
      child: Row(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                if (subtitle.isNotEmpty)
                  Text(
                    subtitle,
                    style: const TextStyle(fontSize: 12.0, color: kInkSoft),
                  ),
              ],
            ),
          ),
          if (trailing != null)
            Text(
              trailing,
              style: const TextStyle(fontSize: 14.0, color: kInkSoft),
            ),
          hgap(6.0),
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              pill(
                insetGrouped ? 'INSET GROUPED' : 'BASE',
                color: insetGrouped ? kAccent : kInkSoft,
              ),
            ],
          ),
          gap(10.0),
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CupertinoListSection', color: kAccent),
            hgap(8.0),
            pill('CupertinoListTile', color: kIndigo),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'CupertinoListSection has two flavours — base (full-bleed) and insetGrouped '
        ...
        sectionBlock(
          ...
          header: 'Connectivity',
          footer:
              'Inset grouped style with rounded children, used on Settings-style screens.',
          tiles: [
            tile(
              icon: CupertinoIcons.wifi,
              tint: kAccent,
        ...
        sectionBlock(
          ...
          header: 'Devices',
          footer:
              'Base style with full-bleed children, common in master lists.',
          tiles: [
            tile(
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('MediaQueryData', color: kPurple),
            hgap(8.0),
            pill('iOS TRAITS', color: kInkSoft),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'Cupertino widgets read several MediaQuery slots to adapt — '
        ...
        kv(
          'viewInsets.bottom',
          mq?.viewInsets.bottom.toStringAsFixed(1) ?? '0.0',
        ),
      ],
    ),
  );
      ...
      Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            hgap(10.0),
            Expanded(
              child: i + 1 < recipes.length ? recipes[i + 1] : const SizedBox(),
            ),
          ],
        ),
      ),
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('RECIPES', color: kAccent),
            hgap(8.0),
            pill('SIX SNIPPETS', color: kInkSoft),
          ],
        ),
        gap(10.0),
        ...
        gap(4.0),
        body(
          'Each recipe pairs a one-line tagline with three concrete steps. '
...
Widget comparisonTable() {
  final rows = <List<String>>[
    [
      'CupertinoColors',
      'ColorScheme',
      'Cupertino exposes named dynamic colors that resolve from context; Material composes them into a scheme.',
    ],
    [
      'CupertinoDynamicColor',
      'MaterialStateColor',
      'Both encode trait-dependent variants; CupertinoDynamicColor keys on brightness/contrast/elevation, MaterialStateColor on widget states.',
    ],
    [
      'CupertinoIcons',
      'Icons',
      'Different icon font; CupertinoIcons is line-style at one weight, Icons supports filled/outlined/rounded.',
    ],
    [
      'CupertinoTheme',
      'Theme',
      'CupertinoTheme is leaner — no MaterialState plumbing, no elevation overlay, no implicit ColorScheme.',
    ],
    [
      'CupertinoThemeData',
      'ThemeData',
      'CupertinoThemeData has ~7 slots vs ThemeData\'s ~50; applyThemeToAll bridges to Material.',
    ],
    [
      'CupertinoTextThemeData',
      'TextTheme',
      'Cupertino names slots by *use* (navTitle, picker) rather than by *size* (headlineLarge).',
    ],
    [
      'CupertinoLocalizations',
      'MaterialLocalizations',
      'Same idea; Cupertino adds picker semantics labels.',
    ],
    [
      'CupertinoActivityIndicator',
      'CircularProgressIndicator',
      'Cupertino renders spokes, Material renders an arc; partiallyRevealed gives Cupertino a determinate mode.',
    ],
    [
      'CupertinoListSection',
      'ListView / Card',
      'CupertinoListSection bakes in header/footer/grouped style; Material composes separately.',
    ],
  ];
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('CROSS-WALK', color: kIndigo),
            hgap(8.0),
            pill('CUPERTINO × MATERIAL', color: kAccent),
          ],
        ),
        gap(10.0),
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('PITFALLS', color: kDestructive),
            hgap(8.0),
            pill('GOTCHAS', color: kWarning),
          ],
        ),
        gap(10.0),
  ...
  return card(
    child: Column(
      ...
      children: [
        Row(
          children: [
            pill('GLOSSARY', color: kIndigo),
            hgap(8.0),
            pill('SIXTEEN TERMS', color: kInkSoft),
          ],
        ),
        gap(10.0),
        ...
        glossaryEntry(
          'CupertinoColors',
          'Static class of named iOS color tokens; most are CupertinoDynamicColor.',
        ),
        glossaryEntry(
          'CupertinoDynamicColor',
          'Color that resolves to a different value based on brightness, accessibility-contrast and elevation traits.',
        ),
        glossaryEntry(
          'CupertinoIcons',
          'Static class of IconData glyphs from the cupertino_icons font.',
        ),
        glossaryEntry(
          'CupertinoTheme',
          'InheritedWidget exposing a CupertinoThemeData; analogous to Theme for Material.',
        ),
        glossaryEntry(
          'CupertinoThemeData',
          'Immutable struct of theme slots (primaryColor, barBackgroundColor, textTheme, etc.).',
        ),
        glossaryEntry(
          'CupertinoTextThemeData',
          'Group of TextStyles used by Cupertino widgets for nav, picker and selection text.',
        ),
        glossaryEntry(
          'CupertinoLocalizations',
          'Abstract class of localised strings/getters used by Cupertino widgets.',
        ),
        glossaryEntry(
          'DefaultCupertinoLocalizations',
          'Concrete en-US implementation of CupertinoLocalizations used as a fallback.',
        ),
        glossaryEntry(
          'CupertinoActivityIndicator',
          'iOS-style spinner with optional partiallyRevealed determinate mode.',
        ),
        glossaryEntry(
          'CupertinoListSection',
          'Grouped list container with header, footer and rounded corners (insetGrouped variant).',
        ),
        glossaryEntry(
          'CupertinoListTile',
          'Row used inside CupertinoListSection — leading/title/subtitle/trailing/additionalInfo slots.',
        ),
        glossaryEntry(
          'CupertinoDatePicker',
          'Rotating-wheel date and time picker; reads from CupertinoLocalizations.',
        ),
        glossaryEntry(
          'CupertinoTimerPicker',
          'Hour/minute/second wheel picker used for countdowns.',
        ),
        glossaryEntry(
          'CupertinoPicker',
          'Generic wheel picker; CupertinoDatePicker and CupertinoTimerPicker are built on top.',
        ),
        glossaryEntry(
          'MediaQuery',
          'InheritedWidget exposing screen and accessibility metrics; Cupertino reads platformBrightness and textScaler.',
        ),
        glossaryEntry(
          'Brightness',
          'Enum (light, dark); drives CupertinoDynamicColor resolution and most colour decisions.',
        ),
      ],
    ),
  );
          ...
          child: Column(
            ...
            children: [
              ...
              sectionTitle(
                ...
                note: 'Where the two design languages diverge',
              ),
              overviewCard(),
              ...
              sectionTitle(
                3,
                'CupertinoColors catalog',
                note: 'Twenty-four named tokens with hex values',
              ),
              colorsCatalog(),
              ...
              sectionTitle(
                4,
                'CupertinoDynamicColor',
                note: 'One name, four trait-dependent resolutions',
              ),
              ...
              sectionTitle(
                5,
                'CupertinoIcons catalog',
                note: 'Thirty representative glyphs from the iOS icon font',
              ),
              iconsCatalog(),
              ...
              sectionTitle(
                ...
                note: 'Every slot, plus a nested override specimen',
              ),
              themeAnatomy(),
              ...
              sectionTitle(
                7,
                'CupertinoTextThemeData',
                note: 'Eight typography slots with rendered samples',
              ),
              textThemeSpecimens(),
              ...
              sectionTitle(
                ...
                note: 'Light vs dark renderings of the same screen',
              ),
              ...
              sectionTitle(
                ...
                'CupertinoLocalizations',
                note:
                    'DefaultCupertinoLocalizations getters and their resolved values',
              ),
              ...
              sectionTitle(
                10,
                'CupertinoActivityIndicator',
                note: 'Four static configurations of the iOS spinner',
              ),
              ...
              sectionTitle(
                ...
                'CupertinoListSection',
                note:
                    'Inset-grouped and base flavours with CupertinoListTile children',
              ),
              listSectionDemo(),
              ...
              sectionTitle(
                12,
                'MediaQuery iOS context',
                note: 'Slots Cupertino widgets read to adapt',
              ),
              ...
              sectionTitle(
                13,
                'Recipes',
                note: 'Six small, copy-pasteable patterns',
              ),
              recipesGrid(),
              ...
              sectionTitle(
                14,
                'Cross-walk to Material',
                note:
                    'Each Cupertino concept aligned with its Material counterpart',
              ),
              comparisonTable(),
              ...
              sectionTitle(
                15,
                'Pitfalls',
                note: 'Mistakes that compile but render wrong',
              ),
              pitfallsCard(),
              ...
              sectionTitle(
                16,
                'Glossary',
                note: 'Sixteen terms you\'ll see in the cupertino.dart library',
              ),
              glossaryCard(),
