...
dynamic build(BuildContext context) {
  ...
  Widget adSectionHeader(String title, IconData icon) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [adPrimary, adAccent]),
  ...
  final adCompass = adCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'All four AxisDirection values arranged spatially',
  ...
  for (final d in AxisDirection.values) {
    ...
    print(
      '  ${d.name}: axis=$axis, reversed=$reversed, flipped=${flipped.name}',
    );
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Center(child: Icon(adIconFor(d), color: c, size: 30.0)),
            ),
            SizedBox(width: 14.0),
            Expanded(
              child: Column(
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      adBadge(
                        ...
                        reversed ? Colors.red.shade700 : Colors.teal.shade700,
                      ),
                    ],
                  ),
                  SizedBox(height: 6.0),
  ...
  final adAxisMapping = adCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Maps each AxisDirection to its parent Axis',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
          children: [
            Expanded(
              child: adAxisGroup('vertical', Color(0xFF00695C), [
                AxisDirection.up,
                AxisDirection.down,
              ]),
            ),
            SizedBox(width: 10.0),
            Expanded(
              child: adAxisGroup('horizontal', Color(0xFF4527A0), [
                AxisDirection.left,
                AxisDirection.right,
              ]),
            ),
  ...
  for (final info in adReversedInfo) {
    ...
    adReversedRows.add(
      TableRow(
        decoration: BoxDecoration(color: revColor.withValues(alpha: 0.04)),
        children: [
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(
          ...
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(info['axis']!, style: TextStyle(fontSize: 12.0)),
          ),
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(
  ...
  final adReversedTable = adCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          '"Reversed" means content grows opposite to the natural reading order',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Table(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    width: 30.0,
                    height: 2.0,
                    color: adPrimary.withValues(alpha: 0.4),
                  ),
  ...
  final adFlipSection = adCard(
    Column(
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Returns the AxisDirection pointing in the opposite direction',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 10.0),
  ...
  final adScrollSection = adCard(
    Column(
      children: [
        Text(
          'Scroll Direction Visualization',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: adDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'Each box shows how items order when scrolled in that AxisDirection',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Wrap(
  ...
  final adGrowthSection = adCard(
    Column(
      children: [
        Text(
          'Relationship with GrowthDirection',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: adDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'A Viewport combines AxisDirection with GrowthDirection to decide '
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              adInfoRow(
                'GrowthDirection',
                'forward (add to end) or reverse (add to start)',
              ),
  ...
  final adUsageData = <Map<String, String>>[
    ...
    {
      'widget': 'Viewport',
      'prop': 'axisDirection (direct)',
      'note': 'Core rendering widget; owns the enum',
    },
    {
      'widget': 'RenderSliver',
      'prop': 'constraints.axisDirection',
    ...
    {
      'widget': 'Scrollbar',
      'prop': 'Derived from scroll position',
  ...
  for (var i = 0; i < adUsageData.length; i++) {
    ...
    adUsageRows.add(
      TableRow(
        decoration: BoxDecoration(
          color: i.isEven ? Colors.white : adSurface.withValues(alpha: 0.5),
        ),
        children: [
          Padding(
            padding: EdgeInsets.all(8.0),
          ...
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(u['prop']!, style: TextStyle(fontSize: 11.0)),
          ),
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(
  ...
  final adConversion = adCard(
    Column(
      children: [
        Text(
          'scrollDirection + reverse → AxisDirection',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: adDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'How ListView/GridView resolve the direction enum',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 10.0),
  ...
  final adTextDirSection = adCard(
    Column(
      children: [
        Text(
          'TextDirection Interplay',
          style: TextStyle(
            fontSize: 14.0,
            fontWeight: FontWeight.bold,
            color: adDark,
        ...
        SizedBox(height: 4.0),
        Text(
          'textDirectionToAxisDirection() converts TextDirection to AxisDirection',
          style: TextStyle(fontSize: 11.0, color: Colors.grey.shade600),
        ),
        SizedBox(height: 12.0),
        Row(
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8.0),
                  border: Border.all(
                    color: adRightColor.withValues(alpha: 0.3),
                  ),
                ),
                child: Column(
                  children: [
  ...
  final adPatternsSection = adCard(
    Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.0),
              Text(
                'ListView(reverse: true) → AxisDirection.up\n'
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.0),
              Text(
                'ListView(scrollDirection: Axis.horizontal) → AxisDirection.right\n'
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.0),
              Text(
                'ListView() → AxisDirection.down (default)\n'
  ...
  final adEqualitySection = adCard(
    Column(
      children: [
        Text(
          'Enum Equality & Index',
  ...
  final adHelperData = [
    {
      'fn': 'axisDirectionToAxis()',
      'desc': 'Maps to Axis.horizontal or Axis.vertical',
    },
    {
      'fn': 'axisDirectionIsReversed()',
      'desc': 'true for up and left (opposite of natural reading)',
    },
    {
      'fn': 'flipAxisDirection()',
      'desc': 'Returns the opposite direction on the same axis',
    },
    {
      'fn': 'textDirectionToAxisDirection()',
      'desc': 'Converts TextDirection.ltr/rtl to right/left',
    },
  ];
  ...
  final adSummarySection = Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(colors: [adDark, adPrimary]),
      borderRadius: BorderRadius.circular(12.0),
    ),
    child: Column(
      children: [
        Text(
          'AxisDirection — Summary',
          style: TextStyle(
            color: Colors.white,
            fontSize: 16.0,
            fontWeight: FontWeight.bold,
