...
class _RegularWindowDemoState extends State<_RegularWindowDemo>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabCtrl,
        children: [_TheoryTab(), _MultiWindowLabTab(), _LifecycleScopingTab()],
      ),
    );
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildBullet(
            Icons.account_tree,
            'Child renders inside a platform View',
          ),
          ...
          _buildBullet(
            ...
            'Removal does NOT destroy the window',
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTreeNode(
            ...
            'Rebuilds on controller changes',
          ),
          _buildTreeNode(
            2,
            'WindowScope',
            _kScopeColor,
            'Provides controller to subtree',
          ),
          _buildTreeNode(
            3,
            'View',
            _kViewColor,
            'Renders into native FlutterView',
          ),
          _buildTreeNode(
            4,
            'child (your widget)',
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: TextStyle(
                fontSize: 10,
                color: _kDarkText.withOpacity(0.6),
              ),
            ),
          ),
        ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildParamRow(
            'controller',
            'The window controller managing this window\'s native state',
            _kPrimary,
          ),
          _buildParamRow(
            'child',
            'The widget tree to render inside the window',
            _kDelegateColor,
          ),
          SizedBox(height: 10),
          Container(
          ...
          Row(
            children: [
              Expanded(
                child: _buildInfoBox(
                  'FlutterView',
                  'Low-level engine surface. Each\n'
                      'native window owns exactly one.\n'
                      'controller.rootView returns it.',
                  _kViewColor,
                ),
              ),
              SizedBox(width: 10),
              Expanded(
                child: _buildInfoBox(
                  'View Widget',
                  'Framework widget that binds\n'
                      'the widget tree to a FlutterView.\n'
                      'Handles pixel ratio and sizing.',
                  _kAccent,
                ),
              ),
            ],
  ...
  Widget _buildWindowGrid() {
    if (_windows.isEmpty) {
      return Container(
        ...
        child: Center(
          child: Text(
            'No windows. Tap "New Window" to create one.',
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: win.isActive
              ? [
                  BoxShadow(
                    color: win.contentColor.withOpacity(0.15),
                    blurRadius: 8,
                  ),
                ]
              : [],
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'RegularWindow(controller: ctrl_$index, child: ...)',
                          style: TextStyle(
                            fontSize: 10,
                            fontFamily: 'monospace',
                            color: _kDarkText,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          Text(
            'Active controllers: ${_windows.length}',
            ...
            return Padding(
              ...
              child: Row(
                children: [
                  ...
                  Spacer(),
                  Text(
                    win.isActive ? 'active' : 'background',
                    style: TextStyle(
                      fontSize: 10,
                      color: win.isActive ? _kDelegateColor : Colors.grey,
                    ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildCommRow(
            'Provider',
            'InheritedWidget above all windows',
            Icons.account_tree,
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFlowStep(
            1,
            'Controller Created',
            'RegularWindowController() → native window',
            _kDelegateColor,
          ),
          _buildFlowStep(
            2,
            'Widget Mounted',
            'RegularWindow enters widget tree',
            _kPrimary,
          ),
          _buildFlowStep(
            3,
            'View Bound',
            'Child renders into controller.rootView',
            _kViewColor,
          ),
          _buildFlowStep(
            4,
            'State Changes',
            'Title, size, focus → notifyListeners()',
            _kAccent,
          ),
          _buildFlowStep(
            5,
            'Close Request',
            'Delegate.onCloseRequested() called',
            _kScopeColor,
          ),
          _buildFlowStep(
            6,
            'Destroy',
            'controller.destroy() releases native window',
            _kDestroyColor,
          ),
        ],
      ),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _windowState == 'destroyed'
                    ? _kDestroyColor.withOpacity(0.3)
                    : _kDelegateColor.withOpacity(0.2),
              ),
            ),
            child: Column(
              children: [
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 8),
              Text(
                'Important: Widget Removal ≠ Destroy',
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w700,
                  color: _kDarkText,
      ...
      child: Column(
        ...
        children: [
          ...
          if (_lifecycleLog.isEmpty)
            Text(
              'No events yet. Use simulator controls above.',
              style: TextStyle(
                fontSize: 11,
