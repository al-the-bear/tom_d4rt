...
dynamic build(BuildContext context) {
  ...
  Widget noteBox(String text, Color border, Color bg) {
    return Container(
      ...
      child: Text(text, style: TextStyle(fontSize: 13, color: darkSteel)),
    );
  }
  ...
  final objB = Object();
  print(
    'ObjectKey(objA) == ObjectKey(objA): ${ObjectKey(objA) == ObjectKey(objA)}',
  );
  print(
    'ObjectKey(objA) == ObjectKey(objB): ${ObjectKey(objA) == ObjectKey(objB)}',
  );
  print(
    'ValueKey("x") == ValueKey("x"): ${const ValueKey("x") == const ValueKey("x")}',
  );
  print(
    'ValueKey(objA) == ValueKey(objB): ${ValueKey(objA) == ValueKey(objB)}',
  );
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'A key that uses object identity (identical()) for '
        ...
        Container(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: deepSlate.withValues(alpha: 0.3)),
            ),
            child: Text(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              for (final level in [
                ('Key (abstract)', 'Base class for all keys', deepSlate, true),
                (
                  '\u2514\u2500 LocalKey',
                ...
                (
                  '    \u2514\u2500 UniqueKey',
                  'Always unique (never equal to another)',
                  lightSlate,
                  false,
                ),
                (
                  '\u2514\u2500 GlobalKey',
                  'Globally unique, state access',
                  accentAmber,
                  false,
                ),
                (
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border(left: BorderSide(color: level.$3, width: 2)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Text(
                          level.$2,
                          style: TextStyle(fontSize: 11, color: darkSteel),
                        ),
                      ),
                    ],
                  ),
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.fingerprint, size: 24, color: slate),
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 10, color: darkSteel),
                      ),
                    ],
                  ),
                ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.compare, size: 24, color: accentAmber),
                      const SizedBox(height: 4),
                      Text(
                        'operator ==',
                        style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                          color: row.$2 == 'true' ? accentTeal : slate,
                        ),
                      ),
                    ),
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                          color: row.$3 == 'true' ? accentTeal : slate,
                        ),
                      ),
                    ),
                  ],
              ...
              for (final comparison in [
                ...
                Container(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(comparison.$4, size: 20, color: comparison.$5),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 10,
                                    fontFamily: 'monospace',
                                    color: comparison.$5.withValues(alpha: 0.7),
                                  ),
                                ),
                              ],
                            ),
        ...
        sectionBanner(
          '6 \u00b7 Live Demo: Identity vs Value Comparison',
          ...
          builder: (ctx) {
            ...
            final results = <(String, bool, Color)>[
              ...
              (
                ...
                const ValueKey(42) == const ValueKey(42),
                accentTeal,
              ),
              (
              ...
              (
                ...
                const ObjectKey(null) == const ObjectKey(null),
                accentTeal,
              ),
            ];
            return Container(
                  ...
                  for (final r in results)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(6),
                        border: Border(left: BorderSide(color: r.$3, width: 2)),
                      ),
                      child: Row(
                        children: [
                          Expanded(
        ...
        sectionBanner(
          '8 \u00b7 Live Demo: List With ObjectKey',
                ...
                children: [
                  ...
                  for (var i = 0; i < items.length; i++)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (i.isEven ? slate : iron).withValues(
                          alpha: 0.06,
                        ),
                        borderRadius: BorderRadius.circular(6),
                        border: Border(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Spacer(),
                          Text(
                            'hash: ${identityHashCode(items[i]).toRadixString(16)}',
                            style: TextStyle(
                              fontSize: 9,
                              fontFamily: 'monospace',
                              color: softIron,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: iron.withValues(alpha: 0.3)),
                ),
                child: Text(
          ...
          child: Column(
            children: [
              for (final perf in [
                (
                  'Equality check',
                  'O(1) — identical() is a pointer comparison',
                  Icons.speed,
                  slate,
                ),
                (
                  'hashCode',
                  'O(1) — identityHashCode is the default object hash',
                  Icons.tag,
                  iron,
                ),
                (
                  'Memory',
                  'Single reference field — minimal overhead',
                  Icons.memory,
                  deepSlate,
                ),
                (
                  'Const',
                  'const ObjectKey — zero allocation when const',
                  Icons.eco,
                  accentTeal,
                ),
                (
                  'vs ValueKey',
                  'ObjectKey is always O(1). ValueKey depends on the '
