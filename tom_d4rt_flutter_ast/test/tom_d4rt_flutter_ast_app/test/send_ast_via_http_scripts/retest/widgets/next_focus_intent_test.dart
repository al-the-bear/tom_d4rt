...
dynamic build(BuildContext context) {
  ...
  Widget noteBox(String text, Color border, Color bg) {
    return Container(
      ...
      child: Text(text, style: TextStyle(fontSize: 13, color: deepPewter)),
    );
  }
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Intent subclass — a declarative request to move keyboard '
        ...
        sectionBanner(
          '2 \u00b7 The Intent / Action Design Pattern',
          ...
          child: Column(
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Tab key \u2192 NextFocusIntent()',
                            style: TextStyle(fontSize: 10, color: deepPewter),
                          ),
                        ],
                      ),
                    ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.play_circle_fill, size: 20, color: accentTeal),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          child: Column(
            children: [
              for (final reason in [
                (
                  'Deterministic',
                  'The next focusable widget is determined '
                ...
                (
                  'Const-able',
                  'With no parameters, the intent can be '
                ...
                (
                  'Composable',
                  'If you want a different traversal target, '
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              reason.$2,
                              style: TextStyle(fontSize: 11, color: deepPewter),
                            ),
                          ],
                        ),
                      ),
        ...
        Container(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: deepPewter.withValues(alpha: 0.3)),
            ),
            child: Text(
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      fontFamily: 'monospace',
                      fontWeight: level.$1.contains('NextFocusIntent')
                          ? FontWeight.bold
                          : FontWeight.normal,
                      color: level.$2,
                    ),
          ...
          child: Table(
            ...
            children: [
              ...
              for (final row in [
                ...
                ('DirectionalFocusIntent', 'Arrow keys', 'TraversalDirection'),
                ('RequestFocusIntent', 'Custom', 'FocusNode'),
                ('DismissIntent', 'Escape', 'None'),
              ])
                TableRow(
                  decoration: row.$1 == 'NextFocusIntent'
                      ? BoxDecoration(color: accentBlue.withValues(alpha: 0.06))
                      : null,
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(8),
        ...
        sectionBanner(
          '7 \u00b7 Default Shortcut Registration',
        ...
        sectionBanner(
          '10 \u00b7 Why Intents Instead of Callbacks',
          ...
          child: Column(
            children: [
              for (final point in [
                (
                  'Testability',
                  'Intents can be dispatched programmatically '
                ...
                (
                  'Separation',
                  'The key binding (Shortcuts), the request '
                ...
                (
                  'Discoverability',
                  'The Actions widget can query isEnabled '
                ...
                (
                  'Hierarchy',
                  'Actions walk up the widget tree to find the '
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border(left: BorderSide(color: point.$4, width: 3)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
        ...
        // ── 13. isEnabled check ──────────────────────────────────────
        sectionBanner(
          '12 \u00b7 Checking If Action Is Enabled',
                ...
                builder: (ctx) {
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        Icon(
                          action != null ? Icons.check_circle : Icons.cancel,
                          size: 20,
                          color: action != null
                              ? const Color(0xFF2E7D32)
                              : const Color(0xFFE53935),
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(fontSize: 12, color: deepPewter),
                          ),
                        ),
                      ],
                    ),
          ...
          child: Column(
            children: [
              for (final pattern in [
                (
                  'Form navigation',
                  'Tab between text fields in a form. '
                ...
                (
                  'Toolbar buttons',
                  'Tab through a row of toolbar buttons '
                ...
                (
                  'Dialog focus',
                  'Tab through dialog body and action '
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.looks_one, size: 20, color: accentBlue),
                        const SizedBox(width: 8),
                        Text(
                          'NextFocusIntent — zero parameters',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                            color: accentBlue,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.looks_two, size: 20, color: accentTeal),
                        const SizedBox(width: 8),
                        Text(
                          'DirectionalFocusIntent — direction param',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                            color: accentTeal,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.looks_3, size: 20, color: accentAmber),
                        const SizedBox(width: 8),
                        Text(
                          'RequestFocusIntent — node param',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                            color: accentAmber,
                    ...
                    Text(
                      'RequestFocusIntent(specificNode)',
                      style: TextStyle(
                        fontSize: 10,
                        fontFamily: 'monospace',
                        color: deepPewter,
