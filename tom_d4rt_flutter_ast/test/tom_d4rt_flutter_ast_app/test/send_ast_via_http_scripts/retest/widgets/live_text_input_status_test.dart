    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 13, color: deepDusk)),
          ),
        ],
      ),
    );
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Enum representing camera-based text input availability',
                style: TextStyle(
        ...
        dataRow(
          'Values count',
          '${LiveTextInputStatus.values.length}',
          twilight,
        ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Icon(
                        ...
                        size: 16,
                        color: pair.$3 ? const Color(0xFF2E7D32) : sunsetPink,
                      ),
                      const SizedBox(width: 4),
                      Text(
                        '${pair.$3}',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        mapping.$4,
                        style: TextStyle(fontSize: 12, color: amethyst),
                      ),
                    ],
                  ),
                ),
            ...
            children: [
              ...
              for (final row in [
                ...
                (
                  'iPadOS 15+',
                  'enabled',
                  'Full support with larger viewfinder',
                ),
          ...
          child: Column(
            children: [
              for (final step in [
                (
                  1,
                  'App creates notifier',
                  'Status starts as unknown',
                  dawnGold,
                ),
                (
                  2,
                  'Async platform check',
                ...
                (
                  4,
                  'Status updated',
                  'Changes to enabled or disabled',
                  const Color(0xFF2E7D32),
                ),
                (
                  5,
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ...
                        size: 16,
                        color: timing.$3 ? const Color(0xFF2E7D32) : sunsetPink,
                      ),
                      const SizedBox(width: 8),
                      SizedBox(
                        width: 110,
