...
dynamic build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 12, color: hunter)),
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: deepEmerald)),
              Text(
  ...
  Widget measurementLine(String label, double widthPx, Color color) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label, style: TextStyle(fontSize: 10, color: deepEmerald)),
  ...
  final methods = <Map<String, String>>[
    {
      ...
      'purpose': 'Get full line containing the offset',
    },
    {
      'method': 'getWordBoundary()',
      'returns': 'TextRange',
      'purpose': 'Get word boundaries at position',
    },
    {
      'method': 'getTextPositionAbove()',
      'returns': 'TextPosition',
      'purpose': 'Character position one line up',
    },
    {
      'method': 'getTextPositionBelow()',
      'returns': 'TextPosition',
      'purpose': 'Character position one line down',
    },
  ];
  ...
  final navPatterns = <Map<String, String>>[
    {
      'key': 'Left arrow',
      'action': 'Move one character left',
      'uses': 'Offset - 1',
    },
    {
      'key': 'Right arrow',
      'action': 'Move one character right',
      'uses': 'Offset + 1',
    },
    {
      'key': 'Up arrow',
      'action': 'Move one line up',
      'uses': 'getTextPositionAbove()',
    },
    {
      'key': 'Down arrow',
      'action': 'Move one line down',
      'uses': 'getTextPositionBelow()',
    },
    {
      'key': 'Home',
      'action': 'Go to line start',
      'uses': 'getLineAtOffset().start',
    },
    {'key': 'End', 'action': 'Go to line end', 'uses': 'getLineAtOffset().end'},
    {
      'key': 'Ctrl+Left',
      'action': 'Jump word left',
      'uses': 'getWordBoundary()',
    },
    {
      'key': 'Ctrl+Right',
      'action': 'Jump word right',
      'uses': 'getWordBoundary()',
    },
  ];
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            dataRow(
              'getLineAtOffset()',
              'Queries RenderEditable.getLineAtOffset',
            ),
            dataRow(
              'getWordBoundary()',
              'Queries RenderEditable.getWordBoundary',
            ),
            dataRow(
              'getTextPositionAbove()',
              'Uses RenderEditable + preferred x',
            ),
            dataRow(
              'getTextPositionBelow()',
              'Uses RenderEditable + preferred x',
