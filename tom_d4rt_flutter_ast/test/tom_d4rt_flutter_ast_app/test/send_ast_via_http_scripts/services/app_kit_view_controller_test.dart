...
Widget _akDivider() => Padding(
  ...
  child: Container(height: 1, color: _akBurgundy.withValues(alpha: 0.1)),
);
...
Widget _akBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'macOS AppKit view embedding for Flutter',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        _akArchLayer(
          'Controller Layer',
          'AppKitViewController manages lifecycle',
          _akAccent,
          1,
        ),
        _akArchArrow(),
        ...
        _akArchLayer(
          'macOS Embedder',
          'FlutterViewController hosts NSView',
          _akGreen,
          3,
        ),
        _akArchArrow(),
        _akArchLayer(
          'Native AppKit',
          'NSView receives events and renders',
          _akOrange,
          4,
        ),
      ],
...
Widget _akArchLayer(String title, String desc, Color c, int depth) => Container(
  width: double.infinity,
    ...
    child: Column(
      children: [
        _akLifeStep(
          1,
          'Create',
          'Platform creates NSView with viewId',
          _akBurgundy,
        ...
        _akLifeStep(
          2,
          'Connect',
          'Controller receives viewId handle',
          _akBlue,
          Icons.link,
        ),
        _akLifeStep(
          3,
          'Resize',
          'View resizes with Flutter layout',
          _akGreen,
          Icons.aspect_ratio,
        ),
        _akLifeStep(
          4,
          'Re-position',
          'Offset updates as view scrolls or moves',
          _akOrange,
          Icons.open_with,
        ),
        _akLifeStep(
          5,
          'Accept touch',
          'Hit testing routes gestures to NSView',
          _akPurple,
          Icons.touch_app,
        ),
        _akLifeStep(
          6,
          'Dispose',
          'Controller tears down the NSView',
          _akAccent,
...
Widget _akLifeStep(int step, String name, String desc, Color c, IconData icon) {
  return Padding(
...
List<Widget> _akRenderModes() => [
  ...
  _akBullet('Cons', 'More expensive compositing, potential thread contention'),
  _akSubtitle('Virtual display trade-offs'),
  _akBullet('Pros', 'Simpler compositing, fewer platform thread issues'),
  _akBullet('Cons', 'Loss of some native rendering features, possible latency'),
];
...
List<Widget> _akMethods() => [
  ...
  _akBody('Key methods and properties of the AppKitViewController:'),
  _akMethodCard(
    'id',
    'int',
    'get',
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _akGestureStep(
          'Native view competes with Flutter '
          'recognizers',
          _akOrange,
        ),
        _akGestureStep(
          'Winner calls acceptGesture() or '
          'rejectGesture()',
          _akPurple,
        ),
...
List<Widget> _akComparison() => [
  ...
  Container(
    ...
    child: Column(
      children: [
        _akCompHeader(),
        _akCompEntry('macOS', 'AppKitViewController', 'NSView', _akBurgundy),
        _akCompEntry('iOS', 'UiKitViewController', 'UIView', _akBlue),
        _akCompEntry('Android', 'AndroidViewController', 'View', _akGreen),
        _akCompEntry('Windows', 'WindowsViewController', 'HWND', _akOrange),
        _akCompEntry('Linux', 'GtkViewController', 'GtkWidget', _akPurple),
        _akCompEntry('Web', 'HtmlElementController', 'HTMLElement', _akTeal),
      ],
    ),
  ),
  _akNote(
...
Widget _akCompEntry(String platform, String controller, String view, Color c) =>
    Padding(
      padding: const EdgeInsets.symmetric(vertical: 3),
      child: Row(
        children: [
...
List<Widget> _akUseCases() => [
  ...
  _akBody('Scenarios where embedding native AppKit views is valuable:'),
  _akUseCaseCard(
    Icons.text_fields,
    'Rich text editing',
    'Embed NSTextView for spell-check, dictation, and '
        'platform-native text services',
    _akBurgundy,
  ),
  _akUseCaseCard(
    Icons.map_outlined,
...
Widget _akUseCaseCard(IconData icon, String title, String desc, Color c) {
  return Container(
    width: double.infinity,
    margin: const EdgeInsets.symmetric(vertical: 4),
    padding: const EdgeInsets.all(12),
...
List<Widget> _akSummary() => [
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _akSumPt('Rendering', 'Hybrid composition or virtual display modes'),
        _akSumPt(
          'Gestures',
        ...
        _akSumPt('Common uses', 'Maps, web views, text editors, media players'),
      ],
    ),
  ),
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of AppKitViewController Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
  ...
  child: Row(
    ...
    children: [
      const Padding(
        ...
        child: Icon(Icons.check_circle, size: 14, color: _akAccent),
      ),
      Expanded(
        child: RichText(
          text: TextSpan(
