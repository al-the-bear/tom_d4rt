...
dynamic build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 12, color: pine)),
          ),
        ],
      ),
    );
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: color,
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: pine.withValues(alpha: 0.2), width: 1),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: deepForest)),
              Text(
  ...
  final menuTypes = <Map<String, String>>[
    {'platform': 'iOS', 'trigger': 'Long-press', 'style': 'UIMenu callout'},
    {
      'platform': 'Android',
      'trigger': 'Long-press',
      'style': 'ActionMode toolbar',
    },
    {
      'platform': 'macOS',
      'trigger': 'Right-click / Ctrl+click',
      'style': 'NSMenu',
    },
    {
      'platform': 'Windows',
      'trigger': 'Right-click',
      'style': 'Win32 context menu',
    },
    {
      'platform': 'Linux',
      'trigger': 'Right-click',
      'style': 'GTK/Qt popup menu',
    },
    {
      'platform': 'Web',
      'trigger': 'Right-click',
      'style': 'Browser context menu',
    },
  ];
  ...
  final eventFlow = <Map<String, String>>[
    ...
    {'step': '4', 'event': 'Hide signal sent', 'handler': 'Platform channel'},
    {
      ...
      'handler': 'SystemChannels.contextMenu',
    },
  ...
  final testScenarios = <Map<String, String>>[
    {
      ...
      'verify': 'Client is registered with controller',
    },
  ...
  final edgeCases = <Map<String, String>>[
    {
      ...
      'handling': 'handleSystemHide never called',
    },
  ...
  final practices = <Map<String, String>>[
    ...
    {
      'practice': 'Test with mocks',
      'reason': 'Platform channel not available in tests',
    },
    {'practice': 'Check platform', 'reason': 'Not all platforms support it'},
    {
      'practice': 'Group with controller',
      'reason': 'Client/controller are a pair',
    },
  ];
  ...
  final section16 = Column(
    ...
    children: [
      ...
      noteBox(
        'Comprehensive overview of the SystemContextMenuClient deep demo.',
      ),
      infoCard(
        'Demo Color Palette',
        Wrap(
