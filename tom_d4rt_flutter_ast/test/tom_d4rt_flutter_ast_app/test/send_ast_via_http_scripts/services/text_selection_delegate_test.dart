...
dynamic build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 12, color: rust)),
          ),
        ],
      ),
    );
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: deepCoral.withValues(alpha: 0.2),
                width: 1,
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: deepCoral)),
              Text(
  ...
  Widget clipboardVisual(String content, bool hasContent) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: hasContent ? coral : Colors.grey.shade300,
          width: 1.5,
        ),
      ),
      child: Row(
  ...
  final pitfalls = <Map<String, String>>[
    {
      'issue': 'Paste returns null',
      'cause': 'Clipboard empty or format mismatch',
      'fix': 'Check Clipboard.hasStrings() first',
    },
    {
      'issue': 'Toolbar not showing',
      'cause': 'No selection or focus lost',
      'fix': 'Verify textEditingValue.selection.isValid',
    },
    {
      'issue': 'Cut does nothing',
      'cause': 'readOnly is true',
      'fix': 'Check readOnly flag before action',
    },
    {
      'issue': 'Selection lost on rebuild',
      'cause': 'Controller recreated',
      'fix': 'Preserve controller across rebuilds',
    },
    {
      'issue': 'Toolbar clips offscreen',
      'cause': 'Selection near edges',
      'fix': 'Toolbar auto-repositions but check overlay',
    },
  ];
