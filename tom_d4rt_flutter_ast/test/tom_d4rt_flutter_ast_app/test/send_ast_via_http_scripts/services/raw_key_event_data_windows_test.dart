    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Center(child: Container(width: 1.5, height: 16.0, color: _kMuted)),
          const SizedBox(height: 6.0),
          Wrap(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(6.0),
              border: Border.all(color: const Color(0xFFB6D7EC), width: 1.0),
            ),
            child: const Text(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: highlight ? const Color(0xFFFFFFFF) : _kInkSoft,
            ),
          ),
        ],
      ),
      ...
      child: Column(
        children: const <Widget>[
          ...
          _VkRow(
            ...
            hex: '0x10',
            dec: '16',
            desc: 'Either Shift key',
          ),
          _VkRow(
            name: 'VK_CONTROL',
            hex: '0x11',
            dec: '17',
            desc: 'Either Control key',
          ),
          _VkRow(
            name: 'VK_MENU',
            hex: '0x12',
          ...
          _VkRow(
            ...
            hex: '0x5B',
            dec: '91',
            desc: 'Left Windows logo',
          ),
          _VkRow(
            name: 'VK_RWIN',
            hex: '0x5C',
            dec: '92',
            desc: 'Right Windows logo',
          ),
          ...
          _VkRow(
            ...
            hex: '0x70',
            dec: '112',
            desc: 'Function key F1',
          ),
          _VkRow(
            name: 'VK_F2',
            hex: '0x71',
            dec: '113',
            desc: 'Function key F2',
          ),
          _VkRow(
            name: 'VK_F5',
            hex: '0x74',
            dec: '116',
            desc: 'Function key F5',
          ),
          _VkRow(
            name: 'VK_F11',
            hex: '0x7A',
            dec: '122',
            desc: 'Function key F11',
          ),
          _VkRow(
            name: 'VK_F12',
            hex: '0x7B',
            dec: '123',
            desc: 'Function key F12',
          ),
...
class _VkRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        border: Border(bottom: BorderSide(color: _kStripe, width: 1.0)),
      ),
      child: Row(
        children: <Widget>[
          SizedBox(
          ...
          Expanded(
            child: Text(
              desc,
              style: const TextStyle(fontSize: 12.0, color: _kInkSoft),
            ),
          ),
        ],
      ),
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                Text(
                  '· $subtitle',
                  style: const TextStyle(fontSize: 11.0, color: _kMuted),
                ),
              ],
            ),
            const SizedBox(height: 10.0),
        ...
        children: <Widget>[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(6.0),
              border: Border.all(color: const Color(0xFFFFB900), width: 1.0),
            ),
            child: const Text(
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  label,
                  style: const TextStyle(fontSize: 11.0, color: _kInkSoft),
                ),
              ],
            ),
          ),
          const SizedBox(width: 8.0),
          Container(width: 28.0, height: 1.0, color: _kMuted),
          const SizedBox(width: 8.0),
          Container(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12.0),
        border: Border.all(color: const Color(0xFF1B1B1F), width: 1.0),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(4.0),
        border: Border.all(color: const Color(0xFF1B1B1F), width: 0.5),
      ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF1B1B1F),
        borderRadius: BorderRadius.circular(10.0),
        border: Border.all(color: const Color(0xFF0F0F12), width: 1.0),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          ...
          child: Column(
            children: const <Widget>[
              ...
              _SectionHeader(
                number: '11',
                title: 'Use cases',
                subtitle: 'Where Windows-specific key data still matters today',
              ),
              SizedBox(height: 10.0),
              _UseCases(),
              SizedBox(height: 22.0),
