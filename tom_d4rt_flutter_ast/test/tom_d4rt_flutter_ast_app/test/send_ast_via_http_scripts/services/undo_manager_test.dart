        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: midnight.withValues(alpha: 0.15),
                width: 1,
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: midnight)),
              Text(
    ...
    children: [
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            routingArrow(
              'Platform (3-finger swipe)',
              'flutter/undomanager channel',
              sapphire,
            ),
            routingArrow(
              'Channel handler',
              'UndoManager.handlePlatformUndo()',
              cobalt,
            ),
            routingArrow(
              'UndoManager',
              'client.handlePlatformUndo(undo)',
              navy,
            ),
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            ...
            routingArrow(
              'Platform updates',
              'System undo UI enabled/disabled',
              royal,
            ),
          ],
        ),
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            ...
            dataRow(
              'Payload',
              '{"direction": "undo"} or {"direction": "redo"}',
            ),
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            ...
            routingArrow(
              'EditableTextState',
              'setUndoState(canUndo: true)',
              royal,
            ),
            routingArrow(
              'User 3-finger swipes',
              'Platform sends undo',
              sapphire,
            ),
            routingArrow(
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '"John Doe" — 3 undo steps available',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Email Field (not focused)',
                    style: TextStyle(fontSize: 12, color: deepSapphire),
                  ),
                  Text(
                    '"john@example.com" — undo preserved but inactive',
                    style: TextStyle(fontSize: 11, color: deepSapphire),
                  ),
                ],
              ),
