...
TextStyle rweHeading({Color color = rweInk, double size = 16}) =>
    TextStyle(color: color, fontSize: size, fontWeight: FontWeight.w700);

TextStyle rweLabel({Color color = rweCharcoal, double size = 12}) =>
  ...
  return Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        Expanded(child: Text(value, style: rweMono())),
      ],
    ),
  );
}
    ...
    children: [
      ...
      Container(
        ...
        child: Row(
          children: [
            ...
            Text(
              '•',
              style: rweMono(color: rweMist.withValues(alpha: 0.6), size: 14),
            ),
            const SizedBox(width: 6),
            Text(
              'keydown / keyup / keypress',
              style: rweMono(color: rweMist.withValues(alpha: 0.85), size: 10),
            ),
          ],
        ),
      ),
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              '> document.addEventListener("keydown", e => print(e))',
            ...
            Text('  }', style: rweMono(color: rweAmberSoft, size: 11)),
          ],
        ),
      ),
    ],
      ...
      children: [
        Row(
          children: [
            ...
            Text(
              '@Deprecated · v3.18',
              style: rweMono(color: rweAmberSoft, size: 10.5),
            ),
          ],
        ),
      ...
      children: [
        Row(
          children: [
            ...
            const Spacer(),
            Text('e.g. $example', style: rweMono(color: rweAmber, size: 11)),
          ],
        ),
        const SizedBox(height: 4),
...
Widget rweCodeKeyCell(
  String text, {
  Color color = rwePaper,
  Color textColor = rweCharcoal,
  bool mono = true,
}) {
  return Container(
...
Widget rweLocationKey(String label, int loc, Color color) {
  return Expanded(
    child: Container(
      ...
      child: Column(
        children: [
          Text(label, style: rweMonoBold(color: color, size: 12)),
          ...
          children: [
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Text('Space', style: rweMonoBold(color: rweInk, size: 12)),
                    const SizedBox(height: 2),
                    Text(
                      'loc=0',
                      style: TextStyle(
      ...
      child: Column(
        children: [
          ...
          Text(
            'bit $idx',
            style: TextStyle(
              color: set ? rweWhite.withValues(alpha: 0.85) : rweAsh,
              fontSize: 8,
              fontWeight: FontWeight.w500,
            ),
          ),
    ...
    child: Column(
      ...
      children: [
        Row(
          children: [
            Text(
              'metaState = 0x${value.toRadixString(16).padLeft(2, '0')}'
              ' (decimal $value)',
              style: rweMonoBold(),
            ),
            const Spacer(),
            Text(
              'binary 0b${value.toRadixString(2).padLeft(8, '0')}',
  ...
  return rweCard(
    ...
    Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Ctrl + Alt (browser sometimes treats as AltGr):',
          style: rweLabel(),
        ),
        const SizedBox(height: 4),
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text('— end of report —', style: rweMono(color: rweCyanSoft, size: 11)),
      ],
    ),
  );
}
...
void rwePrintConsoleReport() {
  ...
  print('Five fields:');
  print(
    '  • code      String   "KeyboardEvent.code"      physical, layout-stable',
  );
  print(
    '  • key       String   "KeyboardEvent.key"       logical, layout-aware',
  );
  print(
    '  • location  int      0..3                      STANDARD/LEFT/RIGHT/NUMPAD',
  );
  print(
    '  • metaState int      bitmask                   shift/ctrl/alt/meta/...',
  );
  ...
  for (final _RawKeyEventDataWeb ev in [
    ...
    print(
      '     → isShiftPressed = ${ev.isShiftPressed}, '
  ...
  print(
    '  1 → LEFT     (left modifier — ShiftLeft, ControlLeft, AltLeft, MetaLeft)',
  );
  print(
    '  2 → RIGHT    (right modifier — ShiftRight, ControlRight, AltRight, MetaRight)',
  );
  print(
    '  3 → NUMPAD   (Numpad0..9, NumpadEnter, NumpadAdd, NumpadDecimal, …)',
  );
  print('');
