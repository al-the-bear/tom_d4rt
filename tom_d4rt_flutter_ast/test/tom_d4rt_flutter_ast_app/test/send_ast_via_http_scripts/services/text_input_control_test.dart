...
dynamic build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 12, color: bronze)),
          ),
        ],
      ),
    );
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: deepAmber.withValues(alpha: 0.2),
                width: 1,
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: deepAmber)),
              Text(
  ...
  final apiMethods = <Map<String, String>>[
    {
      'method': 'show()',
      'purpose': 'Called when keyboard should appear',
      'response': 'Display your custom input',
    },
    {
      'method': 'hide()',
      'purpose': 'Called when keyboard should dismiss',
      'response': 'Hide your custom input',
    },
    {
      'method': 'setEditingState()',
      'purpose': 'Current text state from client',
      'response': 'Sync your input UI state',
    },
    {
      'method': 'setClient()',
      'purpose': 'Client connection established',
      'response': 'Store client reference',
    },
    {
      'method': 'setCaretRect()',
      'purpose': 'Cursor position reported',
      'response': 'Position input near cursor',
    },
    {
      'method': 'setComposingRect()',
      'purpose': 'Composing area reported',
      'response': 'Position IME overlay',
    },
    {
      'method': 'setStyle()',
      'purpose': 'Text style information',
      'response': 'Match font in your input',
    },
  ];
