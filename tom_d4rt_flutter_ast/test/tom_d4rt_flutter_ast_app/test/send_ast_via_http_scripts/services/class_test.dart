  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _clCopper, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _clBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Runtime class identity and type introspection in Dart',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
...
List<Widget> _clTypeCheck() => [
  ...
  _clBody('Dart provides two operators for runtime type checking:'),
  Container(
    width: double.infinity,
    padding: const EdgeInsets.all(12),
    margin: const EdgeInsets.symmetric(vertical: 8),
...
Widget _clOpCard(String op, String name, String desc, Color c) => Container(
  padding: const EdgeInsets.all(10),
  decoration: BoxDecoration(
    color: Colors.white,
    borderRadius: BorderRadius.circular(8),
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _clGenRow('Map<String, int>', 'Map<String, int>', true, _clGreen),
...
Widget _clGenRow(String typeA, String typeB, bool match, Color c) => Padding(
  padding: const EdgeInsets.symmetric(vertical: 3),
  child: Row(
    children: [
      Container(
      ...
      const Spacer(),
      Icon(match ? Icons.check : Icons.close, size: 14, color: c),
    ],
  ),
);
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _clHierNode(1, 'DiagnosticableTree', 'Debug printing', _clBlue),
        _clHierNode(2, 'Widget', 'Immutable UI description', _clGreen),
        _clHierNode(3, 'StatelessWidget', 'No mutable state', _clPurple),
...
Widget _clHierNode(int depth, String name, String desc, Color c) => Padding(
...
List<Widget> _clServiceKey() => [
  ...
  Container(
    ...
    child: Column(
      children: [
        _clUsageRow('Theme.of(context)', 'Type lookup on ThemeData', _clCopper),
        _clUsageRow(
          'MediaQuery.of(context)',
          'Type lookup on MediaQueryData',
          _clBlue,
        ),
        _clUsageRow(
          'Provider.of<T>(context)',
          'Generic type as registry key',
          _clGreen,
        ),
        _clUsageRow(
          'GetIt.I.get<T>()',
          'Service locator using Type',
          _clPurple,
        ),
      ],
    ),
    ...
    child: Column(
      ...
      children: [
        ...
        _clRelRow(
          'implements',
          'Interface',
          'Multiple allowed, must override all',
          _clBlue,
        ),
        _clRelRow(
          'with',
          'Mixin',
          'Multiple allowed, provides implementations',
          _clGreen,
        ),
        _clRelRow(
          'on',
          'Mixin constraint',
          'Restricts which classes can apply mixin',
          _clPurple,
        ),
      ],
    ),
...
Widget _clRelRow(String keyword, String kind, String desc, Color c) => Padding(
  padding: const EdgeInsets.symmetric(vertical: 4),
  child: Row(
    children: [
      Container(
...
List<Widget> _clSummary() => [
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _clSumPt('is / is!', 'Check class membership across the hierarchy'),
        _clSumPt(
          'Reified generics',
        ...
        _clSumPt('Service keys', 'Type objects serve as keys in registries'),
        _clSumPt('Diagnostics', 'runtimeType powers Flutter error messages'),
      ],
    ),
  ),
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of Class & Type System Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
