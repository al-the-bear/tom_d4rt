  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _gkNavy, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _gkBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'GTK key event translation for Flutter on Linux',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
...
Widget _gkPipeArrow() => const Padding(
  ...
  child: Center(
    child: Icon(Icons.keyboard_arrow_down, size: 18, color: Colors.black26),
  ),
);
...
List<Widget> _gkKeysym() => [
  ...
  Container(
    ...
    child: Column(
      children: [
        _gkMapHeader(),
        _gkMapRow('GDK_KEY_a', '0x0061', 'LogicalKeyboardKey.keyA', _gkNavy),
        _gkMapRow(
          'GDK_KEY_Return',
          '0xFF0D',
        ...
        _gkMapRow('GDK_KEY_Tab', '0xFF09', 'LogicalKeyboardKey.tab', _gkOrange),
        _gkMapRow(
          'GDK_KEY_BackSpace',
          '0xFF08',
        ...
        _gkMapRow('GDK_KEY_F1', '0xFFBE', 'LogicalKeyboardKey.f1', _gkTeal),
        _gkMapRow(
          'GDK_KEY_Control_L',
          '0xFFE3',
...
Widget _gkMapRow(String keysym, String hex, String flutter, Color c) => Padding(
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _gkPhysRow(38, 'A position', 'PhysicalKeyboardKey.keyA', _gkNavy),
        _gkPhysRow(36, 'Enter', 'PhysicalKeyboardKey.enter', _gkAccent),
        _gkPhysRow(9, 'Escape', 'PhysicalKeyboardKey.escape', _gkGreen),
        _gkPhysRow(23, 'Tab', 'PhysicalKeyboardKey.tab', _gkOrange),
        _gkPhysRow(65, 'Spacebar', 'PhysicalKeyboardKey.space', _gkPurple),
      ],
    ),
  ),
  _gkNote(
...
Widget _gkPhysRow(int code, String desc, String physKey, Color c) => Padding(
  padding: const EdgeInsets.symmetric(vertical: 3),
  child: Row(
    children: [
      Container(
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        _gkModRow('GDK_MOD1_MASK', '1 << 3', 'Alt', _gkGreen, Icons.alt_route),
        _gkModRow(
          'GDK_SUPER_MASK',
          '1 << 26',
          'Super',
...
List<Widget> _gkComparison() => [
  ...
  _gkBody('Each desktop platform has its own key helper in Flutter:'),
  Container(
    width: double.infinity,
    padding: const EdgeInsets.all(12),
    margin: const EdgeInsets.symmetric(vertical: 8),
    ...
    child: Column(
      children: [
        _gkCompRow(
          'Linux (GTK)',
          'GtkKeyHelper',
          'GDK keysyms + hardware keycodes',
          _gkNavy,
        ),
        _gkCompRow(
          'Linux (GLFW)',
          'GLFWKeyHelper',
          'GLFW key tokens (alternative)',
          _gkAccent,
        ),
        _gkCompRow(
          'macOS',
          'KeyCodeToLogical',
          'macOS key codes + Carbon events',
          _gkGreen,
        ),
        _gkCompRow(
          'Windows',
        ...
        _gkCompRow('iOS', 'IOSKeyHelper', 'UIKey + HIDUsage codes', _gkTeal),
        _gkCompRow(
          'Web',
          'WebKeyHelper',
          'DOM KeyboardEvent.code + key',
          _gkRed,
        ),
      ],
    ),
...
Widget _gkLayoutCard(String name, List<_GkKeyPair> rows, Color c) {
  return Container(
...
List<Widget> _gkDeadKeys() => [
    ...
    child: Column(
      ...
      children: [
        ...
        _gkDeadStep(
          1,
          'Press dead acute (\')',
          'No character emitted yet',
          _gkNavy,
        ),
        _gkDeadStep(
          2,
          'Press "e"',
          'Combines: dead acute + e = e with acute',
          _gkAccent,
        ),
        _gkDeadStep(
          3,
          'Character generated',
          'Flutter receives "e with acute" as text input',
          _gkGreen,
        ),
      ],
    ),
  ...
  Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _gkComposeRow('Compose + o + c', '\u00A9', 'Copyright symbol', _gkNavy),
        _gkComposeRow('Compose + - + >', '\u2192', 'Right arrow', _gkAccent),
        _gkComposeRow(
          "Compose + ' + e",
          '\u00E9',
          'e with acute accent',
        ...
        _gkComposeRow('Compose + s + s', '\u00DF', 'German eszett', _gkOrange),
      ],
    ),
  ),
];

Widget _gkDeadStep(int step, String key, String result, Color c) => Padding(
  padding: const EdgeInsets.symmetric(vertical: 3),
  child: Row(
    children: [
      Container(
...
Widget _gkComposeRow(String seq, String result, String desc, Color c) =>
    Padding(
      padding: const EdgeInsets.symmetric(vertical: 3),
      child: Row(
        children: [
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _gkSumPt('Keysym mapping', 'GDK keysyms to LogicalKeyboardKey'),
        _gkSumPt('Hardware mapping', 'Scancodes to PhysicalKeyboardKey'),
        _gkSumPt('Modifier decoding', 'GDK state bitmask to modifier flags'),
        _gkSumPt(
          'Layout aware',
          'Correct logical keys across QWERTY/AZERTY/etc',
        ),
        _gkSumPt('Dead keys', 'Handles compose sequences for accented input'),
        _gkSumPt('Cross-platform', 'Output matches other platform key helpers'),
      ],
    ),
  ),
