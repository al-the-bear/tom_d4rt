...
dynamic build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 12, color: plum)),
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: deepIndigo)),
              Text(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(description, style: TextStyle(fontSize: 11, color: plum)),
            ],
          ),
        ],
      ),
  ...
  final staticMethods = <Map<String, String>>[
    {
      'method': 'attach()',
      'signature': 'TextInputConnection attach(client, config)',
      'purpose': 'Create a new text input connection',
    },
    {
      'method': 'setInputControl()',
      'signature': 'void setInputControl(TextInputControl?)',
      'purpose': 'Replace platform input with custom',
    },
    {
      'method': 'restorePlatformInputControl()',
      'signature': 'void restorePlatformInputControl()',
      'purpose': 'Revert to default platform input',
    },
    {
      'method': 'finishAutofillContext()',
      'signature': 'void finishAutofillContext({shouldSave})',
      'purpose': 'Complete or cancel autofill session',
    },
    {
      'method': 'setChannel()',
      'signature': 'void setChannel(MethodChannel)',
      'purpose': 'Override the platform channel (testing)',
    },
    {
      'method': 'ensureInitialized()',
      'signature': 'void ensureInitialized()',
      'purpose': 'Initialize text input subsystem',
    },
  ];
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            flowStep(
              '1. Client requests',
              'TextInput.attach(client, config)',
              Icons.input,
              indigo,
            ),
            flowStep(
            ...
            flowStep(
              '3. Create connection',
              'New TextInputConnection made',
              Icons.link,
              iris,
            ),
            flowStep(
              '4. Configure platform',
              'Send config via channel',
              Icons.settings,
              amethyst,
            ),
            flowStep(
              '5. Return connection',
              'Client uses it to communicate',
              Icons.check,
              periwinkle,
            ),
          ],
  ...
  final channelMethods = <Map<String, String>>[
    {
      'name': 'TextInput.setClient',
      'dir': '→ Platform',
      'data': 'Client ID + config JSON',
    },
    {'name': 'TextInput.show', 'dir': '→ Platform', 'data': '(empty)'},
    {
      'name': 'TextInput.setEditingState',
      'dir': '→ Platform',
    ...
    {
      'name': 'TextInputClient.updateEditingState',
      'dir': '← Platform',
      'data': 'TextEditingValue',
    },
    {
      'name': 'TextInputClient.performAction',
      'dir': '← Platform',
      'data': 'Action string',
    },
    {
      'name': 'TextInputClient.updateEditingStateWithDeltas',
      'dir': '← Platform',
      'data': 'Delta list',
    },
  ];
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            ...
            flowStep(
              '2. Fields connected',
              'Each has autofillHints',
              Icons.link,
              violet,
            ),
            flowStep(
              '3. User submits',
              'App processes credentials',
              Icons.send,
              iris,
            ),
            flowStep(
              '4. Finish context',
              'finishAutofillContext(save: true)',
              Icons.save,
              amethyst,
            ),
            flowStep(
  ...
  final platforms = <Map<String, String>>[
    {
      'platform': 'Android',
      'keyboard': 'System soft keyboard',
      'ime': 'Full IME support',
      'special': 'Content commitment API',
    },
    {
      'platform': 'iOS',
      'keyboard': 'System soft keyboard',
      'ime': 'Full IME support',
      'special': 'Scribble + Floating cursor',
    },
    {
      'platform': 'Web',
      'keyboard': 'Browser input element',
      'ime': 'Browser-dependent',
      'special': 'Hidden input strategy',
    },
    {
      'platform': 'macOS',
      'keyboard': 'Physical + IME',
      'ime': 'Native IME',
      'special': 'Selector-based actions',
    },
    {
      'platform': 'Linux',
      'keyboard': 'Physical + IBus/Fcitx',
      'ime': 'Through GTK/IBus',
      'special': 'IME framework dependent',
    },
    {
      'platform': 'Windows',
      'keyboard': 'Physical + IME',
      'ime': 'Windows IME',
      'special': 'Touch keyboard support',
    },
  ];
