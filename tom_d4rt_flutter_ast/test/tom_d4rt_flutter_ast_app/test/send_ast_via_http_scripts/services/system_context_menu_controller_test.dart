...
dynamic build(BuildContext context) {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: deepGarnet)),
              Text(
  ...
  final lifecycle = <Map<String, String>>[
    ...
    {
      'phase': 'Requesting',
      'state': 'Platform notified',
      'action': 'Channel message sent',
    },
    {'phase': 'Showing', 'state': 'Menu visible', 'action': 'isShowing = true'},
    {
      'phase': 'User interaction',
      'state': 'Item selected or dismissed',
      'action': 'Platform decides',
    },
    {
      'phase': 'Hiding',
      'state': 'Menu closing',
      'action': 'Platform sends hide',
    },
    {'phase': 'Hidden', 'state': 'Menu gone', 'action': 'Clients notified'},
    {
      'phase': 'Disposed',
      'state': 'Controller cleaned up',
      'action': 'No further events',
    },
  ];
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            ...
            dataRow(
              'Error isolation',
              'One client error doesn\'t block others',
            ),
  ...
  final practices = <Map<String, String>>[
    {
      'practice': 'Check isSupported first',
      'reason': 'Avoid no-op on unsupported platforms',
    },
    ...
    {
      'practice': 'Provide Flutter fallback',
      'reason': 'Works on all platforms',
    },
    {
      'practice': 'Test channel messages',
      'reason': 'Verify correct platform API usage',
    },
  ];
  ...
  final section16 = Column(
    ...
    children: [
      ...
      noteBox(
        'Comprehensive overview of the SystemContextMenuController deep demo.',
      ),
      infoCard(
        'Demo Color Palette',
        Wrap(
