...
dynamic build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 12, color: obsidian)),
          ),
        ],
      ),
    );
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: obsidian.withValues(alpha: 0.2),
                width: 1,
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: deepSlate)),
              Text(
  ...
  final callbacks = <Map<String, String>>[
    {
      'method': 'updateEditingValue',
      'purpose': 'Receive new text state from platform',
    },
    {
      'method': 'performAction',
      'purpose': 'Handle keyboard action (done, go, etc.)',
    },
    {
      'method': 'updateFloatingCursor',
      'purpose': 'Track floating cursor on iOS',
    },
    {
      'method': 'showAutocorrectionPromptRect',
      'purpose': 'Show autocorrection UI',
    },
    {
      'method': 'connectionClosed',
      'purpose': 'Platform closed the input connection',
    },
    {'method': 'performSelector', 'purpose': 'Handle macOS selector actions'},
    {
      'method': 'insertContent',
      'purpose': 'Receive rich content (images, etc.)',
    },
  ...
  final imeExamples = <Map<String, String>>[
    {
      'language': 'Japanese',
      'engine': 'Kana/Romaji → Kanji',
      'style': 'Multi-step composition',
    },
    {
      'language': 'Chinese',
      'engine': 'Pinyin → Hanzi',
      'style': 'Candidate selection',
    },
    {
      'language': 'Korean',
      'engine': 'Jamo → Hangul',
      'style': 'Block composition',
    },
    {
      'language': 'Hindi',
      'engine': 'Transliteration',
      'style': 'Script mapping',
    },
    {
      'language': 'Thai',
      'engine': 'Tone marks',
      'style': 'Combining characters',
    },
  ];
  ...
  final inputActions = <Map<String, String>>[
    {
      ...
      'keyboard': 'Done / Return',
      'behavior': 'Submit and close',
    },
    {
      'action': 'TextInputAction.go',
      'keyboard': 'Go',
      'behavior': 'Navigate to URL',
    },
    {
    ...
    },
    {
      ...
      'keyboard': 'Search',
      'behavior': 'Execute search',
    },
    {
      'action': 'TextInputAction.next',
      'keyboard': 'Next',
      'behavior': 'Move to next field',
    },
    {
  ...
  final testStrategies = <Map<String, String>>[
    {
      'strategy': 'enterText()',
      'description': 'Simulates typing text in widget tests',
    },
    {
      'strategy': 'testTextInput',
      'description': 'Mock text input for unit tests',
    },
    {
      'strategy': 'showKeyboard()',
      'description': 'Simulates keyboard appearance',
    },
    {
      'strategy': 'FakeTextInputConnection',
      'description': 'Custom mock connection',
    },
    {
      'strategy': 'Integration test',
      'description': 'Real platform keyboard input',
    },
  ];
