  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _cbForest, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _cbBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'In-memory caching layer for asset loading',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
...
List<Widget> _cbHierarchy() => [
  ...
  Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _cbHierNode(0, 'AssetBundle', 'Abstract base', _cbForest),
        _cbHierNode(
          1,
          'CachingAssetBundle',
...
Widget _cbHierNode(int depth, String name, String desc, Color c) => Padding(
  ...
  Container(
    ...
    child: Column(
      children: [
        _cbFlowStep(
          1,
          'loadString(key) called',
          'Check _stringCache[key]',
          _cbForest,
          Icons.search,
        ),
        _cbFlowStep(
          2,
          'Cache miss',
          'Call super.load(key) for ByteData',
          _cbBlue,
          Icons.download,
        ),
        _cbFlowStep(
          3,
          'Decode bytes',
          'UTF-8 decode ByteData to String',
          _cbAccent,
          Icons.text_snippet,
        ),
        _cbFlowStep(
          4,
          'Store in cache',
          '_stringCache[key] = Future.value(string)',
          _cbOrange,
          Icons.save,
        ),
        _cbFlowStep(
...
Widget _cbFlowStep(int step, String name, String desc, Color c, IconData icon) {
  return Padding(
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _cbTimeEvent('App start', 'Bundle created, caches empty', _cbForest),
        _cbTimeEvent('First load', 'Asset fetched from disk, cached', _cbBlue),
        _cbTimeEvent('Second load', 'Returned from cache (no I/O)', _cbAccent),
        _cbTimeEvent(
          'evict(key)',
          'Single entry removed from cache',
          _cbOrange,
        ),
        _cbTimeEvent('clear()', 'Both caches fully emptied', _cbRed),
        _cbTimeEvent(
          'Hot reload',
          'Framework calls evict() for changed assets',
          _cbPurple,
        ),
      ],
    ),
...
List<Widget> _cbMethods() => [
  ...
  _cbBody('Key methods provided or overridden by CachingAssetBundle:'),
  _cbMethodCard(
    'loadString(key, {cache})',
    'Future<String>',
    ...
    child: Column(
      children: [
        _cbAssetRow(
          Icons.description,
          'JSON',
          'Configuration, translations, API schemas',
          _cbForest,
        ),
        _cbAssetRow(
          Icons.image,
          'Images',
          'Via load() for raw bytes — not string-cached',
          _cbBlue,
        ),
        _cbAssetRow(
          Icons.font_download,
          'Fonts',
          'Font files loaded via loadBuffer()',
          _cbAccent,
        ),
        _cbAssetRow(
          Icons.code,
          'YAML / TOML',
          'Structured config via loadStructuredData()',
          _cbOrange,
        ),
        _cbAssetRow(
          Icons.text_snippet,
          'Text / Markdown',
          'Help text, licenses, documentation',
          _cbPurple,
        ),
        _cbAssetRow(
          Icons.auto_graph,
          'Shader programs',
          'FragmentProgram loads via loadBuffer()',
          _cbTeal,
        ),
      ],
    ),
...
Widget _cbAssetRow(IconData icon, String type, String desc, Color c) => Padding(
  padding: const EdgeInsets.symmetric(vertical: 4),
  child: Row(
    children: [
      Container(
...
Widget _cbBundleCard(String name, String desc, String detail, Color c) =>
    Container(
      padding: const EdgeInsets.all(10),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            detail,
            style: TextStyle(fontSize: 10, color: c.withValues(alpha: 0.8)),
          ),
        ],
      ),
    );
...
List<Widget> _cbComparison() => [
  ...
  _cbBullet('Testing', 'DefaultAssetBundle widget allows bundle injection'),
];
...
List<Widget> _cbSummary() => [
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _cbSumPt('Two caches', 'Separate string and structured-data caches'),
        _cbSumPt(
          'putIfAbsent',
        ...
        _cbSumPt('Hot reload aware', 'Framework auto-evicts changed resources'),
        _cbSumPt(
          'Abstract class',
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of CachingAssetBundle Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
