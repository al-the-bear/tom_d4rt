...
dynamic build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isTarget
            ? [
                BoxShadow(
                  color: _ecPrimary.withValues(alpha: 0.15),
                  blurRadius: 6.0,
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: isTarget ? _ecAccent : _ecMuted,
            size: 18.0,
          ),
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: isTarget ? _ecPrimary : _ecDark,
                  ),
                ),
                Text(
                  c['note']!,
  ...
  Widget ecFrameCard(Map<String, dynamic> f) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isCollapsed
              ? _ecMuted.withValues(alpha: 0.3)
              : _ecAccent.withValues(alpha: 0.4),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  final backwardFrames = <Map<String, dynamic>>[
    {'base': 5, 'extent': 9, 'label': 'Starting selection: base=5 extent=9'},
    {
      'base': 5,
      'extent': 8,
      'label': 'After Shift+Left (1x) — selection shrinks',
    },
    ...
    {'base': 5, 'extent': 6, 'label': 'After Shift+Left (3x)'},
    {
      'base': 5,
      'extent': 5,
      'label': 'After Shift+Left (4x) — collapsed again',
    },
  ];
  ...
  final graphemes = <Map<String, String>>[
    {
      'text': 'a',
      'clusters': '1 cluster → 1 code unit',
      'note': 'ASCII — trivial case',
    },
    {
      'text': 'ñ',
      'clusters': '1 cluster → 1 code unit (U+00F1)',
      'note': 'Precomposed Unicode',
    },
    {
      'text': 'n\u0303',
      'clusters': '1 cluster → 2 code units',
      'note': 'Decomposed n + combining tilde',
    },
    {
      'text': '👨‍👩‍👧',
      'clusters': '1 cluster → 8 code units',
      'note': 'Emoji ZWJ family sequence',
    },
    {
      'text': '🇫🇷',
      'clusters': '1 cluster → 4 code units',
      'note': 'Regional indicator pair (flag)',
    },
    {
      'text': '🏳️‍🌈',
      'clusters': '1 cluster → 6 code units',
      'note': 'Flag + ZWJ + rainbow',
    },
  ];
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: _ecPrimary.withValues(alpha: 0.06),
            borderRadius: BorderRadius.circular(6.0),
          ),
          child: Row(
            children: [
  ...
  final pipeSteps = <Map<String, String>>[
    {
      'step': '1',
      'title': 'KeyEvent received',
      'detail': 'RawKeyboard or HardwareKeyboard sees Shift+Right arrow.',
    },
    {
      'step': '2',
      'title': 'ShortcutActivator match',
      'detail':
          'LogicalKeySet(LogicalKeyboardKey.shift, LogicalKeyboardKey.arrowRight) fires.',
    },
    {
      'step': '3',
      'title': 'Intent created',
      'detail':
          'Shortcuts widget creates ExtendSelectionByCharacterIntent(forward: true).',
    },
    {
      'step': '4',
      'title': 'Action resolved',
      'detail':
          'Actions widget finds the CallbackAction registered in EditableTextState.',
    },
    {
      'step': '5',
      'title': 'Grapheme boundary lookup',
      'detail':
          'TextEditingValue delegates to Characters to find the next cluster boundary.',
    },
    {
      'step': '6',
      'title': 'Selection mutated',
      'detail':
          'TextEditingController.selection extent is incremented by one cluster.',
    },
    {
      'step': '7',
      'title': 'Caret repaint',
      'detail': 'RenderEditable repaints with the updated selection highlight.',
    },
  ];
          ...
          children: [
            ...
            if (!isLast)
              Container(
                width: 2.0,
                height: 30.0,
                color: _ecMuted.withValues(alpha: 0.3),
              ),
          ],
        ),
  ...
  final pipeSection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10.0),
        for (int i = 0; i < pipeSteps.length; i++)
          ecPipeStep(pipeSteps[i], i == pipeSteps.length - 1),
      ],
    ),
  );
  ...
  final relatives = <Map<String, String>>[
    ...
    },
    {
      ...
      'granularity': '1 word',
      'typical': 'Ctrl+Shift+Arrow',
    },
    {
      'intent': 'ExpandSelectionToLineBreakIntent',
      'granularity': 'To line end/start',
      'typical': 'Shift+Home/End',
    },
    {
      'intent': 'ExpandSelectionToDocumentBoundaryIntent',
      'granularity': 'To document end/start',
      'typical': 'Ctrl+Shift+Home/End',
    },
    {
      'intent': 'ExtendSelectionByPageIntent',
      'granularity': '1 page',
      'typical': 'Shift+PageUp/Down',
    },
  ];
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isHighlighted
            ...
            : idx.isEven
            ? _ecLight.withValues(alpha: 0.4)
            : Colors.white,
        borderRadius: BorderRadius.circular(6.0),
        border: isHighlighted
            ? Border.all(color: _ecAccent.withValues(alpha: 0.4))
            : null,
      ),
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Text(
              r['granularity']!,
              style: TextStyle(fontSize: 11.0, color: _ecAccent),
            ),
          ),
          Expanded(
            flex: 2,
  ...
  final relSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Selection-extension intent family',
          style: TextStyle(
            fontSize: 15.0,
            fontWeight: FontWeight.w700,
            color: _ecDark,
  ...
  final customPatterns = <Map<String, dynamic>>[
    {
      ...
      'desc':
          'Override so that Shift+Arrow skips over whitespace characters automatically, selecting non-space content.',
      'code':
    ...
    },
    {
      ...
      'icon': Icons.code,
      'desc':
          'In a code editor, extend to the nearest token boundary instead of one raw character.',
      'code':
          'CallbackAction<ExtendSelectionByCharacterIntent>(\n'
          '  onInvoke: (intent) {\n'
    ...
    },
    {
      ...
      'desc':
          'Play a click sound when moving by character — useful for accessibility.',
      'code':
          'CallbackAction<ExtendSelectionByCharacterIntent>(\n'
          '  onInvoke: (intent) {\n'
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            padding: const EdgeInsets.all(12.0),
            decoration: BoxDecoration(
              color: _ecDark.withValues(alpha: 0.05),
              borderRadius: BorderRadius.circular(8.0),
            ),
            child: Text(
              p['code'] as String,
  ...
  final edgeCases = <Map<String, String>>[
    {
      'case': 'At document start, forward=false',
      'result': 'No change — offset 0 cannot go lower.',
    },
    {
      'case': 'At document end, forward=true',
      'result': 'No change — already at max offset.',
    },
    {
      'case': 'Emoji at caret',
      'result': 'Skips all code units of the emoji in one step.',
    },
    {
      'case': 'Combining diacritical mark',
      'result': 'Treated as single cluster with its base character.',
    },
    {
      'case': 'Surrogate pair (e.g. 𝑎)',
      'result': 'Both code units consumed as one character.',
    },
    {
      'case': 'Empty text field',
      'result': 'Intent dispatched but no movement — offset stays 0.',
    },
    {
      'case': 'RTL text',
      'result': 'forward=true still means higher offset (logical right).',
    },
    {
      'case': 'Selection crosses line boundary',
      'result':
          'Extent wraps to the next visual line — no special handling needed.',
    },
  ];
  ...
  final perfSection = Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [
          _ecAccent.withValues(alpha: 0.07),
          _ecLight.withValues(alpha: 0.4),
        ],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
  ...
  final summarySection = Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [
          _ecPrimary.withValues(alpha: 0.08),
          _ecLight.withValues(alpha: 0.5),
        ],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
