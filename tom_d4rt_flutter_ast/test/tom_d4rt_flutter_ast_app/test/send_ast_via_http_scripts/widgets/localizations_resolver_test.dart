...
dynamic build(BuildContext context) {
  ...
  Widget noteBox(String text, Color border, Color bg) {
    return Container(
      ...
      child: Text(text, style: TextStyle(fontSize: 13, color: deepVermilion)),
    );
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(desc, style: TextStyle(fontSize: 12, color: cinnabar)),
              ],
            ),
          ),
        ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(detail, style: TextStyle(fontSize: 11, color: cinnabar)),
              ],
            ),
          ),
        ],
  ...
  print(
    'Signature: Future<T> Function(Locale locale, Iterable<Locale> supportedLocales)',
  );
  ...
  print(
    'MaterialLocalizations available: ${Localizations.of<MaterialLocalizations>(context, MaterialLocalizations) != null}',
  );
  print(
    'WidgetsLocalizations available: ${Localizations.of<WidgetsLocalizations>(context, WidgetsLocalizations) != null}',
  );
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Callback typedef for resolving localized resources',
                style: TextStyle(
        ...
        // ── 2. What is it ────────────────────────────────────────────
        sectionBanner(
          '1 \u00b7 What Is LocalizationsResolver',
        ...
        dataRow(
          'Full signature',
          'Future<T> Function(Locale, Iterable<Locale>)',
          burntOrange,
        ),
        dataRow(
          'Returns',
          'Future<T> — the localized resource object',
          mandarin,
        ),
        ...
        sectionBanner(
          '2 \u00b7 Function Signature Breakdown',
          ...
          child: Column(
            children: [
              for (final param in [
                (
                  'Locale locale',
                  'The locale requested by the system or user',
                  Icons.language,
                  deepVermilion,
                ),
                (
                  'Iterable<Locale> supportedLocales',
                  'All locales the app declares support for',
                  Icons.list,
                  cinnabar,
                ),
                (
                  'Returns: Future<T>',
                  'Async result with the localized resource object',
                  Icons.output,
                  burntOrange,
                ),
              ])
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              param.$2,
                              style: TextStyle(fontSize: 11, color: mandarin),
                            ),
                          ],
                        ),
                      ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          Text(
                            'Language',
                            style: TextStyle(fontSize: 10, color: cinnabar),
                          ),
                          const SizedBox(height: 2),
                          Text(
        ...
        // ── 5. Localization flow ─────────────────────────────────────
        sectionBanner(
          '4 \u00b7 Localization Resolution Flow',
        ...
        flowStep(
          ...
          'Platform reports new locale to Flutter',
          deepVermilion,
        ),
        flowStep(
          2,
          'Localizations widget rebuilds',
          'Passes locale to each delegate',
          cinnabar,
        ),
        flowStep(
          3,
          'isSupported() checked',
          'Delegate confirms it handles this locale',
          burntOrange,
        ),
        flowStep(
          4,
          'shouldReload() consulted',
          'Skip loading if delegate unchanged',
          mandarin,
        ),
        flowStep(
          5,
          'Resolver called',
          'load(locale) invoked on the delegate',
          tangerine,
        ),
        flowStep(
          6,
          'Future resolves',
          'Localized resource object returned',
          salmon,
        ),
        flowStep(
          7,
          'Widgets rebuild',
          'Localizations.of<T>() returns new resources',
          peachBlush,
        ),
        const SizedBox(height: 14),
          ...
          child: Column(
            ...
            children: [
              for (final line in [
                ...
                (
                  '       \u2514\u2500 AppLocalizations.delegate (custom)',
                  tangerine,
                ),
                (
                  '            \u2514\u2500 load() \u2192 LocalizationsResolver<T>',
                  salmon,
                ),
              ])
                Padding(
              ...
              for (final loc in [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(color: loc.$4.withValues(alpha: 0.2)),
                  ),
                  child: Column(
        ...
        apiCard(
          ...
          'Material design text strings, formatters, and directionality',
          Icons.palette,
          deepVermilion,
        ),
        apiCard(
          'GlobalWidgetsLocalizations',
          'Text direction (LTR/RTL) for the Widgets layer',
          Icons.text_format,
          cinnabar,
        ),
        apiCard(
          'GlobalCupertinoLocalizations',
          'Cupertino (iOS-style) text strings and formatting',
          Icons.phone_iphone,
          burntOrange,
        ),
        apiCard(
          'Custom delegate',
          'Your app-specific LocalizationsDelegate<T>',
          Icons.extension,
          mandarin,
        ),
        const SizedBox(height: 14),
            ...
            children: [
              for (final strategy in [
                ...
                (
                  2,
                  'Language match',
                  'Same languageCode, any country',
                  cinnabar,
                ),
                (
                  3,
                  'Script match',
                  'Same scriptCode if specified',
                  burntOrange,
                ),
                ...
                (
                  5,
                  'First supported',
                  'supportedLocales[0] as last resort',
                  tangerine,
                ),
              ])
                Container(
              ...
              for (final dir in [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border(left: BorderSide(color: dir.$4, width: 3)),
                  ),
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Text(
                          dir.$2,
                          style: TextStyle(fontSize: 22, color: dir.$4),
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
          ...
          child: Column(
            children: [
              for (final phase in [
                ...
                (
                  'Loading',
                  'Reading .arb file or initializing',
                  Icons.hourglass_empty,
                  cinnabar,
                ),
                (
                  'Resolved',
                  'AppLocalizations_de instance ready',
                  Icons.check_circle,
                  tealContrast,
                ),
                (
                  'Available',
                  'Localizations.of<AppLocalizations>(context)',
                  Icons.visibility,
                  burntOrange,
                ),
              ])
            ...
            children: [
              for (final scenario in [
                (
                  'Locale changes',
                  true,
                  'Always calls load() with new locale',
                  deepVermilion,
                ),
                (
                  'shouldReload returns true',
                  true,
                  'Delegate updated, reload resources',
                  cinnabar,
                ),
                (
                  'shouldReload returns false',
                  false,
                  'Keep cached resources',
                  tealContrast,
                ),
                ('Hot reload', true, 'Development convenience', burntOrange),
                (
                  'Same locale, same delegate',
                  false,
                  'No need to reload',
                  salmon,
                ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          scenario.$2 ? 'RELOAD' : 'CACHED',
                          style: TextStyle(
                            fontSize: 10,
                            fontWeight: FontWeight.bold,
                            color: scenario.$2 ? deepVermilion : tealContrast,
                          ),
                        ),
                      ),
                      const SizedBox(width: 8),
          ...
          child: Column(
            children: [
              for (final tip in [
                (
                  '\u2705',
                  'Wrap widgets in Localizations for tests',
                  deepVermilion,
                ),
                ('\u2705', 'Test each supported locale explicitly', cinnabar),
                (
                  '\u2705',
                  'Verify fallback when locale not supported',
                  burntOrange,
                ),
                (
                  '\u2705',
                  'Check RTL layout for Arabic/Hebrew locales',
                  mandarin,
                ),
                (
                  '\u26a0\ufe0f',
                  'Await resolver Future in widget tests',
                  tangerine,
                ),
                (
                  '\u26a0\ufe0f',
                  'Ensure delegates are provided in test harness',
                  salmon,
                ),
              ])
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          tip.$2,
                          style: TextStyle(fontSize: 12, color: tip.$3),
                        ),
                      ),
                    ],
                  ),
