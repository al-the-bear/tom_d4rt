...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'EdgeInsetsGeometryTween interpolates between two '
    ...
    },
    {
      ...
      'body':
          'EdgeInsetsGeometry is the abstract base — EdgeInsets '
    ...
    },
    {
      ...
      'body':
          'It extends Tween<EdgeInsetsGeometry?> and overrides '
    ...
    },
    {
      ...
      'body':
          'AnimatedContainer and AnimatedPadding use this tween '
  ...
  final hierarchy = <Map<String, dynamic>>[
    {
      ...
      'isSubject': false,
      'description':
          'The abstract base. Defines along(), '
    ...
    },
    {
      ...
      'isSubject': false,
      'description':
          'Physical direction insets: left, top, right, '
    ...
    },
    {
      ...
      'isSubject': false,
      'description':
          'Logical direction insets: start, top, end, '
    ...
    },
    {
      ...
      'isSubject': true,
      'description':
          'Tween<EdgeInsetsGeometry?> that interpolates '
    ...
    },
    {
      ...
      'isSubject': false,
      'description':
          'Tween<EdgeInsets?> — a narrower tween that '
  ...
  for (final t in tValues) {
    ...
    print(
      '  t=$t → L:${resolved.left} T:${resolved.top} '
  ...
  final paddingExamples = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Starts with uniform 4px padding on all sides, '
    ...
    },
    {
      ...
      'description':
          'Starts with zero padding, animates to symmetric '
    ...
    },
    {
      ...
      'description':
          'Shifts padding from left to right. At t=0.5, '
    ...
    },
    {
      ...
      'description':
          'Inverts vertical distribution. Great for '
  ...
  final apiMembers = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.green[700]!,
      'description':
          'Creates a tween with optional begin and end '
    ...
    },
    {
      ...
      'color': Colors.teal[600]!,
      'description':
          'Returns the interpolated EdgeInsetsGeometry at '
    ...
    },
    {
      ...
      'description':
          'The EdgeInsetsGeometry at t=0.0. Can be '
    ...
    },
    {
      ...
      'color': Colors.teal[700]!,
      'description':
          'The EdgeInsetsGeometry at t=1.0. Can be '
    ...
    },
    {
      ...
      'color': Colors.green[800]!,
      'description':
          'Inherited from Animatable. Calls lerp() with '
    ...
    },
    {
      ...
      'description':
          'Inherited from Animatable. Creates an Animation '
  ...
  final mixedExamples = <Map<String, dynamic>>[
    {
      ...
      'rtlResult':
          'At t=0.5: left=16, right=16 → but resolves differently in RTL',
      'description':
          'When lerping between physical and directional '
    ...
    },
    {
      ...
      'description':
          'Demonstrates how the same tween produces '
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.green[700]!,
      'description':
          'A product card in a grid has tight 8px padding. '
    ...
    },
    {
      ...
      'color': Colors.teal[600]!,
      'description':
          'A SliverAppBar\'s title padding changes as '
    ...
    },
    {
      ...
      'color': Colors.green[600]!,
      'description':
          'On a phone, content has symmetric(h:16). On '
    ...
    },
    {
      ...
      'color': Colors.teal[700]!,
      'description':
          'When the keyboard appears, bottom padding '
    ...
    },
    {
      ...
      'color': Colors.green[800]!,
      'description':
          'App switches locale from LTR to RTL. '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'If you only need EdgeInsets (no directional), '
    ...
    },
    {
      ...
      'body':
          'If begin or end is null, EdgeInsetsGeometry.lerp() '
    ...
    },
    {
      ...
      'body':
          'The lerp result is an EdgeInsetsGeometry, not '
    ...
    },
    {
      ...
      'body':
          'The lerp is linear by default. Chain with '
    ...
    },
    {
      ...
      'body':
          'If using EdgeInsetsDirectional, always test the '
            ...
            return Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: pe['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                  ...
                  children: [
                    ...
                    Row(
                      children: [0.0, 0.5, 1.0].map((t) {
                        final lerped = EdgeInsetsGeometry.lerp(begin, end, t)!;
                        final resolved = lerped.resolve(TextDirection.ltr);
                        return Expanded(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  height: 80,
                                  decoration: BoxDecoration(
                                    color: (pe['color'] as Color).withOpacity(
                                      0.15,
                                    ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        _padViz(api['kind'] as String, Colors.grey[500]!),
                      ],
                    ),
                    SizedBox(height: 4),
                    Text(
            ...
            (me) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: me['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _padViz('begin: ${p['begin']}', Colors.green[600]!),
                        SizedBox(width: 6),
                        Icon(
                          Icons.arrow_forward,
                          size: 12,
                        ...
                        SizedBox(width: 6),
                        _padViz('end: ${p['end']}', Colors.teal[600]!),
                      ],
                    ),
                  ],
                ),
