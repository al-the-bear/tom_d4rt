  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'DisposableBuildContext wraps a BuildContext (specifically '
    ...
    },
    {
      ...
      'body':
          'In Flutter, BuildContext is only valid while its widget '
    ...
    },
    {
      ...
      'body':
          'Instead of storing a raw BuildContext, store a '
    ...
    },
    {
      ...
      'body':
          'The dispose() method explicitly nulls out the context '
  ...
  final problemScenarios = <Map<String, dynamic>>[
    {
      ...
      'code':
          '// WRONG: Storing raw BuildContext\n'
          '//\n'
          ...
          '// }',
      'note':
          'Storing a raw BuildContext in a long-lived object is '
    ...
    },
    {
      ...
      'code':
          '// CORRECT: Using DisposableBuildContext\n'
          '//\n'
          '// class MyScrollPosition {\n'
          ...
          '// }',
      'note':
          'DisposableBuildContext becomes null after disposal, '
  ...
  final apiItems = <Map<String, dynamic>>[
    {
      ...
      'desc':
          'Creates a DisposableBuildContext wrapping the given '
    ...
    },
    {
      ...
      'desc':
          'Returns the wrapped BuildContext if the State is still '
    ...
    },
    {
      ...
      'desc':
          'Marks this DisposableBuildContext as disposed. After '
  ...
  final consumers = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[600]!,
      'desc':
          'ScrollPosition is a long-lived object (managed by '
      ...
      'lifecycle':
          'Created in ScrollableState.initState()\n'
    ...
    },
    {
      ...
      'color': Colors.blueGrey[600]!,
      'desc':
          'ScrollableState creates the DisposableBuildContext and '
          ...
          'is no longer valid.',
      'lifecycle':
          'Creates DisposableBuildContext(this)\n'
    ...
    },
    {
      ...
      'color': Colors.brown[500]!,
      'desc':
          'KeepAliveHandle (internal to AutomaticKeepAliveClientMixin) '
      ...
      'lifecycle':
          'Created when keep-alive starts\n'
    ...
    },
    {
      ...
      'desc':
          'Any custom object that needs to hold a BuildContext '
  ...
  final lifecycle = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[600]!,
      'detail':
          'The State creates a DisposableBuildContext wrapping '
    ...
    },
    {
      ...
      'color': Colors.blueGrey[600]!,
      'detail':
          'The DisposableBuildContext is passed to another object '
    ...
    },
    {
      ...
      'color': Colors.brown[500]!,
      'detail':
          'During normal operation, .context returns the valid '
    ...
    },
    {
      ...
      'color': Colors.blueGrey[500]!,
      'detail':
          'The widget is being removed. State.dispose() calls '
    ...
    },
    {
      ...
      'detail':
          'The holder (e.g., ScrollPosition) still exists but '
  ...
  final mistakes = <Map<String, dynamic>>[
    {
      ...
      'icon': Icons.error,
      'body':
          'If you create a DisposableBuildContext but forget to '
    ...
    },
    {
      ...
      'icon': Icons.warning,
      'body':
          'Don\'t create DisposableBuildContext in the constructor '
    ...
    },
    {
      ...
      'icon': Icons.error,
      'body':
          'The whole point of DisposableBuildContext is that '
    ...
    },
    {
      ...
      'icon': Icons.info,
      'body':
          'After dispose(), context returns null. This is safe '
  ...
  final relatedConcepts = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[600]!,
      'desc':
          'The raw context interface. Every Element implements '
    ...
    },
    {
      ...
      'color': Colors.blueGrey[600]!,
      'desc':
          'State has a mounted property. Before DisposableBuildContext, '
    ...
    },
    {
      ...
      'color': Colors.brown[500]!,
      'desc':
          'The primary consumer. ScrollPosition can be shared '
    ...
    },
    {
      ...
      'color': Colors.blueGrey[500]!,
      'desc':
          'Like DisposableBuildContext, ChangeNotifier has a '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'Any object that stores a BuildContext and lives longer '
    ...
    },
    {
      ...
      'body':
          'The entire safety benefit comes from the null check: '
    ...
    },
    {
      ...
      'body':
          'If you store both the DisposableBuildContext AND the '
    ...
    },
    {
      ...
      'body':
          'For most developers, you\'ll never create a '
    ...
    },
    {
      ...
      'body':
          'Dart\'s null-aware operators make DisposableBuildContext '
    ...
    },
    {
      ...
      'body':
          'A State should only create one DisposableBuildContext. '
            ...
            (ai) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: ai['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _dbTag(ai['kind'] as String, ai['color'] as Color),
                        SizedBox(width: 8),
                        Expanded(
                          child: Text(
                            ai['name'] as String,
