  ...
  Widget ptBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('■ ', style: TextStyle(color: ptAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          ptSection('1 · Class Identity & Role', [
            ...
            ptKeyValue('Toolbar', 'CupertinoAdaptiveTextSelectionToolbar'),
            ptDivider(),
            ptBullet(
          ...
          ptSection('3 · When Paste Appears', [
            ptBullet('The Paste item appears when ALL conditions are met:'),
            ptKeyValue(
              'Editable field',
          ...
          ptSection('5 · UIPasteControl (iOS 16+)', [
            ...
            ptKeyValue('Keyboard Cmd+V', 'Shows dialog for cross-app paste'),
          ]),
          ...
          ptSection('10 · Comparison with Other Menu Items', [
            ...
            ptCompare(
              'Select All',
              'Selects all text, no clipboard interaction',
            ),
            ptDivider(),
            ptBullet(
