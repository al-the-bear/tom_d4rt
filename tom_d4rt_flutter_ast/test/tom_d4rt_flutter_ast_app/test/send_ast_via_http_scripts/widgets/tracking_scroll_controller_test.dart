  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'TrackingScrollController extends ScrollController and '
    ...
    },
    {
      ...
      'body':
          'The primary use case is TabBarView, where each tab has '
    ...
    },
    {
      ...
      'body':
          'The key property: returns the ScrollPosition that was '
    ...
    },
    {
      ...
      'body':
          'When a new tab attaches to the controller, it receives '
  ...
  final apiEntries = <Map<String, dynamic>>[
    {
      ...
      'type': 'ScrollPosition?',
      'description':
          'Returns the ScrollPosition that was most recently '
    ...
    },
    {
      ...
      'type': 'double',
      'description':
          'The initial scroll offset applied to newly '
    ...
    },
    {
      ...
      'description':
          'Inherited from ScrollController. Returns all '
    ...
    },
    {
      ...
      'type': 'double',
      'description':
          'Returns the offset of the most recently updated '
  ...
  final lifecycleSteps = <Map<String, dynamic>>[
    {
      ...
      'title': 'Attach',
      'detail':
          'ScrollView creates a ScrollPosition and calls '
    ...
    },
    {
      ...
      'title': 'Scroll / Update',
      'detail':
          'As the user scrolls, position.pixels updates. '
    ...
    },
    {
      ...
      'title': 'Tab Switch',
      'detail':
          'When the user switches tabs, the old position may '
    ...
    },
    {
      ...
      'title': 'Detach',
      'detail':
          'When a scrollable is disposed, its position detaches '
    ...
    },
    {
      ...
      'title': 'Dispose',
      'detail':
          'Disposing the controller detaches all remaining '
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Most common pattern. Create one '
          'TrackingScrollController and pass it to the ListView '
          'in each tab page.',
      'code':
          'final _tsc = TrackingScrollController();\n\n'
          'TabBarView(\n'
          '  children: [\n'
          '    ListView(\n'
          '      controller: _tsc,\n'
    ...
    },
    {
      ...
      'description':
          'Check the most recent position offset for '
    ...
    },
    {
      ...
      'description':
          'Start all tabs at a specific scroll position. '
    ...
    },
    {
      ...
      'description':
          'Use addListener to respond to scroll changes '
  ...
  final edgeCases = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'Calling .offset before any scrollable attaches throws '
    ...
    },
    {
      ...
      'detail':
          'If tabs need independent scroll positions, use '
    ...
    },
    {
      ...
      'detail':
          'During tab transitions, two positions may be '
    ...
    },
    {
      ...
      'detail':
          'Always dispose the controller AFTER the scrollable '
  ...
  final bestPractices = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'Create a single TrackingScrollController for each '
    ...
    },
    {
      ...
      'detail':
          'Always null-check the position. It\'s null before '
    ...
    },
    {
      ...
      'detail':
          'Use AutomaticKeepAliveClientMixin in tab pages to '
    ...
    },
    {
      ...
      'detail':
          'For a single scrollable, use ScrollController. '
