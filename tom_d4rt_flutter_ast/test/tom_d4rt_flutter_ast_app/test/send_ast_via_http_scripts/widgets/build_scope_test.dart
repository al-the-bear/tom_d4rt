...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'BuildScope partitions the widget tree into independent '
    ...
    },
    {
      ...
      'body':
          'Before BuildScope, BuildOwner maintained a single global '
    ...
    },
    {
      ...
      'body':
          'The primary motivation for BuildScope: overlays (tooltips, '
    ...
    },
    {
      ...
      'body':
          'BuildScope works with BuildOwner. When an Element is '
  ...
  final lifecycle = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'A BuildScope is created when an overlay entry, route, '
    ...
    },
    {
      ...
      'detail':
          'When elements mount inside a scope-owning widget, they '
    ...
    },
    {
      ...
      'detail':
          'When setState() is called, the element is marked dirty '
    ...
    },
    {
      ...
      'detail':
          'During the frame, BuildOwner calls buildScope() for '
    ...
    },
    {
      ...
      'detail':
          'After processing, the scope\'s dirty list is empty. '
  ...
  final architecture = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.deepOrange[600]!,
      'code':
          '// // Every Element has a buildScope:\n'
    ...
    },
    {
      ...
      'color': Colors.red[500]!,
      'code':
          '// // BuildOwner processes each scope:\n'
          '// void buildScope(\n'
          '//   BuildScope scope, {\n'
  ...
  final useCases = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.red[600]!,
      'desc':
          'Each OverlayEntry gets a BuildScope. When tooltip #3 '
      ...
      'visual':
          'Page rebuilds: 0 overlay rebuilds\n'
    ...
    },
    {
      ...
      'color': Colors.deepOrange[600]!,
      'desc':
          'During a page transition, both the old and new routes '
      ...
      'visual':
          'Old route animating out: 0 new route rebuilds\n'
    ...
    },
    {
      ...
      'color': Colors.red[500]!,
      'desc':
          'A persistent bottom sheet in a Scaffold can have its '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[500]!,
      'desc':
          'FABs rendered as overlay entries benefit from scope '
  ...
  final dirtyProcessing = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.red[600]!,
      'body':
          'Within a BuildScope, dirty elements are sorted by depth '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[600]!,
      'body':
          'A dirty element is always processed by its own scope. '
    ...
    },
    {
      ...
      'color': Colors.red[500]!,
      'body':
          'Before BuildScope, ALL dirty elements were sorted '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[500]!,
      'body':
          'While scopes are processed sequentially (not actually '
  ...
  final related = <Map<String, dynamic>>[
    {
      ...
      'relation': 'Manager',
      'desc':
          'BuildOwner coordinates all BuildScopes. It maintains '
    ...
    },
    {
      ...
      'relation': 'Member',
      'desc':
          'Each Element belongs to exactly one BuildScope. The '
    ...
    },
    {
      ...
      'relation': 'Creator',
      'desc':
          'OverlayEntry is the primary creator of BuildScopes '
    ...
    },
    {
      ...
      'relation': 'Host',
      'desc':
          'Overlay hosts multiple OverlayEntries, each with its '
    ...
    },
    {
      ...
      'relation': 'Consumer',
      'desc':
          'Navigator uses Overlay internally. Each route pushed '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'You don\'t need to create BuildScopes manually. The '
    ...
    },
    {
      ...
      'body':
          'If you\'re profiling rebuilds using debugPrint or a '
    ...
    },
    {
      ...
      'body':
          'BuildScope isolates BETWEEN scopes, not within. Inside '
    ...
    },
    {
      ...
      'body':
          'The debugDumpApp() output includes scope information '
    ...
    },
    {
      ...
      'body':
          'BuildScope is an internal optimization. Your existing '
    ...
    },
    {
      ...
      'body':
          'InheritedWidget notifications DO cross scope boundaries. '
            ...
            (ba) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: ba['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
          ...
          Container(
            ...
            child: Column(
              ...
              children: scopeTree.map((st) {
                ...
                return Padding(
                  padding: EdgeInsets.only(bottom: 10, left: depth * 20.0),
                  child: Container(
                    padding: EdgeInsets.all(10),
                    decoration: BoxDecoration(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: (uc['color'] as Color).withOpacity(0.2),
                        ),
                      ),
                      child: Text(
                        uc['visual'] as String,
            ...
            (dp) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: dp['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _bsTag(r['name'] as String, r['color'] as Color),
                        SizedBox(width: 8),
                        _bsTag(r['relation'] as String, Colors.grey[500]!),
                      ],
                    ),
                    SizedBox(height: 8),
                    Text(
