  ...
  Widget ipBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('● ', style: TextStyle(color: ipAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          ipSection('1 · Class Identity & Role', [
            ...
            ipKeyValue('Purpose', 'Debug representation of IconData values'),
            ipDivider(),
            ipBullet(
          ...
          ipSection('9 · toString Representation', [
            ...
            ipDivider(),
            ipBullet('The U+XXXXX format shows the Unicode code point in hex.'),
          ]),
          ...
          ipSection('15 · Where Flutter Uses IconDataProperty', [
            ...
            ipBullet('IconButton uses it for its icon diagnostics.'),
            ipBullet(
