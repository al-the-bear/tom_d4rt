          ...
          child: Column(
            children: const <Widget>[
              ...
              _SectionHeader(
                ...
                subtitle:
                    'How ScrollNotification fits in the Notification tree',
          ...
          Container(
            ...
            child: Column(
              ...
              children: const <Widget>[
                ...
                _LeafRow(
                  label: 'ScrollEndNotification',
                  color: Color(0xFFEF5350),
                ),
                _LeafRow(
                  label: 'OverscrollNotification',
                  color: Color(0xFFFF7043),
                ),
                _LeafRow(
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          ...
          Container(width: 14.0, height: 2.0, color: const Color(0xFF90A4AE)),
          const SizedBox(width: 10),
          Text(
            label,
            style: const TextStyle(
            ...
            child: Column(
              ...
              children: const <Widget>[
                _StepText(
                  step: 1,
                  text:
                      'ScrollStartNotification fires when a Scrollable begins moving.',
                ),
                _StepText(
                  step: 2,
                  text:
                      'A run of ScrollUpdateNotifications fires per frame while pixels change.',
                ),
                _StepText(
                  step: 3,
                  text:
                      'OverscrollNotification interleaves if drag goes past extents.',
                ),
                _StepText(
                  step: 4,
                  text:
                      'ScrollEndNotification fires when motion settles to rest.',
                ),
                _StepText(
                  step: 5,
                  text:
                      'UserScrollNotification fires when the active drag direction changes.',
                ),
              ],
            ),
          ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: <Color>[Color(0xFF1E1E2E), Color(0xFF2A2D3E)],
        ),
        boxShadow: <BoxShadow>[
          BoxShadow(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: const <Widget>[
                ...
                _CodeLine(
                  n: 2,
                  code: '  onNotification: (notification) {',
                  color: Color(0xFFD4D4D4),
                ),
                _CodeLine(
                  n: 3,
                  code: '    if (notification is ScrollStartNotification) {',
                  color: Color(0xFF569CD6),
                ),
                _CodeLine(
                  n: 4,
                  code: '      // begin tracking drag',
                ...
                _CodeLine(
                  n: 6,
                  code: '      final delta = notification.scrollDelta;',
                  color: Color(0xFFD4D4D4),
                ),
                _CodeLine(
                  n: 7,
                  code: '      final pixels = notification.metrics.pixels;',
                  color: Color(0xFFD4D4D4),
                ),
                _CodeLine(
                  n: 8,
                ...
                _CodeLine(
                  n: 9,
                  code: '      final amount = notification.overscroll;',
                  color: Color(0xFFD4D4D4),
                ),
                _CodeLine(
                  n: 10,
                ...
                _CodeLine(
                  n: 11,
                  code: '      final dir = notification.direction;',
                  color: Color(0xFFD4D4D4),
                ),
                _CodeLine(
                  n: 12,
                ...
                _CodeLine(
                  n: 13,
                  code: '      // commit final position',
                  color: Color(0xFF6A9955),
                ),
                _CodeLine(n: 14, code: '    }', color: Color(0xFFD4D4D4)),
                _CodeLine(
                  n: 15,
                  code: '    return false; // let ancestors keep observing',
                  color: Color(0xFF6A9955),
                ),
                _CodeLine(n: 16, code: '  },', color: Color(0xFFD4D4D4)),
                _CodeLine(
                  n: 17,
                  code: '  child: ListView(children: items),',
                  color: Color(0xFFD4D4D4),
                ),
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          ...
          Container(width: 2.0, height: 20.0, color: const Color(0xFF90A4AE)),
      ...
      child: Column(
        ...
        children: const <Widget>[
          ...
          _PitfallBullet(
            ...
            text:
                'return true STOPS bubbling, return false lets it bubble. Easy to flip.',
          ),
          _PitfallBullet(
            number: 2,
            title: 'Depth filtering forgotten',
            text:
                'Nested Scrollables produce notifications at different depths. Filter via notification.depth.',
          ),
          _PitfallBullet(
            number: 3,
            title: 'Listener overhead at 120fps',
            text:
                'onNotification runs on every frame during a drag. Avoid heavy work or expensive isinstance branches.',
          ),
          _PitfallBullet(
            number: 4,
            title: 'setState in onNotification',
            text:
                'Triggering rebuild on every ScrollUpdateNotification is a common cause of jank. Use ValueNotifier instead.',
          ),
          _PitfallBullet(
            number: 5,
            title: 'OverscrollIndicatorNotification confusion',
            text:
                'That is a separate notification type for suppressing the glow. It is not part of the scroll lifecycle proper.',
          ),
        ],
      ),
    );
