...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'DirectionalFocusAction is the built-in Action class that '
    ...
    },
    {
      ...
      'body':
          'Flutter registers DirectionalFocusAction in the default '
    ...
    },
    {
      ...
      'body':
          'The action does not decide where focus goes — it asks the '
    ...
    },
    {
      ...
      'body':
          'Directional focus is critical for keyboard-only users, TV '
  ...
  final actionIntentPairs = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Moves focus in a TraversalDirection (up/down/'
    ...
    },
    {
      ...
      'description':
          'Requests focus on a specific FocusNode. Unlike '
  ...
  final directions = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.deepPurple[700]!,
      'description':
          'Move focus to the nearest focusable widget above '
    ...
    },
    {
      ...
      'color': Colors.purple[600]!,
      'description':
          'Move focus to the nearest focusable widget below. '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[600]!,
      'description':
          'Move focus to the nearest focusable widget to the '
  ...
  print(
    '  Prepared ${gridCells.length} grid cells and ${gridArrows.length} arrows',
  );
  ...
  final policies = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.deepPurple[700]!,
      'description':
          'The default policy. Uses widget geometry to determine '
      ...
      'directional':
          'Geometry-based: finds nearest visually in that '
    ...
    },
    {
      ...
      'color': Colors.purple[600]!,
      'description':
          'Uses FocusTraversalOrder widgets to define explicit '
          'ordering. Tab order follows the numeric/lexicographic order '
          'of the assigned FocusOrder values.',
      'directional':
          'Falls back to reading-order geometry for directional '
    ...
    },
    {
      ...
      'color': Colors.purple[700]!,
      'description':
          'You can extend FocusTraversalPolicy to create custom '
      ...
      'directional':
          'Full control: implement inDirection(FocusNode, '
  ...
  final codePatterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.deepPurple[700]!,
      'code':
          '// No setup needed! Flutter registers\n'
    ...
    },
    {
      ...
      'color': Colors.purple[600]!,
      'code':
          '// Group widgets with a specific policy\n'
          'FocusTraversalGroup(\n'
    ...
    },
    {
      ...
      'color': Colors.deepPurple[600]!,
      'code':
          '// You can invoke the action manually:\n'
    ...
    },
    {
      ...
      'color': Colors.purple[700]!,
      'code':
          '// Override default directional focus behavior\n'
          'Actions(\n'
          '  actions: {\n'
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'You don\'t need to register DirectionalFocusAction — '
    ...
    },
    {
      ...
      'body':
          'Unlike Tab traversal (NextFocusAction), directional '
    ...
    },
    {
      ...
      'body':
          'Wrap related widgets in FocusTraversalGroup to create '
    ...
    },
    {
      ...
      'body':
          'Directional focus relies on widget geometry (size and '
    ...
    },
    {
      ...
      'body':
          'DirectionalFocusIntent has an ignoreTextFields property. '
    ...
    },
    {
      ...
      'body':
          'Always test directional focus on TV platforms (Android TV, '
            ...
            (aip) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: aip['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _dfChip(aip['intent'] as String, aip['color'] as Color),
                        SizedBox(width: 8),
                        Icon(
                          Icons.arrow_forward,
                          size: 14,
                        ...
                        SizedBox(width: 8),
                        _dfChip(aip['action'] as String, aip['color'] as Color),
                      ],
                    ),
                    SizedBox(height: 8),
                    Text(
                      aip['description'] as String,
                      style: TextStyle(
                        fontSize: 12,
                        color: Colors.grey[700],
                        height: 1.4,
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          height: 22,
                          decoration: BoxDecoration(
                            color: (ga['color'] as Color).withOpacity(0.15),
