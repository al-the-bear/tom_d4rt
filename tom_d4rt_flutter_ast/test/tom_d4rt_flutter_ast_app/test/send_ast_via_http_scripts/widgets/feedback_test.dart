...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'The Feedback class provides static methods that trigger '
    ...
    },
    {
      ...
      'body':
          'Feedback distinguishes between two gesture types: '
    ...
    },
    {
      ...
      'body':
          'Feedback respects the user\'s system-level haptics '
    ...
    },
    {
      ...
      'body':
          'Material widgets like InkWell, InkResponse, and '
  ...
  final methods = <Map<String, dynamic>>[
    {
      ...
      'returns': 'Future<void>',
      'description':
          'Provides haptic feedback appropriate for a tap. '
      ...
      'when':
          'After confirming a tap gesture — call this in onTap '
    ...
    },
    {
      ...
      'returns': 'Future<void>',
      'description':
          'Provides haptic and audio feedback for a long '
      ...
      'when':
          'When a long-press gesture is recognized — typically '
    ...
    },
    {
      ...
      'description':
          'Returns a new VoidCallback that calls '
      ...
      'when':
          'Pass directly to onTap/onPressed parameters: '
  ...
  final pipelineSteps = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[700]!,
      'detail':
          'Your widget triggers feedback after detecting a '
    ...
    },
    {
      ...
      'color': Colors.orange[800]!,
      'detail':
          'Feedback reads Theme.of(context).platform. This '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'detail':
          'A platform channel message is sent to the native '
    ...
    },
    {
      ...
      'color': Colors.orange[700]!,
      'detail':
          'The native OS triggers the actual hardware response: '
    ...
    },
    {
      ...
      'detail':
          'If the user has disabled haptic feedback in device '
  ...
  final wrapperCards = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'code':
          '// If handler is null, wrapper returns null\n'
  ...
  final materialWidgets = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[700]!,
      'feedback':
          'Uses Feedback.forTap on tap, Feedback.forLongPress '
    ...
    },
    {
      ...
      'color': Colors.orange[800]!,
      'feedback':
          'Similar to InkWell but with a circular highlight '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'feedback':
          'Uses InkWell internally, which provides feedback. '
    ...
    },
    {
      ...
      'color': Colors.orange[700]!,
      'feedback':
          'Button widgets use InkWell or InkResponse '
    ...
    },
    {
      ...
      'color': Colors.brown[800]!,
      'feedback':
          'Toggle widgets provide haptic feedback when their '
  ...
  final customPatterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[700]!,
      'description':
          'When building a custom button that doesn\'t use '
    ...
    },
    {
      ...
      'color': Colors.orange[800]!,
      'description':
          'Trigger Feedback.forLongPress when a drag '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'description':
          'When the user long-presses an item to enter '
    ...
    },
    {
      ...
      'color': Colors.orange[700]!,
      'description':
          'For a custom slider that snaps to discrete '
    ...
    },
    {
      ...
      'color': Colors.brown[800]!,
      'description':
          'When the user pulls past the refresh threshold, '
  ...
  final enableCards = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[700]!,
      'body':
          'Many Material widgets have an enableFeedback parameter '
    ...
    },
    {
      ...
      'color': Colors.orange[800]!,
      'body':
          'Follow the same pattern in your custom widgets: add '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'body':
          'For an app-wide setting, create a provider or inherited '
    ...
    },
    {
      ...
      'color': Colors.orange[700]!,
      'body':
          'Each Feedback call sends a platform channel message. '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'Prefer Feedback.wrapForTap over manually calling '
    ...
    },
    {
      ...
      'body':
          'Not every interaction needs haptic feedback. Reserve '
    ...
    },
    {
      ...
      'body':
          'Haptic feedback cannot be tested in simulators or '
    ...
    },
    {
      ...
      'body':
          'If you use InkWell, ElevatedButton, ListTile, or '
    ...
    },
    {
      ...
      'body':
          'forLongPress produces stronger feedback than forTap. '
    ...
    },
    {
      ...
      'body':
          'Haptic feedback works best alongside visual feedback '
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        _fbPill(m['returns'] as String, m['color'] as Color),
                      ],
                    ),
                    SizedBox(height: 6),
                    Text(
            ...
            (ps) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(
                    left: BorderSide(color: ps['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
            ...
            (wc) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: wc['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
            ...
            (mw) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: mw['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
            ...
            (ec) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: ec['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
