...
// ─── theory content ────────────────────────────────────────
const _kOverview =
    'SliverAnimatedListState coordinates animated insertions '
...
const _kApiMethods = <_ApiMethod>[
  ...
  _ApiMethod(
    'insertAllItems',
    'insertAllItems(int index, int length, {Duration duration})',
...
const _kPractices = <_Practice>[
  ...
  _Practice(
    'Wrap in SliverPadding for spacing',
        ...
        _card(
          child: Column(
            ...
            children: [
              ...
              _bullet(
                'Access the state via _listKey.currentState to insert/remove.',
              ),
            ],
          ),
        ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Tap buttons to insert or remove items with animations. '
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: enabled ? _kOrange : Colors.white24),
        ),
        child: Row(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Add or remove batches of items. Operations queue and '
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isRemove
              ...
              : _kOrange.withOpacity(0.25),
          borderRadius: BorderRadius.circular(6),
          border: Border.all(color: isRemove ? Colors.red.shade300 : _kOrange),
        ),
        child: Text(
          label,
          style: TextStyle(
