  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'RawScrollbarState is the State class for RawScrollbar. '
    ...
    },
    {
      ...
      'body':
          'The scrollbarPainter property is the CustomPainter that '
    ...
    },
    {
      ...
      'body':
          'The scrollbar fades in when scroll activity begins and '
    ...
    },
    {
      ...
      'body':
          'The state attaches gesture recognizers for thumb drag '
  ...
  final lifecycleSteps = <Map<String, dynamic>>[
    {
      ...
      'title': 'initState()',
      'detail':
          'Creates the ScrollbarPainter with initial configuration, '
    ...
    },
    {
      ...
      'detail':
          'Re-resolves the ScrollController (it may come from '
    ...
    },
    {
      ...
      'detail':
          'Called by subclasses to update the painter with new '
    ...
    },
    {
      ...
      'detail':
          'Handles ScrollUpdateNotification to update the painter\'s '
    ...
    },
    {
      ...
      'title': 'dispose()',
      'detail':
          'Disposes the AnimationController, the ScrollbarPainter, '
  ...
  final apiEntries = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[700]!,
      'description':
          'The painter that renders the scrollbar. Created in '
    ...
    },
    {
      ...
      'color': Colors.amber[800]!,
      'description':
          'Whether the scrollbar is always visible. Returns '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'description':
          'Whether the scrollbar responds to drag and tap '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'description':
          'Protected method that subclasses call to push new '
  ...
  final fadePhases = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Scrollbar is invisible. The fade animation '
    ...
    },
    {
      ...
      'description':
          'Animation controller forward() runs over '
    ...
    },
    {
      ...
      'description':
          'Scrollbar stays fully visible while scroll events '
    ...
    },
    {
      ...
      'description':
          'A timer starts (widget.timeToFade). Scrollbar '
    ...
    },
    {
      ...
      'trigger': 'Timer fires',
      'description':
          'After the delay, animation controller reverse() '
    ...
    },
    {
      ...
      'description':
          'Overrides the fade cycle entirely. The scrollbar '
  ...
  final gestureDetails = <Map<String, dynamic>>[
    {
      'title': 'Thumb Drag',
      'description':
          'Click/touch and drag the scrollbar thumb to scroll. '
    ...
    },
    {
      'title': 'Track Tap',
      'description':
          'Tapping the scrollbar track (not the thumb) jumps '
    ...
    },
    {
      'title': 'Hover Effects',
      'description':
          'On desktop, hovering over the scrollbar enlarges '
    ...
    },
    {
      ...
      'description':
          'The scrollbar itself doesn\'t handle keyboard input, '
  ...
  final customizationOptions = <Map<String, dynamic>>[
    {
      'property': 'thickness',
      'description':
          'Width of the scrollbar thumb in physical pixels. '
    ...
    },
    {
      'property': 'radius',
      'description':
          'Corner radius of the scrollbar thumb. Cupertino '
    ...
    },
    {
      'property': 'thumbColor',
      'description':
          'The color of the scrollbar thumb. Can be '
    ...
    },
    {
      'property': 'timeToFade',
      'description':
          'Delay after scroll ends before the fade-out begins. '
    ...
    },
    {
      ...
      'description':
          'When true, the scrollbar is always visible (no fading). '
          ...
          (g) => Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                border: Border(
                  left: BorderSide(color: g['color'] as Color, width: 4),
                ),
              ),
              padding: EdgeInsets.all(14),
              child: Row(
