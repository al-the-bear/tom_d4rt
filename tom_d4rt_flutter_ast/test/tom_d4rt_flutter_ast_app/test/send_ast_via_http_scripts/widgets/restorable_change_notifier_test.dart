...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'RestorableChangeNotifier<T extends ChangeNotifier> is '
    ...
    },
    {
      ...
      'body':
          'Subclasses implement toPrimitives() to encode the notifier '
    ...
    },
    {
      ...
      'title': 'Auto-Disposal',
      'body':
          'When the RestorableProperty is disposed (widget removed), '
    ...
    },
    {
      ...
      'body':
          'RestorableChangeNotifier (via RestorableListenable) '
  ...
  final hierarchy = <Map<String, dynamic>>[
    {
      ...
      'depth': 0,
      'description':
          'Base: registers with RestorationMixin, '
    ...
    },
    {
      ...
      'depth': 1,
      'description':
          'Adds ChangeNotifier forwarding — listens to '
    ...
    },
    {
      ...
      'depth': 2,
      'description':
          'Narrows T to ChangeNotifier — the abstract '
    ...
    },
    {
      ...
      'depth': 3,
      'description':
          'Concrete: wraps TextEditingController, '
  ...
  final lifecycle = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The State mixin (RestorationMixin) registers '
    ...
    },
    {
      ...
      'description':
          'If no saved state exists, this is called to '
    ...
    },
    {
      ...
      'description':
          'The ChangeNotifier mutates as the user interacts. '
    ...
    },
    {
      ...
      'phase': 'toPrimitives()',
      'description':
          'When the system needs to save state (app '
    ...
    },
    {
      ...
      'description':
          'The OS kills the app. Serialized primitives '
    ...
    },
    {
      ...
      'description':
          'On restore, the framework calls fromPrimitives() '
    ...
    },
    {
      ...
      'phase': 'dispose()',
      'description':
          'When the widget is removed, the property auto-'
  ...
  final rtecProperties = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'description':
          'TextSelection range — cursor position or highlighted '
    ...
    },
    {
      ...
      'serialized': 'List<int> (start, end)',
      'description':
          'Composing region for IME input — the range undergoing '
  ...
  final practices = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'toPrimitives() should return compact data — avoid '
    ...
    },
    {
      ...
      'detail':
          'fromPrimitives() may be called multiple times if '
    ...
    },
    {
      ...
      'detail':
          'Call dispose() on the RestorableChangeNotifier in '
    ...
    },
    {
      ...
      'detail':
          'Each property needs a unique ID within its '
    ...
    },
    {
      ...
      'detail':
          'Write tests that serialize via toPrimitives() then '
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
              ...
              child: Column(
                ...
                children: [
                  Text(
                    h['class'] as String,
                    style: TextStyle(
                      fontWeight: h['class'] == 'RestorableChangeNotifier<T>'
                          ? FontWeight.bold
                          : FontWeight.w600,
                      fontFamily: 'monospace',
                      fontSize: h['class'] == 'RestorableChangeNotifier<T>'
                          ? 14
                          : 12,
                      color: h['color'] as Color,
                    ),
        ...
        // ---- Section 4: RestorableTextEditingController ----
        _sectionHeader(
          '4. RestorableTextEditingController',
          Icons.text_fields,
          Color(0xFFC62828),
        ),
        SizedBox(height: 10),
        Text(
          'Properties serialized by the built-in implementation:',
        ...
        SizedBox(height: 10),
        Text(
          'Building a restorable counter notifier from scratch:',
          style: TextStyle(fontSize: 13, color: Colors.grey[700]),
        ),
        SizedBox(height: 8),
        Container(
          ...
          (re) => Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(10),
                border: Border(
                  left: BorderSide(color: re['color'] as Color, width: 3),
                ),
              ),
              padding: EdgeInsets.all(12),
              child: Row(
