  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'ExpansibleController is a ChangeNotifier that manages '
    ...
    },
    {
      ...
      'body':
          'Because ExpansibleController extends ChangeNotifier, '
    ...
    },
    {
      ...
      'body':
          'Just like ScrollController for scrollable widgets or '
    ...
    },
    {
      ...
      'body':
          'Each ExpansionTile gets its own controller. To coordinate '
  ...
  final members = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Returns whether the controller is in expanded '
    ...
    },
    {
      ...
      'description':
          'Programmatically expand the tile. If already '
    ...
    },
    {
      ...
      'description':
          'Programmatically collapse the tile. If already '
    ...
    },
    {
      ...
      'description':
          'Alias for isExpanded. Returns the current boolean '
    ...
    },
    {
      ...
      'description':
          'Release resources. Call in your State\'s dispose() '
  ...
  final integrationSteps = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.indigo[700]!,
      'detail':
          'In initState(), create the ExpansibleController. '
    ...
    },
    {
      ...
      'color': Colors.blue[700]!,
      'detail':
          'Assign the controller to ExpansionTile\'s controller '
    ...
    },
    {
      ...
      'color': Colors.indigo[600]!,
      'detail':
          'Call expand() or collapse() from button handlers, '
    ...
    },
    {
      ...
      'color': Colors.blue[600]!,
      'detail':
          'Add a listener to react when expansion state changes. '
    ...
    },
    {
      ...
      'color': Colors.indigo[500]!,
      'detail':
          'Call dispose() in the State\'s dispose method to '
  ...
  final controlExamples = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.indigo[700]!,
      'description':
          'Expand every panel at once — useful for a '
    ...
    },
    {
      ...
      'color': Colors.blue[700]!,
      'description':
          'Collapse every panel — useful for a "Reset" or '
    ...
    },
    {
      ...
      'color': Colors.indigo[600]!,
      'description':
          'When one panel expands, collapse all others. '
    ...
    },
    {
      ...
      'color': Colors.blue[600]!,
      'description':
          'Expand a section after a delay — for guided tours, '
  ...
  final coordinationRows = <Map<String, dynamic>>[
    {
      'pattern': 'Independent',
      'description':
          'Each tile operates independently. Multiple tiles '
    ...
    },
    {
      'pattern': 'Accordion',
      'description':
          'Only one tile can be open at a time. When one '
    ...
    },
    {
      ...
      'description':
          'All tiles expand or collapse together via a '
    ...
    },
    {
      'pattern': 'Dependent',
      'description':
          'Expanding tile A enables tile B\'s expansion. '
    ...
    },
    {
      'pattern': 'Sequential',
      'description':
          'Tiles must be opened in order. Tile 2 only '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'ExpansibleController extends ChangeNotifier which holds '
    ...
    },
    {
      ...
      'body':
          'Each ExpansionTile needs its own controller. Sharing '
    ...
    },
    {
      ...
      'body':
          'The ExpansionTile\'s initiallyExpanded parameter still '
    ...
    },
    {
      ...
      'body':
          'Calling expand() or collapse() inside the build method '
    ...
    },
    {
      ...
      'body':
          'Wrap dependent UI in ListenableBuilder(listenable: '
    ...
    },
    {
      ...
      'body':
          'In widget tests, create a controller and pass it to '
            ...
            (ce) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: ce['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
            ...
            (cr) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(
                    left: BorderSide(color: cr['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
