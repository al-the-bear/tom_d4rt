...
dynamic build(BuildContext context) {
  ...
  final DiagnosticsNode debugDescription = DiagnosticsProperty<bool>(
    'isReleaseBuild',
    isReleaseBuild,
  );
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            dataRow('Affects', 'Text, RichText, ListTile labels, …', mossGreen),
            dataRow(
              'Does NOT affect',
              'TextSpan style on RichText directly',
              mossGreen,
            ),
            dataRow('Lookup helper', 'DefaultTextStyle.of(context)', mossGreen),
  ...
  final anatomy = Column(
    ...
    children: [
      sectionBanner(
        '2. Anatomy',
        'Every constructor parameter, visualized',
        mossGreen,
        ivory,
      ),
      paramStyle,
      ...
      children: [
        Align(
          ...
          child: Container(
            ...
            child: DefaultTextStyle(
              style: TextStyle(fontSize: 14, color: deepForest, height: 1.35),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: const [
        ...
        Align(
          ...
          child: Container(
            ...
            child: DefaultTextStyle(
              style: TextStyle(fontSize: 14, color: ivory, height: 1.35),
              child: Column(
        ...
        children: [
          ...
          for (final r in rows)
            Container(
              ...
              decoration: BoxDecoration(
                border: Border(
                  bottom: BorderSide(color: mistSage.withValues(alpha: 0.5)),
                ),
              ),
              child: DefaultTextStyle(
                style: TextStyle(
    ...
    SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          tableCol(
            'PRICE',
            const ['188.42', '143.10', '241.75', '378.22'],
            110,
            TextAlign.right,
            mossGreen,
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: DefaultTextStyle(
              style: TextStyle(fontSize: 13.5, color: deepForest, height: 1.45),
              child: const Text(
    ...
    DefaultTextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          DefaultTextStyle.merge(
            style: TextStyle(color: rustContrast, fontWeight: FontWeight.w700),
            child: const Text(
          ...
          DefaultTextStyle.merge(
            ...
            child: DefaultTextStyle.merge(
              style: TextStyle(color: goldAccent, fontWeight: FontWeight.w700),
              child: const Text(
    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          dataRow(
            'style.fontSize=14',
            'inherited unless child sets fontSize',
            sageGreen,
          ),
          dataRow(
            'style.color=deepForest',
            'inherited unless child sets color',
            sageGreen,
          ),
          dataRow(
            'style.fontWeight=w400',
            'inherited unless child sets fontWeight',
            sageGreen,
          ),
          dataRow(
            'textAlign=start',
            'inherited unless child passes textAlign',
            sageGreen,
          ),
          dataRow(
            'softWrap=true',
            'inherited unless child passes softWrap',
            sageGreen,
          ),
          dataRow(
            'overflow=clip',
            'inherited unless child passes overflow',
            sageGreen,
          ),
          dataRow(
            'maxLines=null',
            'inherited unless child passes maxLines',
            sageGreen,
          ),
        ],
      ),
  ...
  final mergeLayered = cardWrap(
    ...
    DefaultTextStyle(
      style: TextStyle(fontSize: 13, color: deepForest, fontFamily: 'serif'),
      child: Container(
        padding: const EdgeInsets.all(10),
        color: creamMint,
        child: Column(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            width: 220,
            child: DefaultTextStyle(
              style: TextStyle(fontSize: 12, color: deepForest, height: 1.35),
              maxLines: n,
              overflow: TextOverflow.ellipsis,
              child: const Text(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            padding: const EdgeInsets.all(6),
            child: DefaultTextStyle(
              style: TextStyle(fontSize: 13, color: deepForest, height: 1.3),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            padding: const EdgeInsets.all(6),
            child: DefaultTextStyle(
              style: TextStyle(fontSize: 14, color: deepForest, height: 2.0),
              textHeightBehavior: behavior,
              child: const Text(
    ...
    children: [
      ...
      Container(
        ...
        decoration: BoxDecoration(
          color: creamMint,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: sageGreen.withValues(alpha: 0.5)),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(color: palePistachio, fontSize: 12, height: 1.4),
            ),
          ],
        ),
      ),
