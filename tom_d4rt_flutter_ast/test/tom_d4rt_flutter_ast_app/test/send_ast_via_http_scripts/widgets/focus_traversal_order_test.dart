...
dynamic build(BuildContext context) {
  ...
  final conceptPoints = <Map<String, dynamic>>[
    {
      ...
      'body':
          'FocusTraversalOrder is a widget that wraps a focusable '
    ...
    },
    {
      ...
      'title': 'Order Objects',
      'body':
          'The order property takes a FocusOrder subclass. '
    ...
    },
    {
      ...
      'body':
          'FocusTraversalOrder only works inside a '
    ...
    },
    {
      ...
      'body':
          'Explicit traversal order is critical for accessible '
  ...
  final anatomyParts = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The outer widget that attaches an order to its '
    ...
    },
    {
      ...
      'description':
          'A FocusOrder instance that determines where this '
    ...
    },
    {
      ...
      'description':
          'The focusable widget (or subtree containing '
    ...
    },
    {
      ...
      'description':
          'A FocusTraversalGroup with OrderedTraversalPolicy '
    ...
    },
    {
      ...
      'description':
          'The traversal policy that reads FocusTraversalOrder '
  ...
  final comparisonRows = <Map<String, String>>[
    ...
    },
    {
      ...
      'explicit':
          'FocusTraversalOrder annotations '
          '(numbers or strings)',
    },
    {
    ...
    },
    {
      ...
      'default_':
          'Order changes with visual '
          'position (may surprise users)',
      'explicit':
          'Order stays fixed regardless '
          'of layout changes',
    },
    {
      'aspect': 'Best For',
  ...
  final groupPatterns = <Map<String, dynamic>>[
    {
      ...
      'code':
          ...
          ')',
      'description':
          'Simplest pattern — one group with ordered '
    ...
    },
    {
      ...
      'code':
          ...
          ')',
      'description':
          'Each group is traversed completely before '
    ...
    },
    {
      ...
      'code':
          ...
          ')',
      'description':
          'The outer group uses explicit ordering, but a '
  ...
  final customOrderSteps = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.deepPurple[700]!,
      'description':
          'Create a class that extends FocusOrder. '
    ...
    },
    {
      ...
      'color': Colors.purple[600]!,
      'description':
          'Override doCompare(FocusOrder other) and return '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[600]!,
      'description':
          'Pass an instance of your custom FocusOrder to '
    ...
    },
    {
      ...
      'color': Colors.purple[500]!,
      'description':
          'A custom order that sorts by priority (high, '
  ...
  final realWorldPatterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.purple[700]!,
      'body':
          'In a two-column form, the visual order is left-right '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[600]!,
      'body':
          'Give primary actions (Save, Submit) lower order '
    ...
    },
    {
      ...
      'color': Colors.purple[600]!,
      'body':
          'In a confirmation dialog: order 1 = message text, '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[500]!,
      'body':
          'A settings grid shows toggles in a 3×3 layout. '
    ...
    },
    {
      ...
      'color': Colors.purple[500]!,
      'body':
          'Give large order numbers (e.g., 999) to decorative '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'FocusTraversalOrder is IGNORED unless an ancestor '
    ...
    },
    {
      ...
      'body':
          'Don\'t use 1, 2, 3 — use 10, 20, 30. This leaves '
    ...
    },
    {
      ...
      'body':
          'You can read the order assigned to any context with '
    ...
    },
    {
      ...
      'body':
          'All children within a single FocusTraversalGroup '
    ...
    },
    {
      ...
      'body':
          'FocusTraversalOrder only affects keyboard traversal '
    ...
    },
    {
      ...
      'body':
          'The easiest way to verify traversal order: run the '
            ...
            (cp) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(
                    left: BorderSide(color: cp['accent'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
          ...
          ...numericExamples.map(
            (ex) => Padding(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    _orderBadge(ex['order'].toString(), ex['color'] as Color),
                    SizedBox(width: 12),
                    Icon(
                      ex['icon'] as IconData,
            ...
            (gp) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: gp['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (gp['color'] as Color).withOpacity(0.06),
                        borderRadius: BorderRadius.circular(6),
                      ),
                      child: Text(
                        gp['code'] as String,
            ...
            (rp) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: rp['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
