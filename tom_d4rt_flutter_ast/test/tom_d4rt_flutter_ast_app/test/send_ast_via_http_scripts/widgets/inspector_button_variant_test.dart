    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 12, color: moss)),
          ),
        ],
      ),
    );
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: deepPine.withValues(alpha: 0.15),
                width: 1,
              ),
            ),
          ),
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(
                        Icons.touch_app,
                        size: 20,
                        color: evergreen.withValues(alpha: 0.5),
                      ),
                    ),
                    const SizedBox(height: 4),
                    Text(
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text(
                        'Selected',
                        style: TextStyle(fontSize: 8, color: pine),
                      ),
                    ],
                  ),
                  Column(
                    children: [
                      ...
                      Text(
                        'Standard',
                        style: TextStyle(fontSize: 8, color: deepPine),
                      ),
                    ],
                  ),
                  Column(
