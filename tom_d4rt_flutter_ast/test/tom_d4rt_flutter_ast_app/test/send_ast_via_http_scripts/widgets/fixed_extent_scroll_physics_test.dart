...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'FixedExtentScrollPhysics is a ScrollPhysics that '
    ...
    },
    {
      ...
      'body':
          'Every child has the same height (the "item extent"). '
    ...
    },
    {
      ...
      'body':
          'ListWheelScrollView applies FixedExtentScrollPhysics '
    ...
    },
    {
      ...
      'body':
          'FixedExtentScrollPhysics is a standard ScrollPhysics '
  ...
  final snapSteps = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'The user drags or flings the wheel. The scroll '
    ...
    },
    {
      ...
      'detail':
          'The user lifts their finger. The framework asks '
    ...
    },
    {
      ...
      'detail':
          'FixedExtentScrollPhysics calculates the nearest '
    ...
    },
    {
      ...
      'detail':
          'A SpringSimulation is created to animate from the '
    ...
    },
    {
      ...
      'detail':
          'The spring simulation drives the scroll position '
    ...
    },
    {
      ...
      'detail':
          'The simulation completes when the velocity is near '
  ...
  final physicsTypes = <Map<String, dynamic>>[
    {
      ...
      'clamps': false,
      'description':
          'Snaps to item boundaries. Designed for wheel '
    ...
    },
    {
      ...
      'clamps': false,
      'description':
          'iOS-style physics. Allows overscroll with '
    ...
    },
    {
      ...
      'clamps': true,
      'description':
          'Android-style physics. Hard stop at scroll '
    ...
    },
    {
      ...
      'clamps': false,
      'description':
          'Snaps to page boundaries (viewport-sized). '
    ...
    },
    {
      ...
      'clamps': false,
      'description':
          'Disables user scrolling entirely. The scroll '
  ...
  final pipeline = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.green[500]!,
      'description':
          'Entry point. Called when user lifts finger. '
    ...
    },
    {
      ...
      'color': Colors.green[600]!,
      'description':
          'Uses FixedExtentMetrics.itemIndex to determine '
    ...
    },
    {
      ...
      'color': Colors.lightGreen[600]!,
      'description':
          'Multiplies the target item index by the item '
    ...
    },
    {
      ...
      'color': Colors.green[700]!,
      'description':
          'Creates a spring simulation from current '
    ...
    },
    {
      ...
      'description':
          'During active dragging, this translates user '
  ...
  final methods = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The core override. Creates the spring simulation '
    ...
    },
    {
      ...
      'description':
          'Inherited from ScrollPhysics. Translates raw '
    ...
    },
    {
      ...
      'bgColor': Colors.green[50]!,
      'description':
          'Determines behavior at scroll boundaries (start '
    ...
    },
    {
      ...
      'bgColor': Colors.lightGreen[50]!,
      'description':
          'Creates a copy with an optional new parent. '
  ...
  final metricsFields = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.lightGreen[600]!,
      'description':
          'Inherited from ScrollMetrics. The raw pixel '
    ...
    },
    {
      ...
      'color': Colors.green[500]!,
      'description':
          'The minimum scroll offset (usually 0.0). '
    ...
    },
    {
      ...
      'color': Colors.lightGreen[700]!,
      'description':
          'The maximum scroll offset based on total items '
    ...
    },
    {
      ...
      'color': Colors.green[700]!,
      'description':
          'Height of the visible viewport. Determines how '
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.green[600]!,
      'body':
          'When building a custom scrollable (not using '
    ...
    },
    {
      ...
      'color': Colors.lightGreen[600]!,
      'body':
          'FixedExtentScrollPhysics works with any axis. Use '
    ...
    },
    {
      ...
      'color': Colors.green[700]!,
      'body':
          'Sometimes you want snapping except in one region. '
    ...
    },
    {
      ...
      'color': Colors.lightGreen[700]!,
      'body':
          'Use onSelectedItemChanged on ListWheelScrollView to '
    ...
    },
    {
      ...
      'color': Colors.green[800]!,
      'body':
          'Compose FixedExtentScrollPhysics with a parent like '
  ...
  final customizations = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.green[500]!,
      'description':
          'The snap speed is controlled by the spring '
    ...
    },
    {
      ...
      'color': Colors.lightGreen[600]!,
      'description':
          'ScrollPhysics.toleranceFor() determines when '
    ...
    },
    {
      ...
      'color': Colors.green[600]!,
      'description':
          'Override createBallisticSimulation to apply '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'FixedExtentScrollPhysics only works correctly when '
    ...
    },
    {
      ...
      'body':
          'You almost never need to pass FixedExtentScrollPhysics '
    ...
    },
    {
      ...
      'body':
          'During an active drag (finger still on screen), the '
    ...
    },
    {
      ...
      'body':
          'A very fast fling can overshoot the target and then '
    ...
    },
    {
      ...
      'body':
          'While the user is actively scrolling, the scroll '
    ...
    },
    {
      ...
      'body':
          'The most common bug is a very slow release that barely '
