...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'SnapshotController extends ChangeNotifier and controls '
    ...
    },
    {
      ...
      'body':
          'Rasterizing complex widget subtrees into bitmaps avoids '
    ...
    },
    {
      ...
      'body':
          'As a ChangeNotifier, SnapshotController notifies its '
    ...
    },
    {
      ...
      'body':
          'You can toggle snapshotting on/off at runtime. Turn it '
  ...
  final apiEntries = <Map<String, dynamic>>[
    {
      ...
      'description':
          'When true, the SnapshotWidget captures the child '
    ...
    },
    {
      ...
      'type': 'Constructor',
      'description':
          'Creates a new controller. Optional parameter '
    ...
    },
    {
      ...
      'type': 'void',
      'description':
          'Clears any cached snapshot image. The next paint '
    ...
    },
    {
      ...
      'type': 'void (inherited)',
      'description':
          'Register/unregister callbacks invoked when '
  ...
  print(
    '  Controller created: allowSnapshotting=${controller.allowSnapshotting}',
  );
  ...
  final snapshotWidgetInfo = <Map<String, dynamic>>[
    {
      ...
      'code':
          ...
          ')',
      'description':
          'Wraps a child widget. When the controller\'s '
    ...
    },
    {
      ...
      'code':
          ...
          ')',
      'description':
          'The optional painter parameter allows custom '
  ...
  final scenarios = <Map<String, dynamic>>[
    {
      ...
      'description':
          'List items with shadows, gradients, and images '
    ...
    },
    {
      ...
      'description':
          'Snapshot the outgoing page during a route transition '
    ...
    },
    {
      ...
      'description':
          'When a dialog or bottom sheet covers the page, '
    ...
    },
    {
      ...
      'description':
          'Dashboard widgets that update infrequently (charts, '
    ...
    },
    {
      'title': 'Tab Switching',
      'description':
          'Snapshot inactive tabs so they paint cheaply when '
  ...
  final painterInfo = <Map<String, dynamic>>[
    {
      'name': 'paint',
      'description':
          'Called to paint the snapshot. Receives the '
    ...
    },
    {
      'name': 'paintSnapshot',
      'description':
          'Called instead of the default painting when a '
    ...
    },
    {
      'name': 'shouldRepaint',
      'description':
          'Return true when the painter\'s parameters change. '
  ...
  final practices = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'Always dispose the SnapshotController in your State\'s '
    ...
    },
    {
      ...
      'detail':
          'If the child content changes while snapshotting is active, '
    ...
    },
    {
      ...
      'detail':
          'Snapshotted children can\'t update visually (hover, press '
    ...
    },
    {
      ...
      'detail':
          'Each snapshot allocates a raster image in GPU memory. '
    ...
    },
    {
      ...
      'detail':
          'For maximum control, wrap a SnapshotWidget in a '
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        _sectionHeader(
          '3. SnapshotWidget Integration',
          Icons.widgets,
          Colors.green[800]!,
        ),
        SizedBox(height: 10),
        ...snapshotWidgetInfo.map(
          (info) => Padding(
            padding: EdgeInsets.only(bottom: 10),
            child: Container(
              decoration: BoxDecoration(
