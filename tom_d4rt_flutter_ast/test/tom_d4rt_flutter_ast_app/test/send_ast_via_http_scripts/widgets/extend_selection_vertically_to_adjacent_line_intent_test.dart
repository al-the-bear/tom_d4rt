  ...
  Widget vlBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('● ', style: TextStyle(color: vlAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          vlSection('2 · The Vertical Navigation Model', [
            ...
            vlKeyValue(
              'Forward (false)',
              'Extend upward to previous visual line',
            ),
            vlKeyValue(
              'Column affinity',
              'Preserved across consecutive vertical moves',
            ),
          ]),
          ...
          vlSection('6 · Soft-Wrap Line vs Hard-Line', [
            ...
            vlKeyValue(
              'Visual line',
              'One row of rendered text (may be a wrap)',
            ),
          ...
          vlSection('7 · Comparison with Related Intents', [
            vlCompare(
              'MoveSelectionVerticallyToAdjacentLineIntent',
          ...
          vlSection('8 · Keyboard Shortcut Mapping', [
            ...
            vlKeyValue(
              'Web',
              'Shift+Down/Up (Flutter overrides browser default)',
            ),
            vlDivider(),
            vlBullet(
          ...
          vlSection('12 · RTL & Bidirectional Text', [
            ...
            vlKeyValue(
              'Difference',
              'Column affinity X is measured from the right in RTL',
            ),
          ]),
