...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'DraggableScrollableNotification is a notification '
    ...
    },
    {
      ...
      'body':
          'It directly extends Notification (not '
    ...
    },
    {
      ...
      'body':
          'All extent values are fractions of the parent '
    ...
    },
    {
      ...
      'body':
          'Notifications fire during both user-driven drags '
  ...
  final properties = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The current extent of the sheet as a fraction '
    ...
    },
    {
      ...
      'description':
          'The minimum extent the sheet can be dragged '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'description':
          'The maximum extent the sheet can be dragged '
    ...
    },
    {
      ...
      'description':
          'The initial extent when the sheet first '
    ...
    },
    {
      ...
      'description':
          'The build context of the widget that '
  ...
  final derived = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'description':
          'Whether the sheet is fully collapsed at its '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'description':
          'Whether the sheet is fully expanded. At this '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'description':
          'The actual pixel height of the sheet. Multiply '
    ...
    },
    {
      ...
      'description':
          'How far the sheet has moved from its initial '
  ...
  final lifecycle = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[600]!,
      'description':
          'DraggableScrollableSheet is built with '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'description':
          'User touches and drags the sheet handle or '
    ...
    },
    {
      ...
      'color': Colors.brown[700]!,
      'description':
          'Continuous notifications fire as the sheet '
    ...
    },
    {
      ...
      'color': Colors.amber[800]!,
      'description':
          'User lifts finger. If snap=true, the sheet '
    ...
    },
    {
      ...
      'color': Colors.brown[500]!,
      'description':
          'Sheet reaches its final position (a snap '
    ...
    },
    {
      ...
      'description':
          'DraggableScrollableController.animateTo() or '
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[700]!,
      'description':
          'Wrap the sheet (or its ancestor) with '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'description':
          'Attach a DraggableScrollableController and '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'description':
          'Compute normalized progress and use it to '
      ...
      'code':
          'final progress = (n.extent - n.minExtent)\n'
  ...
  final scenarios = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[700]!,
      'description':
          'Google Maps-style bottom sheet showing place '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'description':
          'A draggable now-playing bar. At minExtent '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'description':
          'Sheet shows ride options. Collapsed: summary '
    ...
    },
    {
      ...
      'color': Colors.amber[800]!,
      'description':
          'E-commerce filter sheet. At minExtent, shows '
    ...
    },
    {
      ...
      'color': Colors.brown[500]!,
      'description':
          'A photo editing sheet with adjustment sliders. '
  ...
  final configItems = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.brown[700]!,
      'description':
          'Minimum extent the sheet can be dragged to. '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'description':
          'Maximum extent. The notification\'s maxExtent '
    ...
    },
    {
      ...
      'color': Colors.brown[600]!,
      'description':
          'Where the sheet starts. The notification\'s '
    ...
    },
    {
      ...
      'color': Colors.amber[800]!,
      'description':
          'When true, the sheet snaps to positions '
    ...
    },
    {
      ...
      'color': Colors.brown[500]!,
      'description':
          'List of fractional snap positions between '
    ...
    },
    {
      ...
      'color': Colors.amber[600]!,
      'description':
          'Whether the sheet pops the route when dragged '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'DraggableScrollableNotification does NOT extend '
    ...
    },
    {
      ...
      'body':
          'Notifications fire every frame during a drag (60+ '
    ...
    },
    {
      ...
      'body':
          'DraggableScrollableController.size gives you the '
    ...
    },
    {
      ...
      'body':
          'The notification\'s extent will never exceed maxExtent '
    ...
    },
    {
      ...
      'body':
          'When the sheet is fully expanded, dragging its '
    ...
    },
    {
      ...
      'body':
          'For smooth visual transitions driven by extent, '
          ...
          ...properties.map(
            (prop) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: prop['key'] == true ? Colors.amber[50] : Colors.white,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        _dragTag(prop['type'] as String, Colors.grey[500]!),
                        if (prop['key'] == true) ...[
                          SizedBox(width: 4),
            ...
            (c) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10),
                  border: Border(
                    left: BorderSide(color: c['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        _dragTag('default: ${c['default']}', Colors.grey[500]!),
                      ],
                    ),
                    SizedBox(height: 4),
                    Text(
