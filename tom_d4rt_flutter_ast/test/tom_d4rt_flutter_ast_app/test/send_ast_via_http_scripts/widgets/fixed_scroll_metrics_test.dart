...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'FixedScrollMetrics is a concrete, immutable '
    ...
    },
    {
      ...
      'body':
          'Live ScrollPosition changes constantly during '
    ...
    },
    {
      ...
      'body':
          'ScrollNotification carries a FixedScrollMetrics '
    ...
    },
    {
      ...
      'body':
          'FixedScrollMetrics is ideal for saving "before" and '
  ...
  final coreProps = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The minimum scroll offset. Usually 0.0 for '
    ...
    },
    {
      ...
      'description':
          'The maximum scroll offset. This is '
    ...
    },
    {
      ...
      'description':
          'The size of the viewport along the scroll axis '
    ...
    },
    {
      ...
      'description':
          'Which direction content scrolls. Determines '
  ...
  for (final s in scrollScenarios) {
    ...
    print(
      '  ${s['label']}: extentBefore=${before.toStringAsFixed(0)}, '
  ...
  final notificationPatterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.green[700]!,
      'description':
          'Listen for ScrollNotification and compute '
    ...
    },
    {
      ...
      'color': Colors.lime[800]!,
      'description':
          'Check if metrics.extentAfter is below a '
    ...
    },
    {
      ...
      'color': Colors.green[800]!,
      'description':
          'Store the previous metrics snapshot. Compare '
    ...
    },
    {
      ...
      'color': Colors.green[900]!,
      'description':
          'After scroll ends (ScrollEndNotification), '
  ...
  final scenarios = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.green[700]!,
      'description':
          'Use FixedScrollMetrics to drive AppBar title '
    ...
    },
    {
      ...
      'color': Colors.lime[800]!,
      'description':
          'Log maxScrollExtent + viewportDimension to get '
    ...
    },
    {
      ...
      'color': Colors.green[800]!,
      'description':
          'When metrics.pixels goes below '
    ...
    },
    {
      ...
      'color': Colors.lightGreen[700]!,
      'description':
          'Given two items at known scroll offsets, check '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'For most read-only scroll monitoring, use '
    ...
    },
    {
      ...
      'body':
          'If the content fits entirely within the viewport, '
    ...
    },
    {
      ...
      'body':
          'To simulate how the scroll state would look at a '
    ...
    },
    {
      ...
      'body':
          'On iOS (BouncingScrollPhysics), pixels can be '
    ...
    },
    {
      ...
      'body':
          'The devicePixelRatio in FixedScrollMetrics is the '
    ...
    },
    {
      ...
      'body':
          'Store a previous FixedScrollMetrics and compare with '
        ...
        children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        _fxBadge(prop['type'] as String, Colors.grey[500]!),
                      ],
                    ),
                    SizedBox(height: 6),
                    Text(
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(
                  'Content Layout Along Scroll Axis',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 14,
                ...
                ...diagramParts.map((part) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: (part['color'] as Color).withOpacity(0.4),
                      ),
                      borderRadius: BorderRadius.circular(6),
                    ),
                    child: Row(
