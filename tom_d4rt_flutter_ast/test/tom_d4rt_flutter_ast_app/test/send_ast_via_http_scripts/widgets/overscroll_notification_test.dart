  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'A scroll notification that reports the scroll position '
        ...
        // ── 2. What is it ────────────────────────────────────────────
        sectionHeader(
          '1 \u00b7 What Is OverscrollNotification',
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: deepIndigo.withValues(alpha: 0.3)),
                ),
                child: Text(
        ...
        sectionHeader(
          '2 \u00b7 Scroll Notification Hierarchy',
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Divider(),
                          Text(
                            'Scrolled past the maximum extent '
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Divider(),
                          Text(
                            'Scrolled past the minimum extent '
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              fieldRow(
                'Null when',
                'Overscroll caused by ballistic '
                    'fling, not by active drag',
                violet,
              ),
              fieldRow(
                'Non-null when',
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              fieldRow(
                'Source',
                'From the ballistic simulation or '
                    'drag velocity tracker',
                violet,
              ),
              const SizedBox(height: 8),
              Row(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Gentle overscroll from slow drag or '
                            'scroll near boundary',
                            textAlign: TextAlign.center,
                            style: TextStyle(fontSize: 9, color: darkNavy),
                          ),
                        ],
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Aggressive overscroll from fast fling '
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: [
                      ...
                      accentOrange,
                      indigo,
                    ][i].withValues(alpha: i == 2 || i == 3 ? 0.15 : 0.08),
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                      color: [
                        indigo,
              ...
              for (final phys in [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border(left: BorderSide(color: phys.$4, width: 3)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        row.$2,
                        style: TextStyle(fontSize: 8, color: darkNavy),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(5),
        ...
        sectionHeader(
          '12 \u00b7 Visual: Overscroll at Boundaries',
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'minScrollExtent \u2264 pixels \u2264 maxScrollExtent',
                          style: TextStyle(
                            fontFamily: 'monospace',
                            fontSize: 8,
                            color: accentGreen,
                        ...
                        const SizedBox(height: 6),
                        Text(
                          'ScrollUpdateNotification dispatched here',
                          style: TextStyle(
                            fontSize: 7,
                            fontStyle: FontStyle.italic,
                            color: darkNavy,
          ...
          child: Column(
            children: [
              for (final app in [
                (
                  'Pull-to-refresh',
                  'Monitor negative overscroll amount '
                ...
                (
                  'Scroll analytics',
                  'Track how often users hit boundaries '
                ...
                (
                  ...
                  'Use overscroll amount to drive '
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border(left: BorderSide(color: app.$4, width: 3)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
          ...
          child: Column(
            children: [
              for (final note in [
                ...
                (
                  'Bubble propagation',
                  'Notifications bubble up the entire '
                ...
                (
                  'Type-safe listeners',
                  'Use typed NotificationListener to '
