  ...
  Widget bubbleStep(String step, String name, bool active, Color color) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: active ? color : sage, width: active ? 2 : 1),
      ),
      child: Row(
        children: [
          Container(
          ...
          if (active) Icon(Icons.arrow_upward, size: 14, color: color),
        ],
      ),
    );
  }
