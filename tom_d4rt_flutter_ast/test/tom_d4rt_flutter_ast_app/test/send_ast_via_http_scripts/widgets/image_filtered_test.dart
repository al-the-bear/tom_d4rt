                      ...
                      child: Container(
                        ...
                        child: const Column(
                          ...
                          children: [
                            ...
                            _Bullet(
                              text:
                                  'ImageFiltered affects only its child rendering output.',
                            ),
                            _Bullet(
                              text:
                                  'enabled=false bypasses filtering without replacing the widget.',
                            ),
                            _Bullet(
                              text:
                                  'No-op filters are still treated as active filters by design.',
                            ),
                            _Bullet(
                              text:
                                  'Use localized placement around only the visual subtree you need.',
                            ),
                          ],
                        ),
                      ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _InfoLine(
                            label: 'blur sigma',
                            value: _sigma.toStringAsFixed(2),
                          ),
                          _InfoLine(
                            label: 'rotation(rad)',
                            value: _rotation.toStringAsFixed(3),
                          ),
                          _InfoLine(
                            label: 'complex child',
                            value: '$_heavyChild',
            ...
            child: _GuideStage(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      _matrixMode ? 'Matrix output' : 'Blur output',
                      style: const TextStyle(fontWeight: FontWeight.w800),
                    ),
                    const SizedBox(height: 8),
                    Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _LabeledSlider(
                      ...
                      min: 0,
                      max: 16,
                      onChanged: (v) => setState(() => _radiusX = v),
                    ),
                    _LabeledSlider(
                      label: 'radiusY',
                      value: _radiusY,
                      min: 0,
                      max: 16,
                      onChanged: (v) => setState(() => _radiusY = v),
                    ),
                    SwitchListTile(
                      dense: true,
                      contentPadding: EdgeInsets.zero,
                      ...
                      child: Container(
                        ...
                        child: const Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 6),
                            _Bullet(
                              text: 'Dilate expands bright/opaque regions.',
                            ),
                            _Bullet(
                              text: 'Erode contracts bright/opaque regions.',
                            ),
                            _Bullet(
                              text:
                                  'Morphology can create stylized emphasis or erosion effects.',
                            ),
                            _Bullet(
                              text:
                                  'Apply selectively: overuse can reduce readability.',
                            ),
                          ],
                        ),
                      ),
      ...
      child: const Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 4),
            Text(
              'Visual edge sculpting with ImageFilter morphology.',
              style: TextStyle(fontSize: 13, color: Color(0xFF42586A)),
            ),
            Spacer(),
            Text(
              'Use for stylization, not for primary legibility paths.',
              style: TextStyle(fontSize: 12, color: Color(0xFF5C7080)),
            ),
          ],
        ),
      ),
...
class _ComposeAnimationSceneState extends State<_ComposeAnimationScene>
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 6),
                            Text(
                              _pipelineDescription(_pipeline),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(10),
                                border: Border.all(
                                  color: _cBlue.withValues(alpha: 0.3),
                                ),
                              ),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          Expanded(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(10),
                                border: Border.all(
                                  color: _cViolet.withValues(alpha: 0.3),
                                ),
                              ),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  ui.ImageFilter _composedFilter(int pipeline, double t) {
    ...
    final dilate = ui.ImageFilter.dilate(
      radiusX: 1 + (t * 4),
      radiusY: 1 + (t * 4),
    );
    final erode = ui.ImageFilter.erode(
      radiusX: 1 + (t * 2),
      radiusY: 1 + (t * 2),
    );
                      ...
                      child: Container(
                        ...
                        child: const Column(
                          ...
                          children: [
                            ...
                            _Bullet(
                              text:
                                  'Prefer smallest practical scope for filter application.',
                            ),
                            _Bullet(
                              text:
                                  'Wrap only selected cards when emphasizing one target.',
                            ),
                            _Bullet(
                              text:
                                  'Whole-section filtering can be useful for transition states.',
                            ),
                            _Bullet(
                              text:
                                  'Keep text legibility in mind when choosing sigma values.',
                            ),
                          ],
                        ),
                      ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Expanded(child: _buildSection(filter)),
                    const SizedBox(height: 8),
                    Container(
                      width: double.infinity,
                      padding: const EdgeInsets.all(10),
...
const _scopeCards = <_ScopeItem>[
  _ScopeItem(
    'Telemetry',
    'Signal drift and trend quality.',
    Icons.query_stats,
    _cBlue,
  ),
  ...
  _ScopeItem(
    'Release',
    'Rollout progression controls.',
    Icons.rocket_launch,
    _cCoral,
  ),
  _ScopeItem(
    'Routing',
    'Path balancing and queue flow.',
    Icons.route,
    _cViolet,
  ),
  _ScopeItem(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(10),
        border: Border.all(
          color: item.color.withValues(alpha: focused ? 0.5 : 0.3),
          width: focused ? 2 : 1,
        ),
      ),
      child: Column(
...
class _PracticalBoardSceneState extends State<_PracticalBoardScene> {
  ...
  Widget _heroZone(_BoardProfile profile) {
    ...
    Widget content = Padding(
      ...
      child: Column(
        children: [
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    profile.color.withValues(alpha: 0.18),
          ...
          Text(
            'Hero visual lane',
            style: TextStyle(color: profile.color, fontWeight: FontWeight.w800),
          ),
        ],
      ),
    );
    ...
    return Container(
      decoration: const BoxDecoration(
        border: Border(right: BorderSide(color: Color(0xFFD7E2ED))),
      ),
      child: content,
    );
  }
  ...
  Widget _rightColumn(_BoardProfile profile) {
    ...
    if (_alertFiltered) {
      alerts = ImageFiltered(
        imageFilter: alertFilter,
        enabled: _enabled,
        child: alerts,
      );
    }
    ...
    if (_miniFiltered) {
      miniMap = ImageFiltered(
        imageFilter: miniFilter,
        enabled: _enabled,
        child: miniMap,
      );
    }
    ...
    return Container(
      decoration: const BoxDecoration(
        border: Border(left: BorderSide(color: Color(0xFFD7E2ED))),
      ),
      child: Padding(
        padding: const EdgeInsets.all(8),
        child: Column(
      ...
      child: Row(
        children: [
          ...
          Text(
            ...
            style: const TextStyle(fontSize: 11, color: Color(0xFF5A6E7F)),
          ),
        ],
      ),
    );
...
const _boardProfiles = <_BoardProfile>[
  _BoardProfile(
    ...
    tiles: [
      _TileData(
        'Roadmap',
        'Milestone map and dependency weave.',
        Icons.alt_route,
        _cBlue,
      ),
      _TileData(
        'Queue',
        'Build throughput and lane occupancy.',
        Icons.layers,
        _cTeal,
      ),
      _TileData(
        'Risk',
        'Escalation watch and confidence lanes.',
        Icons.warning_amber,
        _cCoral,
      ),
      _TileData(
        'Metrics',
        'Signal drift and trend narrative.',
        Icons.query_stats,
        _cViolet,
      ),
      _TileData(
      ...
      _TileData(
        'Design',
        'Visual token consistency status.',
        Icons.palette,
        _cNight,
      ),
    ],
  ...
  _BoardProfile(
    ...
    tiles: [
      _TileData(
        'Outage',
        'Primary incident timeline board.',
        Icons.crisis_alert,
        _cCoral,
      ),
      _TileData(
      ...
      _TileData(
        'Repair',
        'Data and API remediation tracks.',
        Icons.auto_fix_high,
        _cOlive,
      ),
      _TileData(
        'Closure',
        'Postmortem and recovery report.',
        Icons.task_alt,
        _cNight,
      ),
    ],
  ...
  _BoardProfile(
    ...
    tiles: [
      _TileData(
        'Tokens',
        'Color and type token alignment.',
        Icons.style,
        _cViolet,
      ),
      _TileData(
        'Components',
        'State matrix consistency pass.',
        Icons.widgets,
        _cBlue,
      ),
      _TileData(
        'Motion',
        'Animation pacing quality checks.',
        Icons.animation,
        _cTeal,
      ),
      _TileData(
        'Contrast',
        'Readability and ratio auditing.',
        Icons.visibility,
        _cOlive,
      ),
      _TileData(
        'Localization',
        'Directionality and truncation checks.',
        Icons.translate,
        _cCoral,
      ),
      _TileData(
        'Signoff',
        'Approval queue and readiness.',
        Icons.verified,
        _cNight,
      ),
    ],
    alerts: [
      _AlertData(
        'Contrast',
        'Two label pairs below threshold.',
        Icons.visibility_off,
        _cCoral,
      ),
      _AlertData(
        'Token Drift',
        'Unmapped semantic token found.',
        Icons.error_outline,
        _cViolet,
      ),
...
class _DecorativeArt extends StatelessWidget {
  const _DecorativeArt({
    required this.rotation,
    required this.heavy,
    required this.showOverlayText,
  });
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            Transform.rotate(
              angle: rotation,
              child: CustomPaint(painter: _ArtPainter(heavy: heavy)),
            ),
            if (showOverlayText)
              Align(
...
class _ArtPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double y = 14; y < size.height; y += 22) {
      canvas.drawLine(
        Offset(0, y),
        Offset(size.width, y + (math.sin(y / 20) * 6)),
        line,
      );
    }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 6; i++) {
      ...
      for (double x = 0; x <= size.width; x += 8) {
        final y =
            yBase + math.sin((x / 30) + (i * 0.7) + (seed * 0.2)) * (8 + i * 2);
        path.lineTo(x, y);
      }
            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    'inner -> outer',
                    style: TextStyle(fontSize: 12, color: Color(0xFF4B5F71)),
                  ),
                ],
              ),
            ),
      ...
      child: Column(
        ...
        children: [
          ...
          if (events.isEmpty)
            const Text(
              'No interactions yet.',
              style: TextStyle(color: Color(0xFF5E7283)),
            )
          else
            ...events.map(
              (line) => Padding(
