...
dynamic build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isLast
            ? [
                BoxShadow(
                  color: _dbPrimary.withValues(alpha: 0.15),
                  blurRadius: 6.0,
      ...
      child: Row(
        children: [
          Icon(
            isLast ? Icons.star : Icons.circle_outlined,
            color: isLast ? _dbAccent : _dbMuted,
            size: 18.0,
          ),
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: isLast ? _dbPrimary : _dbDark,
                  ),
                ),
                Text(
                  c['note']!,
  ...
  final existingSelScenarios = <Map<String, String>>[
    ...
    },
    {
      ...
      'note':
          'Extent crosses back behind the base, resulting in a backward selection.',
    },
    {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: _dbPrimary.withValues(alpha: 0.04),
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: _dbPrimary.withValues(alpha: 0.06),
            borderRadius: BorderRadius.circular(6.0),
          ),
          child: Row(
            children: [
  ...
  final flowSteps = <Map<String, String>>[
    {
      'step': '1',
      'title': 'Shortcut fired',
      'detail': 'Ctrl+Shift+End triggers the Shortcuts widget activator.',
    },
    {
      'step': '2',
      'title': 'Intent created',
      'detail':
          'ExtendSelectionToDocumentBoundaryIntent(forward: true) is instantiated.',
    },
    {
      'step': '3',
      'title': 'Action lookup',
      'detail': 'Actions widget walks up the tree for a matching action.',
    },
    {
      'step': '4',
      'title': 'Document length read',
      'detail':
          'The action reads controller.text.length (or 0) for the boundary offset.',
    },
    {
      'step': '5',
      'title': 'Extent moved',
      'detail':
          'controller.selection.copyWith(extentOffset: boundary) applied.',
    },
    {
      'step': '6',
      'title': 'Scroll + repaint',
      'detail':
          'RenderEditable repaints the highlight; scrollable makes extent visible.',
    },
  ];
          ...
          children: [
            ...
            if (!isLast)
              Container(
                width: 2.0,
                height: 30.0,
                color: _dbMuted.withValues(alpha: 0.3),
              ),
          ],
        ),
    ...
    child: Column(
      ...
      children: [
        ...
        for (int i = 0; i < flowSteps.length; i++)
          dbFlowStep(flowSteps[i], i == flowSteps.length - 1),
      ],
    ),
  );
  ...
  Widget dbFamilyRow(Map<String, String> f, int idx) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelf
            ? _dbHighlight.withValues(alpha: 0.15)
            : idx.isEven
            ? _dbLight.withValues(alpha: 0.4)
            : Colors.white,
        borderRadius: BorderRadius.circular(6.0),
        border: isSelf
            ? Border.all(color: _dbAccent.withValues(alpha: 0.4))
            : null,
      ),
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Text(
              f['range']!,
              style: TextStyle(fontSize: 11.0, color: _dbAccent),
            ),
          ),
          Expanded(
            flex: 2,
            child: Text(
              f['moves']!,
              style: TextStyle(fontSize: 11.0, color: _dbMuted),
            ),
          ),
        ],
      ),
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'desc':
          'Common in code editors to select all text below the caret for deletion or copy.',
      'code':
          'Actions.invoke<ExtendSelectionToDocumentBoundaryIntent>(\n'
          '  context,\n'
    ...
    },
    {
      ...
      'desc':
          'Override to stop at section markers (e.g. ---) instead of the true document boundary.',
      'code':
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            padding: const EdgeInsets.all(12.0),
            decoration: BoxDecoration(
              color: _dbDark.withValues(alpha: 0.05),
              borderRadius: BorderRadius.circular(8.0),
            ),
            child: Text(
              p['code'] as String,
  ...
  final edgeCases = <Map<String, String>>[
    {
      'case': 'Empty document, forward=true',
      'result': 'No movement. offset stays 0.',
    },
    {
      'case': 'Extent already at doc end',
      'result': 'No change — already at boundary.',
    },
    {
      'case': 'Single character document',
      'result': 'Extent moves to 0 or 1 as expected.',
    },
    {
      'case': 'Very long document (100k chars)',
      'result': 'Selection covers all text; scrollable adjusts in one step.',
    },
    {
      'case': 'RTL text',
      'result': 'forward still means higher offset (logical end).',
    },
    {
      'case': 'Mixed LTR/RTL',
      'result':
          'Logical offsets are used; visual ordering does not affect boundary calc.',
    },
  ];
  ...
  final summarySection = Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [
          _dbPrimary.withValues(alpha: 0.08),
          _dbLight.withValues(alpha: 0.5),
        ],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
