...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'DismissUpdateDetails is an immutable data class that '
    ...
    },
    {
      ...
      'body':
          'Unlike onDismissed (fires once at the end), onUpdate '
    ...
    },
    {
      ...
      'body':
          'The direction property reports the active swipe '
    ...
    },
    {
      ...
      'body':
          'The reached property is true when the swipe has '
  ...
  final properties = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'The direction the Dismissible is currently being '
    ...
    },
    {
      ...
      'detail':
          'A value from 0.0 to 1.0 representing how far '
    ...
    },
    {
      ...
      'detail':
          'Whether the current progress has passed the dismiss '
    ...
    },
    {
      ...
      'detail':
          'Whether the dismiss threshold was reached in the '
  ...
  final lifecycle = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.orange[700]!,
      'detail':
          'GestureDetector inside Dismissible recognizes a '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'detail':
          'The user moves their finger. Dismissible calculates '
    ...
    },
    {
      ...
      'color': Colors.orange[600]!,
      'detail':
          'For every pointer-move event, Dismissible recomputes '
    ...
    },
    {
      ...
      'color': Colors.amber[600]!,
      'detail':
          'When progress exceeds the threshold (default 0.4), '
    ...
    },
    {
      ...
      'detail':
          'If reached is true → the item animates to full '
    ...
    },
    {
      ...
      'detail':
          'The last onUpdate call has progress = 0.0 (snap-back) '
  ...
  final thresholdCode = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.amber[600]!,
      'code':
          '// If dismissThresholds is empty or\n'
  ...
  final relationship = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.orange[700]!,
      'desc':
          'The parent widget that hosts the gesture. It wraps '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'desc':
          'void Function(DismissUpdateDetails)? — called with '
    ...
    },
    {
      ...
      'color': Colors.orange[600]!,
      'desc':
          'void Function(DismissDirection)? — called once after '
    ...
    },
    {
      ...
      'color': Colors.amber[600]!,
      'desc':
          'Future<bool?> Function(DismissDirection)? — called '
    ...
    },
    {
      ...
      'color': Colors.orange[500]!,
      'desc':
          'Widgets shown behind the child during swipe. '
  ...
  final mistakes = <Map<String, dynamic>>[
    {
      ...
      'icon': Icons.error,
      'body':
          'onDismissed fires AFTER the dismiss animation. At that '
    ...
    },
    {
      ...
      'icon': Icons.warning,
      'body':
          'onUpdate fires ~60 times per second. Avoid expensive '
    ...
    },
    {
      ...
      'icon': Icons.info,
      'body':
          'Many developers only check "reached" and miss the '
    ...
    },
    {
      ...
      'icon': Icons.error,
      'body':
          'Each Dismissible MUST have a unique Key (usually '
    ...
    },
    {
      ...
      'icon': Icons.info,
      'body':
          'progress ranges 0.0–1.0, so it can be used as opacity. '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'The main value of DismissUpdateDetails is enabling '
    ...
    },
    {
      ...
      'body':
          'The most satisfying UX pattern: when reached becomes '
    ...
    },
    {
      ...
      'body':
          'Since onUpdate fires every frame, each call should '
    ...
    },
    {
      ...
      'body':
          'Use onUpdate for visual feedback during the drag, '
    ...
    },
    {
      ...
      'body':
          'Test your onUpdate handler with very slow drags to '
    ...
    },
    {
      ...
      'body':
          'If the user reverses their swipe, progress goes down. '
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _duTag(p['name'] as String, p['color'] as Color),
                        SizedBox(width: 8),
                        Text(
                          p['type'] as String,
                          style: TextStyle(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(color: d['color'] as Color),
                      ),
                      child: Center(
                        child: Text(
                          d['visual'] as String,
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _duTag(d['dir'] as String, d['color'] as Color),
                          SizedBox(height: 4),
                          Text(
                            d['desc'] as String,
                            style: TextStyle(
