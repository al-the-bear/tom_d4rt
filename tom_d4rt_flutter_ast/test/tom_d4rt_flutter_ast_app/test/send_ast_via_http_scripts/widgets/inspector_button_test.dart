    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: TextStyle(fontSize: 12, color: caramel)),
          ),
        ],
      ),
    );
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: deepAmber.withValues(alpha: 0.15),
                width: 1,
              ),
            ),
          ),
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            dataRow(
              'Type',
              'OverlayEntry or custom CompositedTransformFollower',
            ),
