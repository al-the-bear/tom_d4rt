...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'FocusHighlightStrategy is an enum that tells the '
    ...
    },
    {
      ...
      'title': 'Three Choices',
      'body':
          'You can let Flutter auto-detect from input events '
    ...
    },
    {
      ...
      'body':
          'FocusHighlightStrategy is set on the FocusManager '
    ...
    },
    {
      ...
      'body':
          'Strategy is the RULE (how to decide). Mode is the '
  ...
  final enumValues = <Map<String, dynamic>>[
    {
      ...
      'shortLabel': 'DEFAULT',
      'description':
          'The highlight mode is determined automatically '
      ...
      'behavior':
          'Mode flips dynamically as the user switches '
      ...
      'useCase':
          'Almost every app. Let Flutter handle the '
    ...
    },
    {
      ...
      'shortLabel': 'FORCED',
      'description':
          'Forces FocusHighlightMode.touch regardless '
      ...
      'behavior':
          'All focusable widgets suppress their highlight '
      ...
      'useCase':
          'Kiosk apps with only touchscreen input. '
    ...
    },
    {
      ...
      'shortLabel': 'FORCED',
      'description':
          'Forces FocusHighlightMode.traditional '
      ...
      'behavior':
          'Every focused widget shows its highlight '
      ...
      'useCase':
          'TV/set-top box apps with d-pad navigation. '
  ...
  final pipeline = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'detail':
          'User touches screen, presses key, or moves '
    ...
    },
    {
      ...
      'detail':
          'If automatic: input type maps to mode (touch → '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[700]!,
      'detail':
          'FocusManager.instance.highlightMode changes to '
    ...
    },
    {
      ...
      'color': Colors.indigo[800]!,
      'detail':
          'Focused widgets rebuild and check the mode. '
  ...
  final platformScenarios = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Automatic detects all interactions as touch. '
    ...
    },
    {
      ...
      'recommended': 'automatic',
      'description':
          'Automatic seamlessly switches between touch '
    ...
    },
    {
      ...
      'recommended': 'automatic',
      'description':
          'Automatic stays in traditional mode since '
    ...
    },
    {
      ...
      'description':
          'Force alwaysTraditional. Remote control d-pad '
    ...
    },
    {
      ...
      'description':
          'Force alwaysTouch. No keyboard will ever be '
    ...
    },
    {
      ...
      'recommended': 'alwaysTraditional',
      'description':
          'Temporarily force alwaysTraditional during '
  ...
  final codePatterns = <Map<String, dynamic>>[
    {
      ...
      'code':
          ...
          '        .highlightStrategy;',
      'description':
          'Access the FocusManager singleton to read '
    ...
    },
    {
      ...
      'code':
          ...
          '}',
      'description':
          'Set strategy once in main() before runApp. '
    ...
    },
    {
      ...
      'code':
          ...
          '}',
      'description':
          'Strategy can be changed at any time. The '
    ...
    },
    {
      ...
      'code':
          ...
          '  );',
      'description':
          'Register a callback that fires when the '
  ...
  final relatedApis = <Map<String, dynamic>>[
    {
      ...
      'relationship': 'Output',
      'description':
          'The RESULT of the strategy. Strategy is the '
    ...
    },
    {
      ...
      'relationship': 'Owner',
      'description':
          'Holds both the strategy and the computed '
    ...
    },
    {
      ...
      'description':
          'Individual focus nodes query the mode '
    ...
    },
    {
      ...
      'relationship': 'Consumer',
      'description':
          'Material widgets use the computed mode '
    ...
    },
    {
      ...
      'description':
          'Sometimes confused with highlight strategy. '
  ...
  final pitfalls = <Map<String, dynamic>>[
    {
      ...
      'bad':
          'Trying to set different strategies for different '
          'parts of the widget tree. Strategy is global — it '
          'applies to the entire app.',
      'good':
          'Set strategy once in main() or in your app\'s '
    ...
    },
    {
      ...
      'bad':
          'Checking FocusHighlightStrategy.automatic to '
          'determine if highlights should show. Strategy tells '
          'you the RULE, not the current state.',
      'good':
          'Check FocusManager.instance.highlightMode to see '
    ...
    },
    {
      ...
      'bad':
          'Using alwaysTouch on a desktop app, then wondering '
          'why keyboard users can\'t see which element has focus.',
      'good':
          'Only use alwaysTouch when you\'re certain no '
    ...
    },
    {
      ...
      'bad':
          'Developing only with automatic and never checking '
          'how your app looks in alwaysTraditional mode.',
      'good':
          'During QA, temporarily set alwaysTraditional to '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'FocusHighlightStrategy.automatic is the default '
    ...
    },
    {
      ...
      'body':
          'Add an accessibility toggle in your settings that '
    ...
    },
    {
      ...
      'body':
          'When you change the strategy, the mode updates '
    ...
    },
    {
      ...
      'body':
          'On Android TV and Apple TV, the remote sends key '
    ...
    },
    {
      ...
      'body':
          'Strategy controls highlight visibility. '
    ...
    },
    {
      ...
      'body':
          'Emulator input may not accurately represent real '
            ...
            (pit) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: pit['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(
                          pit['icon'] as IconData,
                          color: pit['color'] as Color,
                          size: 20,
                        ),
                        SizedBox(width: 8),
                        Expanded(
