  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        sectionBanner(
          '2 · Concept Overview',
          'Understanding lexical focus ordering',
          goldenrod,
          Colors.white,
        ),
        noteBox(
        ...
        sectionBanner(
          '3 · Basic Creation',
          'Creating LexicalFocusOrder instances',
          warmSaffron,
          Colors.white,
        ),
        noteBox(
        ...
        sectionBanner(
          '4 · Multi-Character Ordering',
          'How longer strings compare',
          marigold,
          Colors.white,
        ),
        noteBox(
        ...
        // ── 5. Numerical strings ─────────────────────────────────────
        sectionBanner(
          '5 · Numerical String Gotcha',
          'Why "10" sorts before "2"',
          sunflower,
          deepGold,
        ),
        noteBox(
        ...
        sectionBanner(
          '7 · Special Character Ordering',
          'Punctuation and symbols in order strings',
          goldenrod,
          Colors.white,
        ),
        noteBox(
        ...
        sectionBanner(
          '10 · FocusTraversalOrder Widget',
          'Assigning order to widget subtrees',
          goldenrod,
          Colors.white,
        ),
        noteBox(
        ...
        // ── 11. Sorting demo ─────────────────────────────────────────
        sectionBanner(
          '11 · Sorting Demonstration',
          'Visualizing lexical sort order',
          marigold,
          Colors.white,
        ),
        noteBox(
        ...
        // ── 13. Unicode patterns ─────────────────────────────────────
        sectionBanner(
          '13 · Unicode Character Behavior',
          'International characters in order strings',
          buttercup,
          deepGold,
        ),
        noteBox(
        ...
        sectionBanner(
          '15 · Lexical vs Numeric Ordering',
          'Comparing the two built-in FocusOrder types',
          warmSaffron,
          Colors.white,
        ),
        noteBox(
        ...
        sectionBanner(
          '16 · Summary Dashboard',
          'LexicalFocusOrder metrics and patterns',
          deepGold,
          Colors.white,
        ),
        Wrap(
