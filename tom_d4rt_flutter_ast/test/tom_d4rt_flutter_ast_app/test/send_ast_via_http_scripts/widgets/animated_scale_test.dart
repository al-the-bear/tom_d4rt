...
dynamic build(BuildContext context) {
  return MaterialApp(theme: ThemeData.light(), home: const AnimatedScaleDemo());
}
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: () {
                    ...
                    print(
                      'Curve demo: scale down with ${_curves[_curveIndex].key}',
                    );
                  },
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    ...
                    print(
                      'Curve demo: normal with ${_curves[_curveIndex].key}',
                    );
                  },
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    ...
                    print(
                      'Curve demo: scale up with ${_curves[_curveIndex].key}',
                    );
                  },
          ...
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () {
                ...
                print(
                  'Alignment demo: scale $_alignScale from ${_alignmentNames[_alignmentIndex]}',
                );
              },
              ...
              children: List.generate(3, (index) {
                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    print(
                      'Card ${index + 1} ${isSelected ? 'deselected' : 'selected'}',
                    );
                  },
                  child: AnimatedScale(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildEdgeCaseItem(
              'Scale 0',
              'Widget becomes invisible but still occupies space',
            ),
            _buildEdgeCaseItem(
              'Negative scale',
              'Results in mirroring (not recommended)',
            ),
            _buildEdgeCaseItem(
              'Very large scale',
              'May cause overflow - use ClipRect',
            ),
