  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'DismissAction is a built-in Action that handles DismissIntent. '
    ...
    },
    {
      ...
      'body':
          'Flutter\'s default keyboard shortcuts map the Escape key '
    ...
    },
    {
      ...
      'body':
          'Many Flutter widgets install their own DismissAction '
    ...
    },
    {
      ...
      'body':
          'You can override DismissAction at any point in the widget '
  ...
  final apiProperties = <Map<String, dynamic>>[
    {
      ...
      'description':
          'A simple intent with no parameters. Represents the '
    ...
    },
    {
      ...
      'description':
          'The Action that handles DismissIntent. The default '
    ...
    },
    {
      ...
      'description':
          'A specialized DismissAction variant used by menu '
  ...
  final usageContexts = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.red[700]!,
      'dismiss':
          'Pops the dialog route. Returns null from the '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[600]!,
      'dismiss':
          'Closes the bottom sheet route. Equivalent to '
    ...
    },
    {
      ...
      'color': Colors.red[600]!,
      'dismiss':
          'Closes the popup menu without selecting an item. '
    ...
    },
    {
      ...
      'dismiss':
          'Closes the drawer. Scaffold registers an action '
    ...
    },
    {
      ...
      'dismiss':
          'Hides the tooltip overlay. Tooltips register their '
    ...
    },
    {
      ...
      'dismiss':
          'Closes the dropdown list without changing selection. '
  ...
  final flowSteps = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The keyboard event is captured by the Shortcuts '
    ...
    },
    {
      ...
      'description':
          'The Actions system walks up the widget tree from '
    ...
    },
    {
      ...
      'description':
          'The found DismissAction calls ModalRoute.of(context)'
    ...
    },
    {
      ...
      'description':
          'maybePop() pops the top route if it can be popped. '
    ...
    },
    {
      ...
      'description':
          'After the overlay is removed, focus returns to '
  ...
  final platformBehaviors = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.red[700]!,
      'behavior':
          'Escape key is the primary dismiss trigger. All dialogs, '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[600]!,
      'behavior':
          'Same as desktop — Escape key generates DismissIntent. '
    ...
    },
    {
      ...
      'color': Colors.red[600]!,
      'behavior':
          'The system Back button/gesture generates a PopRoute '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[700]!,
      'behavior':
          'iOS has no Escape key on touch devices. DismissAction '
  ...
  final overridePatterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.red[700]!,
      'code':
          '// Ask user before closing a dialog with\n'
          '// unsaved changes:\n'
          'Actions(\n'
          '  actions: {\n'
    ...
    },
    {
      ...
      'color': Colors.deepOrange[600]!,
      'code':
          '// Prevent Escape from closing a mandatory\n'
    ...
    },
    {
      ...
      'color': Colors.red[600]!,
      'code':
          '// Trigger a custom exit animation before\n'
          '// actually closing:\n'
          'Actions(\n'
          '  actions: {\n'
          '    DismissIntent: CallbackAction<DismissIntent>(\n'
    ...
    },
    {
      ...
      'color': Colors.deepOrange[700]!,
      'code':
          '// Return a specific value when dismissing:\n'
          'Actions(\n'
          '  actions: {\n'
          '    DismissIntent: CallbackAction<DismissIntent>(\n'
          '      onInvoke: (intent) {\n'
  ...
  final relatedActions = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.red[700]!,
      'description':
          'Specialized DismissAction for menus. Closes the menu '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[600]!,
      'description':
          'The opposite gesture — activates/selects the currently '
    ...
    },
    {
      ...
      'color': Colors.red[600]!,
      'description':
          'Handles scroll intents from keyboard (Page Up/Down, '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[700]!,
      'description':
          'Moves focus directionally (arrow keys). Within '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'DismissAction is automatically registered by MaterialApp/'
    ...
    },
    {
      ...
      'body':
          'DismissAction uses maybePop(), not pop(). This means '
    ...
    },
    {
      ...
      'body':
          'In widget tests, simulate Escape key press with '
    ...
    },
    {
      ...
      'body':
          'When overlays are nested (e.g., a dialog opens a dropdown), '
    ...
    },
    {
      ...
      'body':
          'DismissAction reports isEnabled: false if there is no '
    ...
    },
    {
      ...
      'body':
          'Use PopScope (Flutter 3.16+) alongside DismissAction. '
          ...
          Container(
            ...
            child: Column(
              children: flowSteps.map((fs) {
                final isLast = fs['step'] == flowSteps.last['step'];
                return Column(
                  children: [
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
            ...
            (pb) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: pb['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(
                          pb['icon'] as IconData,
                          color: pb['color'] as Color,
                          size: 18,
                        ),
                        SizedBox(width: 8),
                        Expanded(
                          child: Text(
                            pb['platform'] as String,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 13,
                            ),
            ...
            (op) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: op['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
            ...
            (ra) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: ra['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
