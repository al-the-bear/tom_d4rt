...
dynamic build(BuildContext context) {
  ...
  print(
    'Constructor: OrderedTraversalPolicy({secondary, requestFocusCallback})',
  );
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'The only FocusTraversalPolicy that respects '
        ...
        sectionBanner(
          '1 \u00b7 What Is OrderedTraversalPolicy',
        ...
        dataRow(
          'Defined in',
          'widgets/focus_traversal.dart line 1882',
          darkForest,
        ),
              ...
              for (final level in [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border(left: BorderSide(color: level.$2, width: 2)),
                  ),
                  child: Text(
                    level.$1,
                    style: TextStyle(
        ...
        sectionBanner(
          '3 \u00b7 The sortDescendants() Algorithm',
        ...
        sectionBanner(
          '4 \u00b7 Setting Up With FocusTraversalGroup',
        ...
        Container(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: deepJuniper.withValues(alpha: 0.3)),
            ),
            child: Text(
              'FocusTraversalGroup(\n'
        ...
        sectionBanner(
          '5 \u00b7 Live Demo: Ordered vs Unordered Nodes',
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(6),
                    border: Border(
                      left: BorderSide(color: accentBrown, width: 3),
                    ),
                  ),
                  child: Row(
                    children: [
                ...
                FocusTraversalOrder(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(6),
                      border: Border(left: BorderSide(color: spruce, width: 3)),
                    ),
                    child: Row(
                      children: [
                        Container(
                ...
                FocusTraversalOrder(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(6),
                      border: Border(
                        left: BorderSide(color: deepJuniper, width: 3),
                      ),
                    ),
                    child: Row(
                      children: [
                ...
                FocusTraversalOrder(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(6),
                      border: Border(
                        left: BorderSide(color: juniper, width: 3),
                      ),
                    ),
                    child: Row(
                      children: [
        ...
        sectionBanner(
          '6 \u00b7 Configuring the Secondary Policy',
              ...
              for (final sec in [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border(left: BorderSide(color: sec.$4, width: 3)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
              ...
              for (final row in [
                ...
                TableRow(
                  decoration: row.$1 == 'Ordered'
                      ? BoxDecoration(color: juniper.withValues(alpha: 0.06))
                      : null,
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(8),
                      child: Text(
                        '${row.$1}TraversalPolicy',
                        style: TextStyle(
                          fontFamily: 'monospace',
                          fontSize: 9,
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                          color: row.$3 == 'Yes' ? accentIndigo : accentBrown,
                        ),
                      ),
                    ),
                  ],
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.arrow_forward, size: 20, color: accentIndigo),
                      const SizedBox(height: 4),
                      Text(
                        'Arrow Keys',
                        style: TextStyle(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: spruce.withValues(alpha: 0.06),
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: spruce.withValues(alpha: 0.3)),
                ),
                child: Text(
        ...
        // ── 11. Nested groups ────────────────────────────────────────
        sectionBanner(
          '10 \u00b7 Nested FocusTraversalGroups',
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Outer Group (OrderedTraversalPolicy)',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 11,
                        color: deepJuniper,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Nodes sorted within this scope',
                            style: TextStyle(fontSize: 10, color: darkForest),
                          ),
                        ],
                      ),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: juniper.withValues(alpha: 0.06),
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: juniper.withValues(alpha: 0.3)),
                ),
                child: Text(
                  'OrderedTraversalPolicy(\n'
        ...
        sectionBanner(
          '12 \u00b7 Live Demo: Form With Mixed Ordering',
          ...
          child: Column(
            children: [
              for (final perf in [
                (
                  'Sort cost',
                  'O(n log n) mergeSort on ordered nodes',
                  Icons.sort,
                  juniper,
                ),
                (
                  'Secondary sort',
                  'O(n log n) on all nodes before split',
                  Icons.low_priority,
                  spruce,
                ),
                (
                ...
                (
                  'Memory',
                  'Two temporary lists (ordered + unordered)',
                  Icons.memory,
                  accentBrown,
                ),
                (
                  'Per-frame',
                  'Only runs when Tab is pressed, not every frame',
                  Icons.timer,
                  accentIndigo,
                ),
              ])
          ...
          child: Column(
            children: [
              for (final pattern in [
                ...
                (
                  'Toolbar ordering',
                  'Primary actions first, secondary actions '
                ...
                (
                  'Dashboard panels',
                  'Important panels get low order numbers. '
                ...
                (
                  'Settings page',
                  'Critical settings first (1-3), advanced '
                ...
                (
                  'Grid layout',
                  'Override column-by-column reading order. '
