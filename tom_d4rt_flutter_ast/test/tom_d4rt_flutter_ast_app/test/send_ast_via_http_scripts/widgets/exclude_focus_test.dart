...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'ExcludeFocus wraps a subtree and, when its excluding '
    ...
    },
    {
      ...
      'body':
          'When a user presses Tab to move focus through a form, '
    ...
    },
    {
      ...
      'body':
          'The excluding property can change at run-time. Set it '
    ...
    },
    {
      ...
      'body':
          'ExcludeFocus affects its entire descendant subtree, '
  ...
  final vsRows = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'excludeFocus':
          'Blocked — FocusNode.requestFocus() '
          'has no effect while excluded',
      'excludeTraversal':
          'Allowed — can still be focused via '
          'FocusNode.requestFocus() or FocusScope.of()',
    },
    {
      'aspect': 'Typical use',
      'excludeFocus':
          'Completely disabled sections, '
    ...
    },
    {
      'aspect': 'Underneath',
      'excludeFocus':
          'Sets FocusNode.canRequestFocus = false '
          'on the scope node',
      'excludeTraversal':
          'Sets FocusNode.skipTraversal = true '
          'on the scope node',
    },
  ];
  ...
  final properties = <Map<String, dynamic>>[
    {
      ...
      'description':
          'When true, the entire descendant subtree is excluded '
    ...
    },
    {
      ...
      'description':
          'The widget subtree to conditionally exclude from focus. '
  ...
  final scenarios = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.green[700]!,
      'description':
          'A multi-section form where some sections are '
      ...
      'example':
          'Shipping address form disabled when "Same as billing" '
          'is checked.',
    },
    {
      ...
      'description':
          'When showing a modal dialog, the background page '
      ...
      'example':
          'Full-screen modal overlay with form — background '
  ...
  final codeBlocks = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.lime[700]!,
      'code':
          '// Visually dim AND exclude from focus\n'
          'IgnorePointer(\n'
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'The excluding parameter defaults to true. If you just '
    ...
    },
    {
      ...
      'body':
          'ExcludeFocus only affects keyboard focus. Users can still '
    ...
    },
    {
      ...
      'body':
          'ExcludeFocus is essential for accessible applications. '
    ...
    },
    {
      ...
      'body':
          'If you exclude everything around the currently focused '
    ...
    },
    {
      ...
      'body':
          'The "triple disable" pattern covers all interaction modes:\n'
    ...
    },
    {
      ...
      'body':
          'ExcludeFocus can nest. A child ExcludeFocus(excluding: false) '
        ...
        children: [
            ...
            (cb) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: cb['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Without ExcludeFocus — All 7 fields focusable',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 11,
                    color: Colors.green[700],
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: traversalWith.map((t) {
                    ...
                    return Container(
                      padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                      decoration: BoxDecoration(
                        color: excluded ? Colors.red[50] : Colors.green[50],
                        borderRadius: BorderRadius.circular(6),
                        border: Border.all(
                          color: excluded
                              ? Colors.red[300]!
                ...
                SizedBox(height: 6),
                Text(
                  'Tab order: 1 → [skip] → [skip] → [skip] → 2 → 3 → 4',
                  style: TextStyle(
                    fontSize: 9,
                    fontFamily: 'monospace',
                    color: Colors.grey[600],
