...
dynamic build(BuildContext context) {
  ...
  Widget noteBox(String text, Color border, Color bg) {
    return Container(
      ...
      child: Text(text, style: TextStyle(fontSize: 13, color: deepEmerald)),
    );
  }
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Interpolation between 4\u00d74 transformation matrices',
                style: TextStyle(
        ...
        matrixCard(
          'end: translate + rotate(45\u00b0) + scale(2x)',
          end,
          amberContrast,
        ),
        noteBox(
            ...
            children: [
              for (final step in [
                (
                  1,
                  'Decompose begin',
                  'Extract translation, rotation, scale from begin matrix',
                  emerald,
                ),
                (
                  2,
                  'Decompose end',
                  'Extract same three components from end matrix',
                  forestGreen,
                ),
                (
                  3,
                  'Lerp translation',
                  'Vector3.lerp(beginT, endT, t) — linear interpolation',
                  malachite,
                ),
                (
                  4,
                  'Slerp rotation',
                  'Quaternion.slerp(beginQ, endQ, t) — spherical linear interpolation',
                  deepEmerald,
                ),
                (
                  5,
                  'Lerp scale',
                  'Vector3.lerp(beginS, endS, t) — linear interpolation',
                  darkTeal,
                ),
                (
                  6,
                  'Recompose',
                  'Matrix4.compose(translation, rotation, scale) — build final matrix',
                  amberContrast,
                ),
              ])
                Container(
        ...
        sectionBanner(
          '5 \u00b7 Visual Transform Progression',
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        row.$2,
                        style: TextStyle(fontSize: 10, color: roseContrast),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8),
                      child: Text(
                        row.$3,
                        style: TextStyle(fontSize: 10, color: emerald),
                      ),
                    ),
                  ],
                ),
        ...
        sectionBanner(
          '7 \u00b7 The Three Transform Components',
        ...
        for (final comp in [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: mintCream,
              borderRadius: BorderRadius.circular(10),
              border: Border(left: BorderSide(color: comp.$6, width: 4)),
            ),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        comp.$3,
                        style: TextStyle(fontSize: 12, color: malachite),
                      ),
            ...
            children: [
              for (final member in [
                (
                  'begin',
                  'Matrix4?',
                  'Start matrix (set in constructor or later)',
                  'Getter/Setter',
                  forestGreen,
                ),
                (
                  'end',
                  'Matrix4?',
                  'End matrix (set in constructor or later)',
                  'Getter/Setter',
                  emerald,
                ),
                (
                  'lerp(t)',
                  'Matrix4',
                  'Decompose \u2192 interpolate \u2192 recompose (overridden)',
                  'Method',
                  malachite,
                ),
                (
                  'transform(t)',
                  'Matrix4',
                  'Calls lerp(t) — inherited from Tween',
                  'Method',
                  darkTeal,
                ),
                (
                  'evaluate(anim)',
                  'Matrix4',
                  'Calls transform(anim.value) — from Animatable',
                  'Method',
                  deepEmerald,
                ),
                (
                  'animate(parent)',
                  'Animation<Matrix4>',
                  'Creates driven animation from controller',
                  'Method',
                  amberContrast,
                ),
              ])
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          member.$3,
                          style: TextStyle(fontSize: 10, color: forestGreen),
                        ),
                      ),
                    ],
                  ),
        ...
        sectionBanner(
          '9 \u00b7 Usage with Implicit Animations',
              ...
              for (final usage in [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border(left: BorderSide(color: usage.$5, width: 3)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
          ...
          child: Column(
            children: [
              for (final related in [
                (
                  'Matrix4Tween',
                  'Full 4\u00d74 matrix decomposition interpolation',
                  emerald,
                ),
                (
                  'Tween<double>',
                  'Single value (rotation angle, scale factor)',
                  forestGreen,
                ),
                (
                  'Tween<Offset>',
                  'Translation only (without rotation/scale)',
                  malachite,
                ),
                (
                  'AlignmentTween',
                  'Alignment interpolation for positioned transforms',
                  darkTeal,
                ),
                (
                  'DecorationTween',
                  'BoxDecoration interpolation (borders, shadows)',
                  deepEmerald,
                ),
                (
                  'ColorTween',
                  'Color interpolation (often combined with transforms)',
                  amberContrast,
                ),
              ])
                Padding(
          ...
          child: Column(
            children: [
              for (final scenario in [
                (
                  'Transform.translate',
                  Matrix4.identity()..translateByDouble(40.0, 0.0, 0.0, 1.0),
                  'Moved 40px right',
                  forestGreen,
                ),
                (
                  'Transform.rotate',
                  Matrix4.identity()..rotateZ(0.3),
                  'Rotated ~17\u00b0',
                  emerald,
                ),
                (
                ...
                (
                  'Combined',
                  Matrix4.identity()
                    ..translateByDouble(20.0, 0.0, 0.0, 1.0)
                    ..rotateZ(0.2)
                        ...
                        child: Transform(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: scenario.$4, width: 2),
                              borderRadius: BorderRadius.circular(4),
                            ),
                            alignment: Alignment.center,
                            child: Text(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Composition order in the matrix:',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 12,
                  color: deepEmerald,
              ...
              for (final part in [
                ...
                ('[0,3]..[2,3]', 'Translation', 'Right column', forestGreen),
                ('[3,3]', '1.0', 'Homogeneous coordinate', malachite),
              ])
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 3),
                  child: Row(
