...
class _AnimatedCrossFadeDemoState extends State<AnimatedCrossFadeDemo> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: ElevatedButton.icon(
                onPressed: () {
                  ...
                  print(
                    'Duration demo toggled with ${_selectedDuration.inMilliseconds}ms duration',
                  );
                },
            ...
            print(
              'Duration section rendered with ${_selectedDuration.inMilliseconds}ms',
            ),
          ].whereType<Widget>().toList(),
        ),
      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCurveSelector('First Curve (fade-out):', curves, _firstCurve, (
              curve,
            ) {
              setState(() => _firstCurve = curve);
              print(
                'First curve changed to: ${curves.entries.firstWhere((e) => e.value == curve).key}',
              );
            }),
            ...
            _buildCurveSelector('Second Curve (fade-in):', curves, _secondCurve, (
              curve,
            ) {
              setState(() => _secondCurve = curve);
              print(
                'Second curve changed to: ${curves.entries.firstWhere((e) => e.value == curve).key}',
              );
            }),
            ...
            _buildCurveSelector('Size Curve:', curves, _sizeCurve, (curve) {
              ...
              print(
                'Size curve changed to: ${curves.entries.firstWhere((e) => e.value == curve).key}',
              );
            }),
  ...
  Widget _buildLayoutBuilderSection() {
    ...
    print(
      'layoutBuilder controls how children are positioned during transition',
    );
              ...
              child: Center(
                child: AnimatedCrossFade(
                  firstChild: Container(
                    ...
                    child: const Center(
                      child: Text('Small', style: TextStyle(color: Colors.red)),
                    ),
                  ),
                  secondChild: Container(
                    width: 160,
                ...
                child: AnimatedCrossFade(
                  firstChild: AnimatedCrossFade(
                    firstChild: AnimatedCrossFade(
                      ...
                      crossFadeState: _chainedIndex == 1
                          ? CrossFadeState.showSecond
                          : CrossFadeState.showFirst,
                      duration: const Duration(milliseconds: 300),
                    ),
                    secondChild: _buildChainedChild(colors[2], icons[2], '3'),
                    crossFadeState: _chainedIndex == 2
                        ? CrossFadeState.showSecond
                        : CrossFadeState.showFirst,
                    duration: const Duration(milliseconds: 300),
                  ),
                  secondChild: AnimatedCrossFade(
                    firstChild: AnimatedCrossFade(
                      ...
                      crossFadeState: _chainedIndex == 4
                          ? CrossFadeState.showSecond
                          : CrossFadeState.showFirst,
                      duration: const Duration(milliseconds: 300),
                    ),
                    secondChild: _buildChainedChild(colors[5], icons[5], '6'),
                    crossFadeState: _chainedIndex == 5
                        ? CrossFadeState.showSecond
                        : CrossFadeState.showFirst,
                    duration: const Duration(milliseconds: 300),
                  ),
                  crossFadeState: _chainedIndex >= 3
                      ? CrossFadeState.showSecond
                      : CrossFadeState.showFirst,
                  duration: const Duration(milliseconds: 300),
                ),
  ...
  Widget _buildApiReference() {
    ...
    print(
      '  - alignment: AlignmentGeometry - Child alignment during transition',
    );
        ...
        child: Column(
          ...
          children: [
            ...
            _buildApiRow(
              'firstCurve',
              'Curve',
              'Fade curve for first child (default: linear)',
            ),
            _buildApiRow(
              'secondCurve',
              'Curve',
              'Fade curve for second child (default: linear)',
            ),
            _buildApiRow(
              'sizeCurve',
              'Curve',
              'Size transition curve (default: linear)',
            ),
            _buildApiRow(
              'alignment',
              'AlignmentGeometry',
              'Alignment during transition (default: center)',
            ),
            _buildApiRow('layoutBuilder', 'Function', 'Custom layout builder'),
            _buildApiRow(
              'excludeBottomFocus',
              'bool',
              'Exclude hidden child from focus tree',
            ),
            ...
            const SizedBox(height: 4),
            const Text(
              '• Both children are always built (for size calculation)',
            ),
