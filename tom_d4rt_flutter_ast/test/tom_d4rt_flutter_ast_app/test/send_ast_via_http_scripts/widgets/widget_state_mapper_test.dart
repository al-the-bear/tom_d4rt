...
mixin _WsmTickerShim<T extends StatefulWidget> on State<T>
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: const TextTheme(
          ...
          bodyMedium: TextStyle(height: 1.4, color: _WsmPalette.ivoryDim),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: const <Widget>[
        ...
        SizedBox(width: 12),
        Text(
          'WidgetStateMapper<T> - Switchboard Console',
          style: TextStyle(
            color: _WsmPalette.ivory,
            fontWeight: FontWeight.w800,
            letterSpacing: 1.1,
      ...
      child: Column(
        ...
        children: const <Widget>[
          ...
          _WsmDossierCard(
            ...
            lead:
                'Any value type can be mapped - Color, double, String, TextStyle, BorderSide...',
            body:
          ...
          _WsmDossierCard(
            ...
            lead:
                'Mapper = static-map strategy; resolveWith = functional strategy.',
            body:
          ...
          _WsmDossierCard(
            ...
            lead:
                'WidgetState values AND compound expressions are both accepted.',
            body:
...
class _WsmMatrixBoardState extends State<_WsmMatrixBoard> with _WsmTickerShim {
            ...
            return Transform.translate(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                      color: resolution.color.withValues(
                        alpha: 0.55 * pulseValue,
                      ),
                      blurRadius: 20,
                      spreadRadius: 2,
                    ),
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Text(
                  states.isEmpty
                      ? 'states: { }'
                      : 'states: { ${states.map(_wsmShort).join(', ')} }',
                  style: const TextStyle(
                    color: _WsmPalette.ivoryDim,
                    fontSize: 11,
                    fontFamily: 'monospace',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _WsmLamp(lit: active, color: descriptor.color, size: 8),
          ],
        ),
      ),
    );
...
class _WsmFirstMatchTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _WsmSection(
      title: 'FIRST MATCH',
      subtitle:
          'Declaration order is the rule - reorder and the winner changes',
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: const <Widget>[
          _WsmPanel(
...
int _wsmFirstMatchResolveIndex(Set<WidgetState> states) {
  ...
  final WidgetStateMapper<Color> mapper = WidgetStateMapper<Color>(
    _wsmFirstMatchColorMap,
  );
  // Ensure resolve works and returns a valid value (exercise the API).
  mapper.resolve(states);
  final List<WidgetStatesConstraint> keys = _wsmFirstMatchColorMap.keys
      .toList();
  for (int i = 0; i < keys.length; i++) {
  ...
  Widget build(BuildContext context) {
    return _WsmPanel(
      child: Column(
        ...
        children: const <Widget>[
          Text(
            'Order matters - try these thought experiments',
            style: TextStyle(
              color: _WsmPalette.ivory,
              fontSize: 14,
              fontWeight: FontWeight.w800,
  ...
  Widget build(BuildContext context) {
    return _WsmPanel(
      child: Column(
        ...
        children: const <Widget>[
          Text(
            'One algorithm, many value types',
            style: TextStyle(
              color: _WsmPalette.ivory,
              fontSize: 15,
              fontWeight: FontWeight.w800,
      ...
      builder: (BuildContext context, Set<WidgetState> states, _) {
        ...
        return LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
            ...
            final Widget colorCard = _WsmGenericCard(
              title: 'Color',
              typeParam: 'WidgetStateMapper<Color>',
              child: _WsmColorDisc(color: c),
            );
            final Widget angleCard = _WsmGenericCard(
              title: 'Angle (double)',
              typeParam: 'WidgetStateMapper<double>',
              child: _WsmAngleDial(angle: angle),
            );
            final Widget labelCard = _WsmGenericCard(
              title: 'Label (String)',
              typeParam: 'WidgetStateMapper<String>',
              child: _WsmLabelPanel(label: label),
            );
            if (narrow) {
              return Column(
                children: <Widget>[
...
class _WsmDialNeedlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
      center,
      Offset(center.dx, center.dy - size.height / 2 + 14),
      paint,
    );
    ...
    for (int i = 0; i < 12; i++) {
      ...
      final Offset p1 =
          center + Offset(math.cos(a), math.sin(a)) * (size.width / 2 - 4);
      final Offset p2 =
          center + Offset(math.cos(a), math.sin(a)) * (size.width / 2 - 12);
      ...
      child: Column(
        ...
        children: const <Widget>[
          ...
          _WsmConstraintCard(
            ...
            rationale:
                'Hover effects should switch off when the control is disabled.',
            op: _WsmOp.and,
            a: _WsmLeaf.hovered,
          ...
          _WsmConstraintCard(
            ...
            rationale:
                'Either signal highlights the row for accessibility readers.',
            op: _WsmOp.or,
            a: _WsmLeaf.focused,
            b: _WsmLeaf.selected,
          ),
          ...
          _WsmConstraintCard(
            ...
            rationale:
                'Composite - outer AND, inner OR. Parentheses clarify priority.',
            op: _WsmOp.andGroup,
            a: _WsmLeaf.pressed,
...
class _WsmWiredStageState extends State<_WsmWiredStage> with _WsmTickerShim {
                ...
                child: ValueListenableBuilder<bool>(
                  ...
                  builder: (BuildContext context, bool on, _) {
                    return SwitchListTile(
                      ...
                      subtitle: const Text(
                        'Toggle to observe the disabled rule',
        ...
        return Container(
          ...
          child: Row(
            children: <Widget>[
              ...
              const Spacer(),
              Text(
                'states: ${s.isEmpty ? '{}' : '{${s.map(_wsmShort).join(', ')}}'}',
                style: const TextStyle(
                  color: _WsmPalette.lampAmber,
                  fontFamily: 'monospace',
                  fontSize: 11,
  ...
  void _drawRackPort(
    ...
    if (idx != 4) {
      final Paint glow = Paint()
        ..color = lamp.withValues(
          alpha: lamp == _WsmPalette.brassDark ? 0.0 : 0.35,
        )
      ...
      child: Column(
        ...
        children: const <Widget>[
          ...
          _WsmRecipeCard(
            ...
            blurb: 'TextStyle interpolation via WidgetStateMapper<TextStyle>.',
            code:
...
class _WsmCompareTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _WsmSection(
      ...
      subtitle:
          'When to reach for each member of the WidgetStateProperty family',
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: const <Widget>[
    ...
    return _WsmPanel(
      child: Column(
        ...
        children: const <Widget>[
          ...
          SizedBox(height: 10),
          _WsmBullet(
            text: 'Declare maps in most-specific to least-specific order.',
          ),
