...
final ValueNotifier<List<String>> _nestedLog = ValueNotifier<List<String>>([]);
...
TableRow _tr(String a, String b, String c) {
  return TableRow(children: <Widget>[_TD(a), _TD(b), _TD(c)]);
}
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            ValueListenableBuilder<bool>(
                              ...
                              builder: (BuildContext ctx, bool en, _) => _Chip(
                                en ? 'enabled' : 'disabled',
                  ...
                  builder: (BuildContext ctx, List<String> entries, _) {
                    if (entries.isEmpty) {
                      return Container(
                        ...
                        child: Text(
                          'No events yet — tap Simulate pop',
                          style: TextStyle(
                            fontSize: 13,
                            color: cs.onSurfaceVariant,
                          ),
                    ...
                    return Column(
                      children: <Widget>[
                        ...
                        AnimatedContainer(
                          ...
                          padding: const EdgeInsets.all(20),
                          decoration: BoxDecoration(
                            color: en ? cs.primaryContainer : cs.errorContainer,
                            borderRadius: BorderRadius.circular(14),
                            border: Border.all(
            ...
            child: Column(
              ...
              children: <Widget>[
                _InfoRow(
                  ...
                  color: cs.primary,
                  label:
                      'Changing enabled does not trigger a rebuild of child — it only affects '
                ...
                _InfoRow(
                  ...
                  color: cs.primary,
                  label:
                      'When enabled flips from false to true, the handler re-registers '
                ...
                _InfoRow(
                  ...
                  color: Colors.orange,
                  label:
                      'Do not toggle enabled inside the onPop callback itself — it can cause '
          ...
          _SectionCard(
            ...
            child: Column(
              ...
              children: <Widget>[
                _PriorityRule(
                  '1',
                  'Innermost NavigatorPopHandler with enabled: true fires first.',
                ),
                const SizedBox(height: 8),
                _PriorityRule(
                  '2',
                  ...
                  children: <Widget>[
                    ...
                    AnimatedContainer(
                      ...
                      child: Row(
                        children: <Widget>[
                          Icon(
                            dirty ? Icons.edit : Icons.check_circle_outline,
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.w600,
                              color: dirty ? cs.onErrorContainer : cs.onSurface,
                            ),
                          ),
                        ],
                      ),
            ...
            child: Column(
              children: <Widget>[
                _DiagramStep(
                  '1',
                  'System back',
                  'User presses the system back button or calls Navigator.maybePop()',
                  cs,
                ),
                const SizedBox(height: 8),
                _DiagramStep(
                  ...
                  'Router\'s BackButtonDispatcher receives the event and dispatches to registered children',
                  cs,
                ),
                const SizedBox(height: 8),
                _DiagramStep(
                  '3',
                  'NavigatorPopHandler',
                  'The handler intercepts if enabled == true and the Navigator canPop()',
                  cs,
                ),
                const SizedBox(height: 8),
                _DiagramStep(
                  '4a',
                  'onPop callback',
                  'If enabled: true → onPop() fires synchronously. Normal pop is suppressed.',
                  cs,
                  color: Colors.green,
                ),
                const SizedBox(height: 8),
                _DiagramStep(
                  '4b',
                  'Pass-through',
                  'If enabled: false → event passes to the Router delegate for default navigation.',
                  cs,
                  color: Colors.orange,
                ),
              ],
...
class _DiagramStep extends StatelessWidget {
  const _DiagramStep(this.id, this.title, this.body, this.cs, {this.color});
...
class _FlowDiagramPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final RRect bypassBox = RRect.fromRectAndRadius(
      Rect.fromCenter(center: Offset(cx + 130, 270), width: 120, height: 40),
            ...
            child: Column(
              ...
              children: <Widget>[
                _WhenRow(
                  ...
                  when:
                      'You are using Router / Navigator 2.0 and need a synchronous VoidCallback '
                ...
                _WhenRow(
                  ...
                  when:
                      'You need async logic (e.g., "await shouldWeLeave()") or you are in a '
                ...
                _WhenRow(
                  widget: 'PopScope',
                  when:
                      'You need fine-grained control with canPop and the newer '
                ...
                _WhenRow(
                  widget: 'WillPopScope',
                  when:
                      'Legacy code only — deprecated, do not use in new code.',
                  recommended: false,
                ),
              ],
            ),
      ...
      child: Row(
        ...
        children: <Widget>[
          Icon(
            ...
            color: recommended ? Colors.green : cs.error,
            size: 18,
          ),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                const SizedBox(height: 4),
                Text(when, style: const TextStyle(fontSize: 12, height: 1.4)),
              ],
            ),
          ),
        ],
            ...
            child: Column(
              ...
              children: <Widget>[
                _InfoRow(
                  ...
                  color: cs.primary,
                  label:
                      'Place NavigatorPopHandler as a direct ancestor of the Navigator widget '
                ...
                _InfoRow(
                  ...
                  color: cs.primary,
                  label:
                      'Do NOT place it above MaterialApp — it must be inside the Router\'s '
                ...
                _InfoRow(
                  ...
                  color: cs.primary,
                  label:
                      'The onPop callback does not automatically call Navigator.pop(). '
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _PitfallCard(
            ...
            symptom:
                'onPop never fires even though the system back button is pressed.',
            cause:
                'Developer placed the widget in a plain Navigator 1.0 stack (e.g., inside '
            ...
            fix:
                'Use BackButtonListener (returns Future<bool>) when working inside a traditional '
          ...
          _PitfallCard(
            ...
            symptom:
                'Back button navigates away even though the handler is present.',
            cause:
                'The enabled property was left as false (or wired to a condition that is '
                'currently false) while the developer expects the handler to be active.',
            fix:
                'Use a ValueListenableBuilder or similar reactive widget so that enabled '
          ...
          _PitfallCard(
            ...
            symptom:
                'UI state is inconsistent after the back press; or the pop proceeds before '
                'the async operation completes.',
            cause:
                'onPop is a VoidCallback — it is synchronous. Any async operation (e.g., '
            ...
            fix:
                'Use BackButtonListener (which returns Future<bool>) if you need to await '
          ...
          child: RichText(
            text: TextSpan(
              style: DefaultTextStyle.of(
                context,
              ).style.copyWith(fontSize: 12, height: 1.45),
              children: <TextSpan>[
                TextSpan(
                  text: '$label: ',
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _ApiParamCard(
            ...
            defaultVal: 'null',
            desc:
                'Standard widget key for identity-based updates. Use a GlobalKey if you need '
          ...
          _ApiParamCard(
            ...
            defaultVal: 'null',
            desc:
                'Called synchronously when the system back button fires and the attached Navigator '
          ...
          _ApiParamCard(
            ...
            defaultVal: 'true',
            desc:
                'When true the handler intercepts back-navigation and fires onPop. '
          ...
          _ApiParamCard(
            ...
            defaultVal: 'required',
            desc:
                'The subtree that the handler wraps. Typically contains a Navigator widget '
          ...
          _SectionCard(
            ...
            child: Column(
              ...
              children: <Widget>[
                _LifecycleRow(
                  'initState',
                  'Registers as child of nearest BackButtonDispatcher if enabled',
                ),
                _LifecycleRow(
                  'didUpdateWidget',
                  'Re-registers/de-registers if enabled changed',
                ),
                _LifecycleRow(
                  'build',
                  'Returns child unchanged — NavigatorPopHandler is transparent',
                ),
                _LifecycleRow(
                  'dispose',
                  'Deregisters from BackButtonDispatcher',
                ),
              ],
            ),
          ),
            ...
            child: Column(
              ...
              children: <Widget>[
                _RelatedApi(
                  ...
                  desc:
                      'The system object that routes back-button events to child handlers.',
                ...
                _RelatedApi(
                  ...
                  desc:
                      'Similar to NavigatorPopHandler but async (Future<bool>) — for Navigator 1.0.',
                  icon: Icons.hearing,
                ),
                const SizedBox(height: 8),
                _RelatedApi(
                  name: 'PopScope',
                  desc:
                      'Replacement for WillPopScope; provides canPop and onPopInvokedWithResult.',
                  icon: Icons.undo,
                ),
                const SizedBox(height: 8),
                _RelatedApi(
                  name: 'RouterDelegate',
                  desc:
                      'The delegate that manages the Navigator page stack in Navigator 2.0.',
                  icon: Icons.route,
                ),
              ],
            ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 10),
            Text(desc, style: const TextStyle(fontSize: 13, height: 1.45)),
          ],
        ),
      ),
    );
