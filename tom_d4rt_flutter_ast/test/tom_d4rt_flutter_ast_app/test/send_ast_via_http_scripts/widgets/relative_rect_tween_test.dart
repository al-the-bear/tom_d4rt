...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'RelativeRectTween interpolates between two RelativeRect '
    ...
    },
    {
      ...
      'body':
          'RelativeRect has four values: left, top, right, bottom — '
    ...
    },
    {
      ...
      'body':
          'The tween\'s lerp() method calls RelativeRect.lerp(begin, '
    ...
    },
    {
      ...
      'body':
          'PositionedTransition is the primary consumer of '
  ...
  print(
    '  start: left=${rectStart.left}, top=${rectStart.top}, right=${rectStart.right}, bottom=${rectStart.bottom}',
  );
  print(
    '  end: left=${rectEnd.left}, top=${rectEnd.top}, right=${rectEnd.right}, bottom=${rectEnd.bottom}',
  );
  print('  fill: $rectFill');
  ...
  for (final t in tValues) {
    ...
    print(
      '  t=$t: L=${rect.left.toStringAsFixed(1)}, T=${rect.top.toStringAsFixed(1)}, '
  ...
  final factoryMethods = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Direct construction from four inset values. '
    ...
    },
    {
      ...
      'description':
          'Creates from a child Rect and the parent Size. '
    ...
    },
    {
      ...
      'description':
          'Creates from a child Rect and a container Rect. '
    ...
    },
    {
      ...
      'description':
          'Static constant where all four insets are zero. '
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'Animate from off-screen (left: -200) to final position. '
    ...
    },
    {
      ...
      'detail':
          'Animate a small positioned element to fill the Stack. '
    ...
    },
    {
      ...
      'detail':
          'Two items swap positions in a Stack by using mirrored '
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        // ---- Section 5: Factory Methods ----
        _sectionHeader(
          '5. RelativeRect Factory Methods',
          Icons.build,
          Colors.deepPurple[700]!,
        ),
        SizedBox(height: 10),
        ...
        // ---- Section 7: Practical Patterns ----
        _sectionHeader(
          '7. Practical Animation Patterns',
          Icons.engineering,
          Colors.deepPurple[700]!,
        ),
        SizedBox(height: 10),
