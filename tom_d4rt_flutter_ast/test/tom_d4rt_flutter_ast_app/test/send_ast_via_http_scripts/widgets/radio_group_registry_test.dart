...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'RadioGroupRegistry is an InheritedWidget that manages '
    ...
    },
    {
      ...
      'body':
          'Radio, RadioListTile, and RadioMenuButton widgets '
    ...
    },
    {
      ...
      'body':
          'The registry enables arrow-key navigation between radios '
    ...
    },
    {
      ...
      'body':
          'By grouping radios in a registry, screen readers can '
  ...
  final mechanicsSteps = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'A RadioGroupRegistry widget is placed in the tree '
    ...
    },
    {
      ...
      'detail':
          'Each Radio widget\'s State calls register() on '
    ...
    },
    {
      ...
      'detail':
          'When a radio is tapped or activated via keyboard, '
    ...
    },
    {
      ...
      'detail':
          'Arrow keys invoke the registry to find the next '
    ...
    },
    {
      ...
      'detail':
          'When a Radio\'s State is disposed, it calls '
  ...
  print(
    '  Color group: ${colorOptions.length} options, selected=$selectedColor',
  );
  ...
  final sizeOptions = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'subtitle': '16px body text',
    },
    {
      'value': 'large',
      'label': 'Large',
      'icon': Icons.title,
      'subtitle': '20px body text',
    },
  ];
  ...
  print(
    '  Theme group: ${themeOptions.length} options, selected=$selectedTheme',
  );
  ...
  print(
    '  Priority group: ${priorityOptions.length} options, selected=$selectedPriority',
  );
  ...
  final navRules = <Map<String, dynamic>>[
    {
      ...
      'action': 'Move to Next',
      'detail':
          'Focuses the next radio button in registration order. '
    ...
    },
    {
      ...
      'detail':
          'Focuses the previous radio button. Wraps around to '
    ...
    },
    {
      ...
      'detail':
          'Activates the currently focused radio button, calling '
    ...
    },
    {
      ...
      'action': 'Leave Group',
      'detail':
          'Tab moves focus out of the radio group entirely to '
  ...
  final styleExamples = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Changes the color of the selected radio dot. '
    ...
    },
    {
      ...
      'description':
          'The overlay color when the radio has keyboard focus. '
    ...
    },
    {
      ...
      'description':
          'The overlay on mouse hover. Provides visual feedback '
    ...
    },
    {
      ...
      'description':
          'Controls the size of the ink splash and overlay '
    ...
    },
    {
      ...
      'description':
          'Adjusts the overall size and spacing. Compact '
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Define radio values as enum members for type safety. '
    ...
    },
    {
      ...
      'description':
          'Radio buttons work inside Form widgets. Use '
    ...
    },
    {
      ...
      'description':
          'Set onChanged to null to disable a radio option. '
    ...
    },
    {
      ...
      'description':
          'Radio groups can have dynamic members. Adding or '
    ...
    },
    {
      ...
      'description':
          'While radios are often vertical, use Row or Wrap '
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        _sectionHeader(
          '5. RadioListTile — Priority Picker',
          Icons.flag,
          Colors.red[700]!,
        ),
        SizedBox(height: 10),
