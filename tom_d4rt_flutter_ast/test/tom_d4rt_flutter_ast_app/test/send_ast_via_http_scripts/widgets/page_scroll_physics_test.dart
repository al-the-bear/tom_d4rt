...
dynamic build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(val, style: TextStyle(fontSize: 13, color: darkBark)),
          ),
        ],
      ),
    );
  ...
  final chained = const PageScrollPhysics().applyTo(
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Scroll physics that cause a PageView to snap to '
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Optional ScrollPhysics? to chain with. '
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(fontSize: 9, color: darkBark),
                            ),
                          ],
                        ),
                      ),
        ...
        heading(
          '4 \u00b7 Velocity-Based Snap Scenarios',
          ...
          child: Column(
            children: [
              for (final scenario in [
                ...
                (
                  'Fast fling forward at page 1.3',
                  'velocity > +tolerance',
                  '1.3 + 0.5 = 1.8 \u2192 round \u2192 2.0',
                  'Snaps forward to page 2',
                  Icons.arrow_forward,
                  emerald,
                ),
                (
                  'Fast fling backward at page 1.8',
                  'velocity < -tolerance',
                  '1.8 - 0.5 = 1.3 \u2192 round \u2192 1.0',
                  'Snaps backward to page 1',
                  Icons.arrow_back,
                  deepForest,
                ),
                (
                  'Exactly at page 2.5, no velocity',
                  'velocity \u2248 0',
                  '2.5 \u2192 round \u2192 3.0',
                  'Rounds up to page 3 (0.5 rounds up)',
                  Icons.swap_horiz,
                  accentAmber,
                ),
                (
                  ...
                  'velocity \u2265 0',
                  'Defers to parent',
                  'Parent physics handles out-of-range bounce',
                  Icons.undo,
                  accentSlate,
                ),
              ])
        ...
        // ── 7. applyTo method ────────────────────────────────────────
        heading(
          '6 \u00b7 applyTo and Physics Chaining',
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: deepForest.withValues(alpha: 0.3)),
                ),
                child: Text(
                  '@override\n'
              ...
              const SizedBox(height: 6),
              Text(
                'Page snapping handled first \u2192 out-of-range defers to parent \u2192 parent defers to platform',
                style: TextStyle(
                  fontSize: 9,
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        row.$3,
                        style: TextStyle(fontSize: 9, color: accentSlate),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(5),
        ...
        heading(
          '10 \u00b7 Live PageView with PageScrollPhysics',
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              for (final edge in [
                (
                  'At min, scrolling backward',
                  'Delegate to parent (e.g. bounce/clamp to first page)',
                  Icons.first_page,
                  accentAmber,
                ),
                (
                  'At max, scrolling forward',
                  'Delegate to parent (e.g. bounce/clamp to last page)',
                  Icons.last_page,
                  accentAmber,
                ),
                (
                  'Between pages, in range',
                  'PageScrollPhysics handles snap to nearest page',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border(left: BorderSide(color: edge.$4, width: 2)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '(fling backward)',
                                style: TextStyle(fontSize: 7, color: darkBark),
                              ),
                            ],
                          ),
                        ),
                    ...
                    Container(width: 1, color: forest.withValues(alpha: 0.3)),
                    Expanded(
                      flex: 2,
                      child: Container(
                        color: forest.withValues(alpha: 0.06),
          ...
          child: Column(
            children: [
              for (final perf in [
                (
                  'Const-constructible',
                  'Single shared instance across rebuilds '
                ...
                (
                  'Minimal computation',
                  'Snap decision is a few multiplications and '
                      'one round — runs in microseconds.',
                  Icons.speed,
                  emerald,
                ),
                (
                  'Returns null when settled',
                  'No simulation created when already at a '
                ...
                (
                  'Spring-based',
                  'ScrollSpringSimulation converges quickly '
        ...
        // ── 16. Summary ──────────────────────────────────────────────
        heading('15 \u00b7 Summary', 'Key takeaways', deepForest, Colors.white),
        Container(
          width: double.infinity,
...
class _SpringCurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var x = 0.0; x < size.width; x += 1) {
      ...
      final y =
          1.0 -
          (1.0 - (1.0 + 0.08 * (1 - t)) * (1 - (1 - t) * (1 - t) * (1 - t)));
