...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'RangeMaintainingScrollPhysics ensures the scroll position '
    ...
    },
    {
      ...
      'body':
          'Perfect for lists where items are added to the top, removed '
    ...
    },
    {
      ...
      'body':
          'The key method is adjustPositionForNewDimensions(). It '
    ...
    },
    {
      ...
      'body':
          'Like all ScrollPhysics subclasses, it can be combined '
  ...
  final algorithmSteps = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'If the scroll position is currently animating (e.g., '
    ...
    },
    {
      ...
      'detail':
          'Compare old min/maxScrollExtent with new values. '
    ...
    },
    {
      ...
      'detail':
          'If the position was already corrected elsewhere '
    ...
    },
    {
      ...
      'detail':
          'If the old position was beyond min or max, compute '
    ...
    },
    {
      ...
      'detail':
          'If the old position was within range but new dimensions '
  ...
  final apiEntries = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.teal[700]!,
      'description':
          'The core method. Called by the scroll position when '
    ...
    },
    {
      ...
      'color': Colors.cyan[700]!,
      'description':
          'Creates a new RangeMaintainingScrollPhysics chained '
    ...
    },
    {
      ...
      'color': Colors.teal[600]!,
      'description':
          'The parent physics in the chain. When non-null, '
    ...
    },
    {
      ...
      'color': Colors.cyan[600]!,
      'description':
          'The precision thresholds for velocity and distance. '
  ...
  final scenarioItems = <Map<String, dynamic>>[
    {
      'id': 1,
      'text': 'First message in the chat',
      'time': '09:00',
      'mine': false,
    },
    ...
    {
      'id': 3,
      'text': 'I\'m great, thanks! Working on the demo.',
      'time': '09:02',
      'mine': false,
    },
    {
    ...
    {
      'id': 5,
      'text': 'It\'s about scroll physics — they keep the view stable.',
      'time': '09:04',
      'mine': false,
    },
    {
      'id': 6,
      'text': 'So no jumping when new messages arrive?',
      'time': '09:05',
      'mine': true,
    },
    {
      'id': 7,
      'text': 'Exactly! The physics adjust the position automatically.',
      'time': '09:06',
      'mine': false,
    },
    {
      'id': 8,
      'text': 'That\'s really useful for real-time apps.',
      'time': '09:07',
      'mine': true,
    },
  ];
  ...
  final chainingExamples = <Map<String, dynamic>>[
    {
      ...
      'code':
          ...
          ')',
      'description':
          'iOS-style bouncing overscroll combined with position '
    ...
    },
    {
      ...
      'code':
          ...
          ')',
      'description':
          'Android-style clamped overscroll with position '
    ...
    },
    {
      ...
      'code':
          ...
          ')',
      'description':
          'Disabled scrolling with position stability. Useful '
    ...
    },
    {
      ...
      'description':
          'Without parent, delegates to the platform default. '
  ...
  final useCases = <Map<String, dynamic>>[
    {
      ...
      'recommend': true,
      'detail':
          'New messages arrive at the bottom while the user reads '
    ...
    },
    {
      ...
      'recommend': true,
      'detail':
          'New posts appear and old posts are removed as the user '
    ...
    },
    {
      ...
      'recommend': true,
      'detail':
          'Widgets resize based on real-time data. Position stays '
    ...
    },
    {
      ...
      'recommend': false,
      'detail':
          'If content never changes after initial build, the '
    ...
    },
    {
      ...
      'recommend': false,
      'detail':
          'If items are only appended at the end (infinite scroll), '
