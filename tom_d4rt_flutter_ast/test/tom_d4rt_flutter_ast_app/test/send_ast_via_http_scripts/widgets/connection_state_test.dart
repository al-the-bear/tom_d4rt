...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'ConnectionState is an enum with four values that '
    ...
    },
    {
      ...
      'body':
          'AsyncSnapshot<T> wraps three things:\n'
    ...
    },
    {
      ...
      'body':
          'The four values are: none (not connected to anything), '
    ...
    },
    {
      ...
      'body':
          'FutureBuilder and StreamBuilder call their builder '
  ...
  final enumValues = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'meaning':
          'Connected to an async computation but no result '
    ...
    },
    {
      ...
      'meaning':
          'Connected to an active Stream that has emitted at '
    ...
    },
    {
      ...
      'meaning':
          'The async computation has finished. For a Future: '
  ...
  final futureSteps = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'initState() runs. If future is null, state stays '
    ...
    },
    {
      ...
      'detail':
          'The builder subscribes to the Future via .then() '
    ...
    },
    {
      ...
      'color': Colors.green[700]!,
      'detail':
          'The Future completes successfully. Builder is '
    ...
    },
    {
      ...
      'detail':
          'The Future completes with an error. Builder is '
    ...
    },
    {
      ...
      'color': Colors.orange[600]!,
      'detail':
          'If the parent rebuilds with a different Future '
  ...
  final streamSteps = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.grey[500]!,
      'detail':
          'initState() runs. If stream is null, state stays '
    ...
    },
    {
      ...
      'color': Colors.orange[600]!,
      'detail':
          'The widget calls stream.listen(). No events '
    ...
    },
    {
      ...
      'color': Colors.green[700]!,
      'detail':
          'Each data event triggers a rebuild with '
    ...
    },
    {
      ...
      'detail':
          'A stream error triggers a rebuild with active '
    ...
    },
    {
      ...
      'detail':
          'The stream emits a done event. Builder is called '
    ...
    },
    {
      ...
      'color': Colors.orange[600]!,
      'detail':
          'If the parent provides a new Stream instance, the '
  ...
  final builderPatterns = <Map<String, dynamic>>[
    {
      ...
      'code':
          ...
          '}',
      'note':
          'Exhaustive switch handles every state explicitly. '
    ...
    },
    {
      ...
      'code':
          ...
          '}',
      'note':
          'Simpler, but conflates none/waiting/active into a '
    ...
    },
    {
      ...
      'code':
          ...
          '}',
      'note':
          'Crashes or shows "null" during loading. Always check '
  ...
  final realPatterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.orange[600]!,
      'body':
          'Show a full-screen loader while connectionState is '
    ...
    },
    {
      ...
      'color': Colors.green[600]!,
      'body':
          'Use StreamBuilder with a Firestore or WebSocket '
    ...
    },
    {
      ...
      'color': Colors.blue[600]!,
      'body':
          'Wrap a submit button in FutureBuilder. state==none: '
    ...
    },
    {
      ...
      'body':
          'Pass initialData to FutureBuilder/StreamBuilder to '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[600]!,
      'body':
          'Nest a StreamBuilder inside a FutureBuilder: load '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'If you write FutureBuilder(future: fetchData(), ...) '
    ...
    },
    {
      ...
      'body':
          'FutureBuilder never enters the active state. It goes '
    ...
    },
    {
      ...
      'body':
          'When a Stream emits an error, connection state stays '
    ...
    },
    {
      ...
      'body':
          'Hot reload recreates the State object, triggering '
    ...
    },
    {
      ...
      'body':
          'The enum values are indexed 0–3: none(0), waiting(1), '
    ...
    },
    {
      ...
      'body':
          'snapshot.requireData throws a StateError if data is '
    ...
    body: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          _buildDiagram(
            'FutureBuilder Transitions',
            transitionText['future']!,
            Colors.deepPurple[600]!,
          ),
          SizedBox(height: 12),
          _buildDiagram(
            'StreamBuilder Transitions',
            transitionText['stream']!,
            Colors.green[700]!,
          ),
