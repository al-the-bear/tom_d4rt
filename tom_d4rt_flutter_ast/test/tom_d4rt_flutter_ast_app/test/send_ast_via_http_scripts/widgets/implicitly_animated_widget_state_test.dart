  ...
  Widget wsBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('▸ ', style: TextStyle(color: wsAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          wsSection('1 · Class Identity & Hierarchy', [
            wsKeyValue('Class', 'ImplicitlyAnimatedWidgetState<T>'),
          ...
          wsSection('4 · The forEachTween Visitor Pattern', [
            ...
            wsDivider(),
            wsBullet(
              'First call (initState): tween is null, visitor '
              'creates a new Tween with begin=targetValue.',
            ),
            wsBullet(
              'Subsequent calls (didUpdateWidget): tween exists, '
          ...
          wsSection('9 · Built-in Implicit Animation Widgets', [
            ...
            wsCompare('AnimatedAlign', 'Animates alignment within parent'),
            wsCompare('AnimatedCrossFade', 'Cross-fades between two children'),
          ]),
