  ...
  Widget tsBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('▸ ', style: TextStyle(color: tsAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          tsSection('1 · Class Identity & Role', [
            ...
            tsKeyValue('Mixins', 'SingleTickerProviderStateMixin'),
            tsKeyValue(
              'Purpose',
          ...
          tsSection('7 · Trigger Modes', [
            tsInfoRow(
              'H',
              'Hover:',
              'Mouse enter triggers show after waitDuration',
            ),
            tsInfoRow(
              'L',
              'LongPress:',
          ...
          tsSection('14 · Dismissal Behavior', [
            tsBullet('Automatic: showDuration timer triggers hide.'),
            tsBullet('User action: tapping outside the tooltip dismisses it.'),
            tsBullet(
