  ...
  Widget luBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('◉ ', style: TextStyle(color: luAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          luSection('1 · Class Identity & Role', [
            ...
            luKeyValue('Toolbar', 'CupertinoAdaptiveTextSelectionToolbar'),
            luDivider(),
            luBullet(
          ...
          luSection('2 · What Look Up Displays', [
            luInfoRow(
              'D',
              'Dictionary:',
              'Word definitions from installed dictionaries',
            ),
          ...
          luSection('3 · When Look Up Appears', [
            luBullet('The Look Up item appears when ALL conditions are met:'),
            luKeyValue(
            ...
            luKeyValue('iOS platform', 'Only available on iOS and iPadOS'),
            luDivider(),
            luBullet(
          ...
          luSection('4 · Action Flow', [
            ...
            luBullet('Step 3: User taps "Look Up" in the secondary row.'),
            luBullet(
            ...
            luBullet('Step 6: The text field retains its selection and focus.'),
            luDivider(),
            luHighlight(
          ...
          luSection('7 · Look Up vs Translate', [
            luCompare(
              'Look Up',
              'Shows dictionary definition, Wikipedia, Siri Knowledge',
            ),
            luCompare(
              'Translate',
          ...
          luSection('14 · Multi-Word & Phrase Lookups', [
            luBullet('Look Up works for single words AND multi-word phrases.'),
            luBullet(
          ...
          luSection('16 · Edge Cases', [
            ...
            luBullet('URLs: Look Up shows a web preview for recognized URLs.'),
            luBullet(
