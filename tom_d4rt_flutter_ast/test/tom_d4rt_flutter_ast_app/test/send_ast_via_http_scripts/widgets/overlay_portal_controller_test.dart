  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'A controller that manages the visibility of an '
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: deepWine.withValues(alpha: 0.3)),
                ),
                child: Text(
                  'OverlayPortalController({\n'
                  '  String? debugLabel,\n'
            ...
            children: [
              for (final method in [
                (
                  'show()',
                  'void',
                  'Makes the overlay child visible. '
                ...
                (
                  'hide()',
                  'void',
                  'Makes the overlay child invisible. '
                ...
                (
                  'toggle()',
                  'void',
                  'Switches between showing and hidden. '
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.visibility_off, size: 18, color: rose),
                        Text(
                          'Hidden',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                        ...
                        Text(
                          'isShowing: false',
                          style: TextStyle(fontSize: 8, color: darkBurgundy),
                        ),
                      ],
                    ),
                  ),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Icon(Icons.arrow_forward, size: 14, color: wine),
                        ],
                      ),
                      const SizedBox(height: 4),
                      Row(
                        children: [
                          Icon(Icons.arrow_back, size: 14, color: rose),
                          Text(
                            'hide()',
                            style: TextStyle(
                              fontSize: 8,
                  ...
                  Container(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.visibility, size: 18, color: wine),
                        Text(
                          'Showing',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text(
                      'Z-Stack After Multiple show() Calls',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 10,
                        color: wine,
        ...
        Container(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: wine.withValues(alpha: 0.3)),
            ),
            child: Text(
          ...
          child: Column(
            children: [
              for (final method in [
                (
                  'show()',
                  'Opening overlay from a known closed state',
                  'Button click to open menu, programmatic open on data load',
                  wine,
                ),
                (
                  'hide()',
                  'Closing overlay from a known open state',
                  'Dismiss on outside tap, close on navigation, timeout close',
                  rose,
                ),
                (
                  'toggle()',
                  'Switching state when current state is unknown',
          ...
          child: Column(
            children: [
              for (final dismiss in [
                (
                  'Tap outside',
                  'Wrap overlay child in TapRegion or use '
                ...
                (
                  'Back button',
                  'Use PopScope in the overlay child to '
                ...
                (
                  'Timeout',
                  'Start a Timer in overlayChildBuilder, call '
                ...
                (
                  'Navigation',
                  'Listen to NavigatorObserver or route '
                ...
                (
                  'Programmatic',
                  'Call hide() directly from any event '
                      'handler or callback',
                  Icons.code,
                  accentTeal,
                ),
        ...
        sectionHeader(
          '12 \u00b7 vs Other Flutter Controllers',
              ...
              for (final error in [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border(left: BorderSide(color: error.$3, width: 3)),
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
          ...
          child: Column(
            children: [
              for (final perf in [
                (
                  'No ChangeNotifier',
                  'No listener list overhead — direct '
                      'state management',
                  Icons.flash_on,
                  wine,
                ),
                (
                  'Boolean state',
                  'Single bool flip — minimal work per '
                      'show/hide call',
                  Icons.toggle_on,
                  rose,
                ),
                (
                  'No dispose needed',
                  'No cleanup bookkeeping — no listener '
                      'leak risk',
                ...
                (
                  'Automatic rebuild',
                  'Only the OverlayPortal widget rebuilds '
                      'when state changes',
                  Icons.refresh,
                  softWine,
                ),
