...
dynamic build(BuildContext context) {
  ...
  Widget noteBox(String text, Color border, Color bg) {
    return Container(
      ...
      child: Text(text, style: TextStyle(fontSize: 13, color: darkBurgundy)),
    );
  }
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Programmatic control of MenuAnchor menu open/close state',
                style: TextStyle(
            ...
            children: [
              for (final member in [
                ...
                (
                  'close()',
                  'void',
                  'Closes the menu and all descendant menus',
                  'Method',
                  carmine,
                  Icons.close,
                ),
                ...
                (
                  'maybeOf(ctx)',
                  'MenuController?',
                  'Finds controller from BuildContext',
                  'Static',
                  darkBurgundy,
                  Icons.search,
                ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              member.$3,
                              style: TextStyle(fontSize: 11, color: carmine),
                            ),
                            Text(
                              'Returns: ${member.$2}',
                              style: TextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              for (final detail in [
                (
                  'No position',
                  'Menu opens at anchor default location',
                  'Used for button-triggered menus',
                  tealContrast,
                ),
                (
                  'With position',
                  'Menu opens at specified screen offset',
                  'Used for context menus at tap location',
                  scarlet,
                ),
                (
                  'Already open',
                  'Calling open() again is a no-op',
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        detail.$2,
                        style: TextStyle(fontSize: 11, color: darkBurgundy),
                      ),
                      Text(
                        detail.$3,
                        style: TextStyle(
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        row.$2,
                        style: TextStyle(fontSize: 10, color: carmine),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8),
            ...
            children: [
              for (final step in [
                ...
                (
                  3,
                  'MenuAnchor attaches',
                  'Internal _attach() binds controller to state',
                  carmine,
                ),
                (
                  4,
                  'Call controller.open()',
                  'Controller tells MenuAnchor to show overlay',
                  deepCarmine,
                ),
                (
                  5,
                  'Menu is displayed',
                  'Overlay entry with menu items appears',
                  darkBurgundy,
                ),
                (
                  6,
                  'Call controller.close()',
                  'Menu overlay is dismissed',
                  tealContrast,
                ),
              ])
                Container(
          ...
          child: Column(
            ...
            children: [
              ...
              for (final scenario in [
                (
                  'Inside MenuAnchor',
                  'Returns the controller attached to the nearest MenuAnchor',
                  tealContrast,
                  Icons.check_circle,
                ),
                (
                  'Outside MenuAnchor',
                  'Returns null — no menu ancestor found',
                  amberContrast,
                  Icons.warning,
                ),
                (
                  'Nested menus',
                  'Returns the nearest (innermost) controller',
                  scarlet,
                  Icons.layers,
                ),
              ])
                  ...
                  children: [
                    for (final item in [
                      ...
                      (
                        'Recent',
                        true,
                        ['file1.dart', 'file2.dart', 'file3.dart'],
                      ),
                      ('Save', false, null),
                      ('Exit', false, null),
                    ])
          ...
          child: Column(
            children: [
              for (final step in [
                (
                  1,
                  'Detect secondary tap',
                  'GestureDetector.onSecondaryTapUp',
                  scarlet,
                ),
                (2, 'Get tap position', 'details.globalPosition', brightRed),
                (
                  3,
                  'Call open(position:)',
                  'controller.open(position: tapPos)',
                  carmine,
                ),
                (
                  4,
                  'Menu appears at cursor',
                  'Overlay positioned at tap location',
                  deepCarmine,
                ),
              ])
                Container(
          ...
          child: Column(
            children: [
              for (final behavior in [
                ...
                (
                  'dispose()',
                  'Clean up — important to call when done',
                  deepCarmine,
                ),
              ])
                Container(
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        row.$3,
                        style: TextStyle(fontSize: 10, color: darkBurgundy),
                      ),
                    ),
                  ],
                ),
            ...
            children: [
              for (final pattern in [
                (
                  ...
                  'Create controller in State, pass to MenuAnchor, '
                ...
                (
                  ...
                  'Wrap area in GestureDetector, call '
                ...
                (
                  'Programmatic toggle',
                  'Check isOpen and call open() or close() accordingly '
                      'for toggle behavior',
                  Icons.toggle_on,
                  carmine,
                ),
                (
                  ...
                  'Use Shortcuts/Actions to call open() or close() '
                      'on key combinations',
                  Icons.keyboard,
                  deepCarmine,
                ),
                (
                  ...
                  'In onPressed of MenuItemButton, call '
          ...
          child: Column(
            children: [
              for (final internal in [
                (
                  '_attach(state)',
                  'Binds controller to MenuAnchor state',
                  carmine,
                ),
