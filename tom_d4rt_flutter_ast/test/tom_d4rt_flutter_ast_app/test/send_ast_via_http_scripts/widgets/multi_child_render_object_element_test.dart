...
dynamic build(BuildContext context) {
  ...
  Widget noteBox(String text, Color border, Color bg) {
    return Container(
      ...
      child: Text(text, style: TextStyle(fontSize: 13, color: deepArctic)),
    );
  }
  ...
  final columnWidget = Column(
    children: [const Text('Alpha'), const Text('Beta'), const Text('Gamma')],
  );
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Element that manages a list of children for multi-child render objects',
                style: TextStyle(
        ...
        // ── 2. What is it ────────────────────────────────────────────
        sectionBanner(
          '1 \u00b7 What Is MultiChildRenderObjectElement',
        ...
        sectionBanner(
          '3 \u00b7 Widgets That Create This Element',
          ...
          child: Column(
            children: [
              for (final widget in [
                ...
                (
                  'Flex',
                  'Flexible layout (base of Row/Column)',
                  'RenderFlex',
                  Icons.view_stream,
                  deepArctic,
                ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              widget.$2,
                              style: TextStyle(fontSize: 11, color: deepArctic),
                            ),
                            Text(
                              '\u2192 ${widget.$3}',
                              style: TextStyle(
        ...
        sectionBanner(
          '4 \u00b7 Live Demo: Column With Children',
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Column(children: [Text("Alpha"), Text("Beta"), Text("Gamma")])',
                style: TextStyle(
                  fontSize: 11,
                  fontFamily: 'monospace',
                  color: glacier,
              ...
              Text(
                'This Column creates a MultiChildRenderObjectElement with 3 child elements.',
                style: TextStyle(
                  fontSize: 11,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'IndexedSlot(index: $i, value: ${i == 0 ? "null" : "child[${i - 1}]"})',
                              style: TextStyle(
                                fontSize: 11,
                                fontFamily: 'monospace',
                                fontWeight: FontWeight.bold,
                            ...
                            Text(
                              ...
                              style: TextStyle(fontSize: 10, color: slateBlue),
                            ),
                          ],
                        ),
                      ),
            ...
            children: [
              for (final step in [
                (
                  1,
                  'Element created',
                  'MultiChildRenderObjectWidget.createElement() called',
                  glacier,
                ),
                (
                  2,
                  'mount(parent, slot)',
                  'Element attaches to the element tree',
                  arcticBlue,
                ),
                (
                  3,
                  'super.mount()',
                  'Creates the RenderObject via createRenderObject()',
                  skyBlue,
                ),
                (
                  4,
                  'For each child widget',
                  'Iterates over widget.children list',
                  slateBlue,
                ),
                (
                  5,
                  'inflateWidget(child, slot)',
                  'Creates child Element with IndexedSlot',
                  deepArctic,
                ),
                (
                  6,
                  'Children list built',
                  'All child elements stored in _children list',
                  warmAmber,
                ),
              ])
                Container(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              step.$3,
                              style: TextStyle(fontSize: 11, color: slateBlue),
                            ),
                          ],
                        ),
                      ),
        ...
        sectionBanner(
          '8 \u00b7 Forgotten Children Optimization',
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'O(n\u00b2) to remove\nchildren from list',
                            textAlign: TextAlign.center,
                            style: TextStyle(fontSize: 10, color: deepArctic),
                          ),
                        ],
                      ),
                    ),
        ...
        sectionBanner(
          '9 \u00b7 Render Object Child Operations',
            ...
            children: [
              for (final op in [
                (
                  ...
                  'Inserts child RO into container after the sibling in slot',
                ...
                (
                  ...
                  'Moves child RO from oldSlot to newSlot position',
                ...
                (
                  ...
                  'Removes child RO from the container',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border(left: BorderSide(color: op.$5, width: 3)),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
        ...
        sectionBanner(
          '10 \u00b7 Live Demo: Stack With Layers',
          ...
          child: Column(
            ...
            children: [
              for (final scenario in [
                (
                  'Without keys',
                  'Children matched by position only. Reordering destroys and recreates elements.',
                  coralAccent,
                  Icons.shuffle,
                ),
                (
                  'With ValueKey',
                  'Children matched by key. Reordering moves existing elements without recreation.',
                  glacier,
                  Icons.vpn_key,
                ),
                (
                  'With ObjectKey',
                  'Like ValueKey but uses object identity. Useful for model-based lists.',
                  arcticBlue,
                  Icons.fingerprint,
                ),
                (
                  'With GlobalKey',
                  'Element can move across different parents. Most expensive but most flexible.',
                  warmAmber,
                  Icons.public,
                ),
              ])
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        ...
                        Color.lerp(arcticBlue, lightIce, i / 11.0) ??
                            arcticBlue,
                      ],
                    ),
                    borderRadius: BorderRadius.circular(6),
