  ...
  Widget cxBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('● ', style: TextStyle(color: cxAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          cxSection('1 · Class Identity & Purpose', [
            ...
            cxKeyValue('Toolbar', 'CupertinoAdaptiveTextSelectionToolbar'),
            cxDivider(),
            cxBullet(
          ...
          cxSection('4 · Adding Custom Items Step-by-Step', [
            ...
            cxNumberedStep(5, 'Return the toolbar widget from the builder.'),
            cxDivider(),
            cxCodeBlock(
              'TextField(\n'
