  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'CharacterActivator is a ShortcutActivator that matches '
    ...
    },
    {
      ...
      'body':
          'A "/" character might be produced by different keys on '
    ...
    },
    {
      ...
      'body':
          'SingleActivator matches specific key + modifier combos '
    ...
    },
    {
      ...
      'title': 'Simple API',
      'body':
          'Construction is straightforward: CharacterActivator("?") '
  ...
  final properties = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The character that activates this shortcut. Must '
    ...
    },
    {
      ...
      'description':
          'Optional set of logical keys that can trigger '
    ...
    },
    {
      ...
      'description':
          'Returns true when the key event produces the '
    ...
    },
    {
      ...
      'description':
          'Returns a debug description of this activator '
  ...
  final commonChars = <Map<String, dynamic>>[
    {
      ...
      'note':
          'The most common character shortcut. Nearly universal '
          'for "start searching."',
    },
    {
      'char': '?',
  ...
  final mechanismSteps = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.cyan[700]!,
      'detail':
          'The user presses a physical key on their keyboard. '
    ...
    },
    {
      ...
      'color': Colors.teal[700]!,
      'detail':
          'The platform (OS + keyboard layout) resolves the '
    ...
    },
    {
      ...
      'color': Colors.cyan[600]!,
      'detail':
          'Flutter receives a KeyEvent with both the logical '
    ...
    },
    {
      ...
      'color': Colors.teal[600]!,
      'detail':
          'For each registered CharacterActivator, the accepts() '
    ...
    },
    {
      ...
      'color': Colors.cyan[500]!,
      'detail':
          'If accepted, the Shortcuts widget creates the mapped '
  ...
  final useCases = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.cyan[700]!,
      'description':
          'Map "/" to a SearchIntent that opens or focuses '
    ...
    },
    {
      ...
      'color': Colors.teal[700]!,
      'description':
          'Map "?" to a ShowShortcutsIntent that displays '
    ...
    },
    {
      ...
      'color': Colors.cyan[600]!,
      'description':
          'Map "j" and "k" to NavigateDownIntent and '
    ...
    },
    {
      ...
      'color': Colors.teal[600]!,
      'description':
          'Map ":" to an OpenCommandPaletteIntent that '
    ...
    },
    {
      ...
      'color': Colors.cyan[500]!,
      'description':
          'In a messaging or email UI, map "r" to a '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'CharacterActivator fires on character input, which '
    ...
    },
    {
      ...
      'body':
          'The character parameter must be exactly one character '
    ...
    },
    {
      ...
      'body':
          'When the shortcut concept is character-based (e.g., '
    ...
    },
    {
      ...
      'body':
          'The optional triggers parameter lets you restrict '
    ...
    },
    {
      ...
      'body':
          'CharacterActivator("a") and CharacterActivator("A") '
    ...
    },
    {
      ...
      'body':
          'Platform text composition differs between Windows, '
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        _caTag(p['type'] as String, p['color'] as Color),
                      ],
                    ),
                    SizedBox(height: 8),
                    Text(
            ...
            (cc) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: cc['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
            ...
            (le) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: le['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
