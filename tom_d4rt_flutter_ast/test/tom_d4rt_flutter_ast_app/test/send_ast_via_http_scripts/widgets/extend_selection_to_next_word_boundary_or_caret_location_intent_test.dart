  ...
  Widget wcBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('● ', style: TextStyle(color: wcAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          wcSection('2 · The Composite Destination Concept', [
            ...
            wcKeyValue(
              'Extent equals base',
              'Behaves like simple word-boundary',
            ),
          ]),
          ...
          wcSection('3 · Forward Selection Walk-Through', [
            ...
            wcBullet('Result: TextSelection(baseOffset: 4, extentOffset: 15).'),
            wcCodeBlock(
          ...
          wcSection('4 · Backward Selection Walk-Through', [
            ...
            wcBullet('Result: TextSelection(baseOffset: 9, extentOffset: 10).'),
            wcDivider(),
            wcBullet(
          ...
          wcSection('6 · Keyboard Shortcut Mapping', [
            ...
            wcKeyValue('Linux / Windows', 'Ctrl+Shift+Right / Ctrl+Shift+Left'),
            wcKeyValue(
              'iOS',
          ...
          wcSection('9 · RTL & Bidirectional Text', [
            ...
            wcKeyValue(
              'Mixed bidi',
              'Visual position depends on embedding level',
            ),
          ]),
