  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'DragScrollActivity is the ScrollActivity subclass that '
    ...
    },
    {
      ...
      'body':
          'The Scrollable\'s gesture detector captures raw pointer '
    ...
    },
    {
      ...
      'body':
          'ScrollPosition maintains a current activity. DragScrollActivity '
    ...
    },
    {
      ...
      'body':
          'DragScrollActivity tracks the velocity of the user\'s '
  ...
  final states = <Map<String, dynamic>>[
    {
      ...
      'desc':
          'No scrolling happening. The default resting state. '
    ...
    },
    {
      ...
      'desc':
          'User is actively dragging. Receives delta updates from '
    ...
    },
    {
      ...
      'desc':
          'Momentum scrolling after a fling gesture. Created with '
    ...
    },
    {
      ...
      'desc':
          'Programmatic animated scrolling (e.g., animateTo()). '
  ...
  final internals = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.teal[600]!,
      'desc':
          'The actual drag logic is in ScrollDragController, '
    ...
    },
    {
      ...
      'desc':
          'Called on every drag update with the pixel delta. '
    ...
    },
    {
      ...
      'desc':
          'Called when the user lifts their finger. Receives the '
    ...
    },
    {
      ...
      'desc':
          'Called when the drag is cancelled (e.g., by the system). '
    ...
    },
    {
      ...
      'desc':
          'DragScrollActivity communicates with ScrollPosition '
    ...
    },
    {
      ...
      'color': Colors.indigo[500]!,
      'desc':
          'When DragScrollActivity is installed, it dispatches a '
  ...
  final flow = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.teal[600]!,
      'detail':
          'User puts finger on screen. The Scrollable\'s gesture '
    ...
    },
    {
      ...
      'color': Colors.indigo[500]!,
      'detail':
          'After the pointer moves past the drag threshold '
    ...
    },
    {
      ...
      'color': Colors.teal[500]!,
      'detail':
          'ScrollPosition.drag() creates a new ScrollDragController '
    ...
    },
    {
      ...
      'color': Colors.indigo[400]!,
      'detail':
          'Each pointer move generates a DragUpdateDetails. The '
    ...
    },
    {
      ...
      'color': Colors.teal[400]!,
      'detail':
          'If the user drags past the scroll extent, '
    ...
    },
    {
      ...
      'color': Colors.indigo[500]!,
      'detail':
          'User lifts finger. The gesture detector calculates '
    ...
    },
    {
      ...
      'color': Colors.teal[600]!,
      'detail':
          'ScrollPosition.goBallistic() creates a simulation '
  ...
  final physicsCards = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.teal[500]!,
      'desc':
          'During drag: allows overscroll with rubber-banding '
    ...
    },
    {
      ...
      'color': Colors.indigo[500]!,
      'desc':
          'During drag: clamps to bounds, no overscroll. '
    ...
    },
    {
      ...
      'color': Colors.grey[500]!,
      'desc':
          'Returns false from shouldAcceptUserOffset(). This '
    ...
    },
    {
      ...
      'color': Colors.purple[400]!,
      'desc':
          'You can create custom ScrollPhysics to modify drag '
  ...
  final notifications = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.teal[600]!,
      'desc':
          'Dispatched immediately when the drag begins. Contains '
    ...
    },
    {
      ...
      'color': Colors.indigo[500]!,
      'desc':
          'Dispatched after each pixel change. Contains the scroll '
    ...
    },
    {
      ...
      'color': Colors.teal[500]!,
      'desc':
          'Dispatched when setPixels() returns non-zero overscroll. '
    ...
    },
    {
      ...
      'color': Colors.indigo[400]!,
      'desc':
          'Dispatched when DragScrollActivity.dispose() is called '
    ...
    },
    {
      ...
      'color': Colors.teal[400]!,
      'desc':
          'Dispatched with ScrollDirection.forward or .reverse '
  ...
  final relatedConcepts = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.teal[600]!,
      'desc':
          'The owning object. ScrollPosition creates and manages '
    ...
    },
    {
      ...
      'color': Colors.indigo[500]!,
      'desc':
          'Defines how drags feel. DragScrollActivity delegates '
    ...
    },
    {
      ...
      'color': Colors.teal[500]!,
      'desc':
          'The actual Drag interface implementation. '
    ...
    },
    {
      ...
      'color': Colors.indigo[400]!,
      'desc':
          'The widget that hosts scrolling. Its ScrollableState '
    ...
    },
    {
      ...
      'color': Colors.teal[400]!,
      'desc':
          'Raw gesture recognition. Scrollable wraps its child in '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'You almost never need to subclass DragScrollActivity. '
    ...
    },
    {
      ...
      'body':
          'To react to drag scrolling, wrap your widget in '
    ...
    },
    {
      ...
      'body':
          'Axis.vertical uses VerticalDragGestureRecognizer, '
    ...
    },
    {
      ...
      'body':
          'When a user touches during a BallisticScrollActivity '
    ...
    },
    {
      ...
      'body':
          'DragEndDetails includes velocity. ScrollPhysics has '
    ...
    },
    {
      ...
      'body':
          'DragScrollActivity is ephemeral. It exists only while '
            ...
            (i) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: i['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _dsTag(i['kind'] as String, i['color'] as Color),
                        SizedBox(width: 8),
                        Expanded(
                          child: Text(
                            i['name'] as String,
            ...
            (n) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: n['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _dsTag(n['title'] as String, n['color'] as Color),
                      ],
                    ),
                    SizedBox(height: 4),
                    Text(
