...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'TickerProviderStateMixin is a mixin applied to State '
    ...
    },
    {
      ...
      'body':
          'When you create an AnimationController, you pass vsync: '
    ...
    },
    {
      ...
      'body':
          'Unlike SingleTickerProviderStateMixin (which asserts '
    ...
    },
    {
      ...
      'body':
          'When the widget tree is not visible (offscreen, app in '
  ...
  final lifecycleSteps = <Map<String, dynamic>>[
    {
      ...
      'title': 'Mixin Applied',
      'detail':
          'Add "with TickerProviderStateMixin" to your State '
    ...
    },
    {
      ...
      'detail':
          'In initState(), create AnimationController(vsync: this). '
    ...
    },
    {
      ...
      'detail':
          'When the controller is started (forward, repeat, etc.), '
    ...
    },
    {
      ...
      'detail':
          'If the widget becomes invisible (e.g., pushed behind '
    ...
    },
    {
      ...
      'title': 'Dispose',
      'detail':
          'In dispose(), call controller.dispose() which stops '
  ...
  final comparison = <Map<String, dynamic>>[
    ...
    {'feature': 'Ticker count', 'single': 'Exactly 1', 'multi': 'Unlimited'},
    {
      'feature': 'Assertion',
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'code':
          ...
          '}',
      'description':
          'Standard pattern: mixin on State, create '
    ...
    },
    {
      ...
      'code':
          ...
          '}',
      'description':
          'The main reason to choose TickerProviderStateMixin '
    ...
    },
    {
      ...
      'code':
          'class _TabState extends State<MyTabs>\n'
          '    with TickerProviderStateMixin {\n'
          ...
          '}',
      'description':
          'TabController also needs a TickerProvider. '
  ...
  final mistakes = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'Not calling controller.dispose() causes "Ticker was '
    ...
    },
    {
      ...
      'detail':
          'Creating AnimationController in build() creates a new '
    ...
    },
    {
      ...
      'detail':
          'Using SingleTickerProviderStateMixin with 2+ controllers '
    ...
    },
    {
      ...
      'detail':
          'Accessing a disposed AnimationController (e.g., from an '
    ...
    },
    {
      ...
      'detail':
          'The mixin can only be applied to State subclasses. '
  ...
  final internals = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'The method from TickerProvider that the mixin '
    ...
    },
    {
      'name': 'Ticker.start()',
      'detail':
          'Registers the ticker with SchedulerBinding. It '
    ...
    },
    {
      'name': 'Ticker.muted',
      'detail':
          'When true, the ticker silences its callback without '
    ...
    },
    {
      ...
      'detail':
          'Ancestor widget that controls whether tickers should '
  ...
  final practices = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'Use SingleTickerProviderStateMixin for exactly 1 '
    ...
    },
    {
      ...
      'detail':
          'Every AnimationController must be disposed. For N '
    ...
    },
    {
      ...
      'detail':
          'Declare controllers as "late final" fields. This '
    ...
    },
    {
      ...
      'detail':
          'Wrap offscreen content with TickerMode(enabled: false) '
    ...
    },
    {
      ...
      'detail':
          'After await, check "if (!mounted) return" before '
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 10),
        Text(
          'How a single frame flows from scheduler to pixels:',
