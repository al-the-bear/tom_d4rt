...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'ClipboardStatusNotifier is a ValueNotifier that tracks '
    ...
    },
    {
      ...
      'body':
          'It extends ValueNotifier<ClipboardStatus>, so you '
    ...
    },
    {
      ...
      'body':
          'Since there is no clipboard-change event on most '
    ...
    },
    {
      ...
      'body':
          'Flutter\'s text editing widgets (TextField, '
  ...
  final statusValues = <Map<String, dynamic>>[
    {
      ...
      'meaning':
          'The clipboard contains content that can be pasted. '
    ...
    },
    {
      ...
      'meaning':
          'The clipboard is empty or does not contain string '
    ...
    },
    {
      ...
      'meaning':
          'The clipboard status has not been determined yet. '
  ...
  final pollingSteps = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'When the first listener is added via addListener(), '
    ...
    },
    {
      ...
      'color': Colors.green[600]!,
      'detail':
          'update() calls Clipboard.hasStrings() via the '
    ...
    },
    {
      ...
      'detail':
          'When the Future completes, the notifier sets its '
    ...
    },
    {
      ...
      'detail':
          'The notifier does not continuously poll on a timer. '
    ...
    },
    {
      ...
      'detail':
          'When the last listener is removed, polling stops. '
  ...
  final usagePatterns = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.teal[500]!,
      'code':
          '// The text editing toolbar does this:\n'
          '//\n'
    ...
    },
    {
      ...
      'color': Colors.green[500]!,
      'code':
          '// ALWAYS dispose ClipboardStatusNotifier\n'
  ...
  final architectureCards = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.teal[700]!,
      'body':
          'Clipboard.hasStrings() uses the flutter/platform '
    ...
    },
    {
      ...
      'color': Colors.green[600]!,
      'body':
          'The notifier caches the last known status in its '
    ...
    },
    {
      ...
      'color': Colors.teal[500]!,
      'body':
          'ClipboardStatusNotifier can re-poll when the app '
    ...
    },
    {
      ...
      'color': Colors.green[500]!,
      'body':
          'If the platform channel call fails (e.g., on web '
  ...
  final statusDisplays = <Map<String, dynamic>>[
    {
      ...
      'desc':
          'Clipboard has string content. The paste button is '
    ...
    },
    {
      ...
      'desc':
          'Clipboard is empty or has non-string content. The '
    ...
    },
    {
      ...
      'label': 'Checking...',
      'desc':
          'Status not yet determined. Waiting for the platform '
  ...
  final relatedClasses = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.teal[700]!,
      'desc':
          'Clipboard class provides static methods: getData(), '
    ...
    },
    {
      ...
      'color': Colors.green[600]!,
      'desc':
          'The three-value enum: pasteable, notPasteable, unknown. '
    ...
    },
    {
      ...
      'color': Colors.teal[500]!,
      'desc':
          'The text selection toolbar (copy/cut/paste/select all) '
    ...
    },
    {
      ...
      'color': Colors.green[500]!,
      'desc':
          'EditableTextState creates and manages a '
    ...
    },
    {
      ...
      'color': Colors.teal[400]!,
      'desc':
          'ClipboardStatusNotifier extends ValueNotifier, '
  ...
  final edgeCases = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'Clipboard access on web is restricted by browser '
    ...
    },
    {
      ...
      'detail':
          'macOS supports clipboard change count, so polling '
    ...
    },
    {
      ...
      'detail':
          'Android provides clipboard change listeners via '
    ...
    },
    {
      ...
      'detail':
          'ClipboardStatusNotifier only checks for string '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'Don\'t rely on automatic polling alone. Call update() '
    ...
    },
    {
      ...
      'body':
          'ClipboardStatusNotifier maintains platform resources. '
    ...
    },
    {
      ...
      'body':
          'The initial status is unknown until the first poll '
    ...
    },
    {
      ...
      'body':
          'Create one ClipboardStatusNotifier per editing '
    ...
    },
    {
      ...
      'body':
          'On web, clipboard reads require user gesture and '
    ...
    },
    {
      ...
      'body':
          'ClipboardStatusNotifier tells you IF you can paste. '
            ...
            (sv) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: sv['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
            ...
            (ac) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: ac['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      height: 50,
                      decoration: BoxDecoration(
                        color: (sd['iconColor'] as Color).withOpacity(0.15),
                        shape: BoxShape.circle,
                      ),
                      child: Center(
                        child: Icon(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _cnTag(rc['class'] as String, rc['color'] as Color),
                        SizedBox(width: 8),
                        Expanded(
                          child: Text(
                            rc['role'] as String,
