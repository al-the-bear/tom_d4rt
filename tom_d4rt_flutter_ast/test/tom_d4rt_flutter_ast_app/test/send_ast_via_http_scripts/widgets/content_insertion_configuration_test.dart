...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'ContentInsertionConfiguration tells Flutter\'s text '
    ...
    },
    {
      ...
      'body':
          'It is not a widget itself. You pass it as a property '
    ...
    },
    {
      ...
      'body':
          'Modern soft keyboards (Android Gboard, iOS keyboard, '
    ...
    },
    {
      ...
      'body':
          'You declare which content types you accept via a list '
  ...
  final properties = <Map<String, dynamic>>[
    {
      ...
      'description':
          'List of MIME types the text field accepts. '
    ...
    },
    {
      ...
      'description':
          'Callback invoked when the user selects content '
  ...
  final contentFields = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.amber[800]!,
      'description':
          'The MIME type of the inserted content, such as '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[700]!,
      'description':
          'A URI pointing to the content. On Android, this '
    ...
    },
    {
      ...
      'description':
          'Whether raw byte data is available. When true, '
    ...
    },
    {
      ...
      'description':
          'The raw bytes of the inserted content. May be '
  ...
  final mimeTypes = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Lossless raster format. Screenshots, icons, '
    ...
    },
    {
      ...
      'description':
          'Lossy compressed photos. Smaller file size than '
    ...
    },
    {
      ...
      'description':
          'Animated image format. Keyboard GIF pickers '
    ...
    },
    {
      ...
      'description':
          'Modern format supporting both lossy and lossless '
    ...
    },
    {
      ...
      'description':
          'Uncompressed bitmap. Rarely used from keyboards, '
  ...
  final codePatterns = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.deepOrange[700]!,
      'code':
          'void _handleContent(KeyboardInsertedContent c) {\n'
  ...
  final flowSteps = <Map<String, dynamic>>[
    {
      ...
      'icon': Icons.settings,
      'description':
          'Create ContentInsertionConfiguration with '
    ...
    },
    {
      ...
      'description':
          'Flutter sends the allowed MIME types to the '
    ...
    },
    {
      ...
      'icon': Icons.keyboard,
      'description':
          'The soft keyboard shows content buttons '
    ...
    },
    {
      ...
      'description':
          'User taps a GIF, sticker, or image in the '
    ...
    },
    {
      ...
      'description':
          'The platform sends the content data through '
    ...
    },
    {
      ...
      'icon': Icons.call_received,
      'description':
          'Your onContentInserted callback fires with '
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.amber[800]!,
      'description':
          'Accept images and GIFs for inline message '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[700]!,
      'description':
          'Accept high-quality images for post composition. '
    ...
    },
    {
      ...
      'color': Colors.amber[700]!,
      'description':
          'Accept all image types for inline note content. '
    ...
    },
    {
      ...
      'color': Colors.deepOrange[600]!,
      'description':
          'Only accept animated stickers (WebP and GIF) for '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'Always check hasData before accessing the data property. '
    ...
    },
    {
      ...
      'body':
          'Content URIs (especially Android content:// URIs) may '
    ...
    },
    {
      ...
      'body':
          'Keyboards can send very large images. Check the data '
    ...
    },
    {
      ...
      'body':
          'Many keyboards ignore content insertion configuration '
    ...
    },
    {
      ...
      'body':
          'The MIME type comes from the keyboard and may not be '
    ...
    },
    {
      ...
      'body':
          'ContentInsertionConfiguration handles keyboard-sourced '
            ...
            (pl) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: pl['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        _ciTag(pl['support'] as String, pl['color'] as Color),
                      ],
                    ),
                    SizedBox(height: 8),
                    ...(pl['details'] as List<String>).map(
                      (detail) => Padding(
