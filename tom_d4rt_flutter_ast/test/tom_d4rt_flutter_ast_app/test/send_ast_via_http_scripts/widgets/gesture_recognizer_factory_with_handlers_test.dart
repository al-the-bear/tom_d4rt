  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'GestureRecognizerFactoryWithHandlers<T> is a generic '
    ...
    },
    {
      ...
      'body':
          'The factory separates creation from configuration. '
    ...
    },
    {
      ...
      'body':
          'RawGestureDetector\'s gestures parameter takes a '
    ...
    },
    {
      ...
      'body':
          'The familiar GestureDetector widget builds a '
  ...
  final constructorParts = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'The type T must extend GestureRecognizer. This is '
    ...
    },
    {
      ...
      'detail':
          'First argument — GestureRecognizerFactoryConstructor. '
    ...
    },
    {
      ...
      'code':
          ...
          '}',
      'detail':
          'Second argument — GestureRecognizerFactoryInitializer. '
  ...
  final lifecycleSteps = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.purple[700]!,
      'detail':
          'RawGestureDetector reads its gestures map. For each '
    ...
    },
    {
      ...
      'color': Colors.indigo[700]!,
      'detail':
          'If no recognizer of this type exists yet, '
    ...
    },
    {
      ...
      'color': Colors.purple[600]!,
      'detail':
          'RawGestureDetector calls factory.initializer(instance) '
    ...
    },
    {
      ...
      'detail':
          'The recognizer is registered with the gesture arena '
    ...
    },
    {
      ...
      'detail':
          'On subsequent rebuilds, the constructor is NOT called '
    ...
    },
    {
      ...
      'detail':
          'When RawGestureDetector is removed from the tree, '
  ...
  final arenaCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'When a pointer event arrives, all registered recognizers '
    ...
    },
    {
      ...
      'body':
          'When you register multiple factories in the gestures '
    ...
    },
    {
      ...
      'body':
          'Some recognizers are eager (accept immediately after '
    ...
    },
    {
      ...
      'body':
          'The factory pattern ensures recognizers persist across '
  ...
  final scenarios = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.purple[700]!,
      'description':
          'A RawGestureDetector with PanGestureRecognizer '
    ...
    },
    {
      ...
      'color': Colors.indigo[700]!,
      'description':
          'Multiple factories: ScaleGestureRecognizer for '
    ...
    },
    {
      ...
      'color': Colors.purple[600]!,
      'description':
          'A custom SwipeGestureRecognizer that only accepts '
    ...
    },
    {
      ...
      'color': Colors.indigo[600]!,
      'description':
          'Multiple overlapping recognizers for a game: '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'Only use GestureRecognizerFactoryWithHandlers when '
    ...
    },
    {
      ...
      'body':
          'The constructor callback creates a GestureRecognizer. '
    ...
    },
    {
      ...
      'body':
          'Set ALL event handlers in the initializer, not the '
    ...
    },
    {
      ...
      'body':
          'In the gestures map, the key (Type) must match the '
    ...
    },
    {
      ...
      'body':
          'Properties that don\'t change (like dragStartBehavior, '
    ...
    },
    {
      ...
      'body':
          'RawGestureDetector automatically disposes all '
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        _grfTag(rt['use'] as String, rt['color'] as Color),
                      ],
                    ),
                    SizedBox(height: 4),
                    Text(
                      rt['handlers'] as String,
                      style: TextStyle(
                        fontSize: 10,
