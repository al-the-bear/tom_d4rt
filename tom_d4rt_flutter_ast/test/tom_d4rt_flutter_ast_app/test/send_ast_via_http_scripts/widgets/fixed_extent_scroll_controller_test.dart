  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'FixedExtentScrollController extends ScrollController '
    ...
    },
    {
      ...
      'body':
          'The primary consumer is ListWheelScrollView (and its '
    ...
    },
    {
      ...
      'body':
          'The most important property: selectedItem returns '
    ...
    },
    {
      ...
      'body':
          'Instead of jumpTo(pixels) and animateTo(pixels), '
  ...
  final properties = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Constructor parameter: the item index to start '
    ...
    },
    {
      ...
      'bgColor': Colors.indigo[50]!,
      'description':
          'Immediately jumps to the given item index '
    ...
    },
    {
      ...
      'bgColor': Colors.deepPurple[50]!,
      'description':
          'Smoothly scrolls to the given item with '
  ...
  final ecosystem = <Map<String, dynamic>>[
    {
      ...
      'role': 'Controller',
      'description':
          'Navigates by item index. Provides selectedItem, '
    ...
    },
    {
      ...
      'role': 'Physics',
      'description':
          'Snapping physics that always settles on an item '
    ...
    },
    {
      ...
      'role': 'Widget',
      'description':
          'Renders children on a 3D cylinder. Uses '
    ...
    },
    {
      ...
      'role': 'Widget',
      'description':
          'iOS-style picker built on ListWheelScrollView. '
    ...
    },
    {
      ...
      'role': 'Metrics',
      'description':
          'ScrollMetrics subclass that adds itemIndex. '
  ...
  final lwsvConfigs = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.indigo[500]!,
      'description':
          'Height of each child in logical pixels. Every '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[500]!,
      'description':
          'Ratio of the wheel diameter to viewport height. '
    ...
    },
    {
      ...
      'color': Colors.indigo[600]!,
      'description':
          'How much 3D perspective to apply (0.0–0.01). '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[600]!,
      'description':
          'Horizontal offset of the wheel center '
    ...
    },
    {
      ...
      'color': Colors.indigo[700]!,
      'description':
          'How tightly children pack on the wheel. '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[700]!,
      'description':
          'Whether to magnify the selected (center) item. '
  ...
  final notifications = <Map<String, dynamic>>[
    {
      ...
      'detail':
          'The metrics property provides FixedExtentMetrics '
    ...
    },
    {
      ...
      'detail':
          'Fires continuously as the scroll position changes. '
    ...
    },
    {
      ...
      'detail':
          'Fires when the physics simulation finishes and '
    ...
    },
    {
      ...
      'detail':
          'Extends FixedScrollMetrics with itemIndex (int). '
  ...
  final patterns = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.indigo[600]!,
      'body':
          'Three FixedExtentScrollControllers — one for hours, '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[600]!,
      'body':
          'Multiple wheels with looping delegates. Call '
    ...
    },
    {
      ...
      'color': Colors.indigo[500]!,
      'body':
          'Left wheel selects the "from" unit, right wheel '
    ...
    },
    {
      ...
      'color': Colors.deepPurple[500]!,
      'body':
          'A "Reset" button calls animateToItem(0, ...) to '
    ...
    },
    {
      ...
      'color': Colors.indigo[700]!,
      'body':
          'Year, month, and day wheels — each with their own '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'Reading controller.selectedItem before the controller '
    ...
    },
    {
      ...
      'body':
          'ListWheelScrollView has an onSelectedItemChanged callback '
    ...
    },
    {
      ...
      'body':
          'Like any ScrollController, you must dispose it in '
    ...
    },
    {
      ...
      'body':
          'A FixedExtentScrollController can only be attached '
    ...
    },
    {
      ...
      'body':
          'For infinite/looping scrolling (like a date wheel), '
    ...
    },
    {
      ...
      'body':
          'Set initialItem in the constructor for the starting '
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: FractionallySizedBox(
                        ...
                        widthFactor: ((m['fraction'] as double) + 0.02).clamp(
                          0.02,
                          1.0,
                        ),
                        child: Container(
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: (e['color'] as Color).withOpacity(
                                    0.15,
                                  ),
                                  borderRadius: BorderRadius.circular(8),
                                ),
            ...
            (cfg) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10),
                  border: Border(
                    left: BorderSide(color: cfg['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
