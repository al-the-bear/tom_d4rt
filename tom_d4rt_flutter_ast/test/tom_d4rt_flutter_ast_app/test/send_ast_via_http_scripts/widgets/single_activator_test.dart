...
class _SingleActivatorDemo extends StatefulWidget {
  ...
  @override
  State<_SingleActivatorDemo> createState() => _SingleActivatorDemoState();
}

class _SingleActivatorDemoState extends State<_SingleActivatorDemo>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabCtrl,
        children: const [_ConstructorTab(), _MatchingTab(), _LockStatesTab()],
      ),
    );
  }
}
...
class _ConstructorTab extends StatefulWidget {
  ...
  @override
  State<_ConstructorTab> createState() => _ConstructorTabState();
}
...
class _ConstructorTabState extends State<_ConstructorTab>
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                ...
                Row(
                  children: [
                    ...
                    Switch(
                      ...
                      onChanged: (v) => setState(() => _includeRepeats = v),
          ...
          const SizedBox(height: 8),
          GestureDetector(
            onTap: () => setState(() => _expandParams = !_expandParams),
            child: Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: _kCard,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Icon(
                        _expandParams ? Icons.expand_less : Icons.expand_more,
                        size: 18,
                        color: _kDimText,
                      ),
                    ],
  ...
  List<Widget> _buildKeyBadges() {
    ...
    badges.add(_keyBadge(_triggers[_selectedTrigger].label, _kAccent));
    return badges;
  }
...
class _MatchingTabState extends State<_MatchingTab>
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          GestureDetector(
            onTap: () => setState(() => _expandAccepts = !_expandAccepts),
            child: Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: _kCard,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Icon(
                        _expandAccepts ? Icons.expand_less : Icons.expand_more,
                        size: 18,
                        color: _kDimText,
                      ),
                    ],
          ...
          const SizedBox(height: 8),
          GestureDetector(
            onTap: () => setState(() => _expandModOrder = !_expandModOrder),
            child: Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: _kCard,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Icon(
                        _expandModOrder ? Icons.expand_less : Icons.expand_more,
                        size: 18,
                        color: _kDimText,
                      ),
                    ],
                  ...
                  if (_expandModOrder) ...[
                    ...
                    _checkRow('shift', 'isShiftPressed == shift flag', _kGreen),
                    _checkRow('alt', 'isAltPressed == alt flag', _kAmber),
                    _checkRow('meta', 'isMetaPressed == meta flag', _kPurple),
                    const SizedBox(height: 8),
                    _codeBlock(
          ...
          const SizedBox(height: 8),
          GestureDetector(
            onTap: () => setState(() => _expandRepeats = !_expandRepeats),
            child: Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: _kCard,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Icon(
                        _expandRepeats ? Icons.expand_less : Icons.expand_more,
                        size: 18,
                        color: _kDimText,
                      ),
                    ],
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    GestureDetector(
                      onTap: () => setState(() => _simRepeat = !_simRepeat),
                      child: Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 10,
                          vertical: 4,
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: _simRepeat ? _kAmber : _kSubtle,
                          ),
                        ),
                        child: Text(
                          _simRepeat ? 'KeyRepeatEvent' : 'KeyDownEvent',
                          style: TextStyle(
                            color: _simRepeat ? _kAmber : _kDimText,
                            fontSize: 10,
                          ),
                        ),
                      ),
  ...
  Widget _matchResult() {
    ...
    final allMatch = keyMatch && ctrlMatch && shiftMatch && repeatOk;
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(
                allMatch ? Icons.check_circle : Icons.cancel,
                size: 16,
          ...
          _matchLine('Control: $_simCtrl == true', ctrlMatch),
          _matchLine('Shift: $_simShift == false', shiftMatch),
          _matchLine(
...
class _LockStatesTabState extends State<_LockStatesTab>
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          GestureDetector(
            onTap: () => setState(() => _expandPresets = !_expandPresets),
            child: Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: _kCard,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Icon(
                        _expandPresets ? Icons.expand_less : Icons.expand_more,
                        size: 18,
                        color: _kDimText,
                      ),
                    ],
                  ...
                  if (_expandPresets) ...[
                    ...
                    _presetRow('Paste', 'Ctrl+V', 'PasteTextIntent', _kGreen),
                    _presetRow('Undo', 'Ctrl+Z', 'UndoTextIntent', _kAmber),
                    _presetRow(
                      'Redo',
                      'Ctrl+Shift+Z',
                      'RedoTextIntent',
                    ...
                    _presetRow('Save', 'Ctrl+S', 'Custom SaveIntent', _kAccent),
                    _presetRow(
                      'New',
                      'Ctrl+N',
                      'Custom NewDocIntent',
  ...
  Widget _lockRow(String name, int value, ValueChanged<int> onChanged) {
    return Row(
      children: [
        SizedBox(
          width: 75,
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: sel
                      ? _stateColors[i].withValues(alpha: 0.15)
                      : Colors.transparent,
                  borderRadius: BorderRadius.circular(4),
                  border: Border.all(color: sel ? _stateColors[i] : _kSubtle),
                ),
                child: Center(
                  child: Text(
                    _stateLabels[i],
                    style: TextStyle(
                      color: sel ? _stateColors[i] : _kDimText,
                      fontSize: 9,
                      fontWeight: sel ? FontWeight.w700 : FontWeight.w400,
                    ),
                  ),
  ...
  String _buildLockCode() {
    ...
    if (_numLock != 0) {
      params.add('  numLock: LockState.${_stateLabels[_numLock]},');
    }
    if (_capsLock != 0) {
      params.add('  capsLock: LockState.${_stateLabels[_capsLock]},');
    }
    if (_scrollLock != 0) {
      params.add('  scrollLock: LockState.${_stateLabels[_scrollLock]},');
    }
    return 'const SingleActivator(\n'
        '${params.join('\n')}\n'
        ')';
  ...
  Widget _lockStateRow(String name, String desc, Color color) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 3),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _presetRow(String action, String keys, String intent, Color color) {
    return Container(
...
Widget _modToggle(String label, bool on, Color color, ValueChanged<bool> cb) {
  return GestureDetector(
    onTap: () => cb(!on),
    child: Container(
...
Widget _paramEntry(String name, String type, String desc, Color color) {
  return Padding(
