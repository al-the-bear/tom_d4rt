...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'SliverFadeTransition is a sliver widget that applies an '
    ...
    },
    {
      ...
      'body':
          'You provide an Animation<double> (typically from an '
    ...
    },
    {
      ...
      'body':
          'Wraps any sliver child: SliverList, SliverGrid, '
    ...
    },
    {
      ...
      'body':
          'Unlike wrapping a sliver\'s content in an Opacity widget, '
  ...
  final properties = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The animation that drives the opacity. Values should '
    ...
    },
    {
      ...
      'description':
          'The child sliver widget to fade. Must produce a '
    ...
    },
    {
      ...
      'description':
          'Whether to include the sliver\'s semantics in the '
  ...
  final sliverFamily = <Map<String, dynamic>>[
    {
      ...
      'description':
          'You control the Animation<double>. Paired with '
    ...
    },
    {
      ...
      'description':
          'You set a target opacity value and duration. The '
    ...
    },
    {
      ...
      'type': 'No animation',
      'description':
          'Applies a static opacity to a sliver. No animation — '
    ...
    },
    {
      ...
      'description':
          'Shows/hides a sliver completely. When hidden, the '
  ...
  final animationPatterns = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.lightGreen[600]!,
      'code':
          '// Fade happens between 20% and 60% of the\n'
    ...
    },
    {
      ...
      'color': Colors.teal[600]!,
      'code':
          '// Three slivers fading in sequence\n'
  ...
  final scenarios = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.lightGreen[700]!,
      'description':
          'Data loads asynchronously. While loading, show a '
    ...
    },
    {
      ...
      'color': Colors.teal[700]!,
      'description':
          'A scroll view with header, body, and footer sections. '
    ...
    },
    {
      ...
      'color': Colors.lightGreen[600]!,
      'description':
          'A product grid that can be collapsed/expanded. When '
    ...
    },
    {
      ...
      'color': Colors.teal[600]!,
      'description':
          'When search results change, the old list fades out, '
  ...
  final perfTips = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.lightGreen[700]!,
      'description':
          'Don\'t wrap a sliver\'s children individually in '
    ...
    },
    {
      ...
      'color': Colors.teal[700]!,
      'description':
          'A sliver at opacity 0.0 is still laid out and still '
    ...
    },
    {
      ...
      'color': Colors.lightGreen[600]!,
      'description':
          'SliverFadeTransition creates an opacity layer in the '
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'The sliver parameter must be a sliver widget (produces '
    ...
    },
    {
      ...
      'body':
          'If your AnimationController starts at 0.0 and you haven\'t '
    ...
    },
    {
      ...
      'body':
          'Need simpler API? SliverAnimatedOpacity is the implicit '
    ...
    },
    {
      ...
      'body':
          'When fully transparent, the sliver\'s children cannot '
    ...
    },
    {
      ...
      'body':
          'Set alwaysIncludeSemantics: true if screen readers should '
    ...
    },
    {
      ...
      'body':
          'For the best UX, combine SliverFadeTransition (section '
            ...
            (sf) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: sf['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
            ...
            (ap) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: ap['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    ...(sc['sequence'] as List<String>).asMap().entries.map(
                      (entry) => Padding(
