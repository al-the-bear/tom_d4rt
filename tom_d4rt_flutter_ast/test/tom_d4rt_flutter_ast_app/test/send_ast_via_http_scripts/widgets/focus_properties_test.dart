        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: mahogany.withValues(alpha: 0.15),
                width: 1,
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(label, style: TextStyle(fontSize: 11, color: mahogany)),
              Text(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: focused ? Border.all(color: color, width: 1.5) : null,
            ),
          ),
    ...
    children: [
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            Text(
              'Step 1: User is editing name field',
              style: TextStyle(
                fontSize: 12,
                fontWeight: FontWeight.w600,
                color: mahogany,
            ...
            Text(
              'Step 2: Dialog opens — form scope loses focus',
              style: TextStyle(
                fontSize: 12,
                fontWeight: FontWeight.w600,
                color: mahogany,
            ...
            const SizedBox(height: 8),
            Text(
              'Step 3: Dialog closes — focus returns to Name',
              style: TextStyle(
                fontSize: 12,
                fontWeight: FontWeight.w600,
                color: mahogany,
      ...
      infoCard(
        ...
        Column(
          ...
          children: [
            ...
            Text(
              'Disposition.previouslyFocusedChild:',
              style: TextStyle(
                fontSize: 12,
                fontWeight: FontWeight.w700,
                color: terracotta,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 6),
                      Text(
                        'Disabled Section (canRequestFocus: false)',
                        style: TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.w700,
                          color: rust,
