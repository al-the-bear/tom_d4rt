  ...
  Widget ieBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('▸ ', style: TextStyle(color: ieAccent, fontSize: 11)),
          Expanded(
            child: Text(
              text,
              style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          ieSection('3 · The _dependents Map', [
            ...
            ieKeyValue('Value', 'Object? (aspect — null for full dependency)'),
          ]),
          ...
          ieSection('4 · Dependency Registration Flow', [
            ...
            ieFlowStep(
              '2',
              'Framework looks up InheritedElement of type T '
                  'in the ancestor chain',
              const Color(0xFF1B5E20),
            ),
            ieFlowStep(
              '3',
              'Calls inheritedElement.updateDependencies('
                  'dependent, aspect)',
              const Color(0xFFE65100),
            ),
            ieFlowStep(
              '4',
              'Default: _dependents[dependent] = aspect '
                  '(stores the dependency)',
              const Color(0xFF6A1B9A),
            ),
            ieFlowStep(
              '5',
              'Returns the InheritedWidget so the caller '
          ...
          ieSection('5 · Notification Flow (Data Changes)', [
            ieFlowStep(
              '1',
              'Parent rebuilds InheritedWidget with new data',
              const Color(0xFF0277BD),
            ),
            ieFlowStep(
              '2',
              'Framework calls updated(oldWidget) on '
                  'InheritedElement',
              const Color(0xFF1B5E20),
            ),
            ieFlowStep(
              '3',
              'updated() calls widget.updateShouldNotify('
                  'oldWidget)',
              const Color(0xFFE65100),
            ),
            ieFlowStep(
              '4',
              'If true → calls notifyClients(oldWidget)',
              const Color(0xFF6A1B9A),
            ),
            ieFlowStep(
              '5',
              'notifyClients iterates _dependents and calls '
                  'notifyDependent for each',
              const Color(0xFF880E4F),
            ),
            ieFlowStep(
              '6',
              'notifyDependent calls dependent.'
                  'didChangeDependencies()',
              const Color(0xFF283593),
            ),
            ieFlowStep(
              '7',
              'Dependent element is marked dirty → rebuilds '
                  'in next frame',
          ...
          ieSection('8 · Common InheritedWidget Examples', [
            ieCompare('Theme', '_InheritedTheme → ThemeData for styling'),
            ieCompare(
              'MediaQuery',
          ...
          ieSection('16 · Quick API Reference', [
            ...
            ieKeyValue('notifyDependent', '(InheritedWidget, Element) → void'),
            ieDivider(),
            ieCodeBlock(
              '// Summary:\n'
