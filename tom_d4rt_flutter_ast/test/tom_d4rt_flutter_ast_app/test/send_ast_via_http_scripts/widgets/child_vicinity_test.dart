...
dynamic build(BuildContext context) {
  ...
  final conceptCards = <Map<String, dynamic>>[
    {
      ...
      'body':
          'ChildVicinity is a simple immutable class that holds '
    ...
    },
    {
      ...
      'body':
          'In a ListView, child 5 means the 6th item. But in a '
    ...
    },
    {
      ...
      'body':
          'TwoDimensionalChildBuilderDelegate receives a '
    ...
    },
    {
      ...
      'body':
          'ChildVicinity implements Comparable<ChildVicinity>. '
  ...
  final properties = <Map<String, dynamic>>[
    {
      ...
      'description':
          'The column index (horizontal position). Starts '
    ...
    },
    {
      ...
      'description':
          'The row index (vertical position). Starts at 0 '
    ...
    },
    {
      ...
      'description':
          'Both parameters are required named parameters. '
    ...
    },
    {
      ...
      'description':
          'Value equality: two ChildVicinity instances are '
    ...
    },
    {
      ...
      'description':
          'Compares first by yIndex (row), then by xIndex '
  ...
  final delegates = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.red[700]!,
      'description':
          'Lazy builder delegate — creates children on '
    ...
    },
    {
      ...
      'color': Colors.pink[700]!,
      'description':
          'Explicit list delegate — you provide a 2D list '
  ...
  final layouts = <Map<String, dynamic>>[
    {
      ...
      'color': Colors.red[700]!,
      'description':
          'Each cell at (xIndex, yIndex) maps to a '
    ...
    },
    {
      ...
      'color': Colors.pink[700]!,
      'description':
          'An 8x8 grid where xIndex maps to file (a-h) and '
    ...
    },
    {
      ...
      'color': Colors.red[600]!,
      'description':
          'xIndex 0-6 for days of the week (Mon-Sun), '
    ...
    },
    {
      ...
      'color': Colors.pink[600]!,
      'description':
          'A Pinterest-style layout where xIndex is the '
  ...
  final arithmeticCards = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'color': Colors.pink[600]!,
      'formula':
          'isInRegion = xIndex >= minX && xIndex <= maxX\n'
          '          && yIndex >= minY && yIndex <= maxY',
      'reverse':
          'Useful for: selection ranges, visible region,\n'
  ...
  final tips = <Map<String, dynamic>>[
    {
      ...
      'body':
          'Don\'t confuse the order. x is horizontal (column), '
    ...
    },
    {
      ...
      'body':
          'compareTo sorts by yIndex first. This means (0,1) > '
    ...
    },
    {
      ...
      'body':
          'ChildVicinity has proper hashCode and equality. You '
    ...
    },
    {
      ...
      'body':
          'In TwoDimensionalChildBuilderDelegate, maxXIndex and '
    ...
    },
    {
      ...
      'body':
          'The builder can return null for coordinates that '
    ...
    },
    {
      ...
      'body':
          'For spreadsheet-like frozen headers, check the '
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(
                  'Row-Major Ordering (yIndex first, then xIndex)',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 12,
                    color: Colors.grey[800],
            ...
            (lay) => Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border(
                    left: BorderSide(color: lay['color'] as Color, width: 4),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(
                          lay['icon'] as IconData,
                          color: lay['color'] as Color,
                          size: 20,
                        ),
                        SizedBox(width: 8),
                        Expanded(
                    ...
                    ...List.generate(
                      ...
                      (row) => Row(
                        children: List.generate(4, (col) {
                          ...
                          final isHeader = cell['header'] as bool;
                          final isChess = lay['name'] == 'Chess Board';
                          Color cellColor;
                          if (isChess) {
                            cellColor =
                                ((cell['x'] as int) + (cell['y'] as int)) % 2 ==
                                    0
                                ? Colors.brown[200]!
                                : Colors.brown[600]!;
                          } else {
                            cellColor = isHeader
                                ? (lay['color'] as Color).withOpacity(0.15)
                                : Colors.grey[100]!;
                          }
                          return Expanded(
                            child: Container(
