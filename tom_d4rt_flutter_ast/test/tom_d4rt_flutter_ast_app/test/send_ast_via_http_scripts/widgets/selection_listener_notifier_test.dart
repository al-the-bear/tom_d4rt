...
dynamic build(BuildContext context) {
  ...
  final conceptPoints = <Map<String, dynamic>>[
    {
      ...
      'body':
          'The Flutter selection system emits events when the user '
    ...
    },
    {
      ...
      'body':
          'A listener subscribes to selection changes and receives '
    ...
    },
    {
      ...
      'body':
          'A notifier (ChangeNotifier/ValueNotifier) broadcasts '
    ...
    },
    {
      ...
      'body':
          'By combining onSelectionChanged with a ValueNotifier, '
  ...
  final callbackParams = <Map<String, String>>[
    {
      ...
      'desc':
          'Called when the selection changes. Receives the currently '
  ...
  final callbackInfo = <Map<String, String>>[
    {
      'title': 'When It Fires',
      'body':
          'Every time the selection changes: start, update during drag, '
          'and end. Also fires with null when selection is cleared.',
    },
    {
      'title': 'What It Receives',
      'body':
          'A SelectedContent object containing the plainText of the '
    ...
    },
    {
      ...
      'body':
          'The callback fires frequently during drag operations. '
  ...
  final patternSteps = <Map<String, dynamic>>[
    {
      ...
      'desc':
          'Holds the current selection text. Empty string means no selection.',
      'color': Colors.blue,
    },
    {
      'step': '2',
    ...
    },
    {
      ...
      'code':
          ...
          ')',
      'desc':
          'Any widget can subscribe to the notifier and rebuild when selection changes.',
      'color': Colors.teal,
    },
    {
      'step': '4',
      ...
      'desc':
          'Clean up the notifier in the State dispose() method to avoid memory leaks.',
      'color': Colors.red,
    },
  ];
  ...
  final summaryPoints = <Map<String, dynamic>>[
    {
      'icon': Icons.notifications_active,
      'text': 'onSelectionChanged is the primary callback for selection events',
    },
    {
      'icon': Icons.broadcast_on_personal,
      'text': 'ValueNotifier decouples selection source from consumers',
    },
    {
      'icon': Icons.hearing,
      'text': 'Multiple widgets can listen to the same notifier independently',
    },
    {
      'icon': Icons.speed,
      'text': 'Debounce or throttle for expensive operations during drag',
    },
    {
      'icon': Icons.analytics,
      'text': 'Selection analytics: word count, char count, event history',
    },
    {
      'icon': Icons.code,
      'text': 'Dispose notifiers/streams in State.dispose() to avoid leaks',
    },
  ];
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(children: archWidgets),
                ),
                const SizedBox(height: 14.0),
                Container(
                  padding: const EdgeInsets.all(12.0),
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                _buildSLNBullet(
                  'ValueNotifier Broadcast Pattern',
...
class _SelectionListenerDemoState extends State<_SelectionListenerDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    final wordCount = _selectedText.trim().isEmpty
        ? 0
        : _selectedText.trim().split(RegExp(r'\s+')).length;
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      fontStyle: _selectedText.isEmpty
                          ? FontStyle.italic
                          : FontStyle.normal,
                    ),
                    maxLines: 5,
...
class _SelectionAnalyticsDemo extends StatefulWidget {
  @override
  State<_SelectionAnalyticsDemo> createState() =>
      _SelectionAnalyticsDemoState();
}
