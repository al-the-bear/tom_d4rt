...
Widget buildCheckmarkColorDemo(
  String label,
  Color chipColor,
  Color checkColor,
  bool selected,
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 12,
                  color: selected ? checkColor : Colors.black87,
...
Widget buildCheckmarkVisibilityRow(
  String label,
  bool showCheckmark,
  Color color,
) {
...
Widget buildAttributePropertyCard(
  String name,
  String type,
  String description,
  Color color,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            buildAttributePropertyCard(
              'showCheckmark',
              'bool?',
              'Whether to display the check mark on selected chips',
              Colors.blue,
            ),
            buildAttributePropertyCard(
              'checkmarkColor',
              'Color?',
              'Color of the check mark when displayed',
              Colors.green,
            ),
            buildAttributePropertyCard(
              'selected',
            ...
            buildAttributePropertyCard(
              'onSelected',
              'ValueChanged<bool>?',
              'Called when the chip selection state changes',
              Colors.purple,
            ),

            // Section 3: Show Checkmark vs Hide
            buildSectionHeader(
              'Show vs Hide Checkmark',
              Icons.visibility,
              Colors.indigo,
            ),
            Padding(
            ...
            buildCheckmarkVisibilityRow(
              'ChoiceChip orange (show)',
              true,
              Colors.orange,
            ),
            buildCheckmarkVisibilityRow(
              'ChoiceChip orange (hide)',
              false,
              Colors.orange,
            ),
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      Chip(
                        label: Text('selected', style: TextStyle(fontSize: 10)),
