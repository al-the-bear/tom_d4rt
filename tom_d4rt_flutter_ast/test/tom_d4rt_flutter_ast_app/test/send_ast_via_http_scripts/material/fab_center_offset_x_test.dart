...
Widget _buildCenterAlignedPositions() {
  ...
  items.add(
    _buildScaffoldDiagram('centerFloat', 0.5, 0.7, Color(0xFFD84315), false),
  );
  items.add(SizedBox(height: 12));
  items.add(
    _buildScaffoldDiagram('centerDocked', 0.5, 0.92, Color(0xFF00897B), true),
  );
  items.add(SizedBox(height: 12));
  items.add(
    _buildScaffoldDiagram('centerTop', 0.5, 0.12, Color(0xFF1565C0), false),
  );
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Three Center X-Offset FAB Locations',
        ...
        buildInfoCard(
          'FabCenterOffsetX:',
          'Mixin providing getOffsetX for horizontal centering',
        ),
      ],
    ),
  );
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'X offset: centered (scaffoldWidth - fabWidth) / 2',
                style: TextStyle(
              ...
              SizedBox(height: 4),
              Text(
                docked ? 'Docked into bottom bar' : 'Floating above content',
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'FAB docked INTO bottom bar',
                  style: TextStyle(fontSize: 11, color: Color(0xFF616161)),
                ),
                Text(
                  'Notch cradles the FAB',
                  style: TextStyle(fontSize: 11, color: Color(0xFF9E9E9E)),
                ),
              ],
            ),
...
Widget _buildXAxisCalculation() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'getOffsetX Calculation Formula',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),
        ),
        SizedBox(height: 16),
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text(
                '// Example with 400px scaffold, 56px FAB:',
                style: TextStyle(
                  fontFamily: 'monospace',
                  fontSize: 11,
                  color: Color(0xFF78909C),
              ...
              Positioned(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      ' offsetX ',
                      style: TextStyle(fontSize: 8, color: Color(0xFF2E7D32)),
                    ),
                    Icon(
                      Icons.arrow_forward,
                      size: 10,
        ...
        buildInfoCard(
          'Key:',
          'X offset ensures FAB is horizontally centered in Scaffold',
        ),
      ],
    ),
  );
...
Widget _buildFabWithBottomNav() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Common Pattern: Center FAB with Bottom Navigation',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 16),
        Container(
        ...
        buildInfoCard(
          'Pattern:',
          'centerDocked FAB with BottomAppBar having a notch',
        ),
        buildInfoCard(
          'X Position:',
          'Calculated by FabCenterOffsetX.getOffsetX()',
        ),
      ],
    ),
  );
  ...
  return Column(
    ...
    children: [
      ...
      Icon(
        icon,
        size: 20,
        color: active ? Color(0xFF1565C0) : Color(0xFF9E9E9E),
      ),
      Text(
        label,
        style: TextStyle(
...
Widget _buildMiniFabCenterPositions() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Mini FAB variants also use center X offset',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 16),
        Row(
          children: [
            Expanded(
              child: _buildFabSizeCard('Standard FAB', 56, Color(0xFFD84315)),
            ),
            SizedBox(width: 12),
            Expanded(
              child: _buildFabSizeCard('Mini FAB', 40, Color(0xFF6A1B9A)),
            ),
          ],
        ),
        SizedBox(height: 12),
        buildInfoCard(
          'Standard:',
          'miniCenterFloat, miniCenterDocked, miniCenterTop',
        ),
        buildInfoCard(
          'Size Difference:',
          'Mini FAB adjusts the offset calculation for its smaller width',
        ),
      ],
    ),
  );
...
Widget _buildScaffoldWidthImpact() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'How scaffold width affects center X offset',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 12),
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4),
        Text(
          'FAB takes ${(fraction * 100).toStringAsFixed(1)}% of scaffold width',
...
Widget _buildCenterTopLocation() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'CenterTop: FAB positioned at top-center',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),
        ),
        SizedBox(height: 16),
        Container(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Column(
                  children: [
                    Text(
                      'centerTop places FAB overlapping AppBar',
                      style: TextStyle(fontSize: 12, color: Color(0xFF616161)),
                    ),
                    SizedBox(height: 4),
                    Text(
                      'Same X offset as centerFloat and centerDocked',
                      style: TextStyle(fontSize: 11, color: Color(0xFF9E9E9E)),
                    ),
                  ],
                ),
        ...
        buildInfoCard(
          'X Offset:',
          'Identical to centerFloat - horizontally centered',
        ),
        buildInfoCard(
          'Y Offset:',
          'Different - positions FAB at top of body area',
        ),
      ],
    ),
  );
...
Widget _buildLocationEnumValues() {
  ...
  locations.add(
    _buildLocationRow(
      'centerFloat',
      'Center X, floating above bottom',
      true,
      Color(0xFFD84315),
    ),
  );
  ...
  locations.add(
    _buildLocationRow(
      'centerDocked',
      'Center X, docked into bottom bar',
      true,
      Color(0xFF00897B),
    ),
  );
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'FloatingActionButtonLocation values using FabCenterOffsetX',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 12),
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
          ...
          child: Stack(
            children: [
              Positioned(
                ...
                left: 0,
                right: 0,
                child: Container(height: 2, color: Color(0xFF90CAF9)),
              ),
              Positioned(
                top: 4,
                left: 0,
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'FAB',
                        style: TextStyle(fontSize: 8, color: Color(0xFFD84315)),
                      ),
                    ),
                    Expanded(
                      child: Container(height: 1, color: Color(0xFF4CAF50)),
        ...
        buildInfoCard(
          'Symmetry:',
          'Left offset = Right offset (perfect centering)',
        ),
      ],
    ),
  );
...
Widget _buildPropertiesAndMethods() {
  ...
  rows.add(
    _buildPropRow(
      'getOffsetX',
      'double',
      'Returns X offset for centering FAB',
      Color(0xFFD84315),
    ),
  );
  rows.add(
  ...
  rows.add(
    _buildPropRow(
      ...
      'Size',
      'FAB dimensions for calculation',
      Color(0xFFC62828),
    ),
  );
