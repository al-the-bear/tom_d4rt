...
dynamic build(BuildContext context) {
  ...
  debugPrint(
    'Demonstrating dialog routes, barrier colors, sizes, transitions, and shapes',
  );
...
Widget _buildBasicDialogs() {
  ...
  return Row(
    ...
    children: [
      Expanded(
        child: _buildDialogPreview('Alert Dialog', Color(0xFFF44336), [
          Container(
            padding: EdgeInsets.all(16),
            child: Column(
              children: [
      ...
      SizedBox(width: 8),
      Expanded(
        child: _buildDialogPreview('Confirm Dialog', Color(0xFF4CAF50), [
          Container(
            padding: EdgeInsets.all(16),
            child: Column(
              children: [
      ...
      SizedBox(width: 8),
      Expanded(
        child: _buildDialogPreview('Full Dialog', Color(0xFF2196F3), [
          Container(
            padding: EdgeInsets.symmetric(horizontal: 16, vertical: 10),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text(
                          'Background content shown here with some text',
                          style: TextStyle(
                            fontSize: 8,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  '${(s['width'] as double).toInt()} x ${(s['height'] as double).toInt()}',
                  style: TextStyle(
                    fontSize: 12,
                    color: Color(0xFF757575),
  ...
  List<Map<String, dynamic>> transitions = [
    {
      ...
      'icon': Icons.gradient,
      'color': Color(0xFF4CAF50),
      'desc': 'Opacity animates from 0 to 1',
    },
    {
      'label': 'Scale Up',
      'icon': Icons.zoom_in,
      'color': Color(0xFF2196F3),
      'desc': 'Dialog scales from small to full size',
    },
    {
      'label': 'Slide Up',
      'icon': Icons.arrow_upward,
      'color': Color(0xFFFF9800),
      'desc': 'Dialog slides from bottom of screen',
    },
    {
      'label': 'None',
      'icon': Icons.block,
      'color': Color(0xFF9E9E9E),
      'desc': 'Dialog appears instantly with no animation',
    },
  ];
  return Column(
    ...
    child: Row(
      children: [
        Icon(
          ...
          color: yes ? Color(0xFF4CAF50) : Color(0xFFE0E0E0),
          size: 16,
        ),
        SizedBox(width: 6),
...
Widget _buildActionLayouts() {
  ...
  return Column(
    children: [
      _buildActionLayoutRow('End-Aligned', MainAxisAlignment.end, [
        'Cancel',
        'OK',
      ]),
      SizedBox(height: 8),
      _buildActionLayoutRow('Space-Between', MainAxisAlignment.spaceBetween, [
        'Cancel',
        'OK',
      ]),
      SizedBox(height: 8),
      _buildActionLayoutRow('Three Actions', MainAxisAlignment.end, [
        'Learn More',
        'Cancel',
        'Accept',
      ]),
      SizedBox(height: 8),
      _buildActionLayoutStacked('Stacked Actions', [
        'Accept and Continue',
        'Cancel',
      ]),
    ],
          ...
          child: Row(
            ...
            children: actions.asMap().entries.map((entry) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color: isPrimary ? Color(0xFF4E342E) : Color(0x00000000),
                  borderRadius: BorderRadius.circular(6),
                ),
                child: Text(
                  entry.value,
                  style: TextStyle(
                    color: isPrimary ? Color(0xFFFFFFFF) : Color(0xFF4E342E),
                    fontWeight: FontWeight.bold,
                    fontSize: 12,
                  ),
                ),
            ...
            children: actions.asMap().entries.map((entry) {
              ...
              return Container(
                margin: EdgeInsets.only(
                  bottom: entry.key < actions.length - 1 ? 6 : 0,
                ),
                ...
                decoration: BoxDecoration(
                  ...
                  border: isPrimary
                      ? null
                      : Border.all(color: Color(0xFF4E342E)),
                ),
                child: Text(
                  entry.value,
                  style: TextStyle(
...
Widget _buildRouteProperties() {
  ...
  List<Map<String, dynamic>> props = [
    {
      'prop': 'barrierDismissible',
      'type': 'bool',
      'default': 'true',
      'desc': 'Whether tapping the barrier closes the dialog',
    },
    {
      'prop': 'barrierColor',
      'type': 'Color',
      'default': 'Colors.black54',
      'desc': 'Color of the scrim behind the dialog',
    },
    {
      'prop': 'barrierLabel',
      'type': 'String?',
      'default': 'null',
      'desc': 'Semantic label for the barrier',
    },
    {
      'prop': 'transitionDuration',
      'type': 'Duration',
      'default': '150ms',
      'desc': 'How long the open/close animation takes',
    },
    {
      'prop': 'transitionBuilder',
      'type': 'RouteTransitionsBuilder?',
      'default': 'null',
      'desc': 'Custom animation builder',
    },
    {
      'prop': 'useSafeArea',
      'type': 'bool',
      'default': 'true',
      'desc': 'Whether to respect device safe areas',
    },
    {
      'prop': 'settings',
      'type': 'RouteSettings?',
      'default': 'null',
      'desc': 'Route settings for navigation',
    },
    {
      'prop': 'anchorPoint',
      'type': 'Offset?',
      'default': 'null',
      'desc': 'Anchor point for dialog positioning',
    },
  ];
  return Column(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'This dialog contains content that may trigger a child dialog.',
                  style: TextStyle(fontSize: 12, color: Color(0xFF757575)),
                ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 6),
                  Text(
                    'Nested dialog on top of parent',
