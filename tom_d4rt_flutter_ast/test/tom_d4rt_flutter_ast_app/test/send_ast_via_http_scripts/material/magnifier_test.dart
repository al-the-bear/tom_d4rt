...
dynamic build(BuildContext context) {
  ...
  print(
    'Magnifier provides a magnifying glass effect with loupe border and shadow',
  );
  ...
  sections.add(
    buildSectionHeader('Magnifier Widget Demo', Icons.search, Colors.indigo),
  );
  sections.add(
    buildInfoCard(
      'Widget',
      'Magnifier - Material Design magnifying glass effect',
      Colors.indigo,
    ),
  );
  sections.add(
    buildInfoCard(
      'Purpose',
      'Used for text selection magnification with loupe border and shadow',
      Colors.blue,
    ),
  );
  sections.add(
    buildInfoCard(
      'Key Properties',
      'size, borderRadius, filmColor, shadows, additionalFocalPointOffset',
      Colors.teal,
    ),
  );
  sections.add(
    buildInfoCard(
      'MagnifierDecoration',
      'ShapeDecoration subclass with opacity control for the magnifier chrome',
      Colors.deepPurple,
    ),
  );
  ...
  sections.add(
    buildSectionHeader('Basic Magnifier', Icons.zoom_in, Colors.blue),
  );
  sections.add(
    buildInfoCard(
      'Default Settings',
      'Magnifier with factory defaults placed over colorful content',
      Colors.blue,
    ),
  );
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              ...
              Positioned(left: 80, top: 55, child: Magnifier()),
            ],
          ),
        ),
      ),
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              ...
              Positioned(left: 60, top: 30, child: Magnifier()),
            ],
          ),
        ),
      ),
  ...
  sections.add(
    buildSectionHeader('Size Variations', Icons.aspect_ratio, Colors.purple),
  );
  sections.add(
    buildInfoCard(
      'size Property',
      'Controls the dimensions of the magnifier lens via Size(width, height)',
      Colors.purple,
    ),
  );
  ...
  sections.add(
    buildInfoCard(
      ...
      'Controls corner rounding of the magnifier shape - round vs square',
      Colors.deepOrange,
    ),
  );
  ...
  sections.add(
    buildSectionHeader('Film Color Tints', Icons.color_lens, Colors.teal),
  );
  sections.add(
    buildInfoCard(
      'filmColor Property',
      'Applies a colored overlay on the magnified content for tinting',
      Colors.teal,
    ),
  );
  ...
  sections.add(
    buildSectionHeader('Shadow Configurations', Icons.layers, Colors.blueGrey),
  );
  sections.add(
    buildInfoCard(
      'shadows Property',
      'List of BoxShadow controlling the magnifier drop shadow appearance',
      Colors.blueGrey,
    ),
  );
  sections.add(
    buildInfoCard(
      'MagnifierDecoration',
      'ShapeDecoration subclass with opacity used internally by RawMagnifier',
      Colors.grey,
    ),
  );
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                left: 80,
                top: 25,
                child: Magnifier(size: Size(90, 80), shadows: []),
              ),
            ],
          ),
        ),
  ...
  sections.add(
    buildInfoCard(
      ...
      'Shifts the magnification center relative to the magnifier position',
      Colors.orange,
    ),
  );
  ...
  sections.add(
    buildSectionHeader('Over Different Content', Icons.grid_view, Colors.green),
  );
  sections.add(
    buildInfoCard(
      'Content Variety',
      'Demonstrates magnifier appearance over text, icons, and colored patterns',
      Colors.green,
    ),
  );
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Curabitur pretium tincidunt lacus in fermentum.',
                      style: TextStyle(fontSize: 9, color: Colors.black87),
                    ),
                  ],
                ),
  ...
  sections.add(
    buildInfoCard(
      'Visual Concept',
      'Multiple magnifiers positioned at different locations showing the effect',
      Colors.deepPurple,
    ),
  );
  ...
  sections.add(
    buildSectionHeader('Opacity / Transparency', Icons.opacity, Colors.cyan),
  );
  sections.add(
    buildInfoCard(
      'Glass Transparency',
      'Wrapping Magnifier in Opacity widget to show different transparency levels',
      Colors.cyan,
    ),
  );
  ...
  sections.add(
    buildInfoCard(
      'Magnifier',
      'Material Design magnifier with loupe border and shadow for text selection',
      Colors.green.shade700,
    ),
  );
  sections.add(
    buildInfoCard(
      'size',
      'Controls lens dimensions - accepts Size(width, height)',
      Colors.blue,
    ),
  );
  sections.add(
    buildInfoCard(
      'borderRadius',
      'Controls corner rounding - from square (0) to fully round',
      Colors.purple,
    ),
  );
  sections.add(
    buildInfoCard(
      'filmColor',
      'Applies tinted overlay on magnified content (Color with alpha)',
      Colors.teal,
    ),
  );
  sections.add(
    buildInfoCard(
      'shadows',
      'List of BoxShadow for drop shadow depth and appearance',
      Colors.blueGrey,
    ),
  );
  sections.add(
    buildInfoCard(
      'additionalFocalPointOffset',
      'Shifts magnification center - Offset(dx, dy) from default position',
      Colors.orange,
    ),
  );
  sections.add(
    buildInfoCard(
      'MagnifierDecoration',
      'ShapeDecoration subclass with opacity control for RawMagnifier',
      Colors.deepPurple,
    ),
  );
  sections.add(
    buildInfoCard(
      'Usage Context',
      'Primarily used in text selection UIs with gesture detection integration',
      Colors.grey,
    ),
  );
  ...
  print(
    'Demonstrated: size, borderRadius, filmColor, shadows, offset, opacity',
  );
