      ...
      decoration: BoxDecoration(
        ...
        boxShadow: <BoxShadow>[
          BoxShadow(
            color: const Color(
              0xFF1F2937,
            ).withValues(alpha: 0.04 + elevation * 0.02),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          const SizedBox(width: 8.0),
          Container(width: 1.0, height: 12.0, color: fg.withValues(alpha: 0.3)),
          const SizedBox(width: 8.0),
          Text(
            hex,
            style: TextStyle(
...
class _ArrowDescriptor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: <Widget>[
        Container(width: 16.0, height: 1.5, color: const Color(0x66FFFFFF)),
        const SizedBox(width: 6.0),
        Text(
          text,
          style: const TextStyle(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            style: TextStyle(color: data.fg, fontSize: 12.0, height: 1.3),
          ),
