  ...
  for (int i = 0; i < colors.length && i < labels.length; i++) {
    items.add(
      buildColorBox(
        ...
        labels[i],
        darkText:
            ThemeData.estimateBrightnessForColor(colors[i]) == Brightness.light,
      ),
    );
  }
  return Container(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Section 1: Primary colors (warm + cool) rendered',
            ...
            Text(
              'Section 2: Primary colors (nature) rendered',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
            ...
            Text(
              'Section 3: Neutral swatches rendered',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
            ...
            Text(
              'Section 4: Accent colors rendered',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
            ...
            Text(
              'Section 5: Special colors rendered',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
            ...
            Text(
              'Section 6: Color reference cards rendered',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
            ...
            Text(
              'Section 8: Themed palettes rendered',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
            ...
            Text(
              'Section 9: Opacity variations rendered',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
            ...
            Text(
              'Section 10: Color usage examples rendered',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    '- 18 primary color swatches (10 shades each)',
                    style: TextStyle(color: Color(0xCCFFFFFF), fontSize: 13),
                  ),
                  Text(
                    '- 16 accent color swatches (4 shades each)',
                    style: TextStyle(color: Color(0xCCFFFFFF), fontSize: 13),
                  ),
                  Text(
                  ...
                  Text(
                    '- 14 reference cards with hex values',
                    style: TextStyle(color: Color(0xCCFFFFFF), fontSize: 13),
                  ),
                  Text(
                    '- 9 gradient demonstrations',
                    style: TextStyle(color: Color(0xCCFFFFFF), fontSize: 13),
                  ),
                  Text(
                    '- 4 themed palettes (Earth, Ocean, Sunset, Forest)',
                    style: TextStyle(color: Color(0xCCFFFFFF), fontSize: 13),
                  ),
                  Text(
                    '- Black/white opacity variations',
                    style: TextStyle(color: Color(0xCCFFFFFF), fontSize: 13),
                  ),
                  Text(
            ...
            Text(
              '=== Material Colors Deep Demo Complete ===',
              style: TextStyle(fontSize: 10, color: Colors.grey),
            ),
