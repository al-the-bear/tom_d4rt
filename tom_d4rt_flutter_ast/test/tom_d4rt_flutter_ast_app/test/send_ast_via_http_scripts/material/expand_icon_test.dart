...
Widget _buildExpandCollapseStates() {
  ...
  return Container(
    ...
    child: Column(
      children: [
        Text(
          'ExpandIcon rotates arrow between collapsed and expanded',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 16),
        Row(
...
Widget _buildSizeVariations() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'ExpandIcon size property controls icon size',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 12),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'size: ${size.toInt()} logical pixels',
                style: TextStyle(
                  fontFamily: 'monospace',
                  fontSize: 11,
                  color: Color(0xFF757575),
...
Widget _buildColorConfigurations() {
  ...
  items.add(
    _buildColorRow('Default (grey)', Color(0xFF757575), Color(0xFF424242)),
  );
  items.add(SizedBox(height: 6));
  items.add(
    _buildColorRow('Primary Blue', Color(0xFF1565C0), Color(0xFF0D47A1)),
  );
  items.add(SizedBox(height: 6));
  items.add(
    _buildColorRow('Success Green', Color(0xFF2E7D32), Color(0xFF1B5E20)),
  );
  items.add(SizedBox(height: 6));
  items.add(
    _buildColorRow('Warning Orange', Color(0xFFE65100), Color(0xFFBF360C)),
  );
  items.add(SizedBox(height: 6));
  items.add(_buildColorRow('Error Red', Color(0xFFC62828), Color(0xFFB71C1C)));
  items.add(SizedBox(height: 6));
  items.add(
    _buildColorRow('Purple Accent', Color(0xFF6A1B9A), Color(0xFF4A148C)),
  );
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'ExpandIcon color and expandedColor properties',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 12),
...
Widget _buildPaddingVariations() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Padding controls the ExpandIcon touch target area',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 12),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Total touch target: ${totalSize.toInt()}x${totalSize.toInt()} px',
...
Widget _buildListContext() {
    ...
    items.add(
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: expanded ? Color(0xFF00897B) : Color(0xFFE0E0E0),
          ),
    ...
    if (expanded) {
      items.add(
        Container(
          ...
          child: Text(
            'Expanded content for $title would appear here',
            style: TextStyle(fontSize: 12, color: Color(0xFF616161)),
          ),
        ),
      );
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'ExpandIcon in a file browser list',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 12),
        Column(children: items),
...
Widget _buildExpansionTileLayouts() {
  ...
  tiles.add(SizedBox(height: 8));
  tiles.add(
    _buildMockExpansionTile('About', Icons.info, Color(0xFF6A1B9A), false),
  );
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'ExpandIcon in ExpansionTile-like layouts',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 12),
...
Widget _buildMockExpansionTile(
  String title,
  IconData icon,
  Color color,
  bool expanded,
...
Widget _buildArrowDirectionVisual() {
  ...
  return Container(
    ...
    child: Column(
      children: [
        Text(
          'Arrow Rotation Animation (0 to 180 degrees)',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        SizedBox(height: 16),
        Row(
...
Widget _buildPropertiesReference() {
  ...
  rows.add(
    _buildPropRow(
      'isExpanded',
      'bool',
      'Whether the icon shows expanded state',
      Color(0xFF1565C0),
    ),
  );
  rows.add(
...
Widget _buildUseCasesGallery() {
  ...
  useCases.add(
    _buildUseCaseCard(
      'Accordion Menu',
      'Expandable navigation menu items',
      Icons.menu,
      Color(0xFF1565C0),
    ),
  );
