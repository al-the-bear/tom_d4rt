...
Widget _mbSmall(String t) =>
    Text(t, style: const TextStyle(fontSize: 10.5, color: Colors.black54));
...
Widget _mbBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'The parent-data class powering SliverList & SliverGrid',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
...
List<Widget> _mbIndexField() => [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...
              Container(width: 2, height: 42, color: _mbAccent),
              _mbChildBox(2),
              _mbChildBox(3),
              _mbChildBox(4),
              _mbChildBox(5),
  ...
  _mbBullet(
    'Range',
    'index typically starts at 0 and goes up to childCount - 1',
  ),
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _mbKeepAliveStep(
          '1',
          'Child enters viewport',
          'index = 5, keptAlive = false',
          _mbPurple,
        ),
        _mbKeepAliveStep(
          '2',
        ...
        _mbKeepAliveStep(
          '5',
          'Child re-enters viewport',
          'Reused with state intact',
          _mbPurple,
        ),
        _mbKeepAliveStep(
          '6',
...
Widget _mbKeepAliveStep(String num, String title, String detail, Color c) =>
    Padding(
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        _mbFlowArrow(),
        _mbFlowRow(
          'Element.createChild(index)',
          'inflates widget, attaches RenderBox',
        ),
        _mbFlowArrow(),
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Row(children: List.generate(5, (i) => _mbChildBox(i + 3))),
        ),
        ...
        const SizedBox(height: 8),
        _mbSmall(
          'Children at indices 3–5 are garbage collected; 8–10 are created fresh',
        ),
      ],
    ),
  ),
...
Widget _mbSnapshotRow(String label, int start, int end) => Column(
  ...
  children: [
    ...
    SingleChildScrollView(
      scrollDirection: Axis.horizontal,
      child: Row(
        children: List.generate(end - start + 1, (i) => _mbChildBox(start + i)),
      ),
    ),
  ],
);
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        _mbGcRow(
          'Off-screen, keptAlive = true',
          'Moved to keep-alive bucket',
          _mbKeep,
        ),
        _mbGcRow('On-screen', 'Retained in active child list', _mbPurple),
        _mbGcRow(
          'Cache extent region',
          'Retained (within cacheExtent)',
          _mbAccent,
        ),
      ],
    ),
...
List<Widget> _mbDebugging() => [
  ...
  _mbPropRow(
    'Freshly created',
    'index=null; paintOffset=Offset(0, 0)',
    valColor: _mbMuted,
  ),
  _mbBody(
...
List<Widget> _mbSummary() => [
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_mbPurple.withValues(alpha: 0.08), _mbLavender],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        _mbSummaryPoint(
          'index',
          'Maps each child to its delegate position (0..N-1)',
        ),
        _mbSummaryPoint(
          'keptAlive',
          'Preserves off-screen state for AutomaticKeepAlive',
        ),
        _mbSummaryPoint(
          'Recycling',
          'Index enables efficient child reuse on scroll',
        ),
        _mbSummaryPoint(
          'GC',
          'collectGarbage removes children by walking the child list',
        ),
        _mbSummaryPoint(
          'Inheritance',
          'Extends SliverLogicalContainerParentData → has '
              'paintOffset + linked list pointers',
        ),
        _mbSummaryPoint(
          'Debugging',
          'toString includes index and keepAlive for easy inspection',
        ),
      ],
    ),
  ),
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of SliverMultiBoxAdaptorParentData Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
...
List<Widget> _mbHierarchy() => [
  ...
  _mbBody(
    'SliverMultiBoxAdaptorParentData sits at the end of a deep '
