...
class _GestureRecognitionGalleryState
  ...
  Widget _buildScenario() {
    switch (_scenario) {
      ...
      case 1:
        return _buildLongPressStudio();
      case 2:
        return _buildDragPanWorkshop();
      case 3:
        return _buildScaleRotationLab();
      case 4:
        return _buildSwipeDismissible();
      case 5:
  ...
  Widget _tapPadRow() {
    final colors = [_p.primary, _p.secondary, _p.accent, Color(0xFF6A1B9A)];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Each pad responds to a different tap gesture type.',
            style: TextStyle(
              fontSize: 12,
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: GestureDetector(
                      onTap: i == 0 ? () => _log('single tap') : null,
                      onDoubleTap: i == 1 ? () => _log('double tap') : null,
                      onTapDown: i == 2 ? (_) => _log('tap down') : null,
                      onTapCancel: i == 3 ? () => _log('tap cancel') : null,
                      child: Container(
                        height: 80,
                        decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'When both are registered, Flutter waits ~300ms after a '
  ...
  Widget _tapLifecycleCards() {
    final phases = <(String, String, IconData, Color)>[
      (
        'onTapDown',
        'Finger contacts the screen at a specific position. '
      ...
      (
        'onTapUp',
        'Finger lifts after a successful tap. Provides '
      ...
      (
        'onTapCancel',
        'Gesture was aborted (finger moved too far or '
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'The full tap lifecycle from finger-down to completion '
            'or cancellation.',
            style: TextStyle(
              fontSize: 12,
              color: _p.onSurface.withValues(alpha: 0.7),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'A single GestureDetector can register tap, double-tap, and '
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'InkWell creates the same semantic gesture handler as '
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Hold the target for 500ms+ to trigger onLongPress.',
            style: TextStyle(
              fontSize: 12,
              color: _p.onSurface.withValues(alpha: 0.7),
            ),
  ...
  Widget _longPressLifecycle() {
    final steps = <(String, String, Color)>[
      (
        'onLongPressDown',
        'Initial contact detected (before timer starts)',
        Color(0xFF0277BD),
      ),
      (
        'onLongPressCancel',
        'Finger moved too far before 500ms',
        Color(0xFFC62828),
      ),
      (
        'onLongPress',
        'Timer reached 500ms — long press confirmed',
        Color(0xFF2E7D32),
      ),
      (
        'onLongPressMoveUpdate',
        'Finger moves after long press confirmed',
        Color(0xFFE65100),
      ),
      ('onLongPressUp', 'Finger lifts after long press', Color(0xFF6A1B9A)),
      (
        'onLongPressEnd',
        'Long press gesture completely finished',
        Color(0xFF37474F),
      ),
    ];
    return Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Long press typically shows a context menu. This is one '
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(Icons.text_snippet, color: _p.secondary, size: 24),
                      Text(
                        'Long-press here',
                        style: TextStyle(fontSize: 11, color: _p.secondary),
                      ),
                    ],
                  ),
                ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'onLongPressMoveUpdate tracks movement after the long press '
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    alignment: Alignment.center,
                    child: Icon(Icons.drag_handle, color: _p.primary, size: 24),
                  ),
                  Expanded(
                    child: Padding(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Default long-press threshold is 500ms. Shown here with '
          ...
          for (var d in durations) ...[
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                Icon(
                  d >= 500 ? Icons.check_circle : Icons.cancel,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'onHorizontalDragUpdate fires as the finger moves '
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'onVerticalDragUpdate fires as the finger moves up or '
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Pan combines horizontal and vertical into free 2D movement. '
          ...
          GestureDetector(
            onPanUpdate: (d) => _log(
              'pan dx=${d.delta.dx.toStringAsFixed(1)} '
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Center(
                        child: Icon(
                          Icons.arrow_upward,
                          color: _p.muted.withValues(alpha: 0.4),
                          size: 16,
                        ),
                      ),
                    ),
  ...
  Widget _dragDetailsCard() {
    final details = <(String, String, String)>[
      ...
      (
        'DragUpdateDetails',
        'delta, primaryDelta, globalPosition',
        ...
        children: [
          ...
          for (var i = 0; i < details.length; i++) ...[
            Container(
              ...
              decoration: BoxDecoration(
                color: i.isEven
                    ? _p.primary.withValues(alpha: 0.04)
                    : Colors.transparent,
                borderRadius: BorderRadius.circular(6),
              ),
              child: Column(
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.swap_horiz, color: _p.primary, size: 24),
                      const SizedBox(height: 4),
                      Text(
                        'Horizontal',
                        style: TextStyle(
                      ...
                      Text(
                        'Sliders\nCarousels\nSwipe cards',
                        style: TextStyle(fontSize: 10, color: _p.onSurface),
                        textAlign: TextAlign.center,
                      ),
                    ],
                  ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.swap_vert, color: _p.secondary, size: 24),
                      const SizedBox(height: 4),
                      Text(
                        'Vertical',
                        style: TextStyle(
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.open_with, color: _p.accent, size: 24),
                      const SizedBox(height: 4),
                      Text(
                        'Pan (2D)',
                        style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Two fingers move apart to zoom in, together to zoom out.',
            style: TextStyle(
              fontSize: 12,
              color: _p.onSurface.withValues(alpha: 0.7),
            ),
            ...
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  for (var r = 1; r <= 3; r++)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(
                          color: _p.primary.withValues(alpha: 0.1 + r * 0.08),
                          width: 1.5,
                        ),
                      ),
                    ),
                  ...
                  // Finger indicators
                  Positioned(top: 20, left: 60, child: _fingerIndicator('1')),
                  Positioned(
                    bottom: 20,
                    right: 60,
  ...
  Widget _fingerIndicator(String label) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: _p.secondary,
        boxShadow: [
          BoxShadow(color: _p.secondary.withValues(alpha: 0.3), blurRadius: 6),
        ],
      ),
      alignment: Alignment.center,
      child: Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'The rotation property reports the angle in radians '
              ...
              for (var i = 0; i < angles.length; i++)
                Column(
                  ...
                  children: [
                    Transform.rotate(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(6),
                          border: Border.all(color: _p.secondary, width: 1.5),
                        ),
                        alignment: Alignment.center,
                        child: Icon(
                          Icons.arrow_upward,
                    ...
                    Text(
                      '${angles[i].toStringAsFixed(2)} rad',
                      style: TextStyle(
                        fontSize: 9,
                        fontFamily: 'monospace',
                        color: _p.muted,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Showing how different scale factors affect a widget.',
            style: TextStyle(
              fontSize: 12,
              color: _p.onSurface.withValues(alpha: 0.7),
            ),
  ...
  Widget _scaleVsDrag() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Scale vs Pan: Arena Competition',
            style: TextStyle(
              fontWeight: FontWeight.bold,
              fontSize: 14,
              color: _p.primary,
          ...
          const SizedBox(height: 8),
          Text(
            'ScaleGestureRecognizer subsumes Pan. If you register '
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Dismissible supports four primary directions and two '
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Each row is wrapped in Dismissible. Swipe to remove. '
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Icon(Icons.chevron_left, color: _p.muted, size: 16),
                        Text(
                          'swipe',
                          style: TextStyle(fontSize: 9, color: _p.muted),
                        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Dismissible checks both displacement threshold (40%) and '
  ...
  Widget _velocityBar(String level) {
    final heights = {'Slow': 20.0, 'Medium': 40.0, 'Fast': 60.0, 'Fling': 80.0};
    final colors = {
      'Slow': _p.muted,
      'Medium': _p.secondary,
      'Fast': _p.primary,
    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(4),
          border: Border.all(color: colors[level] ?? _p.muted, width: 1),
        ),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Always use confirmDismiss for destructive actions. '
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.warning_amber, color: Color(0xFFC62828), size: 28),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _swipeActionTypes() {
    final actions = <(String, String, IconData, Color)>[
      ('Delete', 'Remove item permanently', Icons.delete, Color(0xFFC62828)),
      ('Archive', 'Move to archive folder', Icons.archive, Color(0xFF1565C0)),
      (
        'Mark Read',
        'Toggle read status',
      ...
      ('Pin', 'Pin to top of list', Icons.push_pin, Color(0xFFE65100)),
    ];
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.all(14),
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(actions[i].$3, color: actions[i].$4, size: 22),
                          const SizedBox(height: 4),
                          Text(
                            actions[i].$1,
                            style: TextStyle(
                          ...
                          Text(
                            actions[i].$2,
                            style: TextStyle(fontSize: 9, color: _p.onSurface),
                            textAlign: TextAlign.center,
                          ),
                        ],
                      ),
  ...
  Widget _gestureRecognizerTable() {
    final rows = <(String, String, String)>[
      ...
      ('PanGestureRecognizer', 'onPanStart/Update/End', 'Free 2D movement'),
      (
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Icon(Icons.arrow_forward, size: 14, color: _p.muted),
                  ),
                  Expanded(
                    child: Text(
                      mappings[i].$2,
