  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _tcPurple, height: 1.4),
        ),
      ),
    ],
  ),
          ...
          (c) => Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: _tcPurple.withValues(alpha: 0.2),
                  width: 0.5,
                ),
              ),
...
Widget _tcHierBox(String name, Color bg, {bool highlight = false}) => Container(
...
Widget _tcBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Per-cell vertical alignment for Table children',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        _tcArrow(),
        _tcHierBox('TableCellParentData', _tcLavender, highlight: true),
      ],
    ),
  ),
...
Widget _tcFieldRow(String val, String behavior, {bool isHeader = false}) {
  ...
  return Padding(
    ...
    child: Row(
      children: [
        SizedBox(width: 90, child: Text(val, style: style)),
...
List<Widget> _tcLayoutFlow() => [
  ...
  _tcBullet('Step 4', 'Read verticalAlignment from parentData; position cell'),
  _tcBullet(
    'Step 5',
...
List<Widget> _tcMixedRow() => [
      ...
      children: [
        ...
        Row(
          children: [
            ...
            ...['top', 'middle', 'bottom', 'fill', 'baseline'].map(
              (a) => Expanded(
                child: Center(
                  child: Text(
                    a,
  ...
  _tcSmall('Each cell positions differently within the same 80px row'),
  _tcBody(
...
List<Widget> _tcCreators() => [
  ...
  _tcSubtitle('Writing'),
  _tcBody('TableCell.applyParentData() writes the verticalAlignment:'),
  _tcCode(
    'void applyParentData(RenderObject renderObject) {\n'
...
List<Widget> _tcComparison() => [
  ...
  _tcBody('How TableCellParentData relates to other parent data classes:'),
  Container(
    width: double.infinity,
    padding: const EdgeInsets.all(12),
    margin: const EdgeInsets.symmetric(vertical: 8),
    ...
    child: Column(
      ...
      children: [
        ...
        _tcCmpRow('TableCellPD', 'verticalAlignment', 'RenderTable'),
        _tcCmpRow('SliverPhysicalPD', 'paintOffset', 'Slivers'),
      ],
    ),
  ),
  _tcSubtitle('Key differences'),
  _tcBullet('BoxParentData', 'Only stores position (offset). No layout hints.'),
  _tcBullet(
    'FlexParentData',
...
List<Widget> _tcSummary() => [
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_tcPurple.withValues(alpha: 0.08), _tcLavender],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        _tcSumPt('RenderTable reads it', 'Uses alignment during performLayout'),
        _tcSumPt(
          'Values',
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of TableCellParentData Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
