...
dynamic build(BuildContext context) {
  ...
  try {
    ...
    ctorReport =
        'SelectParagraphSelectionEvent(globalPosition: $sampleOffset) -> ${ev.runtimeType}';
  ...
  try {
    ...
    ctorBackwardReport =
        'second instance (globalPosition: ${const Offset(64.0, 96.0)}) -> ${evb.runtimeType}';
  } catch (e) {
  ...
  final List<List<String>> timeline = <List<String>>[
    ...
    <String>[
      't3',
      'SelectionContainer.dispatchSelectionEvent',
      'SelectParagraphSelectionEvent.forward(globalPosition)',
    ],
    <String>[
      't4',
      'For each Selectable',
      'handler.dispatchSelectionEvent(event) -> SelectionResult',
    ],
    <String>[
      't5',
      'SelectionGeometry recomputed',
      'paint highlights, show handles',
    ],
  ];
...
''';
  ...
  final List<List<String>> references = <List<String>>[
    <String>[
      'SelectionContainer',
      'Widget that hosts a SelectionContainerDelegate',
    ],
    <String>[
      'SelectionContainerDelegate',
      'Routes events; aggregates SelectionGeometry',
    ],
    <String>[
      'SelectionRegistrar / SelectionRegistrarScope',
      'InheritedWidget for Selectable registration',
    ],
    ...
    <String>[
      'SelectionEventType',
      'Enum: selectParagraph, selectWord, selectAll, clear, ...',
    ],
  ];
  ...
  final List<List<dynamic>> paletteRows = <List<dynamic>>[
    ...
    <dynamic>[
      ...
      cVioletLight,
      '#B59BEA',
      'Highlight wash for selected paragraph',
    ],
    ...
    <dynamic>[
      ...
      cTeal,
      '#2F8C8C',
      'Section three accent, hierarchy chip',
    ],
    <dynamic>[
      'cTealLight',
      cTealLight,
      '#9CD3D3',
      'Compare-table even row tint',
    ],
    <dynamic>[
      'cRose',
      cRose,
      '#C8456A',
      'Edge-case ribbon, warning highlights',
    ],
    ...
    <dynamic>[
      ...
      cSlate,
      '#3C4A5A',
      'Compare-table accent, neutral chips',
    ],
  ...
  final List<List<String>> resultRows = <List<String>>[
    ...
    <String>[
      'next',
      'Event is partly consumed; remainder forwards to next sibling.',
    ],
    <String>[
      'previous',
      'Event partly consumed; remainder forwards to previous sibling.',
    ],
    <String>[
      'pending',
      'Selectable needs another frame to settle (async layout).',
    ],
  ];
  ...
  final List<List<String>> geometryRows = <List<String>>[
    <String>[
      ...
      'SelectionPoint?',
      'Offset(  64.0, 312.0 )',
      'Top-left edge of paragraph 2',
    ],
    <String>[
      'endSelectionPoint',
      'SelectionPoint?',
      'Offset( 504.0, 360.0 )',
      'Bottom-right edge of paragraph 2',
    ],
    ...
    <String>[
      'selectionRects',
      'List<Rect>',
      '[Rect(64,312,440,48), Rect(64,330,420,18)]',
      'Two visual rectangles, one per visual line',
    ],
    <String>[
      'startSelectionPoint.lineHeight',
      'double',
      '20.0',
      'Cursor caret height at start edge',
    ],
    <String>[
      'endSelectionPoint.handleType',
      'TextSelectionHandleType',
      'right',
      'Direction the end-handle faces',
    ],
  ];
  ...
  final List<List<dynamic>> granularityRows = <List<dynamic>>[
    ...
    <dynamic>[
      ...
      0.78,
      'Triple-tap',
      'SelectParagraphSelectionEvent  <-- focus',
    ],
  ...
  final List<List<String>> gestureRows = <List<String>>[
    ...
    <String>[
      'Shift+Arrow',
      'Keyboard',
      'GranularlyExtendSelectionEvent (character)',
    ],
    <String>[
      'Shift+Ctrl+Arrow',
      'Keyboard',
      'GranularlyExtendSelectionEvent (word)',
    ],
    <String>[
      'Shift+Up/Down',
      'Keyboard',
      'DirectionallyExtendSelectionEvent (line)',
    ],
    <String>[
      'Shift+PgUp/Dn',
      'Keyboard',
      'DirectionallyExtendSelectionEvent (page)',
    ],
  ...
  final List<List<String>> curiosities = <List<String>>[
    ...
    <String>[
      'What about emoji-only paragraphs?',
  ...
  final List<List<String>> inspectorRows = <List<String>>[
    ...
    <String>[
      'toString',
      'SelectParagraphSelectionEvent(globalPosition: $sampleOffset)',
    ],
  ...
  final List<List<String>> lifecycleRows = <List<String>>[
    ...
    <String>[
      '5. Hit-test',
      'Each Selectable checks if globalPosition is within its bounds',
    ],
  ...
  final List<List<String>> antiPatterns = <List<String>>[
    <String>[
      'Storing the event for later replay',
    ...
    <String>[
      'Calling dispatchSelectionEvent off the main thread',
    ...
    <String>[
      'Mixing global and local coordinates',
    ...
    <String>[
      'Relying on equality across frames',
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  'SelectParagraphSelectionEvent.forward(...)',
                  style: TextStyle(
                    color: cAmberLight,
                ...
                Text(
                  'SelectParagraphSelectionEvent.backward(...)',
                  style: TextStyle(
                    color: cAmberLight,
                    fontFamily: 'monospace',
                    fontSize: 12,
    ...
    for (int i = 0; i < paragraphs.length; i++) {
      ...
      rows.add(
        Container(
          ...
          decoration: BoxDecoration(
            color: selected
                ? cVioletLight.withValues(alpha: 0.55)
                : Colors.transparent,
      ...
      Padding(
        ...
        child: Row(
          children: <Widget>[
            ...
            const Text(
              'Highlight = paragraph claimed by SelectParagraphSelectionEvent.forward',
  ...
  Widget narrativeSection() {
    return Column(
      children: <Widget>[
        ...
        const SizedBox(height: 8),
        proseBlock(
          'Multi-Selectable paragraphs',
          narrativeMultiSelectable,
          cRose,
        ),
      ],
    );
  ...
  Widget granularityGauge() {
    ...
    for (int i = 0; i < granularityRows.length; i++) {
      ...
      final AlwaysStoppedAnimation<double> snap =
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              ...
              top: BorderSide(color: cDivider, width: 1),
              right: BorderSide(color: cDivider, width: 1),
              bottom: BorderSide(color: cDivider, width: 1),
            ),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
      ...
      rows.add(
        Container(
          ...
          decoration: BoxDecoration(
            color: cParchment,
            border: Border(
              left: BorderSide(color: cRose, width: 4),
              top: BorderSide(color: cDivider, width: 1),
              right: BorderSide(color: cDivider, width: 1),
              bottom: BorderSide(color: cDivider, width: 1),
            ),
      ...
      tiles.add(
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              Icon(
                focus ? Icons.star : Icons.circle_outlined,
