...
/// A property card.
Widget _tlPropCard(String name, String type, String desc, Color c) => Container(
  width: double.infinity,
  padding: const EdgeInsets.all(10),
...
Widget _tlBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'A compositing layer that displays a platform texture',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
    ...
    child: Column(
      children: [
        _tlPropCard(
          'rect',
          'Rect',
          'Screen rectangle where the texture is drawn',
          _tlBlue,
        ),
        _tlPropCard(
          'textureId',
          'int',
          'Engine-assigned ID of the native texture',
          _tlPurple,
        ),
        _tlPropCard(
          'freeze',
          'bool',
          'If true, show last frame instead of updating',
          _tlOrange,
        ),
        _tlPropCard(
          'filterQuality',
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _tlStep('2', 'Creates TextureLayer with rect + textureId', _tlBlue),
        _tlStep('3', 'Calls context.addLayer(textureLayer)', _tlPurple),
        _tlStep('4', 'Layer is attached to the compositing tree', _tlOrange),
        _tlStep('5', 'Engine traverses tree and composites texture', _tlGreen),
      ],
    ),
  ),
  _tlCode(
...
class _TlRectPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawText(
      canvas,
      'rect: 100x70',
      Offset(smallRect.left + 8, smallRect.top + 26),
      const Color(0xFFFFFFFF),
    );
    _drawText(
      canvas,
      'Small',
      Offset(smallRect.left + 8, smallRect.top + 6),
    ...
    _drawText(
      canvas,
      'Same textureId, different rects',
...
Widget _tlQualCard(String name, String algo, Color c) => Container(
  ...
  child: Column(
    children: [
      ...
      const SizedBox(height: 2),
      Text(algo, style: const TextStyle(fontSize: 9, color: Colors.black45)),
    ],
  ),
);
...
Widget _tlQualBar(String label, List<int> values, Color c) => Row(
  children: [
    SizedBox(width: 50, child: _tlSmall(label)),
    ...values.expand(
      (v) => [
        Expanded(
          child: Row(
            ...
            children: List.generate(
              ...
              (i) => Container(
                ...
                decoration: BoxDecoration(
                  color: i < v ? c : _tlCharcoal.withValues(alpha: 0.08),
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _tlMappingRow('Texture', 'TextureBox', 'TextureLayer', isHeader: true),
        const SizedBox(height: 4),
        _tlMappingRow(
          'Widget tree',
          'Render tree',
...
Widget _tlMappingRow(String w, String r, String l, {required bool isHeader}) {
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        _tlCompRow(
          'TextureLayer',
          'Native texture compositing',
          'Leaf',
          _tlOrange,
        ),
        _tlCompRow(
          'PictureLayer',
          'Canvas-drawn Flutter content',
          'Leaf',
          _tlBlue,
        ),
        _tlCompRow(
        ...
        _tlCompRow(
          'OpacityLayer',
          'Applies opacity to children',
          'Container',
          _tlTeal,
        ),
        _tlCompRow(
          'ClipRectLayer',
          'Clips children to rectangle',
          'Container',
          _tlRed,
        ),
      ],
...
Widget _tlCompRow(String name, String desc, String kind, Color c) => Padding(
  padding: const EdgeInsets.symmetric(vertical: 3),
  child: Row(
    children: [
      Container(
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_tlCharcoal.withValues(alpha: 0.07), _tlGray],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        _tlSumPt('textureId', 'Integer linking to the engine texture registry'),
        ...
        _tlSumPt(
          'Created by TextureBox',
          'Added during paint() via context.addLayer()',
        ),
        _tlSumPt(
          'Complementary to PictureLayer',
