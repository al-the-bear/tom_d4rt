  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _tpCyan, height: 1.4),
        ),
      ),
    ],
  ),
...
/// A hierarchy box.
Widget _tpHierBox(String name, Color bg, {bool highlight = false}) => Container(
...
Widget _tpBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Parent data for inline widgets in rich text',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        SizedBox(
          width: 80,
          child: Text(type, style: style.copyWith(fontFamily: null)),
        ),
        Expanded(child: Text(src, style: style.copyWith(fontFamily: null))),
      ],
    ),
  );
}
...
List<Widget> _tpWidgetSpan() => [
  ...
  _tpBullet('Step 1', 'RichText creates RenderParagraph as its render object'),
  _tpBullet(
    'Step 2',
  ...
  _tpBullet('Step 4', 'During layout, range and scale are populated'),
];
...
List<Widget> _tpInlineVisual() => [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _tpPdAnnotation(
                'NEW chip',
                'range: TextRange(15, 16)',
                'scale: 1.0',
                _tpAccent,
              ),
              _tpPdAnnotation(
                'Flutter chip',
                'range: TextRange(31, 32)',
                'scale: 1.0',
                _tpCyan,
              ),
              _tpPdAnnotation(
                'Star icon',
                'range: TextRange(53, 54)',
                'scale: 1.0',
                _tpPurple,
              ),
            ],
  ...
  _tpSmall(
    'Each inline widget has its own TextParentData with range and scale',
  ),
];

Widget _tpPdAnnotation(String widget, String range, String scale, Color c) =>
    Padding(
      padding: const EdgeInsets.symmetric(vertical: 3),
      child: Row(
        children: [
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            ...List.generate(
              3,
              (_) => const Icon(Icons.star, size: 14, color: Color(0xFFFFA000)),
            ),
            ...List.generate(
              2,
              (_) => const Icon(
...
Widget _tpLinkedListRow(String from, String to, Color fc, Color tc) => Padding(
  padding: const EdgeInsets.symmetric(vertical: 2),
  child: Row(
    children: [
      Container(
      ...
      Text(from, style: const TextStyle(fontSize: 10, color: Colors.black87)),
      const SizedBox(width: 4),
      ...
      const SizedBox(width: 4),
      Text(to, style: const TextStyle(fontSize: 10, color: Colors.black87)),
    ],
  ),
);
...
List<Widget> _tpComparison() => [
  ...
  _tpBullet('range', 'No other ParentData tracks a text position range'),
  _tpBullet(
    'scale',
...
List<Widget> _tpSummary() => [
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_tpCyan.withValues(alpha: 0.08), _tpLight],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        _tpSumPt('range field', 'TextRange marking position in text'),
        _tpSumPt('scale field', 'Font scale factor for proportional sizing'),
        _tpSumPt(
          'Created by RenderParagraph',
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of TextParentData Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
