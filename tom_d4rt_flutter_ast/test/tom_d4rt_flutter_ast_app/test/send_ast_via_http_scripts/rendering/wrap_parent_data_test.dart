  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _wpSlate, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _wpBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Per-child layout data for RenderWrap positioning',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
...
List<Widget> _wpHierarchy() => [
  ...
  _wpBody('WrapParentData sits in the container parent data chain:'),
  Container(
    width: double.infinity,
...
List<Widget> _wpFields() => [
  ...
  _wpFieldCard(
    ...
    'int',
    '0',
    'Which run (row/column) this child occupies',
    _wpOrange,
  ),
  ...
  _wpFieldCard(
    ...
    'Offset',
    'Offset.zero',
    'Painting position (x, y) from BoxParentData',
    _wpBlue,
  ),
  ...
  _wpFieldCard(
    ...
    'RenderBox?',
    'null',
    'Previous child in the linked list',
    _wpGreen,
  ),
  _wpFieldCard(
    'nextSibling',
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 6),
        _wpRunRow(2, [_WpChild('G', 150, _wpSlate)]),
      ],
    ),
  ),
  _wpBody(
    ...
    child: Column(
      ...
      children: [
        ...
        _wpOffsetItem(
          'Child A',
          'Offset(0, 0)',
          'First child in run 0',
          _wpBlue,
        ),
        _wpOffsetItem('Child B', 'Offset(84, 0)', '80 + 4 spacing', _wpGreen),
        _wpOffsetItem(
          'Child C',
          'Offset(188, 0)',
          '80 + 4 + 100 + 4',
        ...
        _wpOffsetItem(
          'Child D',
          'Offset(0, 44)',
          'First in run 1, y = run0Height + runSpacing',
          _wpOrange,
        ),
        _wpOffsetItem(
          'Child E',
          'Offset(124, 44)',
          '120 + 4 spacing in run 1',
          _wpTeal,
        ),
      ],
    ),
...
Widget _wpDirCard(String title, String code, String info, Color c) => Container(
  padding: const EdgeInsets.all(10),
  decoration: BoxDecoration(
    color: Colors.white,
    borderRadius: BorderRadius.circular(8),
  ...
  child: Column(
    ...
    children: [
      ...
      Text(
        code,
        style: TextStyle(fontSize: 10, color: c, fontFamily: 'monospace'),
      ),
      const SizedBox(height: 6),
      Text(
        info,
    ...
    child: Column(
      ...
      children: [
        _wpCompRow(
          'ParentData',
          'BoxParentData',
          'Just offset — simple box layout',
          _wpSlate,
        ),
        _wpCompRow(
          'ParentData',
          'FlexParentData',
          'flex, fit — for Row/Column',
          _wpBlue,
        ),
        _wpCompRow(
          'ParentData',
        ...
        _wpCompRow(
          'ParentData',
          'WrapParentData',
          'runIndex — which row/column run',
          _wpOrange,
        ),
        _wpCompRow(
          'ParentData',
          'SliverMultiBoxAdaptorParentData',
          'index, keepAlive — for slivers',
          _wpPurple,
        ),
        _wpCompRow(
          'ParentData',
          'TreeSliverNodeParentData',
          'depth, parentIndex — for trees',
          _wpTeal,
        ),
      ],
    ),
...
List<Widget> _wpSummary() => [
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of WrapParentData Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
