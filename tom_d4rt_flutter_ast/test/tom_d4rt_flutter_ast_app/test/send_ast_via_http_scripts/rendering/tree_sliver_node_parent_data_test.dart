  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _tnIndigo, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _tnBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Per-node metadata attached by TreeSliver during layout',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
    ...
    child: Column(
      ...
      children: [
        _tnHierItem(
          0,
          'ParentData',
          'Base — generic child metadata',
          _tnIndigo,
        ),
        _tnHierItem(
          1,
          'SliverLogicalParentData',
          'layoutOffset (position in sliver)',
          _tnAccent,
        ),
        _tnHierItem(
          2,
...
List<Widget> _tnFields() => [
  ...
  _tnFieldCard('depth', 'int', '0', 'Nesting level (root = 0)', _tnGreen),
    ...
    child: Column(
      ...
      children: [
        _tnInhRow(
          'layoutOffset',
          'double?',
          'Position within the sliver scroll extent',
          _tnIndigo,
        ),
        _tnInhRow(
          'index',
          'int?',
          'Index in the flattened child list',
          _tnAccent,
        ),
        _tnInhRow(
          'keepAlive',
          'bool',
          'Preserve even when off-screen',
          _tnGreen,
        ),
      ],
    ),
  ...
  return Container(
    ...
    child: Row(
      children: [
        ...
        _tnBadge(parentIdx != null ? 'p=$parentIdx' : 'p=null', _tnPurple),
...
List<Widget> _tnAnimation() => [
  ...
  _tnBullet('animationProgress = 0', 'Child has zero visible extent (hidden)'),
  _tnBullet('animationProgress = 0.5', 'Child shows half its natural height'),
  _tnBullet(
    ...
    children: [
      ...
      SizedBox(
        ...
        child: Text(
          ...
          style: TextStyle(fontSize: 9, color: c, fontFamily: 'monospace'),
        ),
      ),
    ],
  ),
    ...
    children: [
      ...
      Expanded(
        child: Container(
          ...
          child: Center(
            child: Text(
              'offset=$offset  h=$height',
              style: TextStyle(fontSize: 8, color: c, fontFamily: 'monospace'),
            ),
          ),
        ),
      ),
...
Widget _tnPathStep(String name, String meta, Color c, bool hasArrow) => Column(
  children: [
    Container(
      width: double.infinity,
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        _tnRelRow(
          'SliverMultiBoxAdaptorParentData',
          'index + keepAlive for general slivers',
          _tnAccent,
        ),
        _tnRelRow(
          'TreeSliverNodeParentData',
          '+ depth, parentIndex, animation for trees',
          _tnOrange,
        ),
        _tnRelRow(
          'SliverGridParentData',
          'crossAxisOffset for grid layouts',
          _tnTeal,
        ),
        _tnRelRow('BoxParentData', 'offset for plain box layout', _tnPurple),
      ],
    ),
  ),
  _tnNote(
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_tnIndigo.withValues(alpha: 0.07), _tnLavender],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _tnSumPt('depth', 'Nesting level — used for indentation calculation'),
        _tnSumPt('parentIndex', 'Links each node to its parent for traversal'),
        _tnSumPt('isExpanded', 'Tracks whether children are visible'),
        _tnSumPt(
          'animationProgress',
