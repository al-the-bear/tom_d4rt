  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _shBrown, height: 1.4),
        ),
      ),
    ],
  ),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    switch (dir) {
      case _ShHandleDir.left:
        ...
        canvas.drawRect(Rect.fromLTWH(r - 2, 0, 4, size.height - r), paint);
      ...
      case _ShHandleDir.collapsed:
        ...
        canvas.drawRect(Rect.fromLTWH(r - 1.5, 0, 3, size.height - r), paint);
    }
  }
...
Widget _shBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'The shape of draggable text selection handles',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: _shBrown.withValues(alpha: 0.15)),
                ),
                child: Column(
                  children: [
                    Row(
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        Row(
          children: [
            SizedBox(width: 70, child: _shLabel('Material')),
            Expanded(
              child: Row(
        ...
        Row(
          children: [
            SizedBox(width: 70, child: _shLabel('Cupertino')),
            Expanded(
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
...
Widget _shPlatRow(String plat, String lr, String col, {bool isHeader = false}) {
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_shBrown.withValues(alpha: 0.08), _shTan],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        _shSumPt('collapsed', 'Cursor handle — shown when no text is selected'),
        _shSumPt(
          'Platform visual',
        ...
        _shSumPt('RTL aware', 'Enum means start/end, not screen left/right'),
      ],
    ),
  ),
