  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _ptGreen, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _ptDirArrow(TextDirection dir, Color c) => Row(
  ...
  children: [
    Icon(
      dir == TextDirection.ltr ? Icons.arrow_forward : Icons.arrow_back,
      size: 18,
      color: c,
    ),
...
Widget _ptBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Screen position + direction of a selection endpoint',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Row(
              children: [
                Container(width: 12, height: 12, color: _ptBlue),
                const SizedBox(width: 4),
            ...
            Row(
              children: [
                Container(width: 12, height: 12, color: _ptOrange),
                const SizedBox(width: 4),
...
class _PtCoordsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(const Offset(px, py), 3, Paint()..color = Colors.white);
    ...
    child: Column(
      ...
      children: [
        ...
        _ptDirRow(
          'LTR',
          Icons.arrow_forward,
          'Handle drawn to the right of point',
          _ptBlue,
        ),
        ...
        _ptDirRow(
          'RTL',
          Icons.arrow_back,
          'Handle drawn to the left of point',
          _ptPurple,
        ),
        const SizedBox(height: 8),
        _ptDirRow(
          'null',
          Icons.help_outline,
          'Default placement (typically LTR)',
          _ptOrange,
        ),
      ],
    ),
...
Widget _ptDirRow(String label, IconData icon, String desc, Color c) => Row(
  children: [
    Container(
      ...
      child: Center(child: Icon(icon, size: 18, color: c)),
    ),
    const SizedBox(width: 10),
    Expanded(
      child: Column(
...
List<Widget> _ptCreation() => [
  ...
  _ptBullet('RenderParagraph', 'getEndpointsForSelection() for read-only text'),
  _ptBullet(
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _ptFlowStep('2', 'RenderEditable computes endpoints', _ptBlue),
        _ptFlowStep('3', 'Returns List<TextSelectionPoint>', _ptPurple),
        _ptFlowStep('4', 'SelectionOverlay reads .point', _ptOrange),
        _ptFlowStep('5', 'Overlay reads .direction for handle shape', _ptTeal),
    ...
    child: Column(
      children: [
        ...
        _ptCoordBox(
          ...
          72.0,
          dir: TextDirection.ltr,
          markerColor: _ptPurple,
        ),
        const SizedBox(height: 8),
        _ptSmall('Start point is on line 1, end point is on line 3'),
      ],
    ),
  ),
  _ptCode(
...
Widget _ptBidiRow(String label, String text, TextDirection dir, Color c) {
  return Padding(
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _ptCompRow(
          'TextSelection',
          'Range of text (base & extent offsets)',
          'Logical selection',
        ),
        _ptCompRow(
          'TextPosition',
          'Single character offset + affinity',
          'Index into text',
        ),
        _ptCompRow(
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_ptGreen.withValues(alpha: 0.08), _ptMint],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
