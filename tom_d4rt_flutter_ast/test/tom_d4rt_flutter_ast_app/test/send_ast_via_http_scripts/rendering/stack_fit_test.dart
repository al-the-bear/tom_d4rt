  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _sfRose, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _sfBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Controls how Stack sizes non-positioned children',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
      ...
      children: [
        ...
        Center(
          child: _sfStackFrame('loose', 200, 150, [
            _sfChild('Child A\n60x40', _sfRose, 60, 40),
            _sfChild('Child B\n120x80', _sfAccent, 120, 80, left: 30, top: 30),
            _sfChild('Child C\n40x30', _sfBlue, 40, 30, left: 10, top: 100),
          ]),
        ),
        const SizedBox(height: 8),
        _sfSmall('Each child sizes itself freely (min=0, max=stack size)'),
      ],
    ),
  ),
  _sfCode(
      ...
      children: [
        ...
        Center(
          child: _sfStackFrame('expand', 200, 150, [
            _sfChild(
              'Child A\n(fills stack)',
              _sfRose.withValues(alpha: 0.4),
              192,
              138,
            ),
            _sfChild(
              'Child B\n(fills stack)',
              _sfAccent.withValues(alpha: 0.5),
              192,
              138,
            ),
        ...
        const SizedBox(height: 8),
        _sfSmall('All children are the same size: exactly 200x150'),
      ],
    ),
  ),
  _sfCode(
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        const SizedBox(height: 8),
        _sfSmall('Children get parent constraints: not stack-derived'),
      ],
    ),
  ),
  _sfCode(
  ...
  Container(
    ...
    child: Center(
      child: _sfStackFrame('expand + Positioned', 200, 130, [
        ...
        _sfChild(
          'Background\n(expand = fills)',
          _sfRose.withValues(alpha: 0.3),
          192,
          118,
        ),
        // Positioned: respects its props
        _sfChild('Positioned\n100x50', _sfBlue, 100, 50, left: 10, top: 10),
      ]),
    ),
  ),
  _sfSmall(
...
List<Widget> _sfComparison() => [
  ...
  _sfBody('All three StackFit values with the same Stack and children:'),
  Container(
    width: double.infinity,
    padding: const EdgeInsets.all(10),
    margin: const EdgeInsets.symmetric(vertical: 8),
              ...
              child: Column(
                children: [
                  ...
                  _sfStackFrame('', 100, 80, [
                    _sfChild('A\n40x30', _sfRose, 40, 30),
                    _sfChild('B\n60x50', _sfBlue, 60, 50, left: 20, top: 20),
                  ]),
                ],
              ),
            ),
  ...
  Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _sfCmpRow('Property', 'loose', 'expand', 'passthrough', isHeader: true),
...
List<Widget> _sfPatterns() => [
  ...
  _sfBody('Use loose to let cards size themselves naturally:'),
  _sfCode(
    'Stack(\n'
    '  fit: StackFit.loose,  // default\n'
  ...
  _sfBody('Use passthrough when wrapping a Stack in a LayoutBuilder:'),
  _sfCode(
    'LayoutBuilder(\n'
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _sfGotchaRow(
          Icons.warning_amber,
          'expand + UnconstrainedBox',
          'Constraint override — may overflow',
          _sfWarn,
        ),
        _sfGotchaRow(
          Icons.warning_amber,
          'passthrough + unbounded',
          'Assertion failure if child expects bounds',
          _sfWarn,
        ),
        _sfGotchaRow(
          Icons.check_circle_outline,
          'expand + all Positioned',
          'fit is ignored — no non-positioned children',
          _sfGood,
        ),
      ],
    ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(desc, style: TextStyle(fontSize: 10.5, color: c)),
              ],
            ),
          ),
        ],
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_sfRose.withValues(alpha: 0.08), _sfPink],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _sfSummPt('loose', 'Default — children size freely, 0 to stack size'),
        _sfSummPt(
          'expand',
          'Children forced to match stack size (tight constraints)',
        ),
        _sfSummPt('passthrough', 'Parent constraints forwarded unchanged'),
        _sfSummPt(
          'Positioned',
