  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _tiOlive, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _tiBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Controls how tree nodes are indented in a TreeSliver',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _tiFlowStep('2', 'For each node, queries indentation type', _tiBlue),
        _tiFlowStep('3', 'Indentation returns horizontal offset', _tiPurple),
        _tiFlowStep('4', 'Node row is padded by that offset', _tiOrange),
        _tiFlowStep('5', 'Visual nesting appears in the sliver', _tiAccent),
      ],
    ),
  ),
];
    ...
    child: Row(
      children: [
        ...
        Expanded(
          child: Text(
            std,
            style: style.copyWith(color: isHeader ? _tiOlive : _tiBlue),
          ),
        ),
        Expanded(
          child: Text(
            custom,
            style: style.copyWith(color: isHeader ? _tiOlive : _tiPurple),
          ),
        ),
      ],
    ),
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _tiFileRow(1, 'pubspec.yaml', Icons.settings, const Color(0xFFBDBDBD)),
      ],
    ),
  ),
...
Widget _tiFileRow(int depth, String name, IconData icon, Color c) => Padding(
  ...
  child: Row(
    children: [
      ...
      Text(
        name,
        style: TextStyle(fontSize: 12, color: c.withValues(alpha: 0.9)),
      ),
    ],
  ),
);
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_tiOlive.withValues(alpha: 0.07), _tiCream],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        _tiSumPt('Used by TreeSliver', 'Passed as the indentation parameter'),
        _tiSumPt(
          'Affects layout',
