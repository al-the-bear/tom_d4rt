  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _spIndigo, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _spBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Physical paintOffset for single-child slivers',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        Expanded(child: Text(source, style: style.copyWith(fontFamily: null))),
...
List<Widget> _spOffsetVsPaintOffset() => [
  ...
  _spBody('Having two offsets can be confusing. Here is when each is used:'),
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _spPathArrow(),
        _spPathStep(
          'pd.paintOffset = Offset(x, y)',
          'Physical offset stored',
          _spIndigo,
        ),
        _spPathArrow(),
        _spPathStep(
          'applyPaintTransform()',
          'Direct translate — done!',
          _spGood,
        ),
        ...
        _spPathArrow(),
        _spPathStep(
          'pd.layoutOffset = mainAxisPos',
          'Logical offset stored',
          _spAccent,
        ),
        _spPathArrow(),
        _spPathStep(
          'applyPaintTransform()',
          'Must convert: axis + growth direction',
          _spWarn,
        ),
        _spPathArrow(),
        _spPathStep(
          'computeAbsolutePaintOffset()',
          'Finally get physical coords',
          _spGood,
        ),
      ],
    ),
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _spAxisRow(
          'AxisDirection.up',
          'Offset(0, height - mainAxisPos)',
          _spAccent,
        ),
        _spAxisRow('AxisDirection.right', 'Offset(mainAxisPos, 0)', _spGood),
        _spAxisRow(
          'AxisDirection.left',
          'Offset(width - mainAxisPos, 0)',
          _spWarn,
        ),
      ],
    ),
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: visible ? _spIndigo : _spAccent.withValues(alpha: 0.2),
                  borderRadius: BorderRadius.circular(4),
                ),
                child: Center(
                  child: Text(
...
List<Widget> _spUsers() => [
  ...
  _spBody('Several built-in slivers use the physical parent data variant:'),
...
List<Widget> _spSummary() => [
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_spIndigo.withValues(alpha: 0.08), _spLightIndigo],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _spSummPt('paintOffset', 'Physical offset in viewport coordinates'),
        _spSummPt('Simple', 'One extra field over BoxParentData'),
        _spSummPt('Direct transform', 'applyPaintTransform uses offset as-is'),
        _spSummPt(
          'Set at layout',
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of SliverPhysicalParentData Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
