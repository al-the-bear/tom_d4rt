  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _waTeal, height: 1.4),
        ),
      ),
    ],
  ),
...
List<Widget> _waCenter() => [
  ...
  _waBullet('Use case', 'Centered tag clouds, centered action buttons'),
...
List<Widget> _waSpaceBetween() => [
  ...
  _waBullet('Use case', 'Navigation items, evenly distributed content'),
...
List<Widget> _waUsage() => [
  ...
  _waBody('WrapAlignment is used in two Wrap properties:'),
  _waBullet('alignment', 'Main-axis alignment within each run (row/column)'),
  _waBullet('runAlignment', 'Cross-axis alignment between runs'),
  _waCode(
    'Wrap(\n'
...
Widget _waRtlRow(String label, MainAxisAlignment align, bool isRtl, Color c) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(
...
List<Widget> _waSummary() => [
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_waTeal.withValues(alpha: 0.07), _waPale],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _waSumPt('start', 'Pack to start edge (default)'),
        _waSumPt('end', 'Pack to end edge'),
        _waSumPt('center', 'Center in run, equal space on both sides'),
        _waSumPt('spaceBetween', 'Even space between items, none at edges'),
        _waSumPt('spaceAround', 'Half-space at edges, full space between'),
        _waSumPt('spaceEvenly', 'All gaps equal — edges and between'),
        _waSumPt('RTL-aware', 'Start/end flip with text direction'),
      ],
    ),
  ),
  ...
  Center(
    child: Container(
      ...
      child: const Text(
        'End of WrapAlignment Deep Demo',
        style: TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w700,
          color: Colors.white,
