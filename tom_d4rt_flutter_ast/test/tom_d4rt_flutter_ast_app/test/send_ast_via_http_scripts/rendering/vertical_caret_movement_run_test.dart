...
Widget _vcDivider() => Padding(
  ...
  child: Container(height: 1, color: _vcVermilion.withValues(alpha: 0.1)),
);
...
List<Widget> _vcStickyX() => [
  ...
  _vcTextBlock([
    _VcLine('This is a long line of text with many characters.', 40, _vcGrey),
    _VcLine('Short.', 5, _vcRed),
    _VcLine('Another fairly long line of text here.', 35, _vcGrey),
                        ...
                        if (line.caretPos <= line.text.length) ...[
                          TextSpan(
                            text: line.text.substring(
                              0,
                              line.caretPos.clamp(0, line.text.length),
                            ),
                          ),
                          TextSpan(
                            text: '|',
                          ...
                          if (line.caretPos < line.text.length)
                            TextSpan(text: line.text.substring(line.caretPos)),
                        ] else
    ...
    child: Column(
      ...
      children: [
        ...
        _vcStep(
          '2',
          'Iterator created',
          'Records current caret pixel X position',
          _vcBlue,
        ),
        _vcStep(
          '3',
...
Widget _vcStep(String num, String action, String detail, Color c) => Padding(
  padding: const EdgeInsets.symmetric(vertical: 3),
  child: Row(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
...
List<Widget> _vcApi() => [
  ...
  _vcMethodCard(
    'isValid',
    'bool',
    'Whether the run is still valid (not invalidated)',
    _vcBlue,
  ),
  _vcMethodCard(
    'moveNext()',
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _vcMapRow('Line 1: "Hello World"', 7, 'After "Hello W"', _vcVermilion),
        _vcMapRow('Line 2: "MMMM"', 3, 'After "MMM" (wide chars)', _vcBlue),
        _vcMapRow(
          'Line 3: "iiiiiiiiiiii"',
          10,
          'After 10 "i" (narrow)',
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _vcInvRow('Mouse click', Icons.mouse, 'New selection position'),
        _vcInvRow(
          'Text insertion',
          Icons.edit,
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const Center(
          child: Icon(Icons.arrow_downward, size: 16, color: Colors.black38),
        ),
        const SizedBox(height: 4),
        _vcRelBox(
          'VerticalCaretMovementRun',
...
Widget _vcRelBox(String name, String desc, Color c) => Container(
  ...
  child: Column(
    ...
    children: [
      ...
      Text(desc, style: const TextStyle(fontSize: 10.5, color: Colors.black54)),
    ],
  ),
);
...
List<Widget> _vcWalkthrough() => [
  ...
  _vcWalkStep(
    ...
    'Line 1',
    15,
    'Caret at position 15 — saved X = 90px',
    _vcVermilion,
  ),
  _vcWalkStep(
    'After Down #1',
    'Line 2',
    12,
    'Shorter line — closest pos to X=90 is 12',
    _vcBlue,
  ),
  _vcWalkStep(
    'After Down #2',
    'Line 3',
    15,
    'Back to full length — X=90 maps to pos 15',
    _vcGreen,
  ),
  _vcWalkStep(
    'After Down #3',
    'Line 4',
    8,
    'Line 4 is short — caret at end (pos 8)',
    _vcPurple,
  ),
  _vcCode(
...
Widget _vcWalkStep(String title, String line, int pos, String desc, Color c) {
  return Container(
    width: double.infinity,
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_vcVermilion.withValues(alpha: 0.07), _vcIvory],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
