...
const List<_Scenario> _scenarios = <_Scenario>[
  _Scenario(
    id: _ScenarioMode.cardStack,
    title: 'Card Stack',
    subtitle:
        'Layered PhysicalModel cards with depth ordering and tint controls.',
  ),
  _Scenario(
    id: _ScenarioMode.portalClip,
    title: 'Portal Clip',
    subtitle:
        'Clipped portal surfaces to show clip behavior and child overflow limits.',
  ),
  _Scenario(
    id: _ScenarioMode.chipCloud,
    title: 'Chip Cloud',
    subtitle:
        'Small physical surfaces in dense layouts with varying elevations.',
  ),
  _Scenario(
    id: _ScenarioMode.ramp,
    title: 'Elevation Ramp',
    subtitle: 'Animated elevation sweeps with color and shadow transitions.',
  ),
  _Scenario(
    id: _ScenarioMode.diagnostics,
    title: 'Diagnostics',
    subtitle: 'Comparison and render metrics for physical model behavior.',
  ),
];
...
const List<_FaqItem> _faqItems = <_FaqItem>[
  _FaqItem(
    ...
    answer:
        'When you need explicit clipping and elevation-based shadow behavior from a shaped surface.',
  ),
  _FaqItem(
    question: 'How is this different from Material?',
    answer:
        'Material adds semantic/theming behavior, while PhysicalModel is a focused rendering primitive.',
  ),
  _FaqItem(
    question: 'Why does clipBehavior matter?',
    answer:
        'It controls whether child content can extend beyond the model shape and affects visual correctness.',
  ),
  _FaqItem(
    question: 'Can I animate elevation and color together?',
    answer:
        'Yes, this is common for hover/press states and motion-driven depth transitions.',
  ),
  _FaqItem(
    question: 'How can I debug layer ordering?',
    answer:
        'Capture per-surface depth metrics and visualize stacking in a dedicated board.',
  ),
];

enum _ScenarioMode { cardStack, portalClip, chipCloud, ramp, diagnostics }

enum _ShapeMode { rectangle, rounded, stadium, circle }
...
class _RenderPhysicalModelStudio extends StatefulWidget {
  ...
  @override
  State<_RenderPhysicalModelStudio> createState() =>
      _RenderPhysicalModelStudioState();
}

class _RenderPhysicalModelStudioState extends State<_RenderPhysicalModelStudio>
          ...
          children: <Widget>[
            Wrap(
              ...
              children: <Widget>[
                ...
                Text(
                  'RenderPhysicalModel Depth and Shadow Studio',
                  style: TextStyle(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'Tune elevation, clipping shape, shadow intensity, and scenario visibility.',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            const SizedBox(height: 10),
            _sliderRow(
            ...
            _sliderRow(
              ...
              onChangeEnd: (double v) => _bumpControl(
                'Elevation',
                'Set base elevation to ${v.toStringAsFixed(1)}.',
              ),
            ),
            _sliderRow(
              scheme: scheme,
              ...
              onChangeEnd: (double v) => _bumpControl(
                'Spread',
                'Set elevation spread to ${v.toStringAsFixed(1)}.',
              ),
            ),
            _sliderRow(
              scheme: scheme,
              ...
              onChangeEnd: (double v) => _bumpControl(
                'Radius',
                'Set radius to ${v.toStringAsFixed(1)}.',
              ),
            ),
            _sliderRow(
              scheme: scheme,
              ...
              onChangeEnd: (double v) => _bumpControl(
                'Opacity',
                'Set surface opacity to ${v.toStringAsFixed(2)}.',
              ),
            ),
            _sliderRow(
              scheme: scheme,
            ...
            _sliderRow(
              ...
              onChangeEnd: (double v) => _bumpControl(
                'Chip Density',
                'Set chip density to ${v.toStringAsFixed(2)}.',
              ),
            ),
            _sliderRow(
              scheme: scheme,
              ...
              onChangeEnd: (double v) => _bumpControl(
                'Portal',
                'Set portal inset to ${v.toStringAsFixed(1)}.',
              ),
            ),
            _sliderRow(
              scheme: scheme,
              ...
              onChangeEnd: (double v) => _bumpControl(
                'Stack Gap',
                'Set stack gap to ${v.toStringAsFixed(1)}.',
              ),
            ),
            _sliderRow(
              scheme: scheme,
              ...
              onChangeEnd: (double v) => _bumpControl(
                'Tile Scale',
                'Set tile scale to ${v.toStringAsFixed(2)}.',
              ),
            ),
            const SizedBox(height: 8),
            Text(
              ...
              children: _ShapeMode.values.map((_ShapeMode mode) {
                return ChoiceChip(
                  ...
                  onSelected: (_) {
                    ...
                    _pushTimeline(
                      'Shape',
                      'Shape mode switched to ${mode.name}.',
                    );
                  },
                );
              }).toList(),
              ...
              children: Clip.values.map((Clip c) {
                return ChoiceChip(
                  ...
                  onSelected: (_) {
                    ...
                    _pushTimeline(
                      'Clip',
                      'Clip behavior switched to ${c.name}.',
                    );
                  },
                );
              }).toList(),
            ...
            Wrap(
              ...
              children: <Widget>[
                ...
                CheckboxMenuButton(
                  value: _showPortalOverflow,
                  onChanged: (bool? v) => _toggle('overflow', v),
                  child: const Text('Show portal overflow child'),
                ),
                CheckboxMenuButton(
                  value: _showChipLabels,
                  onChanged: (bool? v) => _toggle('chips', v),
                  child: const Text('Show chip labels'),
                ),
                CheckboxMenuButton(
                  value: _showRampLabels,
                  onChanged: (bool? v) => _toggle('ramp', v),
                  child: const Text('Show ramp labels'),
                ),
                CheckboxMenuButton(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'Interactive depth stage with scenario-specific PhysicalModel lanes.',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
  ...
  Widget _chipCloudLane(ColorScheme scheme, double progress) {
    ...
    for (int i = 0; i < 28; i += 1) {
      final double x =
          26 +
          ((i % 7) * 170) +
          math.sin((progress * math.pi * 2) + (i * 0.4)) * 6;
      final double y =
          40 +
          ((i ~/ 7) * 120) +
          math.cos((progress * math.pi * 2) + (i * 0.28)) * 8;
      final double elevation =
          _baseElevation *
          (0.25 + ((i % 5) / 5)) *
          (0.6 + (_chipDensity * 0.8));
      chips.add(
        Positioned(
          left: x,
          top: y,
  ...
  Widget _rampLane(ColorScheme scheme, double progress) {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        final double animated = _animate
            ? (0.5 + (math.sin((progress * math.pi * 2) + (t * math.pi)) * 0.5))
            : 0.5;
        final double elevation =
            _baseElevation +
            (_elevationSpread * t * (0.65 + (animated * 0.35)));
        return Padding(
  ...
  Widget _diagnosticsLane(ColorScheme scheme, double progress) {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            'PhysicalModel Diagnostics Lane',
            style: TextStyle(
              color: scheme.onSurface,
              fontWeight: FontWeight.w800,
              fontSize: 22,
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(
                        ...
                        blurRadius:
                            (_baseElevation + _elevationSpread * 0.6) * 2,
                      ),
                    ],
                    gradient: LinearGradient(
          ...
          Wrap(
            ...
            children: <Widget>[
              ...
              _diagChip(
                'elevation ${_baseElevation.toStringAsFixed(1)} + ${_elevationSpread.toStringAsFixed(1)}',
                scheme.tertiary,
              ),
              _diagChip(
                'opacity ${_surfaceOpacity.toStringAsFixed(2)}',
                scheme.primary,
              ),
            ],
          ),
  ...
  Widget _physicalTile({
    ...
    final BorderRadius radius = BorderRadius.circular(
      _shape == _ShapeMode.rounded
          ? _radius
          : _shape == _ShapeMode.stadium
          ? 999
          : math.max(0, _radius * 0.4),
    );
    ...
    return PhysicalModel(
      ...
      child: Container(
        ...
        decoration: ShapeDecoration(
          ...
          gradient: LinearGradient(
            colors: <Color>[
              colorA.withValues(alpha: _surfaceOpacity),
              colorB.withValues(alpha: _surfaceOpacity),
            ],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'Compare PhysicalModel usage to related surface patterns.',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            const SizedBox(height: 12),
            LayoutBuilder(
              builder: (BuildContext context, BoxConstraints constraints) {
                ...
                final Widget physical = _comparisonCard(
                  ...
                  title: 'PhysicalModel',
                  subtitle:
                      'Dedicated render primitive for physical depth + clipping.',
                  icon: Icons.layers,
                ...
                final Widget material = _comparisonCard(
                  ...
                  title: 'Material',
                  subtitle:
                      'Higher-level component with theme and interaction semantics.',
                ...
                final Widget decorated = _comparisonCard(
                  ...
                  title: 'DecoratedBox',
                  subtitle:
                      'Surface styling without explicit physical model behavior.',
  ...
  List<_MetricEntry> _metrics() {
    return <_MetricEntry>[
      _MetricEntry(
        ...
        note: 'Active physical surface scenario.',
      ...
      _MetricEntry(
        label: 'Shape',
        value: _shape.name,
        note: 'Physical surface geometry.',
        icon: Icons.rounded_corner_outlined,
      ),
      _MetricEntry(
        label: 'Clip',
        value: _clip.name,
        note: 'Child clipping behavior.',
        icon: Icons.content_cut_outlined,
      ),
      _MetricEntry(
        label: 'Stage Height',
        value: _stageHeight.toStringAsFixed(0),
        note: 'Visible stage height.',
      ...
      _MetricEntry(
        ...
        note: 'Base and spread across lanes.',
        icon: Icons.vertical_align_top_outlined,
      ),
      _MetricEntry(
        label: 'Radius',
        value: _radius.toStringAsFixed(1),
        note: 'Corner rounding parameter.',
        icon: Icons.circle_outlined,
      ),
      _MetricEntry(
        label: 'Surface Opacity',
        value: _surfaceOpacity.toStringAsFixed(2),
        note: 'Tint alpha for physical surfaces.',
        icon: Icons.opacity_outlined,
      ),
      _MetricEntry(
        label: 'Shadow Alpha',
        value: _shadowAlpha.toStringAsFixed(2),
        note: 'Shadow intensity parameter.',
        icon: Icons.dark_mode_outlined,
      ),
      _MetricEntry(
        label: 'Gradient Shift',
        value: _gradientShift.toStringAsFixed(2),
        note: 'Background shift in grid painter.',
        icon: Icons.gradient_outlined,
      ),
      _MetricEntry(
        label: 'Chip Density',
        value: _chipDensity.toStringAsFixed(2),
        note: 'Density factor for chip cloud.',
        icon: Icons.bubble_chart_outlined,
      ),
      _MetricEntry(
        label: 'Portal Inset',
        value: _portalInset.toStringAsFixed(1),
        note: 'Inset used in portal clip lane.',
        icon: Icons.crop_free_outlined,
      ),
      _MetricEntry(
        label: 'Stack Gap',
        value: _stackGap.toStringAsFixed(1),
        note: 'Offset spacing for stacked cards.',
        icon: Icons.stacked_bar_chart_outlined,
      ),
      _MetricEntry(
        label: 'Tile Scale',
        value: _tileScale.toStringAsFixed(2),
        note: 'Scale factor for chip cards.',
        icon: Icons.photo_size_select_small_outlined,
      ),
      _MetricEntry(
        label: 'Switches',
        value:
            'theme=$_themeSwitches scenario=$_scenarioSwitches shape=$_shapeSwitches clip=$_clipSwitches',
        note: 'Major mode switch counts.',
        icon: Icons.swap_horiz_outlined,
      ),
      _MetricEntry(
        label: 'Control Edits',
        value: '$_controlEdits',
        note: 'Slider/toggle interaction count.',
        icon: Icons.tune_outlined,
      ),
      _MetricEntry(
        label: 'Stage Taps',
        value: '$_tapCount',
        note: 'Tap interactions on stage.',
        icon: Icons.touch_app_outlined,
      ),
      _MetricEntry(
        label: 'Snapshot',
        value:
            '${_snapshot.scenario} e=${_snapshot.elevation.toStringAsFixed(1)} r=${_snapshot.radius.toStringAsFixed(1)} ${_snapshot.clip}',
        note: 'Last depth snapshot.',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'theme=${_themes[_themeIndex].id} scenario=${_scenarios[_scenarioIndex].id.name} shape=${_shape.name} clip=${_clip.name}',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'stage=${_stageHeight.toStringAsFixed(0)} elevation=${_baseElevation.toStringAsFixed(1)} spread=${_elevationSpread.toStringAsFixed(1)} radius=${_radius.toStringAsFixed(1)}',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'surfaceOpacity=${_surfaceOpacity.toStringAsFixed(2)} shadowAlpha=${_shadowAlpha.toStringAsFixed(2)} gradientShift=${_gradientShift.toStringAsFixed(2)}',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'chipDensity=${_chipDensity.toStringAsFixed(2)} portalInset=${_portalInset.toStringAsFixed(1)} stackGap=${_stackGap.toStringAsFixed(1)} tileScale=${_tileScale.toStringAsFixed(2)}',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'flags animate=$_animate grid=$_showGrid overflow=$_showPortalOverflow chips=$_showChipLabels ramp=$_showRampLabels',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'switches t=$_themeSwitches s=$_scenarioSwitches sh=$_shapeSwitches c=$_clipSwitches edits=$_controlEdits taps=$_tapCount',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
          ],
        ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'Chronological stream of depth and clipping interactions.',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            const SizedBox(height: 10),
