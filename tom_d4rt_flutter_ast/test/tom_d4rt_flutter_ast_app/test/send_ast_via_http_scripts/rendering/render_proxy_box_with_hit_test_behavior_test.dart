...
const List<_Scenario> _scenarios = <_Scenario>[
  _Scenario(
    ...
    title: 'Layer Stack',
    description:
        'Overlapping zones with different hit-test behaviors in one stack.',
  ),
  _Scenario(
    mode: _ScenarioMode.passThroughLab,
    title: 'Pass-Through Lab',
    description:
        'Transparent regions where behavior choice changes event forwarding.',
  ),
  _Scenario(
    mode: _ScenarioMode.nestedArena,
    title: 'Nested Arena',
    description:
        'Outer/inner proxy hierarchy showing route priority and capture.',
  ),
  _Scenario(
    mode: _ScenarioMode.signalTower,
    title: 'Signal Tower',
    description:
        'Pointer-signal and hover channels across stacked behavior gates.',
  ),
  _Scenario(
  ...
  _Scenario(
    ...
    title: 'Analytics',
    description:
        'Route summaries, behavior comparisons, and verification checklist.',
  ),
];
...
const List<_Faq> _faqs = <_Faq>[
  _Faq(
    ...
    answer:
        'When building wrappers that alter hit testing without owning a completely custom render tree.',
  ),
  _Faq(
    question: 'Which behavior is safest by default?',
    answer:
        'Opaque is predictable for full-region interaction, but choose based on pass-through needs.',
  ),
  _Faq(
    question: 'Why use translucent?',
    answer:
        'It is useful for overlays that must observe events while not fully blocking content beneath.',
  ),
  _Faq(
    question: 'What does deferToChild solve?',
    answer:
        'It keeps wrapper interaction conditional on whether children are hit, reducing accidental interception.',
  ),
  _Faq(
    question: 'How can I verify behavior under overlap?',
    answer:
        'Build stacked zones with distinct labels and log every event with zone + behavior metadata.',
  ),
];
...
class _RenderProxyBoxWithHitTestBehaviorStudio extends StatefulWidget {
  ...
  @override
  State<_RenderProxyBoxWithHitTestBehaviorStudio> createState() =>
      _RenderProxyBoxWithHitTestBehaviorStudioState();
}

class _RenderProxyBoxWithHitTestBehaviorStudioState
    extends State<_RenderProxyBoxWithHitTestBehaviorStudio>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _logSynthetic(
        ...
        type: 'init',
        note: 'Hit-test behavior studio initialized.',
      );
    });
  }
  ...
  void _record({
    ...
    setState(() {
      ...
      final List<Offset> trail = _trails.putIfAbsent(
        event.pointer,
        () => <Offset>[],
      );
          ...
          children: <Widget>[
            Wrap(
              ...
              children: <Widget>[
                ...
                Text(
                  'RenderProxyBoxWithHitTestBehavior Routing Arena',
                  style: TextStyle(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'Tune behavior channels, visual overlays, and route diagnostics.',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            const SizedBox(height: 10),
            _slider(
            ...
            _slider(
              ...
              max: 48,
              divisions: 96,
              onChanged: (double v) => setState(() => _zoneRound = v),
              onChangeEnd: (double v) => _onSlider('zoneRound', v),
            ),
            _slider(
              scheme: scheme,
              label: 'Zone Opacity',
              ...
              onChangeEnd: (double v) => _onSlider('zoneOpacity', v),
            ),
            _slider(
              scheme: scheme,
              label: 'Overlay Alpha',
              ...
              onChangeEnd: (double v) => _onSlider('overlayAlpha', v),
            ),
            _slider(
              scheme: scheme,
              label: 'Trail Width',
              ...
              max: 8,
              divisions: 74,
              onChanged: (double v) => setState(() => _trailWidth = v),
              onChangeEnd: (double v) => _onSlider('trailWidth', v),
            ),
            _slider(
              scheme: scheme,
              label: 'Trail Fade',
              ...
              onChangeEnd: (double v) => _onSlider('trailFade', v),
            ),
            _slider(
              scheme: scheme,
              label: 'Heat Strength',
              ...
              max: 1,
              divisions: 100,
              onChanged: (double v) => setState(() => _heatStrength = v),
              onChangeEnd: (double v) => _onSlider('heatStrength', v),
            ),
            _slider(
              scheme: scheme,
            ...
            _slider(
              ...
              onChangeEnd: (double v) => _onSlider('signalGain', v),
            ),
            const SizedBox(height: 8),
            Text(
              'Primary Behavior',
            ...
            Wrap(
              ...
              children: <Widget>[
                ...
                CheckboxMenuButton(
                  value: _showSignals,
                  onChanged: (bool? v) => _toggle('signals', v),
                  child: const Text('Signal Hints'),
                ),
                CheckboxMenuButton(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'Interact with overlapping zones to observe hit-test behavior routing in real time.',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
      ...
      children: <Widget>[
        ...
        if (_showSignals)
          Positioned(
            ...
            top: 12,
            child: _hint(
              'Tap or hover in overlaps to see capture priority by behavior.',
            ),
          ),
      ],
    );
      ...
      child: Row(
        children: <Widget>[
          Expanded(
            ...
            child: Listener(
              behavior: _primaryBehavior,
              onPointerSignal: (PointerSignalEvent e) => _record(
                zone: 'signal-main',
                behavior: _primaryBehavior,
                event: e,
                type: 'signal',
              ...
              onPointerHover: (PointerHoverEvent e) => _record(
                zone: 'signal-main',
                behavior: _primaryBehavior,
                event: e,
                type: 'hover',
              ),
              onPointerDown: (PointerDownEvent e) => _record(
                zone: 'signal-main',
                behavior: _primaryBehavior,
                event: e,
                type: 'down',
              ),
              onPointerMove: (PointerMoveEvent e) => _record(
                zone: 'signal-main',
                behavior: _primaryBehavior,
                event: e,
                type: 'move',
              ),
              onPointerUp: (PointerUpEvent e) => _record(
                zone: 'signal-main',
                behavior: _primaryBehavior,
                event: e,
                type: 'up',
                  ...
                  children: <Widget>[
                    ...
                    Center(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'signals=$_signalCount hover=$_hoverCount',
                            style: const TextStyle(
                    ...
                    if (_showSignals)
                      Positioned(
                        right: 12,
                        top: 12,
                        child: _hint('Use wheel/trackpad scroll here'),
                      ),
                  ],
                ),
              ),
              ...
              builder: (BuildContext context, BoxConstraints constraints) {
                ...
                if (entries.isEmpty) {
                  return Container(
                    ...
                    child: const Center(
                      child: Text(
                        'Interact with stage to populate map frequencies',
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    '1. Toggle behaviors and verify route changes in timeline.',
                    style: TextStyle(color: Colors.white70),
                  ),
                  const Text(
                    '2. Confirm overlap capture differs between opaque/translucent/deferToChild.',
                    style: TextStyle(color: Colors.white70),
                  ),
                  const Text(
                    '3. Observe signal and hover channels in stacked zones.',
                    style: TextStyle(color: Colors.white70),
                  ),
                  const Text(
                    '4. Validate zone frequency map updates consistently.',
                    style: TextStyle(color: Colors.white70),
                  ),
                  const SizedBox(height: 10),
                  Wrap(
    ...
    return Positioned.fromRect(
      ...
      child: Listener(
        ...
        onPointerDown: (PointerDownEvent e) =>
            _record(zone: zone, behavior: behavior, event: e, type: 'down'),
        onPointerMove: (PointerMoveEvent e) =>
            _record(zone: zone, behavior: behavior, event: e, type: 'move'),
        onPointerUp: (PointerUpEvent e) =>
            _record(zone: zone, behavior: behavior, event: e, type: 'up'),
        onPointerHover: (PointerHoverEvent e) =>
            _record(zone: zone, behavior: behavior, event: e, type: 'hover'),
        onPointerCancel: (PointerCancelEvent e) =>
            _record(zone: zone, behavior: behavior, event: e, type: 'cancel'),
        onPointerSignal: (PointerSignalEvent e) =>
            _record(zone: zone, behavior: behavior, event: e, type: 'signal'),
        child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: <Color>[
                colors.first.withValues(alpha: _zoneOpacity),
                colors.last.withValues(alpha: _zoneOpacity),
              ],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'Quick visual summary of behavior semantics in proxy wrappers.',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            const SizedBox(height: 12),
            LayoutBuilder(
              builder: (BuildContext context, BoxConstraints constraints) {
                ...
                final Widget opaque = _behaviorCard(
                  scheme,
                  'opaque',
                  'Captures entire bounds for hit testing.',
                  const Color(0xFF0F766E),
                );
                final Widget translucent = _behaviorCard(
                  scheme,
                  'translucent',
                  'Receives hits and may allow behind targets too.',
                  const Color(0xFF1D4ED8),
                );
                final Widget defer = _behaviorCard(
                  scheme,
                  'deferToChild',
                  'Only hits when child reports a hit.',
                ...
                return Row(
                  children: <Widget>[
                    Expanded(child: opaque),
                    const SizedBox(width: 10),
                    Expanded(child: translucent),
                    const SizedBox(width: 10),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Center(
                child: Text(
                  'selected=${_primaryBehavior.name == title || _secondaryBehavior.name == title || _tertiaryBehavior.name == title}',
  ...
  List<_Metric> _metrics() {
    return <_Metric>[
      ...
      _Metric(
        label: 'Primary',
        value: _primaryBehavior.name,
        note: 'Primary behavior selection.',
        icon: Icons.looks_one_outlined,
      ),
      _Metric(
        label: 'Secondary',
        value: _secondaryBehavior.name,
        note: 'Secondary behavior selection.',
        icon: Icons.looks_two_outlined,
      ),
      _Metric(
        label: 'Tertiary',
        value: _tertiaryBehavior.name,
        note: 'Tertiary behavior selection.',
        icon: Icons.looks_3_outlined,
      ),
      _Metric(
        label: 'Events',
        value: '${_events.length}',
        note: 'Total timeline entries captured.',
        icon: Icons.list_alt_outlined,
      ),
      _Metric(
        label: 'Counters',
        value: 'd=$_downCount m=$_moveCount u=$_upCount',
        note: 'Down/move/up counts.',
        icon: Icons.countertops_outlined,
      ),
      _Metric(
        label: 'Secondary Counts',
        value: 'h=$_hoverCount s=$_signalCount c=$_cancelCount',
        note: 'Hover/signal/cancel counts.',
      ...
      _Metric(
        ...
        note: 'Accumulated scroll delta totals.',
        icon: Icons.swipe_vertical_outlined,
      ),
      _Metric(
        label: 'Trails',
        value: '${_trails.length} pointers',
        note: 'Active pointer trail maps.',
        icon: Icons.timeline_outlined,
      ),
      _Metric(
        label: 'Heat',
        value: '${_heat.length} points',
        note: 'Heat-map samples retained.',
        icon: Icons.blur_on_outlined,
      ),
      _Metric(
        label: 'Stage Height',
        value: _stageHeight.toStringAsFixed(0),
        note: 'Stage display height.',
        icon: Icons.height_outlined,
      ),
      _Metric(
        label: 'Zone Style',
        value:
            'round=${_zoneRound.toStringAsFixed(1)} opacity=${_zoneOpacity.toStringAsFixed(2)}',
        note: 'Zone visual styling.',
        icon: Icons.style_outlined,
      ),
      _Metric(
        label: 'Trail Style',
        value:
            'width=${_trailWidth.toStringAsFixed(2)} fade=${_trailFade.toStringAsFixed(2)}',
        note: 'Trail drawing settings.',
        icon: Icons.gesture_outlined,
      ),
      _Metric(
        label: 'Switches',
        value:
            'theme=$_themeSwitches scenario=$_scenarioSwitches behavior=$_behaviorSwitches',
        note: 'Major switch counts.',
        icon: Icons.swap_horiz_outlined,
      ),
      _Metric(
        label: 'Controls',
        value: '$_controlEdits',
        note: 'Control edit count.',
        icon: Icons.tune_outlined,
      ),
      _Metric(
        label: 'Last Zone',
        value: _lastZone,
        note: 'Most recent event zone.',
        icon: Icons.place_outlined,
      ),
      _Metric(
        label: 'Last Type',
        value: _lastType,
        note: 'Most recent pointer type.',
        icon: Icons.fiber_manual_record_outlined,
      ),
      _Metric(
        label: 'Last Kind',
        value: _lastKind.name,
        note: 'Most recent device kind.',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            Text(
              'theme=${_themes[_themeIndex].id} scenario=${_snapshot.scenario} primary=${_snapshot.primaryBehavior} secondary=${_snapshot.secondaryBehavior}',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'tertiary=${_tertiaryBehavior.name} events=${_snapshot.events} phase=$_phase lastZone=$_lastZone lastType=$_lastType',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'stage=${_stageHeight.toStringAsFixed(0)} zoneRound=${_zoneRound.toStringAsFixed(1)} zoneOpacity=${_zoneOpacity.toStringAsFixed(2)} overlay=${_overlayAlpha.toStringAsFixed(2)}',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'trailWidth=${_trailWidth.toStringAsFixed(2)} trailFade=${_trailFade.toStringAsFixed(2)} heat=${_heatStrength.toStringAsFixed(2)} drift=${_drift.toStringAsFixed(2)} signalGain=${_signalGain.toStringAsFixed(2)}',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            Text(
              'flags animate=$_animate grid=$_showGrid trail=$_showTrail heat=$_showHeat labels=$_showLabels signals=$_showSignals',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
          ],
        ),
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                TextButton.icon(
                  onPressed: () =>
                      setState(() => _events = const <_EventRow>[]),
            ...
            const SizedBox(height: 8),
            Text(
              'Chronological list of captured pointer events and behavior metadata.',
              style: TextStyle(color: scheme.onSurfaceVariant),
            ),
            const SizedBox(height: 10),
            if (_events.isEmpty)
              Container(
                ...
                child: Text(
                  'Timeline is empty. Interact with the stage to collect event routes.',
                  style: TextStyle(color: scheme.onSurfaceVariant),
                ),
              )
            else
                ...
                children: _events.take(44).map((_EventRow e) {
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        '$stamp  local=(${e.local.dx.toStringAsFixed(1)}, ${e.local.dy.toStringAsFixed(1)}) kind=${e.kind.name}  ${e.note}',
                        style: TextStyle(
                          color: scheme.onSurfaceVariant,
                          fontSize: 12,
                        ),
