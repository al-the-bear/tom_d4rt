...
class _StarClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    final double outerR =
        (size.width < size.height ? size.width : size.height) / 2.0;
    final double innerR = outerR * 0.45;
    final int total = points * 2;
    for (int i = 0; i < total; i++) {
      final double r = (i % 2 == 0) ? outerR : innerR;
      final double angle =
          (i * 3.141592653589793) / points - 3.141592653589793 / 2.0;
...
class _HeartClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.cubicTo(-w * 0.2, h * 0.55, w * 0.15, -h * 0.1, w / 2.0, h * 0.25);
    path.cubicTo(w * 0.85, -h * 0.1, w * 1.2, h * 0.55, w / 2.0, h * 0.95);
    path.close();
    return path;
  }
      ...
      child: Column(
        ...
        children: <Widget>[
          const _SectionHeader(
            ...
            subtitle:
                'Parent → ClipLayer → child paint, gated by clipBehavior.',
            ...
            child: Column(
              children: const <Widget>[
                ...
                _AnatomyNode(
                  ...
                  detail:
                      'PaintingContext pushes a ClipLayer onto the layer tree',
                ...
                _AnatomyNode(
                  ...
                  detail:
                      'none → skip · hardEdge → clipRect · antiAlias → clipRect(AA)',
      ...
      child: Column(
        ...
        children: <Widget>[
          const _SectionHeader(
            ...
            subtitle:
                'Anything outside the box bounds is discarded before paint.',
      ...
      child: Column(
        ...
        children: <Widget>[
          const _SectionHeader(
            ...
            subtitle:
                'Borrow the curve table from ClipRect; anti-alias the corners.',
          ...
          Row(
            children: const <Widget>[
              ...
              _BehaviorCard(
                ...
                detail:
                    'extra offscreen buffer. Only when blending requires it.',
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: <Color>[Color(0xFF7C3AED), Color(0xFFE91E63)],
                ),
              ),
              alignment: Alignment.center,
              child: Text(
      ...
      child: Column(
        ...
        children: <Widget>[
          const _SectionHeader(
            ...
            subtitle:
                'Inscribed ellipse of the child\'s paintBounds; circle when square.',
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: <Color>[Color(0xFFE91E63), Color(0xFFFB923C)],
                ),
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: <Widget>[
          const _SectionHeader(
            ...
            subtitle:
                'You supply a CustomClipper<Path>; the engine pushes a ClipPathLayer.',
      ...
      child: Column(
        ...
        children: <Widget>[
          const _SectionHeader(
            ...
            subtitle:
                'Five properties × four modes; pick the cheapest that still looks right.',
            tagColor: _Palette.accentBlue,
      ...
      child: Column(
        ...
        children: <Widget>[
          const _SectionHeader(
            ...
            subtitle:
                'Most clips push a single ClipLayer. saveLayer adds an offscreen buffer.',
            tagColor: _Palette.accentViolet,
            icon: Icons.layers,
          ),
          const SizedBox(height: 18.0),
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                ...
                colors: <Color>[Color(0xFFEDE9FE), Color(0xFFFCE7F3)],
              ),
              borderRadius: BorderRadius.circular(14.0),
              border: Border.all(
...
class _LayerStackRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        Row(
          children: <Widget>[_LabelChip(label: title, color: color)],
        ),
        const SizedBox(height: 8.0),
                ...
                child: Column(
                  ...
                  children: const <Widget>[
                    _HitRow(
                      ...
                      detail:
                          'inside the ClipOval ellipse — child sees the tap.',
                    ),
                    ...
                    _HitRow(
                      ...
                      detail:
                          'inside the bounding rect, outside the oval — '
                    ...
                    _HitRow(
                      ...
                      color: _Palette.accentRed,
                      detail:
                          'completely outside the bounds — never reaches '
      ...
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(color: color.withValues(alpha: 0.35), blurRadius: 4.0),
            ],
          ),
        ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: <Color>[Color(0xFFFEF2F2), Color(0xFFFFFFFF)],
        ),
        borderRadius: BorderRadius.circular(12.0),
        border: Border.all(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                ...
                colors: <Color>[Color(0xFFEF4444), Color(0xFFE91E63)],
              ),
              borderRadius: BorderRadius.circular(10.0),
              boxShadow: <BoxShadow>[
                BoxShadow(
        ...
        children: <Widget>[
          ...
          const _CodeBlock(
            lines: <_CodeLine>[
              ...
              _CodeLine.blank(),
              _CodeLine.comment(
                '// rounded rectangle clip — default antiAlias',
              ),
              ...
              _CodeLine.blank(),
              _CodeLine.comment(
                '// arbitrary path — supply a CustomClipper<Path>',
              ),
