  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _vaAmber, height: 1.4),
        ),
      ),
    ],
  ),
        ...
        Align(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: fill ? BorderRadius.zero : BorderRadius.circular(4),
            ),
            child: Center(
              child: Text(
                label,
...
Widget _vaBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'How cells sit vertically inside table rows',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        _vaCellDisplay('top', Alignment.topCenter, _vaAmber, 35, 80),
        _vaCellDisplay('top', Alignment.topCenter, _vaAccent, 50, 80),
      ],
    ),
  ),
  _vaCode(
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        const SizedBox(height: 8),
        _vaCellDisplay('middle', Alignment.center, _vaBlue, 35, 80),
        _vaCellDisplay('middle', Alignment.center, _vaPurple, 50, 80),
      ],
    ),
  ),
  _vaCode(
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        const SizedBox(height: 8),
        _vaCellDisplay('bottom', Alignment.bottomCenter, _vaTeal, 35, 80),
        _vaCellDisplay('bottom', Alignment.bottomCenter, _vaGood, 50, 80),
      ],
    ),
  ),
  _vaCode(
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        const SizedBox(height: 6),
        _vaSmall('Red line = shared baseline. Texts align regardless of size.'),
      ],
    ),
  ),
  _vaCode(
  ...
  Container(
    ...
    child: Column(
      children: [
        ...
        Row(
          children: [
            for (final label in ['top', 'middle', 'bottom', 'fill', 'baseline'])
              Expanded(
                child: Center(
                  child: Text(
                    label,
        ...
        const SizedBox(height: 6),
        _vaSmall('Same 30px cell in an 80px row, positioned differently'),
      ],
    ),
  ),
  // Comparison table
...
List<Widget> _vaRenderTable() => [
  ...
  _vaBody('RenderTable reads the alignment in two phases during layout:'),
  ...
  _vaBody('Each cell is positioned based on its verticalAlignment:'),
  _vaCode(
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_vaAmber.withValues(alpha: 0.08), _vaLight],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
    ...
    child: Column(
      ...
      children: [
        ...
        _vaSumPt('fill', 'Content stretched to fill row height (relayout)'),
        _vaSumPt(
          'baseline',
          'Text baselines aligned across cells (needs textBaseline)',
        ),
        _vaSumPt('intrinsicHeight', 'Uses intrinsic height, positioned at top'),
        _vaSumPt(
          'Per-cell override',
