  ...
  child: Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          t,
          style: const TextStyle(fontSize: 12.5, color: _pcOrange, height: 1.4),
        ),
      ),
    ],
  ),
...
Widget _pcChildWithOffset(
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(8),
      border: Border.all(color: active ? c : _pcMuted, width: active ? 1.5 : 1),
    ),
    child: Row(
      children: [
        Expanded(
...
Widget _pcBanner() => Container(
  ...
  child: Column(
    children: [
      ...
      Text(
        'Physical offsets + linked-list container for sliver children',
        textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 13,
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _pcHierLevel(2, 'SliverPhysicalParentData', '+ Offset paintOffset'),
        _pcHierLevel(
          3,
          'SliverPhysicalContainerParentData',
    ...
    child: Row(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: depth == 3 ? _pcOrange : _pcAccent.withValues(alpha: 0.6),
            shape: BoxShape.circle,
          ),
        ),
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  fontSize: 12,
                  fontWeight: depth == 3 ? FontWeight.w800 : FontWeight.w600,
                  fontFamily: 'monospace',
  ...
  Container(
    ...
    child: Column(
      ...
      children: [
        ...
        _pcLinkArrow(),
        _pcChildWithOffset('Child B', 'paintOffset: (0, 48)', _pcAccent),
        _pcLinkArrow(),
        _pcChildWithOffset(
          'Child C (lastChild)',
          'paintOffset: (0, 96)',
  ...
  Container(
    ...
    child: Column(
      children: [
        _pcFlowStep(
          '1',
          'SliverToBoxAdapter.performLayout()',
        ...
        _pcFlowStep(
          '3',
          'paint() → paintChild(child, offset + pd.paintOffset)',
  ...
  Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_pcOrange.withValues(alpha: 0.08), _pcPeach],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      borderRadius: BorderRadius.circular(12),
