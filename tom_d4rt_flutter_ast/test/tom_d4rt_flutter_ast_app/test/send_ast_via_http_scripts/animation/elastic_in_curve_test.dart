...
dynamic build(BuildContext context) {
  ...
  print(
    '│ Understanding elastic spring animation curves                     │',
  );
  print(
    '└────────────────────────────────────────────────────────────────────┘',
  );
  ...
  print(
    '│ Understanding overshoot behavior                                  │',
  );
  print(
    '└────────────────────────────────────────────────────────────────────┘',
  );
  ...
  print(
    '│ SECTION 5: ELASTIC CURVE FAMILY COMPARISON                        │',
  );
  print(
  ...
  print(
    '│ Analysis of curve characteristics                                 │',
  );
  print(
    '└────────────────────────────────────────────────────────────────────┘',
  );
  ...
  for (final t in [0.1, 0.25, 0.5, 0.75, 0.9]) {
    ...
    if (velocity < -0.5) {
      ...
      interpretation = 'Moderate forward';
    else
      interpretation = 'Rapid acceleration';

    derivativeResults.add({
      't': t,
      'velocity': velocity,
      'interpretation': interpretation,
    });
    print(
      '│  ${t.toStringAsFixed(2)}   │  ${velocity.toStringAsFixed(8).padLeft(12)}   │ ${interpretation.padRight(39)} │',
    );
  }
  print(
    '└─────────┴─────────────────┴─────────────────────────────────────────┘',
  ...
  print(
    '│ Practical applications of ElasticInCurve                          │',
  );
  print(
    '└────────────────────────────────────────────────────────────────────┘',
  );
  ...
  for (final t in [0.0, 0.25, 0.5, 0.75, 1.0]) {
    ...
    print(
      '  t=${t.toStringAsFixed(2)}: raw=${rawOpacity.toStringAsFixed(4)} → clamped=${clampedOpacity.toStringAsFixed(4)}',
    );
  }
  print('');
  ...
  print(
    '  transform(0.0) = ${defaultCurve.transform(0.0).toStringAsFixed(12)}',
  );
  print(
    '  transform(1.0) = ${defaultCurve.transform(1.0).toStringAsFixed(12)}',
  );
  print('');
  ...
  for (final t in [0.001, 0.01, 0.99, 0.999]) {
    print(
      '  transform(${t.toString().padRight(5)}) = ${defaultCurve.transform(t).toStringAsFixed(8)}',
    );
  }
  print('');
  ...
  print(
    '  period=0.05 at t=0.5: ${veryTight.transform(0.5).toStringAsFixed(6)}',
  );
  print(
    '  period=2.0 at t=0.5:  ${veryWide.transform(0.5).toStringAsFixed(6)}',
  );
  print('');
  ...
  print(
    '│ Continuity and smoothness verification                            │',
  );
  print(
    '└────────────────────────────────────────────────────────────────────┘',
  );
  ...
  print(
    '  ${maxJump < 0.1 ? "✓ Curve is continuous (no jumps)" : "⚠ Large jumps detected"}',
  );
  print('');
  ...
  for (final t in [0.1, 0.5, 0.9]) {
    ...
    print(
      '  t=${t.toStringAsFixed(1)}: acceleration ≈ ${acceleration.toStringAsFixed(4)}',
    );
  }
  print('');
  ...
  print(
    '│ Comparing with the predefined constant                            │',
  );
  print(
    '└────────────────────────────────────────────────────────────────────┘',
  );
  ...
  print(
    '│    t    │   ElasticInCurve()  │   Curves.elasticIn  │   Difference   │',
  );
  print(
    '├─────────┼─────────────────────┼─────────────────────┼────────────────┤',
  );
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildKeyPoint(
                  'Negative values',
                  'Curve can return values < 0',
                ),
                _buildKeyPoint(
                  'Period control',
                  'Smaller = faster oscillations',
                ),
                _buildKeyPoint(
                  'Start effect',
                  'Pull-back at animation beginning',
                ),
                _buildKeyPoint(
                  'Clamping',
                  'Required for 0-1 bounded properties',
                ),
              ],
            ),
          ),
