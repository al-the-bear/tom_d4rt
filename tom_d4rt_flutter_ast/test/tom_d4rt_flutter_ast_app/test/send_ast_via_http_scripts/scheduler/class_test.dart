...
dynamic build(BuildContext context) {
  ...
  final skTitleSection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 8.0),
        Text(
          'Frame scheduling, callback phases, and timing in the Flutter engine',
      ...
      children: keyMethods.map((km) {
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(6.0),
            border: Border(
              left: BorderSide(color: km['color'] as Color, width: 3.0),
            ),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
  ...
  final timingPhases = <Map<String, dynamic>>[
    {
      'phase': 'vsyncStart',
      'desc': 'When vsync signal arrived',
      'color': Color(0xFF78909C),
    },
    {
      'phase': 'buildStart',
      'desc': 'When build phase began',
      'color': Color(0xFF607D8B),
    },
    {
      'phase': 'buildFinish',
      'desc': 'When build phase ended',
      'color': Color(0xFF546E7A),
    },
    {
      'phase': 'rasterStart',
      'desc': 'When rasterization started on GPU',
      'color': Color(0xFF455A64),
    },
    {
      'phase': 'rasterFinish',
      'desc': 'When rasterization completed',
      'color': Color(0xFF37474F),
    },
  ];
  ...
  final skTimingSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Detailed timing breakdown for each rendered frame',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFF263238),
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                child: Text(
                  'vsync',
                  style: TextStyle(fontSize: 7.0, color: Color(0xFF546E7A)),
                ),
              ),
              // build start
              Positioned(
  ...
  final appStates = <Map<String, dynamic>>[
    {
      ...
      'desc': 'App visible, responding to input',
    },
    {
      'state': AppLifecycleState.inactive,
      'icon': Icons.pause_circle_outline,
      'color': Color(0xFFFFA726),
      'desc': 'App visible but not receiving input',
    },
    {
      'state': AppLifecycleState.paused,
      'icon': Icons.stop_circle_outlined,
      'color': Color(0xFFEF5350),
      'desc': 'App not visible, may be suspended',
    },
    {
      'state': AppLifecycleState.detached,
      'icon': Icons.close,
      'color': Color(0xFF78909C),
      'desc': 'Still hosted but detached from views',
    },
    {
      'state': AppLifecycleState.hidden,
      'icon': Icons.visibility_off,
      'color': Color(0xFF455A64),
      'desc': 'All views hidden',
    },
  ];
  ...
  final skLifecycleStateSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Scheduler adjusts frame scheduling based on app lifecycle',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFF263238),
        ...
        ...appStates.map((appS) {
          ...
          return Container(
            ...
            child: Row(
              children: [
                Icon(
                  appS['icon'] as IconData,
                  color: appS['color'] as Color,
                  size: 20.0,
                ),
                SizedBox(width: 8.0),
                SizedBox(
  ...
  print(
    '  scheduleFrame() → engine callback → handleBeginFrame → handleDrawFrame',
  );

  final flowSteps = <Map<String, dynamic>>[
    {
      'step': 'scheduleFrame()',
      'desc': 'Request engine schedule a vsync',
      'color': Color(0xFF78909C),
    },
    {
      'step': 'handleBeginFrame()',
      'desc': 'Process transient callbacks + microtasks',
      'color': Color(0xFF607D8B),
    },
    {
      'step': 'handleDrawFrame()',
      'desc': 'Process persistent + post-frame callbacks',
      'color': Color(0xFF455A64),
    },
    {
      'step': 'Frame complete',
      'desc': 'Return to idle, display rendered frame',
      'color': Color(0xFF37474F),
    },
  ];
  ...
  final typedefs = <Map<String, dynamic>>[
    {
      'name': 'FrameCallback',
      'sig': 'void Function(Duration timeStamp)',
      'color': Color(0xFF607D8B),
      'desc': 'Callback for transient and persistent frames',
    },
    {
      'name': 'TimingsCallback',
      'sig': 'void Function(List<FrameTiming> timings)',
      'color': Color(0xFF455A64),
      'desc': 'Callback for performance timing data',
    },
    {
      'name': 'VoidCallback',
      'sig': 'void Function()',
      'color': Color(0xFF37474F),
      'desc': 'Post-frame callback (no arguments)',
    },
  ];
            ...
            children: [
              Row(
                children: [
                  ...
                  skChip(
                    'typedef',
                    (td['color'] as Color).withValues(alpha: 0.7),
                  ),
                ],
              ),
              Text(
  ...
  final totalMs = budgetItems.fold<double>(
    0.0,
    (s, b) => s + (b['ms'] as double),
  );
  ...
  final skBudgetSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          '16.67ms total budget per frame at 60fps',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFF263238),
            ...
            children: budgetItems.map((bi) {
              return Expanded(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      '${(bi['ms'] as double).toStringAsFixed(0)}ms',
                      style: TextStyle(
                        fontSize: 8.0,
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
        ...
        skInfoRow(
          'Total shown:',
          '${totalMs.toStringAsFixed(0)}ms / 16.67ms budget',
        ),
      ],
    ),
  );
  ...
  final skMicrotaskSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Microtasks run between transient and persistent callbacks',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFF263238),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.0),
                    Text(
                      'Dart microtasks queued during transient callbacks execute here',
                      style: TextStyle(
                        fontSize: 10.0,
                        color: Color(0xFF546E7A),
                      ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.0),
                    Text(
                      'Heavy microtask work can delay persistent callbacks and cause jank',
                      style: TextStyle(
                        fontSize: 10.0,
                        color: Color(0xFF546E7A),
                      ),
  ...
  final skPrioritySection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'scheduleTask() runs work between frames based on priority',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFF263238),
