...
dynamic build(BuildContext context) {
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            'Settings',
            style: TextStyle(color: cSecondary, fontWeight: FontWeight.w600),
          ),
        ],
      ),
    ),
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                'Brightness',
                style: TextStyle(color: Colors.grey.shade800, fontSize: 13.0),
              ),
              Spacer(),
              Text(
                '75%',
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: [
          Text(
            'مرحبا بك في التطبيق',
            style: TextStyle(fontSize: 14.0, color: cMuted),
          ),
          SizedBox(width: 8.0),
    ...
    return Container(
      ...
      child: Row(
        children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: (isActive ? cSuccess : cMuted).withValues(
                            alpha: 0.12,
                          ),
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize: 8.0,
                            fontWeight: FontWeight.bold,
                            color: isActive ? cSuccess : cMuted,
                          ),
                        ),
                      ),
                    ],
          ...
          // Live example
          Container(margin: EdgeInsets.only(right: 12.0), child: example),
        ],
      ),
    );
  }
  ...
  final scene2 = Column(
    ...
    children: [
      ...
      traitTile(
        ...
        color: cSecondary,
        whenTrue:
            'Announced as "link". Screen readers group links for quick nav.',
      ...
      traitTile(
        ...
        color: Colors.brown,
        whenTrue:
            'Announced as "heading". VoiceOver rotor lists it for quick jump.',
      ...
      traitTile(
        ...
        color: cError,
        whenTrue:
            'Auto-announced on change. For toasts, progress, notifications.',
  ...
  print(
    '  Non-container: labels merge into parent → "Favorite star icon, Star, Favorite, (12)"',
  );
    ...
    child: Column(
      ...
      children: [
        Semantics(
          ...
          child: Padding(
            padding: EdgeInsets.all(4.0),
            child: Text('🍎 Apple', style: TextStyle(fontSize: 12.0)),
          ),
        ),
        Semantics(
          label: 'Banana',
          child: Padding(
            padding: EdgeInsets.all(4.0),
            child: Text('🍌 Banana', style: TextStyle(fontSize: 12.0)),
          ),
        ),
        Semantics(
          label: 'Cherry',
          child: Padding(
            padding: EdgeInsets.all(4.0),
            child: Text('🍒 Cherry', style: TextStyle(fontSize: 12.0)),
          ),
        ),
      ],
    ),
  ...
  final unmergedExample = Container(
    ...
    child: Row(
      children: [
        Semantics(
          label: 'Wi-Fi icon',
          child: Icon(Icons.wifi, color: cMuted, size: 24.0),
        ),
        SizedBox(width: 10.0),
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Semantics(
                label: 'Connected to HomeNetwork',
                child: Text(
                  'Connected to HomeNetwork',
        ...
        Semantics(
          label: 'Navigate to Wi-Fi settings',
  ...
  final actionWidget = Semantics(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            cSecondary.withValues(alpha: 0.12),
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            height: 30.0,
            decoration: BoxDecoration(
              color: cAccent.withValues(alpha: 0.2),
              borderRadius: BorderRadius.circular(4.0),
  ...
  print(
    '  Created focused action examples: tap-only, adjustable, scrollable, dismissible',
  );
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Only onTap registered. Double-tap is the single interaction.',
                    style: TextStyle(
                      fontSize: 9.5,
                      color: Colors.grey.shade600,
                    ),
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.0),
            Text(
              'Adjustable Control (slider: true + onIncrease/onDecrease)',
              style: TextStyle(
                fontSize: 10.0,
                fontWeight: FontWeight.bold,
                color: cSuccess,
            ...
            Text(
              'Swipe up increases, swipe down decreases. value/increasedValue/decreasedValue announce the change.',
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.0),
            Text(
              'Scrollable Region (onScrollLeft/onScrollRight)',
              style: TextStyle(
                fontSize: 10.0,
                fontWeight: FontWeight.bold,
                color: cAccent,
            ...
            Text(
              'Three-finger swipe gestures navigate through carousel content.',
              style: TextStyle(fontSize: 9.5, color: Colors.grey.shade600),
            ),
          ],
        ),
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Z-gesture on iOS or swipe-dismiss on Android removes the notification.',
              style: TextStyle(fontSize: 9.5, color: Colors.grey.shade600),
            ),
          ],
        ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 8.0),
              Text(
                'Auto-announced by TalkBack on value change',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Email',
                      style: TextStyle(fontSize: 10.0, color: cSuccess),
                    ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Password',
                      style: TextStyle(fontSize: 10.0, color: cError),
                    ),
                ...
                Wrap(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        'Archive',
                        style: TextStyle(fontSize: 8.0, color: cSecondary),
                      ),
                    ),
                    Container(
                      padding: EdgeInsets.symmetric(
                    ...
                    Container(
                      ...
                      child: Text(
                        'Star',
                        style: TextStyle(fontSize: 8.0, color: cWarning),
                      ),
                    ),
                  ],
                ),
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Clear Browsing Data',
                    style: TextStyle(fontSize: 13.0, color: cError),
                  ),
                ),
                Icon(
                  Icons.chevron_right,
  ...
  print(
    'Scene 6: Real-World Patterns — 6 complete accessibility implementations',
  );
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    cPrimary.withValues(alpha: 0.12),
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text(
                    'End of Semantics Widget Deep Demo',
                    style: TextStyle(
                      fontSize: 12.0,
                      fontWeight: FontWeight.bold,
                      color: cPrimary,
