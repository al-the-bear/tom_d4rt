    ...
    child: Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(
            value,
            style: TextStyle(fontSize: 12.0, color: Color(0xFF8D6E63)),
          ),
        ),
      ],
    ),
...
dynamic build(BuildContext context) {
  ...
  final cbTitleSection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 8.0),
        Text(
          'Builder for partitioning child semantics configurations into merged/siblingMergeUp groups',
  ...
  final cbPurposeSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'During semantics assembly, child configurations must be sorted:',
          style: TextStyle(
            fontSize: 12.0,
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 4.0),
                    Text(
                      'Configs folded into the parent semantics node',
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8.0),
                  border: Border.all(
                    color: Color(0xFFBF360C).withValues(alpha: 0.3),
                  ),
                ),
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 4.0),
                    Text(
                      'Configs that become separate sibling nodes',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 10.0,
                        color: Color(0xFF8D6E63),
  ...
  final apiMethods = <Map<String, dynamic>>[
    {
      'method': 'markAsSiblingMergeUp()',
      'color': Color(0xFFF4511E),
      'sig': 'void markAsSiblingMergeUp(SemanticsConfiguration config)',
      'desc':
          'Marks a child configuration to be merged as a sibling node rather than into the parent',
    },
    {
      'method': 'build()',
      ...
      'desc':
          'Produces the partitioned result with mergeUp and siblingMergeUp lists',
    },
  ];
      ...
      children: apiMethods.map((am) {
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(8.0),
            border: Border(
              left: BorderSide(color: am['color'] as Color, width: 4.0),
            ),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
  ...
  final cbResultSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'The output of the builder — two lists of configurations',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFFBF360C),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Configs that fold into the parent SemanticsNode',
                          style: TextStyle(
                            fontSize: 10.0,
                            color: Color(0xFF8D6E63),
                          ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Configs that become separate sibling SemanticsNodes',
                          style: TextStyle(
                            fontSize: 10.0,
                            color: Color(0xFF8D6E63),
                          ),
  ...
  final cbUsageSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'The builder is typically used inside childSemanticsConfigurationsDelegate',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFFBF360C),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Framework collects child SemanticsConfigurations',
                      style: TextStyle(
                        fontSize: 10.0,
                        color: Color(0xFF8D6E63),
                      ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Delegate receives list and builder instance',
                      style: TextStyle(
                        fontSize: 10.0,
                        color: Color(0xFF8D6E63),
                      ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Delegate marks configs as siblingMergeUp or leaves for merge',
                      style: TextStyle(
                        fontSize: 10.0,
                        color: Color(0xFF8D6E63),
                      ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Builder.build() returns partitioned result',
                      style: TextStyle(
                        fontSize: 10.0,
                        color: Color(0xFF8D6E63),
                      ),
  ...
  final semanticsProps = <Map<String, dynamic>>[
    {
      'prop': 'isSemanticBoundary',
      'desc': 'Creates a new SemanticsNode',
      'color': Color(0xFFF4511E),
    },
    {
      'prop': 'hasBeenAnnotated',
      'desc': 'Whether properties have been set',
      'color': Color(0xFFE64A19),
    },
    {
      'prop': 'isBlockingSemanticsOfPreviouslyPaintedNodes',
      'desc': 'Blocks earlier siblings',
      'color': Color(0xFFD84315),
    },
    {
      'prop': 'isMergingSemanticsOfDescendants',
      'desc': 'Merges all descendant info',
      'color': Color(0xFFBF360C),
    },
    {
      'prop': 'label / value / hint',
      'desc': 'Accessibility text properties',
      'color': Color(0xFFE65100),
    },
    {
      'prop': 'textDirection',
      'desc': 'Direction for accessibility text',
      'color': Color(0xFFF4511E),
    },
  ];
  ...
  final cbSemConfigSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'The configuration object the builder partitions',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFFBF360C),
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                top: 120.0,
                child: Text(
                  'Result: Parent merges A+B, C becomes sibling',
                  style: TextStyle(
                    fontSize: 10.0,
                    fontWeight: FontWeight.w600,
                    color: Color(0xFF8D6E63),
  ...
  final builderSteps = <Map<String, dynamic>>[
    {
      'step': 'Create',
      'desc': 'Framework creates builder with child config list',
      'color': Color(0xFFF4511E),
      'icon': Icons.add_circle_outline,
    },
    {
      'step': 'Iterate',
      'desc': 'Delegate iterates over child configurations',
      'color': Color(0xFFE64A19),
      'icon': Icons.loop,
    },
    {
      'step': 'Mark',
      'desc': 'Call markAsSiblingMergeUp for configs that should separate',
      'color': Color(0xFFD84315),
      'icon': Icons.bookmark_border,
    },
    {
      'step': 'Build',
      'desc': 'Call build() to get the partitioned result',
      'color': Color(0xFFBF360C),
      'icon': Icons.build,
    },
  ];
  ...
  final cbSemanticsSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'The Semantics widget provides high-level access to configuration',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFFBF360C),
  ...
  final cbNodeTreeSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'The semantics tree parallels the render tree for accessibility',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFFBF360C),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              cbInfoRow(
                'Children:',
                'childrenInTraversalOrder / childrenInInverseHitTestOrder',
              ),
              cbInfoRow('Actions:', 'tap, longPress, scrollLeft, etc.'),
              cbInfoRow(
                'Flags:',
                'hasCheckedState, isSelected, isFocused, etc.',
              ),
            ],
          ),
        ),
  ...
  final cbActionsSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Actions available through the semantics tree',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFFBF360C),
  ...
  final cbMergeSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'MergeSemantics combines descendants into one node',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFFBF360C),
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(6.0),
                  border: Border.all(
                    color: Color(0xFFF4511E).withValues(alpha: 0.3),
                  ),
                ),
                child: Column(
                  children: [
                    ...
                    Text(
                      '(2 separate nodes)',
                      style: TextStyle(fontSize: 8.0, color: Color(0xFF8D6E63)),
                    ),
                  ],
                ),
              ),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 4.0),
                    Text(
                      'Removes subtree from semantics',
                      textAlign: TextAlign.center,
  ...
  final flags = <Map<String, dynamic>>[
    {
      'flag': 'isButton',
      'desc': 'Element is a button',
      'color': Color(0xFFF4511E),
    },
    {'flag': 'isLink', 'desc': 'Element is a link', 'color': Color(0xFFE64A19)},
    {
      'flag': 'isTextField',
      'desc': 'Element is a text field',
      'color': Color(0xFFD84315),
    },
    {
      'flag': 'isSlider',
      'desc': 'Element is a slider',
      'color': Color(0xFFBF360C),
    },
    {
      'flag': 'isHeader',
      'desc': 'Element is a heading',
      'color': Color(0xFFE65100),
    },
    {
      'flag': 'isReadOnly',
      'desc': 'Element is read-only',
      'color': Color(0xFFF4511E),
    },
    {
      'flag': 'isFocusable',
      'desc': 'Element can receive focus',
      'color': Color(0xFFE64A19),
    },
    {
      'flag': 'isToggled',
      'desc': 'Element is toggled on',
      'color': Color(0xFFD84315),
    },
  ];
          ...
          children: flags.map((f) {
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(
                  left: BorderSide(color: f['color'] as Color, width: 3.0),
                ),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  final cbTestingSection = Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Flutter provides tools to verify semantics in widget tests',
          style: TextStyle(
            fontSize: 12.0,
            fontStyle: FontStyle.italic,
            color: Color(0xFFBF360C),
          ...
          children: [
            Column(
              children: [
                ...
                Text(
                  'Merge Up',
                  style: TextStyle(fontSize: 11.0, color: Color(0xFFFFCCBC)),
                ),
              ],
            ),
            Column(
