...
dynamic build(BuildContext context) {
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    'Current: ${dpr.toStringAsFixed(2)}x',
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14.0,
                      color: Color(0xFF455A64),
  ...
  print(
    'Physical: ${physSize.width.toStringAsFixed(0)} x ${physSize.height.toStringAsFixed(0)}',
  );
  print(
    'Logical: ${logicalWidth.toStringAsFixed(0)} x ${logicalHeight.toStringAsFixed(0)}',
  );
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      '${physSize.width.toStringAsFixed(0)} x ${physSize.height.toStringAsFixed(0)}',
  ...
  print(
    'viewInsets: L=${insets.left} T=${insets.top} R=${insets.right} B=${insets.bottom}',
  );
  ...
  Widget swInsetsSection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Areas obscured by system UI like the on-screen keyboard. Values are in physical pixels.',
        ...
        SizedBox(height: 6.0),
        Text(
          'Bottom inset > 0 typically means the keyboard is open.',
          style: TextStyle(
            fontSize: 10.5,
  ...
  print(
    'padding: L=${vPadding.left} T=${vPadding.top} R=${vPadding.right} B=${vPadding.bottom}',
  );
  final viewPadding = view.viewPadding;
  print(
    'viewPadding: L=${viewPadding.left} T=${viewPadding.top} R=${viewPadding.right} B=${viewPadding.bottom}',
  );
  ...
  Widget swPaddingSection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Areas partially obscured by system UI (notch, status bar, home indicator).',
          style: TextStyle(fontSize: 11.5, color: Colors.grey.shade700),
        ),
        SizedBox(height: 10.0),
        Row(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Shrinks when keyboard opens',
                    style: TextStyle(fontSize: 10.0, color: Colors.grey),
                  ),
                  SizedBox(height: 4.0),
                  Text(
                    'T: ${vPadding.top.toStringAsFixed(0)}',
                    style: TextStyle(fontFamily: 'monospace', fontSize: 11.0),
                  ),
                  Text(
                    'B: ${vPadding.bottom.toStringAsFixed(0)}',
                    style: TextStyle(fontFamily: 'monospace', fontSize: 11.0),
                  ),
                ],
              ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.0),
                    Text(
                      'T: ${viewPadding.top.toStringAsFixed(0)}',
                      style: TextStyle(fontFamily: 'monospace', fontSize: 11.0),
                    ),
                    Text(
                      'B: ${viewPadding.bottom.toStringAsFixed(0)}',
                      style: TextStyle(fontFamily: 'monospace', fontSize: 11.0),
                    ),
                  ],
                ),
  ...
  print(
    'systemGestureInsets: L=${sysGesture.left} T=${sysGesture.top} R=${sysGesture.right} B=${sysGesture.bottom}',
  );
  ...
  Widget swGestureSection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Edges where system gestures take priority over app gestures (back swipe, home gesture).',
          style: TextStyle(fontSize: 11.5, color: Colors.grey.shade700),
        ),
        SizedBox(height: 10.0),
        ...
        SizedBox(height: 6.0),
        Text(
          'On Android gesture navigation, left/right can be 0-44px for back-swipe.',
          style: TextStyle(
            fontSize: 10.5,
            fontStyle: FontStyle.italic,
            color: Colors.grey.shade600,
  ...
  Widget swDisplayFeatures = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Physical display features like folds, hinges, and cutouts on foldable or multi-screen devices.',
          style: TextStyle(fontSize: 11.5, color: Colors.grey.shade700),
        ),
        SizedBox(height: 10.0),
        Container(
          ...
          child: Row(
            children: [
              Icon(
                features.isEmpty ? Icons.check_circle : Icons.info,
                color: features.isEmpty ? Colors.green : Colors.purple,
                size: 18.0,
              ),
              SizedBox(width: 8.0),
              Text(
                features.isEmpty
                    ? 'No display features (standard flat screen)'
                    : '${features.length} feature(s) detected',
        ...
        SizedBox(height: 8.0),
        Text(
          'Types: DisplayFeatureType.fold, .hinge, .cutout',
          style: TextStyle(
            fontSize: 11.0,
            fontFamily: 'monospace',
        ...
        Text(
          'States: DisplayFeatureState.unknown, .postureFlat, .postureHalfOpened',
          style: TextStyle(
            fontSize: 11.0,
            fontFamily: 'monospace',
            color: Colors.purple.shade600,
  ...
  Widget swDispatcherSection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Central dispatch point for platform events to the engine. Replaces the locale/brightness/etc. accessors that used to be on window.',
          style: TextStyle(fontSize: 11.5, color: Colors.grey.shade700),
        ),
        SizedBox(height: 10.0),
        swViewInfo(
          'runtimeType',
          '${dispatcher.runtimeType}',
          Icons.code,
          Colors.deepPurple,
        ),
        swViewInfo(
        ...
        swViewInfo(
          'brieflyShowPassword',
          '${dispatcher.brieflyShowPassword}',
          Icons.visibility,
          Colors.deepPurple,
        ),
      ],
    ...
    child: Column(
      ...
      children: [
        ...
        if (implicitView != null) ...[
          ...
          swViewInfo(
            'same as View.of()',
            '${view.viewId == implicitView.viewId}',
            Icons.compare,
            Colors.indigo,
          ),
        ] else
  ...
  Widget swGestureSettingsSection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'Platform-specific touch slop values that determine gesture recognition thresholds.',
          style: TextStyle(fontSize: 11.5, color: Colors.grey.shade700),
        ),
        SizedBox(height: 10.0),
        swViewInfo(
        ...
        swViewInfo(
          ...
          '${gestureSettings.physicalDoubleTapSlop ?? "null"}',
          Icons.double_arrow,
          Colors.pink,
        ),
        SizedBox(height: 6.0),
        Text(
          'Touch slop: minimum pixels a finger must move before a drag is recognized.',
          style: TextStyle(
            fontSize: 10.5,
            fontStyle: FontStyle.italic,
            color: Colors.grey.shade600,
  ...
  Widget swMediaQuerySection = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4.0),
        Text(
          'MediaQuery provides logical units (already divided by DPR). View returns physical pixels.',
          style: TextStyle(fontSize: 11.5, color: Colors.grey.shade700),
        ),
        SizedBox(height: 10.0),
        Container(
        ...
        swMediaQueryRow(
          'width',
          '${physSize.width.toStringAsFixed(0)} px',
          '${mediaQuery.size.width.toStringAsFixed(0)} dp',
          Colors.lightGreen,
        ),
        swMediaQueryRow(
          'height',
          '${physSize.height.toStringAsFixed(0)} px',
          '${mediaQuery.size.height.toStringAsFixed(0)} dp',
          Colors.lightGreen,
        ),
        swMediaQueryRow(
          'top pad',
          '${vPadding.top.toStringAsFixed(0)} px',
          '${mediaQuery.padding.top.toStringAsFixed(0)} dp',
          Colors.lightGreen,
        ),
        swMediaQueryRow(
          'bottom pad',
          '${vPadding.bottom.toStringAsFixed(0)} px',
          '${mediaQuery.padding.bottom.toStringAsFixed(0)} dp',
          Colors.lightGreen,
        ),
      ],
    ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 4.0),
            Text(
              'Replace deprecated window API with modern alternatives:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...swMigrations,
            ...
            SizedBox(height: 4.0),
            Text(
              'How the window types relate in the Flutter engine:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  swHierarchyLevel(
                    'SingletonFlutterWindow',
                    'deprecated single-window accessor',
                    1,
                    Colors.grey,
                    true,
                  ),
            ...
            Wrap(
              children: [
                swSummaryTile(
                  'DPR',
                  '${dpr.toStringAsFixed(1)}x',
                  Color(0xFFECEFF1),
                  Color(0xFF455A64),
                ),
                swSummaryTile(
                  'Width',
                  '${logicalWidth.toStringAsFixed(0)}dp',
                  Color(0xFFE3F2FD),
                  Colors.blue.shade700,
                ),
                swSummaryTile(
                  'Height',
                  '${logicalHeight.toStringAsFixed(0)}dp',
                  Color(0xFFF3E5F5),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8.0),
        border: Border.all(
          color: isActive ? Color(0xFF455A64) : Color(0xFFB0BEC5),
