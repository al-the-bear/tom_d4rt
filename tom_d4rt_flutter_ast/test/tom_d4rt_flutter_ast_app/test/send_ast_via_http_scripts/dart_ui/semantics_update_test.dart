...
dynamic build(BuildContext context) {
  ...
  final suPipelineStages = <Widget>[
    suPipelineCard(
      'Semantics Widget',
      'Annotates the widget tree with accessibility labels, actions, and flags',
      Icons.widgets,
      Colors.deepOrange.shade700,
    ),
    suPipelineCard(
      'SemanticsNode Tree',
      'Framework assembles a parallel tree of semantics nodes from annotations',
      Icons.account_tree,
      Colors.deepOrange.shade600,
    ),
    suPipelineCard(
      'SemanticsUpdateBuilder',
      'Serializes changed nodes into a compact update using updateNode()',
      Icons.build_circle,
      Colors.deepOrange.shade500,
    ),
    suPipelineCard(
      'SemanticsUpdate',
      'Immutable payload object produced by builder.build()',
      Icons.send,
      Colors.deepOrange.shade400,
    ),
    suPipelineCard(
      'Platform Engine',
      'Receives the update and notifies the operating system accessibility API',
      Icons.phone_android,
  ...
  final suActionList = <Map<String, dynamic>>[
    {
      ...
      'name': 'tap',
      'desc': 'Activates the element (click/press)',
      'icon': Icons.touch_app,
    },
    {
      'action': SemanticsAction.longPress,
      'name': 'longPress',
      'desc': 'Triggers on extended press',
      'icon': Icons.pan_tool,
    },
    {
      'action': SemanticsAction.scrollLeft,
      'name': 'scrollLeft',
      'desc': 'Scrolls content leftward',
      'icon': Icons.arrow_back,
    },
    {
      'action': SemanticsAction.scrollRight,
      'name': 'scrollRight',
      'desc': 'Scrolls content rightward',
      'icon': Icons.arrow_forward,
    },
    {
      'action': SemanticsAction.scrollUp,
      'name': 'scrollUp',
      'desc': 'Scrolls content upward',
      'icon': Icons.arrow_upward,
    },
    {
      'action': SemanticsAction.scrollDown,
      'name': 'scrollDown',
      'desc': 'Scrolls content downward',
      'icon': Icons.arrow_downward,
    },
    {
      'action': SemanticsAction.increase,
      'name': 'increase',
      'desc': 'Increments a value (slider, stepper)',
      'icon': Icons.add_circle_outline,
    },
    {
      'action': SemanticsAction.decrease,
      'name': 'decrease',
      'desc': 'Decrements a value',
      'icon': Icons.remove_circle_outline,
    },
    {
      'action': SemanticsAction.copy,
      'name': 'copy',
      'desc': 'Copies text to clipboard',
      'icon': Icons.copy,
    },
    {
      'action': SemanticsAction.cut,
      'name': 'cut',
      'desc': 'Cuts text to clipboard',
      'icon': Icons.content_cut,
    },
    {
      'action': SemanticsAction.paste,
      'name': 'paste',
      'desc': 'Pastes from clipboard',
      'icon': Icons.paste,
    },
    {
      'action': SemanticsAction.dismiss,
      'name': 'dismiss',
      'desc': 'Closes or dismisses element',
      'icon': Icons.close,
    },
  ];
  ...
  final suFlagData = <Map<String, dynamic>>[
    {
      ...
      'desc': 'Element has a checked/unchecked state (checkbox)',
      'color': Colors.teal,
    },
    {
      'name': 'isChecked',
      'desc': 'Element is currently checked',
      'color': Colors.green,
    },
    {
      'name': 'isSelected',
      'desc': 'Element is the current selection in a group',
      'color': Colors.blue,
    },
    {
      'name': 'isButton',
      'desc': 'Element is a pressable button',
      'color': Colors.indigo,
    },
    {
      'name': 'isLink',
      'desc': 'Element is a navigational hyperlink',
      'color': Colors.purple,
    },
    {
      'name': 'isTextField',
      'desc': 'Element accepts text input',
      'color': Colors.orange,
    },
    {
      'name': 'isSlider',
      'desc': 'Element is a slider control',
      'color': Colors.red,
    },
    {
      'name': 'isReadOnly',
      'desc': 'Text field is not editable',
      'color': Colors.brown,
    },
    {
      'name': 'isFocusable',
      'desc': 'Element can receive keyboard focus',
      'color': Colors.cyan,
    },
    {
      'name': 'isFocused',
      'desc': 'Element currently holds focus',
      'color': Colors.lime,
    },
    {
      'name': 'isHeader',
      'desc': 'Element is a heading for a section',
      'color': Colors.amber,
    },
    {
      'name': 'isImage',
      'desc': 'Element represents an image',
      'color': Colors.pink,
    },
    {
      'name': 'isHidden',
      'desc': 'Element is present but invisible to accessibility',
      'color': Colors.grey,
    },
    {
      'name': 'isObscured',
      'desc': 'Text content is obscured (password)',
      'color': Colors.blueGrey,
    },
    {
      'name': 'hasImplicitScrolling',
      'desc': 'Element scrolls implicitly',
  ...
  final suFlagWidgets = suFlagData
      .map(
        (f) => suFlagChip(
          f['name'] as String,
          f['desc'] as String,
  ...
  Widget suMergeExample = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 8.0),
        Text(
          'Without merge: screen reader reads icon and text separately.',
          style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
        ),
        SizedBox(height: 6.0),
        Row(
          children: [
            ...
            Semantics(
              label: 'Star icon',
              child: Icon(Icons.star, color: Colors.amber, size: 20.0),
            ),
            SizedBox(width: 4.0),
        ...
        Text(
          'With merge: single announcement "Star icon, 4.5 stars".',
          style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
        ),
        SizedBox(height: 6.0),
        MergeSemantics(
  ...
  Widget suExcludeExample = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 8.0),
        Text(
          'Decorative elements should be excluded from the accessibility tree.',
          style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
        ),
        SizedBox(height: 8.0),
        Row(
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '- Redundant text already announced elsewhere',
                style: TextStyle(fontSize: 11.5),
              ),
            ],
          ),
  ...
  final suProperties = <Widget>[
    suPropertyRow(
      'label',
      '"Submit button"',
      'Primary description read by screen reader',
      Colors.deepOrange,
    ),
    suPropertyRow(
      'hint',
    ...
    suPropertyRow(
      'value',
      '"50%"',
      'Current value of a slider or progress',
      Colors.amber,
    ),
    suPropertyRow(
      'increasedValue',
      '"60%"',
      'Value after increase action',
      Colors.green,
    ),
    suPropertyRow(
      'decreasedValue',
      '"40%"',
      'Value after decrease action',
      Colors.red,
    ),
    suPropertyRow(
      'tooltip',
      '"Saves the document"',
      'Tooltip text associated with the element',
      Colors.blue,
    ),
    suPropertyRow(
      'textDirection',
      'TextDirection.ltr',
      'Reading direction of the label',
      Colors.indigo,
    ),
    suPropertyRow(
      'sortKey',
      'OrdinalSortKey(1.0)',
      'Controls traversal order',
      Colors.purple,
    ),
    suPropertyRow(
      'tagForChildren',
      'RenderViewport.excludeFromScrolling',
      'Tag semantics children for framework use',
      Colors.teal,
    ),
  ];
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Text(
                'sort: ${sortOrder.toStringAsFixed(1)}',
                style: TextStyle(
                  fontSize: 10.0,
                  fontFamily: 'monospace',
                  color: Colors.deepOrange.shade700,
  ...
  Widget suLiveRegionDemo = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 6.0),
        Text(
          'liveRegion: true causes re-announcement on every label change.',
          style: TextStyle(
            fontSize: 11.0,
            fontStyle: FontStyle.italic,
            color: Colors.grey.shade600,
  ...
  Widget suImageSemantics = Container(
    ...
    child: Column(
      ...
      children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.0),
                  Text(
                    'Marks the node as an image. Screen reader announces label with "image" role.',
                    style: TextStyle(
                      fontSize: 11.0,
        ...
        SizedBox(height: 8.0),
        Text(
          'Decorative images should use ExcludeSemantics instead.',
          style: TextStyle(
            fontSize: 11.0,
            fontStyle: FontStyle.italic,
            color: Colors.grey.shade600,
  ...
  Widget suTextFieldDemo = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 8.0),
        Text(
          'TextField automatically provides:',
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                '- isTextField flag (announces "edit text")',
                style: TextStyle(fontSize: 11.5),
              ),
              Text(
              ...
              Text(
                '- label from decoration.labelText',
                style: TextStyle(fontSize: 11.5),
              ),
              Text(
                '- hint from decoration.hintText',
                style: TextStyle(fontSize: 11.5),
              ),
              Text(
                '- isReadOnly when readOnly: true',
                style: TextStyle(fontSize: 11.5),
              ),
              Text(
                '- isObscured when obscureText: true',
                style: TextStyle(fontSize: 11.5),
              ),
            ],
          ),
        ...
        SizedBox(height: 6.0),
        Text(
          'Screen reader: "Email, edit text, Enter your email address"',
          style: TextStyle(
            fontSize: 10.5,
            fontStyle: FontStyle.italic,
            color: Colors.grey.shade600,
  ...
  Widget suTooltipDemo = Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 8.0),
        Text(
          'Tooltip text is announced by the screen reader as additional context. The tooltip property on Semantics sets the accessibility tooltip for the node.',
          style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
        ),
        SizedBox(height: 10.0),
        Row(
          children: [
            ...
            Expanded(
              child: Text(
                'Announced: "Save, button, Saves the current document"',
                style: TextStyle(
                  fontSize: 10.5,
                  fontStyle: FontStyle.italic,
                  color: Colors.grey.shade600,
  ...
  final suDebugTools = <Widget>[
    suDebugCard(
      ...
      'Enable visual overlay showing semantic nodes',
      Icons.bug_report,
      Colors.deepOrange,
    ),
    suDebugCard(
      'debugDumpSemanticsTree()',
      'Print semantics tree to console',
      Icons.terminal,
      Colors.green,
    ),
    suDebugCard(
      'Accessibility Inspector (iOS)',
      'Xcode tool for inspecting VoiceOver nodes',
      Icons.phone_iphone,
      Colors.blue,
    ),
    suDebugCard(
    ...
    suDebugCard(
      ...
      'Wrap MaterialApp to see all nodes overlaid',
      Icons.layers,
      Colors.purple,
    ),
  ];
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 4.0),
                  Text(
                    'The payload that carries accessibility tree changes to the platform engine',
            ...
            SizedBox(height: 4.0),
            Text(
              'The journey from widget annotations to platform accessibility:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...suPipelineStages,
            ...
            SizedBox(height: 4.0),
            Text(
              'Low-level API for constructing semantics updates:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...suBuilderFacts,
            ...
            SizedBox(height: 4.0),
            Text(
              'Semantics widget annotates children with accessibility labels and hints:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            suLabelDemo(
            ...
            suLabelDemo(
              ...
              'Double tap to view cart contents',
              Colors.amber,
            ),
            ...
            SizedBox(height: 4.0),
            Text(
              'Actions that assistive technology can trigger on a node:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...
            SizedBox(height: 4.0),
            Text(
              'Boolean flags that describe the nature and state of a node:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...
            SizedBox(height: 4.0),
            Text(
              'Key properties on the Semantics widget that populate the SemanticsUpdate:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...suProperties,
            ...
            SizedBox(height: 20.0),
            Text(
              '9. Interactive Widget Semantics',
              style: TextStyle(
                fontSize: 18.0,
                fontWeight: FontWeight.bold,
                color: Colors.deepOrange.shade800,
            ...
            SizedBox(height: 4.0),
            Text(
              'Built-in widgets that provide rich semantics automatically:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...suInteractives,
            ...
            SizedBox(height: 4.0),
            Text(
              'OrdinalSortKey controls screen reader traversal order (lower = first):',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...
            SizedBox(height: 4.0),
            Text(
              'Tools for inspecting and verifying the semantics tree:',
              style: TextStyle(fontSize: 12.0, color: Colors.grey.shade700),
            ),
            SizedBox(height: 8.0),
            ...suDebugTools,
