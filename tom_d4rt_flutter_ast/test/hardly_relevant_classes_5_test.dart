    ...
    test(
      ...
      () async {
        final result = await SendTestRunner.send(
          ...
          // 20260523-1056 baseline §1.8/E34: TimeoutException 30s
          // — cold-start contention. This 1734-line / 57 KB script
          // (675 KB bundle) builds in ~1.4 s in both variants. Same
