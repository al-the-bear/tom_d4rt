...
// Sources: 10 files
// Generated: 2026-09-18T04:57:19.058743 by tom_d4rt_generator 1.26.2
...
class CliApiBridge {
  ...
  bridgeReExports() {
    return [
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/cli_api.dart', show: null, hide: null),
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/cli_bridge.dart', show: null, hide: null),
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/cli_controller.dart', show: null, hide: null),
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/cli_exceptions.dart', show: null, hide: null),
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/cli_result_types.dart', show: null, hide: null),
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/cli_runtime.dart', show: null, hide: null),
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/cli_state.dart', show: null, hide: null),
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/cli_test_utils.dart', show: null, hide: null),
      (source: 'package:tom_dcli_exec/tom_d4rt_cli_api.dart', target: 'package:tom_dcli_exec/src/api/execution_context.dart', show: null, hide: null),
    ];
  }
...
BridgedClass _createCliGlobalHolderBridge() {
  return BridgedClass(
    ...
    getters: {
      'controller': (visitor, target) => (D4.validateTarget<$tom_dcli_exec_3.CliGlobalHolder>(target, 'CliGlobalHolder') as dynamic).controller,
  ...
  return BridgedClass(
    ...
    setters: {
      'processDirectory': (visitor, target, value) => 
        D4.validateTarget<$tom_dcli_exec_6.CliRuntime>(target, 'CliRuntime').processDirectory = D4.extractBridgedArg<String>(value, 'processDirectory'),
    },
    getterSignatures: {
...
BridgedClass _createCliRuntimeImplBridge() {
  return BridgedClass(
    ...
    setters: {
      'processDirectory': (visitor, target, value) => 
        D4.validateTarget<$tom_dcli_exec_6.CliRuntimeImpl>(target, 'CliRuntimeImpl').processDirectory = D4.extractBridgedArg<String>(value, 'processDirectory'),
    },
    constructorSignatures: {
      '': 'CliRuntimeImpl()',
    },
  ...
  return BridgedClass(
    ...
    setters: {
      'sessionFile': (visitor, target, value) => 
        D4.validateTarget<$tom_dcli_exec_7.CliState>(target, 'CliState').sessionFile = D4.extractBridgedArgOrNull<RandomAccessFile>(value, 'sessionFile'),
      'currentSessionId': (visitor, target, value) => 
        D4.validateTarget<$tom_dcli_exec_7.CliState>(target, 'CliState').currentSessionId = D4.extractBridgedArgOrNull<String>(value, 'currentSessionId'),
    },
    methods: {
      'cd': (visitor, target, positional, named, typeArgs) {
  ...
  return BridgedClass(
    ...
    setters: {
      'multilineMode': (visitor, target, value) => 
        D4.validateTarget<$tom_dcli_exec_9.ExecutionContext>(target, 'ExecutionContext').multilineMode = D4.extractBridgedArg<$tom_dcli_exec_9.MultilineMode>(value, 'multilineMode'),
    },
    methods: {
      'clearMultilineBuffer': (visitor, target, positional, named, typeArgs) {
  ...
  return BridgedClass(
    ...
    setters: {
      'onUncaughtError': (visitor, target, value) {
        ...
        D4.validateTarget<$tom_d4rt_exec_1.D4rt>(target, 'D4rt').onUncaughtError = onUncaughtErrorRaw == null ? null : (Object p0, StackTrace p1) { D4.callInterpreterCallback(visitor!, onUncaughtErrorRaw, [p0, p1]); };
      },
    },
    methods: {
      'registerBridgedEnum': (visitor, target, positional, named, typeArgs) {
        ...
        final definition = D4.getRequiredArg<$tom_d4rt_ast_3.BridgedEnumDefinition<Enum>>(positional, 0, 'definition', 'registerBridgedEnum');
      ...
      'createBundleFromSource': (visitor, target, positional, named, typeArgs) {
        ...
        final bundlerConfig = D4.getOptionalNamedArg<$tom_ast_generator_1.AstBundlerConfig?>(named, 'bundlerConfig');
    ...
    setterSignatures: {
      'onUncaughtError': 'set onUncaughtError(void Function(Object error, StackTrace stackTrace)? value)',
    },
