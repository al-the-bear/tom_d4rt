...
// Sources: 7 files
// Generated: 2026-02-07T14:39:13.368818
...
/// Bridge class for package_tom_chattools module.
class PackageTomChattoolsBridge {
...
BridgedClass _createChatConfigBridge() {
  return BridgedClass(
    ...
    constructors: {},
    getters: {
      'platform': (visitor, target) =>
          D4.validateTarget<$pkg.ChatConfig>(target, 'ChatConfig').platform,
    },
    methods: {
      'createApi': (visitor, target, positional, named, typeArgs) {
        ...
        final settings = D4.getRequiredArg<$pkg.ChatSettings>(
          positional,
          0,
          'settings',
          'createApi',
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final sender = D4.getRequiredNamedArg<$pkg.ChatSender>(
          named,
          'sender',
          'ChatMessage',
        );
        ...
        final type = D4.getNamedArgWithDefault<$pkg.ChatMessageType>(
          named,
          'type',
          $pkg.ChatMessageType.text,
        );
        ...
        final attachments =
            ...
            ? D4.coerceList<$pkg.ChatAttachment>(
                named['attachments'],
                'attachments',
              )
    ...
    getters: {
      'id': (visitor, target) =>
          D4.validateTarget<$pkg.ChatMessage>(target, 'ChatMessage').id,
      'text': (visitor, target) =>
          D4.validateTarget<$pkg.ChatMessage>(target, 'ChatMessage').text,
      'sender': (visitor, target) =>
          D4.validateTarget<$pkg.ChatMessage>(target, 'ChatMessage').sender,
      'timestamp': (visitor, target) =>
          D4.validateTarget<$pkg.ChatMessage>(target, 'ChatMessage').timestamp,
      'type': (visitor, target) =>
          D4.validateTarget<$pkg.ChatMessage>(target, 'ChatMessage').type,
      'platformMessageId': (visitor, target) => D4
          .validateTarget<$pkg.ChatMessage>(target, 'ChatMessage')
          .platformMessageId,
      ...
      'attachments': (visitor, target) => D4
          .validateTarget<$pkg.ChatMessage>(target, 'ChatMessage')
          .attachments,
      'rawData': (visitor, target) =>
          D4.validateTarget<$pkg.ChatMessage>(target, 'ChatMessage').rawData,
    },
    methods: {
...
BridgedClass _createChatSenderBridge() {
  return BridgedClass(
    ...
    getters: {
      'id': (visitor, target) =>
          D4.validateTarget<$pkg.ChatSender>(target, 'ChatSender').id,
      'name': (visitor, target) =>
          D4.validateTarget<$pkg.ChatSender>(target, 'ChatSender').name,
      'username': (visitor, target) =>
          D4.validateTarget<$pkg.ChatSender>(target, 'ChatSender').username,
      'isSelf': (visitor, target) =>
          D4.validateTarget<$pkg.ChatSender>(target, 'ChatSender').isSelf,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
...
BridgedClass _createChatAttachmentBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final type = D4.getRequiredNamedArg<$pkg.ChatAttachmentType>(
          named,
          'type',
          'ChatAttachment',
        );
    ...
    getters: {
      'type': (visitor, target) =>
          D4.validateTarget<$pkg.ChatAttachment>(target, 'ChatAttachment').type,
      'url': (visitor, target) =>
          D4.validateTarget<$pkg.ChatAttachment>(target, 'ChatAttachment').url,
      'mimeType': (visitor, target) => D4
          .validateTarget<$pkg.ChatAttachment>(target, 'ChatAttachment')
          .mimeType,
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final messages = D4.coerceList<$pkg.ChatMessage>(
          named['messages'],
          'messages',
        );
        final success = D4.getNamedArgWithDefault<bool>(named, 'success', true);
        final status = D4.getNamedArgWithDefault<$pkg.ChatResponseStatus>(
          named,
          'status',
          $pkg.ChatResponseStatus.ok,
        );
      ...
      'error': (visitor, positional, named) {
        ...
        final status = D4.getOptionalNamedArg<$pkg.ChatResponseStatus?>(
          named,
          'status',
        );
    ...
    getters: {
      'messages': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').messages,
      'success': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').success,
      'status': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').status,
      'error': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').error,
      'waitDuration': (visitor, target) => D4
          .validateTarget<$pkg.ChatResponse>(target, 'ChatResponse')
          .waitDuration,
      'hasMore': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').hasMore,
      'metadata': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').metadata,
      'hasMessages': (visitor, target) => D4
          .validateTarget<$pkg.ChatResponse>(target, 'ChatResponse')
          .hasMessages,
      'count': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').count,
      'first': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').first,
      'last': (visitor, target) =>
          D4.validateTarget<$pkg.ChatResponse>(target, 'ChatResponse').last,
    ...
    methods: {
      ...
      'ofType': (visitor, target, positional, named, typeArgs) {
        ...
        final type = D4.getRequiredArg<$pkg.ChatMessageType>(
          positional,
          0,
          'type',
          'ofType',
...
BridgedClass _createChatReceiverBridge() {
  return BridgedClass(
    ...
    getters: {
      'type': (visitor, target) =>
          D4.validateTarget<$pkg.ChatReceiver>(target, 'ChatReceiver').type,
      'value': (visitor, target) =>
          D4.validateTarget<$pkg.ChatReceiver>(target, 'ChatReceiver').value,
      'hashCode': (visitor, target) =>
          D4.validateTarget<$pkg.ChatReceiver>(target, 'ChatReceiver').hashCode,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
  ...
  return BridgedClass(
    ...
    getters: {
      'id': (visitor, target) => D4
          .validateTarget<$pkg.ChatReceiverInfo>(target, 'ChatReceiverInfo')
          .id,
    ...
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.ChatReceiverInfo>(
          target,
          'ChatReceiverInfo',
        );
        return t.toString();
  ...
  return BridgedClass(
    ...
    constructors: {
      ...
      'telegram': (visitor, positional, named) {
        ...
        return $pkg.ChatSettings.telegram(
          token,
          pollingTimeout: pollingTimeout,
          usePolling: usePolling,
        );
    ...
    getters: {
      'settings': (visitor, target) =>
          D4.validateTarget<$pkg.ChatSettings>(target, 'ChatSettings').settings,
      'pollingTimeout': (visitor, target) => D4
          .validateTarget<$pkg.ChatSettings>(target, 'ChatSettings')
          .pollingTimeout,
...
BridgedClass _createChatApiBridge() {
  return BridgedClass(
    ...
    getters: {
      'settings': (visitor, target) =>
          D4.validateTarget<$pkg.ChatApi>(target, 'ChatApi').settings,
      'isConnected': (visitor, target) =>
          D4.validateTarget<$pkg.ChatApi>(target, 'ChatApi').isConnected,
      'platform': (visitor, target) =>
          D4.validateTarget<$pkg.ChatApi>(target, 'ChatApi').platform,
      'onMessage': (visitor, target) =>
          D4.validateTarget<$pkg.ChatApi>(target, 'ChatApi').onMessage,
    },
    setters: {
      'settings': (visitor, target, value) =>
          D4.validateTarget<$pkg.ChatApi>(target, 'ChatApi').settings =
              value as $pkg.ChatSettings,
    },
    methods: {
      ...
      'sendMessage': (visitor, target, positional, named, typeArgs) {
        ...
        final receiver = D4.getRequiredArg<$pkg.ChatReceiver>(
          positional,
          0,
          'receiver',
          'sendMessage',
      ...
      'send': (visitor, target, positional, named, typeArgs) {
        ...
        final message = D4.getRequiredArg<$pkg.ChatMessage>(
          positional,
          1,
          'message',
          'send',
      ...
      'getMessages': (visitor, target, positional, named, typeArgs) {
        ...
        final filter = D4.getOptionalNamedArg<$pkg.ChatMessageFilter?>(
          named,
          'filter',
        );
...
BridgedClass _createChatMessageFilterBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final from = D4.coerceListOrNull<$pkg.ChatReceiver>(
          named['from'],
          'from',
        );
        final types = D4.coerceListOrNull<$pkg.ChatMessageType>(
          named['types'],
          'types',
        );
    ...
    getters: {
      'from': (visitor, target) => D4
          .validateTarget<$pkg.ChatMessageFilter>(target, 'ChatMessageFilter')
          .from,
  ...
  return BridgedClass(
    ...
    getters: {
      'platform': (visitor, target) => D4
          .validateTarget<$pkg.TelegramChatConfig>(target, 'TelegramChatConfig')
          .platform,
    ...
    methods: {
      'createApi': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.TelegramChatConfig>(
          target,
          'TelegramChatConfig',
        );
        D4.requireMinArgs(positional, 1, 'createApi');
