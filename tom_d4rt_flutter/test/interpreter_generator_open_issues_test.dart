...
// cold-starts the analyzer/parser (issue B.11) and can exceed the framework's
// default 30 s per-test timeout. Without this, the first build is killed
// mid-interpret, leaving the app wedged and cascading every subsequent test
// into a spurious timeout. 90 s sits above the runner's 55 s inner
// `_httpBuildTimeout` so the inner budget governs.
