...
// Sources: 43 files
// Generated: 2026-06-07T15:38:14.533344
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'loadStructuredData': (visitor, target, positional, named, typeArgs) {
        ...
        return t.loadStructuredData(key, ((String p0) { return Future.value(D4.callInterpreterCallback(visitor!, parserRaw, [p0])).then((v) => v as dynamic); }) as Future<dynamic> Function(String));
      },
...
BridgedClass _createBasicMessageChannelBridge() {
  return BridgedClass(
    ...
    methods: {
      ...
      'setMessageHandler': $tom_d4rt_flutter_1.BasicMessageChannelUserBridge.overrideMethodSetMessageHandler,
    },
    constructorSignatures: {
