...
class D4rt {
  ...
  Object? _bridgeInterpreterValueToNative(Object? interpreterValue) {
    ...
    if (interpreterValue is List) {
      ...
      // `as Uint8List` failed. The reference front end and tom_d4rt_ast's
      // runner carried this since scd98; this copy did not, and nothing could
      // show it until exec resolved an interpreter that returns the bare
      // native from a constructor (sce160's pre-publish pass).
      var changed = false;
