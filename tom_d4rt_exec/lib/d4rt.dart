...
// Re-export bundler from tom_ast_generator for bundle creation
export 'package:tom_ast_generator/src/bundler/ast_bundler.dart'
    show AstBundler, AstBundlerConfig, FileAccessValidator;
