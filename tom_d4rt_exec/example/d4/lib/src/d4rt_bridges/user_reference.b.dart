...
// Sources: 2 files
// Generated: 2026-05-23T11:00:58.175976
...
class UserReferenceBridge {
  ...
  bridgeReExports() {
    return [
      (source: 'package:d4_example/user_reference.dart', target: 'package:d4_example/src/user_reference/data_models.dart', show: null, hide: null),
      (source: 'package:d4_example/user_reference.dart', target: 'package:d4_example/src/user_reference/services.dart', show: null, hide: null),
    ];
  }
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'findUsers': (visitor, target, positional, named, typeArgs) {
        ...
        return t.findUsers((($d4_example_1.User p0) { return D4.callInterpreterCallback(visitor!, predicateRaw, [p0]) as bool; }) as bool Function($d4_example_1.User));
      },
