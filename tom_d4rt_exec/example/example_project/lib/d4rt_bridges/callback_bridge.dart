...
// Generated: 2026-02-07T11:52:13.340106
  ...
  return BridgedClass(
    ...
    getters: {
      'value': (visitor, target) =>
          D4.validateTarget<$pkg.Result>(target, 'Result').value,
      'error': (visitor, target) =>
          D4.validateTarget<$pkg.Result>(target, 'Result').error,
      'isSuccess': (visitor, target) =>
          D4.validateTarget<$pkg.Result>(target, 'Result').isSuccess,
      'isFailure': (visitor, target) =>
          D4.validateTarget<$pkg.Result>(target, 'Result').isFailure,
    },
    methods: {
  ...
  return BridgedClass(
    ...
    methods: {
      'addTask': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.TaskScheduler>(
          target,
          'TaskScheduler',
        );
        ...
        t.addTask(() {
          (taskRaw as InterpretedFunction).call(visitor, []);
        });
        return null;
      },
      ...
      'runWithHandler': (visitor, target, positional, named, typeArgs) {
        ...
        t.runWithHandler(
          () {
            return (taskRaw as InterpretedFunction).call(visitor, [])
                as dynamic;
          },
          (dynamic p0) {
            (onSuccessRaw as InterpretedFunction).call(visitor, [p0]);
          },
          (Object p0) {
            (onErrorRaw as InterpretedFunction).call(visitor, [p0]);
          },
        );
        return null;
      },
      'mapValues': (visitor, target, positional, named, typeArgs) {
        ...
        return t.mapValues(values, (dynamic p0) {
          return (mapperRaw as InterpretedFunction).call(visitor, [p0])
              as dynamic;
        });
      },
      ...
      'reduceValues': (visitor, target, positional, named, typeArgs) {
        ...
        return t.reduceValues(values, (dynamic p0, dynamic p1) {
          return (combinerRaw as InterpretedFunction).call(visitor, [p0, p1])
              as dynamic;
        });
      },
    },
    staticMethods: {
      'generate': (visitor, positional, named, typeArgs) {
        ...
        final generator = (int p0) {
          return (generatorRaw as InterpretedFunction).call(visitor, [p0])
              as dynamic;
        };
...
BridgedClass _createAsyncServiceBridge() {
  return BridgedClass(
    ...
    getters: {
      'name': (visitor, target) =>
          D4.validateTarget<$pkg.AsyncService>(target, 'AsyncService').name,
    },
    methods: {
      ...
      'fetchWithProgress': (visitor, target, positional, named, typeArgs) {
        ...
        return t.fetchWithProgress((int p0) {
          (onProgressRaw as InterpretedFunction).call(visitor, [p0]);
        });
      },
    ...
    methods: {
      'on': (visitor, target, positional, named, typeArgs) {
        ...
        t.on(event, (String p0) {
          (callbackRaw as InterpretedFunction).call(visitor, [p0]);
        });
        return null;
      },
