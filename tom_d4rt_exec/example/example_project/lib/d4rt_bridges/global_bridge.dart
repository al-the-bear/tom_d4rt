...
class GlobalBridge {
  ...
  static void registerGlobalVariables(D4rt interpreter, String importPath) {
    ...
    if (errors.isNotEmpty) {
      throw StateError(
        'Bridge registration errors (Global):\n${errors.join("\n")}',
      );
    }
  }
  ...
  static Map<String, NativeFunctionImpl> globalFunctions() {
    return {
      ...
      'findWhere': (visitor, positional, named, typeArgs) {
        ...
        final predicate = D4.getRequiredArg<bool Function(dynamic)>(
          positional,
          1,
          'predicate',
          'findWhere',
      ...
      'mapList': (visitor, positional, named, typeArgs) {
        ...
        final mapper = D4.getRequiredArg<dynamic Function(dynamic)>(
          positional,
          1,
          'mapper',
          'mapList',
      ...
      'reduceList': (visitor, positional, named, typeArgs) {
        ...
        final combiner = D4.getRequiredArg<dynamic Function(dynamic, dynamic)>(
          positional,
          1,
          'combiner',
          'reduceList',
      ...
      'sortItems': (visitor, positional, named, typeArgs) {
        ...
        if (firstElem is DateTime) {
          return $pkg.sortItems<DateTime>(
            (positional[0] as List).cast<DateTime>(),
          );
        }
        throw ArgumentError(
          'sortItems: Unsupported type for recursive bound. Supported types: num, String, DateTime. Got: ${sample.runtimeType}',
        );
      },
      'minValue': (visitor, positional, named, typeArgs) {
        ...
        if (sample is String) {
          return $pkg.minValue<String>(
            positional[0] as String,
            positional[1] as String,
          );
        }
        if (sample is DateTime) {
          return $pkg.minValue<DateTime>(
            positional[0] as DateTime,
            positional[1] as DateTime,
          );
        }
        throw ArgumentError(
          'minValue: Unsupported type for recursive bound. Supported types: num, String, DateTime. Got: ${sample.runtimeType}',
        );
      },
      'maxValue': (visitor, positional, named, typeArgs) {
        ...
        if (sample is String) {
          return $pkg.maxValue<String>(
            positional[0] as String,
            positional[1] as String,
          );
        }
        if (sample is DateTime) {
          return $pkg.maxValue<DateTime>(
            positional[0] as DateTime,
            positional[1] as DateTime,
          );
        }
        throw ArgumentError(
          'maxValue: Unsupported type for recursive bound. Supported types: num, String, DateTime. Got: ${sample.runtimeType}',
        );
      },
      ...
      'processAsync': (visitor, positional, named, typeArgs) {
        ...
        final processor = D4.getRequiredArg<Future<dynamic> Function(dynamic)>(
          positional,
          1,
          'processor',
          'processAsync',
  ...
  static List<String> sourceLibraries() {
    return ['package:d4rt_generator_example/test_classes/global_members.dart'];
  }
