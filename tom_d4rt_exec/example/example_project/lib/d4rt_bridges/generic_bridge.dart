...
// Generated: 2026-02-07T11:52:08.531291
...
class GenericBridge {
  ...
  static List<String> sourceLibraries() {
    return ['package:d4rt_generator_example/test_classes/generic_classes.dart'];
  }
...
BridgedClass _createIdentifiableBridge() {
  return BridgedClass(
    ...
    getters: {
      'id': (visitor, target) =>
          D4.validateTarget<$pkg.Identifiable>(target, 'Identifiable').id,
    },
...
BridgedClass _createEntityBridge() {
  return BridgedClass(
    ...
    getters: {
      'id': (visitor, target) =>
          D4.validateTarget<$pkg.Entity>(target, 'Entity').id,
      'name': (visitor, target) =>
          D4.validateTarget<$pkg.Entity>(target, 'Entity').name,
    },
    methods: {
  ...
  return BridgedClass(
    ...
    getters: {
      'value': (visitor, target) =>
          D4.validateTarget<$pkg.Box>(target, 'Box').value,
      'isEmpty': (visitor, target) =>
          D4.validateTarget<$pkg.Box>(target, 'Box').isEmpty,
    },
    setters: {
    ...
    methods: {
      ...
      'transform': (visitor, target, positional, named, typeArgs) {
        ...
        return t.transform((dynamic p0) {
          return (transformerRaw as InterpretedFunction).call(visitor, [p0])
              as dynamic;
        });
      },
    },
  ...
  return BridgedClass(
    ...
    getters: {
      'count': (visitor, target) =>
          D4.validateTarget<$pkg.Repository>(target, 'Repository').count,
    },
    methods: {
      'add': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.Repository>(target, 'Repository');
        D4.requireMinArgs(positional, 1, 'add');
        final item = D4.getRequiredArg<$pkg.Identifiable>(
          positional,
          0,
          'item',
          'add',
      ...
      'findWhere': (visitor, target, positional, named, typeArgs) {
        ...
        return t.findWhere(($pkg.Identifiable p0) {
      ...
      'mapAll': (visitor, target, positional, named, typeArgs) {
        ...
        return t.mapAll(($pkg.Identifiable p0) {
  ...
  return BridgedClass(
    ...
    getters: {
      'first': (visitor, target) =>
          D4.validateTarget<$pkg.Pair>(target, 'Pair').first,
      'second': (visitor, target) =>
          D4.validateTarget<$pkg.Pair>(target, 'Pair').second,
    },
    methods: {
      ...
      'mapBoth': (visitor, target, positional, named, typeArgs) {
        ...
        return t.mapBoth(
          (dynamic p0) {
            return (mapFirstRaw as InterpretedFunction).call(visitor, [p0])
                as dynamic;
          },
          (dynamic p0) {
            return (mapSecondRaw as InterpretedFunction).call(visitor, [p0])
                as dynamic;
          },
        );
      },
