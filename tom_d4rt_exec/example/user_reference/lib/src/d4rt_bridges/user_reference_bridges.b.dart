...
// Sources: 2 files
// Generated: 2026-09-17T23:15:28.270102 by tom_d4rt_generator 1.26.2
...
class AllBridge {
  ...
  static Map<String, BridgedClass Function()> bridgeClassThunks() {
    return {
      ...
      'Product': _createProductBridge,
      'Order': _createOrderBridge,
      'UserService': _createUserServiceBridge,
      'ProductService': _createProductServiceBridge,
  ...
  static Map<String, Type> bridgeClassTypes() {
    return {
      'User': $user_reference_example_1.User,
      'Product': $user_reference_example_1.Product,
      'Order': $user_reference_example_1.Order,
      'UserService': $user_reference_example_2.UserService,
      'ProductService': $user_reference_example_2.ProductService,
      'EventEmitter': $user_reference_example_2.EventEmitter,
    };
  }
  ...
  bridgeReExports() {
    return [
      (source: 'package:user_reference_example/user_reference_example.dart', target: 'package:user_reference_example/src/data_models.dart', show: null, hide: null),
      (source: 'package:user_reference_example/user_reference_example.dart', target: 'package:user_reference_example/src/services.dart', show: null, hide: null),
    ];
  }
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'findUsers': (visitor, target, positional, named, typeArgs) {
        ...
        return t.findUsers((($user_reference_example_1.User p0) { return D4.callInterpreterCallback(visitor!, predicateRaw, [p0]) as bool; }) as bool Function($user_reference_example_1.User));
      },
