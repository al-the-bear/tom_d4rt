...
void main() {
  ...
  if (LogLevel.debug.severity != 0) {
    errors.add(
      'LogLevel.debug.severity expected 0, got ${LogLevel.debug.severity}',
    );
  }
  if (LogLevel.info.severity != 1) {
    errors.add(
      'LogLevel.info.severity expected 1, got ${LogLevel.info.severity}',
    );
  }
  if (LogLevel.warning.severity != 2) {
    errors.add(
      'LogLevel.warning.severity expected 2, got ${LogLevel.warning.severity}',
    );
  }
  if (LogLevel.error.severity != 3) {
    errors.add(
      'LogLevel.error.severity expected 3, got ${LogLevel.error.severity}',
    );
  }
  ...
  if (!LogLevel.error.shouldLog(LogLevel.warning)) {
    errors.add(
      'LogLevel.error.shouldLog(LogLevel.warning) expected true, got false',
    );
  }
  ...
  if (LogLevel.debug.shouldLog(LogLevel.warning)) {
    errors.add(
      'LogLevel.debug.shouldLog(LogLevel.warning) expected false, got true',
    );
  }
  ...
  if (!LogLevel.error.shouldLog(LogLevel.debug)) {
    errors.add(
      'LogLevel.error.shouldLog(LogLevel.debug) expected true, got false',
    );
  }
