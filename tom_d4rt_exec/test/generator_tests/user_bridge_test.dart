...
void main() {
  ...
  setUpAll(() {
    ...
    tempOutputDir = Directory.systemTemp
        .createTempSync('user_bridge_test_')
        .path;
  });
  ...
  group('UserBridgeScanner', () {
    ...
    test(
      'G-UB-22: Detects class extending D4UserBridge. [2026-02-10 06:37] (PASS)',
      () {
        // MyCollectionUserBridge should be detected as extending D4UserBridge
        expect(
          generator.userBridgeScanner.shouldExcludeClass(
            'MyCollectionUserBridge',
          ),
          isTrue,
          reason:
              'MyCollectionUserBridge extends D4UserBridge and should be excluded',
        );
      },
    );

    test(
      'G-UB-23: Identifies target class from annotation. [2026-02-10 06:37] (PASS)',
      () {
        // Should map MyCollectionUserBridge to target class MyCollection via @D4rtUserBridge
        final userBridge = generator.userBridgeScanner.getUserBridgeFor(
          testLibraryPath,
          'MyCollection',
        );
        ...
        expect(
          ...
          equals('MyCollectionUserBridge'),
        );
      },
    );

    test(
      'G-UB-24: Detects static nativeNames getter. [2026-02-10 06:37] (PASS)',
      () {
        final userBridge = generator.userBridgeScanner.getUserBridgeFor(
          testLibraryPath,
          'MyCollection',
    ...
    test(
      'G-UB-25: Detects static constructor override. [2026-02-10 06:37] (PASS)',
      () {
        final userBridge = generator.userBridgeScanner.getUserBridgeFor(
          testLibraryPath,
          'MyCollection',
    ...
    test(
      'G-UB-1a: Detects static operator override. [2026-02-10 06:37] (PASS)',
      () {
        final userBridge = generator.userBridgeScanner.getUserBridgeFor(
          testLibraryPath,
          'MyCollection',
    ...
    test(
      'G-UB-2a: Detects static getter override. [2026-02-10 06:37] (PASS)',
      () {
        final userBridge = generator.userBridgeScanner.getUserBridgeFor(
          testLibraryPath,
          'MyCollection',
    ...
    test(
      'G-UB-3b: Detects static method override. [2026-02-10 06:37] (PASS)',
      () {
        final userBridge = generator.userBridgeScanner.getUserBridgeFor(
          testLibraryPath,
          'MyCollection',
    ...
    test(
      'G-UB-4b: Detects static getter override for static member. [2026-02-10 06:37] (PASS)',
      () {
        final userBridge = generator.userBridgeScanner.getUserBridgeFor(
          testLibraryPath,
          'MyCollection',
        ...
        expect(
          staticGetterOverride,
          equals('overrideStaticGetterDefaultCapacity'),
        );
      },
    );

    test(
      'G-UB-5b: Class without UserBridge is not excluded. [2026-02-10 06:37] (PASS)',
      () {
        ...
        expect(
          generator.userBridgeScanner.getUserBridgeFor(
            testLibraryPath,
            'SimpleClass',
          ),
          isNull,
    ...
    test(
      'G-UB-6a: Excludes UserBridge class from generated code. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-UB-7: Generates bridge for target class with overrides. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-UB-8: Uses nativeNames from UserBridge. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
    ...
    test(
      'G-UB-9: Uses constructor override from UserBridge. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
    ...
    test(
      'G-UB-10: Uses operator override from UserBridge. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-UB-11: Uses getter override from UserBridge. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
    ...
    test(
      'G-UB-12: Uses method override from UserBridge. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
    ...
    test(
      'G-UB-13: Uses static getter override from UserBridge. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains(
            'MyCollectionUserBridge.overrideStaticGetterDefaultCapacity',
          ),
    ...
    test(
      'G-UB-14: Generates non-overridden members normally. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-UB-15: Generates SimpleClass normally (no UserBridge). [2026-02-10 06:37] (PASS)',
      () {
  ...
  group('GlobalsUserBridge', () {
    ...
    setUpAll(() async {
      ...
      final globalSourceFile = p.join(
        testFixturesDir,
        'global_test_source.dart',
      );
      final globalsUserBridgeFile = p.join(
        testFixturesDir,
        'globals_user_bridge.dart',
      );
      final outputFile = p.join(tempOutputDir, 'globals_user_bridge_test.dart');
    ...
    group('Scanner Detection', () {
      test(
        'G-UB-16: Detects GlobalsUserBridge class. [2026-02-10 06:37] (PASS)',
        () {
          final globalsInfo = generator.userBridgeScanner
              .getGlobalsUserBridgeFor(globalsLibraryPath);
          expect(globalsInfo, isNotNull);
          expect(globalsInfo!.userBridgeClassName, equals('GlobalsUserBridge'));
        },
      );

      test(
        'G-UB-17: Excludes GlobalsUserBridge from bridge generation. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            generator.userBridgeScanner.shouldExcludeClass('GlobalsUserBridge'),
            isTrue,
          );
        },
      );
      ...
      test(
        'G-UB-18: Detects global variable overrides. [2026-02-10 06:37] (PASS)',
        () {
          final globalsInfo = generator.userBridgeScanner
              .getGlobalsUserBridgeFor(globalsLibraryPath);
          expect(globalsInfo, isNotNull);
      ...
      test(
        'G-UB-19: Detects global getter overrides. [2026-02-10 06:37] (PASS)',
        () {
          final globalsInfo = generator.userBridgeScanner
              .getGlobalsUserBridgeFor(globalsLibraryPath);
          expect(globalsInfo, isNotNull);
      ...
      test(
        'G-UB-20: Detects global function overrides. [2026-02-10 06:37] (PASS)',
        () {
          final globalsInfo = generator.userBridgeScanner
              .getGlobalsUserBridgeFor(globalsLibraryPath);
          expect(globalsInfo, isNotNull);
    ...
    group('Code Generation with Overrides', () {
      test(
        'G-UB-1b: Override for global variable appName. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-UB-2b: Override for global variable maxRetries. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            generatedCode,
            contains(
      ...
      test(
        'G-UB-3a: Override for global getter currentTime. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            generatedCode,
            contains(
      ...
      test(
        'G-UB-4a: Override for global getter globalService. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            generatedCode,
            contains(
      ...
      test(
        'G-UB-5a: Override for global function greet. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            generatedCode,
            contains(
              r"'greet': $test_package_3.GlobalsUserBridge.overrideGlobalFunctionGreet,",
            ),
          );
        },
      );
      ...
      test(
        'G-UB-6b: Override for global function add. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            generatedCode,
            contains(
              r"'add': $test_package_3.GlobalsUserBridge.overrideGlobalFunctionAdd,",
            ),
          );
        },
      );
      ...
      test(
        'G-UB-21: Non-overridden globals are generated normally. [2026-02-10 06:37] (PASS)',
        () {
