...
void main() {
  ...
  group('dart_overview coverage', () {
    ...
    setUpAll(() async {
      ...
      // can run in parallel with d4rt_tester_test.dart without ETXTBSY
      ...
      expect(
        ...
        isTrue,
        reason:
            'Bridge generation/compilation failed for dart_overview. This '
            'withholds $_corpusCaseCount cases in this file — they are not '
            'registered, so the run reports one failure rather than '
            '$_corpusCaseCount missing tests.\n'
            '${ExecTestSetup.lastFailure ?? "(no detail recorded)"}',
      );
    });
