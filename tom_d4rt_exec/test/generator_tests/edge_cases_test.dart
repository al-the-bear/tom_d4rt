...
void main() {
  ...
  setUpAll(() {
    ...
    tempOutputDir = Directory.systemTemp
        .createTempSync('bridge_edge_test_')
        .path;
  });
  ...
  group('Edge Cases Generation', () {
    ...
    group('Reserved Word Parameters', () {
      test(
        'G-EDGE-34: Detects ReservedWordsClass. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-EDGE-35: Handles reserved word parameter names safely. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Nested Generic Types', () {
      test(
        'G-EDGE-36: Detects NestedGenericsClass. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-EDGE-37: Detects Result<T, E> with multiple type params. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-EDGE-38: Generates methods with nested generics. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Default Values with Static References', () {
      test(
        'G-EDGE-39: Detects DefaultValuesClass. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-EDGE-40: Constructor with static default values is bridged. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Function Type Parameters', () {
      ...
      test(
        'G-EDGE-1: Detects FunctionParamsClass. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-EDGE-2: Methods with function parameters may be bridged or skipped. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Empty and Minimal Classes', () {
      ...
      test(
        'G-EDGE-9: Empty class has default constructor. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Many Parameters Stress Test', () {
      ...
      test(
        'G-EDGE-11: Constructor with many params is bridged. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Nullable Parameters', () {
      test(
        'G-EDGE-12: Detects NullableParamsClass. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-EDGE-13: Nullable getters are bridged. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-EDGE-14: Methods with nullable params are bridged. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Mixins', () {
      ...
      test(
        'G-EDGE-16: LoggingClass has its own doWork method. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Late Initialization', () {
      ...
      test(
        'G-EDGE-18: Late fields have getters and setters. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-EDGE-19: Initialize method is bridged. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Covariant Parameters', () {
      ...
      test(
        'G-EDGE-21: Overridden method with covariant param is bridged. [2026-02-10 06:37] (PASS)',
        () {
  ...
  group('Edge Case Class Verification', () {
    ...
    test(
      'G-EDGE-22: Result class with multiple type parameters is bridged. [2026-02-10 06:37] (PASS)',
      () {
        expect(generatedCode, contains("name: 'Result'"));
      },
    );
    ...
    test(
      'G-EDGE-23: Empty class is bridged with constructor. [2026-02-10 06:37] (PASS)',
      () {
        expect(generatedCode, contains("name: 'EmptyClass'"));
        expect(generatedCode, contains('_createEmptyClassBridge'));
      },
    ...
    test(
      'G-EDGE-24: Static-only class has static members. [2026-02-10 06:37] (PASS)',
      () {
        expect(generatedCode, contains("name: 'StaticOnlyClass'"));
    ...
    test(
      'G-EDGE-25: Class using mixin is bridged. [2026-02-10 06:37] (PASS)',
      () {
        // Note: Mixin-provided methods may not be detected without full resolution
        expect(generatedCode, contains("name: 'LoggingClass'"));
      },
    ...
    test(
      'G-EDGE-26: LoggingClass has its own method doWork bridged. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-EDGE-27: Concrete implementation Cat is bridged. [2026-02-10 06:37] (PASS)',
      () {
  ...
  group('Combined Sources Generation', () {
    test(
      'G-EDGE-28: Generates from multiple source files. [2026-02-10 06:37] (PASS)',
      () async {
        final generator = BridgeGenerator(
          workspacePath: testFixturesDir,
          skipPrivate: true,
    ...
    test(
      'G-EDGE-29: Handles empty source file gracefully. [2026-02-10 06:37] (PASS)',
      () async {
  ...
  group('Error Handling', () {
    test(
      'G-EDGE-30: Reports errors for invalid source paths. [2026-02-10 06:37] (PASS)',
      () async {
        final generator = BridgeGenerator(
          workspacePath: testFixturesDir,
          skipPrivate: true,
  ...
  group('Generator Options', () {
    test(
      'G-EDGE-31: SkipPrivate=true skips private members in output. [2026-02-10 06:37] (PASS)',
      () async {
        final generator = BridgeGenerator(
          workspacePath: testFixturesDir,
          skipPrivate: true,
    ...
    test(
      'G-EDGE-32: SkipPrivate=false includes private members in output. [2026-02-10 06:37] (PASS)',
      () async {
        final generator = BridgeGenerator(
          workspacePath: testFixturesDir,
          skipPrivate: false,
    ...
    test(
      'G-EDGE-33: Verbose mode does not affect output structure. [2026-02-10 06:37] (PASS)',
      () async {
