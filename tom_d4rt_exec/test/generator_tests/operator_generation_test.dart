...
void main() {
  ...
  group('Operator Generation', () {
    ...
    test(
      'G-OP-2: Generates bridges for arithmetic operators. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-OP-3: Generates bridges for index operators. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains("'[]': (visitor, target, positional, named, typeArgs)"),
    ...
    test(
      'G-OP-4: Generates bridges for bitwise operators. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains("'&': (visitor, target, positional, named, typeArgs)"),
    ...
    test(
      'G-OP-5: Generates bridges for comparison operators. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains("'<': (visitor, target, positional, named, typeArgs)"),
    ...
    test(
      'G-OP-1: Operators are placed in methods map. [2026-02-10 06:37] (PASS)',
      () {
        ...
        expect(
          generatedCode,
          contains("'add': (visitor, target, positional, named, typeArgs)"),
        );
      },
    );
  });
