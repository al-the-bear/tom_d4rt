...
void main() {
  ...
  setUpAll(() {
    ...
    tempOutputDir = Directory.systemTemp
        .createTempSync('bridge_mixin_test_')
        .path;
  });
  ...
  group('GEN-048: Pure Mixin Bridging', () {
    ...
    test(
      'G-MIX-6: Bridges JsonSerializable mixin. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
    ...
    test('G-MIX-9: Skips private _PrivateMixin. [2026-02-10 06:37] (PASS)', () {
      expect(
        generatedCode,
        isNot(contains("'_PrivateMixin'")),
        reason: 'Should skip private mixin',
      );
      expect(
        generatedCode,
        isNot(contains("'secretMethod'")),
        reason: 'Should not include private mixin methods',
      );
    });

    test(
      'G-MIX-10: Includes Printable.printFormatted method. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains("'printFormatted'"),
    ...
    test(
      'G-MIX-11: Includes Printable.displayString getter. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
    ...
    test(
      'G-MIX-12: Includes JsonSerializable.toMap method. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains("'toMap'"),
    ...
    test(
      'G-MIX-1: Includes JsonSerializable.toJsonString method. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains("'toJsonString'"),
    ...
    test(
      'G-MIX-2: Includes Nameable.name getter. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-MIX-3: Mixins are bridged as abstract (no constructors). [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-MIX-4: TestEntity class is also bridged. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains("'TestEntity'"),
