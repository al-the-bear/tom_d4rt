...
void main() {
  ...
  group('GEN-070: re-export through show clause with visited barrel', () {
    ...
    test(
      'G-ISS-10: Class exported through re-export show chain is bridged correctly. [2026-02-15] (PASS)',
      () async {
...
''');
        ...
        // Output directory
        Directory(
          p.join(root, 'main/lib/src/bridges'),
        ...
        expect(
          exports.containsKey(classCSourcePath),
          isTrue,
        ...
        expect(
          classCExport!.isSymbolExported('ClassC'),
          isTrue,
          reason:
              'ClassC should be exported (visible through reexporter chain)',
        );
        ...
        expect(
          exports[classASourcePath]?.isSymbolExported('ClassA'),
          isTrue,
          reason: 'ClassA should be exported from direct chain',
        );
        expect(
          exports[classBSourcePath]?.isSymbolExported('ClassB'),
          isTrue,
    ...
    test(
      'G-ISS-11: Function exported through re-export show chain is bridged correctly. [2026-02-15] (PASS)',
      () async {
...
''');
        ...
        expect(
          exports.containsKey(funcsSourcePath),
          isTrue,
        ...
        expect(
          funcsExport.isSymbolExported('funcA'),
          isTrue,
          reason: 'funcA should be exported from direct chain',
        );
        expect(
          funcsExport.isSymbolExported('funcB'),
          isTrue,
    ...
    test(
      'G-ISS-12: Full bridge generation includes re-exported class. [2026-02-15] (PASS)',
      () async {
        // dep source
