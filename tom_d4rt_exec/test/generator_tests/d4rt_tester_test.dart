...
void main() {
  ...
  setUpAll(() async {
    ...
    expect(
      ...
      isTrue,
      reason:
          'Bridge generation/compilation failed for d4. This withholds '
          '$_corpusCaseCount cases in this file — they are not registered, so '
          'the run reports one failure rather than $_corpusCaseCount missing '
          'tests.\n'
          '${ExecTestSetup.lastFailure ?? tester.lastGenerationErrors}',
    );
  });
