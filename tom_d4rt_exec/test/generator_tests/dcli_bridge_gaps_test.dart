...
void main() {
  ...
  setUpAll(() {
    ...
    tempOutputDir = Directory.systemTemp.createTempSync('dcli_gaps_test_').path;
  });
  ...
  group('DCli Bridge Gaps', () {
    ...
    group('Extension Callback Wrapping', () {
      ...
      test(
        'DCL-EXT-001: Extension on String should be generated [2026-02-11] (PASS)',
        () {
          expect(
            generatedCode,
      ...
      test(
        'DCL-EXT-002: Extension forEach method should be generated [2026-02-11] (PASS)',
        () {
          final section = _extractSection(generatedCode, 'bridgedExtensions');
          expect(
            section,
            isNotNull,
            reason: 'Should have bridgedExtensions method',
          );
          expect(
            section,
            contains("'forEach'"),
      ...
      test(
        ...
        () {
          ...
          expect(
            ...
            reason:
                'Extension method with callback should wrap InterpretedFunction',
          );
        },
      );
    });
    ...
    group('Class Method Callback Wrapping', () {
      ...
      test(
        'DCL-CLS-001: ProcessRunner forEach should wrap callback [2026-02-11] (PASS)',
        () {
      ...
      test(
        'DCL-CLS-002: Class forEach callback uses InterpretedFunction [2026-02-11] (PASS)',
        () {
    ...
    group('Optional Parameter Detection', () {
      ...
      test(
        'DCL-OPT-001: find() progress parameter should be optional [2026-02-11] (PASS)',
        () {
          ...
          expect(
            ...
            reason:
                'Nullable optional parameter should use getOptionalNamedArg',
          );
        },
      );

      test(
        'DCL-OPT-002: find() progress should NOT use getRequiredNamedArg [2026-02-11] (PASS)',
        () {
      ...
      test(
        'DCL-OPT-003: runCommand onLine should handle null callback [2026-02-11] (PASS)',
        () {
    ...
    group('Abstract Class Bridge', () {
      ...
      test(
        'DCL-SUB-001: Progress abstract class should be bridged [2026-02-11] (PASS)',
        () {
          expect(
            generatedCode,
      ...
      test(
        'DCL-SUB-002: Progress bridge should have lines getter [2026-02-11] (PASS)',
        () {
      ...
      test(
        'DCL-SUB-003: Progress bridge should have forEach method [2026-02-11] (PASS)',
        () {
          expect(
            generatedCode,
            contains("'forEach':"),
      ...
      test(
        'DCL-SUB-004: Private _ProgressImpl should NOT be bridged [2026-02-11] (PASS)',
        () {
    ...
    group('FindProgress Class', () {
      test(
        'DCL-FND-001: FindProgress should be bridged [2026-02-11] (PASS)',
        () {
          expect(
            generatedCode,
      ...
      test(
        'DCL-FND-002: FindProgress forEach should wrap callback [2026-02-11] (PASS)',
        () {
    ...
    group('Find Function', () {
      ...
      test(
        'DCL-FIND-001: dcli_core.find requires progress callback (by design) [2026-02-11] (PASS)',
        () {
          ...
          expect(
            ...
            isTrue,
            reason:
                'Documentation test - dcli_core.find requires progress by design',
          );
        },
      );
    });
