...
void main() {
  ...
  setUpAll(() {
    ...
    tempOutputDir = Directory.systemTemp
        .createTempSync('bridge_extension_test_')
        .path;
  });
  ...
  group('Extension Bridge Generation', () {
    ...
    test(
      'G-EXT-10: Generates bridgedExtensions() method. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains(
    ...
    test(
      'G-EXT-11: Generates extensionSourceUris() method. [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains('static Map<String, String> extensionSourceUris()'),
        );
      },
    );

    test(
      'G-EXT-12: Generates StringHelpers extension. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-EXT-13: Generates isPalindrome getter for StringHelpers. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-EXT-1: Generates reversed getter for StringHelpers. [2026-02-10 06:37] (PASS)',
      () {
        final section = _extractSection(generatedCode, 'bridgedExtensions');
        expect(section, isNotNull);
    ...
    test(
      'G-EXT-2: Generates repeat method for StringHelpers. [2026-02-10 06:37] (PASS)',
      () {
        final section = _extractSection(generatedCode, 'bridgedExtensions');
        expect(section, isNotNull);
    ...
    test(
      'G-EXT-3: Generates surround method for StringHelpers. [2026-02-10 06:37] (PASS)',
      () {
        final section = _extractSection(generatedCode, 'bridgedExtensions');
        expect(section, isNotNull);
    ...
    test(
      'G-EXT-4: Generates DateTimeHelpers extension. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-EXT-5: Generates PointExtensions extension. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'G-EXT-6: Generates magnitude getter for PointExtensions. [2026-02-10 06:37] (PASS)',
      () {
        final section = _extractSection(generatedCode, 'bridgedExtensions');
        expect(section, isNotNull);
    ...
    test(
      'G-EXT-7: Generates add method for PointExtensions. [2026-02-10 06:37] (PASS)',
      () {
        final section = _extractSection(generatedCode, 'bridgedExtensions');
        expect(section, isNotNull);
    ...
    test(
      'G-EXT-9: Registers extensions in registerBridges(). [2026-02-10 06:37] (PASS)',
      () {
        expect(
          generatedCode,
          contains('final extensions = bridgedExtensions()'),
        );
