...
void main() {
  group('SC6: StreamView bridge', () {
    ...
    test('F-SC6-3: inherited Stream methods dispatch on a StreamView [2026-07-27]',
        () async {
    ...
    test('F-SC6-4: inherited Stream getters and listen work on a StreamView [2026-07-27]',
        () async {
      final result = await executeAsync('''
        import 'dart:async';
        main() async {
    ...
    test('F-SC6-5: is StreamView still discriminates despite Stream dispatch [2026-07-27]',
        () {
  ...
  group('SC6: AsyncError bridge', () {
    ...
    test('F-SC6-11: a thrown AsyncError is caught by on AsyncError [2026-07-27]',
        () {
      final result = execute('''
        import 'dart:async';
        main() {
  ...
  group('SC6: StreamTransformerBase bridge', () {
    ...
    test('F-SC6-13: a script class can extend StreamTransformerBase [2026-07-27]',
        () async {
    ...
    test('F-SC6-14: a StreamTransformerBase subclass is a StreamTransformerBase [2026-07-27]',
        () async {
    ...
    test('F-SC6-15: a StreamTransformerBase subclass is a StreamTransformer [2026-07-27]',
        () async {
    ...
    test('F-SC6-16: an unrelated script class is not a StreamTransformer [2026-07-27]',
        () async {
    ...
    test('F-SC6-17: Stream.transform accepts a StreamTransformerBase subclass [2026-07-27]',
        () async {
    ...
    test('F-SC6-18: Stream.transform accepts a class that implements StreamTransformer [2026-07-27]',
        () async {
    ...
    test('F-SC6-19: Stream.transform still accepts a native transformer [2026-07-27]',
        () async {
    ...
    test('F-SC6-20: Stream.transform rejects a non-transformer [2026-07-27]',
        () async {
      final result = await executeAsync('''
        import 'dart:async';
        main() async {
