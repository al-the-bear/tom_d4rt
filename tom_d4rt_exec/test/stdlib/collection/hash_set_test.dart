...
void main() {
  ...
  group('HashSet Tests', () {
    test(
      'I-COLL-30: HashSet() constructor and basic properties. [2026-02-10 06:37] (PASS)',
      () {
        final result =
            d4rt.execute(
                  source: '''
    ...
    test(
      'I-COLL-27: HashSet() constructor, add, length, contains. [2026-02-10 06:37] (PASS)',
      () {
        final result =
            d4rt.execute(
                  source: '''
        ...
        expect(
          result[5],
          false,
          reason: "Add duplicate 10 should return false",
        );
    ...
    test(
      'I-COLL-28: HashSet.from() constructor. [2026-02-10 06:37] (PASS)',
      () {
        final result =
            d4rt.execute(
                  source: '''
    ...
    test(
      'I-COLL-31: AddAll(), remove(), removeAll(), retainAll(), containsAll(). [2026-02-10 06:37] (PASS)',
      () {
        final result =
            d4rt.execute(
                  source: '''
    ...
    test(
      'I-COLL-24: First, last, single getters. [2026-02-10 06:37] (PASS)',
      () {
        final result =
            d4rt.execute(
                  source: '''
    ...
    test(
      'I-COLL-25: Iterator basics and forEach. [2026-02-10 06:37] (PASS)',
      () {
        final result =
            d4rt.execute(
                  source: '''
