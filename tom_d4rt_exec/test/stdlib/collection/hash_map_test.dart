...
void main() {
  group('dart:collection - HashMap Tests', () {
    ...
    test('I-COLL-19: Operator []= and []. [2026-02-10 06:37] (PASS)', () {
      final result = execute('''
        var map = HashMap();
        map['key1'] = 'value1';
        map[2] = 'value2'; 
    ...
    test('I-COLL-20: AddAll() method. [2026-02-10 06:37] (PASS)', () {
      final result = execute('''
        var map = HashMap();
        map.addAll({'c': 3, 'd': 4});
    ...
    test('I-COLL-21: Clear() method. [2026-02-10 06:37] (PASS)', () {
      final result = execute('''
    ...
    test('I-COLL-13: ForEach() method. [2026-02-10 06:37] (PASS)', () {
      final result = execute('''
        var map = HashMap.from({'a': 1, 'b': 2});
        var log = <String>[];
    ...
    test('I-COLL-15: Keys and values getters. [2026-02-10 06:37] (PASS)', () {
      final result = execute('''
