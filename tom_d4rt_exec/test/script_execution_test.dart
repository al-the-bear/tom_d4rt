...
void main() {
  group('ScriptExecutionResult', () {
    test(
      'I-FILE-109: Success creates successful result. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-FILE-114: Failure creates failed result. [2026-02-10 06:37] (PASS)',
      () {
  ...
  group('executeFile', () {
    ...
    test(
      'I-FILE-123: Executes simple script file. [2026-02-10 06:37] (PASS)',
      () {
...
''');
    ...
    test(
      'I-FILE-117: Returns failure for non-existent file. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-FILE-125: Executes script with main returning value. [2026-02-10 06:37] (PASS)',
      () {
...
''');
    ...
    test(
      'I-FILE-126: Executes script with relative import. [2026-02-10 06:37] (PASS)',
      () {
...
''');
    ...
    test(
      'I-FILE-110: Provides logging callback. [2026-02-10 06:37] (PASS)',
      () {
        final logs = <String>[];
...
''');
        ...
        executeFile(d4rt, scriptFile.path, log: (message) => logs.add(message));
  ...
  group('executeSource', () {
    ...
    test(
      'I-FILE-111: Executes simple source code. [2026-02-10 06:37] (PASS)',
      () {
        const source = '''
main() {
  return 100;
...
''';
    ...
    test(
      'I-FILE-112: Resolves imports from basePath. [2026-02-10 06:37] (PASS)',
      () {
...
''',
    ...
    test(
      'I-FILE-115: Continues execution in existing environment. [2026-02-10 06:37] (PASS)',
      () {
...
''');
    ...
    test(
      'I-FILE-116: Adds declarations to global environment. [2026-02-10 06:37] (PASS)',
      () {
...
''');
    ...
    test(
      'I-FILE-124: Returns failure for non-existent file. [2026-02-10 06:37] (PASS)',
      () {
  ...
  group('resolveImportsRecursively', () {
    ...
    test(
      'I-FILE-118: Resolves relative imports. [2026-02-10 06:37] (PASS)',
      () {
        // Create files
    ...
    test(
      'I-FILE-119: Handles circular imports gracefully. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-FILE-120: Skips dart: and package: imports. [2026-02-10 06:37] (PASS)',
      () {
        const source = '''
import 'dart:core';
import 'dart:async';
...
''';
    ...
    test(
      'I-FILE-122: Handles imports with double quotes. [2026-02-10 06:37] (PASS)',
      () {
