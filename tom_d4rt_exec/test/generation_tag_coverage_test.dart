...
// `ExecTestSetup.prepareBridges`, which is not a test file and so is never scanned. No test does
...
void main() {
  ...
  group('sce40: generation-bound tests declare it', () {
    test('EX-GENTAG-1: every test file that runs the generator carries '
    ...
    test('EX-GENTAG-2: the tag is configured, so carrying it actually '
