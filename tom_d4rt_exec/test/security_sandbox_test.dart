...
void main() {
  ...
  group('Real File Operations - No Permission', () {
    test(
      'I-NET-8: Reading a file fails without permission. [2026-02-10 06:37] (PASS)',
      () {
        // Create a real file
    ...
    test(
      'I-NET-13: Writing a file fails without permission. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
        expect(
          () => interpreter.execute(
    ...
    test(
      'I-NET-20: Deleting a file fails without permission. [2026-02-10 06:37] (PASS)',
      () {
  ...
  group('Real File Operations - With Permission', () {
    test(
      'I-NET-29: Reading a file succeeds with read permission. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-NET-30: Writing a file succeeds with write permission. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
      ...
      ''',
        ...
        expect(
          io.File('output.txt').readAsStringSync(),
    ...
    test(
      'I-NET-1: Complex file operations with full permission. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
  ...
  group('Real Directory Operations', () {
    test(
      'I-NET-2: Listing directory contents with permission. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
        interpreter.grant(FilesystemPermission.any);
    ...
    test(
      'I-NET-3: Directory operations without permission fail. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
  ...
  group('Real Process Execution', () {
    test(
      'I-NET-4: Running echo command with permission. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
  ...
  group('Complex Real-World Scenarios', () {
    test(
      'I-NET-6: Config file processor with read/write permissions. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-NET-7: Log file aggregator - read multiple files, write summary. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-NET-9: Data transformation pipeline. [2026-02-10 06:37] (PASS)',
      () {
        // Create input data
        io.File(
          'input.txt',
  ...
  group('Multi-Module Real Scenarios', () {
    test(
      'I-NET-11: Module importing with file operations. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
        interpreter.grant(FilesystemPermission.any);
        ...
        expect(
          ...
          equals('Hello from main'),
        );
      },
    );

    test(
      'I-NET-12: Complex data processing across modules. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
        interpreter.grant(FilesystemPermission.any);
  ...
  group('Permission Revocation - Real Impact', () {
    test(
      'I-NET-14: Permission revocation prevents further operations. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
        interpreter.grant(FilesystemPermission.any);
  ...
  group('Safe Operations Without Permissions', () {
    test(
      'I-NET-15: Pure computation works without any permissions. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
    ...
    test(
      'I-NET-16: String processing works without permissions. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
    ...
    test(
      'I-NET-17: Complex data structures work without permissions. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
  ...
  group('Network Permission Scenarios', () {
    test(
      'I-NET-18: Network lookup requires permission. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
        interpreter.grant(FilesystemPermission.any);
  ...
  group('Error Handling in Sandboxed Environment', () {
    group('NetworkPermission - Real Tests', () {
      ...
      test(
        'I-NET-21: Network succeeds with NetworkPermission.any. [2026-02-10 06:37] (PASS)',
        () async {
          final interpreter = D4rt();
          interpreter.grant(FilesystemPermission.any);
    ...
    group('ProcessRunPermission - Real Tests', () {
      ...
      test(
        'I-NET-23: Echo with ProcessRunPermission.any. [2026-02-10 06:37] (PASS)',
        () {
          final interpreter = D4rt();
          interpreter.grant(FilesystemPermission.any);
          interpreter.grant(ProcessRunPermission.any);
    ...
    group('DangerousPermission - Real Tests', () {
      test(
        'I-NET-25: Platform access with DangerousPermission.any. [2026-02-10 06:37] (PASS)',
        () {
          final interpreter = D4rt();
          interpreter.grant(FilesystemPermission.any);
      ...
      test(
        'I-NET-27: Platform numberOfProcessors. [2026-02-10 06:37] (PASS)',
        () {
          final interpreter = D4rt();
          interpreter.grant(FilesystemPermission.any);
          interpreter.grant(DangerousPermission.any);
    ...
    test(
      'I-NET-28: File not found error propagates correctly. [2026-02-10 06:37] (PASS)',
      () {
        final interpreter = D4rt();
        interpreter.grant(FilesystemPermission.any);
