...
Use the `executeFile` and `executeFileContinued` utility functions from `package:tom_d4rt_exec/src/script_execution.dart` for file-based execution.

**executeFile — Fresh execution:**
```dart
import 'package:tom_d4rt_exec/src/script_execution.dart';
