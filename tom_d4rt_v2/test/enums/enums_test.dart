...
void main() {
  group('Enum Tests', () {
    test('I-ENUM-34: Enum Value Access. [2026-02-10 06:37] (PASS)', () {
      const source = '''
        enum Color { red, green, blue }
    ...
    test('I-ENUM-40: Enum Index Access. [2026-02-10 06:37] (PASS)', () {
      const source = '''
        enum Status { pending, running, completed, failed }
    ...
    test('I-ENUM-44: Enum Static Values List. [2026-02-10 06:37] (PASS)', () {
      const source = '''
        enum Color { red, green, blue }
    ...
    test('I-ENUM-46: Enum Comparison. [2026-02-10 06:37] (PASS)', () {
      const source = '''
        enum Status { pending, running, completed, failed }
    ...
    test('I-ENUM-47: Enum in Switch Statement. [2026-02-10 06:37] (PASS)', () {
      const source = '''
        enum Status { pending, running, completed, failed }
  ...
  group('Enum Tests', () {
    ...
    test('I-ENUM-37: Enum in switch statement. [2026-02-10 06:37] (PASS)', () {
      const source = '''
        enum TrafficLight {
          red,
          yellow,
    ...
    test('I-ENUM-38: Enum with methods. [2026-02-10 06:37] (PASS)', () {
      const source = '''
        enum Planet {
          mercury(0.38),
          venus(0.91),
