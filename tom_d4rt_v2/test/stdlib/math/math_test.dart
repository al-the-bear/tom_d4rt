...
void main() {
  group('MathCore tests', () {
    test('I-MISC-427: Math constants. [2026-02-10 06:37] (PASS)', () {
      const source = '''
      import 'dart:math';
      main() {
    ...
    test('I-MISC-424: Math functions. [2026-02-10 06:37] (PASS)', () {
      const source = '''
      import 'dart:math';
      main() {
        return [
  ...
  group('RandomCore tests', () {
    test('I-MISC-423: Random methods. [2026-02-10 06:37] (PASS)', () {
      const source = '''
      import 'dart:math';
      main() {
