  ...
  return Scaffold(
    ...
    body: Padding(
      ...
      child: Column(
        ...
        children: [
          const Text('Binary Deserialization',
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Buffer: [2A 00 00 00 1F 85 EB 51 B8 1E 09 40]', style: TextStyle(fontFamily: 'monospace', fontSize: 11)),
                const SizedBox(height: 16),
                ...
                const Row(children: [
                  ...
                  SizedBox(width: 4),
                  Text('Position: 12 bytes', style: TextStyle(fontFamily: 'monospace', fontSize: 11)),
                ]),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: const Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Read Methods:', style: TextStyle(fontWeight: FontWeight.bold)),
                SizedBox(height: 4),
...
class _ReadOp extends StatelessWidget {
  ...
  final String result;
  final String bytes;
  const _ReadOp({required this.method, required this.result, required this.bytes});
  @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(children: [
        ...
        const Spacer(),
        Text('(\$bytes bytes)', style: const TextStyle(fontSize: 10, color: Colors.grey)),
      ]),
    );
  }
}
