// D4rt comprehensive test script for TextInputControl
...
class _TextInputControlProbe implements TextInputControl {
  _TextInputControlProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _TextInputControlProbe probe,
...
dynamic build(BuildContext context) {
  print('=== TextInputControl comprehensive script start ===');

  final _TextInputControlProbe primary = _TextInputControlProbe(
    'primary',
    seed: 7,
  );
  final _TextInputControlProbe edge = _TextInputControlProbe('', seed: -3);
  final _TextInputControlProbe large = _TextInputControlProbe(
    'large-case',
    seed: 999,
  );
  ...
  print('=== TextInputControl comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('TextInputControl Summary'),
