// D4rt comprehensive test script for TextInputClient
...
class _TextInputClientProbe implements TextInputClient {
  _TextInputClientProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _TextInputClientProbe probe,
...
dynamic build(BuildContext context) {
  print('=== TextInputClient comprehensive script start ===');

  final _TextInputClientProbe primary = _TextInputClientProbe(
    'primary',
    seed: 7,
  );
  final _TextInputClientProbe edge = _TextInputClientProbe('', seed: -3);
  final _TextInputClientProbe large = _TextInputClientProbe(
    'large-case',
    seed: 999,
  );
  ...
  print('=== TextInputClient comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('TextInputClient Summary'),
