// Comprehensive D4rt test script: PageStorageKey from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PageStorageKey script ===');
  ...
  detailLines.add('target=PageStorageKey');
  ...
  const PageStorageKey<String> key1 = PageStorageKey<String>('page-1');
  const PageStorageKey<String> key2 = PageStorageKey<String>('page-1');
  check(key1 == key2, 'Same value keys are equal');
  const PageStorageKey<String> key3 = PageStorageKey<String>('page-2');
  check(key1 != key3, 'Different value keys differ');
  detailLines.add('key1Value=page-1');
