// Comprehensive D4rt test script: RestorableBool from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableBool script ===');
  ...
  detailLines.add('target=RestorableBool');
  ...
  final RestorableBool prop = RestorableBool(true);
  check(prop is RestorableBool, 'Created');
  check(prop.value == true, 'Initial value is true');
  detailLines.add('initialValue=true');
  prop.dispose();
