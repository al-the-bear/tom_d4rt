// Comprehensive D4rt test script: UserScrollNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UserScrollNotification script ===');
  ...
  detailLines.add('target=UserScrollNotification');
  ...
  const String targetTypeName = 'UserScrollNotification';
  detailLines.add('category=widgets_scroll');
  detailLines.add('desc=Notification about user-initiated scrolling');
  check(targetTypeName.contains('Scroll'), 'Has Scroll');
  check(targetTypeName.contains('Notification'), 'Has Notification');
