// Comprehensive D4rt test script: InspectorReferenceData from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InspectorReferenceData script ===');
  ...
  detailLines.add('target=InspectorReferenceData');
  ...
  const String targetTypeName = 'InspectorReferenceData';
  check(targetTypeName.contains('Reference'), 'Name includes Reference');
  detailLines.add('description=Reference data for widget inspector');
  detailLines.add('usedBy=Flutter DevTools inspector');
