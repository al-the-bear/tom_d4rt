...
dynamic build(BuildContext context) {
  ...
  final GlobalKey<SliverAnimatedGridState> key =
      GlobalKey<SliverAnimatedGridState>();
  final SliverAnimatedGrid grid = SliverAnimatedGrid(
    key: key,
    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
      crossAxisCount: 3,
    ),
    itemBuilder: (BuildContext ctx, int index, Animation<double> anim) {
