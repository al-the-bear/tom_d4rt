// Comprehensive D4rt test script: RawMagnifier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawMagnifier script ===');
  ...
  detailLines.add('target=RawMagnifier');
  ...
  final Widget mag = RawMagnifier(
    size: const Size(80, 80),
    child: Container(color: const Color(0xFF10B981)),
  );
  check(mag is RawMagnifier, 'RawMagnifier created');
  check(mag is Widget, 'Is a Widget');
  detailLines.add('size=80x80');
