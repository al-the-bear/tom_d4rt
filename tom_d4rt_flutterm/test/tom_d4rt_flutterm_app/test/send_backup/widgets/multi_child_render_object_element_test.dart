// Comprehensive D4rt test script: MultiChildRenderObjectElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MultiChildRenderObjectElement script ===');
  ...
  detailLines.add('target=MultiChildRenderObjectElement');
  ...
  const String targetTypeName = 'MultiChildRenderObjectElement';
  check(targetTypeName.contains('Element'), 'Name includes Element');
  detailLines.add('description=Element for multi-child RenderObject widgets');
  final Widget stack = Stack(children: const <Widget>[Text('A'), Text('B')]);
  check(stack is Stack, 'Stack (MultiChildRenderObjectWidget) created');
