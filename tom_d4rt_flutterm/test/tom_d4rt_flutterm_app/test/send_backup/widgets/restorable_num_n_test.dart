// Comprehensive D4rt test script: RestorableNumN from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableNumN script ===');
  ...
  detailLines.add('target=RestorableNumN');
  ...
  const String targetTypeName = 'RestorableNumN';
  check(targetTypeName.contains('Num'), 'Name includes Num');
  detailLines.add('description=Restorable nullable num');
  final RestorableDoubleN rdn = RestorableDoubleN(null);
  check(rdn.value == null, 'Nullable num initial is null');
  rdn.dispose();
