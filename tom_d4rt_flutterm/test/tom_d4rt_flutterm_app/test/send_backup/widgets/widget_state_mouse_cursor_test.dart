// Comprehensive D4rt test script: WidgetStateMouseCursor from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStateMouseCursor script ===');
  ...
  detailLines.add('target=WidgetStateMouseCursor');
  ...
  const String targetTypeName = 'WidgetStateMouseCursor';
  detailLines.add('category=widgets_state');
  detailLines.add('desc=Mouse cursor resolved from widget states');
  check(targetTypeName.contains('MouseCursor'), 'Has MouseCursor');
