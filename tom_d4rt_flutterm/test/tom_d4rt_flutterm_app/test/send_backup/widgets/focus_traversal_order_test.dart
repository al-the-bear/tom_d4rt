// Comprehensive D4rt test script: FocusTraversalOrder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive FocusTraversalOrder script ===');
  ...
  detailLines.add('target=FocusTraversalOrder');
  ...
  // FocusTraversalOrder: assigns traversal order to a focus node
  final Widget ordered = FocusTraversalOrder(
    order: const NumericFocusOrder(1.0),
    child: const Focus(child: Text('Ordered focus')),
  );
  check(ordered is FocusTraversalOrder, 'FocusTraversalOrder created');
  check(ordered is Widget, 'FocusTraversalOrder is a Widget');
