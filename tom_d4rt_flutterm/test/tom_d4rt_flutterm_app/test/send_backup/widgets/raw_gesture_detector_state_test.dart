// Comprehensive D4rt test script: RawGestureDetectorState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawGestureDetectorState script ===');
  ...
  detailLines.add('target=RawGestureDetectorState');
  ...
  const String targetTypeName = 'RawGestureDetectorState';
  check(targetTypeName.contains('State'), 'Name includes State');
  detailLines.add('description=State for RawGestureDetector');
  final Widget gd = RawGestureDetector(child: const Text('Gesture'));
  check(gd is RawGestureDetector, 'RawGestureDetector created');
