// Comprehensive D4rt test script: SensitiveContent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SensitiveContent script ===');
  ...
  detailLines.add('target=SensitiveContent');
  ...
  const String targetTypeName = 'SensitiveContent';
  check(targetTypeName.contains('Sensitive'), 'Name includes Sensitive');
  detailLines.add('description=Widget that marks content as sensitive');
