// Comprehensive D4rt test script: ScrollPhysics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollPhysics script ===');
  ...
  detailLines.add('target=ScrollPhysics');
  ...
  check(physics is ScrollPhysics, 'Created');
  detailLines.add('physicsType=ScrollPhysics');
  const BouncingScrollPhysics bouncing = BouncingScrollPhysics();
  check(bouncing is ScrollPhysics, 'BouncingScrollPhysics is ScrollPhysics');
  const ClampingScrollPhysics clamping = ClampingScrollPhysics();
  check(clamping is ScrollPhysics, 'ClampingScrollPhysics is ScrollPhysics');
