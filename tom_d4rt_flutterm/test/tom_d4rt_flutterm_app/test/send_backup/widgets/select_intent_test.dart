// Comprehensive D4rt test script: SelectIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectIntent script ===');
  ...
  detailLines.add('target=SelectIntent');
  ...
  const String targetTypeName = 'SelectIntent';
  check(targetTypeName.contains('Select'), 'Name includes Select');
  detailLines.add('description=Intent to select');
