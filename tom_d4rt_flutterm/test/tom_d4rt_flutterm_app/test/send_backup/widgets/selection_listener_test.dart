// Comprehensive D4rt test script: SelectionListener from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionListener script ===');
  ...
  detailLines.add('target=SelectionListener');
  ...
  const String targetTypeName = 'SelectionListener';
  check(targetTypeName.contains('Listener'), 'Name includes Listener');
  detailLines.add('description=Listener for text selection events');
