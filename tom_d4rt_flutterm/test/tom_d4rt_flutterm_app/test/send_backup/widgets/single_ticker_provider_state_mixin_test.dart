...
class _SingleTickerProbeState extends State<StatefulWidget>
...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    stateA is SingleTickerProviderStateMixin,
    'stateA mixes in SingleTickerProviderStateMixin',
    logs,
    counters,
  );
  expectCondition(
    tickerA.isActive == false,
    'tickerA initially inactive',
    logs,
    counters,
  );
  expectCondition(
    tickerB.isActive == false,
    'tickerB initially inactive',
    logs,
    counters,
  );
  tickerA.dispose();
