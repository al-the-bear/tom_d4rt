// Comprehensive D4rt test script: RadioGroupRegistry from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RadioGroupRegistry script ===');
  ...
  detailLines.add('target=RadioGroupRegistry');
  ...
  const String targetTypeName = 'RadioGroupRegistry';
  check(targetTypeName.contains('Radio'), 'Name includes Radio');
  detailLines.add('description=Registry for RadioGroup coordination');
