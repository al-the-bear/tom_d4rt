...
dynamic build(BuildContext context) {
  print(
    '=== Running comprehensive GestureRecognizerFactoryWithHandlers script ===',
  );
  ...
  detailLines.add(
    'description=Concrete GestureRecognizerFactory with handler callbacks',
  );
  ...
  check(
    ...
    'GestureDetector with multiple handlers created',
  );
