// D4rt comprehensive test script for RouteAware
...
class _RouteAwareProbe implements RouteAware {
  _RouteAwareProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _RouteAwareProbe probe,
...
dynamic build(BuildContext context) {
  print('=== RouteAware comprehensive script start ===');

  final _RouteAwareProbe primary = _RouteAwareProbe('primary', seed: 7);
  final _RouteAwareProbe edge = _RouteAwareProbe('', seed: -3);
  final _RouteAwareProbe large = _RouteAwareProbe('large-case', seed: 999);
  ...
  print('=== RouteAware comprehensive script done ===');
