...
class _RestorationProbeState extends State<StatefulWidget>
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    print(
      'restoreState called: id=$_id initialRestore=$initialRestore oldBucket=${oldBucket != null}',
    );
  }
...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    stateA is RestorationMixin,
    'stateA mixes in RestorationMixin',
    logs,
    counters,
  );
  expectCondition(
    stateA.restorationId == 'alpha',
    'restorationId returned from constructor data',
    logs,
    counters,
  );
  expectCondition(
    stateB.restorationId == '',
    'edge case empty restoration id supported',
    logs,
    counters,
  );
