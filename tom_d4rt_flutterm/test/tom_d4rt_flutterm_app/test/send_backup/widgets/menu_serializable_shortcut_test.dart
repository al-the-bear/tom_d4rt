// D4rt comprehensive test script for MenuSerializableShortcut
...
class _MenuSerializableShortcutProbe implements MenuSerializableShortcut {
  _MenuSerializableShortcutProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _MenuSerializableShortcutProbe probe,
...
dynamic build(BuildContext context) {
  print('=== MenuSerializableShortcut comprehensive script start ===');

  final _MenuSerializableShortcutProbe primary = _MenuSerializableShortcutProbe(
    'primary',
    seed: 7,
  );
  final _MenuSerializableShortcutProbe edge = _MenuSerializableShortcutProbe(
    '',
    seed: -3,
  );
  final _MenuSerializableShortcutProbe large = _MenuSerializableShortcutProbe(
    'large-case',
    seed: 999,
  );
  ...
  print('=== MenuSerializableShortcut comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('MenuSerializableShortcut Summary'),
