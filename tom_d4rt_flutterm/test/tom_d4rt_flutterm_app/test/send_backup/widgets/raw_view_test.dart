// Comprehensive D4rt test script: RawView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawView script ===');
  ...
  detailLines.add('target=RawView');
  ...
  const String targetTypeName = 'RawView';
  check(targetTypeName.contains('View'), 'Name includes View');
  detailLines.add('description=Low-level view widget');
  final Widget view = const SizedBox.expand();
  check(view is SizedBox, 'SizedBox (placeholder for view) created');
