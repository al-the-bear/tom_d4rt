...
dynamic build(BuildContext context) {
  ...
  const SliverIgnorePointer ignore = SliverIgnorePointer(
    sliver: SliverToBoxAdapter(child: SizedBox(height: 80)),
  );
  check(ignore is Widget, 'Is Widget');
  check(ignore.ignoring == true, 'Default ignoring=true');
  const SliverIgnorePointer notIgnore = SliverIgnorePointer(
    ignoring: false,
    sliver: SliverToBoxAdapter(child: SizedBox(height: 80)),
  );
