// Comprehensive D4rt test script: ShortcutRegistry from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShortcutRegistry script ===');
  ...
  detailLines.add('target=ShortcutRegistry');
  ...
  const String targetTypeName = 'ShortcutRegistry';
  detailLines.add('category=widgets_shortcuts');
  detailLines.add('desc=Registry for keyboard shortcuts');
  check(targetTypeName.contains('Registry'), 'Name contains Registry');
