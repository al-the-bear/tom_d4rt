// Comprehensive D4rt test script: WidgetsLocalizations from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetsLocalizations script ===');
  ...
  detailLines.add('target=WidgetsLocalizations');
  ...
  const String targetTypeName = 'WidgetsLocalizations';
  detailLines.add('category=widgets_l10n');
  detailLines.add('desc=Default localizations for widgets');
  check(targetTypeName.contains('Localizations'), 'Has Localizations');
