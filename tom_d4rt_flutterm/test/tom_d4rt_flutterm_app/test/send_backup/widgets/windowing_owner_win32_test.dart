// Comprehensive D4rt test script: WindowingOwnerWin32 from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WindowingOwnerWin32 script ===');
  ...
  detailLines.add('target=WindowingOwnerWin32');
  ...
  const String targetTypeName = 'WindowingOwnerWin32';
  detailLines.add('category=widgets_window');
  detailLines.add('desc=Win32 windowing owner implementation');
  check(targetTypeName.contains('Win32'), 'Has Win32');
