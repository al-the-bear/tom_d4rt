// Comprehensive D4rt test script: SliverMultiBoxAdaptorElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverMultiBoxAdaptorElement script ===');
  ...
  detailLines.add('target=SliverMultiBoxAdaptorElement');
  ...
  const String targetTypeName = 'SliverMultiBoxAdaptorElement';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=Element for multi-box adaptor slivers');
