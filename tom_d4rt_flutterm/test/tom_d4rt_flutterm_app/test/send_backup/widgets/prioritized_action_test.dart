// Comprehensive D4rt test script: PrioritizedAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PrioritizedAction script ===');
  ...
  detailLines.add('target=PrioritizedAction');
  ...
  final PrioritizedAction action = PrioritizedAction();
  check(action is PrioritizedAction, 'Created');
  check(action is Action, 'Is an Action');
