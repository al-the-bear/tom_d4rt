...
dynamic build(BuildContext context) {
  ...
  final TreeSliver<String> tree = TreeSliver<String>(
    tree: <TreeSliverNode<String>>[
      TreeSliverNode<String>('A'),
      TreeSliverNode<String>('B'),
    ],
    treeNodeBuilder:
        (BuildContext ctx, TreeSliverNode<Object?> node, AnimationStyle anim) {
