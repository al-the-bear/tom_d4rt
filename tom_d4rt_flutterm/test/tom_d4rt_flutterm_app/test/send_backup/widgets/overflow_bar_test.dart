// Comprehensive D4rt test script: OverflowBar from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OverflowBar script ===');
  ...
  detailLines.add('target=OverflowBar');
  ...
  check(bar is OverflowBar, 'OverflowBar created');
  check(bar is MultiChildRenderObjectWidget, 'Is MultiChildRenderObjectWidget');
  detailLines.add('spacing=8.0');
