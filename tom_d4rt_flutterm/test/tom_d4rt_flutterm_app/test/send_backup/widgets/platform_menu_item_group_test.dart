// Comprehensive D4rt test script: PlatformMenuItemGroup from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformMenuItemGroup script ===');
  ...
  detailLines.add('target=PlatformMenuItemGroup');
  ...
  final PlatformMenuItemGroup group = PlatformMenuItemGroup(
    members: const <PlatformMenuItem>[],
  );
  check(group is PlatformMenuItemGroup, 'PlatformMenuItemGroup created');
  check(group is PlatformMenuItem, 'Is a PlatformMenuItem');
