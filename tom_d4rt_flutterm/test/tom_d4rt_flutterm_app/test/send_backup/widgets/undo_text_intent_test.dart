// Comprehensive D4rt test script: UndoTextIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UndoTextIntent script ===');
  ...
  detailLines.add('target=UndoTextIntent');
  ...
  const String targetTypeName = 'UndoTextIntent';
  detailLines.add('category=widgets_intent');
  detailLines.add('desc=Intent to undo text changes');
  const String intentName = 'UndoTextIntent';
  check(intentName.contains('Undo'), 'Has Undo');
  check(intentName.contains('Text'), 'Has Text');
