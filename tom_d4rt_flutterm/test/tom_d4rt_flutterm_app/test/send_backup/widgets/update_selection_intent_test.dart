// Comprehensive D4rt test script: UpdateSelectionIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UpdateSelectionIntent script ===');
  ...
  detailLines.add('target=UpdateSelectionIntent');
  ...
  const String targetTypeName = 'UpdateSelectionIntent';
  detailLines.add('category=widgets_intent');
  detailLines.add('desc=Intent to update text selection');
