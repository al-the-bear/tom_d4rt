...
dynamic build(BuildContext context) {
  ...
  // Test with parent
  final FixedExtentScrollPhysics withParent = FixedExtentScrollPhysics(
    parent: const BouncingScrollPhysics(),
  );
  check(
    withParent.parent is BouncingScrollPhysics,
    'Parent physics set to bouncing',
  );
  detailLines.add(
    'parentType=' + (withParent.parent?.runtimeType.toString() ?? 'null'),
  );
