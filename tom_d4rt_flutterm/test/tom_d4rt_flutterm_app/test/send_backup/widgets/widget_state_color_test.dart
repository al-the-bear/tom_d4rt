// Comprehensive D4rt test script: WidgetStateColor from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStateColor script ===');
  ...
  detailLines.add('target=WidgetStateColor');
  ...
  const String targetTypeName = 'WidgetStateColor';
  detailLines.add('category=widgets_state');
  detailLines.add('desc=Color resolved from widget states');
  check(targetTypeName.contains('Color'), 'Has Color');
