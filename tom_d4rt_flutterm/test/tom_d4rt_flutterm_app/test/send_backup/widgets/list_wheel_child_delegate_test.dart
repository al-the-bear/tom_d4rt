...
dynamic build(BuildContext context) {
  ...
  detailLines.add(
    'description=Abstract delegate for ListWheelScrollView children',
  );
  final ListWheelChildListDelegate ld = ListWheelChildListDelegate(
    children: const <Widget>[Text('A')],
  );
  check(
    ld is ListWheelChildDelegate,
    'ListWheelChildListDelegate is ListWheelChildDelegate',
  );
