// Comprehensive D4rt test script: ScrollHoldController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollHoldController script ===');
  ...
  detailLines.add('target=ScrollHoldController');
  ...
  const String targetTypeName = 'ScrollHoldController';
  check(targetTypeName.contains('Hold'), 'Name includes Hold');
  detailLines.add('description=Controller for scroll hold');
