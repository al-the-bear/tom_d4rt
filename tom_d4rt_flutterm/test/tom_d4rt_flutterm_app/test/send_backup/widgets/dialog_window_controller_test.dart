...
/// Deep visual demo for DialogWindowController
dynamic build(BuildContext context) {
  return Scaffold(appBar: AppBar(title: Text('DialogWindowController')), body: Padding(padding: EdgeInsets.all(16), child: Column(children: [
    Text('DialogWindowController', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
    SizedBox(height: 8),
    Text('Dialog window controller base', style: TextStyle(fontSize: 12, color: Colors.grey)),
    SizedBox(height: 16),
    Expanded(child: Container(padding: EdgeInsets.all(16), decoration: BoxDecoration(color: Colors.orange.shade50, borderRadius: BorderRadius.circular(12)),
      child: Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        SizedBox(height: 12),
        Text('DialogWindowController Demo', style: TextStyle(fontWeight: FontWeight.bold)),
      ])))),
