// D4rt comprehensive test script for PopNavigatorRouterDelegateMixin
...
class _PopNavigatorRouterDelegateMixinProbe
    implements PopNavigatorRouterDelegateMixin {
  _PopNavigatorRouterDelegateMixinProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _PopNavigatorRouterDelegateMixinProbe probe,
...
dynamic build(BuildContext context) {
  print('=== PopNavigatorRouterDelegateMixin comprehensive script start ===');

  final _PopNavigatorRouterDelegateMixinProbe primary =
      _PopNavigatorRouterDelegateMixinProbe('primary', seed: 7);
  final _PopNavigatorRouterDelegateMixinProbe edge =
      _PopNavigatorRouterDelegateMixinProbe('', seed: -3);
  final _PopNavigatorRouterDelegateMixinProbe large =
      _PopNavigatorRouterDelegateMixinProbe('large-case', seed: 999);
  ...
  print('=== PopNavigatorRouterDelegateMixin comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('PopNavigatorRouterDelegateMixin Summary'),
