// D4rt comprehensive test script for TextSelectionHandleControls
...
class _TextSelectionHandleControlsProbe implements TextSelectionHandleControls {
  _TextSelectionHandleControlsProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _TextSelectionHandleControlsProbe probe,
...
dynamic build(BuildContext context) {
  print('=== TextSelectionHandleControls comprehensive script start ===');

  final _TextSelectionHandleControlsProbe primary =
      _TextSelectionHandleControlsProbe('primary', seed: 7);
  final _TextSelectionHandleControlsProbe edge =
      _TextSelectionHandleControlsProbe('', seed: -3);
  final _TextSelectionHandleControlsProbe large =
      _TextSelectionHandleControlsProbe('large-case', seed: 999);
  ...
  print('=== TextSelectionHandleControls comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('TextSelectionHandleControls Summary'),
