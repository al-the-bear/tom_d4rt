...
dynamic build(BuildContext context) {
  ...
  detailLines.add(
    'description=A slot with an index used during updateChildren',
  );
  ...
  final Widget stack = Stack(
    children: <Widget>[
      Positioned(
        left: 0,
        child: Container(width: 50, height: 50, color: const Color(0xFFEF4444)),
      ),
      Positioned(
        left: 60,
        child: Container(width: 50, height: 50, color: const Color(0xFF3B82F6)),
      ),
    ],
  );
