// Comprehensive D4rt test script: RestorableProperty from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableProperty script ===');
  ...
  detailLines.add('target=RestorableProperty');
  ...
  const String targetTypeName = 'RestorableProperty';
  check(targetTypeName.contains('Property'), 'Name includes Property');
  detailLines.add('description=Base class for restorable properties');
  final RestorableBool rb = RestorableBool(false);
  check(rb is RestorableProperty, 'RestorableBool is RestorableProperty');
  check(rb.value == false, 'Value is false');
  rb.dispose();
