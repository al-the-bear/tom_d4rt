// Comprehensive D4rt test script: MenuController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MenuController script ===');
  ...
  detailLines.add('target=MenuController');
  ...
  check(controller is MenuController, 'MenuController created');
  final Widget menuAnchor = MenuAnchor(
    controller: controller,
    menuChildren: const <Widget>[MenuItemButton(child: Text('A'))],
    child: const Text('Menu'),
  );
  check(menuAnchor is MenuAnchor, 'MenuAnchor with controller created');
