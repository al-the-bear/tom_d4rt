// Comprehensive D4rt test script: SliverWithKeepAliveWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverWithKeepAliveWidget script ===');
  ...
  detailLines.add('target=SliverWithKeepAliveWidget');
  ...
  const String targetTypeName = 'SliverWithKeepAliveWidget';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=Sliver widget that keeps children alive');
  check(targetTypeName.contains('KeepAlive'), 'Has KeepAlive');
