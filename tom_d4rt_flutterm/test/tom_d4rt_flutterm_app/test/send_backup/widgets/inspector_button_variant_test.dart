...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    values.isNotEmpty,
    'InspectorButtonVariant.values should not be empty',
    logs,
    counters,
  );
  expectCondition(
    values.length >= 2,
    'InspectorButtonVariant should provide multiple values',
    logs,
    counters,
  );
  ...
  for (final InspectorButtonVariant value in values) {
    ...
    final InspectorButtonVariant byName = InspectorButtonVariant.values.byName(
      value.name,
    );
    expectCondition(
      byName == value,
  ...
  final List<InspectorButtonVariant> copied = List<InspectorButtonVariant>.from(
    values,
  );
  expectCondition(
  ...
  final List<InspectorButtonVariant> reversed = values.reversed.toList(
    growable: false,
  );
  expectCondition(
    reversed.first == last,
  ...
  final InspectorButtonVariant edgeByName = InspectorButtonVariant.values
      .byName(edgeName);
  expectCondition(
