// Comprehensive D4rt test script: Flex from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Flex script ===');
  ...
  check(flex is Flex, 'Flex created');
  check(flex is Widget, 'Flex is a Widget');
  detailLines.add('direction=horizontal');
  final Widget vertFlex = Flex(
    direction: Axis.vertical,
    mainAxisAlignment: MainAxisAlignment.center,
    crossAxisAlignment: CrossAxisAlignment.stretch,
    children: const <Widget>[Text('X'), Text('Y')],
  );
  check(vertFlex is Flex, 'Vertical Flex created');
  // Row and Column are Flex subclasses
  check(Row(children: const <Widget>[]) is Flex, 'Row is a Flex');
  check(Column(children: const <Widget>[]) is Flex, 'Column is a Flex');
