// Comprehensive D4rt test script: SelectableRegionState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectableRegionState script ===');
  ...
  detailLines.add('target=SelectableRegionState');
  ...
  const String targetTypeName = 'SelectableRegionState';
  check(targetTypeName.contains('State'), 'Name includes State');
  detailLines.add('description=State for SelectableRegion');
  final Widget text = const SelectableText('Selectable state');
