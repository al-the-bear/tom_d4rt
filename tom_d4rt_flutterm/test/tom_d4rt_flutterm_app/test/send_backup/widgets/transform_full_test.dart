...
dynamic build(BuildContext context) {
  ...
  final Transform rotate = Transform.rotate(
    angle: 0.5,
    child: Container(width: 80, height: 80, color: const Color(0xFF42A5F5)),
  );
  check(rotate is Widget, 'Rotate is Widget');
  final Transform scale = Transform.scale(
    scale: 1.5,
    child: const SizedBox(width: 50, height: 50),
  );
  check(scale is Widget, 'Scale is Widget');
  final Transform translate = Transform.translate(
