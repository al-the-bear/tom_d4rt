// Comprehensive D4rt test script: StatelessElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive StatelessElement script ===');
  ...
  detailLines.add('target=StatelessElement');
  ...
  const String targetTypeName = 'StatelessElement';
  detailLines.add('category=widgets_element');
  detailLines.add('desc=Element backing StatelessWidget');
  check(targetTypeName.contains('Stateless'), 'Has Stateless');
