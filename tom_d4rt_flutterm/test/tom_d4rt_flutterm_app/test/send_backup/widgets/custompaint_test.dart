...
/// Deep visual demo for CustomPaint
dynamic build(BuildContext context) {
  return Scaffold(appBar: AppBar(title: Text('CustomPaint')), body: Padding(padding: EdgeInsets.all(16), child: Column(children: [
    Text('CustomPaint', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
    SizedBox(height: 8),
    Text('Custom canvas painting widget', style: TextStyle(fontSize: 12, color: Colors.grey)),
    SizedBox(height: 16),
    Expanded(child: Container(padding: EdgeInsets.all(16), decoration: BoxDecoration(color: Colors.blue.shade50, borderRadius: BorderRadius.circular(12)),
      child: Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        SizedBox(height: 12),
        Text('CustomPaint Demo', style: TextStyle(fontWeight: FontWeight.bold)),
      ])))),
