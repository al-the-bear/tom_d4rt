// Comprehensive D4rt test script: FractionalTranslation from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive FractionalTranslation script ===');
  ...
  detailLines.add('target=FractionalTranslation');
  ...
  // FractionalTranslation: translates child by fraction of its size
  final Widget ft = FractionalTranslation(
    translation: const Offset(0.5, 0.25),
    child: Container(width: 100, height: 100, color: const Color(0xFF8B5CF6)),
  );
  check(ft is FractionalTranslation, 'FractionalTranslation created');
  check(ft is Widget, 'FractionalTranslation is a Widget');
  detailLines.add('translation=Offset(0.5, 0.25)');
