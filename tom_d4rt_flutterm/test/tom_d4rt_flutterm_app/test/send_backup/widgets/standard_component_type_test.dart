...
dynamic build(BuildContext context) {
  ...
  final List<StandardComponentType> values = StandardComponentType.values
      .toList(growable: false);
  _expect(
    values.isNotEmpty,
    'StandardComponentType exposes at least one enum value',
  );
  _expect(
  ...
  final List<StandardComponentType> reversed = values.reversed.toList(
    growable: false,
  );
  ...
  final String summary =
      'StandardComponentType checks passed: ${values.length} values validated';
  print(summary);
