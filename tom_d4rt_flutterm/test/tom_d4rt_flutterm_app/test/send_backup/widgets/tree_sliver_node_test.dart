// Comprehensive D4rt test script: TreeSliverNode from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TreeSliverNode script ===');
  ...
  detailLines.add('target=TreeSliverNode');
  ...
  const String targetTypeName = 'TreeSliverNode';
  detailLines.add('category=widgets_tree');
  detailLines.add('desc=Node in a TreeSliver data model');
  final TreeSliverNode<String> node = TreeSliverNode<String>('Root');
  check(node.content == 'Root', 'Content=Root');
  detailLines.add('content=Root');
