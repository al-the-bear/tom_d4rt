// Comprehensive D4rt test script: GlowingOverscrollIndicator from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive GlowingOverscrollIndicator script ===');
  ...
  detailLines.add('target=GlowingOverscrollIndicator');
  ...
  // GlowingOverscrollIndicator: shows glow when overscrolling
  final Widget glow = GlowingOverscrollIndicator(
    axisDirection: AxisDirection.down,
    color: const Color(0xFF3B82F6),
    child: const SingleChildScrollView(child: Text('Scroll content')),
  );
  check(glow is GlowingOverscrollIndicator, 'Glow indicator created');
  detailLines.add('axisDirection=down');
  detailLines.add('color=0xFF3B82F6');
