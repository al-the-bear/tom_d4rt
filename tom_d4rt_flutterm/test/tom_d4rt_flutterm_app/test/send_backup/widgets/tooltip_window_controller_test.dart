// Comprehensive D4rt test script: TooltipWindowController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TooltipWindowController script ===');
  ...
  detailLines.add('target=TooltipWindowController');
  ...
  const String targetTypeName = 'TooltipWindowController';
  detailLines.add('category=widgets_tooltip');
  detailLines.add('desc=Controls tooltip window display');
  check(targetTypeName.contains('Controller'), 'Has Controller');
