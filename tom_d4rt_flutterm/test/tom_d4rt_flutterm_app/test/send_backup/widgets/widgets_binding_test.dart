...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    bindingA is WidgetsBinding,
    'bindingA is WidgetsBinding',
    logs,
    counters,
  );
  expectCondition(
    identical(bindingA, bindingB),
    'ensureInitialized and instance return same binding',
    logs,
    counters,
  );
  expectCondition(
    rootPipeline != null,
    'pipelineOwner is available',
    logs,
    counters,
  );
  expectCondition(
    dispatcher != null,
    'platformDispatcher is available',
    logs,
    counters,
  );
