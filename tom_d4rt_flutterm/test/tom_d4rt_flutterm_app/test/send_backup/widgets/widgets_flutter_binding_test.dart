// Comprehensive D4rt test script: WidgetsFlutterBinding from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetsFlutterBinding script ===');
  ...
  detailLines.add('target=WidgetsFlutterBinding');
  ...
  const String targetTypeName = 'WidgetsFlutterBinding';
  detailLines.add('category=widgets_binding');
  detailLines.add('desc=Main binding for widgets Flutter app');
  check(targetTypeName.contains('Binding'), 'Has Binding');
