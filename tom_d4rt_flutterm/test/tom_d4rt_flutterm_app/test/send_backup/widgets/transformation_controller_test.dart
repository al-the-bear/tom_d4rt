// Comprehensive D4rt test script: TransformationController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TransformationController script ===');
  ...
  detailLines.add('target=TransformationController');
  ...
  check(ctrl is ValueNotifier<Matrix4>, 'Is ValueNotifier<Matrix4>');
  check(ctrl.value == Matrix4.identity(), 'Initial=identity');
  ctrl.value = Matrix4.translationValues(10, 20, 0);
  check(ctrl.value != Matrix4.identity(), 'Changed');
  ctrl.dispose();
  detailLines.add('desc=Controls transformation matrix');
