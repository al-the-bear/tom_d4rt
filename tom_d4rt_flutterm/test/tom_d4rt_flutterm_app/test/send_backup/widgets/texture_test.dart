// Comprehensive D4rt test script: Texture from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Texture script ===');
  ...
  detailLines.add('target=Texture');
  ...
  const Texture tex = Texture(textureId: 42);
  check(tex is Widget, 'Is Widget');
  check(tex.textureId == 42, 'Texture ID');
  const Texture tex2 = Texture(textureId: 0, filterQuality: FilterQuality.high);
  check(tex2.textureId == 0, 'ID=0');
  check(tex2.filterQuality == FilterQuality.high, 'Quality=high');
  detailLines.add('textureId=42');
