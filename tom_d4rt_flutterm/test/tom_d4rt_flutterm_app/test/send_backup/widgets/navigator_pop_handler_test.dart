// Comprehensive D4rt test script: NavigatorPopHandler from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NavigatorPopHandler script ===');
  ...
  detailLines.add('target=NavigatorPopHandler');
  ...
  final Widget handler = NavigatorPopHandler(
    onPop: () {
      print('popped');
    },
    child: const Text('Pop handler child'),
  );
  check(handler is NavigatorPopHandler, 'NavigatorPopHandler created');
  check(handler is Widget, 'NavigatorPopHandler is a Widget');
