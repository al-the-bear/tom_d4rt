// Comprehensive D4rt test script: PlatformMenuItem from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformMenuItem script ===');
  ...
  detailLines.add('target=PlatformMenuItem');
  ...
  final PlatformMenuItem item = PlatformMenuItem(
    label: 'Test Item',
    onSelected: () {
      print('selected');
    },
  );
  check(item is PlatformMenuItem, 'PlatformMenuItem created');
  check(item.label == 'Test Item', 'Label is correct');
  detailLines.add('label=Test Item');
