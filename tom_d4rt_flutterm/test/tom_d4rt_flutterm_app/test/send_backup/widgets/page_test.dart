// Comprehensive D4rt test script: Page from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Page script ===');
  ...
  // Page is abstract - MaterialPage is a concrete subclass
  final Page<void> page = MaterialPage<void>(child: const Text('Page content'));
  check(page is Page, 'MaterialPage is a Page');
  check(page.key == null, 'No key by default');
  detailLines.add('pageType=' + page.runtimeType.toString());
