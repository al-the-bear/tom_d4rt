...
dynamic build(BuildContext context) {
  print('--- TextAlign comprehensive test start ---');

  final values = TextAlign.values;
  ...
  print('TextAlign values count: ${values.length}');
  print('TextAlign names: $names');
  print('TextAlign indexes: $indexes');
  ...
  try {
    TextAlign.values.byName('__invalid_text_align__');
  } catch (error) {
    invalidNameThrows = true;
    print('Expected TextAlign byName failure: $error');
  }
  ...
  print(summary);
  print('--- TextAlign comprehensive test complete ---');
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        const Text('TextAlign Comprehensive Tests'),
