...
dynamic build(BuildContext context) {
  ...
  _expect(
    physics.runtimeType.toString().contains('CarouselScrollPhysics'),
    'constructor creates physics instance',
    logs,
  );
  assertionCount++;
  _expect(
    applied.runtimeType.toString().contains('CarouselScrollPhysics'),
    'applyTo preserves physics type',
    logs,
  );
  assertionCount++;
  _expect(
    reapplied.allowImplicitScrolling,
    'allowImplicitScrolling is true',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    const CarouselScrollPhysics().parent == null,
    'edge case supports null parent',
    logs,
  );
  assertionCount++;
  ...
  return Column(
    ...
    children: [
      ...
      Text(
        'Implicit scrolling: ' + reapplied.allowImplicitScrolling.toString(),
      ),
