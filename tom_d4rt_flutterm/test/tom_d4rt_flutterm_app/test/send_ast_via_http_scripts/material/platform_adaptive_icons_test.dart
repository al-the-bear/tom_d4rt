// Comprehensive D4rt test script: PlatformAdaptiveIcons from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformAdaptiveIcons script ===');
  ...
  final Type targetType = PlatformAdaptiveIcons;
  ...
  detailLines.add('target=PlatformAdaptiveIcons');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PlatformAdaptiveIcons'), 'Target type symbol resolves');
