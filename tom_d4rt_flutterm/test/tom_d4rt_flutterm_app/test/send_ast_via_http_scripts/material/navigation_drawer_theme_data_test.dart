// Comprehensive D4rt test script: NavigationDrawerThemeData from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NavigationDrawerThemeData script ===');
  ...
  final Type targetType = NavigationDrawerThemeData;
  ...
  detailLines.add('target=NavigationDrawerThemeData');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('NavigationDrawerThemeData'), 'Target type symbol resolves');
