// Comprehensive D4rt test script: ModalBottomSheetRoute from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ModalBottomSheetRoute script ===');
  ...
  final Type targetType = ModalBottomSheetRoute;
  ...
  detailLines.add('target=ModalBottomSheetRoute');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ModalBottomSheetRoute'), 'Target type symbol resolves');
