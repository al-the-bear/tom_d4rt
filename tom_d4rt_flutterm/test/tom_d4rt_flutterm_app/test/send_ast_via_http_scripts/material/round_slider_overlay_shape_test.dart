// Comprehensive D4rt test script: RoundSliderOverlayShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundSliderOverlayShape script ===');
  ...
  final Type targetType = RoundSliderOverlayShape;
  ...
  detailLines.add('target=RoundSliderOverlayShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundSliderOverlayShape'), 'Target type symbol resolves');
