// Comprehensive D4rt test script: PersistentBottomSheetController from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PersistentBottomSheetController script ===');
  ...
  final Type targetType = PersistentBottomSheetController;
  ...
  detailLines.add('target=PersistentBottomSheetController');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PersistentBottomSheetController'), 'Target type symbol resolves');
