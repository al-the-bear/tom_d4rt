// Comprehensive D4rt test script: TabPageSelector from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TabPageSelector script ===');
  ...
  final Type targetType = TabPageSelector;
  ...
  detailLines.add('target=TabPageSelector');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TabPageSelector'), 'Target type symbol resolves');
