// Comprehensive D4rt test script: ThemeDataTween from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ThemeDataTween script ===');
  ...
  final Type targetType = ThemeDataTween;
  ...
  detailLines.add('target=ThemeDataTween');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ThemeDataTween'), 'Target type symbol resolves');
