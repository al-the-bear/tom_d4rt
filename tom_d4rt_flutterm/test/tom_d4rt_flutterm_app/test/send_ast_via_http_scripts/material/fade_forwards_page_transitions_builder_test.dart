...
// D4rt test script: Comprehensive tests for FadeForwardsPageTransitionsBuilder from material
import 'package:flutter/material.dart';

dynamic build(BuildContext context) {
  print('=== D4rt material test start: FadeForwardsPageTransitionsBuilder ===');

  final symbolName = 'FadeForwardsPageTransitionsBuilder';
  final fileName = 'fade_forwards_page_transitions_builder_test.dart';
  final logs = <String>[];
  ...
  const builderA = FadeForwardsPageTransitionsBuilder();
  const builderB = FadeForwardsPageTransitionsBuilder();
  check(
    builderA.runtimeType == FadeForwardsPageTransitionsBuilder,
    'builder A type matches',
  );
  check(
    builderB.runtimeType == FadeForwardsPageTransitionsBuilder,
    'builder B type matches',
  );
  check(identical(builderA, builderB), 'const builders are canonicalized');
  symbolDetails.add('builderA=$builderA');
