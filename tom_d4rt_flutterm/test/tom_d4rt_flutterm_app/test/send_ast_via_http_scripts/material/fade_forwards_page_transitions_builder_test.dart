...
dynamic build(BuildContext context) {
  ...
  check(builderA.runtimeType == FadeForwardsPageTransitionsBuilder, 'builder A type matches');
  check(builderB.runtimeType == FadeForwardsPageTransitionsBuilder, 'builder B type matches');
