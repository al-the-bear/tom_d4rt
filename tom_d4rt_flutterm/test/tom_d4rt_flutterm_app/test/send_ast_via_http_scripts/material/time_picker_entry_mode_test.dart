...
// D4rt comprehensive test script for TimePickerEntryMode
...
dynamic build(BuildContext context) {
  ...
  print('========== TimePickerEntryMode comprehensive test ==========' );

  final List<TimePickerEntryMode> values = TimePickerEntryMode.values;
  expectCondition(values.isNotEmpty, 'TimePickerEntryMode.values should not be empty', logs, counters);
  expectCondition(values.length >= 2, 'TimePickerEntryMode should provide multiple values', logs, counters);

  final TimePickerEntryMode first = values.first;
  final TimePickerEntryMode last = values.last;
  ...
  for (final TimePickerEntryMode value in values) {
    ...
    final TimePickerEntryMode byName = TimePickerEntryMode.values.byName(value.name);
  ...
  final List<TimePickerEntryMode> copied = List<TimePickerEntryMode>.from(values);
  ...
  final List<TimePickerEntryMode> reversed = values.reversed.toList(growable: false);
  ...
  final TimePickerEntryMode edgeByName = TimePickerEntryMode.values.byName(edgeName);
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Text('TimePickerEntryMode Comprehensive Tests'),
