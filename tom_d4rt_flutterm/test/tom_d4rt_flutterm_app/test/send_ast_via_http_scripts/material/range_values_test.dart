// Comprehensive D4rt test script: RangeValues from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RangeValues script ===');
  ...
  final Type targetType = RangeValues;
  ...
  detailLines.add('target=RangeValues');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RangeValues'), 'Target type symbol resolves');
