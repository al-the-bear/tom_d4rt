// Comprehensive D4rt test script: RoundSliderThumbShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundSliderThumbShape script ===');
  ...
  final Type targetType = RoundSliderThumbShape;
  ...
  detailLines.add('target=RoundSliderThumbShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundSliderThumbShape'), 'Target type symbol resolves');
