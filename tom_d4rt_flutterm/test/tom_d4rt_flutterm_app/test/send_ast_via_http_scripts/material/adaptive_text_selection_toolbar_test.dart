// D4rt test script: Comprehensive tests for AdaptiveTextSelectionToolbar
...
dynamic build(BuildContext context) {
  print('=== AdaptiveTextSelectionToolbar comprehensive test start ===');
  final logs = <String>[];
  ...
  return Column(
    ...
    children: [
      const Text('AdaptiveTextSelectionToolbar Tests'),
