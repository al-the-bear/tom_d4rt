...
const String _targetClassName = 'FabMiniOffsetAdjustment';

class FabMiniOffsetAdjustmentScenario {
  FabMiniOffsetAdjustmentScenario({
    required this.label,
  ...
  FabMiniOffsetAdjustmentScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return FabMiniOffsetAdjustmentScenario(
...
List<String> _runScenarioChecks(FabMiniOffsetAdjustmentScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = FabMiniOffsetAdjustmentScenario(
  ...
  _expect(_targetClassName == 'FabMiniOffsetAdjustment', 'target class identifier should match filename');
