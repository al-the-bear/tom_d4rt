// Comprehensive D4rt test script: PopupMenuItem from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopupMenuItem script ===');
  ...
  final Type targetType = PopupMenuItem;
  ...
  detailLines.add('target=PopupMenuItem');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PopupMenuItem'), 'Target type symbol resolves');
