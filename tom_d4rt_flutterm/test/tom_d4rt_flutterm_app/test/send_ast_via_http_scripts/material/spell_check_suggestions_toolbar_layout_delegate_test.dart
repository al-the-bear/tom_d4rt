// Comprehensive D4rt test script: SpellCheckSuggestionsToolbarLayoutDelegate from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SpellCheckSuggestionsToolbarLayoutDelegate script ===');
  ...
  final Type targetType = SpellCheckSuggestionsToolbarLayoutDelegate;
  ...
  detailLines.add('target=SpellCheckSuggestionsToolbarLayoutDelegate');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SpellCheckSuggestionsToolbarLayoutDelegate'), 'Target type symbol resolves');
