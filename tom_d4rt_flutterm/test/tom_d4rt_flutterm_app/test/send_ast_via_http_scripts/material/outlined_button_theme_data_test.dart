// Comprehensive D4rt test script: OutlinedButtonThemeData from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OutlinedButtonThemeData script ===');
  ...
  final Type targetType = OutlinedButtonThemeData;
  ...
  detailLines.add('target=OutlinedButtonThemeData');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('OutlinedButtonThemeData'), 'Target type symbol resolves');
