// Comprehensive D4rt test script: SwitchListTile from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SwitchListTile script ===');
  ...
  final Type targetType = SwitchListTile;
  ...
  detailLines.add('target=SwitchListTile');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SwitchListTile'), 'Target type symbol resolves');
