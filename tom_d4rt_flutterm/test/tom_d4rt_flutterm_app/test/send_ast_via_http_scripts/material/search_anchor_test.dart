// Comprehensive D4rt test script: SearchAnchor from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SearchAnchor script ===');
  ...
  detailLines.add('target=SearchAnchor');
  ...
  final SearchAnchor anchor = SearchAnchor(builder: (BuildContext ctx, SearchController ctrl) => const Icon(Icons.search), suggestionsBuilder: (BuildContext ctx, SearchController ctrl) => const <Widget>[]);
  check(anchor is Widget, 'Is Widget');
  detailLines.add('hasBuilder=true');
  detailLines.add('hasSuggestions=true');
