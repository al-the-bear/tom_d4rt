// Comprehensive D4rt test script: SliderTickMarkShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliderTickMarkShape script ===');
  ...
  final Type targetType = SliderTickMarkShape;
  ...
  detailLines.add('target=SliderTickMarkShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SliderTickMarkShape'), 'Target type symbol resolves');
