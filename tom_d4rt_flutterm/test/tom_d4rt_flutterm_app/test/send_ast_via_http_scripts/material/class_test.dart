...
Widget buildMaterialElevationDemo(
  double elevation,
  Color color,
  MaterialType type,
  String label,
      ...
      child: Column(
        children: [
          Material(
            ...
            color: color,
            type: type,
            borderRadius: type == MaterialType.card
...
Widget buildMaterialTypeShowcase(
  String typeName,
  MaterialType type,
  Color color,
) {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            buildClassInfoCard(
              'MaterialApp',
              'Root widget providing Material Design',
              Colors.blue,
              Icons.apps,
              [
                'theme',
            ...
            buildClassInfoCard(
              'Scaffold',
              'Visual layout structure for Material pages',
              Colors.green,
              Icons.dashboard,
              [
                'appBar',
            ...
            buildClassInfoCard(
              'Material',
              'Base widget for Material Design surfaces',
              Colors.orange,
              Icons.layers,
              ['elevation', 'color', 'type', 'borderRadius', 'shadowColor'],
            ),
            buildClassInfoCard(
              'InkWell',
              'Rectangular area responding to touch with ripple',
              Colors.purple,
              Icons.touch_app,
              [
                'splashColor',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Surface tinting at different elevations',
                    style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),
                  ),
                  SizedBox(height: 8),
                  Row(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      Chip(
                        label: Text('Scaffold', style: TextStyle(fontSize: 10)),
                        backgroundColor: Colors.green.shade100,
                      ),
                      Chip(
                        label: Text('Material', style: TextStyle(fontSize: 10)),
                        backgroundColor: Colors.orange.shade100,
                      ),
                      Chip(
                        label: Text('InkWell', style: TextStyle(fontSize: 10)),
                        backgroundColor: Colors.purple.shade100,
                      ),
                      Chip(
                        label: Text('Theme', style: TextStyle(fontSize: 10)),
