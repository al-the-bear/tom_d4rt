...
// D4rt test script: Comprehensive tests for FilledButtonThemeData from material
import 'package:flutter/material.dart';

dynamic build(BuildContext context) {
  print('=== D4rt material test start: FilledButtonThemeData ===');

  final symbolName = 'FilledButtonThemeData';
  final fileName = 'filled_button_theme_data_test.dart';
  final logs = <String>[];
  ...
  final data = FilledButtonThemeData(style: style);
  const dataEdge = FilledButtonThemeData();
  check(data.style != null, 'custom style is set');
  check(dataEdge.style == null, 'edge instance supports null style');
  check(
    data.runtimeType == FilledButtonThemeData,
    'runtime type matches symbol',
  );
  symbolDetails.add('data=$data');
