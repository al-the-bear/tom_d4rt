...
dynamic build(BuildContext context) {
  ...
  _expect(
    checked.runtimeType.toString().contains('CheckedPopupMenuItem'),
    'constructor creates typed item',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    ...
    'edge case supports unchecked entries',
    logs,
  );
  assertionCount++;
  _expect(
    checked.enabled && unchecked.enabled,
    'default behavior keeps menu items enabled',
    logs,
  );
  assertionCount++;
