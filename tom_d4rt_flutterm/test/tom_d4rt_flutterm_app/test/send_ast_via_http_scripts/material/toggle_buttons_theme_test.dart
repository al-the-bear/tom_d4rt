// Comprehensive D4rt test script: ToggleButtonsTheme from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ToggleButtonsTheme script ===');
  ...
  final Type targetType = ToggleButtonsTheme;
  ...
  detailLines.add('target=ToggleButtonsTheme');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ToggleButtonsTheme'), 'Target type symbol resolves');
