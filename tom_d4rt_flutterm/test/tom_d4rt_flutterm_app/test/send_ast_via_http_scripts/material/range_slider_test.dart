// Comprehensive D4rt test script: RangeSlider from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RangeSlider script ===');
  ...
  final Type targetType = RangeSlider;
  ...
  detailLines.add('target=RangeSlider');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RangeSlider'), 'Target type symbol resolves');
