...
// D4rt test script: Comprehensive tests for Easing from material
import 'package:flutter/material.dart';

dynamic build(BuildContext context) {
  print('=== D4rt material test start: Easing ===');

  final symbolName = 'Easing';
  final fileName = 'easing_test.dart';
  final logs = <String>[];
  ...
  final standard = Easing.standard;
  final emphasized = Easing.emphasizedAccelerate;
  final decelerate = Easing.emphasizedDecelerate;
  check(standard != Curves.linear, 'standard differs from linear');
  check(emphasized != decelerate, 'accelerate and decelerate differ');
  check(standard != emphasized, 'standard and emphasized differ');
  check(decelerate != Curves.bounceIn, 'decelerate differs from bounce curve');
  symbolDetails.add('standard=$standard');
  symbolDetails.add('emphasized=$emphasized');
  symbolDetails.add('decelerate=$decelerate');
