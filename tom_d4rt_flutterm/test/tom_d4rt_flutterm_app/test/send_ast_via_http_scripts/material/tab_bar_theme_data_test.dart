// Comprehensive D4rt test script: TabBarThemeData from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TabBarThemeData script ===');
  ...
  final Type targetType = TabBarThemeData;
  ...
  detailLines.add('target=TabBarThemeData');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TabBarThemeData'), 'Target type symbol resolves');
