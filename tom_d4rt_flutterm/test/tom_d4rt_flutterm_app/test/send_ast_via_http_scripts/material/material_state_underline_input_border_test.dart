// Comprehensive D4rt test script: MaterialStateUnderlineInputBorder from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MaterialStateUnderlineInputBorder script ===');
  ...
  final Type targetType = MaterialStateUnderlineInputBorder;
  ...
  detailLines.add('target=MaterialStateUnderlineInputBorder');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MaterialStateUnderlineInputBorder'), 'Target type symbol resolves');
