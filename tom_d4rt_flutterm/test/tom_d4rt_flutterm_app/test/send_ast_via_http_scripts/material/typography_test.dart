// Comprehensive D4rt test script: Typography from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Typography script ===');
  ...
  final Type targetType = Typography;
  ...
  detailLines.add('target=Typography');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('Typography'), 'Target type symbol resolves');
