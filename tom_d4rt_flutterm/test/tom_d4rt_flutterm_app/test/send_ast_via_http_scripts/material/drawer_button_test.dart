...
dynamic build(BuildContext context) {
  ...
  _expect(button.runtimeType.toString().contains('DrawerButton'), 'constructs DrawerButton', logs);
  assertionCount++;
  _expect(button.key == null, 'default key is null', logs);
  assertionCount++;
  _expect(buttonWithKey.key != null, 'custom key is preserved', logs);
  assertionCount++;
  _expect(buttonWithKey.toString().contains('DrawerButton'), 'string output mentions DrawerButton', logs);
  assertionCount++;
  _expect(buttonWithKey.runtimeType == button.runtimeType, 'runtime type remains DrawerButton', logs);
  assertionCount++;
