...
dynamic build(BuildContext context) {
  ...
  _expect(
    tile.runtimeType.toString().contains('CheckboxListTile'),
    'constructor creates CheckboxListTile',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    triState.value == null && triState.tristate,
    'edge case allows null value with tristate',
    logs,
  );
  assertionCount++;
  _expect(
    disabled.onChanged == null,
    'behavior supports disabled tile when onChanged is null',
    logs,
  );
  assertionCount++;
