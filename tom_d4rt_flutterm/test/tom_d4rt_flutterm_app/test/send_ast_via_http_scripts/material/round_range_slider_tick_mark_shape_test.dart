// Comprehensive D4rt test script: RoundRangeSliderTickMarkShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundRangeSliderTickMarkShape script ===');
  ...
  final Type targetType = RoundRangeSliderTickMarkShape;
  ...
  detailLines.add('target=RoundRangeSliderTickMarkShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundRangeSliderTickMarkShape'), 'Target type symbol resolves');
