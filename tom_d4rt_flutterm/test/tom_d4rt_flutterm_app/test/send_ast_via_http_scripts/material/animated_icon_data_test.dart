...
dynamic build(BuildContext context) {
  ...
  _expect(
    iconData2 is AnimatedIconData,
    'uses second AnimatedIconData constant',
    logs,
  );
  assertionCount++;
  _expect(
    iconData != iconData2,
    'different constants represent different animations',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    animatedIcon.icon == iconData,
    'AnimatedIcon stores AnimatedIconData',
    logs,
  );
  assertionCount++;
