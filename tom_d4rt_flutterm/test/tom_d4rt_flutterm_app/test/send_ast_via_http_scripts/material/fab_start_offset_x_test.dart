...
const String _targetClassName = 'FabStartOffsetX';

class FabStartOffsetXScenario {
  FabStartOffsetXScenario({
    required this.label,
  ...
  FabStartOffsetXScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return FabStartOffsetXScenario(
...
List<String> _runScenarioChecks(FabStartOffsetXScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = FabStartOffsetXScenario(
  ...
  _expect(_targetClassName == 'FabStartOffsetX', 'target class identifier should match filename');
