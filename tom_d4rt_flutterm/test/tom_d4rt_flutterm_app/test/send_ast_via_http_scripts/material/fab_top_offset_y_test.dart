...
const String _targetClassName = 'FabTopOffsetY';

class FabTopOffsetYScenario {
  FabTopOffsetYScenario({
    required this.label,
  ...
  FabTopOffsetYScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return FabTopOffsetYScenario(
...
List<String> _runScenarioChecks(FabTopOffsetYScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = FabTopOffsetYScenario(
  ...
  _expect(_targetClassName == 'FabTopOffsetY', 'target class identifier should match filename');
