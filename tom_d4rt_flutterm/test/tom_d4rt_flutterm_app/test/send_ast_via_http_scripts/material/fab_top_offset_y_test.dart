...
dynamic build(BuildContext context) {
  ...
  print(
    'Demonstrating FAB top offset Y positioning for top-aligned FAB locations',
  );
...
Widget _buildTopPositionsOverview() {
  ...
  items.add(
    Text(
      'FAB top positions place the FloatingActionButton near the top of the Scaffold.',
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Three Top FAB Position Variants',
        ...
        buildInfoCard(
          'Y Offset:',
          'Calculated from top of Scaffold body, below AppBar',
        ),
      ],
    ),
  );
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Y offset places FAB below AppBar',
                style: TextStyle(fontSize: 11, color: Color(0xFF757575)),
              ),
              SizedBox(height: 4),
              Text(
                'Top position at y=$yFraction',
                style: TextStyle(
...
Widget _buildStartTopLocation() {
  ...
  rows.add(
    buildInfoCard('X Position:', 'Start side (left in LTR, right in RTL)'),
  );
      ...
      children: [
        ...
        Positioned(
          ...
          child: Column(
            ...
            children: [
              Text(
                'FAB overlaps AppBar bottom edge',
                style: TextStyle(fontSize: 11, color: Color(0xFF424242)),
              ),
              SizedBox(height: 4),
              Text(
                'Y = appBarHeight - (fabHeight / 2)',
                style: TextStyle(
                  fontFamily: 'monospace',
                  fontSize: 10,
                  color: Color(0xFF6A1B9A),
              ...
              SizedBox(height: 4),
              Text(
                'Creates a visual bridge between AppBar and body',
                style: TextStyle(fontSize: 11, color: Color(0xFF757575)),
              ),
            ],
          ),
...
Widget _buildEndTopLocation() {
  ...
  rows.add(
    buildInfoCard('X Position:', 'End side (right in LTR, left in RTL)'),
  );
  rows.add(buildInfoCard('Y Position:', 'Just below the AppBar bottom edge'));
  rows.add(SizedBox(height: 12));
        ...
        children: [
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'endTop places FAB at right edge',
                  style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                    color: Color(0xFFC62828),
                ...
                SizedBox(height: 4),
                Text(
                  'Y: Overlapping AppBar bottom edge',
                  style: TextStyle(fontSize: 11, color: Color(0xFF616161)),
                ),
                SizedBox(height: 4),
                Text(
                  'Useful for primary actions related to AppBar context',
                  style: TextStyle(fontSize: 11, color: Color(0xFF757575)),
                ),
              ],
            ),
...
Widget _buildCenterTopLocation() {
  ...
  rows.add(
    buildInfoCard('Location:', 'FloatingActionButtonLocation.centerTop'),
  );
        ...
        children: [
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'centerTop: Symmetrical placement',
                  style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                    color: Color(0xFF00695C),
                ...
                SizedBox(height: 4),
                Text(
                  'Combines horizontal center with top Y offset',
                  style: TextStyle(fontSize: 11, color: Color(0xFF616161)),
                ),
              ],
            ),
...
Widget _buildYOffsetRelativeToAppBar() {
  ...
  items.add(
    Text(
      'The Y offset for top FAB positions is calculated relative to the AppBar.',
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Text(
                'appBarBottom = statusBar + toolbarHeight + bottomOpacity',
                style: TextStyle(
                  fontFamily: 'monospace',
                  fontSize: 9,
                  color: Color(0xFF1565C0),
  ...
  items.add(
    buildInfoCard('Default AppBar Height:', '56.0 pixels (kToolbarHeight)'),
  );
  items.add(
    buildInfoCard(
      'FAB Overlap:',
      'Half the FAB diameter extends into AppBar area',
    ),
  );
...
Widget _buildFabSizeImpactOnY() {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'Diameter: ${diameter.toStringAsFixed(0)}px',
                    style: TextStyle(fontSize: 11, color: Color(0xFF616161)),
                  ),
                  Text(
                    'Overlap into AppBar: ${overlap.toStringAsFixed(0)}px',
                    style: TextStyle(fontSize: 11, color: Color(0xFF616161)),
                  ),
                  Text(
                    'Top Y = appBarBottom - ${overlap.toStringAsFixed(0)}',
                    style: TextStyle(
                      fontFamily: 'monospace',
                      fontSize: 10,
                      color: sizeColor,
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Larger FABs overlap more into the AppBar area',
          style: TextStyle(fontSize: 13, color: Color(0xFF424242)),
        ),
        SizedBox(height: 12),
...
Widget _buildAppBarHeightVariations() {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'FAB top Y = ${barHeight.toStringAsFixed(0)} - 28 = ${(barHeight - 28).toStringAsFixed(0)}px',
                    style: TextStyle(
                      fontFamily: 'monospace',
                      fontSize: 10,
                      color: Color(0xFF7B1FA2),
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'AppBar height changes the Y origin for top FAB positions',
          style: TextStyle(fontSize: 13, color: Color(0xFF424242)),
        ),
        SizedBox(height: 12),
        Column(children: items),
...
Widget _buildTopFabWithBodyContent() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'Top FAB overlaps body content at the top edge',
          style: TextStyle(fontSize: 13, color: Color(0xFF424242)),
        ),
        SizedBox(height: 12),
        Container(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text(
                        'Content may be partially obscured by FAB',
                        style: TextStyle(
                          fontSize: 10,
                          color: Color(0xFF757575),
                        ),
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Tip: Add top padding to body content',
                      style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
                        color: Color(0xFF6A1B9A),
                    ...
                    SizedBox(height: 2),
                    Text(
                      'padding: EdgeInsets.only(top: fabSize + 8)',
                      style: TextStyle(
                        fontFamily: 'monospace',
                        fontSize: 10,
        ...
        buildInfoCard(
          'Overlap Issue:',
          'Top FABs overlap body content - add padding to compensate',
        ),
      ],
    ),
  );
...
Widget _buildMiniFabTopPositions() {
  ...
  items.add(
    Text(
      'MiniStartTop uses a smaller FAB at the start-top position.',
      style: TextStyle(fontSize: 13, color: Color(0xFF424242)),
    ),
  );
  items.add(SizedBox(height: 12));
  ...
  items.add(SizedBox(height: 8));
  items.add(
    buildInfoCard('Mini FAB:', 'Smaller diameter (40px vs 56px regular)'),
  );
  items.add(
    buildInfoCard('Y Overlap:', 'Less overlap into AppBar due to smaller size'),
  );
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'B. Bottom of status bar = 24',
                        style: TextStyle(fontSize: 10),
                      ),
                      Text(
                        'C. Bottom of AppBar = 80',
                        style: TextStyle(fontSize: 10),
                      ),
                      Text(
                        'D. FAB center Y = 80 (AppBar bottom)',
                        style: TextStyle(fontSize: 10),
                      ),
                      Text(
                        'E. FAB top edge = 80 - 28 = 52',
                        style: TextStyle(fontSize: 10),
                      ),
                    ],
                  ),
        ...
        buildInfoCard(
          'getOffsetY:',
          'Mixin method returning Y position for top-aligned FAB',
        ),
      ],
    ),
  );
...
Widget _buildAllTopLocationsComparison() {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text(
          'All four top-aligned FAB locations share the same Y offset calculation',
          style: TextStyle(fontSize: 13, color: Color(0xFF424242)),
        ),
        SizedBox(height: 12),
        Column(children: items),
        ...
        buildInfoCard(
          'Shared Mixin:',
          'FabTopOffsetY provides getOffsetY for all top locations',
        ),
        buildInfoCard(
          'Y Formula:',
          'scaffoldGeometry.contentTop - (fabHeight / 2)',
        ),
      ],
    ),
  );
