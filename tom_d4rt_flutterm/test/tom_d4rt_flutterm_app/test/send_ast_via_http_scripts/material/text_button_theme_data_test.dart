// Comprehensive D4rt test script: TextButtonThemeData from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextButtonThemeData script ===');
  ...
  final Type targetType = TextButtonThemeData;
  ...
  detailLines.add('target=TextButtonThemeData');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TextButtonThemeData'), 'Target type symbol resolves');
