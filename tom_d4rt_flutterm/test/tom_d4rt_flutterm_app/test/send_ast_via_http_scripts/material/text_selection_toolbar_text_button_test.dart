// Comprehensive D4rt test script: TextSelectionToolbarTextButton from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextSelectionToolbarTextButton script ===');
  ...
  final Type targetType = TextSelectionToolbarTextButton;
  ...
  detailLines.add('target=TextSelectionToolbarTextButton');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TextSelectionToolbarTextButton'), 'Target type symbol resolves');
