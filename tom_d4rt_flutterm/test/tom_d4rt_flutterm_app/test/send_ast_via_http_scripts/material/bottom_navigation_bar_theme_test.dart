...
dynamic build(BuildContext context) {
  ...
  final themeData = const BottomNavigationBarThemeData(
  ...
  _expect(
    theme is BottomNavigationBarTheme,
    'instantiates BottomNavigationBarTheme',
    logs,
  );
  assertionCount++;
  _expect(
    theme.data.selectedItemColor == Colors.purple,
    'stores theme data',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    theme.toStringShort().contains('BottomNavigationBarTheme'),
