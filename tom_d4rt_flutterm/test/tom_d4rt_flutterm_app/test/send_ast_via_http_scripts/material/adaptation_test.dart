...
dynamic build(BuildContext context) {
  ...
  _expect(
    adaptation is Adaptation<Object>,
    'instantiates Adaptation<Object>',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    second is Adaptation<String>,
    'generic instantiation supports another type',
    logs,
  );
  assertionCount++;
  _expect(
    adaptation.runtimeType != second.runtimeType ||
        second is Adaptation<String>,
    'generic type path exercised',
    logs,
  );
  assertionCount++;
