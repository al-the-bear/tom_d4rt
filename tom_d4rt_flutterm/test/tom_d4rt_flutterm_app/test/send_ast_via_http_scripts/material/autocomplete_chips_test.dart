...
dynamic build(BuildContext context) {
  ...
  print('showDateRangePicker is a Function: ${showDateRangePicker is Function}');
  ...
  final AutocompleteOptionsBuilder<String> optionsBuilder = (TextEditingValue textEditingValue) {
  ...
  print('AutocompleteOptionsViewBuilder type: ${optionsViewBuilder.runtimeType}');
  ...
  print('ActionChip type (has TappableChipAttributes): ${actionChip.runtimeType}');
  ...
  print('InputChip type (has DisabledChipAttributes): ${inputChip.runtimeType}');
  ...
  print('FilterChip type (has CheckableChipAttributes): ${filterChip.runtimeType}');
    ...
    home: Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Text('Autocomplete & Chips Test', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0)),
