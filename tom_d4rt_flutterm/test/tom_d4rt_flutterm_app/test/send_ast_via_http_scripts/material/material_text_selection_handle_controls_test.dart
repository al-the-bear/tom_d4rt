// Comprehensive D4rt test script: MaterialTextSelectionHandleControls from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MaterialTextSelectionHandleControls script ===');
  ...
  final Type targetType = MaterialTextSelectionHandleControls;
  ...
  detailLines.add('target=MaterialTextSelectionHandleControls');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MaterialTextSelectionHandleControls'), 'Target type symbol resolves');
