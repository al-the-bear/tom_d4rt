// Comprehensive D4rt test script: RangeSliderValueIndicatorShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RangeSliderValueIndicatorShape script ===');
  ...
  final Type targetType = RangeSliderValueIndicatorShape;
  ...
  detailLines.add('target=RangeSliderValueIndicatorShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RangeSliderValueIndicatorShape'), 'Target type symbol resolves');
