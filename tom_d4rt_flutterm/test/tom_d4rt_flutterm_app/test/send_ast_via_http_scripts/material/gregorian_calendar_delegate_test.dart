...
dynamic build(BuildContext context) {
  ...
  check(delegateA.runtimeType == GregorianCalendarDelegate, 'delegate type matches symbol');
  check(delegateB.runtimeType == GregorianCalendarDelegate, 'second delegate type matches symbol');
