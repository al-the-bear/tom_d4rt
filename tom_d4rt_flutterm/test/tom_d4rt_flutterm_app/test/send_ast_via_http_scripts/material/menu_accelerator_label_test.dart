// Comprehensive D4rt test script: MenuAcceleratorLabel from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MenuAcceleratorLabel script ===');
  ...
  final Type targetType = MenuAcceleratorLabel;
  ...
  detailLines.add('target=MenuAcceleratorLabel');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MenuAcceleratorLabel'), 'Target type symbol resolves');
