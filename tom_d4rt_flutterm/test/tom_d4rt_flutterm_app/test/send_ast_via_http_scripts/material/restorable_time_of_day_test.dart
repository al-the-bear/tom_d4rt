// Comprehensive D4rt test script: RestorableTimeOfDay from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableTimeOfDay script ===');
  ...
  final Type targetType = RestorableTimeOfDay;
  ...
  detailLines.add('target=RestorableTimeOfDay');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RestorableTimeOfDay'), 'Target type symbol resolves');
