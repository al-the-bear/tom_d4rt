...
dynamic build(BuildContext context) {
  ...
  check(
    alignmentA.runtimeType == FloatingLabelAlignment,
    'start runtime type is enum/class',
  );
  check(
    alignmentB.runtimeType == FloatingLabelAlignment,
    'center runtime type is enum/class',
  );
  check(alignmentA != alignmentB, 'variants differ');
  check(
    alignmentA.toString().contains('start'),
    'start variant string is informative',
  );
