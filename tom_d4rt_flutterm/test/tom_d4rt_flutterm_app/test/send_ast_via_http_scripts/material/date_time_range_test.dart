...
dynamic build(BuildContext context) {
  ...
  _expect(
    range.runtimeType.toString().contains('DateTimeRange'),
    'constructs DateTimeRange',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    ...
    'start before end in standard range',
    logs,
  );
  assertionCount++;
  _expect(
    singleDay.duration.inDays == 0,
    'edge case supports zero-duration range',
    logs,
  );
  assertionCount++;
