...
dynamic build(BuildContext context) {
  ...
  check(locationA.runtimeType.toString().isNotEmpty, 'endFloat runtime type available');
  check(locationB.runtimeType.toString().isNotEmpty, 'startDocked runtime type available');
  check(locationEdge.runtimeType.toString().isNotEmpty, 'centerFloat runtime type available');
