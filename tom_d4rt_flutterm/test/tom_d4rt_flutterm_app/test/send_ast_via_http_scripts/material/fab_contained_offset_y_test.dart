...
const String _targetClassName = 'FabContainedOffsetY';

class FabContainedOffsetYScenario {
  FabContainedOffsetYScenario({
    required this.label,
  ...
  FabContainedOffsetYScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return FabContainedOffsetYScenario(
...
List<String> _runScenarioChecks(FabContainedOffsetYScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = FabContainedOffsetYScenario(
  ...
  _expect(_targetClassName == 'FabContainedOffsetY', 'target class identifier should match filename');
