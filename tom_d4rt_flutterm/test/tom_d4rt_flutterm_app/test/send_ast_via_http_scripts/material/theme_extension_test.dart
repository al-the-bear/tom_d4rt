// Comprehensive D4rt test script: ThemeExtension from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ThemeExtension script ===');
  ...
  final Type targetType = ThemeExtension;
  ...
  detailLines.add('target=ThemeExtension');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ThemeExtension'), 'Target type symbol resolves');
