// Comprehensive D4rt test script: SnackBarAction from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SnackBarAction script ===');
  ...
  final Type targetType = SnackBarAction;
  ...
  detailLines.add('target=SnackBarAction');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SnackBarAction'), 'Target type symbol resolves');
