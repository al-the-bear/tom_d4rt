// Comprehensive D4rt test script: ToggleButtonsThemeData from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ToggleButtonsThemeData script ===');
  ...
  final Type targetType = ToggleButtonsThemeData;
  ...
  detailLines.add('target=ToggleButtonsThemeData');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ToggleButtonsThemeData'), 'Target type symbol resolves');
