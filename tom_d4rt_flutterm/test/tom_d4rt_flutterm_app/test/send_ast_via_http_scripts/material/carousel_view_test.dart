...
dynamic build(BuildContext context) {
  ...
  _expect(
    standard.runtimeType.toString().contains('CarouselView'),
    'constructor creates CarouselView',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    weighted.flexWeights?.length == 3,
    'weighted constructor stores flexWeights',
    logs,
  );
  assertionCount++;
  _expect(
    weighted.itemExtent == null,
    'weighted constructor uses null itemExtent',
    logs,
  );
  assertionCount++;
  _expect(
    weighted.consumeMaxWeight,
    'weighted defaults to consumeMaxWeight=true',
    logs,
  );
  assertionCount++;
