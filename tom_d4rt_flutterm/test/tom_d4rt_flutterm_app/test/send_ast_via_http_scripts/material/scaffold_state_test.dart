// Comprehensive D4rt test script: ScaffoldState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScaffoldState script ===');
  ...
  final Type targetType = ScaffoldState;
  ...
  detailLines.add('target=ScaffoldState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ScaffoldState'), 'Target type symbol resolves');
