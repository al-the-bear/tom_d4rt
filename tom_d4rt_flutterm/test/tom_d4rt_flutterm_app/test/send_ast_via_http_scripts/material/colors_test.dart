...
dynamic build(BuildContext context) {
  ...
  _expect(
    blue.shade500 == blue[500],
    'Colors.blue exposes MaterialColor shades',
    logs,
  );
  assertionCount++;
  _expect(
    blue[500] == Colors.blue.shade500,
    'shade lookup matches shade500',
    logs,
  );
  assertionCount++;
  _expect(
    blueAccent.shade200 == blueAccent[200],
    'Colors.blueAccent exposes accent shades',
    logs,
  );
  assertionCount++;
