// Comprehensive D4rt test script: NavigationIndicator from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NavigationIndicator script ===');
  ...
  final Type targetType = NavigationIndicator;
  ...
  detailLines.add('target=NavigationIndicator');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('NavigationIndicator'), 'Target type symbol resolves');
