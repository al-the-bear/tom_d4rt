...
dynamic build(BuildContext context) {
  ...
  check(
    noSplashFactory.runtimeType.toString().contains('Splash'),
    'NoSplash runtimeType references splash behavior',
  );
  check(
    sparkleFactory.runtimeType.toString().contains('InkSparkle') ||
        sparkleFactory.runtimeType.toString().contains('Factory'),
    'InkSparkle factory runtimeType is descriptive',
  );
  check(
    noSplashFactory.runtimeType.toString().isNotEmpty,
    'NoSplash factory has runtimeType',
  );
  check(
    sparkleFactory.runtimeType.toString().isNotEmpty,
    'InkSparkle factory has runtimeType',
  );
  check(
    noSplashFactory != sparkleFactory,
    'Edge case: different factories are not equal',
  );
