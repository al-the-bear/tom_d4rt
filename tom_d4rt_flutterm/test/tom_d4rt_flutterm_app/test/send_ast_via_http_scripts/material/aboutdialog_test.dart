// Comprehensive D4rt test script: Aboutdialog from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Aboutdialog script ===');
  ...
  detailLines.add('target=Aboutdialog');
  ...
  // Testing Aboutdialog
  check(true, 'Aboutdialog test placeholder');
  detailLines.add('category=material');
  detailLines.add('desc=Aboutdialog test from material');
