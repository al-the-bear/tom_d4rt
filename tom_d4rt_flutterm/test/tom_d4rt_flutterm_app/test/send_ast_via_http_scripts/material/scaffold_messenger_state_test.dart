// Comprehensive D4rt test script: ScaffoldMessengerState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScaffoldMessengerState script ===');
  ...
  final Type targetType = ScaffoldMessengerState;
  ...
  detailLines.add('target=ScaffoldMessengerState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ScaffoldMessengerState'), 'Target type symbol resolves');
