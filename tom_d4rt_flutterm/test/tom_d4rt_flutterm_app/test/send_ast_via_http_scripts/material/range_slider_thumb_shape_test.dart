// Comprehensive D4rt test script: RangeSliderThumbShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RangeSliderThumbShape script ===');
  ...
  final Type targetType = RangeSliderThumbShape;
  ...
  detailLines.add('target=RangeSliderThumbShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RangeSliderThumbShape'), 'Target type symbol resolves');
