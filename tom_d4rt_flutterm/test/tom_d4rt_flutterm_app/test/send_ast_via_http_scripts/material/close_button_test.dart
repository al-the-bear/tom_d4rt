...
dynamic build(BuildContext context) {
  ...
  _expect(
    close.runtimeType.toString().contains('CloseButton'),
    'constructor creates CloseButton',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    defaultClose.onPressed == null,
    'edge case supports default onPressed behavior',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    built.runtimeType.toString().isNotEmpty,
    'build returns a widget',
    logs,
  );
  assertionCount++;
  _expect(
    defaultClose.runtimeType.toString().contains('CloseButton'),
    'runtime type contains class name',
    logs,
  );
  assertionCount++;
