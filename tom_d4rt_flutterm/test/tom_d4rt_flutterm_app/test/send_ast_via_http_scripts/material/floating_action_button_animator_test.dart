...
// D4rt test script: Comprehensive tests for FloatingActionButtonAnimator from material
import 'package:flutter/material.dart';

dynamic build(BuildContext context) {
  print('=== D4rt material test start: FloatingActionButtonAnimator ===');

  final symbolName = 'FloatingActionButtonAnimator';
  final fileName = 'floating_action_button_animator_test.dart';
  final logs = <String>[];
  ...
  const animatorA = FloatingActionButtonAnimator.scaling;
  const animatorB = FloatingActionButtonAnimator.noAnimation;
  check(
    animatorA.runtimeType.toString().isNotEmpty,
    'animator A has runtime type',
  );
  check(
    animatorB.runtimeType.toString().isNotEmpty,
    'animator B has runtime type',
  );
  check(animatorA != animatorB, 'named animator presets differ');
  check(
    animatorA.toString() != animatorB.toString(),
    'string representations differ',
  );
  symbolDetails.add('animatorA=$animatorA');
  symbolDetails.add('animatorB=$animatorB');
