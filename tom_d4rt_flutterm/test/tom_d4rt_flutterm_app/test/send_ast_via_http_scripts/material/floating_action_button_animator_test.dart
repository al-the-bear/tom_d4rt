...
dynamic build(BuildContext context) {
  ...
  check(animatorA.runtimeType.toString().isNotEmpty, 'animator A has runtime type');
  check(animatorB.runtimeType.toString().isNotEmpty, 'animator B has runtime type');
  check(animatorA != animatorB, 'named animator presets differ');
  check(animatorA.toString() != animatorB.toString(), 'string representations differ');
