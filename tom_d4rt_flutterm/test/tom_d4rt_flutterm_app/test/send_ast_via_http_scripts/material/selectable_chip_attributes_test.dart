// Comprehensive D4rt test script: SelectableChipAttributes from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectableChipAttributes script ===');
  ...
  final Type targetType = SelectableChipAttributes;
  ...
  detailLines.add('target=SelectableChipAttributes');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SelectableChipAttributes'), 'Target type symbol resolves');
