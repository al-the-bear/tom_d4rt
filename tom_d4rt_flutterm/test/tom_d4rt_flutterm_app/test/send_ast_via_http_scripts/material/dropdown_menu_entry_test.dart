...
dynamic build(BuildContext context) {
  ...
  const disabledEntry = DropdownMenuEntry<int>(value: 8, label: 'Eight', enabled: false);
  log('Created enabled && disabled DropdownMenuEntry values');
  _expect(entry.runtimeType.toString().contains('DropdownMenuEntry<int>'), 'constructs generic DropdownMenuEntry', logs);
  assertionCount++;
