// Comprehensive D4rt test script: AutocompleteDatepicker from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutocompleteDatepicker script ===');
  ...
  detailLines.add('target=AutocompleteDatepicker');
  ...
  const String targetTypeName = 'AutocompleteDatepicker';
  check(targetTypeName == 'AutocompleteDatepicker', 'Name matches');
  detailLines.add('category=material_picker');
  detailLines.add('desc=Autocomplete date picker integration');
  // Test individual date picker components
  check(targetTypeName.contains('Date'), 'Contains Date');
  check(targetTypeName.contains('picker'), 'Contains picker');
