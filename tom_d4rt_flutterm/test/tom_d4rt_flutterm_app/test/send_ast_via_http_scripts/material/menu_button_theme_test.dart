// Comprehensive D4rt test script: MenuButtonTheme from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MenuButtonTheme script ===');
  ...
  final Type targetType = MenuButtonTheme;
  ...
  detailLines.add('target=MenuButtonTheme');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MenuButtonTheme'), 'Target type symbol resolves');
