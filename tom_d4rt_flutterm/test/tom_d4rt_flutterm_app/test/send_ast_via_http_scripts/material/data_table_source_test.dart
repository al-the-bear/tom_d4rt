...
dynamic build(BuildContext context) {
  ...
  _expect(
    source.runtimeType.toString().contains('_DemoDataTableSource'),
    'subclass is DataTableSource',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    !source.isRowCountApproximate,
    'isRowCountApproximate is false',
    logs,
  );
  assertionCount++;
  _expect(
    source.selectedRowCount == 0,
    'selectedRowCount default is zero',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    rowMissing == null,
    'edge case returns null for out-of-range index',
    logs,
  );
  assertionCount++;
