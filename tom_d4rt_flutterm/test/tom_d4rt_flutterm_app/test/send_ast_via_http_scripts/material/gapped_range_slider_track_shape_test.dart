...
// D4rt test script: Comprehensive tests for GappedRangeSliderTrackShape from material
import 'package:flutter/material.dart';

dynamic build(BuildContext context) {
  print('=== D4rt material test start: GappedRangeSliderTrackShape ===');

  final symbolName = 'GappedRangeSliderTrackShape';
  final fileName = 'gapped_range_slider_track_shape_test.dart';
  final logs = <String>[];
  ...
  const shapeA = GappedRangeSliderTrackShape();
  const shapeB = GappedRangeSliderTrackShape();
  check(
    shapeA.runtimeType == GappedRangeSliderTrackShape,
    'shape A type matches',
  );
  check(
    shapeB.runtimeType == GappedRangeSliderTrackShape,
    'shape B type matches',
  );
