// Comprehensive D4rt test script: SegmentedButtonState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SegmentedButtonState script ===');
  ...
  final Type targetType = SegmentedButtonState;
  ...
  detailLines.add('target=SegmentedButtonState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SegmentedButtonState'), 'Target type symbol resolves');
