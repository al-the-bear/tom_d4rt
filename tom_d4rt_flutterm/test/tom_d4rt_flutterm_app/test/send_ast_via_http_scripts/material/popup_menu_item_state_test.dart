// Comprehensive D4rt test script: PopupMenuItemState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopupMenuItemState script ===');
  ...
  final Type targetType = PopupMenuItemState;
  ...
  detailLines.add('target=PopupMenuItemState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PopupMenuItemState'), 'Target type symbol resolves');
