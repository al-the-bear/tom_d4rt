// Comprehensive D4rt test script: PaginatedDataTableState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PaginatedDataTableState script ===');
  ...
  final Type targetType = PaginatedDataTableState;
  ...
  detailLines.add('target=PaginatedDataTableState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PaginatedDataTableState'), 'Target type symbol resolves');
