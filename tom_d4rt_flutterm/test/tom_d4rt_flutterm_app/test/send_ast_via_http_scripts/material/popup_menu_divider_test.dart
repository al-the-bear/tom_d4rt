// Comprehensive D4rt test script: PopupMenuDivider from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopupMenuDivider script ===');
  ...
  final Type targetType = PopupMenuDivider;
  ...
  detailLines.add('target=PopupMenuDivider');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PopupMenuDivider'), 'Target type symbol resolves');
