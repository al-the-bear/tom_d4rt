// Comprehensive D4rt test script: RoundedRectRangeSliderTrackShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundedRectRangeSliderTrackShape script ===');
  ...
  final Type targetType = RoundedRectRangeSliderTrackShape;
  ...
  detailLines.add('target=RoundedRectRangeSliderTrackShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundedRectRangeSliderTrackShape'), 'Target type symbol resolves');
