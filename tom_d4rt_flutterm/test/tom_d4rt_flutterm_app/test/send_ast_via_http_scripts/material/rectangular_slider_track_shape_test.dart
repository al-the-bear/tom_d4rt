// Comprehensive D4rt test script: RectangularSliderTrackShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RectangularSliderTrackShape script ===');
  ...
  final Type targetType = RectangularSliderTrackShape;
  ...
  detailLines.add('target=RectangularSliderTrackShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RectangularSliderTrackShape'), 'Target type symbol resolves');
