// Comprehensive D4rt test script: RawMaterialButton from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawMaterialButton script ===');
  ...
  final Type targetType = RawMaterialButton;
  ...
  detailLines.add('target=RawMaterialButton');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RawMaterialButton'), 'Target type symbol resolves');
