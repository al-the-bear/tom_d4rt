...
dynamic build(BuildContext context) {
  ...
  _expect(
    enabled.runtimeType.toString().contains('_DemoButton'),
    'subclass type is created',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    defaultStyle.backgroundColor != null || defaultStyle.padding != null,
    'defaultStyleOf returns populated style',
    logs,
  );
  assertionCount++;
