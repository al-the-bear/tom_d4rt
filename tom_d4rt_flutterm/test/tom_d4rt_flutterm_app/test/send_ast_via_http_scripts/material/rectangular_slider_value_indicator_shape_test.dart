// Comprehensive D4rt test script: RectangularSliderValueIndicatorShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RectangularSliderValueIndicatorShape script ===');
  ...
  final Type targetType = RectangularSliderValueIndicatorShape;
  ...
  detailLines.add('target=RectangularSliderValueIndicatorShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RectangularSliderValueIndicatorShape'), 'Target type symbol resolves');
