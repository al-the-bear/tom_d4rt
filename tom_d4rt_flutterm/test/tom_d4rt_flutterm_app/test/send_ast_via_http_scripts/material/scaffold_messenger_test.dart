// Comprehensive D4rt test script: ScaffoldMessenger from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScaffoldMessenger script ===');
  ...
  final Type targetType = ScaffoldMessenger;
  ...
  detailLines.add('target=ScaffoldMessenger');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ScaffoldMessenger'), 'Target type symbol resolves');
