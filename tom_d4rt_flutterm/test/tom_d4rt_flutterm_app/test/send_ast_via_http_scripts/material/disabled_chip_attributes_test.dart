...
dynamic build(BuildContext context) {
  ...
  final enabled = FilterChip(
    label: const Text('Enabled'),
    selected: false,
    onSelected: (_) {},
  );
  final disabled = const FilterChip(
    label: Text('Disabled'),
    selected: false,
    onSelected: null,
  );
  ...
  log(
    'Evaluated DisabledChipAttributes using enabled/disabled FilterChip instances',
  );
  _expect(
    enabledAttrs.runtimeType.toString().contains('FilterChip'),
    'attribute runtime matches FilterChip implementation',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    !disabledAttrs.isEnabled,
    'edge case: disabled chip reports isEnabled false',
    logs,
  );
  assertionCount++;
  _expect(
    enabled.runtimeType == disabled.runtimeType,
    'enabled/disabled states keep same runtime type',
    logs,
  );
  assertionCount++;
