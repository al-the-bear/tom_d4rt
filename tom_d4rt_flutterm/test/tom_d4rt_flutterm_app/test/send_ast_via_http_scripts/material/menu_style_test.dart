// Comprehensive D4rt test script: MenuStyle from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MenuStyle script ===');
  ...
  final Type targetType = MenuStyle;
  ...
  detailLines.add('target=MenuStyle');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MenuStyle'), 'Target type symbol resolves');
