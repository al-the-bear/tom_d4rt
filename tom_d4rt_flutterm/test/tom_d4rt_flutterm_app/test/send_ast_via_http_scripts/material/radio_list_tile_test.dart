// Comprehensive D4rt test script: RadioListTile from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RadioListTile script ===');
  ...
  final Type targetType = RadioListTile;
  ...
  detailLines.add('target=RadioListTile');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RadioListTile'), 'Target type symbol resolves');
