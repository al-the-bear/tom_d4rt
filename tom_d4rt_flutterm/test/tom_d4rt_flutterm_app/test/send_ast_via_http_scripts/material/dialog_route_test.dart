...
dynamic build(BuildContext context) {
  ...
  _expect(
    ...
    'constructs DialogRoute with builder',
    logs,
  );
  assertionCount++;
  _expect(
    route.settings.name == null,
    'default route settings name is null',
    logs,
  );
  assertionCount++;
  _expect(
    route.barrierDismissible,
    'dialog route is dismissible by default',
    logs,
  );
  assertionCount++;
  _expect(
    route.barrierColor != null,
    'dialog route exposes barrier color',
    logs,
  );
  assertionCount++;
  _expect(
    route.toString().contains('DialogRoute'),
    'string representation confirms DialogRoute behavior',
    logs,
  );
  assertionCount++;
