// Comprehensive D4rt test script: TappableChipAttributes from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TappableChipAttributes script ===');
  ...
  final Type targetType = TappableChipAttributes;
  ...
  detailLines.add('target=TappableChipAttributes');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TappableChipAttributes'), 'Target type symbol resolves');
