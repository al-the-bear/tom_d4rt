// Comprehensive D4rt test script: ScaffoldPrelayoutGeometry from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScaffoldPrelayoutGeometry script ===');
  ...
  final Type targetType = ScaffoldPrelayoutGeometry;
  ...
  detailLines.add('target=ScaffoldPrelayoutGeometry');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ScaffoldPrelayoutGeometry'), 'Target type symbol resolves');
