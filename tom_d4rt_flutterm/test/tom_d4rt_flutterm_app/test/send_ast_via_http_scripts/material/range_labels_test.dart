// Comprehensive D4rt test script: RangeLabels from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RangeLabels script ===');
  ...
  final Type targetType = RangeLabels;
  ...
  detailLines.add('target=RangeLabels');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RangeLabels'), 'Target type symbol resolves');
