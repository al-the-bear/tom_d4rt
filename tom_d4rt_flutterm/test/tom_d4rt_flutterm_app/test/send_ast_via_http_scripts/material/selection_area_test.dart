// Comprehensive D4rt test script: SelectionArea from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionArea script ===');
  ...
  final Type targetType = SelectionArea;
  ...
  detailLines.add('target=SelectionArea');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SelectionArea'), 'Target type symbol resolves');
