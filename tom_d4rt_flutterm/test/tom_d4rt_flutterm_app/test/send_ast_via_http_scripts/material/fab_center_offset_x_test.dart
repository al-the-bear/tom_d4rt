...
const String _targetClassName = 'FabCenterOffsetX';

class FabCenterOffsetXScenario {
  FabCenterOffsetXScenario({
    required this.label,
  ...
  FabCenterOffsetXScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return FabCenterOffsetXScenario(
...
List<String> _runScenarioChecks(FabCenterOffsetXScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = FabCenterOffsetXScenario(
  ...
  _expect(_targetClassName == 'FabCenterOffsetX', 'target class identifier should match filename');
