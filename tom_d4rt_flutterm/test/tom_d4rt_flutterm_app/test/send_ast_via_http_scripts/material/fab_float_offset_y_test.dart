...
const String _targetClassName = 'FabFloatOffsetY';

class FabFloatOffsetYScenario {
  FabFloatOffsetYScenario({
    required this.label,
  ...
  FabFloatOffsetYScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return FabFloatOffsetYScenario(
...
List<String> _runScenarioChecks(FabFloatOffsetYScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = FabFloatOffsetYScenario(
  ...
  _expect(_targetClassName == 'FabFloatOffsetY', 'target class identifier should match filename');
