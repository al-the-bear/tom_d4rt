// Comprehensive D4rt test script: TextSelectionToolbar from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextSelectionToolbar script ===');
  ...
  final Type targetType = TextSelectionToolbar;
  ...
  detailLines.add('target=TextSelectionToolbar');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TextSelectionToolbar'), 'Target type symbol resolves');
