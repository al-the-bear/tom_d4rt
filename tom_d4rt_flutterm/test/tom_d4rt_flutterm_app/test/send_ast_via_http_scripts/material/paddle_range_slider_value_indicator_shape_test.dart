// Comprehensive D4rt test script: PaddleRangeSliderValueIndicatorShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PaddleRangeSliderValueIndicatorShape script ===');
  ...
  final Type targetType = PaddleRangeSliderValueIndicatorShape;
  ...
  detailLines.add('target=PaddleRangeSliderValueIndicatorShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PaddleRangeSliderValueIndicatorShape'), 'Target type symbol resolves');
