...
dynamic build(BuildContext context) {
  ...
  _expect(
    data.alignment == MainAxisAlignment.spaceBetween,
    'stores alignment',
    logs,
  );
  assertionCount++;
  _expect(
    data.buttonAlignedDropdown == true,
    'stores buttonAlignedDropdown',
    logs,
  );
  assertionCount++;
  _expect(
    data.buttonPadding == const EdgeInsets.all(8),
    'stores buttonPadding',
    logs,
  );
  assertionCount++;
  _expect(
    data.layoutBehavior == ButtonBarLayoutBehavior.constrained,
    'stores layoutBehavior',
    logs,
  );
  assertionCount++;
