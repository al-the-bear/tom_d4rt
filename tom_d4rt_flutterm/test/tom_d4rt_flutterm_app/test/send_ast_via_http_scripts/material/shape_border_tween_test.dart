// Comprehensive D4rt test script: ShapeBorderTween from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShapeBorderTween script ===');
  ...
  final Type targetType = ShapeBorderTween;
  ...
  detailLines.add('target=ShapeBorderTween');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ShapeBorderTween'), 'Target type symbol resolves');
