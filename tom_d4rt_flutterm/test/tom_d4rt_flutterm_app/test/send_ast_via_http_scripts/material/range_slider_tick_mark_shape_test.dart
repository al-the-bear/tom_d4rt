// Comprehensive D4rt test script: RangeSliderTickMarkShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RangeSliderTickMarkShape script ===');
  ...
  final Type targetType = RangeSliderTickMarkShape;
  ...
  detailLines.add('target=RangeSliderTickMarkShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RangeSliderTickMarkShape'), 'Target type symbol resolves');
