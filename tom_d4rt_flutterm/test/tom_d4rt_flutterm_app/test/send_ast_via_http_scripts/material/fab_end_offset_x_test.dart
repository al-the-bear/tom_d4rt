...
dynamic build(BuildContext context) {
  ...
  print('Demonstrating FAB end X offset positioning for endDocked and endFloat');
...
Widget _buildEndAlignedPositions() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Three End-Aligned FAB Locations',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 12),
        Column(children: items),
        SizedBox(height: 12),
        buildInfoCard('FabEndOffsetX:', 'Mixin providing getOffsetX for end-alignment'),
      ],
    ),
  );
}

Widget _buildEndDiagram(String label, double xFraction, double yFraction, Color fabColor, bool docked) {
  return Container(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text('X offset: scaffoldWidth - fabWidth - padding',
                  style: TextStyle(fontFamily: 'monospace', fontSize: 10, color: Color(0xFF616161))),
              SizedBox(height: 4),
              Text(docked ? 'Docked into bottom bar at end' : 'Floating at end position',
      ...
      children: [
        Expanded(
          child: Container(
            ...
            child: Column(
              children: [
                Text('endFloat', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF4527A0))),
                SizedBox(height: 12),
                Container(
                ...
                SizedBox(height: 8),
                Text('FAB floats at end, above bar', style: TextStyle(fontSize: 11, color: Color(0xFF616161))),
                Text('Standard 16px end margin', style: TextStyle(fontSize: 11, color: Color(0xFF9E9E9E))),
              ],
            ),
          ),
        ),
        ...
        Expanded(
          child: Container(
            ...
            child: Column(
              children: [
                Text('endDocked', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF00897B))),
                SizedBox(height: 12),
                Container(
                  height: 100, width: double.infinity,
                  decoration: BoxDecoration(
                ...
                SizedBox(height: 8),
                Text('FAB docked at end into bar', style: TextStyle(fontSize: 11, color: Color(0xFF616161))),
                Text('Notch at trailing edge', style: TextStyle(fontSize: 11, color: Color(0xFF9E9E9E))),
              ],
            ),
          ),
        ),
...
Widget _buildXOffsetCalculation() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('FabEndOffsetX.getOffsetX Formula',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 16),
        Container(
          width: double.infinity,
          ...
          child: Column(
            ...
            children: [
              ...
              Text('x = scaffoldWidth - fabWidth - endPadding',
              ...
              SizedBox(height: 10),
              Text('// Example LTR: scaffold=400, fab=56, padding=16:',
                  style: TextStyle(fontFamily: 'monospace', fontSize: 10, color: Color(0xFF78909C))),
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('body content area', style: TextStyle(fontSize: 7, color: Color(0xFF2E7D32)))),
                ),
              ),
              Positioned(
                top: 22, right: 48,
                child: Container(
                  ...
                  child: Center(child: Text('FAB', style: TextStyle(fontSize: 7, color: Color(0xFF4527A0)))),
                ),
              ),
              Positioned(
                top: 22, right: 2,
        ...
        SizedBox(height: 8),
        buildInfoCard('Key:', 'End-aligned FAB sits at scaffoldWidth minus FAB width minus padding'),
      ],
    ),
  );
}
...
Widget _buildLtrVsRtl() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('End Position in LTR vs RTL Layouts',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 16),
        ...
        SizedBox(height: 12),
        buildInfoCard('LTR End:', 'Right side of scaffold (standard Western layout)'),
        buildInfoCard('RTL End:', 'Left side of scaffold (Arabic, Hebrew layout)'),
        buildInfoCard('Impact:', 'getOffsetX considers TextDirection for correct end placement'),
      ],
    ),
  );
}
...
Widget _buildEndOffsetWidths() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('End X Offset at various scaffold widths (LTR)',
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 4),
        Text('FAB starts at ${(fraction * 100).toStringAsFixed(1)}% from left',
...
Widget _buildEndWithBottomAppBar() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('End-Docked FAB with BottomAppBar Pattern',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
        SizedBox(height: 16),
        Container(
        ...
        SizedBox(height: 12),
        buildInfoCard('Pattern:', 'endDocked FAB with BottomAppBar gives leading actions space'),
        buildInfoCard('X Position:', 'Calculated by FabEndOffsetX.getOffsetX()'),
        buildInfoCard('Benefit:', 'Menu items on the left, FAB on the right for easy access'),
      ],
    ),
  );
}
...
Widget _buildPaddingAndSafeArea() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('End Padding and Safe Area Considerations',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 16),
        ...
        SizedBox(height: 12),
        buildInfoCard('Safe Area:', 'End offset accounts for device safe area insets'),
        buildInfoCard('Standard:', 'Default end padding is typically 16dp from scaffold edge'),
      ],
    ),
  );
}
      ...
      children: [
        Container(
          ...
          child: Stack(
            children: [
              Positioned(
                right: (padding * 0.6).toDouble(), top: 4,
                child: Container(
                  width: 22, height: 22,
                  decoration: BoxDecoration(
                    color: color,
              ...
              Positioned(
                right: 2, top: 10,
                child: Container(
                  width: (padding * 0.6).toDouble(), height: 1,
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text('${padding}dp end inset', style: TextStyle(fontFamily: 'monospace', fontSize: 10, color: Color(0xFF757575))),
            ],
          ),
        ),
      ],
...
Widget _buildMiniFabEndPositions() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Mini FAB End Variants',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 16),
        Row(
          children: [
            Expanded(child: _buildFabEndSizeCard('Standard', 56, Color(0xFF4527A0))),
            SizedBox(width: 12),
            Expanded(child: _buildFabEndSizeCard('Mini', 40, Color(0xFF6A1B9A))),
          ],
        ),
        SizedBox(height: 12),
        buildInfoCard('miniEndFloat:', 'Mini FAB floating at end position'),
        buildInfoCard('miniEndDocked:', 'Mini FAB docked at end position'),
        buildInfoCard('Calculation:', 'Same formula but with smaller fabWidth (40 instead of 56)'),
      ],
    ),
  );
}
...
Widget _buildEndPositionEnumValues() {
  ...
  locations.add(_buildLocationRow('endFloat', 'End X, floating above bottom', true, Color(0xFF4527A0)));
  locations.add(SizedBox(height: 4));
  locations.add(_buildLocationRow('endDocked', 'End X, docked into bottom bar', true, Color(0xFF00897B)));
  locations.add(SizedBox(height: 4));
  locations.add(_buildLocationRow('endTop', 'End X, top of body area', true, Color(0xFFD84315)));
  locations.add(SizedBox(height: 4));
  locations.add(_buildLocationRow('miniEndFloat', 'End X, mini size, floating', true, Color(0xFF6A1B9A)));
  locations.add(SizedBox(height: 4));
  locations.add(_buildLocationRow('miniEndDocked', 'End X, mini size, docked', true, Color(0xFF283593)));
  locations.add(SizedBox(height: 4));
  locations.add(_buildLocationRow('miniEndTop', 'End X, mini size, top', true, Color(0xFF00695C)));
  locations.add(SizedBox(height: 10));
  locations.add(_buildLocationRow('centerFloat', 'Center X (NOT end)', false, Color(0xFF757575)));
  locations.add(SizedBox(height: 4));
  locations.add(_buildLocationRow('startFloat', 'Start X (NOT end)', false, Color(0xFF757575)));
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('FAB Location values using FabEndOffsetX',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
        SizedBox(height: 12),
...
Widget _buildPropertiesAndApi() {
  ...
  List<Widget> rows = [];
  rows.add(_buildApiRow('getOffsetX', 'double', 'Returns X offset for end-aligned FAB', Color(0xFF4527A0)));
  rows.add(_buildApiRow('scaffoldGeometry', 'ScaffoldPrelayoutGeometry', 'Input: scaffold layout info', Color(0xFF00897B)));
  rows.add(_buildApiRow('textDirection', 'TextDirection', 'LTR or RTL for correct end side', Color(0xFFD84315)));
  rows.add(_buildApiRow('adjustment', 'double', 'Additional offset adjustment', Color(0xFF1565C0)));
  rows.add(_buildApiRow('endPadding', 'double', 'Padding from scaffold edge', Color(0xFF6A1B9A)));
