...
const String _targetClassName = 'FabEndOffsetX';

class FabEndOffsetXScenario {
  FabEndOffsetXScenario({
    required this.label,
  ...
  FabEndOffsetXScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return FabEndOffsetXScenario(
...
List<String> _runScenarioChecks(FabEndOffsetXScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = FabEndOffsetXScenario(
  ...
  _expect(_targetClassName == 'FabEndOffsetX', 'target class identifier should match filename');
