...
dynamic build(BuildContext context) {
  ...
  _expect(
    iconA.runtimeType.toString().contains('CloseButtonIcon'),
    'constructor creates CloseButtonIcon',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    iconB.key == const ValueKey<String>('close-icon'),
    'constructor stores key',
    logs,
  );
  assertionCount++;
