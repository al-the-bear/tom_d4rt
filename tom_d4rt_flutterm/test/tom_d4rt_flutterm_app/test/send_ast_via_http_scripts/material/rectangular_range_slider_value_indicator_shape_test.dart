// Comprehensive D4rt test script: RectangularRangeSliderValueIndicatorShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RectangularRangeSliderValueIndicatorShape script ===');
  ...
  final Type targetType = RectangularRangeSliderValueIndicatorShape;
  ...
  detailLines.add('target=RectangularRangeSliderValueIndicatorShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RectangularRangeSliderValueIndicatorShape'), 'Target type symbol resolves');
