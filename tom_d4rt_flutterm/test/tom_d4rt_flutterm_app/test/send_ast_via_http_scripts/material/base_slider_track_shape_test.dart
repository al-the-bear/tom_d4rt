...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    shapeA is SliderTrackShape,
    'shapeA implements SliderTrackShape',
    logs,
    counters,
  );
  expectCondition(
    shapeB is SliderTrackShape,
    'shapeB implements SliderTrackShape',
    logs,
    counters,
  );
  expectCondition(
    shapeA.runtimeType.toString().isNotEmpty,
    'shapeA runtimeType available',
    logs,
    counters,
  );
  expectCondition(
    shapeB.runtimeType.toString().isNotEmpty,
    'shapeB runtimeType available',
    logs,
    counters,
  );
  details['shapeA'] = shapeA.runtimeType.toString();
  details['shapeB'] = shapeB.runtimeType.toString();
  details['indirectBaseSliderTrackShape'] =
      'RoundedRectSliderTrackShape/RectangularSliderTrackShape use BaseSliderTrackShape';
