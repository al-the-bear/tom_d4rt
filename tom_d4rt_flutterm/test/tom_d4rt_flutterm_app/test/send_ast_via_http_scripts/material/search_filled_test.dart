// Comprehensive D4rt test script: SearchFilled from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SearchFilled script ===');
  ...
  detailLines.add('target=SearchFilled');
  ...
  const String targetTypeName = 'SearchFilled';
  check(targetTypeName == 'SearchFilled', 'Name matches');
  detailLines.add('category=material_search');
  detailLines.add('desc=Filled search bar variant');
  // SearchBar is the main entry point
  final SearchBar bar = SearchBar(hintText: 'Search...', onChanged: (String v) {});
  check(bar is Widget, 'SearchBar is Widget');
  detailLines.add('hintText=Search...');
