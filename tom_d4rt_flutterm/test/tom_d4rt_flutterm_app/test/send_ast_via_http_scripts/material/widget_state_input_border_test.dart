// Comprehensive D4rt test script: WidgetStateInputBorder from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStateInputBorder script ===');
  ...
  final Type targetType = WidgetStateInputBorder;
  ...
  detailLines.add('target=WidgetStateInputBorder');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('WidgetStateInputBorder'), 'Target type symbol resolves');
