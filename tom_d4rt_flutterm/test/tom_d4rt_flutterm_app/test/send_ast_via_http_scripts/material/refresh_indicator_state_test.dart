// Comprehensive D4rt test script: RefreshIndicatorState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RefreshIndicatorState script ===');
  ...
  final Type targetType = RefreshIndicatorState;
  ...
  detailLines.add('target=RefreshIndicatorState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RefreshIndicatorState'), 'Target type symbol resolves');
