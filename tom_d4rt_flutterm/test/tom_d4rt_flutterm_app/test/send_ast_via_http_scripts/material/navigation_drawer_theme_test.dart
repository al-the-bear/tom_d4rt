...
Widget buildDestinationItem(
  ...
  return Container(
    ...
    child: Row(
      children: [
        SizedBox(width: 16),
        Icon(icon, size: 24, color: selected ? iconColor : Colors.grey.shade600),
        SizedBox(width: 12),
        Expanded(
          child: Text(
            label,
...
Widget buildThemedDrawerPreview(
  ...
  Color iconColor = themeData.iconTheme?.resolve({WidgetState.selected})?.color ?? Colors.blue;

  List<Widget> items = [];
  int i = 0;
  for (i = 0; i < labels.length; i = i + 1) {
    items.add(buildDestinationItem(
      icons[i],
      labels[i],
      i == selectedIndex,
      indicatorColor,
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: Text('Theme 1', textAlign: TextAlign.center, style: TextStyle(fontSize: 11)),
                ),
              ),
              SizedBox(width: 8),
              Expanded(
                child: Container(
                  ...
                  child: Text('Theme 2', textAlign: TextAlign.center, style: TextStyle(fontSize: 11)),
                ),
              ),
            ],
          ),
...
Widget buildNestedThemeDemo(
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(outerLabel, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
        SizedBox(height: 8),
        Container(
          width: double.infinity,
          padding: EdgeInsets.all(12),
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: innerTheme.indicatorColor ?? Colors.blue, width: 2),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(innerLabel, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
              SizedBox(height: 4),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                decoration: BoxDecoration(
                  color: innerTheme.indicatorColor?.withAlpha(50) ?? Colors.blue.shade50,
      ...
      children: [
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(sectionTitle, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
              Text(sectionDesc, style: TextStyle(color: Colors.white70, fontSize: 12)),
            ],
          ),
        ),
        Container(
          ...
          child: Column(
            children: itemLabels.map((label) {
              return Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.circle, size: 8, color: themeData.indicatorColor ?? Colors.grey),
                    SizedBox(width: 12),
...
Widget buildInteractiveSection(
  ...
  List<String> menuItems = ['Dashboard', 'Analytics', 'Settings', 'Profile', 'Help'];
...
dynamic build(BuildContext context) {
  ...
  NavigationDrawerThemeData primaryTheme = NavigationDrawerThemeData(
    ...
    labelTextStyle: WidgetStateProperty.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return TextStyle(color: Colors.blue.shade800, fontWeight: FontWeight.bold);
      }
  ...
  sections.add(buildInfoCard('Purpose', 'Provides NavigationDrawerThemeData to descendants'));
  sections.add(buildInfoCard('Data class', 'NavigationDrawerThemeData'));
  sections.add(buildInfoCard('Access method', 'NavigationDrawerTheme.of(context)'));
  sections.add(buildInfoCard('Merge behavior', 'Inherits from ancestor if not overridden'));
  ...
  sections.add(buildThemedDrawerPreview(
  ...
  sections.add(buildInfoCard('Wrapper usage', 'NavigationDrawerTheme(data: themeData, child: drawer)'));
  sections.add(buildInfoCard('Effect', 'All NavigationDrawer descendants receive the theme'));

  sections.add(buildSectionHeader('3. NavigationDrawerTheme.of(context)'));
  sections.add(buildInfoCard('Static method', 'NavigationDrawerTheme.of(context)'));
  sections.add(buildInfoCard('Returns', 'NavigationDrawerThemeData from nearest ancestor'));
  sections.add(buildInfoCard('Fallback', 'Returns default data if no ancestor found'));
  sections.add(Container(
    margin: EdgeInsets.symmetric(vertical: 8),
    padding: EdgeInsets.all(16),
    decoration: BoxDecoration(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Accessing theme in build method:', style: TextStyle(fontWeight: FontWeight.bold)),
        SizedBox(height: 8),
        Container(
  ...
  sections.add(buildNestedThemeDemo(
    'Outer Theme (Blue)',
  ...
  sections.add(buildInfoCard('Behavior', 'Inner themes override outer themes completely'));

  sections.add(buildSectionHeader('5. Multiple Themed Sections'));
  sections.add(buildThemeSectionCard(
    'Primary Section',
    'Using blue theme',
  ...
  sections.add(buildInfoCard('Inheritance model', 'Child widgets inherit from nearest ancestor'));
  sections.add(buildInfoCard('Specificity', 'Closer ancestors take precedence'));
  sections.add(Container(
    margin: EdgeInsets.symmetric(vertical: 8),
    padding: EdgeInsets.all(12),
    decoration: BoxDecoration(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Inheritance Chain:', style: TextStyle(fontWeight: FontWeight.bold)),
        SizedBox(height: 8),
        Row(
          children: [
            Container(
  ...
  sections.add(buildInfoCard('iconTheme', 'WidgetStateProperty<IconThemeData> for state-based icons'));
  sections.add(buildInfoCard('labelTextStyle', 'WidgetStateProperty<TextStyle> for state-based labels'));
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              buildDestinationItem(Icons.home, 'Home', true, primaryTheme.indicatorColor ?? Colors.blue, Colors.blue),
              buildDestinationItem(Icons.explore, 'Explore', false, primaryTheme.indicatorColor ?? Colors.blue, Colors.blue),
              Divider(),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                child: Text('SETTINGS', style: TextStyle(fontSize: 11, color: Colors.grey, fontWeight: FontWeight.bold)),
              ),
              buildDestinationItem(Icons.settings, 'Settings', false, primaryTheme.indicatorColor ?? Colors.blue, Colors.blue),
              buildDestinationItem(Icons.help, 'Help', false, primaryTheme.indicatorColor ?? Colors.blue, Colors.blue),
            ],
          ),
        ),
      ],
  ...
  sections.add(buildThemeComparisonRow('Background', primaryTheme, secondaryTheme));
        ...
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              color: primaryTheme.backgroundColor,
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: primaryTheme.indicatorColor ?? Colors.blue, width: 2),
            ),
            child: Column(
              children: [
        ...
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: secondaryTheme.indicatorColor ?? Colors.green, width: 2),
            ),
            child: Column(
              children: [
                Text('Secondary', style: TextStyle(fontWeight: FontWeight.bold)),
                SizedBox(height: 4),
                Container(
                  height: 8,
                  decoration: BoxDecoration(
        ...
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: accentTheme.indicatorColor ?? Colors.purple, width: 2),
            ),
            child: Column(
              children: [
  ...
  sections.add(buildInteractiveSection('Interactive Menu - Primary Theme', primaryTheme, 0));
  sections.add(buildInteractiveSection('Interactive Menu - Secondary Theme', secondaryTheme, 2));
  sections.add(buildInteractiveSection('Interactive Menu - Accent Theme', accentTheme, 4));
  ...
  print('NavigationDrawerTheme test completed with ${sections.length} sections');
