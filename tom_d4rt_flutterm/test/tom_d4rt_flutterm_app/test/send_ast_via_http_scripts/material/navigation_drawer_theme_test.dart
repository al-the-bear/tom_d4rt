// Comprehensive D4rt test script: NavigationDrawerTheme from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NavigationDrawerTheme script ===');
  ...
  final Type targetType = NavigationDrawerTheme;
  ...
  detailLines.add('target=NavigationDrawerTheme');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('NavigationDrawerTheme'), 'Target type symbol resolves');
