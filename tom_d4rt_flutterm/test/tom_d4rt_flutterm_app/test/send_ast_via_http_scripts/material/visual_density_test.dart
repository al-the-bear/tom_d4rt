// Comprehensive D4rt test script: VisualDensity from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive VisualDensity script ===');
  ...
  final Type targetType = VisualDensity;
  ...
  detailLines.add('target=VisualDensity');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('VisualDensity'), 'Target type symbol resolves');
