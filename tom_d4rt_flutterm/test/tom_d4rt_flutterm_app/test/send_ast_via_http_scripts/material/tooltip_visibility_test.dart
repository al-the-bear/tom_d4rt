// Comprehensive D4rt test script: TooltipVisibility from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TooltipVisibility script ===');
  ...
  final Type targetType = TooltipVisibility;
  ...
  detailLines.add('target=TooltipVisibility');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TooltipVisibility'), 'Target type symbol resolves');
