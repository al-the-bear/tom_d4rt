...
dynamic build(BuildContext context) {
  ...
  check(
    picker.initialDate == DateTime(2024, 6, 14),
    'Picker stores initialDate',
  );
  check(
    edgePicker.initialDate == firstDate,
    'Edge case: initialDate at lower boundary',
  );
  check(
    picker.acceptEmptyDate == false || picker.acceptEmptyDate == true,
    'acceptEmptyDate is a valid bool',
  );
