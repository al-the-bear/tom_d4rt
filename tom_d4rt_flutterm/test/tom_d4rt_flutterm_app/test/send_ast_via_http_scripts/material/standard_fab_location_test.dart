// Comprehensive D4rt test script: StandardFabLocation from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive StandardFabLocation script ===');
  ...
  final Type targetType = StandardFabLocation;
  ...
  detailLines.add('target=StandardFabLocation');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('StandardFabLocation'), 'Target type symbol resolves');
