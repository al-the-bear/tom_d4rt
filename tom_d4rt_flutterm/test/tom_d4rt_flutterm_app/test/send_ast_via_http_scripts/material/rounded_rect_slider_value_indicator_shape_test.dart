...
/// Deep visual demo for RoundedRectSliderValueIndicatorShape.
/// Rounded rectangle value tooltip for Slider.
dynamic build(BuildContext context) {
  return Column(
    mainAxisSize: MainAxisSize.min,
    children: [
      const Text('RoundedRectSliderValueIndicatorShape', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
      ...
      const Text('Rounded tooltip styling', style: TextStyle(fontSize: 11, color: Colors.grey)),
    ],
  );
}
