// Comprehensive D4rt test script: RoundedRectSliderValueIndicatorShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundedRectSliderValueIndicatorShape script ===');
  ...
  final Type targetType = RoundedRectSliderValueIndicatorShape;
  ...
  detailLines.add('target=RoundedRectSliderValueIndicatorShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundedRectSliderValueIndicatorShape'), 'Target type symbol resolves');
