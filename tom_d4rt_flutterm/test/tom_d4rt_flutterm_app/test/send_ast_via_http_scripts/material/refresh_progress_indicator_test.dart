// Comprehensive D4rt test script: RefreshProgressIndicator from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RefreshProgressIndicator script ===');
  ...
  final Type targetType = RefreshProgressIndicator;
  ...
  detailLines.add('target=RefreshProgressIndicator');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RefreshProgressIndicator'), 'Target type symbol resolves');
