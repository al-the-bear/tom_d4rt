...
dynamic build(BuildContext context) {
  ...
  check(
    ...
    'max extent exceeds min extent',
  );
  check(
    settings.currentExtent >= settings.minExtent,
    'current extent above min extent',
  );
  check(
    edgeSettings.maxExtent == edgeSettings.minExtent,
    'edge supports equal extents',
  );
  check(
    settings.child.toString().contains('SizedBox'),
    'settings child is preserved',
  );
