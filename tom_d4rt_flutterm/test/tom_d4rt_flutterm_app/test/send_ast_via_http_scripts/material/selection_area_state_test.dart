// Comprehensive D4rt test script: SelectionAreaState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionAreaState script ===');
  ...
  final Type targetType = SelectionAreaState;
  ...
  detailLines.add('target=SelectionAreaState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SelectionAreaState'), 'Target type symbol resolves');
