// Comprehensive D4rt test script: RoundedRectSliderTrackShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundedRectSliderTrackShape script ===');
  ...
  final Type targetType = RoundedRectSliderTrackShape;
  ...
  detailLines.add('target=RoundedRectSliderTrackShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundedRectSliderTrackShape'), 'Target type symbol resolves');
