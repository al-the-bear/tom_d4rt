// Comprehensive D4rt test script: SearchController from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SearchController script ===');
  ...
  final Type targetType = SearchController;
  ...
  detailLines.add('target=SearchController');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SearchController'), 'Target type symbol resolves');
