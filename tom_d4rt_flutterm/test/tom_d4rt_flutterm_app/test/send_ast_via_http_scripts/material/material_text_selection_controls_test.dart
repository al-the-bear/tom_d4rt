// Comprehensive D4rt test script: MaterialTextSelectionControls from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MaterialTextSelectionControls script ===');
  ...
  final Type targetType = MaterialTextSelectionControls;
  ...
  detailLines.add('target=MaterialTextSelectionControls');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MaterialTextSelectionControls'), 'Target type symbol resolves');
