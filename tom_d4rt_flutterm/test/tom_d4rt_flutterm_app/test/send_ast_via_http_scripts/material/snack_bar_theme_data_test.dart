// Comprehensive D4rt test script: SnackBarThemeData from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SnackBarThemeData script ===');
  ...
  final Type targetType = SnackBarThemeData;
  ...
  detailLines.add('target=SnackBarThemeData');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SnackBarThemeData'), 'Target type symbol resolves');
