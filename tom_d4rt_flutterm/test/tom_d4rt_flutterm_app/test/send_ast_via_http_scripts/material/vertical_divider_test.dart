// Comprehensive D4rt test script: VerticalDivider from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive VerticalDivider script ===');
  ...
  final Type targetType = VerticalDivider;
  ...
  detailLines.add('target=VerticalDivider');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('VerticalDivider'), 'Target type symbol resolves');
