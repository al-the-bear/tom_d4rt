...
// D4rt test script: Comprehensive tests for GappedSliderTrackShape from material
import 'package:flutter/material.dart';

dynamic build(BuildContext context) {
  print('=== D4rt material test start: GappedSliderTrackShape ===');

  final symbolName = 'GappedSliderTrackShape';
  final fileName = 'gapped_slider_track_shape_test.dart';
  final logs = <String>[];
  ...
  const shapeA = GappedSliderTrackShape();
  const shapeB = GappedSliderTrackShape();
  check(shapeA.runtimeType == GappedSliderTrackShape, 'shape A type matches');
  check(shapeB.runtimeType == GappedSliderTrackShape, 'shape B type matches');
