...
dynamic build(BuildContext context) {
  ...
  assertionCount++;
  _expect(
    copy.padding == base.padding,
    'copyWith preserves untouched values',
    logs,
  );
  assertionCount++;
  _expect(
    lerped.backgroundColor != null,
    'lerp computes interpolated color',
    logs,
  );
  assertionCount++;
  _expect(
    edge.overlayColor == null && edge.shape == null,
