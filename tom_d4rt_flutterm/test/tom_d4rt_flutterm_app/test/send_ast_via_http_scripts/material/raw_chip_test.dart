// Comprehensive D4rt test script: RawChip from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawChip script ===');
  ...
  detailLines.add('target=RawChip');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RawChip'), 'Target type symbol resolves');
