// Comprehensive D4rt test script: SimpleDialogOption from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SimpleDialogOption script ===');
  ...
  final Type targetType = SimpleDialogOption;
  ...
  detailLines.add('target=SimpleDialogOption');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SimpleDialogOption'), 'Target type symbol resolves');
