...
dynamic build(BuildContext context) {
  ...
  _expect(
    controller.runtimeType.toString().contains('DrawerController'),
    'constructs DrawerController',
    logs,
  );
  assertionCount++;
  _expect(
    controller.alignment == DrawerAlignment.start,
    'alignment is start',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    controller.child.runtimeType.toString().contains('SizedBox'),
    'child widget is preserved',
    logs,
  );
  assertionCount++;
  _expect(
    endAligned.alignment == DrawerAlignment.end,
    'edge case: end alignment supported',
    logs,
  );
  assertionCount++;
