// Comprehensive D4rt test script: MenuAcceleratorCallbackBinding from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MenuAcceleratorCallbackBinding script ===');
  ...
  final Type targetType = MenuAcceleratorCallbackBinding;
  ...
  detailLines.add('target=MenuAcceleratorCallbackBinding');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MenuAcceleratorCallbackBinding'), 'Target type symbol resolves');
