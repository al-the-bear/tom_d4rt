...
dynamic build(BuildContext context) {
  ...
  _expect(baseTheme.runtimeType.toString().contains('DataTableThemeData'), 'default constructor creates expected runtime type', logs);
  assertionCount++;
  _expect(denseTheme.dataRowMinHeight == 24, 'copyWith updates dataRowMinHeight', logs);
  assertionCount++;
  _expect(denseTheme.dataRowMaxHeight == 48, 'copyWith updates dataRowMaxHeight', logs);
  assertionCount++;
  _expect(denseTheme.headingRowHeight == 52, 'copyWith updates heading row height', logs);
  assertionCount++;
  _expect(denseTheme.dividerThickness == 1.5, 'copyWith updates divider thickness', logs);
  assertionCount++;
