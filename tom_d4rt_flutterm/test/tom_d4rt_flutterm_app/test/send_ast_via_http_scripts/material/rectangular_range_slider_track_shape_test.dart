// Comprehensive D4rt test script: RectangularRangeSliderTrackShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RectangularRangeSliderTrackShape script ===');
  ...
  final Type targetType = RectangularRangeSliderTrackShape;
  ...
  detailLines.add('target=RectangularRangeSliderTrackShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RectangularRangeSliderTrackShape'), 'Target type symbol resolves');
