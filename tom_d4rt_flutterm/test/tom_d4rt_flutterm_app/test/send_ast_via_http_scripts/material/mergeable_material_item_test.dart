// Comprehensive D4rt test script: MergeableMaterialItem from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MergeableMaterialItem script ===');
  ...
  final Type targetType = MergeableMaterialItem;
  ...
  detailLines.add('target=MergeableMaterialItem');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MergeableMaterialItem'), 'Target type symbol resolves');
