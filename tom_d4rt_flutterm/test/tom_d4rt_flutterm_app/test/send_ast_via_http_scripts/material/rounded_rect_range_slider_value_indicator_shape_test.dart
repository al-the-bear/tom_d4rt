// Comprehensive D4rt test script: RoundedRectRangeSliderValueIndicatorShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundedRectRangeSliderValueIndicatorShape script ===');
  ...
  final Type targetType = RoundedRectRangeSliderValueIndicatorShape;
  ...
  detailLines.add('target=RoundedRectRangeSliderValueIndicatorShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundedRectRangeSliderValueIndicatorShape'), 'Target type symbol resolves');
