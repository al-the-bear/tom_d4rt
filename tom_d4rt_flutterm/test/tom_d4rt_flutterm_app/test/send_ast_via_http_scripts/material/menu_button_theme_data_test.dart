// Comprehensive D4rt test script: MenuButtonThemeData from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MenuButtonThemeData script ===');
  ...
  final Type targetType = MenuButtonThemeData;
  ...
  detailLines.add('target=MenuButtonThemeData');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('MenuButtonThemeData'), 'Target type symbol resolves');
