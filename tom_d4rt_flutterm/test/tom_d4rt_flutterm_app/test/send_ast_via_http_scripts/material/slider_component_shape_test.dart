// Comprehensive D4rt test script: SliderComponentShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliderComponentShape script ===');
  ...
  final Type targetType = SliderComponentShape;
  ...
  detailLines.add('target=SliderComponentShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SliderComponentShape'), 'Target type symbol resolves');
