...
dynamic build(BuildContext context) {
  ...
  print(
    '=== DesktopTextSelectionToolbarButton comprehensive D4rt test start ===',
  );
  _expect(
  ...
  log(
    'Created enabled and disabled DesktopTextSelectionToolbarButton instances',
  );
  _expect(
    button.runtimeType.toString().contains('DesktopTextSelectionToolbarButton'),
    'constructs DesktopTextSelectionToolbarButton.text',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    button.toString().contains('Copy'),
    'string output reflects configured text label',
    logs,
  );
  assertionCount++;
  _expect(
    disabled.onPressed == null,
    'edge case: disabled button allows null callback',
    logs,
  );
  assertionCount++;
  _expect(
    disabled.runtimeType == button.runtimeType,
    'named constructor keeps runtime type stable',
    logs,
  );
  assertionCount++;
  ...
  print(
    '=== DesktopTextSelectionToolbarButton comprehensive D4rt test end ===',
  );
