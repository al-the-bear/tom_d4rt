...
dynamic build(BuildContext context) {
  ...
  _expect(
    localizations.runtimeType.toString().contains(
      'DefaultMaterialLocalizations',
    ),
    'constructs DefaultMaterialLocalizations',
    logs,
  );
  assertionCount++;
  _expect(
    localizations.backButtonTooltip.isNotEmpty,
    'backButtonTooltip is available',
    logs,
  );
  assertionCount++;
  _expect(
    localizations.closeButtonLabel.isNotEmpty,
    'closeButtonLabel is available',
    logs,
  );
  assertionCount++;
  _expect(
    localizations.okButtonLabel.isNotEmpty,
    'okButtonLabel is available',
    logs,
  );
  assertionCount++;
  _expect(
