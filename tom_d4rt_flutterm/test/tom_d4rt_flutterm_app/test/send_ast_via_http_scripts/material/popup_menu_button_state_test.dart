// Comprehensive D4rt test script: PopupMenuButtonState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopupMenuButtonState script ===');
  ...
  final Type targetType = PopupMenuButtonState;
  ...
  detailLines.add('target=PopupMenuButtonState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PopupMenuButtonState'), 'Target type symbol resolves');
