// Comprehensive D4rt test script: ScaffoldGeometry from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScaffoldGeometry script ===');
  ...
  final Type targetType = ScaffoldGeometry;
  ...
  detailLines.add('target=ScaffoldGeometry');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ScaffoldGeometry'), 'Target type symbol resolves');
