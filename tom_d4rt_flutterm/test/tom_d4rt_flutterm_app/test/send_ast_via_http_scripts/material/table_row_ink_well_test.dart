// Comprehensive D4rt test script: TableRowInkWell from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TableRowInkWell script ===');
  ...
  final Type targetType = TableRowInkWell;
  ...
  detailLines.add('target=TableRowInkWell');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TableRowInkWell'), 'Target type symbol resolves');
