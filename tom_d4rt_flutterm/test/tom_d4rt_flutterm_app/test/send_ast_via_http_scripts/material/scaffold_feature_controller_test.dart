// Comprehensive D4rt test script: ScaffoldFeatureController from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScaffoldFeatureController script ===');
  ...
  final Type targetType = ScaffoldFeatureController;
  ...
  detailLines.add('target=ScaffoldFeatureController');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ScaffoldFeatureController'), 'Target type symbol resolves');
