...
dynamic build(BuildContext context) {
  ...
  final InteractiveInkFeatureFactory seededFactory =
      InkSparkle.constantTurbulenceSeedSplashFactory;

  check(
    sparkleFactory.runtimeType.toString().contains('InkSparkle') ||
        sparkleFactory.runtimeType.toString().contains('Factory'),
    'InkSparkle splash factory runtimeType is descriptive',
  );
  check(
    seededFactory.runtimeType.toString().contains('InkSparkle') ||
        seededFactory.runtimeType.toString().contains('Factory'),
    'Seeded splash factory runtimeType is descriptive',
  );
  check(
    sparkleFactory.runtimeType.toString().isNotEmpty,
    'Factory runtimeType is readable',
  );
  check(
    seededFactory.runtimeType.toString().isNotEmpty,
    'Seeded factory runtimeType is readable',
  );
  check(
    sparkleFactory != seededFactory,
    'Edge case: standard and seeded factories differ',
  );
