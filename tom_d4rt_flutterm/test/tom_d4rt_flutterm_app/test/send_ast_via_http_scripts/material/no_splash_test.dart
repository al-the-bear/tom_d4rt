// Comprehensive D4rt test script: NoSplash from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NoSplash script ===');
  ...
  final Type targetType = NoSplash;
  ...
  detailLines.add('target=NoSplash');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('NoSplash'), 'Target type symbol resolves');
