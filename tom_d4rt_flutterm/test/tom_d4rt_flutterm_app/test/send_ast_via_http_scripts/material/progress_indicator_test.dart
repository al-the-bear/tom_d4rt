// Comprehensive D4rt test script: ProgressIndicator from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ProgressIndicator script ===');
  ...
  final Type targetType = ProgressIndicator;
  ...
  detailLines.add('target=ProgressIndicator');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ProgressIndicator'), 'Target type symbol resolves');
