...
dynamic build(BuildContext context) {
  ...
  check(
    addIcon.codePoint != menuIcon.codePoint,
    'Different icons have different code points',
  );
  check(addIcon.fontFamily != null, 'IconData has font family');
  check(
    closeIcon.matchTextDirection == false ||
        closeIcon.matchTextDirection == true,
    'Edge case: matchTextDirection is a valid bool',
  );
