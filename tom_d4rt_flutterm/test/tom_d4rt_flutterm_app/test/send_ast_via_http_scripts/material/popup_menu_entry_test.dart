// Comprehensive D4rt test script: PopupMenuEntry from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopupMenuEntry script ===');
  ...
  final Type targetType = PopupMenuEntry;
  ...
  detailLines.add('target=PopupMenuEntry');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PopupMenuEntry'), 'Target type symbol resolves');
