// Comprehensive D4rt test script: SearchDelegate from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SearchDelegate script ===');
  ...
  final Type targetType = SearchDelegate;
  ...
  detailLines.add('target=SearchDelegate');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SearchDelegate'), 'Target type symbol resolves');
