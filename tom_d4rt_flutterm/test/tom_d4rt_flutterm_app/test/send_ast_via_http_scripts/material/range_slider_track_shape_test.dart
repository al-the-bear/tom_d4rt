// Comprehensive D4rt test script: RangeSliderTrackShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RangeSliderTrackShape script ===');
  ...
  final Type targetType = RangeSliderTrackShape;
  ...
  detailLines.add('target=RangeSliderTrackShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RangeSliderTrackShape'), 'Target type symbol resolves');
