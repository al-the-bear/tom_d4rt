// Comprehensive D4rt test script: ScrollbarThemeData from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollbarThemeData script ===');
  ...
  final Type targetType = ScrollbarThemeData;
  ...
  detailLines.add('target=ScrollbarThemeData');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ScrollbarThemeData'), 'Target type symbol resolves');
