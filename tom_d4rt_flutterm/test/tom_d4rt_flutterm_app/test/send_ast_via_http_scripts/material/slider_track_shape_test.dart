// Comprehensive D4rt test script: SliderTrackShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliderTrackShape script ===');
  ...
  final Type targetType = SliderTrackShape;
  ...
  detailLines.add('target=SliderTrackShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SliderTrackShape'), 'Target type symbol resolves');
