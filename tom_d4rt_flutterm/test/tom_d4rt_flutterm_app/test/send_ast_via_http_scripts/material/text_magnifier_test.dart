// Comprehensive D4rt test script: TextMagnifier from material
...
dynamic build(BuildContext context) {
  ...
  final Type targetType = TextMagnifier;
  ...
  check(targetType.toString().contains('TextMagnifier'), 'Target type symbol resolves');
