...
// D4rt test script: Comprehensive tests for DropRangeSliderValueIndicatorShape from material
import 'package:flutter/material.dart';

dynamic build(BuildContext context) {
  print('=== D4rt material test start: DropRangeSliderValueIndicatorShape ===');

  final symbolName = 'DropRangeSliderValueIndicatorShape';
  final fileName = 'drop_range_slider_value_indicator_shape_test.dart';
  final logs = <String>[];
  ...
  const shapeA = DropRangeSliderValueIndicatorShape();
  const shapeB = DropRangeSliderValueIndicatorShape();
  check(
    shapeA.runtimeType == DropRangeSliderValueIndicatorShape,
    'shape A runtime type matches',
  );
  check(
    shapeB.runtimeType == DropRangeSliderValueIndicatorShape,
    'shape B runtime type matches',
  );
