...
dynamic build(BuildContext context) {
  ...
  check(shapeA.runtimeType == DropRangeSliderValueIndicatorShape, 'shape A runtime type matches');
  check(shapeB.runtimeType == DropRangeSliderValueIndicatorShape, 'shape B runtime type matches');
