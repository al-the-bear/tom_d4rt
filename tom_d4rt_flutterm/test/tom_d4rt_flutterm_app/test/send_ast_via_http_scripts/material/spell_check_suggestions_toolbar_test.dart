// Comprehensive D4rt test script: SpellCheckSuggestionsToolbar from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SpellCheckSuggestionsToolbar script ===');
  ...
  final Type targetType = SpellCheckSuggestionsToolbar;
  ...
  detailLines.add('target=SpellCheckSuggestionsToolbar');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('SpellCheckSuggestionsToolbar'), 'Target type symbol resolves');
