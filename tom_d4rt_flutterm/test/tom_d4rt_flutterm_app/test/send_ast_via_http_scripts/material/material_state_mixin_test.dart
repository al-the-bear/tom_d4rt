...
const String _targetClassName = 'MaterialStateMixin';

class MaterialStateMixinScenario {
  MaterialStateMixinScenario({
    required this.label,
  ...
  MaterialStateMixinScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return MaterialStateMixinScenario(
...
List<String> _runScenarioChecks(MaterialStateMixinScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = MaterialStateMixinScenario(
  ...
  _expect(_targetClassName == 'MaterialStateMixin', 'target class identifier should match filename');
