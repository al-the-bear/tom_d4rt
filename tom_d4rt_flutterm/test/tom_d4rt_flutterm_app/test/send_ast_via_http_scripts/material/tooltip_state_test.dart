// Comprehensive D4rt test script: TooltipState from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TooltipState script ===');
  ...
  final Type targetType = TooltipState;
  ...
  detailLines.add('target=TooltipState');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TooltipState'), 'Target type symbol resolves');
