// D4rt test script: Comprehensive tests for DialogThemeData
...
dynamic build(BuildContext context) {
  ...
  print('=== DialogThemeData comprehensive D4rt test start ===');
  _expect(
  ...
  const base = DialogThemeData();
  const customized = DialogThemeData(
    elevation: 8,
  ...
  log('Created base && customized DialogThemeData');
  _expect(
    base.runtimeType.toString().contains('DialogThemeData'),
    'constructs default DialogThemeData',
    logs,
  );
  assertionCount++;
  _expect(customized.elevation == 8, 'custom elevation is preserved', logs);
  assertionCount++;
  _expect(
    customized.alignment == Alignment.topCenter,
    'custom alignment is preserved',
    logs,
  );
  assertionCount++;
  _expect(customized.shape != null, 'custom shape is assigned', logs);
  assertionCount++;
  _expect(
    customized.copyWith(elevation: 10).elevation == 10,
    'copyWith updates elevation',
    logs,
  );
  assertionCount++;
  ...
  print('=== DialogThemeData comprehensive D4rt test end ===');

  return Column(
    mainAxisSize: MainAxisSize.min,
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text('DialogThemeData Summary'),
