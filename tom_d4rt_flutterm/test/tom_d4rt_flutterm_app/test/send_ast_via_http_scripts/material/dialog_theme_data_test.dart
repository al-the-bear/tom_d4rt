...
dynamic build(BuildContext context) {
  ...
  _expect(base.runtimeType.toString().contains('DialogThemeData'), 'constructs default DialogThemeData', logs);
  assertionCount++;
  _expect(customized.elevation == 8, 'custom elevation is preserved', logs);
  assertionCount++;
  _expect(customized.alignment == Alignment.topCenter, 'custom alignment is preserved', logs);
  assertionCount++;
  _expect(customized.shape != null, 'custom shape is assigned', logs);
  assertionCount++;
  _expect(customized.copyWith(elevation: 10).elevation == 10, 'copyWith updates elevation', logs);
  assertionCount++;
