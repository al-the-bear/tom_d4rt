...
dynamic build(BuildContext context) {
  ...
  log(
    'Instantiated DrawerButtonIcon constants for runtime and identity checks',
  );
  _expect(
    icon.runtimeType.toString().contains('DrawerButtonIcon'),
    'constructs DrawerButtonIcon',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    icon.hashCode >= 0 || icon.hashCode < 0,
    'hashCode property is available',
    logs,
  );
  assertionCount++;
  _expect(
    icon2.runtimeType == icon.runtimeType,
    'second const instance has same runtime type',
    logs,
  );
  assertionCount++;
  _expect(
