...
const String _targetClassName = 'FabDockedOffsetY';

class FabDockedOffsetYScenario {
  FabDockedOffsetYScenario({
    required this.label,
  ...
  FabDockedOffsetYScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return FabDockedOffsetYScenario(
...
List<String> _runScenarioChecks(FabDockedOffsetYScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = FabDockedOffsetYScenario(
  ...
  _expect(_targetClassName == 'FabDockedOffsetY', 'target class identifier should match filename');
