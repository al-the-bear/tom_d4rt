...
dynamic build(BuildContext context) {
  ...
  print('Demonstrating FAB docked Y offset positioning relative to BottomAppBar');
...
Widget _buildDockedConcept() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('How Docked Y-Offset Positions the FAB',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 12),
        Text('The docked Y-offset controls how far the FAB sinks into or rises above the BottomAppBar. A value of 0 means the FAB center aligns with the top edge of the bar.',
        ...
        SizedBox(height: 12),
        buildInfoCard('Mixin:', 'FabDockedOffsetY provides getDockedY() for vertical positioning'),
      ],
    ),
  );
}
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text('getDockedY(offset: $offset)',
...
Widget _buildOffsetComparison() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Y-Offset Values from -16 to +16',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 4),
        Text('Negative = FAB rises above bar, Positive = FAB sinks into bar',
            style: TextStyle(fontSize: 12, color: Color(0xFF795548))),
        SizedBox(height: 16),
        Column(children: items),
        SizedBox(height: 12),
        buildInfoCard('Range:', 'Typical docked Y offsets are -16 to +16 pixels'),
      ],
    ),
  );
}
  ...
  return Container(
    ...
    child: Row(
      children: [
        Container(
          width: 60,
          child: Text(offsetLabel, style: TextStyle(fontFamily: 'monospace', fontSize: 12, fontWeight: FontWeight.bold, color: color)),
        ),
        Expanded(
          child: Container(
            height: 16,
      ...
      children: [
        Expanded(
          child: Container(
            ...
            child: Column(
              children: [
                Text('Docked (Y-Offset)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF00695C))),
                SizedBox(height: 12),
                Container(
                    ...
                    children: [
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text('BottomAppBar', style: TextStyle(color: Color(0xFFFFFFFF), fontSize: 8))),
                        ),
                      ),
                      Positioned(
                ...
                SizedBox(height: 8),
                Text('FAB overlaps BottomAppBar', style: TextStyle(fontSize: 11, color: Color(0xFF616161))),
        ...
        Expanded(
          child: Container(
            ...
            child: Column(
              children: [
                Text('Floating (No Dock)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFFD84315))),
                SizedBox(height: 12),
                Container(
                  height: 120, width: double.infinity,
                  decoration: BoxDecoration(
                    ...
                    children: [
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text('BottomNav', style: TextStyle(color: Color(0xFFFFFFFF), fontSize: 8))),
                        ),
                      ),
                      Positioned(
...
Widget _buildNotchIntegration() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('BottomAppBar Notch and Docked FAB',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 16),
        Container(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                top: 28, left: 0, right: 0, bottom: 40,
                child: Center(child: Text('Body Content', style: TextStyle(color: Color(0xFF9E9E9E), fontSize: 11))),
              ),
              Positioned(
        ...
        SizedBox(height: 12),
        buildInfoCard('Notch:', 'BottomAppBar shape property creates space around the FAB'),
        buildInfoCard('Y-Offset:', 'Controls how deep the FAB sits in the notch area'),
        buildInfoCard('Shape:', 'CircularNotchedRectangle is the standard notch shape'),
      ],
    ),
  );
}
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('// FabDockedOffsetY.getDockedY() calculation:',
                  style: TextStyle(fontFamily: 'monospace', fontSize: 10, color: Color(0xFF78909C))),
              SizedBox(height: 6),
              Text('fabY = scaffoldHeight',
                  style: TextStyle(fontFamily: 'monospace', fontSize: 13, color: Color(0xFF80CBC4))),
              Text('     - bottomBarHeight',
                  style: TextStyle(fontFamily: 'monospace', fontSize: 13, color: Color(0xFF80CBC4))),
              Text('     - fabHeight / 2.0',
                  style: TextStyle(fontFamily: 'monospace', fontSize: 13, color: Color(0xFF80CBC4))),
              SizedBox(height: 8),
              Text('// Example: scaffold=800, bar=56, fab=56:',
                  style: TextStyle(fontFamily: 'monospace', fontSize: 10, color: Color(0xFF78909C))),
              Text('fabY = 800 - 56 - 56/2 = 716.0',
                  style: TextStyle(fontFamily: 'monospace', fontSize: 11, color: Color(0xFFFFCC80))),
            ],
          ),
        ),
        SizedBox(height: 16),
        _buildCalculationRow('scaffoldHeight', '800.0', 'Total scaffold height', Color(0xFF00695C)),
        SizedBox(height: 4),
        _buildCalculationRow('bottomBarHeight', '56.0', 'BottomAppBar height', Color(0xFF1565C0)),
        SizedBox(height: 4),
        _buildCalculationRow('fabHeight', '56.0', 'Standard FAB height', Color(0xFFD84315)),
        SizedBox(height: 4),
        _buildCalculationRow('fabY result', '716.0', 'FAB top-left Y position', Color(0xFF6A1B9A)),
        SizedBox(height: 8),
        buildInfoCard('Key:', 'The FAB center aligns with the top edge of BottomAppBar'),
      ],
    ),
  );
}
...
Widget _buildNegativeOffsetEffects() {
  ...
  for (; i < negativeOffsets.length; i = i + 1) {
    ...
    cards.add(_buildOffsetEffectCard(
      offset,
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Negative Offsets: FAB Rises Above Bar',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 4),
        Text('Negative Y-offset moves the FAB upward, away from the bar',
            style: TextStyle(fontSize: 12, color: Color(0xFF546E7A))),
        SizedBox(height: 16),
        Column(children: cards),
        SizedBox(height: 12),
        buildInfoCard('Use case:', 'Negative offsets make the FAB more prominent and easier to tap'),
      ],
    ),
  );
}

Widget _buildOffsetEffectCard(double offset, String summary, String detail, Color color) {
  String sign = '';
  if (offset > 0) {
    sign = '+';
  }
      ...
      children: [
        Container(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                bottom: fabBottom, left: 22, right: 22,
                child: Container(
                  width: 24, height: 24,
                  decoration: BoxDecoration(
                    color: color,
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('$sign${offset.toStringAsFixed(1)} px',
                  style: TextStyle(fontFamily: 'monospace', fontWeight: FontWeight.bold, fontSize: 14, color: color)),
              SizedBox(height: 2),
              Text(summary, style: TextStyle(fontSize: 12, color: Color(0xFF37474F))),
              Text(detail, style: TextStyle(fontSize: 10, color: Color(0xFF9E9E9E))),
            ],
          ),
        ),
      ],
...
Widget _buildPositiveOffsetEffects() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Positive Offsets: FAB Sinks Into Bar',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 4),
        Text('Positive Y-offset pushes the FAB downward into the bar area',
            style: TextStyle(fontSize: 12, color: Color(0xFF795548))),
        SizedBox(height: 16),
        Column(children: cards),
        SizedBox(height: 12),
        buildInfoCard('Use case:', 'Positive offsets create a more flush look with the bar'),
      ],
    ),
  );
}
...
Widget _buildFabSizesDockedY() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('FAB Size Impact on Docked Y Position',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 16),
        Row(
          children: [
            Expanded(child: _buildSizeDockedCard('Standard', 56.0, Color(0xFF00695C))),
            SizedBox(width: 12),
            Expanded(child: _buildSizeDockedCard('Mini', 40.0, Color(0xFF6A1B9A))),
            SizedBox(width: 12),
            Expanded(child: _buildSizeDockedCard('Large', 96.0, Color(0xFFD84315))),
          ],
        ),
        SizedBox(height: 16),
        buildInfoCard('Standard:', 'scaffoldH - barH - (56 / 2) = default docked Y'),
        buildInfoCard('Mini:', 'scaffoldH - barH - (40 / 2) = higher starting position'),
        buildInfoCard('Large:', 'scaffoldH - barH - (96 / 2) = lower starting position'),
      ],
    ),
  );
}
  ...
  return Container(
    ...
    child: Column(
      children: [
        ...
        Text('${size.toInt()}px', style: TextStyle(fontSize: 11, color: Color(0xFF757575))),
        Text('half: ${halfSize.toStringAsFixed(0)}px', style: TextStyle(fontFamily: 'monospace', fontSize: 10, color: Color(0xFF9E9E9E))),
      ],
    ),
  );
}
...
Widget _buildScaffoldLayoutGeometry() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('ScaffoldPrelayoutGeometry for Docked Y',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        SizedBox(height: 16),
        Container(
            ...
            children: [
              Positioned(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('scaffoldSize.height (top)', style: TextStyle(color: Color(0xFFFFFFFF), fontSize: 9))),
                ),
              ),
              Positioned(
                top: 30, left: 0, right: 0, bottom: 40,
                child: Container(
                  color: Color(0xFFF5F5F5),
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.straighten, color: Color(0xFF9E9E9E), size: 24),
                        Text('contentBottom', style: TextStyle(fontSize: 10, color: Color(0xFF757575))),
                      ],
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('bottomBarHeight', style: TextStyle(color: Color(0xFFFFFFFF), fontSize: 9))),
                ),
              ),
              Positioned(
                bottom: 20, left: 0, right: 0,
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Text('fabY', style: TextStyle(fontFamily: 'monospace', fontSize: 8, color: Color(0xFF37474F))),
                ),
              ),
            ],
          ),
        ...
        SizedBox(height: 12),
        buildInfoCard('scaffoldSize:', 'Full scaffold dimensions from geometry'),
        buildInfoCard('bottomBarHeight:', 'Height of BottomAppBar used in Y calculation'),
        buildInfoCard('fabSize:', 'FAB dimensions needed to compute docked center'),
      ],
    ),
  );
}
...
Widget _buildPropertiesAndApi() {
  ...
  List<Widget> rows = [];
  rows.add(_buildApiRow('getDockedY', 'double', 'Returns Y offset for docked FAB position', Color(0xFF00695C)));
  rows.add(_buildApiRow('scaffoldGeometry', 'ScaffoldPrelayoutGeometry', 'Input: scaffold layout data', Color(0xFF1565C0)));
  rows.add(_buildApiRow('adjustment', 'double', 'Additional Y offset adjustment value', Color(0xFFD84315)));
  rows.add(_buildApiRow('bottomBarHeight', 'double', 'Height of BottomAppBar', Color(0xFF6A1B9A)));
  rows.add(_buildApiRow('fabHeight', 'double', 'FAB height for centering calc', Color(0xFFC62828)));
  rows.add(_buildApiRow('scaffoldHeight', 'double', 'Total scaffold height dimension', Color(0xFF00897B)));
