...
void _expect(bool condition, String message, List<String> logs) {
  if (!condition) {
    ...
    throw StateError(
      'BottomNavigationBarThemeData assertion failed: ' + message,
    );
  }
...
dynamic build(BuildContext context) {
  ...
  assertionCount++;
  _expect(
    data.selectedItemColor == Colors.blue,
    'stores selectedItemColor',
    logs,
  );
  assertionCount++;
  _expect(
    data.unselectedItemColor == Colors.grey,
    'stores unselectedItemColor',
    logs,
  );
  assertionCount++;
