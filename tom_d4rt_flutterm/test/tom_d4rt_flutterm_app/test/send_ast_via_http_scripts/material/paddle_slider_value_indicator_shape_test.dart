// Comprehensive D4rt test script: PaddleSliderValueIndicatorShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PaddleSliderValueIndicatorShape script ===');
  ...
  final Type targetType = PaddleSliderValueIndicatorShape;
  ...
  detailLines.add('target=PaddleSliderValueIndicatorShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('PaddleSliderValueIndicatorShape'), 'Target type symbol resolves');
