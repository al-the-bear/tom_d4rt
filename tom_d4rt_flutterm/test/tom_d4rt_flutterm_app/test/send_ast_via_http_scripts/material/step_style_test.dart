// Comprehensive D4rt test script: StepStyle from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive StepStyle script ===');
  ...
  final Type targetType = StepStyle;
  ...
  detailLines.add('target=StepStyle');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('StepStyle'), 'Target type symbol resolves');
