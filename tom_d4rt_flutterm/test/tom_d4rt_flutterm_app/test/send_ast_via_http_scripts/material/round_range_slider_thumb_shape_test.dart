// Comprehensive D4rt test script: RoundRangeSliderThumbShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundRangeSliderThumbShape script ===');
  ...
  final Type targetType = RoundRangeSliderThumbShape;
  ...
  detailLines.add('target=RoundRangeSliderThumbShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundRangeSliderThumbShape'), 'Target type symbol resolves');
