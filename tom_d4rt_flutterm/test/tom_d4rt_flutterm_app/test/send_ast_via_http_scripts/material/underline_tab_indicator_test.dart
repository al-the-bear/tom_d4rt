// Comprehensive D4rt test script: UnderlineTabIndicator from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UnderlineTabIndicator script ===');
  ...
  final Type targetType = UnderlineTabIndicator;
  ...
  detailLines.add('target=UnderlineTabIndicator');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('UnderlineTabIndicator'), 'Target type symbol resolves');
