// Comprehensive D4rt test script: RoundSliderTickMarkShape from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RoundSliderTickMarkShape script ===');
  ...
  final Type targetType = RoundSliderTickMarkShape;
  ...
  detailLines.add('target=RoundSliderTickMarkShape');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('RoundSliderTickMarkShape'), 'Target type symbol resolves');
