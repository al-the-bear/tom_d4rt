// Comprehensive D4rt test script: TabPageSelectorIndicator from material
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TabPageSelectorIndicator script ===');
  ...
  final Type targetType = TabPageSelectorIndicator;
  ...
  detailLines.add('target=TabPageSelectorIndicator');
  detailLines.add('package=material');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('TabPageSelectorIndicator'), 'Target type symbol resolves');
