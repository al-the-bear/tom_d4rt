// D4rt test script: Comprehensive tests for BackButtonIcon
import 'package:flutter/material.dart';

void _expect(bool condition, String message, List<String> logs) {
  if (!condition) {
    logs.add('FAIL: ' + message);
    throw StateError('BackButtonIcon assertion failed: ' + message);
  }
  logs.add('PASS: ' + message);
}

dynamic build(BuildContext context) {
  print('=== BackButtonIcon comprehensive test start ===');
  final logs = <String>[];
  ...
  return Column(
    ...
    children: [
      const Text('BackButtonIcon Tests'),
