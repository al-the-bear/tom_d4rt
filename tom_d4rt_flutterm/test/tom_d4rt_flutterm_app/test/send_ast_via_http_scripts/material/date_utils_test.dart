...
dynamic build(BuildContext context) {
  ...
  final previousMonth = DateUtils.addMonthsToMonthDate(
    DateTime(2024, 6, 1),
    -1,
  );
  ...
  log(
    'Executed DateUtils static operations for date normalization && comparisons',
  );
  _expect(
  ...
  _expect(
    ...
    'addMonthsToMonthDate supports negative month delta',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    DateUtils.isSameMonth(DateTime(2024, 6, 1), DateTime(2024, 6, 30)),
    'isSameMonth works for same month',
    logs,
  );
  assertionCount++;
  _expect(
