...
Widget buildStateTransitionVisual(
  String fromState,
  String toState,
  Color fromColor,
  Color toColor,
...
Widget buildAnimationFrameStrip(
  String label,
  Color startColor,
  Color endColor,
  int frames,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            buildAnimPropertyCard(
              'enableAnimation',
              'Animation for enable/disable',
              'AnimationStyle',
              Colors.blue,
              Icons.toggle_on,
            ),
            ...
            buildAnimPropertyCard(
              ...
              'Animation for avatar showing/hiding',
              'AnimationStyle',
              Colors.orange,
              Icons.account_circle,
            ),
            buildAnimPropertyCard(
              'deleteIconDrawerAnimation',
              'Animation for delete icon',
              'AnimationStyle',
              Colors.red,
              Icons.delete,
            ),
            ...
            buildCurveVisual('linear', Colors.blue, [
              0.0,
              0.1,
              0.2,
              0.3,
            ...
            buildCurveVisual('easeIn', Colors.green, [
              0.0,
              0.01,
              0.04,
              0.09,
            ...
            buildCurveVisual('easeOut', Colors.orange, [
              0.0,
              0.19,
              0.36,
              0.51,
            ...
            buildCurveVisual('easeInOut', Colors.purple, [
              0.0,
              0.02,
              0.08,
              0.18,
            ...
            buildCurveVisual('bounce', Colors.red, [
              0.0,
              0.06,
              0.25,
              0.56,
            ...
            buildCurveVisual('elastic', Colors.teal, [
              0.0,
              0.0,
              0.0,
              0.1,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Setting duration to Duration.zero disables animation',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Animation Properties Demonstrated:',
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      Chip(
                        label: Text('duration', style: TextStyle(fontSize: 10)),
                        backgroundColor: Colors.purple.shade100,
                      ),
                      Chip(
                        label: Text('curve', style: TextStyle(fontSize: 10)),
