    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderProxyBoxWithHitTestBehavior: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderProxyBoxWithHitTestBehavior();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderProxyBoxWithHitTestBehavior();
  ...
  print('RenderProxyBoxWithHitTestBehavior test completed with ${checkpoints.length} checkpoints.');
