...
class _RenderSliverPinnedPersistentHeaderScript extends StatelessWidget {
  ...
  List<String> _runAssertions() {
    ...
    const String filenameTag =
        'render_sliver_pinned_persistent_header_test.dart';
    ...
    final String normalized = 'RenderSliverPinnedPersistentHeader'
        .toLowerCase();
    ...
    final bool containsSliver = 'RenderSliverPinnedPersistentHeader'.contains(
      'Sliver',
    );
...
dynamic build(BuildContext context) {
  print(
    'Executing comprehensive D4rt script for RenderSliverPinnedPersistentHeader',
  );
