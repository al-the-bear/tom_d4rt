...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    renderStackA
        ...
        >,
    'RenderStack uses ContainerRenderObjectMixin indirectly',
    logs,
    counters,
  );
  expectCondition(
    renderStackB.textDirection == TextDirection.rtl,
    'textDirection property is configurable',
    logs,
    counters,
  );
  expectCondition(
    renderStackA.childCount == 0,
    'new stack starts with zero children edge case',
    logs,
    counters,
  );
