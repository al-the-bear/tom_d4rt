    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSliverConstrainedCrossAxis: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSliverConstrainedCrossAxis();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSliverConstrainedCrossAxis();
  ...
  print('RenderSliverConstrainedCrossAxis test completed with ${checkpoints.length} checkpoints.');
