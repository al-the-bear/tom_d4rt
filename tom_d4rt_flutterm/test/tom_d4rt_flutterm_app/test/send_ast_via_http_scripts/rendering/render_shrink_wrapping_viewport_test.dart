    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderShrinkWrappingViewport: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderShrinkWrappingViewport();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderShrinkWrappingViewport();
  ...
  print('RenderShrinkWrappingViewport test completed with ${checkpoints.length} checkpoints.');
