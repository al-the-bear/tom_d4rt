...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    flexA is DebugOverflowIndicatorMixin,
    'RenderFlex uses DebugOverflowIndicatorMixin indirectly',
    logs,
    counters,
  );
  expectCondition(
    flexB.direction == Axis.vertical,
    'axis property supports vertical value',
    logs,
    counters,
  );
  expectCondition(
    flexA.toStringShort().contains('RenderFlex'),
    'toStringShort includes class name',
    logs,
    counters,
  );
