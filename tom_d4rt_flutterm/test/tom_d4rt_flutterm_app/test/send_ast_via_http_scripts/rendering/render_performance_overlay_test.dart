// D4rt test script: Comprehensive checks for RenderPerformanceOverlay from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderPerformanceOverlay D4rt script start ===");
  ...
  final String targetClassName = "RenderPerformanceOverlay";
  final Widget indirectWidget = const PerformanceOverlay.allEnabled();
  ...
  logStep("Focus area: performance graph toggles");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces performance graph toggles",
  ];
  ...
  logStep("=== RenderPerformanceOverlay D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderPerformanceOverlay summary"),
      ...
      Text("Focus area: performance graph toggles"),
