// D4rt test script: Comprehensive checks for RenderIgnorePointer from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderIgnorePointer D4rt script start ===");
  ...
  final String targetClassName = "RenderIgnorePointer";
  final Widget indirectWidget = const IgnorePointer(ignoring: true, child: SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: pointer event pass-through behavior");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces pointer event pass-through behavior",
  ];
  ...
  logStep("=== RenderIgnorePointer D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderIgnorePointer summary"),
      ...
      Text("Focus area: pointer event pass-through behavior"),
