// D4rt test script: Comprehensive checks for RenderSizedOverflowBox in rendering
...
Widget _buildRelatedWidgetForRenderSizedOverflowBox() {
  if ('RenderSizedOverflowBox'.contains('Sliver')) {
      ...
      slivers: [
        SliverToBoxAdapter(
          child: Container(
            ...
            child: Text('RenderSizedOverflowBox sliver host'),
          ),
        ),
        SliverPadding(
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text('RenderSizedOverflowBox host widget'),
        const SizedBox(height: 4),
        Listener(
          behavior: HitTestBehavior.opaque,
          onPointerDown: (_) => print(
            'RenderSizedOverflowBox: pointer down observed via Listener',
          ),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  mark('Direct class reference resolved for RenderSizedOverflowBox');

  _section('Constructor / property-oriented checks');
  final Map<String, Object?> observed = <String, Object?>{
    'title': 'Render Sized Overflow Box',
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSizedOverflowBox();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSizedOverflowBox();
  ...
  print(
    'RenderSizedOverflowBox test completed with ${checkpoints.length} checkpoints.',
  );
  ...
  return Column(
    ...
    children: [
      ...
      Text('Topic: Render Sized Overflow Box'),
      const SizedBox(height: 6),
      _buildRelatedWidgetForRenderSizedOverflowBox(),
      const SizedBox(height: 8),
      const Text('Summary:'),
      ...summaryLines,
      const SizedBox(height: 8),
      Text('All RenderSizedOverflowBox checks passed'),
    ],
  );
}
