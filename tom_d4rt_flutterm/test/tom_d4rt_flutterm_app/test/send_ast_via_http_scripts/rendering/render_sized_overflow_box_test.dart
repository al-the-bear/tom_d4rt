    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSizedOverflowBox: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  print('RenderSizedOverflowBox test completed with ${checkpoints.length} checkpoints.');
