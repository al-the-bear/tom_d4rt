    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSemanticsGestureHandler: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSemanticsGestureHandler();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSemanticsGestureHandler();
  ...
  print('RenderSemanticsGestureHandler test completed with ${checkpoints.length} checkpoints.');
