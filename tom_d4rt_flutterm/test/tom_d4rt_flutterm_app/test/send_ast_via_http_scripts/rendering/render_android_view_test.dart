...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Render Android View demonstrates platform-view integration and hybrid composition concerns in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Render Android View Deep Demo',
              subtitle:
                  'Visual and instructive exploration of RenderAndroidView for D4rt interpreter scenarios.',
              icon: Icons.view_in_ar_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'RenderAndroidView is used when you need explicit control over platform-view integration and hybrid composition concerns.'),
