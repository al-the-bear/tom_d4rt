// D4rt test script: Comprehensive checks for RenderPhysicalModel from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderPhysicalModel D4rt script start ===");
  ...
  final String targetClassName = "RenderPhysicalModel";
  final Widget indirectWidget = const PhysicalModel(color: Color(0xFF336699), child: SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: physical model clipping and elevation");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces physical model clipping and elevation",
  ];
  ...
  logStep("=== RenderPhysicalModel D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderPhysicalModel summary"),
      ...
      Text("Focus area: physical model clipping and elevation"),
