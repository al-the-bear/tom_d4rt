// D4rt test script: Comprehensive checks for RenderPhysicalShape from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderPhysicalShape D4rt script start ===");
  ...
  final String targetClassName = "RenderPhysicalShape";
  final Widget indirectWidget = PhysicalShape(clipper: ShapeBorderClipper(shape: const StadiumBorder()), color: const Color(0xFF336699), child: const SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: custom physical clipping shape");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces custom physical clipping shape",
  ];
  ...
  logStep("=== RenderPhysicalShape D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderPhysicalShape summary"),
      ...
      Text("Focus area: custom physical clipping shape"),
