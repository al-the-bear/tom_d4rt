// D4rt test script: Comprehensive checks for RenderIndexedStack from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderIndexedStack D4rt script start ===");
  ...
  final String targetClassName = "RenderIndexedStack";
  final Widget indirectWidget = const IndexedStack(index: 0, children: <Widget>[SizedBox(width: 10, height: 10), SizedBox(width: 12, height: 12)]);
  ...
  logStep("Focus area: index-driven child presentation");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces index-driven child presentation",
  ];
  ...
  logStep("=== RenderIndexedStack D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderIndexedStack summary"),
      ...
      Text("Focus area: index-driven child presentation"),
