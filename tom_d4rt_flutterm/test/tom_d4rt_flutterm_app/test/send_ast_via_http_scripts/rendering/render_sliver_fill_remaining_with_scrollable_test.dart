    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSliverFillRemainingWithScrollable: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  mark('Direct class reference resolved for RenderSliverFillRemainingWithScrollable');
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSliverFillRemainingWithScrollable();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSliverFillRemainingWithScrollable();
  ...
  print('RenderSliverFillRemainingWithScrollable test completed with ${checkpoints.length} checkpoints.');
