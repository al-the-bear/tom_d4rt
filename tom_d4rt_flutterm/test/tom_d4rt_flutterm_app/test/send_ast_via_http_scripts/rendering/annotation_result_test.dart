...
dynamic build(BuildContext context) {
  ...
  final strLayer2 = AnnotatedRegionLayer<String>('second', size: Size(100, 100));
  
  container.append(strLayer1);
  container.append(strLayer2);
  
  // Find all string annotations at a point
  strLayer1.findAnnotations<String>(multiResult, Offset(50, 50), onlyFirst: false);
  strLayer2.findAnnotations<String>(multiResult, Offset(50, 50), onlyFirst: false);
  ...
  doubleLayer.findAnnotations<double>(doubleResult, Offset(25, 25), onlyFirst: false);
  ...
  final stopLayer = AnnotatedRegionLayer<String>('stop-here', size: Size(100, 100));
  ...
  results.add('OnlyFirst result: $shouldStop, entries: ${onlyFirstResult.entries.length}');
