...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Render Block Semantics demonstrates accessibility semantics and assistive rendering behavior in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Render Block Semantics Deep Demo',
              subtitle:
                  'Visual and instructive exploration of RenderBlockSemantics for D4rt interpreter scenarios.',
              icon: Icons.category_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'RenderBlockSemantics is used when you need explicit control over accessibility semantics and assistive rendering behavior.'),
