// D4rt test script: Comprehensive checks for RenderMouseRegion from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderMouseRegion D4rt script start ===");
  ...
  final String targetClassName = "RenderMouseRegion";
  final Widget indirectWidget = MouseRegion(onEnter: (_) {}, child: const SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: hover and mouse annotations");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces hover and mouse annotations",
  ];
  ...
  logStep("=== RenderMouseRegion D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderMouseRegion summary"),
      ...
      Text("Focus area: hover and mouse annotations"),
