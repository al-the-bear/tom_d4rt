// D4rt test script: Comprehensive checks for RenderErrorBox from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderErrorBox D4rt script start ===");
  ...
  final String targetClassName = "RenderErrorBox";
  final Widget indirectWidget = ErrorWidget("render error sample");
  ...
  logStep("Focus area: error fallback rendering");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces error fallback rendering",
  ];
  ...
  logStep("=== RenderErrorBox D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderErrorBox summary"),
      ...
      Text("Focus area: error fallback rendering"),
