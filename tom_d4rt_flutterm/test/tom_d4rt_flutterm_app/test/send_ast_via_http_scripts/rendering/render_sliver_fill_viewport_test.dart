    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSliverFillViewport: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSliverFillViewport();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSliverFillViewport();
  ...
  print('RenderSliverFillViewport test completed with ${checkpoints.length} checkpoints.');
