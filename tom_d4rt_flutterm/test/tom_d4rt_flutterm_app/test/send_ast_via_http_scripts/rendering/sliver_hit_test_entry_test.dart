...
dynamic build(BuildContext context) {
  ...
  for (final pos in positions) {
    ...
    print('Entry at (${pos.main}, ${pos.cross}): main=${testEntry.mainAxisPosition}, cross=${testEntry.crossAxisPosition}');
  }
  ...
  for (var i = 0; i < slivers.length; i++) {
    entries.add(SliverHitTestEntry(
      slivers[i],
  ...
  for (var i = 0; i < entries.length; i++) {
    print('  Entry $i: main=${entries[i].mainAxisPosition}, cross=${entries[i].crossAxisPosition}');
  }
