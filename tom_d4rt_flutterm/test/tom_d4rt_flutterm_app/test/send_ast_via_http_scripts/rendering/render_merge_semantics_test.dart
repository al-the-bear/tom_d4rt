// D4rt test script: Comprehensive checks for RenderMergeSemantics from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderMergeSemantics D4rt script start ===");
  ...
  final String targetClassName = "RenderMergeSemantics";
  final Widget indirectWidget = const MergeSemantics(child: SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: semantic subtree merging");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces semantic subtree merging",
  ];
  ...
  logStep("=== RenderMergeSemantics D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderMergeSemantics summary"),
      ...
      Text("Focus area: semantic subtree merging"),
