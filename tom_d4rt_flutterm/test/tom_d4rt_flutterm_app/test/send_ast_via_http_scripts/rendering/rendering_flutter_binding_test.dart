...
dynamic build(BuildContext context) {
  ...
  final Widget indirectWidget = const Directionality(
    textDirection: TextDirection.ltr,
    child: SizedBox(width: 16, height: 10),
  );
  ...
  final RenderingFlutterBinding binding =
      RenderingFlutterBinding.ensureInitialized();
  _expectCondition(
    binding is RenderingFlutterBinding,
    "binding initialization returns RenderingFlutterBinding",
  );
