// D4rt test script: Comprehensive checks for RenderListWheelViewport from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderListWheelViewport D4rt script start ===");
  ...
  final String targetClassName = "RenderListWheelViewport";
  final Widget indirectWidget = ListWheelScrollView(itemExtent: 24, children: const <Widget>[Text("A"), Text("B"), Text("C")]);
  ...
  logStep("Focus area: wheel viewport layout behavior");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces wheel viewport layout behavior",
  ];
  ...
  logStep("=== RenderListWheelViewport D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderListWheelViewport summary"),
      ...
      Text("Focus area: wheel viewport layout behavior"),
