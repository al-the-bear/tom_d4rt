...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Picture Layer demonstrates rendering layers and paint/compositing boundaries in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Picture Layer Deep Demo',
              subtitle:
                  'Visual and instructive exploration of PictureLayer for D4rt interpreter scenarios.',
              icon: Icons.settings_input_component_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'PictureLayer is used when you need explicit control over rendering layers and paint/compositing boundaries.'),
