// D4rt test script: comprehensive checks for RenderTreeSliver
...
class _RenderTreeSliverScript extends StatelessWidget {
  ...
  List<String> _runAssertions() {
    ...
    final String normalized = 'RenderTreeSliver'.toLowerCase();
    ...
    final bool containsSliver = 'RenderTreeSliver'.contains('Sliver');
    logs.add('contains-sliver=' + containsSliver.toString());

    for (final String log in logs) {
      print('[RenderTreeSliver] ' + log);
    }
...
dynamic build(BuildContext context) {
  print('Executing comprehensive D4rt script for RenderTreeSliver');
  return const _RenderTreeSliverScript();
}
