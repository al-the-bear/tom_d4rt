// D4rt test script: Comprehensive checks for RenderIndexedSemantics from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderIndexedSemantics D4rt script start ===");
  ...
  final String targetClassName = "RenderIndexedSemantics";
  final Widget indirectWidget = const IndexedSemantics(index: 1, child: SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: indexed semantics metadata");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces indexed semantics metadata",
  ];
  ...
  logStep("=== RenderIndexedSemantics D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderIndexedSemantics summary"),
      ...
      Text("Focus area: indexed semantics metadata"),
