// D4rt test script: Comprehensive checks for RenderFractionallySizedOverflowBox from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderFractionallySizedOverflowBox D4rt script start ===");
  ...
  final String targetClassName = "RenderFractionallySizedOverflowBox";
  final Widget indirectWidget = const FractionallySizedBox(widthFactor: 1.1, heightFactor: 0.7, child: SizedBox(width: 20, height: 12));
  ...
  logStep("Focus area: fractional sizing overflow rules");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces fractional sizing overflow rules",
  ];
  ...
  logStep("=== RenderFractionallySizedOverflowBox D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderFractionallySizedOverflowBox summary"),
      ...
      Text("Focus area: fractional sizing overflow rules"),
