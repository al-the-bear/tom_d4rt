...
dynamic build(BuildContext context) {
  ...
  data.offset = Offset(12.0, 30.0);
  log('offset after: ${data.offset}');
  assert(data.offset == Offset(12.0, 30.0));

  log('--- edge case values ---');
  data.offset = Offset(-4.0, 9999.0);
  ...
  final mirrors = <FlowParentData>[
    FlowParentData()..offset = Offset.zero,
    FlowParentData()..offset = Offset(1.0, 1.0),
    FlowParentData()..offset = Offset(2.0, 3.0),
  ];
