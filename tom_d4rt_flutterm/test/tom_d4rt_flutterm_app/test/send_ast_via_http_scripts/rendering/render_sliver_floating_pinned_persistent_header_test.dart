...
class _RenderSliverFloatingPinnedPersistentHeaderScript
  ...
  List<String> _runAssertions() {
    ...
    const String filenameTag =
        'render_sliver_floating_pinned_persistent_header_test.dart';
    ...
    assert(
      contextMap['target'] == 'RenderSliverFloatingPinnedPersistentHeader',
    );
    ...
    final String normalized = 'RenderSliverFloatingPinnedPersistentHeader'
        .toLowerCase();
    ...
    final bool containsSliver = 'RenderSliverFloatingPinnedPersistentHeader'
        .contains('Sliver');
...
dynamic build(BuildContext context) {
  print(
    'Executing comprehensive D4rt script for RenderSliverFloatingPinnedPersistentHeader',
  );
