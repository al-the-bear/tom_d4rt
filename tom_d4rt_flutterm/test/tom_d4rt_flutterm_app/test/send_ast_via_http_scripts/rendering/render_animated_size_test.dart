...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Render Animated Size demonstrates Flutter runtime behavior and visual composition patterns in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Render Animated Size Deep Demo',
              subtitle:
                  'Visual and instructive exploration of RenderAnimatedSize for D4rt interpreter scenarios.',
              icon: Icons.account_tree_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'RenderAnimatedSize is used when you need explicit control over Flutter runtime behavior and visual composition patterns.'),
