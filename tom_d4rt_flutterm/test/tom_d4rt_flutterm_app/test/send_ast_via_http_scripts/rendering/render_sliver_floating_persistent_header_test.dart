...
class _RenderSliverFloatingPersistentHeaderScript extends StatelessWidget {
  ...
  List<String> _runAssertions() {
    ...
    const String filenameTag =
        'render_sliver_floating_persistent_header_test.dart';
    ...
    final String normalized = 'RenderSliverFloatingPersistentHeader'
        .toLowerCase();
    ...
    final bool containsSliver = 'RenderSliverFloatingPersistentHeader'.contains(
      'Sliver',
    );
...
dynamic build(BuildContext context) {
  print(
    'Executing comprehensive D4rt script for RenderSliverFloatingPersistentHeader',
  );
