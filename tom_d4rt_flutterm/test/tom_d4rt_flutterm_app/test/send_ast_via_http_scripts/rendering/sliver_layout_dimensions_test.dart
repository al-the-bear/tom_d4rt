...
dynamic build(BuildContext context) {
  ...
  print('Zero dimensions precedingScrollExtent: ${zeroDimensions.precedingScrollExtent}');
  print('Zero dimensions viewportMainAxisExtent: ${zeroDimensions.viewportMainAxisExtent}');
  ...
  print('Large precedingScrollExtent: ${largeDimensions.precedingScrollExtent}');
  print('Large viewportMainAxisExtent: ${largeDimensions.viewportMainAxisExtent}');
  ...
  for (final extent in precedingExtents) {
    ...
    print('Dimensions with precedingScrollExtent $extent: ${dims.precedingScrollExtent}');
  }
  ...
  for (final extent in viewportExtents) {
    ...
    print('Dimensions with viewportMainAxisExtent $extent: ${dims.viewportMainAxisExtent}');
  }
  ...
  print('dims1.hashCode == dims2.hashCode: ${dims1.hashCode == dims2.hashCode}');
