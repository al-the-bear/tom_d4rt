// D4rt test script: Comprehensive checks for RenderLeaderLayer from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderLeaderLayer D4rt script start ===");
  ...
  final String targetClassName = "RenderLeaderLayer";
  final Widget indirectWidget = CompositedTransformTarget(link: LayerLink(), child: const SizedBox(width: 16, height: 10));
  ...
  logStep("Focus area: leader layer registration");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces leader layer registration",
  ];
  ...
  logStep("=== RenderLeaderLayer D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderLeaderLayer summary"),
      ...
      Text("Focus area: leader layer registration"),
