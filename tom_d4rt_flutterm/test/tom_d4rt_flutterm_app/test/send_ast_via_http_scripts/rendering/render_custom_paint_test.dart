// D4rt test script: Comprehensive checks for RenderCustomPaint from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderCustomPaint D4rt script start ===");
  ...
  final String targetClassName = "RenderCustomPaint";
  final Widget indirectWidget = const CustomPaint(size: Size(40, 22));
  ...
  logStep("Focus area: custom painter orchestration");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces custom painter orchestration",
  ];
  ...
  logStep("=== RenderCustomPaint D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderCustomPaint summary"),
      ...
      Text("Focus area: custom painter orchestration"),
