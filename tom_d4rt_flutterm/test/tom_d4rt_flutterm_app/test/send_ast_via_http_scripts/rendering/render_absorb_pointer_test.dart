...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Render Absorb Pointer demonstrates hit testing, event dispatch, and pointer interaction in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Render Absorb Pointer Deep Demo',
              subtitle:
                  'Visual and instructive exploration of RenderAbsorbPointer for D4rt interpreter scenarios.',
              icon: Icons.settings_input_component_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'RenderAbsorbPointer is used when you need explicit control over hit testing, event dispatch, and pointer interaction.'),
