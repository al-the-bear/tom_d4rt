// D4rt test script: Comprehensive checks for RenderMetaData from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderMetaData D4rt script start ===");
  ...
  final String targetClassName = "RenderMetaData";
  final Widget indirectWidget = const MetaData(metaData: "sample", behavior: HitTestBehavior.deferToChild, child: SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: metadata propagation to hit testing");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces metadata propagation to hit testing",
  ];
  ...
  logStep("=== RenderMetaData D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderMetaData summary"),
      ...
      Text("Focus area: metadata propagation to hit testing"),
