// D4rt test script: comprehensive checks for RenderUiKitView
...
class _RenderUiKitViewScript extends StatelessWidget {
  ...
  List<String> _runAssertions() {
    ...
    final String normalized = 'RenderUiKitView'.toLowerCase();
    ...
    final bool containsSliver = 'RenderUiKitView'.contains('Sliver');
    logs.add('contains-sliver=' + containsSliver.toString());

    for (final String log in logs) {
      print('[RenderUiKitView] ' + log);
    }
...
dynamic build(BuildContext context) {
  print('Executing comprehensive D4rt script for RenderUiKitView');
  return const _RenderUiKitViewScript();
}
