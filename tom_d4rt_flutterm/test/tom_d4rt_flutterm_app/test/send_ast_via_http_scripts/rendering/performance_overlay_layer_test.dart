...
Widget _buildOverviewSection() {
  return Container(
    ...
    child: Column(
      ...
      children: [
        _buildSectionHeader(
          'PerformanceOverlayLayer Overview',
          Icons.info_outline,
          _primaryColor,
        ),
        Text(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildPropertyRow(
                'Layer',
                'Base class for all compositing layers',
                _primaryColor,
              ),
              _buildPropertyRow(
                'ContainerLayer',
                'Layer that can contain child layers',
                _primaryColor,
              ),
              _buildPropertyRow(
                'PerformanceOverlayLayer',
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildBenefitRow(
                'Reduced GPU work',
                'Cached images skip re-rasterization',
              ),
              _buildBenefitRow(
                'Faster compositing',
                'Pre-rendered textures composite quickly',
              ),
              _buildBenefitRow(
                'Memory tradeoff',
                'Uses GPU memory to store cached images',
              ),
            ],
          ),
        ),
  ...
  return Opacity(
    ...
    child: GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Container(color: isEven ? _purpleColor : Colors.transparent);
      },
    ),
  );
}
      ...
      children: [
        ...
        Row(
          children: [
            ...
            SizedBox(width: 10),
            Expanded(
              child: _buildColorIndicator('Red', 'Over budget', _errorColor),
            ),
          ],
        ),
        SizedBox(height: 20),
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildReadingGuideRow(
                'Horizontal Line',
                'Target frame budget (16.67ms)',
              ),
              _buildReadingGuideRow(
                'Bars Above Line',
                'Frames that missed budget',
              ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(meaning, style: TextStyle(fontSize: 9, color: _textMedium)),
            ],
          ),
        ),
      ],
...
Widget _buildWidgetDemosSection() {
  return Container(
    ...
    child: Column(
      ...
      children: [
        _buildSectionHeader(
          'PerformanceOverlay Widget Demos',
          Icons.widgets,
          _successColor,
        ),
        Text(
