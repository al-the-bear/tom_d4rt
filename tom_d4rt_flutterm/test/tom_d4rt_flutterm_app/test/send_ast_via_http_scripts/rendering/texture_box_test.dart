...
dynamic build(BuildContext context) {
  ...
  final mediumQuality = TextureBox(textureId: 1, filterQuality: FilterQuality.medium);
  print('Medium filterQuality: ${mediumQuality.filterQuality}');
  
  // High filter quality
  final highQuality = TextureBox(textureId: 1, filterQuality: FilterQuality.high);
  print('High filterQuality: ${highQuality.filterQuality}');
  
  // None filter quality
  final noneQuality = TextureBox(textureId: 1, filterQuality: FilterQuality.none);
  ...
  for (int i = 0; i < 5; i++) {
    ...
    instances.add(tb);
    print('Instance $i - textureId: ${tb.textureId}, filterQuality: ${tb.filterQuality}, freeze: ${tb.freeze}');
  }
