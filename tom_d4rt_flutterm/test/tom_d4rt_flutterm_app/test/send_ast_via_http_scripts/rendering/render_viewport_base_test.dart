// D4rt test script: comprehensive checks for RenderViewportBase
...
class _RenderViewportBaseScript extends StatelessWidget {
  ...
  List<String> _runAssertions() {
    ...
    final String normalized = 'RenderViewportBase'.toLowerCase();
    ...
    final bool containsSliver = 'RenderViewportBase'.contains('Sliver');
    logs.add('contains-sliver=' + containsSliver.toString());

    for (final String log in logs) {
      print('[RenderViewportBase] ' + log);
    }
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> rows = <Widget>[
      ...
      Text('Target: RenderViewportBase'),
...
dynamic build(BuildContext context) {
  print('Executing comprehensive D4rt script for RenderViewportBase');
  return const _RenderViewportBaseScript();
}
