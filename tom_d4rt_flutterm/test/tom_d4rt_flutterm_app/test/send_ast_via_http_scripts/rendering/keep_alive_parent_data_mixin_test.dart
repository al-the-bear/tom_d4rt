...
class _KeepAliveParentDataProbe extends ParentData
...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    dataA is KeepAliveParentDataMixin,
    'dataA uses KeepAliveParentDataMixin',
    logs,
    counters,
  );
  expectCondition(
    dataA.keepAlive == true,
    'keepAlive true assignment preserved',
    logs,
    counters,
  );
  expectCondition(
    dataB.keepAlive == false,
    'keepAlive false edge case preserved',
    logs,
    counters,
  );
