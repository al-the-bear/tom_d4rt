// D4rt test script: Comprehensive checks for RenderProxySliver in rendering
...
Widget _buildRelatedWidgetForRenderProxySliver() {
  if ('RenderProxySliver'.contains('Sliver')) {
      ...
      slivers: [
        SliverToBoxAdapter(
          child: Container(
            ...
            child: Text('RenderProxySliver sliver host'),
          ),
        ),
        SliverPadding(
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text('RenderProxySliver host widget'),
        const SizedBox(height: 4),
        Listener(
          behavior: HitTestBehavior.opaque,
          onPointerDown: (_) =>
              print('RenderProxySliver: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderProxySliver();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderProxySliver();
  ...
  print(
    'RenderProxySliver test completed with ${checkpoints.length} checkpoints.',
  );
  ...
  return Column(
    ...
    children: [
      ...
      Text('Topic: Render Proxy Sliver'),
      const SizedBox(height: 6),
      _buildRelatedWidgetForRenderProxySliver(),
      const SizedBox(height: 8),
      const Text('Summary:'),
      ...summaryLines,
      const SizedBox(height: 8),
      Text('All RenderProxySliver checks passed'),
    ],
  );
}
