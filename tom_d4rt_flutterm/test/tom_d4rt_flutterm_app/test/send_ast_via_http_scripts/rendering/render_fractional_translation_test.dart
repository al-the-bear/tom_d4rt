// D4rt test script: Comprehensive checks for RenderFractionalTranslation from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderFractionalTranslation D4rt script start ===");
  ...
  final String targetClassName = "RenderFractionalTranslation";
  final Widget indirectWidget = const FractionalTranslation(translation: Offset(0.2, 0.3), child: SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: fractional translation offsets");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces fractional translation offsets",
  ];
  ...
  logStep("=== RenderFractionalTranslation D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderFractionalTranslation summary"),
      ...
      Text("Focus area: fractional translation offsets"),
