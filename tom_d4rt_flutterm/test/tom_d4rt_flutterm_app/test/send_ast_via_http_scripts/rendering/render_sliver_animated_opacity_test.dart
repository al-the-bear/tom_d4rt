    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSliverAnimatedOpacity: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSliverAnimatedOpacity();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSliverAnimatedOpacity();
  ...
  print('RenderSliverAnimatedOpacity test completed with ${checkpoints.length} checkpoints.');
