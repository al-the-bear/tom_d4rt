    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSliverCrossAxisGroup: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSliverCrossAxisGroup();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSliverCrossAxisGroup();
  ...
  print('RenderSliverCrossAxisGroup test completed with ${checkpoints.length} checkpoints.');
