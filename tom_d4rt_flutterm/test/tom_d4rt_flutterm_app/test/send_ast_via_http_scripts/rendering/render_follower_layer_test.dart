// D4rt test script: Comprehensive checks for RenderFollowerLayer from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderFollowerLayer D4rt script start ===");
  ...
  final String targetClassName = "RenderFollowerLayer";
  final Widget indirectWidget = CompositedTransformFollower(link: LayerLink(), child: const SizedBox(width: 16, height: 10));
  ...
  logStep("Focus area: leader/follower layer linking");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces leader/follower layer linking",
  ];
  ...
  logStep("=== RenderFollowerLayer D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderFollowerLayer summary"),
      ...
      Text("Focus area: leader/follower layer linking"),
