    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSemanticsAnnotations: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSemanticsAnnotations();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSemanticsAnnotations();
  ...
  print('RenderSemanticsAnnotations test completed with ${checkpoints.length} checkpoints.');
