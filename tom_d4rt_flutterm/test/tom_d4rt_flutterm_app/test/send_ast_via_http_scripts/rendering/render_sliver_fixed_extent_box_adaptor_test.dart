    ...
    child: Column(
      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print('RenderSliverFixedExtentBoxAdaptor: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderSliverFixedExtentBoxAdaptor();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderSliverFixedExtentBoxAdaptor();
  ...
  print('RenderSliverFixedExtentBoxAdaptor test completed with ${checkpoints.length} checkpoints.');
