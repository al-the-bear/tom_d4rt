...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Relayout When System Fonts Change Mixin demonstrates constraint negotiation, sizing rules, and layout composition in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Relayout When System Fonts Change Mixin Deep Demo',
              subtitle:
                  'Visual and instructive exploration of RelayoutWhenSystemFontsChangeMixin for D4rt interpreter scenarios.',
              icon: Icons.account_tree_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'RelayoutWhenSystemFontsChangeMixin is used when you need explicit control over constraint negotiation, sizing rules, and layout composition.'),
