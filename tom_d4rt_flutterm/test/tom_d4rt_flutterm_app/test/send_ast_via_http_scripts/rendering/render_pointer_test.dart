// Comprehensive D4rt test script: RenderPointer from rendering
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RenderPointer script ===');
  ...
  detailLines.add('target=RenderPointer');
  ...
  const String targetTypeName = 'RenderPointer';
  detailLines.add('category=rendering_pointer');
  detailLines.add('desc=Render object pointer/hit test handling');
  // Test hit test concepts via RenderBox
  final RenderDecoratedBox box = RenderDecoratedBox(decoration: const BoxDecoration(color: Color(0xFFEF5350)));
  check(box is RenderBox, 'Is RenderBox');
  check(box is RenderObject, 'Is RenderObject');
  detailLines.add('isHitTestTarget=true');
