...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Placeholder Span Index Semantics Tag demonstrates accessibility semantics and assistive rendering behavior in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Placeholder Span Index Semantics Tag Deep Demo',
              subtitle:
                  'Visual and instructive exploration of PlaceholderSpanIndexSemanticsTag for D4rt interpreter scenarios.',
              icon: Icons.account_tree_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'PlaceholderSpanIndexSemanticsTag is used when you need explicit control over accessibility semantics and assistive rendering behavior.'),
