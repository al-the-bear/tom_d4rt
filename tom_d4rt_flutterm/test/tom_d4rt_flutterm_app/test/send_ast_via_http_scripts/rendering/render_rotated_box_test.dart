// D4rt test script: Comprehensive checks for RenderRotatedBox in rendering
...
Widget _buildRelatedWidgetForRenderRotatedBox() {
  if ('RenderRotatedBox'.contains('Sliver')) {
      ...
      slivers: [
        SliverToBoxAdapter(
          child: Container(
            ...
            child: Text('RenderRotatedBox sliver host'),
          ),
        ),
        SliverPadding(
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Text('RenderRotatedBox host widget'),
        const SizedBox(height: 4),
        Listener(
          behavior: HitTestBehavior.opaque,
          onPointerDown: (_) =>
              print('RenderRotatedBox: pointer down observed via Listener'),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  final Widget relatedWidgetA = _buildRelatedWidgetForRenderRotatedBox();
  final Widget relatedWidgetB = _buildRelatedWidgetForRenderRotatedBox();
  ...
  print(
    'RenderRotatedBox test completed with ${checkpoints.length} checkpoints.',
  );
  ...
  return Column(
    ...
    children: [
      ...
      Text('Topic: Render Rotated Box'),
      const SizedBox(height: 6),
      _buildRelatedWidgetForRenderRotatedBox(),
      const SizedBox(height: 8),
      const Text('Summary:'),
      ...summaryLines,
      const SizedBox(height: 8),
      Text('All RenderRotatedBox checks passed'),
    ],
  );
}
