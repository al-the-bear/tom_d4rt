// D4rt test script: Comprehensive checks for RenderOffstage from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderOffstage D4rt script start ===");
  ...
  final String targetClassName = "RenderOffstage";
  final Widget indirectWidget = const Offstage(offstage: true, child: SizedBox(width: 18, height: 12));
  ...
  logStep("Focus area: offstage participation and layout");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces offstage participation and layout",
  ];
  ...
  logStep("=== RenderOffstage D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderOffstage summary"),
      ...
      Text("Focus area: offstage participation and layout"),
