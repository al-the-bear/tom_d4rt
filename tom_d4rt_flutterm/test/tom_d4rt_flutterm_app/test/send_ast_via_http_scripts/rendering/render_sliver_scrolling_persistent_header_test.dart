...
class _RenderSliverScrollingPersistentHeaderScript extends StatelessWidget {
  ...
  List<String> _runAssertions() {
    ...
    const String filenameTag =
        'render_sliver_scrolling_persistent_header_test.dart';
    ...
    final String normalized = 'RenderSliverScrollingPersistentHeader'
        .toLowerCase();
    ...
    final bool containsSliver = 'RenderSliverScrollingPersistentHeader'
        .contains('Sliver');
...
dynamic build(BuildContext context) {
  print(
    'Executing comprehensive D4rt script for RenderSliverScrollingPersistentHeader',
  );
