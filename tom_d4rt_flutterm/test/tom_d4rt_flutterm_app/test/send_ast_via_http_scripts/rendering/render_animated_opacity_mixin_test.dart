...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Render Animated Opacity Mixin demonstrates animation lifecycle and visual interpolation behavior in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Render Animated Opacity Mixin Deep Demo',
              subtitle:
                  'Visual and instructive exploration of RenderAnimatedOpacityMixin for D4rt interpreter scenarios.',
              icon: Icons.auto_awesome_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'RenderAnimatedOpacityMixin is used when you need explicit control over animation lifecycle and visual interpolation behavior.'),
