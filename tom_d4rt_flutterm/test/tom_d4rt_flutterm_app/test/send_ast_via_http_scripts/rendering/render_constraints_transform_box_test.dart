// D4rt test script: Comprehensive checks for RenderConstraintsTransformBox from rendering
...
dynamic build(BuildContext context) {
  print("=== RenderConstraintsTransformBox D4rt script start ===");
  ...
  logStep("Focus area: constraint transformation behavior");
  ...
  final List<String> behaviorChecks = <String>[
    ...
    "Behavior path traces constraint transformation behavior",
  ];
  ...
  logStep("=== RenderConstraintsTransformBox D4rt script complete ===");

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    mainAxisSize: MainAxisSize.min,
    children: <Widget>[
      Text("RenderConstraintsTransformBox summary"),
      ...
      Text("Focus area: constraint transformation behavior"),
