...
final List<_DemoPanelData> _kPanels = <_DemoPanelData>[
  _DemoPanelData(
    title: 'Purpose',
    text:
        'Platform View Hit Behavior demonstrates hit testing, event dispatch, and pointer interaction in the D4rt interpreter runtime. This deep demo focuses on visual understanding rather than API-level assertions.',
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildHeader(
              title: 'Platform View Hit Behavior Deep Demo',
              subtitle:
                  'Visual and instructive exploration of PlatformViewHitBehavior for D4rt interpreter scenarios.',
              icon: Icons.dashboard_customize_rounded,
              primary: primary,
              accent: accent,
            ),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            _buildBullet(text: 'PlatformViewHitBehavior is used when you need explicit control over hit testing, event dispatch, and pointer interaction.'),
