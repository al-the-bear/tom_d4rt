      ...
      children: [
        ...
        Listener(
          ...
          onPointerDown: (_) => print(
            'RenderSliverFillRemainingAndOverscroll: pointer down observed via Listener',
          ),
          child: Container(
            width: 120,
            height: 28,
...
dynamic build(BuildContext context) {
  ...
  mark(
    'Direct class reference resolved for RenderSliverFillRemainingAndOverscroll',
  );
  ...
  print(
    'RenderSliverFillRemainingAndOverscroll test completed with ${checkpoints.length} checkpoints.',
  );
