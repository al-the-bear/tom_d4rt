...
dynamic build(BuildContext context) {
  ...
  final op2 = OffsetPair.fromEventPosition(Offset(150, 250));
  print('fromEventPosition: local=${op2.local}, global=${op2.global}');

  final op3 = OffsetPair.fromEventDelta(Offset(5, 10));
  print('fromEventDelta: local=${op3.local}, global=${op3.global}');
