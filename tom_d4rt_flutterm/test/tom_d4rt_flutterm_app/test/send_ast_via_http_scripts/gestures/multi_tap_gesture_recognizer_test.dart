...
dynamic build(BuildContext context) {
  ...
  recognizer.onTapDown = (pointer, details) {
    print('tapDown: $pointer');
  };
  recognizer.onTapUp = (pointer, details) {
    print('tapUp: $pointer');
  };
  recognizer.onTapCancel = (pointer) {
    print('tapCancel: $pointer');
  };
  recognizer.onTap = (pointer) {
    print('tap: $pointer');
  };
  recognizer.onLongTapDown = (pointer, details) {
    print('longTapDown: $pointer');
  };
  print('Callbacks set');
  ...
  return Column(
    ...
    children: [
      Text(
        'MultiTapGestureRecognizer Tests',
