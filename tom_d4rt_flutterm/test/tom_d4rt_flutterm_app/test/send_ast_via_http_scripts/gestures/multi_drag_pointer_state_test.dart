...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    stateA is MultiDragPointerState,
    'stateA is MultiDragPointerState subtype',
    logs,
    counters,
  );
  expectCondition(
    stateB.initialPosition.dx == -12,
    'edge case negative initial dx preserved',
    logs,
    counters,
  );
  expectCondition(
    stateA.initialPosition == Offset(3, 4),
    'stateA initialPosition stored',
    logs,
    counters,
  );
