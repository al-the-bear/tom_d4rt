...
const String _targetClassName = 'BaseTapAndDragGestureRecognizer';

class BaseTapAndDragGestureRecognizerScenario {
  BaseTapAndDragGestureRecognizerScenario({
    required this.label,
  ...
  BaseTapAndDragGestureRecognizerScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return BaseTapAndDragGestureRecognizerScenario(
...
List<String> _runScenarioChecks(BaseTapAndDragGestureRecognizerScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = BaseTapAndDragGestureRecognizerScenario(
  ...
  _expect(_targetClassName == 'BaseTapAndDragGestureRecognizer', 'target class identifier should match filename');
