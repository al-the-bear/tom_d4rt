...
dynamic build(BuildContext context) {
  ...
  print(
    'TapGestureRecognizer is OneSequenceGestureRecognizer: ${tap is OneSequenceGestureRecognizer}',
  );
  tap.dispose();

  final longPress = LongPressGestureRecognizer();
  print(
    'LongPress is OneSequenceGestureRecognizer: ${longPress is OneSequenceGestureRecognizer}',
  );
  longPress.dispose();

  final vDrag = VerticalDragGestureRecognizer();
  print(
    'VerticalDrag is OneSequenceGestureRecognizer: ${vDrag is OneSequenceGestureRecognizer}',
  );
  vDrag.dispose();
  ...
  return Column(
    ...
    children: [
      Text(
        'OneSequenceGestureRecognizer Tests',
