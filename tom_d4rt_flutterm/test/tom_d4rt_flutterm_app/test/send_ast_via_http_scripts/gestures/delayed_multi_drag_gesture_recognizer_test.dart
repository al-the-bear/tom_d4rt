...
dynamic build(BuildContext context) {
  ...
  final recognizerB = DelayedMultiDragGestureRecognizer(
  ...
  expectCondition(
    recognizerA is MultiDragGestureRecognizer,
    'recognizerA is MultiDragGestureRecognizer',
    logs,
    counters,
  );
  expectCondition(
    recognizerB.delay.inMilliseconds == 450,
    'recognizerB stores custom delay',
    logs,
    counters,
  );
  expectCondition(
    recognizerA.debugDescription.contains('multidrag'),
    'debugDescription contains multidrag',
    logs,
    counters,
  );
  expectCondition(
    recognizerB.gestureSettings!.touchSlop == 30,
    'gesture settings property writable',
    logs,
    counters,
  );
