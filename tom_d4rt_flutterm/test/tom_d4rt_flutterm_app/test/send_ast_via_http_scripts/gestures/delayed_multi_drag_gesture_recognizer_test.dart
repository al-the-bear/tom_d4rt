// D4rt comprehensive test script for DelayedMultiDragGestureRecognizer
...
dynamic build(BuildContext context) {
  const targetClassName = 'DelayedMultiDragGestureRecognizer';
  const testLabel = 'DelayedMultiDragGestureRecognizer';
  final logs = <String>[];
  ...
  final recognizerA = DelayedMultiDragGestureRecognizer();
  final recognizerB = DelayedMultiDragGestureRecognizer(delay: const Duration(milliseconds: 450));
  recognizerA.gestureSettings = const DeviceGestureSettings(touchSlop: 18);
  recognizerB.gestureSettings = const DeviceGestureSettings(touchSlop: 30);
  expectCondition(recognizerA is MultiDragGestureRecognizer, 'recognizerA is MultiDragGestureRecognizer', logs, counters);
  expectCondition(recognizerB.delay.inMilliseconds == 450, 'recognizerB stores custom delay', logs, counters);
  expectCondition(recognizerA.debugDescription.contains('multidrag'), 'debugDescription contains multidrag', logs, counters);
  expectCondition(recognizerB.gestureSettings!.touchSlop == 30, 'gesture settings property writable', logs, counters);
  details['recognizerA'] = recognizerA.debugDescription;
  details['recognizerB'] = recognizerB.debugDescription;
  recognizerA.dispose();
  recognizerB.dispose();
