...
dynamic build(BuildContext context) {
  ...
  _check(logs: logs, label: 'global position preserved', condition: d1.globalPosition == Offset(10, 20));
  ...
  _check(logs: logs, label: 'custom local position preserved', condition: d2.localPosition == Offset(5, 7));
  _check(logs: logs, label: 'global unaffected by custom local', condition: d2.globalPosition == Offset(50, 70));
  ...
  _check(logs: logs, label: 'offset arithmetic valid', condition: delta == Offset(45, 63));
