...
dynamic build(BuildContext context) {
  ...
  final singleToolbar = CupertinoSpellCheckSuggestionsToolbar(
    anchors: TextSelectionToolbarAnchors(primaryAnchor: Offset(50.0, 100.0)),
    buttonItems: [ContextMenuButtonItem(label: 'Suggestion', onPressed: () {})],
  );
  ...
  final maxToolbar = CupertinoSpellCheckSuggestionsToolbar(
    anchors: TextSelectionToolbarAnchors(primaryAnchor: Offset(150.0, 300.0)),
