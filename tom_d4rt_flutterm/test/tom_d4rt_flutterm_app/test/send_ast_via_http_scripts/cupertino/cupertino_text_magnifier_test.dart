...
dynamic build(BuildContext context) {
  ...
  print(
    'CupertinoTextMagnifier with dragResistance: ${dragMagnifier.dragResistance}',
  );
  ...
  print(
    'CupertinoTextMagnifier with hideBelowThreshold: ${thresholdMagnifier.hideBelowThreshold}',
  );
  ...
  print(
    'CupertinoTextMagnifier with horizontalScreenEdgePadding: ${edgeMagnifier.horizontalScreenEdgePadding}',
  );
  ...
  print(
    'horizontalScreenEdgePadding: ${fullMagnifier.horizontalScreenEdgePadding}',
  );
