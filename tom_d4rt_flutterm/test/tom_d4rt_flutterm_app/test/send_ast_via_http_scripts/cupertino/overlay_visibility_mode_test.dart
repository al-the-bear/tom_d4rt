...
class OverlayVisibilityModeCaseStudy {
  ...
  List<String> run() {
    ...
    assert(samples.isNotEmpty, 'OverlayVisibilityMode must expose at least one value');
...
dynamic build(BuildContext context) {
  ...
  assert(values.length >= 1, 'OverlayVisibilityMode must have at least one enum value');
