...
dynamic build(BuildContext context) {
  ...
  print(
    'CupertinoButton with disabledColor created [${disabledColorButton.hashCode}]',
  );
  ...
  print(
    'CupertinoButton with pressedOpacity created [${opacityButton.hashCode}]',
  );
  ...
  print(
    'CupertinoButton.filled with disabledColor created [${filledDisabledColorButton.hashCode}]',
  );
  ...
  print(
    'CupertinoButton.filled with minSize created [${filledMinSizeButton.hashCode}]',
  );
  ...
  print(
    'CupertinoButton.filled with pressedOpacity created [${filledOpacityButton.hashCode}]',
  );
  ...
  print(
    'CupertinoButton.filled with alignment created [${filledAlignedButton.hashCode}]',
  );
  ...
  print(
    'Various colored CupertinoButton.filled created [${redFilledButton.hashCode}]',
  );
