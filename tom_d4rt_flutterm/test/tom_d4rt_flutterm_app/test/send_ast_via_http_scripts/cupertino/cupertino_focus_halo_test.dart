...
dynamic build(BuildContext context) {
  ...
  final rectHalo = CupertinoFocusHalo.withRect(
    child: CupertinoButton(child: Text('Rect Focus'), onPressed: () {}),
  );
  ...
  final rRectHalo = CupertinoFocusHalo.withRRect(
    ...
    child: CupertinoButton.filled(child: Text('RRect Focus'), onPressed: () {}),
  );
  ...
  final zeroRadius = CupertinoFocusHalo.withRRect(
    ...
    child: Container(
      ...
      child: Center(
        child: Text('Zero', style: TextStyle(color: CupertinoColors.white)),
      ),
    ),
  );
