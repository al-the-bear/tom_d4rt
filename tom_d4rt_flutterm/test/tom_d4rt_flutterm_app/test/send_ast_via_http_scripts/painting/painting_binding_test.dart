...
const String _targetClassName = 'PaintingBinding';

class PaintingBindingScenario {
  PaintingBindingScenario({
    required this.label,
  ...
  PaintingBindingScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return PaintingBindingScenario(
...
List<String> _runScenarioChecks(PaintingBindingScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = PaintingBindingScenario(
  ...
  _expect(_targetClassName == 'PaintingBinding', 'target class identifier should match filename');
