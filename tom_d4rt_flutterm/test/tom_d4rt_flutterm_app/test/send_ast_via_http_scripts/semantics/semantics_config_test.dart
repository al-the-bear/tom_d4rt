// Comprehensive D4rt test script: SemanticsConfig from semantics
      ...
      child: Card(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('D4rt semantics test: \$title', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SemanticsConfig script ===');
  ...
  detailLines.add('target=SemanticsConfig');
  detailLines.add('package=semantics');
  ...
  const String targetTypeName = 'SemanticsConfig';
  detailLines.add('category=semantics_config');
  // Test SemanticsConfiguration
  final SemanticsConfiguration config = SemanticsConfiguration();
  check(config is SemanticsConfiguration, 'Created');
  config.isSemanticBoundary = true;
  check(config.isSemanticBoundary == true, 'Boundary set');
  config.label = 'Test Label';
  check(config.label == 'Test Label', 'Label set');
  detailLines.add('isSemanticBoundary=true');
  detailLines.add('label=Test Label');
