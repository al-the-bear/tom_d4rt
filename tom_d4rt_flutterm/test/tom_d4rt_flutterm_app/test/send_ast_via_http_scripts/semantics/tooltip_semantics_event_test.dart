...
dynamic build(BuildContext context) {
  ...
  print(
    'Multiline tooltip lines: ${multilineEvent.message.split('\n').length}',
  );
  ...
  assert(
    events.every((e) => e is TooltipSemanticsEvent),
    'All should be TooltipSemanticsEvent',
  );
  ...
  assert(
    event1.runtimeType.toString() == 'TooltipSemanticsEvent',
