...
dynamic build(BuildContext context) {
  ...
  assert(
    property is DiagnosticsProperty<AttributedString>,
    'Should be DiagnosticsProperty',
  );
  results.add('Inheritance: DiagnosticsProperty<AttributedString>');
  print(
    'Is DiagnosticsProperty: ${property is DiagnosticsProperty<AttributedString>}',
  );
  ...
  final nullProp = AttributedStringProperty('empty', null, defaultValue: null);
  ...
  assert(
    spellOutString.attributes.first is SpellOutStringAttribute,
    'Should be SpellOutStringAttribute',
  );
  ...
  print(
    'TextRange: start=${range.start}, end=${range.end}, collapsed=${range.isCollapsed}',
  );
