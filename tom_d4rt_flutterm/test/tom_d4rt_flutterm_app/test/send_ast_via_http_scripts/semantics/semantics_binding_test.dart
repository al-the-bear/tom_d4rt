...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    ...
    'binding initialized and is WidgetsBinding',
    logs,
    counters,
  );
  expectCondition(
    semanticsBinding is SemanticsBinding,
    'SemanticsBinding.instance available',
    logs,
    counters,
  );
  expectCondition(
    handle is SemanticsHandle,
    'ensureSemantics returns SemanticsHandle',
    logs,
    counters,
  );
  handle.dispose();
