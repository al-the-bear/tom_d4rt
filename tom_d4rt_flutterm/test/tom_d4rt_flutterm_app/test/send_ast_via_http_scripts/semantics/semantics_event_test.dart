...
dynamic build(BuildContext context) {
  ...
  final announceEvent = AnnounceSemanticsEvent(
    'Test message',
    TextDirection.ltr,
  );
  ...
  assert(
    longPressEvent is SemanticsEvent,
    'LongPress should be SemanticsEvent',
  );
  ...
  assert(
    longPressEvent.type == 'longPress',
    'LongPress type should be longPress',
  );
