...
dynamic build(BuildContext context) {
  ...
  assert(
    config1.explicitChildNodes == false,
    'explicitChildNodes should be false',
  );
  ...
  print(
    'Blocking previously painted: ${config1.isBlockingSemanticsOfPreviouslyPaintedNodes}',
  );
  ...
  assert(
    configList[0].label == 'Test Label',
    'First config label should match',
  );
  assert(
    configList[1].label == 'Second Config',
    'Second config label should match',
  );
  ...
  // Test 20: Summary
  print(
    'ChildSemanticsConfigurationsResult test completed with ${results.length} tests',
  );
