...
dynamic build(BuildContext context) {
  print(
    '=== Running comprehensive ExtendSelectionToNextParagraphBoundaryOrCaretLocationIntent script ===',
  );
  ...
  detailLines.add(
    'target=ExtendSelectionToNextParagraphBoundaryOrCaretLocationIntent',
  );
