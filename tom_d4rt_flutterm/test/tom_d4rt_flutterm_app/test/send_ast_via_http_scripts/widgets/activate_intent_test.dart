...
dynamic build(BuildContext context) {
  ...
  runCase('ActivateIntent symbol check', () {
  ...
  runCase('ActivateIntent const constructor available', () {
    const ActivateIntent intent = ActivateIntent();
    return intent.runtimeType.toString().contains('ActivateIntent');
  });

  runCase('Summary string can be created', () {
    final String summary = 'activateintent:'
