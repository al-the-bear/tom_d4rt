// Comprehensive D4rt test script: ActivateIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ActivateIntent script ===');
  ...
  final Type targetType = ActivateIntent;
  ...
  detailLines.add('target=ActivateIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ActivateIntent'), 'Target type symbol resolves');
