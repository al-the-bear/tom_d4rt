// Comprehensive D4rt test script: Element from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Element script ===');
  ...
  detailLines.add('target=Element');
  ...
  // Element: the instantiation of a Widget at a location in the tree
  check(context is Element, 'BuildContext is an Element');
  final Element elem = context as Element;
  check(elem.widget != null, 'Element has a widget');
  check(elem.mounted, 'Element is mounted');
  detailLines.add('elementDepth=' + elem.depth.toString());
  detailLines.add('elementWidget=' + elem.widget.runtimeType.toString());
  check(elem.depth >= 0, 'Element depth is non-negative');
