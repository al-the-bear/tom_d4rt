// Comprehensive D4rt test script: InheritedTheme from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InheritedTheme script ===');
  ...
  detailLines.add('target=InheritedTheme');
  ...
  // InheritedTheme: base for themes that wrap and capture
  final ThemeData theme = Theme.of(context);
  check(theme is ThemeData, 'Theme resolved from InheritedTheme');
  detailLines.add('themeMode=' + theme.brightness.toString());
  // IconTheme is also an InheritedTheme
  final IconThemeData iconTheme = IconTheme.of(context);
  check(iconTheme is IconThemeData, 'IconTheme resolved');
