// Comprehensive D4rt test script: ListWheelChildDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ListWheelChildDelegate script ===');
  ...
  detailLines.add('target=ListWheelChildDelegate');
  ...
  const String targetTypeName = 'ListWheelChildDelegate';
  check(targetTypeName.contains('Delegate'), 'Name includes Delegate');
  detailLines.add('description=Abstract delegate for ListWheelScrollView children');
  final ListWheelChildListDelegate ld = ListWheelChildListDelegate(children: const <Widget>[Text('A')]);
  check(ld is ListWheelChildDelegate, 'ListWheelChildListDelegate is ListWheelChildDelegate');
