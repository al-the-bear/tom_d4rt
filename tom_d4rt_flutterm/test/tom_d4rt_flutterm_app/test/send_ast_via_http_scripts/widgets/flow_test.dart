// Comprehensive D4rt test script: Flow from widgets
...
class _FlowDemoDelegate extends FlowDelegate {
  ...
  void paintChildren(FlowPaintingContext context) {
    for (int i = 0; i < context.childCount; i++) {
      context.paintChild(i, transform: Matrix4.translationValues(i * 45.0, 0, 0));
    }
  }
  @override
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Flow script ===');
  ...
  final Flow flow = Flow(delegate: _FlowDemoDelegate(), children: <Widget>[for (int i = 0; i < 5; i++) Container(width: 40, height: 40, color: Color(0xFF42A5F5 + i * 0x111111))]);
  check(flow is Widget, 'Is Widget');
  check(flow.delegate is FlowDelegate, 'Has delegate');
  detailLines.add('childCount=5');
