// Comprehensive D4rt test script: SharedAppData from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SharedAppData script ===');
  ...
  detailLines.add('target=SharedAppData');
  ...
  const String targetTypeName = 'SharedAppData';
  check(targetTypeName.contains('App'), 'Name includes App');
  detailLines.add('description=Shared app-wide data');
  final Widget app = MaterialApp(home: const Text('Shared'));
