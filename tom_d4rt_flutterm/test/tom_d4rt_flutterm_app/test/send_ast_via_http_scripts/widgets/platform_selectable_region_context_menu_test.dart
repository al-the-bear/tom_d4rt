// Comprehensive D4rt test script: PlatformSelectableRegionContextMenu from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformSelectableRegionContextMenu script ===');
  ...
  detailLines.add('target=PlatformSelectableRegionContextMenu');
  ...
  const String targetTypeName = 'PlatformSelectableRegionContextMenu';
  check(targetTypeName.contains('Context'), 'Name includes Context');
  detailLines.add('description=Platform context menu for selectable regions');
