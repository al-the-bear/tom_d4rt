...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    values.isNotEmpty,
    'FocusHighlightMode.values should not be empty',
    logs,
    counters,
  );
  expectCondition(
    values.length >= 2,
    'FocusHighlightMode should provide multiple values',
    logs,
    counters,
  );
  ...
  for (final FocusHighlightMode value in values) {
    ...
    final FocusHighlightMode byName = FocusHighlightMode.values.byName(
      value.name,
    );
    expectCondition(
      byName == value,
  ...
  final List<FocusHighlightMode> reversed = values.reversed.toList(
    growable: false,
  );
  expectCondition(
    reversed.first == last,
  ...
  final FocusHighlightMode edgeByName = FocusHighlightMode.values.byName(
    edgeName,
  );
  expectCondition(
