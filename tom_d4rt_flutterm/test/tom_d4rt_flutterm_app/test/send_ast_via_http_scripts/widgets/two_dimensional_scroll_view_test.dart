// Comprehensive D4rt test script: TwoDimensionalScrollView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalScrollView script ===');
  ...
  detailLines.add('target=TwoDimensionalScrollView');
  ...
  const String targetTypeName = 'TwoDimensionalScrollView';
  detailLines.add('category=widgets_2d');
  detailLines.add('desc=Abstract 2D scroll view');
  check(targetTypeName.contains('ScrollView'), 'Has ScrollView');
