// Comprehensive D4rt test script: UnmanagedRestorationScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UnmanagedRestorationScope script ===');
  ...
  detailLines.add('target=UnmanagedRestorationScope');
  ...
  final UnmanagedRestorationScope scope = UnmanagedRestorationScope(bucket: null, child: const SizedBox());
  check(scope is Widget, 'Is Widget');
  detailLines.add('desc=Restoration scope not managed by framework');
