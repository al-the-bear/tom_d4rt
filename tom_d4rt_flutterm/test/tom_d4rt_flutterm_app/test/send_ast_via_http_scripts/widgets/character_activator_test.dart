// Comprehensive D4rt test script: CharacterActivator from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive CharacterActivator script ===');
  ...
  final Type targetType = CharacterActivator;
  ...
  detailLines.add('target=CharacterActivator');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('CharacterActivator'), 'Target type symbol resolves');
