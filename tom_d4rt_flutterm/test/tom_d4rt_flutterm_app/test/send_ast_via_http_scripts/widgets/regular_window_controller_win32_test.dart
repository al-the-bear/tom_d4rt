// Comprehensive D4rt test script: RegularWindowControllerWin32 from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RegularWindowControllerWin32 script ===');
  ...
  detailLines.add('target=RegularWindowControllerWin32');
  ...
  const String targetTypeName = 'RegularWindowControllerWin32';
  check(targetTypeName.contains('Window'), 'Name includes Window');
  detailLines.add('description=Win32 window controller');
