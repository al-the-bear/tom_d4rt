// Comprehensive D4rt test script: SliverMainAxisGroup from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverMainAxisGroup script ===');
  ...
  detailLines.add('target=SliverMainAxisGroup');
  ...
  const SliverMainAxisGroup group = SliverMainAxisGroup(slivers: <Widget>[SliverToBoxAdapter(child: SizedBox(height: 50)), SliverToBoxAdapter(child: SizedBox(height: 50))]);
