// Comprehensive D4rt test script: ShortcutMapProperty from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShortcutMapProperty script ===');
  ...
  detailLines.add('target=ShortcutMapProperty');
  ...
  const String targetTypeName = 'ShortcutMapProperty';
  check(targetTypeName.contains('Property'), 'Name includes Property');
  detailLines.add('description=Diagnostics property for shortcut maps');
  final ShortcutManager sm = ShortcutManager();
  check(sm is ShortcutManager, 'Manager created');
  sm.dispose();
