// Comprehensive D4rt test script: MultiSelectableSelectionContainerDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MultiSelectableSelectionContainerDelegate script ===');
  ...
  detailLines.add('target=MultiSelectableSelectionContainerDelegate');
  ...
  const String targetTypeName = 'MultiSelectableSelectionContainerDelegate';
  check(targetTypeName.contains('Selection'), 'Name includes Selection');
  detailLines.add('description=Delegate for multi-selectable selection containers');
  final Widget selectableText = const SelectableText('Select me');
  check(selectableText is SelectableText, 'SelectableText created');
