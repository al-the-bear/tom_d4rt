// Comprehensive D4rt test script: DraggableDetails from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DraggableDetails script ===');
  ...
  detailLines.add('target=DraggableDetails');
  ...
  // DraggableDetails: outcome details from a drag
  ...
  check(draggable is Draggable, 'Draggable with onDragEnd created');
