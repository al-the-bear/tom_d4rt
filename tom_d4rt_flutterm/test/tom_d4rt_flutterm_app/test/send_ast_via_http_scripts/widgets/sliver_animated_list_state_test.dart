// Comprehensive D4rt test script: SliverAnimatedListState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverAnimatedListState script ===');
  ...
  detailLines.add('target=SliverAnimatedListState');
  ...
  const String targetTypeName = 'SliverAnimatedListState';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=State object for SliverAnimatedList');
