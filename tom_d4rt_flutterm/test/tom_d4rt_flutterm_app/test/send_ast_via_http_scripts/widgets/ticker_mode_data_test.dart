// Comprehensive D4rt test script: TickerModeData from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TickerModeData script ===');
  ...
  detailLines.add('target=TickerModeData');
  ...
  const String targetTypeName = 'TickerModeData';
  detailLines.add('category=widgets_ticker');
  detailLines.add('desc=Data provided by TickerMode');
  check(targetTypeName.contains('Ticker'), 'Has Ticker');
