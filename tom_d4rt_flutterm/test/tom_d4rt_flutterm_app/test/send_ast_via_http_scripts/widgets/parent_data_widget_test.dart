// Comprehensive D4rt test script: ParentDataWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ParentDataWidget script ===');
  ...
  detailLines.add('target=ParentDataWidget');
  ...
  const String targetTypeName = 'ParentDataWidget';
  check(targetTypeName.contains('Widget'), 'Name includes Widget');
  detailLines.add('description=Base class for widgets that configure parent data');
  final Widget positioned = Positioned(left: 10, child: const Text('Pos'));
  check(positioned is ParentDataWidget, 'Positioned is ParentDataWidget');
  final Widget flexible = Flexible(child: const Text('Flex'));
  check(flexible is ParentDataWidget, 'Flexible is ParentDataWidget');
