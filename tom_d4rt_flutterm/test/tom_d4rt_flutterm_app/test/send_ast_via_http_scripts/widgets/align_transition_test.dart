// Comprehensive D4rt test script: AlignTransition from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AlignTransition script ===');
  ...
  final Type targetType = AlignTransition;
  ...
  detailLines.add('target=AlignTransition');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AlignTransition'), 'Target type symbol resolves');
