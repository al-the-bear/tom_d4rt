...
dynamic build(BuildContext context) {
  print(
    '=== Running comprehensive DoNothingAndStopPropagationIntent script ===',
  );
  ...
  check(
    targetTypeName.contains('StopPropagation'),
    'Intent name includes StopPropagation',
  );
  ...
  check(
    actionsWidget is Actions,
    'Actions widget supports stop-propagation intents',
  );
