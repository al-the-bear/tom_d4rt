// Comprehensive D4rt test script: PhysicalShape from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PhysicalShape script ===');
  ...
  detailLines.add('target=PhysicalShape');
  ...
  final Widget shape = PhysicalShape(
    clipper: ShapeBorderClipper(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
    color: const Color(0xFF3B82F6),
    elevation: 8.0,
    child: Container(width: 100, height: 100),
  );
  check(shape is PhysicalShape, 'PhysicalShape created');
  check(shape is SingleChildRenderObjectWidget, 'Is SingleChildRenderObjectWidget');
  detailLines.add('elevation=8.0');
