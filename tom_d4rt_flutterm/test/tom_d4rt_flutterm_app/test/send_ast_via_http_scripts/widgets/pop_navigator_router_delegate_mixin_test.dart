...
class _PopNavigatorRouterDelegateMixinProbe implements PopNavigatorRouterDelegateMixin {
...
dynamic build(BuildContext context) {
  ...
  final _PopNavigatorRouterDelegateMixinProbe primary = _PopNavigatorRouterDelegateMixinProbe('primary', seed: 7);
  final _PopNavigatorRouterDelegateMixinProbe edge = _PopNavigatorRouterDelegateMixinProbe('', seed: -3);
  final _PopNavigatorRouterDelegateMixinProbe large = _PopNavigatorRouterDelegateMixinProbe('large-case', seed: 999);
