...
dynamic build(BuildContext context) {
  ...
  final _TextSelectionHandleControlsProbe primary = _TextSelectionHandleControlsProbe('primary', seed: 7);
  final _TextSelectionHandleControlsProbe edge = _TextSelectionHandleControlsProbe('', seed: -3);
  final _TextSelectionHandleControlsProbe large = _TextSelectionHandleControlsProbe('large-case', seed: 999);
