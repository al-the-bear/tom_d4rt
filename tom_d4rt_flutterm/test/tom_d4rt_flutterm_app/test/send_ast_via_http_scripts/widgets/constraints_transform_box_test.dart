// Comprehensive D4rt test script: ConstraintsTransformBox from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ConstraintsTransformBox script ===');
  ...
  final Type targetType = ConstraintsTransformBox;
  ...
  detailLines.add('target=ConstraintsTransformBox');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ConstraintsTransformBox'), 'Target type symbol resolves');
