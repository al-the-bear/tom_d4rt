// Comprehensive D4rt test script: BackButtonListener from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BackButtonListener script ===');
  ...
  final Type targetType = BackButtonListener;
  ...
  detailLines.add('target=BackButtonListener');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BackButtonListener'), 'Target type symbol resolves');
