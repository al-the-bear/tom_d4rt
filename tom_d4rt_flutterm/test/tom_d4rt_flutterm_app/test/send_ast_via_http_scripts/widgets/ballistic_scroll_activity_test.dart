// Comprehensive D4rt test script: BallisticScrollActivity from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BallisticScrollActivity script ===');
  ...
  final Type targetType = BallisticScrollActivity;
  ...
  detailLines.add('target=BallisticScrollActivity');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BallisticScrollActivity'), 'Target type symbol resolves');
