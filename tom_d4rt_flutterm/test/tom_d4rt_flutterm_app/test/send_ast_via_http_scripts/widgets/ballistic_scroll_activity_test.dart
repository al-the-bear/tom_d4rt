...
dynamic build(BuildContext context) {
  ...
  runCase('BallisticScrollActivity symbol exists', () {
    final Type t = BallisticScrollActivity;
    return t.toString().contains('BallisticScrollActivity');
  });

  runCase('BallisticScrollActivity type string stable', () {
    final Type t = BallisticScrollActivity;
  ...
  runCase('ScrollActivity symbol exists', () {
    final Type t = ScrollActivity;
    return t.toString().contains('ScrollActivity');
  });

  runCase('Summary string can be generated', () {
    final String summary = 'ballisticscrollactivity:'
