// Comprehensive D4rt test script: PrimaryScrollController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PrimaryScrollController script ===');
  ...
  detailLines.add('target=PrimaryScrollController');
  ...
  final Widget psc = PrimaryScrollController(
    controller: sc,
    child: const Text('Primary'),
  );
  check(psc is PrimaryScrollController, 'PrimaryScrollController created');
  check(psc is Widget, 'Is a Widget');
  sc.dispose();
