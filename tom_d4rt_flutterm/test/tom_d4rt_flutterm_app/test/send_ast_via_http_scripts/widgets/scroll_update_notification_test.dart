// Comprehensive D4rt test script: ScrollUpdateNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollUpdateNotification script ===');
  ...
  detailLines.add('target=ScrollUpdateNotification');
  ...
  final Widget listener = NotificationListener<ScrollUpdateNotification>(
    onNotification: (ScrollUpdateNotification n) { print('scroll update'); return true; },
    child: const SingleChildScrollView(child: SizedBox(height: 2000)),
  );
  check(listener is NotificationListener, 'ScrollUpdateNotification listener created');
