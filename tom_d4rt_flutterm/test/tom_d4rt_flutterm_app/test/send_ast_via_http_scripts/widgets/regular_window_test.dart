// Comprehensive D4rt test script: RegularWindow from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RegularWindow script ===');
  ...
  detailLines.add('target=RegularWindow');
  ...
  const String targetTypeName = 'RegularWindow';
  check(targetTypeName.contains('Window'), 'Name includes Window');
  detailLines.add('description=Regular window widget');
  final Widget scaffold = Scaffold(appBar: AppBar(title: const Text('Window')), body: const Center(child: Text('Content')));
  check(scaffold is Scaffold, 'Scaffold (window content) created');
