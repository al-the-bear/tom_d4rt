// Comprehensive D4rt test script: WebBrowserDetection from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WebBrowserDetection script ===');
  ...
  detailLines.add('target=WebBrowserDetection');
  ...
  const String targetTypeName = 'WebBrowserDetection';
  detailLines.add('category=widgets_web');
  detailLines.add('desc=Web browser detection utilities');
  check(targetTypeName.contains('Web'), 'Has Web');
  check(targetTypeName.contains('Browser'), 'Has Browser');
