// Comprehensive D4rt test script: ListWheelScrollView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ListWheelScrollView script ===');
  ...
  detailLines.add('target=ListWheelScrollView');
  ...
  check(wheel is StatefulWidget, 'ListWheelScrollView is StatefulWidget');
  detailLines.add('itemExtent=40.0');
  detailLines.add('diameterRatio=2.0');
