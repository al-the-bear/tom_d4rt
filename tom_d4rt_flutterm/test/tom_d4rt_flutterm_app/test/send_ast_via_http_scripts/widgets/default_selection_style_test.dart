// Comprehensive D4rt test script: DefaultSelectionStyle from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DefaultSelectionStyle script ===');
  ...
  final Type targetType = DefaultSelectionStyle;
  ...
  detailLines.add('target=DefaultSelectionStyle');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DefaultSelectionStyle'), 'Target type symbol resolves');
