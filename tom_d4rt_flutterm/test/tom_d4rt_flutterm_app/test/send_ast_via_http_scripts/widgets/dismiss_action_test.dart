// Comprehensive D4rt test script: DismissAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DismissAction script ===');
  ...
  final Type targetType = DismissAction;
  ...
  detailLines.add('target=DismissAction');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DismissAction'), 'Target type symbol resolves');
