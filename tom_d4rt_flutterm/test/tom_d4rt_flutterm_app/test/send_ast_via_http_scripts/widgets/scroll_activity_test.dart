// Comprehensive D4rt test script: ScrollActivity from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollActivity script ===');
  ...
  detailLines.add('target=ScrollActivity');
  ...
  const String targetTypeName = 'ScrollActivity';
  check(targetTypeName.contains('Activity'), 'Name includes Activity');
  detailLines.add('description=Base for scroll activities');
