// Comprehensive D4rt test script: HTMLElementView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive HTMLElementView script ===');
  ...
  detailLines.add('target=HTMLElementView');
  ...
  const String targetTypeName = 'HTMLElementView';
  check(targetTypeName == 'HTMLElementView', 'Target type name set');
  detailLines.add('description=HTMLElementView widget/class');
  final Widget probe = Container(child: const Text('Generic test'));
  check(probe is Container, 'Test widget created');
