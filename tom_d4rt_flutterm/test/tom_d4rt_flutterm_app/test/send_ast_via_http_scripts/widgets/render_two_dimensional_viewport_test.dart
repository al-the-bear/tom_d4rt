...
const String _targetClassName = 'RenderTwoDimensionalViewport';

class RenderTwoDimensionalViewportScenario {
  RenderTwoDimensionalViewportScenario({
    required this.label,
  ...
  RenderTwoDimensionalViewportScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return RenderTwoDimensionalViewportScenario(
...
List<String> _runScenarioChecks(RenderTwoDimensionalViewportScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = RenderTwoDimensionalViewportScenario(
  ...
  _expect(_targetClassName == 'RenderTwoDimensionalViewport', 'target class identifier should match filename');
