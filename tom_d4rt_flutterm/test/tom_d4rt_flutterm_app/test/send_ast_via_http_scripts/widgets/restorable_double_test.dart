// Comprehensive D4rt test script: RestorableDouble from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableDouble script ===');
  ...
  detailLines.add('target=RestorableDouble');
  ...
  final RestorableDouble prop = RestorableDouble(3.14);
  check(prop is RestorableDouble, 'Created');
  check(prop.value == 3.14, 'Value is 3.14');
  detailLines.add('value=' + prop.value.toString());
  prop.dispose();
