// Comprehensive D4rt test script: TransitionDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TransitionDelegate script ===');
  ...
  detailLines.add('target=TransitionDelegate');
  ...
  const String targetTypeName = 'TransitionDelegate';
  detailLines.add('category=widgets_navigation');
  detailLines.add('desc=Delegate for route transition decisions');
