// Comprehensive D4rt test script: RestorableValue from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableValue script ===');
  ...
  detailLines.add('target=RestorableValue');
  ...
  const String targetTypeName = 'RestorableValue';
  check(targetTypeName.contains('Value'), 'Name includes Value');
  detailLines.add('description=Base for restorable values');
  final RestorableString rs = RestorableString('test');
  check(rs is RestorableValue, 'RestorableString is RestorableValue');
  rs.dispose();
