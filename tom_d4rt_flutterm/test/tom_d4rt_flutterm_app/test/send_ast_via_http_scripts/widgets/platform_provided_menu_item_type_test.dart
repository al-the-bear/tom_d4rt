...
dynamic build(BuildContext context) {
  print('========== PlatformProvidedMenuItemType comprehensive test start ==========' );

  final List<PlatformProvidedMenuItemType> values = PlatformProvidedMenuItemType.values.toList(growable: false);
  _expect(values.isNotEmpty, 'PlatformProvidedMenuItemType exposes at least one enum value');
  _expect(
  ...
  final List<PlatformProvidedMenuItemType> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'PlatformProvidedMenuItemType checks passed: ${values.length} values validated';
  print(summary);
  print('========== PlatformProvidedMenuItemType comprehensive test end ==========' );
