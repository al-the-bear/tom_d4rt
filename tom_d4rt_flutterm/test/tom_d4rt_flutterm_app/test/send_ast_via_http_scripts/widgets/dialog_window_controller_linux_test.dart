// Comprehensive D4rt test script: DialogWindowControllerLinux from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DialogWindowControllerLinux script ===');
  ...
  const String targetTypeName = 'DialogWindowControllerLinux';
  ...
  detailLines.add('target=DialogWindowControllerLinux');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetTypeName);

  check(targetTypeName == 'DialogWindowControllerLinux', 'Target type symbol resolves');
