// Comprehensive D4rt test script: ShortcutManager from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShortcutManager script ===');
  ...
  detailLines.add('target=ShortcutManager');
  ...
  check(manager is ShortcutManager, 'Created');
  check(manager is ChangeNotifier, 'Is ChangeNotifier');
  detailLines.add('shortcuts=empty');
  manager.dispose();
