// Comprehensive D4rt test script: AutocompleteNextOptionIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutocompleteNextOptionIntent script ===');
  ...
  final Type targetType = AutocompleteNextOptionIntent;
  ...
  detailLines.add('target=AutocompleteNextOptionIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutocompleteNextOptionIntent'), 'Target type symbol resolves');
