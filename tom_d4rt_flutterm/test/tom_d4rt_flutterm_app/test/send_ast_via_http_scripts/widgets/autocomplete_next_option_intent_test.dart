...
dynamic build(BuildContext context) {
  ...
  print('AutocompleteNextOptionIntent test executing');
  print('=' * 50);
  ...
  runCase('AutocompleteNextOptionIntent type string stable', () {
    final Type t = AutocompleteNextOptionIntent;
  ...
  runCase('AutocompleteFirstOptionIntent symbol exists', () {
  ...
  runCase('Summary string can be generated', () {
    final String summary = 'autocompletenextoptionintent:'
  ...
  return Column(
    ...
    children: <Widget>[
      const Text(
        'AutocompleteNextOptionIntent Tests',
