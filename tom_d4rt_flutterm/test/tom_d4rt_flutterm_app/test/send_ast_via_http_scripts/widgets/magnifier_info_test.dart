// Comprehensive D4rt test script: MagnifierInfo from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MagnifierInfo script ===');
  ...
  detailLines.add('target=MagnifierInfo');
  ...
  const String targetTypeName = 'MagnifierInfo';
  check(targetTypeName.contains('Magnifier'), 'Name includes Magnifier');
  detailLines.add('description=Information about text field for magnifier positioning');
  final Widget textField = const TextField();
  check(textField is TextField, 'TextField (magnifier host) created');
