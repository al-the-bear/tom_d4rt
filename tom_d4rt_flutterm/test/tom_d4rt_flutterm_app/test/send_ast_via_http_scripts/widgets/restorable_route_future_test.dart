// Comprehensive D4rt test script: RestorableRouteFuture from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableRouteFuture script ===');
  ...
  detailLines.add('target=RestorableRouteFuture');
  ...
  const String targetTypeName = 'RestorableRouteFuture';
  check(targetTypeName.contains('Route'), 'Name includes Route');
  detailLines.add('description=Restorable future for route results');
  final Widget btn = ElevatedButton(onPressed: () {}, child: const Text('Navigate'));
  check(btn is ElevatedButton, 'Navigation button created');
