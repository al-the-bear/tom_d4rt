// Comprehensive D4rt test script: SliverAnimatedList from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverAnimatedList script ===');
  ...
  detailLines.add('target=SliverAnimatedList');
  ...
  final SliverAnimatedList list = SliverAnimatedList(key: key, itemBuilder: (BuildContext ctx, int index, Animation<double> anim) { return SizeTransition(sizeFactor: anim, child: Container(height: 60, color: const Color(0xFF66BB6A))); }, initialItemCount: 5);
  check(list is Widget, 'Is Widget');
  check(list.initialItemCount == 5, 'Initial count');
  detailLines.add('initialItems=5');
