// Comprehensive D4rt test script: ShortcutRegistrar from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShortcutRegistrar script ===');
  ...
  detailLines.add('target=ShortcutRegistrar');
  ...
  final ShortcutRegistrar registrar = ShortcutRegistrar(child: const SizedBox());
  check(registrar is Widget, 'Is Widget');
  detailLines.add('category=widgets_shortcuts');
  detailLines.add('desc=Registers shortcut bindings');
