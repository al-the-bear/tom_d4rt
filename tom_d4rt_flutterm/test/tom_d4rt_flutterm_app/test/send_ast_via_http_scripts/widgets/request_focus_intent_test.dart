// Comprehensive D4rt test script: RequestFocusIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RequestFocusIntent script ===');
  ...
  detailLines.add('target=RequestFocusIntent');
  ...
  final RequestFocusIntent intent = RequestFocusIntent(node);
  check(intent is RequestFocusIntent, 'Created');
  check(intent is Intent, 'Is Intent');
  check(intent.focusNode == node, 'Focus node is correct');
  node.dispose();
