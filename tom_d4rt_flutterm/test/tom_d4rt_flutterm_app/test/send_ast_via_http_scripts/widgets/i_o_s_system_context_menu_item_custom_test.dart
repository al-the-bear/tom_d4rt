// Comprehensive D4rt test script: IOSSystemContextMenuItemCustom from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItemCustom script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItemCustom');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItemCustom';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=Custom');
  detailLines.add('description=iOS system context menu item (Custom)');
