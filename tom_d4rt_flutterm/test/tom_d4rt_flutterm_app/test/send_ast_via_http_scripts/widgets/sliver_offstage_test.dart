// Comprehensive D4rt test script: SliverOffstage from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverOffstage script ===');
  ...
  detailLines.add('target=SliverOffstage');
  ...
  const SliverOffstage offstage = SliverOffstage(offstage: true, sliver: SliverToBoxAdapter(child: SizedBox(height: 60)));
  check(offstage is Widget, 'Is Widget');
  check(offstage.offstage == true, 'offstage=true');
  const SliverOffstage visible = SliverOffstage(offstage: false, sliver: SliverToBoxAdapter(child: SizedBox(height: 60)));
  check(visible.offstage == false, 'offstage=false');
  detailLines.add('offstage=true');
