// Comprehensive D4rt test script: DoNothingIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DoNothingIntent script ===');
  ...
  detailLines.add('target=DoNothingIntent');
  ...
  // DoNothingIntent: intent for DoNothingAction
  const DoNothingIntent intent = DoNothingIntent();
  check(intent is DoNothingIntent, 'DoNothingIntent instance created');
  check(intent is Intent, 'DoNothingIntent is an Intent');
  detailLines.add('intentType=' + intent.runtimeType.toString());
  // Use with Actions widget
  final Widget actionsWidget = Actions(
    actions: <Type, Action<Intent>>{DoNothingIntent: DoNothingAction()},
    child: const SizedBox.shrink(),
  );
  check(actionsWidget is Actions, 'Actions with DoNothingIntent mapping created');
