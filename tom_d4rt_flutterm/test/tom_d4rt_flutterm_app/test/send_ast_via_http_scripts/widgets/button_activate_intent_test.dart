// Comprehensive D4rt test script: ButtonActivateIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ButtonActivateIntent script ===');
  ...
  final Type targetType = ButtonActivateIntent;
  ...
  detailLines.add('target=ButtonActivateIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ButtonActivateIntent'), 'Target type symbol resolves');
