// Comprehensive D4rt test script: AndroidViewSurface from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AndroidViewSurface script ===');
  ...
  final Type targetType = AndroidViewSurface;
  ...
  detailLines.add('target=AndroidViewSurface');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AndroidViewSurface'), 'Target type symbol resolves');
