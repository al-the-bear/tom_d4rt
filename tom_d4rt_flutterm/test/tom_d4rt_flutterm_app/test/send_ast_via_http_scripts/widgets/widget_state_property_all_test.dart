// Comprehensive D4rt test script: WidgetStatePropertyAll from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStatePropertyAll script ===');
  ...
  detailLines.add('target=WidgetStatePropertyAll');
  ...
  const String targetTypeName = 'WidgetStatePropertyAll';
  detailLines.add('category=widgets_state');
  detailLines.add('desc=Property resolving to same value for all states');
  final WidgetStatePropertyAll<double> prop = WidgetStatePropertyAll<double>(42.0);
  check(prop.resolve(<WidgetState>{}) == 42.0, 'Resolves to 42');
  check(prop.resolve(<WidgetState>{WidgetState.pressed}) == 42.0, 'Same when pressed');
  detailLines.add('value=42.0');
