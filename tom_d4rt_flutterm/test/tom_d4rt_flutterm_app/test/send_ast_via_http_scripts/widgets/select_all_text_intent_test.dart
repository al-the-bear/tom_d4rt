// Comprehensive D4rt test script: SelectAllTextIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectAllTextIntent script ===');
  ...
  detailLines.add('target=SelectAllTextIntent');
  ...
  const String targetTypeName = 'SelectAllTextIntent';
  check(targetTypeName.contains('SelectAll'), 'Name includes SelectAll');
  detailLines.add('description=Intent to select all text');
  final TextEditingController tec = TextEditingController(text: 'Select all');
  check(tec.text == 'Select all', 'Controller text set');
  tec.dispose();
