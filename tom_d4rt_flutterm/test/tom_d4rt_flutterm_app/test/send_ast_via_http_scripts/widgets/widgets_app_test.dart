// Comprehensive D4rt test script: WidgetsApp from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetsApp script ===');
  ...
  detailLines.add('target=WidgetsApp');
  ...
  final WidgetsApp app = WidgetsApp(color: const Color(0xFF42A5F5), builder: (BuildContext ctx, Widget? child) => const SizedBox());
  check(app is Widget, 'Is Widget');
  check(app.color == const Color(0xFF42A5F5), 'Color');
  detailLines.add('color=0xFF42A5F5');
