// Comprehensive D4rt test script: ScrollActivityDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollActivityDelegate script ===');
  ...
  detailLines.add('target=ScrollActivityDelegate');
  ...
  const String targetTypeName = 'ScrollActivityDelegate';
  check(targetTypeName.contains('Activity'), 'Name includes Activity');
  detailLines.add('description=Delegate for scroll activities');
  final ScrollController sc = ScrollController();
  check(sc is ScrollController, 'ScrollController created');
  sc.dispose();
