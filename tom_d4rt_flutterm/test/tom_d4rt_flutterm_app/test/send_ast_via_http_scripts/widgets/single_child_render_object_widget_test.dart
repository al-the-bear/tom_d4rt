// Comprehensive D4rt test script: SingleChildRenderObjectWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SingleChildRenderObjectWidget script ===');
  ...
  detailLines.add('target=SingleChildRenderObjectWidget');
  ...
  const String targetTypeName = 'SingleChildRenderObjectWidget';
  detailLines.add('category=widgets_render');
  detailLines.add('desc=Base class for widgets with one render child');
  // Opacity extends SingleChildRenderObjectWidget
  const Opacity opacity = Opacity(opacity: 0.5, child: SizedBox());
  check(opacity is SingleChildRenderObjectWidget, 'Opacity is SCROW');
  detailLines.add('example=Opacity');
