// Comprehensive D4rt test script: CheckedModeBanner from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive CheckedModeBanner script ===');
  ...
  final Type targetType = CheckedModeBanner;
  ...
  detailLines.add('target=CheckedModeBanner');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('CheckedModeBanner'), 'Target type symbol resolves');
