// Comprehensive D4rt test script: BouncingScrollPhysics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BouncingScrollPhysics script ===');
  ...
  final Type targetType = BouncingScrollPhysics;
  ...
  detailLines.add('target=BouncingScrollPhysics');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BouncingScrollPhysics'), 'Target type symbol resolves');
