// Comprehensive D4rt test script: OrderedTraversalPolicy from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OrderedTraversalPolicy script ===');
  ...
  detailLines.add('target=OrderedTraversalPolicy');
  ...
  final OrderedTraversalPolicy policy = OrderedTraversalPolicy();
  check(policy is OrderedTraversalPolicy, 'Policy created');
  check(policy is FocusTraversalPolicy, 'Is FocusTraversalPolicy');
  detailLines.add('traversalType=ordered');
