// Comprehensive D4rt test script: SliverPrototypeExtentList from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverPrototypeExtentList script ===');
  ...
  detailLines.add('target=SliverPrototypeExtentList');
  ...
  final SliverPrototypeExtentList list = SliverPrototypeExtentList(prototypeItem: const SizedBox(height: 60), delegate: SliverChildListDelegate(const <Widget>[SizedBox(height: 60), SizedBox(height: 60), SizedBox(height: 60)]));
  check(list is Widget, 'Is Widget');
  check(list.prototypeItem is Widget, 'Has prototype');
  detailLines.add('prototypeHeight=60');
