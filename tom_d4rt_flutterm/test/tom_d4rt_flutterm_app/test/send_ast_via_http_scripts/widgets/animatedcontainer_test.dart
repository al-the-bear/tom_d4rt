  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 8.0),
        Text('Curved (easeInOut):', style: TextStyle(fontWeight: FontWeight.bold)),
        Center(child: curvedAnimated),
        SizedBox(height: 8.0),
        Text('Decorated:', style: TextStyle(fontWeight: FontWeight.bold)),
        Center(child: decoratedAnimated),
        SizedBox(height: 8.0),
        Text('Large (bounceOut):', style: TextStyle(fontWeight: FontWeight.bold)),
        Center(child: largeAnimated),
        SizedBox(height: 8.0),
        Text('Small (elasticOut):', style: TextStyle(fontWeight: FontWeight.bold)),
