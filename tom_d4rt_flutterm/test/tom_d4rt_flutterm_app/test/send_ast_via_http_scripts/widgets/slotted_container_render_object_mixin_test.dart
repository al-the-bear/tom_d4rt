// D4rt comprehensive test script for SlottedContainerRenderObjectMixin
...
class _SlottedContainerRenderObjectMixinProbe
    implements SlottedContainerRenderObjectMixin {
  _SlottedContainerRenderObjectMixinProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _SlottedContainerRenderObjectMixinProbe probe,
...
dynamic build(BuildContext context) {
  print('=== SlottedContainerRenderObjectMixin comprehensive script start ===');

  final _SlottedContainerRenderObjectMixinProbe primary =
      _SlottedContainerRenderObjectMixinProbe('primary', seed: 7);
  final _SlottedContainerRenderObjectMixinProbe edge =
      _SlottedContainerRenderObjectMixinProbe('', seed: -3);
  final _SlottedContainerRenderObjectMixinProbe large =
      _SlottedContainerRenderObjectMixinProbe('large-case', seed: 999);
  ...
  print('=== SlottedContainerRenderObjectMixin comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('SlottedContainerRenderObjectMixin Summary'),
