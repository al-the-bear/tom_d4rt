// Comprehensive D4rt test script: ExtendSelectionByCharacterIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ExtendSelectionByCharacterIntent script ===');
  ...
  detailLines.add('target=ExtendSelectionByCharacterIntent');
  ...
  const String targetTypeName = 'ExtendSelectionByCharacterIntent';
  check(targetTypeName == 'ExtendSelectionByCharacterIntent', 'Target type name set');
  detailLines.add('boundary=character');
