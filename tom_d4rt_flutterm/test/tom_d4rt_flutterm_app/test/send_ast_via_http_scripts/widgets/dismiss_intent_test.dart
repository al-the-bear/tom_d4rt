// Comprehensive D4rt test script: DismissIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DismissIntent script ===');
  ...
  detailLines.add('target=DismissIntent');
  ...
  // DismissIntent: intent to dismiss a Dismissible
  const String targetTypeName = 'DismissIntent';
  check(targetTypeName == 'DismissIntent', 'Target type name set');
  detailLines.add('description=Intent for dismissing a Dismissible widget');
  // DismissIntent is used with the Actions framework
  final Widget actionsWidget = Actions(
    actions: <Type, Action<Intent>>{},
    child: const SizedBox.shrink(),
  );
  check(actionsWidget is Actions, 'Actions widget created for intent context');
  detailLines.add('actionsWidgetCreated=true');
