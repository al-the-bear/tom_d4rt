// Comprehensive D4rt test script: DecorationTween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DecorationTween script ===');
  ...
  final Type targetType = DecorationTween;
  ...
  detailLines.add('target=DecorationTween');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DecorationTween'), 'Target type symbol resolves');
