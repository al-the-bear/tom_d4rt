// Comprehensive D4rt test script: ViewAnchor from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ViewAnchor script ===');
  ...
  detailLines.add('target=ViewAnchor');
  ...
  const String targetTypeName = 'ViewAnchor';
  detailLines.add('category=widgets_view');
  detailLines.add('desc=Anchors a secondary view onto a primary view');
  check(targetTypeName.contains('Anchor'), 'Has Anchor');
