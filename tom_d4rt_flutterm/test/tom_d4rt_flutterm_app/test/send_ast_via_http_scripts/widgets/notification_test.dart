// Comprehensive D4rt test script: Notification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Notification script ===');
  ...
  detailLines.add('target=Notification');
  ...
  // Notification is the base class for all notifications
  final Widget listener = NotificationListener<ScrollNotification>(
    ...
    child: const SingleChildScrollView(child: SizedBox(height: 1000)),
  );
  check(listener is NotificationListener, 'NotificationListener created');
