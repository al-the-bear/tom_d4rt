...
dynamic build(BuildContext context) {
  ...
  runCase('ConnectionState symbol exists', () {
    final Type t = ConnectionState;
    return t.toString().contains('ConnectionState');
  });
