// Comprehensive D4rt test script: PlatformMenu from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformMenu script ===');
  ...
  detailLines.add('target=PlatformMenu');
  ...
  final PlatformMenu menu = PlatformMenu(
    label: 'File',
    menus: const <PlatformMenuItem>[],
  );
  check(menu is PlatformMenu, 'PlatformMenu created');
  check(menu.label == 'File', 'Label is File');
  check(menu is PlatformMenuItem, 'Is a PlatformMenuItem');
  detailLines.add('label=File');
