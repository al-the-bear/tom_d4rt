...
dynamic build(BuildContext context) {
  ...
  final List<RoutePopDisposition> values = RoutePopDisposition.values.toList(growable: false);
  _expect(values.isNotEmpty, 'RoutePopDisposition exposes at least one enum value');
  _expect(
  ...
  final List<RoutePopDisposition> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'RoutePopDisposition checks passed: ${values.length} values validated';
  print(summary);
