// Comprehensive D4rt test script: TextSelectionOverlay from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextSelectionOverlay script ===');
  ...
  detailLines.add('target=TextSelectionOverlay');
  ...
  const String targetTypeName = 'TextSelectionOverlay';
  detailLines.add('category=widgets_text_selection');
  detailLines.add('desc=Overlay for text selection handles and toolbar');
  check(targetTypeName.contains('Overlay'), 'Has Overlay');
