// Comprehensive D4rt test script: AnimatedAlign from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedAlign script ===');
  ...
  final Type targetType = AnimatedAlign;
  ...
  detailLines.add('target=AnimatedAlign');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedAlign'), 'Target type symbol resolves');
