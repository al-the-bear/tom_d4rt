// Comprehensive D4rt test script: WidgetInspector from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetInspector script ===');
  ...
  detailLines.add('target=WidgetInspector');
  ...
  const String inspectorName = 'WidgetInspector';
  check(inspectorName.contains('Inspector'), 'Has Inspector');
  check(inspectorName.contains('Widget'), 'Has Widget');
  check(inspectorName.length > 0, 'Name non-empty');
  detailLines.add('desc=Widget inspection overlay for debugging');
