// Comprehensive D4rt test script: PreviousFocusAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PreviousFocusAction script ===');
  ...
  detailLines.add('target=PreviousFocusAction');
  ...
  final PreviousFocusAction action = PreviousFocusAction();
  check(action is PreviousFocusAction, 'Created');
  check(action is Action<PreviousFocusIntent>, 'Is Action<PreviousFocusIntent>');
  detailLines.add('actionType=PreviousFocusAction');
