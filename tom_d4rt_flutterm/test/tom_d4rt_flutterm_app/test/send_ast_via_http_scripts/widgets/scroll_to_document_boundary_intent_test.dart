// Comprehensive D4rt test script: ScrollToDocumentBoundaryIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollToDocumentBoundaryIntent script ===');
  ...
  detailLines.add('target=ScrollToDocumentBoundaryIntent');
  ...
  const String targetTypeName = 'ScrollToDocumentBoundaryIntent';
  check(targetTypeName.contains('Boundary'), 'Name includes Boundary');
  detailLines.add('description=Intent to scroll to document boundary');
