// Comprehensive D4rt test script: SlottedMultiChildRenderObjectWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SlottedMultiChildRenderObjectWidget script ===');
  ...
  detailLines.add('target=SlottedMultiChildRenderObjectWidget');
  ...
  const String targetTypeName = 'SlottedMultiChildRenderObjectWidget';
  detailLines.add('category=widgets_render');
  detailLines.add('desc=RenderObject widget with named child slots');
  check(targetTypeName.contains('Slotted'), 'Has Slotted');
  check(targetTypeName.contains('MultiChild'), 'Has MultiChild');
