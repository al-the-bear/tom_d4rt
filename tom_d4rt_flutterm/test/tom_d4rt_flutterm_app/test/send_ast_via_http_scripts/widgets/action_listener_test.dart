// Comprehensive D4rt test script: ActionListener from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ActionListener script ===');
  ...
  final Type targetType = ActionListener;
  ...
  detailLines.add('target=ActionListener');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ActionListener'), 'Target type symbol resolves');
