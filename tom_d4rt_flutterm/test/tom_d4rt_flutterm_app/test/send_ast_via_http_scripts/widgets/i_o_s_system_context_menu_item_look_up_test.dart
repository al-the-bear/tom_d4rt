// Comprehensive D4rt test script: IOSSystemContextMenuItemLookUp from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItemLookUp script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItemLookUp');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItemLookUp';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=LookUp');
  detailLines.add('description=iOS system context menu item (LookUp)');
