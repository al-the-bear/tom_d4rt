// Comprehensive D4rt test script: PlatformRouteInformationProvider from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformRouteInformationProvider script ===');
  ...
  detailLines.add('target=PlatformRouteInformationProvider');
  ...
  const String targetTypeName = 'PlatformRouteInformationProvider';
  check(targetTypeName.contains('Route'), 'Name includes Route');
  detailLines.add('description=Provides route info from the platform');
  final Widget router = const Text('Router placeholder');
  check(router is Text, 'Router placeholder created');
