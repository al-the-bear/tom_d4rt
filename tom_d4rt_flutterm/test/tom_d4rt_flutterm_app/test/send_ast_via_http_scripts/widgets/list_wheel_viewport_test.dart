// Comprehensive D4rt test script: ListWheelViewport from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ListWheelViewport script ===');
  ...
  detailLines.add('target=ListWheelViewport');
  ...
  const String targetTypeName = 'ListWheelViewport';
  check(targetTypeName.contains('Viewport'), 'Name includes Viewport');
  detailLines.add('description=Viewport that renders children in a wheel');
  final Widget wheel = ListWheelScrollView(itemExtent: 30, children: const <Widget>[Text('A')]);
  check(wheel is ListWheelScrollView, 'ListWheelScrollView (contains viewport) created');
