// Comprehensive D4rt test script: RelativeRectTween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RelativeRectTween script ===');
  ...
  detailLines.add('target=RelativeRectTween');
  ...
  final RelativeRectTween tween = RelativeRectTween(begin: const RelativeRect.fromLTRB(0, 0, 100, 100), end: const RelativeRect.fromLTRB(50, 50, 50, 50));
  check(tween is RelativeRectTween, 'RelativeRectTween created');
  check(tween is Tween<RelativeRect>, 'Is Tween<RelativeRect>');
