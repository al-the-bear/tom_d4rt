// Comprehensive D4rt test script: DialogWindowController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DialogWindowController script ===');
  ...
  const String targetTypeName = 'DialogWindowController';
  ...
  detailLines.add('target=DialogWindowController');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetTypeName);

  check(targetTypeName == 'DialogWindowController', 'Target type symbol resolves');
