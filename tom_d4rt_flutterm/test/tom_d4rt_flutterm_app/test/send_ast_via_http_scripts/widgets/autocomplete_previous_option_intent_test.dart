// Comprehensive D4rt test script: AutocompletePreviousOptionIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutocompletePreviousOptionIntent script ===');
  ...
  final Type targetType = AutocompletePreviousOptionIntent;
  ...
  detailLines.add('target=AutocompletePreviousOptionIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutocompletePreviousOptionIntent'), 'Target type symbol resolves');
