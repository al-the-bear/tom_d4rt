// Comprehensive D4rt test script: DisableWidgetInspectorScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DisableWidgetInspectorScope script ===');
  ...
  final Type targetType = DisableWidgetInspectorScope;
  ...
  detailLines.add('target=DisableWidgetInspectorScope');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DisableWidgetInspectorScope'), 'Target type symbol resolves');
