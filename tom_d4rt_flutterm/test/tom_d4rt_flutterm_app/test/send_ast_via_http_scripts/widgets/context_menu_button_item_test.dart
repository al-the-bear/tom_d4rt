// Comprehensive D4rt test script: ContextMenuButtonItem from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ContextMenuButtonItem script ===');
  ...
  final Type targetType = ContextMenuButtonItem;
  ...
  detailLines.add('target=ContextMenuButtonItem');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ContextMenuButtonItem'), 'Target type symbol resolves');
