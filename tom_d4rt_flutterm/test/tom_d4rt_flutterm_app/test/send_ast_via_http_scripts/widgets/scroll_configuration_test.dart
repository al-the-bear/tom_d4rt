// Comprehensive D4rt test script: ScrollConfiguration from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollConfiguration script ===');
  ...
  detailLines.add('target=ScrollConfiguration');
  ...
  final Widget config = ScrollConfiguration(behavior: const ScrollBehavior(), child: ListView(children: const <Widget>[Text('A'), Text('B')]));
  check(config is ScrollConfiguration, 'ScrollConfiguration created');
  check(config is Widget, 'Is a Widget');
  detailLines.add('behavior=ScrollBehavior');
