// Comprehensive D4rt test script: TextStyleTween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextStyleTween script ===');
  ...
  detailLines.add('target=TextStyleTween');
  ...
  final TextStyleTween tween = TextStyleTween(begin: const TextStyle(fontSize: 14, color: Color(0xFF000000)), end: const TextStyle(fontSize: 28, color: Color(0xFFFF0000)));
  check(tween is Tween<TextStyle>, 'Is Tween<TextStyle>');
  final TextStyle? mid = tween.lerp(0.5);
  check(mid != null, 'Mid non-null');
  check(mid!.fontSize == 21.0, 'Mid fontSize');
  detailLines.add('begin=14pt, end=28pt');
  detailLines.add('mid=${mid.fontSize}pt');
