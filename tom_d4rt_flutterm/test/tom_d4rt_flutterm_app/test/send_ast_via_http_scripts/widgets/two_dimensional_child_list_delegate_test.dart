// Comprehensive D4rt test script: TwoDimensionalChildListDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalChildListDelegate script ===');
  ...
  detailLines.add('target=TwoDimensionalChildListDelegate');
  ...
  final TwoDimensionalChildListDelegate delegate = TwoDimensionalChildListDelegate(children: <List<Widget>>[<Widget>[const SizedBox(width: 50, height: 50), const SizedBox(width: 50, height: 50)], <Widget>[const SizedBox(width: 50, height: 50), const SizedBox(width: 50, height: 50)]]);
  check(delegate is TwoDimensionalChildDelegate, 'Is TwoDimensionalChildDelegate');
  check(delegate.children.length == 2, 'Has 2 rows');
  detailLines.add('rows=2');
