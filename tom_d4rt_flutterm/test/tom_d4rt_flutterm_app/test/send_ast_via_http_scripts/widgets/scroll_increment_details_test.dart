// Comprehensive D4rt test script: ScrollIncrementDetails from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollIncrementDetails script ===');
  ...
  detailLines.add('target=ScrollIncrementDetails');
  ...
  const String targetTypeName = 'ScrollIncrementDetails';
  check(targetTypeName.contains('Increment'), 'Name includes Increment');
  detailLines.add('description=Details for scroll increment calculation');
