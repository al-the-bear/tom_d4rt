// Comprehensive D4rt test script: DefaultAssetBundle from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DefaultAssetBundle script ===');
  ...
  final Type targetType = DefaultAssetBundle;
  ...
  detailLines.add('target=DefaultAssetBundle');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DefaultAssetBundle'), 'Target type symbol resolves');
