// Comprehensive D4rt test script: AutocompleteFirstOptionIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutocompleteFirstOptionIntent script ===');
  ...
  final Type targetType = AutocompleteFirstOptionIntent;
  ...
  detailLines.add('target=AutocompleteFirstOptionIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutocompleteFirstOptionIntent'), 'Target type symbol resolves');
