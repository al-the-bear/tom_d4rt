...
dynamic build(BuildContext context) {
  ...
  runCase('AutocompleteFirstOptionIntent symbol check', () {
    final Type t = AutocompleteFirstOptionIntent;
    return t.toString().contains('AutocompleteFirstOptionIntent');
  });
  ...
  runCase('AutocompleteFirstOptionIntent const constructor available', () {
    const AutocompleteFirstOptionIntent intent = AutocompleteFirstOptionIntent();
    return intent.runtimeType.toString().contains('AutocompleteFirstOptionIntent');
  });

  runCase('Summary string can be created', () {
    final String summary = 'autocompletefirstoptionintent:'
  ...
  return Column(
    ...
    children: <Widget>[
      const Text(
        'AutocompleteFirstOptionIntent Tests',
