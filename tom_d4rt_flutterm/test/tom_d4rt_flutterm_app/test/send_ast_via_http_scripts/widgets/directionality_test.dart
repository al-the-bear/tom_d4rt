// Comprehensive D4rt test script: Directionality from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Directionality script ===');
  ...
  final Type targetType = Directionality;
  ...
  detailLines.add('target=Directionality');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('Directionality'), 'Target type symbol resolves');
