// Comprehensive D4rt test script: FixedExtentMetrics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive FixedExtentMetrics script ===');
  ...
  detailLines.add('target=FixedExtentMetrics');
  ...
  const String targetTypeName = 'FixedExtentMetrics';
  check(targetTypeName == 'FixedExtentMetrics', 'Target type name set');
  detailLines.add('description=Scroll metrics for fixed-extent scroll views');
  final FixedExtentScrollController ctrl = FixedExtentScrollController(initialItem: 5);
  check(ctrl.initialItem == 5, 'Initial item is 5');
  detailLines.add('initialItem=5');
  ctrl.dispose();
