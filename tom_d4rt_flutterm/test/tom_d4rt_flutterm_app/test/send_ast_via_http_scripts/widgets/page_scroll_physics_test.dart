// Comprehensive D4rt test script: PageScrollPhysics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PageScrollPhysics script ===');
  ...
  detailLines.add('target=PageScrollPhysics');
  ...
  const PageScrollPhysics physics = PageScrollPhysics();
  check(physics is PageScrollPhysics, 'Created');
  check(physics is ScrollPhysics, 'Is ScrollPhysics');
  detailLines.add('physicsType=PageScrollPhysics');
