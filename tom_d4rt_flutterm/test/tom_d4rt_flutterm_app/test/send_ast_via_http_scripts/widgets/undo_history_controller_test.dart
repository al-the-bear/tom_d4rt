// Comprehensive D4rt test script: UndoHistoryController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UndoHistoryController script ===');
  ...
  detailLines.add('target=UndoHistoryController');
  ...
  check(ctrl is UndoHistoryController, 'Created');
  check(ctrl.value.canUndo == false, 'No undo initially');
  check(ctrl.value.canRedo == false, 'No redo initially');
  ctrl.dispose();
  detailLines.add('canUndo=false, canRedo=false');
