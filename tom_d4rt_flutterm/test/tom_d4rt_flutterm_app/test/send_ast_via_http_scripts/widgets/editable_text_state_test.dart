// Comprehensive D4rt test script: EditableTextState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive EditableTextState script ===');
  ...
  detailLines.add('target=EditableTextState');
  ...
  const String targetTypeName = 'EditableTextState';
  check(targetTypeName == 'EditableTextState', 'Target type name set');
  detailLines.add('description=State object for EditableText widget');
  final TextEditingController tec = TextEditingController(text: 'Hello');
  check(tec.text == 'Hello', 'TextEditingController text set');
  detailLines.add('controllerText=' + tec.text);
  tec.dispose();
