// Comprehensive D4rt test script: ListWheelChildListDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ListWheelChildListDelegate script ===');
  ...
  detailLines.add('target=ListWheelChildListDelegate');
  ...
  final ListWheelChildListDelegate delegate = ListWheelChildListDelegate(
