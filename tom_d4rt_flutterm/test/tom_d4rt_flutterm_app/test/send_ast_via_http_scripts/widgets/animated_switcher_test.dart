// Comprehensive D4rt test script: AnimatedSwitcher from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedSwitcher script ===');
  ...
  final Type targetType = AnimatedSwitcher;
  ...
  detailLines.add('target=AnimatedSwitcher');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedSwitcher'), 'Target type symbol resolves');
