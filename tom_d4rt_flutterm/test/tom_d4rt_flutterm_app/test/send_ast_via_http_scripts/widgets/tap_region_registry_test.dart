// Comprehensive D4rt test script: TapRegionRegistry from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TapRegionRegistry script ===');
  ...
  detailLines.add('target=TapRegionRegistry');
  ...
  const String targetTypeName = 'TapRegionRegistry';
  detailLines.add('category=widgets_tap');
  detailLines.add('desc=Registry for tap region groups');
  check(targetTypeName.contains('Registry'), 'Has Registry');
