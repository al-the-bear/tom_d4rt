...
dynamic build(BuildContext context) {
  print(
    '========== ScrollDecelerationRate comprehensive test start ==========',
  );

  final List<ScrollDecelerationRate> values = ScrollDecelerationRate.values
      .toList(growable: false);
  _expect(
    values.isNotEmpty,
    'ScrollDecelerationRate exposes at least one enum value',
  );
  _expect(
  ...
  final List<ScrollDecelerationRate> reversed = values.reversed.toList(
    growable: false,
  );
  ...
  final String summary =
      'ScrollDecelerationRate checks passed: ${values.length} values validated';
  print(summary);
