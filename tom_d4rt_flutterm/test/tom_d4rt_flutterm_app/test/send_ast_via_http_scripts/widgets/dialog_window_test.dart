// Comprehensive D4rt test script: DialogWindow from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DialogWindow script ===');
  ...
  const String targetTypeName = 'DialogWindow';
  ...
  detailLines.add('target=DialogWindow');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetTypeName);

  check(targetTypeName == 'DialogWindow', 'Target type symbol resolves');
