// Comprehensive D4rt test script: DevToolsDeepLinkProperty from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DevToolsDeepLinkProperty script ===');
  ...
  final Type targetType = DevToolsDeepLinkProperty;
  ...
  detailLines.add('target=DevToolsDeepLinkProperty');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DevToolsDeepLinkProperty'), 'Target type symbol resolves');
