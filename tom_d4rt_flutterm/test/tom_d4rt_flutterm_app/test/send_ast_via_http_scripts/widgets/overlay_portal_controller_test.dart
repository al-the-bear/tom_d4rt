// Comprehensive D4rt test script: OverlayPortalController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OverlayPortalController script ===');
  ...
  detailLines.add('target=OverlayPortalController');
  ...
  check(controller is OverlayPortalController, 'Controller created');
  check(!controller.isShowing, 'Not showing initially');
  detailLines.add('isShowing=' + controller.isShowing.toString());
