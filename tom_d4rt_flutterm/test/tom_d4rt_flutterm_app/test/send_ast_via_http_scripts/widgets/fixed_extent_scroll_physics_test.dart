// Comprehensive D4rt test script: FixedExtentScrollPhysics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive FixedExtentScrollPhysics script ===');
  ...
  detailLines.add('target=FixedExtentScrollPhysics');
  ...
  // FixedExtentScrollPhysics: snaps to items
  const FixedExtentScrollPhysics physics = FixedExtentScrollPhysics();
  check(physics is FixedExtentScrollPhysics, 'Physics created');
  check(physics is ScrollPhysics, 'Is ScrollPhysics');
  // Test with parent
  final FixedExtentScrollPhysics withParent = FixedExtentScrollPhysics(parent: const BouncingScrollPhysics());
  check(withParent.parent is BouncingScrollPhysics, 'Parent physics set to bouncing');
  detailLines.add('parentType=' + (withParent.parent?.runtimeType.toString() ?? 'null'));
