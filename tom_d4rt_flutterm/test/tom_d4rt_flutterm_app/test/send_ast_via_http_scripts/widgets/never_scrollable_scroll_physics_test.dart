// Comprehensive D4rt test script: NeverScrollableScrollPhysics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NeverScrollableScrollPhysics script ===');
  ...
  detailLines.add('target=NeverScrollableScrollPhysics');
  ...
  const NeverScrollableScrollPhysics physics = NeverScrollableScrollPhysics();
  check(physics is NeverScrollableScrollPhysics, 'Created');
  check(physics is ScrollPhysics, 'Is ScrollPhysics');
  check(!physics.shouldAcceptUserOffset(FixedScrollMetrics(minScrollExtent: 0, maxScrollExtent: 100, pixels: 50, viewportDimension: 600, axisDirection: AxisDirection.down, devicePixelRatio: 1.0)), 'Does not accept user offset');
  detailLines.add('shouldAcceptUserOffset=false');
