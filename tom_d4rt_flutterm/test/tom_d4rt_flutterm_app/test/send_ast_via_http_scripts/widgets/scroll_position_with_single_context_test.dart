// Comprehensive D4rt test script: ScrollPositionWithSingleContext from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollPositionWithSingleContext script ===');
  ...
  detailLines.add('target=ScrollPositionWithSingleContext');
  ...
  const String targetTypeName = 'ScrollPositionWithSingleContext';
  check(targetTypeName.contains('SingleContext'), 'Name includes SingleContext');
  detailLines.add('description=Scroll position with a single scroll context');
  final ScrollController sc = ScrollController();
  check(sc is ScrollController, 'Controller created');
  sc.dispose();
