// Comprehensive D4rt test script: RawTooltip from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawTooltip script ===');
  ...
  detailLines.add('target=RawTooltip');
  ...
  const String targetTypeName = 'RawTooltip';
  check(targetTypeName.contains('Tooltip'), 'Name includes Tooltip');
  detailLines.add('description=Low-level tooltip widget');
  final Widget tooltip = Tooltip(message: 'Hover me', child: const Text('Target'));
  check(tooltip is Tooltip, 'Tooltip (wraps RawTooltip) created');
  check(tooltip is StatefulWidget, 'Is StatefulWidget');
