// Comprehensive D4rt test script: RouteTransitionRecord from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RouteTransitionRecord script ===');
  ...
  detailLines.add('target=RouteTransitionRecord');
  ...
  const String targetTypeName = 'RouteTransitionRecord';
  check(targetTypeName.contains('Transition'), 'Name includes Transition');
  detailLines.add('description=Record of route transition');
  final Route<void> route = MaterialPageRoute<void>(builder: (BuildContext ctx) => const Text('Page'));
  check(route is MaterialPageRoute, 'MaterialPageRoute created');
