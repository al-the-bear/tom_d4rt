// Comprehensive D4rt test script: EdgeInsetsGeometryTween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive EdgeInsetsGeometryTween script ===');
  ...
  detailLines.add('target=EdgeInsetsGeometryTween');
  ...
  // EdgeInsetsGeometryTween: interpolates EdgeInsetsGeometry
  final EdgeInsetsGeometryTween tween = EdgeInsetsGeometryTween(
    begin: const EdgeInsets.all(0),
    end: const EdgeInsets.all(20),
  );
  check(tween is EdgeInsetsGeometryTween, 'Tween created');
  final EdgeInsetsGeometry? mid = tween.lerp(0.5);
  check(mid != null, 'Lerp at 0.5 returns non-null');
  detailLines.add('midValue=' + mid.toString());
  final EdgeInsetsGeometry? start = tween.lerp(0.0);
  check(start != null, 'Lerp at 0.0 returns non-null');
