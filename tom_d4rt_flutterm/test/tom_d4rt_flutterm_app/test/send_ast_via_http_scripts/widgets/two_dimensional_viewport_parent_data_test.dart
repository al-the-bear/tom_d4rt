// Comprehensive D4rt test script: TwoDimensionalViewportParentData from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalViewportParentData script ===');
  ...
  detailLines.add('target=TwoDimensionalViewportParentData');
  ...
  const String targetTypeName = 'TwoDimensionalViewportParentData';
  detailLines.add('category=widgets_2d');
  detailLines.add('desc=Parent data for children in 2D viewport');
