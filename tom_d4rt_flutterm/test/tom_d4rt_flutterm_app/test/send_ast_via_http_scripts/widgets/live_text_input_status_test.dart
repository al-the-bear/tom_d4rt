...
dynamic build(BuildContext context) {
  ...
  final List<LiveTextInputStatus> values = LiveTextInputStatus.values.toList(growable: false);
  _expect(values.isNotEmpty, 'LiveTextInputStatus exposes at least one enum value');
  _expect(
  ...
  final List<LiveTextInputStatus> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'LiveTextInputStatus checks passed: ${values.length} values validated';
  print(summary);
