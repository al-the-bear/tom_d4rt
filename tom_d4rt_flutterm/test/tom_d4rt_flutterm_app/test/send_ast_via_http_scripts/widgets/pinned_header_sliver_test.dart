// Comprehensive D4rt test script: PinnedHeaderSliver from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PinnedHeaderSliver script ===');
  ...
  detailLines.add('target=PinnedHeaderSliver');
  ...
  final Widget pinned = PinnedHeaderSliver(child: Container(height: 60, color: const Color(0xFF1F2937)));
  check(pinned is PinnedHeaderSliver, 'PinnedHeaderSliver created');
  check(pinned is Widget, 'Is a Widget');
  detailLines.add('type=pinned header');
