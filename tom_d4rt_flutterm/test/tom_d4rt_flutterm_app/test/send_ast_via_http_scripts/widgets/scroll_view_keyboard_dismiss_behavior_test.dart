...
List<String> _collectDiagnostics(
  List<ScrollViewKeyboardDismissBehavior> values,
) {
...
dynamic build(BuildContext context) {
  print(
    '========== ScrollViewKeyboardDismissBehavior comprehensive test start ==========',
  );

  final List<ScrollViewKeyboardDismissBehavior> values =
      ScrollViewKeyboardDismissBehavior.values.toList(growable: false);
  _expect(
    values.isNotEmpty,
    'ScrollViewKeyboardDismissBehavior exposes at least one enum value',
  );
  _expect(
  ...
  final List<ScrollViewKeyboardDismissBehavior> reversed = values.reversed
  ...
  final String summary =
      'ScrollViewKeyboardDismissBehavior checks passed: ${values.length} values validated';
  print(summary);
  print(
    '========== ScrollViewKeyboardDismissBehavior comprehensive test end ==========',
  );
