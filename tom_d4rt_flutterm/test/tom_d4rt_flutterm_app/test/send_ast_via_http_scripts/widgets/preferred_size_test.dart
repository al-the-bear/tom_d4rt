// Comprehensive D4rt test script: PreferredSize from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PreferredSize script ===');
  ...
  detailLines.add('target=PreferredSize');
  ...
  final Widget ps = PreferredSize(
    preferredSize: const Size.fromHeight(56.0),
    child: Container(color: const Color(0xFF1F2937)),
  );
  check(ps is PreferredSize, 'PreferredSize created');
  check(ps is PreferredSizeWidget, 'Is PreferredSizeWidget');
  detailLines.add('preferredHeight=56.0');
