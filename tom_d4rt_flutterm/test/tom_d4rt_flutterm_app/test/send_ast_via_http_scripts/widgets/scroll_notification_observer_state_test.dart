// Comprehensive D4rt test script: ScrollNotificationObserverState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollNotificationObserverState script ===');
  ...
  detailLines.add('target=ScrollNotificationObserverState');
  ...
  const String targetTypeName = 'ScrollNotificationObserverState';
  check(targetTypeName.contains('Observer'), 'Name includes Observer');
  detailLines.add('description=State for ScrollNotificationObserver');
  final Widget observer = ScrollNotificationObserver(child: const SingleChildScrollView(child: SizedBox(height: 2000)));
  check(observer is ScrollNotificationObserver, 'Observer created');
