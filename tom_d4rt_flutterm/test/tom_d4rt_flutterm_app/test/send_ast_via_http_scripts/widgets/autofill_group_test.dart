// Comprehensive D4rt test script: AutofillGroup from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutofillGroup script ===');
  ...
  final Type targetType = AutofillGroup;
  ...
  detailLines.add('target=AutofillGroup');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutofillGroup'), 'Target type symbol resolves');
