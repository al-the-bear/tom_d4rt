// Comprehensive D4rt test script: BorderRadiusTween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BorderRadiusTween script ===');
  ...
  final Type targetType = BorderRadiusTween;
  ...
  detailLines.add('target=BorderRadiusTween');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BorderRadiusTween'), 'Target type symbol resolves');
