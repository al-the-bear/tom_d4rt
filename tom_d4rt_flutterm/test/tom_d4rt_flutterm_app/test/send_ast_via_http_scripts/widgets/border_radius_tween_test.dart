...
dynamic build(BuildContext context) {
  ...
  runCase('BorderRadiusTween symbol exists', () {
    final Type t = BorderRadiusTween;
    return t.toString().contains('BorderRadiusTween');
  });

  runCase('BorderRadiusTween type string stable', () {
    final Type t = BorderRadiusTween;
  ...
  runCase('BorderRadius.circular creates value', () {
    return BorderRadius.circular(4).topLeft.x == 4;
  });

  runCase('Summary string can be generated', () {
    final String summary = 'borderradiustween:'
