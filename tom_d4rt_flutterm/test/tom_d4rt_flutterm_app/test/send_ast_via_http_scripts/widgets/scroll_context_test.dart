// Comprehensive D4rt test script: ScrollContext from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollContext script ===');
  ...
  detailLines.add('target=ScrollContext');
  ...
  const String targetTypeName = 'ScrollContext';
  check(targetTypeName.contains('Context'), 'Name includes Context');
  detailLines.add('description=Interface for scrollable context');
  final Widget scrollable = const SingleChildScrollView(child: SizedBox(height: 1000));
  check(scrollable is SingleChildScrollView, 'SingleChildScrollView created');
