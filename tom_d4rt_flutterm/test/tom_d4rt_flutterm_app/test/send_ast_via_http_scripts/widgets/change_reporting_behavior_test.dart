...
// D4rt comprehensive test script for ChangeReportingBehavior
...
dynamic build(BuildContext context) {
  ...
  print('========== ChangeReportingBehavior comprehensive test ==========' );

  final List<ChangeReportingBehavior> values = ChangeReportingBehavior.values;
  expectCondition(values.isNotEmpty, 'ChangeReportingBehavior.values should not be empty', logs, counters);
  expectCondition(values.length >= 2, 'ChangeReportingBehavior should provide multiple values', logs, counters);

  final ChangeReportingBehavior first = values.first;
  final ChangeReportingBehavior last = values.last;
  ...
  for (final ChangeReportingBehavior value in values) {
    ...
    final ChangeReportingBehavior byName = ChangeReportingBehavior.values.byName(value.name);
  ...
  final List<ChangeReportingBehavior> copied = List<ChangeReportingBehavior>.from(values);
  ...
  final List<ChangeReportingBehavior> reversed = values.reversed.toList(growable: false);
  ...
  final ChangeReportingBehavior edgeByName = ChangeReportingBehavior.values.byName(edgeName);
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Text('ChangeReportingBehavior Comprehensive Tests'),
