...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    values.isNotEmpty,
    'ChangeReportingBehavior.values should not be empty',
    logs,
    counters,
  );
  expectCondition(
    values.length >= 2,
    'ChangeReportingBehavior should provide multiple values',
    logs,
    counters,
  );
  ...
  for (final ChangeReportingBehavior value in values) {
    ...
    final ChangeReportingBehavior byName = ChangeReportingBehavior.values
        .byName(value.name);
    expectCondition(
      byName == value,
  ...
  final List<ChangeReportingBehavior> copied =
      List<ChangeReportingBehavior>.from(values);
  expectCondition(
  ...
  final List<ChangeReportingBehavior> reversed = values.reversed.toList(
    growable: false,
  );
  expectCondition(
    reversed.first == last,
  ...
  final ChangeReportingBehavior edgeByName = ChangeReportingBehavior.values
      .byName(edgeName);
  expectCondition(
