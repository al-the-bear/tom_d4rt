...
dynamic build(BuildContext context) {
  ...
  runCase('AutovalidateMode symbol exists', () {
    final Type t = AutovalidateMode;
    return t.toString().contains('AutovalidateMode');
  });

  runCase('AutovalidateMode type string stable', () {
    final Type t = AutovalidateMode;
  ...
  runCase('AutovalidateMode has always', () {
    return AutovalidateMode.values.contains(AutovalidateMode.always);
  });

  runCase('Summary string can be generated', () {
    final String summary = 'autovalidatemode:'
