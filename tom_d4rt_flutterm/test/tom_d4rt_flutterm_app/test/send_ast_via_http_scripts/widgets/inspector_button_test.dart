// Comprehensive D4rt test script: InspectorButton from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InspectorButton script ===');
  ...
  detailLines.add('target=InspectorButton');
  ...
  const String targetTypeName = 'InspectorButton';
  check(targetTypeName.contains('Inspector'), 'Name includes Inspector');
  detailLines.add('description=Button for the widget inspector overlay');
  final Widget btn = ElevatedButton(onPressed: () {}, child: const Text('Inspect'));
  check(btn is ElevatedButton, 'Inspector-like button created');
