// Comprehensive D4rt test script: RawWebImage from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawWebImage script ===');
  ...
  detailLines.add('target=RawWebImage');
  ...
  const String targetTypeName = 'RawWebImage';
  check(targetTypeName.contains('Image'), 'Name includes Image');
  detailLines.add('description=Web-specific image widget');
  final Widget img = Image.network('https://example.com/img.png', errorBuilder: (BuildContext c, Object e, StackTrace? s) => const Icon(Icons.broken_image));
