// Comprehensive D4rt test script: DefaultTextHeightBehavior from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DefaultTextHeightBehavior script ===');
  ...
  final Type targetType = DefaultTextHeightBehavior;
  ...
  detailLines.add('target=DefaultTextHeightBehavior');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DefaultTextHeightBehavior'), 'Target type symbol resolves');
