...
dynamic build(BuildContext context) {
  ...
  final List<ScrollIncrementType> values = ScrollIncrementType.values.toList(growable: false);
  _expect(values.isNotEmpty, 'ScrollIncrementType exposes at least one enum value');
  _expect(
  ...
  final List<ScrollIncrementType> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'ScrollIncrementType checks passed: ${values.length} values validated';
  print(summary);
