// Comprehensive D4rt test script: PhysicalModel from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PhysicalModel script ===');
  ...
  detailLines.add('target=PhysicalModel');
  ...
  final Widget model = PhysicalModel(
  ...
  check(model is PhysicalModel, 'PhysicalModel created');
  check(model is SingleChildRenderObjectWidget, 'Is SingleChildRenderObjectWidget');
  detailLines.add('elevation=4.0');
