// Comprehensive D4rt test script: MetaData from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MetaData script ===');
  ...
  detailLines.add('target=MetaData');
  ...
  final Widget meta = MetaData(
    metaData: 'custom-data',
    child: const Text('Meta child'),
  );
  check(meta is MetaData, 'MetaData widget created');
  check(meta is SingleChildRenderObjectWidget, 'Is SingleChildRenderObjectWidget');
  detailLines.add('metaData=custom-data');
