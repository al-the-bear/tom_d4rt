...
// D4rt comprehensive test script for InspectorButtonVariant
...
dynamic build(BuildContext context) {
  ...
  print('========== InspectorButtonVariant comprehensive test ==========' );

  final List<InspectorButtonVariant> values = InspectorButtonVariant.values;
  expectCondition(values.isNotEmpty, 'InspectorButtonVariant.values should not be empty', logs, counters);
  expectCondition(values.length >= 2, 'InspectorButtonVariant should provide multiple values', logs, counters);

  final InspectorButtonVariant first = values.first;
  final InspectorButtonVariant last = values.last;
  ...
  for (final InspectorButtonVariant value in values) {
    ...
    final InspectorButtonVariant byName = InspectorButtonVariant.values.byName(value.name);
  ...
  final List<InspectorButtonVariant> copied = List<InspectorButtonVariant>.from(values);
  ...
  final List<InspectorButtonVariant> reversed = values.reversed.toList(growable: false);
  ...
  final InspectorButtonVariant edgeByName = InspectorButtonVariant.values.byName(edgeName);
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Text('InspectorButtonVariant Comprehensive Tests'),
