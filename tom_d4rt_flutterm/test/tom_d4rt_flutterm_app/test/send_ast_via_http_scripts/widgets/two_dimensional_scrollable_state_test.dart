// Comprehensive D4rt test script: TwoDimensionalScrollableState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalScrollableState script ===');
  ...
  detailLines.add('target=TwoDimensionalScrollableState');
  ...
  const String targetTypeName = 'TwoDimensionalScrollableState';
  detailLines.add('category=widgets_2d');
  detailLines.add('desc=State for TwoDimensionalScrollable');
  check(targetTypeName.contains('State'), 'Has State');
