// Comprehensive D4rt test script: MultiChildRenderObjectWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MultiChildRenderObjectWidget script ===');
  ...
  detailLines.add('target=MultiChildRenderObjectWidget');
  ...
  const String targetTypeName = 'MultiChildRenderObjectWidget';
  check(targetTypeName.contains('Widget'), 'Name includes Widget');
  detailLines.add('description=Base for widgets with multiple children creating RenderObjects');
  final Widget stack = Stack(children: const <Widget>[SizedBox(), SizedBox()]);
  check(stack is MultiChildRenderObjectWidget, 'Stack is MultiChildRenderObjectWidget');
  final Widget row = Row(children: const <Widget>[Text('X')]);
  check(row is MultiChildRenderObjectWidget, 'Row is MultiChildRenderObjectWidget');
