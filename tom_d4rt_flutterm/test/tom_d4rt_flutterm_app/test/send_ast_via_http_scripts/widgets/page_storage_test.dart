// Comprehensive D4rt test script: PageStorage from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PageStorage script ===');
  ...
  detailLines.add('target=PageStorage');
  ...
  final Widget storage = PageStorage(bucket: bucket, child: const Text('Stored'));
  check(storage is PageStorage, 'PageStorage created');
  check(storage is Widget, 'Is a Widget');
  detailLines.add('bucketType=' + bucket.runtimeType.toString());
