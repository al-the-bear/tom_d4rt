// Comprehensive D4rt test script: SliverReorderableListState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverReorderableListState script ===');
  ...
  detailLines.add('target=SliverReorderableListState');
  ...
  const String targetTypeName = 'SliverReorderableListState';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=State for SliverReorderableList');
  check(targetTypeName.contains('State'), 'Name has State');
  check(targetTypeName.contains('Reorderable'), 'Name has Reorderable');
