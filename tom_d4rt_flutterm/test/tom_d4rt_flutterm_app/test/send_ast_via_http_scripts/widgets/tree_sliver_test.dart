// Comprehensive D4rt test script: TreeSliver from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TreeSliver script ===');
  ...
  detailLines.add('target=TreeSliver');
  ...
  final TreeSliver<String> tree = TreeSliver<String>(tree: <TreeSliverNode<String>>[TreeSliverNode<String>('A'), TreeSliverNode<String>('B')], treeNodeBuilder: (BuildContext ctx, TreeSliverNode<Object?> node, AnimationStyle anim) { return const SizedBox(height: 40); });
  check(tree is Widget, 'Is Widget');
  detailLines.add('treeNodes=2');
