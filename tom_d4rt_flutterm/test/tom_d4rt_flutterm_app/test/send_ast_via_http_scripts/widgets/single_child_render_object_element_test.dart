// Comprehensive D4rt test script: SingleChildRenderObjectElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SingleChildRenderObjectElement script ===');
  ...
  detailLines.add('target=SingleChildRenderObjectElement');
  ...
  const String targetTypeName = 'SingleChildRenderObjectElement';
  detailLines.add('category=widgets_element');
  detailLines.add('desc=Element for single-child render object widgets');
  check(targetTypeName.contains('Element'), 'Name contains Element');
