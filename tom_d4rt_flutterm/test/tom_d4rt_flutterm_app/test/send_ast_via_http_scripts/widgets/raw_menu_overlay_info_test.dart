// Comprehensive D4rt test script: RawMenuOverlayInfo from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawMenuOverlayInfo script ===');
  ...
  detailLines.add('target=RawMenuOverlayInfo');
  ...
  const String targetTypeName = 'RawMenuOverlayInfo';
  check(targetTypeName.contains('Menu'), 'Name includes Menu');
  detailLines.add('description=Overlay info for raw menus');
  final Widget menuAnchor = MenuAnchor(menuChildren: const <Widget>[MenuItemButton(child: Text('A'))], child: const Text('M'));
  check(menuAnchor is Widget, 'Menu widget created');
