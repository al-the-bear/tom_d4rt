// Comprehensive D4rt test script: OverlayChildLayoutInfo from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OverlayChildLayoutInfo script ===');
  ...
  detailLines.add('target=OverlayChildLayoutInfo');
  ...
  const String targetTypeName = 'OverlayChildLayoutInfo';
  check(targetTypeName.contains('Overlay'), 'Name includes Overlay');
  detailLines.add('description=Layout info for overlay children');
  final Widget overlay = Overlay(initialEntries: const <OverlayEntry>[]);
  check(overlay is Overlay, 'Overlay created');
