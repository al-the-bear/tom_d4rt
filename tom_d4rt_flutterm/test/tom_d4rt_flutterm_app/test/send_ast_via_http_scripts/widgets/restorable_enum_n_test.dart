// Comprehensive D4rt test script: RestorableEnumN from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableEnumN script ===');
  ...
  detailLines.add('target=RestorableEnumN');
  ...
  const String targetTypeName = 'RestorableEnumN';
  check(targetTypeName.contains('Enum'), 'Name includes Enum');
  detailLines.add('description=Restorable nullable enum');
  final RestorableDouble rd = RestorableDouble(0.0);
  check(rd is RestorableProperty, 'RestorableProperty base');
  rd.dispose();
