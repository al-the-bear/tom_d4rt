// Comprehensive D4rt test script: DeviceOrientationBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DeviceOrientationBuilder script ===');
  ...
  final Type targetType = DeviceOrientationBuilder;
  ...
  detailLines.add('target=DeviceOrientationBuilder');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DeviceOrientationBuilder'), 'Target type symbol resolves');
