// Comprehensive D4rt test script: RouteInformation from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RouteInformation script ===');
  ...
  detailLines.add('target=RouteInformation');
  ...
  final RouteInformation info = RouteInformation(uri: Uri.parse('/home'));
  check(info is RouteInformation, 'Created');
  check(info.uri.path == '/home', 'URI path is /home');
  detailLines.add('uri=' + info.uri.toString());
