// Comprehensive D4rt test script: SizeChangedLayoutNotifier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SizeChangedLayoutNotifier script ===');
  ...
  detailLines.add('target=SizeChangedLayoutNotifier');
  ...
  const SizeChangedLayoutNotifier notifier = SizeChangedLayoutNotifier(child: SizedBox(width: 100, height: 100));
  check(notifier is Widget, 'Is Widget');
  check(notifier is SingleChildRenderObjectWidget, 'Is SCROW');
  detailLines.add('desc=Dispatches SizeChangedLayoutNotification');
