// Comprehensive D4rt test script: AnimatedCrossFade from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedCrossFade script ===');
  ...
  final Type targetType = AnimatedCrossFade;
  ...
  detailLines.add('target=AnimatedCrossFade');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedCrossFade'), 'Target type symbol resolves');
