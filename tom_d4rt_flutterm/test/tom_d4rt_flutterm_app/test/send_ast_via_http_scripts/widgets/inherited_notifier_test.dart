// Comprehensive D4rt test script: InheritedNotifier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InheritedNotifier script ===');
  ...
  detailLines.add('target=InheritedNotifier');
  ...
  // InheritedNotifier: rebuilds dependents when Listenable notifies
  final ValueNotifier<int> notifier = ValueNotifier<int>(0);
  check(notifier.value == 0, 'Notifier initial value is 0');
  notifier.value = 42;
  check(notifier.value == 42, 'Notifier value updated to 42');
  detailLines.add('notifierValue=' + notifier.value.toString());
  notifier.dispose();
