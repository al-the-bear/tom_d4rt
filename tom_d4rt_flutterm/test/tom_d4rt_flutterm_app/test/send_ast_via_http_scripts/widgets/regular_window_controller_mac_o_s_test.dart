// Comprehensive D4rt test script: RegularWindowControllerMacOS from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RegularWindowControllerMacOS script ===');
  ...
  detailLines.add('target=RegularWindowControllerMacOS');
  ...
  const String targetTypeName = 'RegularWindowControllerMacOS';
  check(targetTypeName.contains('Window'), 'Name includes Window');
  detailLines.add('description=macOS window controller');
  final Widget scaffold = Scaffold(body: const Center(child: Text('Window')));
  check(scaffold is Scaffold, 'Scaffold created');
