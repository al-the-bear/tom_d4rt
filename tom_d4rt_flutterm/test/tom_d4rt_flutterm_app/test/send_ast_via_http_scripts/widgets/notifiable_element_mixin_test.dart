// D4rt comprehensive test script for NotifiableElementMixin
...
class _NotifiableElementMixinProbe implements NotifiableElementMixin {
  _NotifiableElementMixinProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _NotifiableElementMixinProbe probe,
...
dynamic build(BuildContext context) {
  print('=== NotifiableElementMixin comprehensive script start ===');

  final _NotifiableElementMixinProbe primary = _NotifiableElementMixinProbe(
    'primary',
    seed: 7,
  );
  final _NotifiableElementMixinProbe edge = _NotifiableElementMixinProbe(
    '',
    seed: -3,
  );
  final _NotifiableElementMixinProbe large = _NotifiableElementMixinProbe(
    'large-case',
    seed: 999,
  );
  ...
  print('=== NotifiableElementMixin comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('NotifiableElementMixin Summary'),
