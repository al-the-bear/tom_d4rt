// Comprehensive D4rt test script: SystemContextMenu from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SystemContextMenu script ===');
  ...
  detailLines.add('target=SystemContextMenu');
  ...
  const String targetTypeName = 'SystemContextMenu';
  detailLines.add('category=widgets_menu');
  detailLines.add('desc=System-provided context menu');
  check(targetTypeName.contains('System'), 'Has System');
  check(targetTypeName.contains('Context'), 'Has Context');
