// Comprehensive D4rt test script: AndroidView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AndroidView script ===');
  ...
  final Type targetType = AndroidView;
  ...
  detailLines.add('target=AndroidView');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AndroidView'), 'Target type symbol resolves');
