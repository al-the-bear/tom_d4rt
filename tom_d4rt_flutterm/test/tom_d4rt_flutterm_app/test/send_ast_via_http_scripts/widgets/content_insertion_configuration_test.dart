// Comprehensive D4rt test script: ContentInsertionConfiguration from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ContentInsertionConfiguration script ===');
  ...
  final Type targetType = ContentInsertionConfiguration;
  ...
  detailLines.add('target=ContentInsertionConfiguration');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ContentInsertionConfiguration'), 'Target type symbol resolves');
