// Comprehensive D4rt test script: StretchEffect from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive StretchEffect script ===');
  ...
  detailLines.add('target=StretchEffect');
  ...
  const String targetTypeName = 'StretchEffect';
  detailLines.add('category=widgets_scroll');
  detailLines.add('desc=Visual stretch effect during overscroll');
  check(targetTypeName.contains('Stretch'), 'Has Stretch');
