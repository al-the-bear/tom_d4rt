// Comprehensive D4rt test script: BackdropFilter from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BackdropFilter script ===');
  ...
  final Type targetType = BackdropFilter;
  ...
  detailLines.add('target=BackdropFilter');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BackdropFilter'), 'Target type symbol resolves');
