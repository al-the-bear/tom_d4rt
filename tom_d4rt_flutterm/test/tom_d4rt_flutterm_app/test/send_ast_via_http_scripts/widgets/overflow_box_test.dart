// Comprehensive D4rt test script: OverflowBox from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OverflowBox script ===');
  ...
  detailLines.add('target=OverflowBox');
  ...
  final Widget box = OverflowBox(
    maxWidth: 500,
    maxHeight: 500,
    child: Container(width: 300, height: 300, color: const Color(0xFF3B82F6)),
  );
  check(box is OverflowBox, 'OverflowBox created');
  check(box is SingleChildRenderObjectWidget, 'Is SingleChildRenderObjectWidget');
  detailLines.add('maxWidth=500');
