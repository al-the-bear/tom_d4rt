// Comprehensive D4rt test script: AnimatedFractionallySizedBox from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedFractionallySizedBox script ===');
  ...
  final Type targetType = AnimatedFractionallySizedBox;
  ...
  detailLines.add('target=AnimatedFractionallySizedBox');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedFractionallySizedBox'), 'Target type symbol resolves');
