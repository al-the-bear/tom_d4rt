// Comprehensive D4rt test script: RawScrollbarState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawScrollbarState script ===');
  ...
  detailLines.add('target=RawScrollbarState');
  ...
  const String targetTypeName = 'RawScrollbarState';
  check(targetTypeName.contains('Scrollbar'), 'Name includes Scrollbar');
  detailLines.add('description=State for RawScrollbar');
  final Widget scrollbar = RawScrollbar(child: const SingleChildScrollView(child: SizedBox(height: 2000, child: Text('Content'))));
  check(scrollbar is RawScrollbar, 'RawScrollbar created');
