// Comprehensive D4rt test script: LookupBoundary from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive LookupBoundary script ===');
  ...
  detailLines.add('target=LookupBoundary');
  ...
  final Widget boundary = LookupBoundary(child: const Text('Bounded'));
  check(boundary is LookupBoundary, 'LookupBoundary created');
  check(boundary is Widget, 'LookupBoundary is a Widget');
  detailLines.add('description=Prevents ancestor lookups from crossing');
