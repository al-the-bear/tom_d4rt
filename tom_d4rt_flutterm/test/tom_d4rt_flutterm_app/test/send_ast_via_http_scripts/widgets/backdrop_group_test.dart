// Comprehensive D4rt test script: BackdropGroup from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BackdropGroup script ===');
  ...
  final Type targetType = BackdropGroup;
  ...
  detailLines.add('target=BackdropGroup');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BackdropGroup'), 'Target type symbol resolves');
