// Comprehensive D4rt test script: InheritedWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InheritedWidget script ===');
  ...
  detailLines.add('target=InheritedWidget');
  ...
  // InheritedWidget: base for widgets that propagate info down
  final ThemeData theme = Theme.of(context);
  check(theme is ThemeData, 'Theme (InheritedWidget) resolved');
  final MediaQueryData mq = MediaQuery.of(context);
  check(mq.size.width > 0 || mq.size.width == 0, 'MediaQuery (InheritedWidget) resolved');
  detailLines.add('screenWidth=' + mq.size.width.toString());
  detailLines.add('screenHeight=' + mq.size.height.toString());
