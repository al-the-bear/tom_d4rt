// Comprehensive D4rt test script: AnimatedScale from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedScale script ===');
  ...
  final Type targetType = AnimatedScale;
  ...
  detailLines.add('target=AnimatedScale');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedScale'), 'Target type symbol resolves');
