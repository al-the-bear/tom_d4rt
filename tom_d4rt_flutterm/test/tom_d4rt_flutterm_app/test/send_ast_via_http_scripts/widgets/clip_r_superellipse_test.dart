// Comprehensive D4rt test script: ClipRSuperellipse from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ClipRSuperellipse script ===');
  ...
  final Type targetType = ClipRSuperellipse;
  ...
  detailLines.add('target=ClipRSuperellipse');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ClipRSuperellipse'), 'Target type symbol resolves');
