// Comprehensive D4rt test script: EditableTextTapOutsideIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive EditableTextTapOutsideIntent script ===');
  ...
  detailLines.add('target=EditableTextTapOutsideIntent');
  ...
  const String targetTypeName = 'EditableTextTapOutsideIntent';
  check(targetTypeName == 'EditableTextTapOutsideIntent', 'Target type name set');
  detailLines.add('description=EditableTextTapOutsideIntent for text field tap outside handling');
