// Comprehensive D4rt test script: KeepAliveNotification from widgets
...
dynamic build(BuildContext context) {
  ...
  detailLines.add('target=KeepAliveNotification');
  ...
  // KeepAliveNotification: notification to keep a sliver child alive
