// Comprehensive D4rt test script: TextMagnifierConfiguration from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextMagnifierConfiguration script ===');
  ...
  detailLines.add('target=TextMagnifierConfiguration');
  ...
  const String targetTypeName = 'TextMagnifierConfiguration';
  detailLines.add('category=widgets_text');
  detailLines.add('desc=Configuration for text magnifier');
