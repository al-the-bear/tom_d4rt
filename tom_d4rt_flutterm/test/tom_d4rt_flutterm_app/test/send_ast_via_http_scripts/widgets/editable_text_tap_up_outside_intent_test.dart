// Comprehensive D4rt test script: EditableTextTapUpOutsideIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive EditableTextTapUpOutsideIntent script ===');
  ...
  detailLines.add('target=EditableTextTapUpOutsideIntent');
  ...
  const String targetTypeName = 'EditableTextTapUpOutsideIntent';
  check(targetTypeName == 'EditableTextTapUpOutsideIntent', 'Target type name set');
  detailLines.add('description=EditableTextTapUpOutsideIntent for text field tap outside handling');
  final TextEditingController tec = TextEditingController(text: 'Test');
  final Widget textField = TextField(controller: tec);
  check(textField is TextField, 'TextField created for tap outside intent');
  tec.dispose();
