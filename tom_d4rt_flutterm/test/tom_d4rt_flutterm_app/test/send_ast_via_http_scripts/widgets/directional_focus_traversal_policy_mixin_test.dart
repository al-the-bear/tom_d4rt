...
class _DirectionalFocusTraversalPolicyMixinProbe implements DirectionalFocusTraversalPolicyMixin {
...
dynamic build(BuildContext context) {
  print('=== DirectionalFocusTraversalPolicyMixin comprehensive script start ===');

  final _DirectionalFocusTraversalPolicyMixinProbe primary = _DirectionalFocusTraversalPolicyMixinProbe('primary', seed: 7);
  final _DirectionalFocusTraversalPolicyMixinProbe edge = _DirectionalFocusTraversalPolicyMixinProbe('', seed: -3);
  final _DirectionalFocusTraversalPolicyMixinProbe large = _DirectionalFocusTraversalPolicyMixinProbe('large-case', seed: 999);
  ...
  print('=== DirectionalFocusTraversalPolicyMixin comprehensive script done ===');
