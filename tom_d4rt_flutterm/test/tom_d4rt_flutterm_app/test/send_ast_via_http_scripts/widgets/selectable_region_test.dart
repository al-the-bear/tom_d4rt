// Comprehensive D4rt test script: SelectableRegion from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectableRegion script ===');
  ...
  detailLines.add('target=SelectableRegion');
  ...
  const String targetTypeName = 'SelectableRegion';
  check(targetTypeName.contains('Region'), 'Name includes Region');
  detailLines.add('description=Region that supports text selection');
  final Widget text = const SelectableText('Selectable region test');
  check(text is SelectableText, 'SelectableText (uses SelectableRegion) created');
