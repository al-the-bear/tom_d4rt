// Comprehensive D4rt test script: NumericFocusOrder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NumericFocusOrder script ===');
  ...
  detailLines.add('target=NumericFocusOrder');
  ...
  const NumericFocusOrder order3 = NumericFocusOrder(1.0);
  check(order1 is FocusOrder, 'Is FocusOrder');
  check(order1.compareTo(order2) < 0, '1.0 < 2.0');
  check(order1.compareTo(order3) == 0, '1.0 == 1.0');
