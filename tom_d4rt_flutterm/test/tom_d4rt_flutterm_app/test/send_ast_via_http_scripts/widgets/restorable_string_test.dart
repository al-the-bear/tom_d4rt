// Comprehensive D4rt test script: RestorableString from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableString script ===');
  ...
  detailLines.add('target=RestorableString');
  ...
  final RestorableString prop = RestorableString('hello');
  check(prop is RestorableString, 'Created');
  check(prop.value == 'hello', 'Value is hello');
  detailLines.add('value=' + prop.value);
  prop.dispose();
