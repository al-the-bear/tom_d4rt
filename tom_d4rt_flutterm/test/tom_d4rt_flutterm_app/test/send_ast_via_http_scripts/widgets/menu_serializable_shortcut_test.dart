...
dynamic build(BuildContext context) {
  ...
  final _MenuSerializableShortcutProbe primary = _MenuSerializableShortcutProbe('primary', seed: 7);
  final _MenuSerializableShortcutProbe edge = _MenuSerializableShortcutProbe('', seed: -3);
  final _MenuSerializableShortcutProbe large = _MenuSerializableShortcutProbe('large-case', seed: 999);
