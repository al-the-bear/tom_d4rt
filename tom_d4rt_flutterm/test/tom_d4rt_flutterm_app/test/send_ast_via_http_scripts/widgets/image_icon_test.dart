// Comprehensive D4rt test script: ImageIcon from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ImageIcon script ===');
  ...
  detailLines.add('target=ImageIcon');
  ...
  // ImageIcon: icon from an ImageProvider
  final Widget icon = ImageIcon(
    const AssetImage('assets/icon.png'),
    size: 48.0,
    color: const Color(0xFF10B981),
  );
  check(icon is ImageIcon, 'ImageIcon created');
  check(icon is Widget, 'ImageIcon is a Widget');
  detailLines.add('size=48.0');
  detailLines.add('color=0xFF10B981');
