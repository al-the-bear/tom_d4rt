// Comprehensive D4rt test script: OverscrollNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OverscrollNotification script ===');
  ...
  detailLines.add('target=OverscrollNotification');
  ...
  final Widget listener = NotificationListener<OverscrollNotification>(
    onNotification: (OverscrollNotification n) {
      print('overscroll=' + n.overscroll.toString());
      return true;
    },
    child: const SingleChildScrollView(child: SizedBox(height: 2000)),
  );
  check(listener is NotificationListener, 'OverscrollNotification listener created');
