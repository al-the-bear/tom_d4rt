// Comprehensive D4rt test script: ClampingScrollSimulation from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ClampingScrollSimulation script ===');
  ...
  final Type targetType = ClampingScrollSimulation;
  ...
  detailLines.add('target=ClampingScrollSimulation');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ClampingScrollSimulation'), 'Target type symbol resolves');
