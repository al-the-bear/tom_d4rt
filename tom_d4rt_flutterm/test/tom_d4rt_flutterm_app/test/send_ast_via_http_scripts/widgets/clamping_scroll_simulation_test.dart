...
dynamic build(BuildContext context) {
  ...
  runCase('ClampingScrollSimulation symbol exists', () {
    final Type t = ClampingScrollSimulation;
    return t.toString().contains('ClampingScrollSimulation');
  });
  ...
  runCase('Summary string can be generated', () {
    final String summary = 'clampingscrollsimulation:'
  ...
  return Column(
    ...
    children: <Widget>[
      const Text(
        'ClampingScrollSimulation Tests',
