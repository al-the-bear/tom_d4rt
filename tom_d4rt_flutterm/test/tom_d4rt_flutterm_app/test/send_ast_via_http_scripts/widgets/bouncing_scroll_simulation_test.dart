...
dynamic build(BuildContext context) {
  ...
  runCase('BouncingScrollSimulation symbol exists', () {
    final Type t = BouncingScrollSimulation;
    return t.toString().contains('BouncingScrollSimulation');
  });

  runCase('BouncingScrollSimulation type string stable', () {
    final Type t = BouncingScrollSimulation;
  ...
  runCase('ScrollSpringSimulation symbol exists', () {
    final Type t = ScrollSpringSimulation;
    return t.toString().contains('ScrollSpringSimulation');
  });

  runCase('Summary string can be generated', () {
    final String summary = 'bouncingscrollsimulation:'
  ...
  return Column(
    ...
    children: <Widget>[
      const Text(
        'BouncingScrollSimulation Tests',
