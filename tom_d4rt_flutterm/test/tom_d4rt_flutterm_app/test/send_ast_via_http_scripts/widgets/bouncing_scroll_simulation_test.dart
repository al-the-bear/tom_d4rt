// Comprehensive D4rt test script: BouncingScrollSimulation from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BouncingScrollSimulation script ===');
  ...
  final Type targetType = BouncingScrollSimulation;
  ...
  detailLines.add('target=BouncingScrollSimulation');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BouncingScrollSimulation'), 'Target type symbol resolves');
