// Comprehensive D4rt test script: ListWheelElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ListWheelElement script ===');
  ...
  detailLines.add('target=ListWheelElement');
  ...
  const String targetTypeName = 'ListWheelElement';
  check(targetTypeName.contains('Element'), 'Name includes Element');
  detailLines.add('description=Element for ListWheelViewport');
  final Widget wheel = ListWheelScrollView(itemExtent: 50, children: const <Widget>[Text('1'), Text('2')]);
  check(wheel is ListWheelScrollView, 'ListWheelScrollView created');
