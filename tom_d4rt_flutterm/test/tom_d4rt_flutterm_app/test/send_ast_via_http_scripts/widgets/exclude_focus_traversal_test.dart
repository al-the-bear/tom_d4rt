// Comprehensive D4rt test script: ExcludeFocusTraversal from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ExcludeFocusTraversal script ===');
  ...
  detailLines.add('target=ExcludeFocusTraversal');
  ...
  const String targetTypeName = 'ExcludeFocusTraversal';
  check(targetTypeName.contains('Focus'), 'Name includes Focus');
  detailLines.add('description=Excludes widget from focus traversal');
  final Widget focusScope = FocusScope(child: const Text('Traversal test'));
  check(focusScope is FocusScope, 'FocusScope created');
