// Comprehensive D4rt test script: ComponentElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ComponentElement script ===');
  ...
  final Type targetType = ComponentElement;
  ...
  detailLines.add('target=ComponentElement');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ComponentElement'), 'Target type symbol resolves');
