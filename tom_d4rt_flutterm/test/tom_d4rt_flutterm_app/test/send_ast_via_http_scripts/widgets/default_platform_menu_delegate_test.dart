// Comprehensive D4rt test script: DefaultPlatformMenuDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DefaultPlatformMenuDelegate script ===');
  ...
  final Type targetType = DefaultPlatformMenuDelegate;
  ...
  detailLines.add('target=DefaultPlatformMenuDelegate');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DefaultPlatformMenuDelegate'), 'Target type symbol resolves');
