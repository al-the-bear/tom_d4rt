...
dynamic build(BuildContext context) {
  ...
  final List<OverflowBarAlignment> values = OverflowBarAlignment.values.toList(growable: false);
  _expect(values.isNotEmpty, 'OverflowBarAlignment exposes at least one enum value');
  _expect(
  ...
  final List<OverflowBarAlignment> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'OverflowBarAlignment checks passed: ${values.length} values validated';
  print(summary);
