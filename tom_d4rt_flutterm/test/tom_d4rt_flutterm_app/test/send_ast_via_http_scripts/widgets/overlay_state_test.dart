// Comprehensive D4rt test script: OverlayState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OverlayState script ===');
  ...
  detailLines.add('target=OverlayState');
  ...
  const String targetTypeName = 'OverlayState';
  check(targetTypeName.contains('State'), 'Name includes State');
  detailLines.add('description=State for Overlay widget');
  final Widget overlay = Overlay(initialEntries: const <OverlayEntry>[]);
  check(overlay is Overlay, 'Overlay widget created');
