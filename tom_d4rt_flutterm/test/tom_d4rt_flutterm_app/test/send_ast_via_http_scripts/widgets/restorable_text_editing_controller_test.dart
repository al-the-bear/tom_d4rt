// Comprehensive D4rt test script: RestorableTextEditingController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableTextEditingController script ===');
  ...
  detailLines.add('target=RestorableTextEditingController');
  ...
  final RestorableTextEditingController rc = RestorableTextEditingController(text: 'Restorable');
  check(rc is RestorableTextEditingController, 'Created');
  check(rc is RestorableChangeNotifier, 'Is RestorableChangeNotifier');
  check(rc.value.text == 'Restorable', 'Controller text set');
  detailLines.add('text=' + rc.value.text);
  rc.dispose();
