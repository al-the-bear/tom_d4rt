// Comprehensive D4rt test script: RangeMaintainingScrollPhysics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RangeMaintainingScrollPhysics script ===');
  ...
  detailLines.add('target=RangeMaintainingScrollPhysics');
  ...
  const RangeMaintainingScrollPhysics physics = RangeMaintainingScrollPhysics();
  check(physics is RangeMaintainingScrollPhysics, 'Created');
  check(physics is ScrollPhysics, 'Is ScrollPhysics');
  detailLines.add('physicsType=RangeMaintaining');
