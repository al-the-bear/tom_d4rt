// Comprehensive D4rt test script: DoNothingAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DoNothingAction script ===');
  ...
  detailLines.add('target=DoNothingAction');
  ...
  // DoNothingAction: an action that does nothing
  final DoNothingAction action = DoNothingAction();
  check(action is DoNothingAction, 'DoNothingAction created');
  check(action is Action, 'DoNothingAction is an Action');
  check(!action.consumesKey(const DoNothingIntent()), 'consumesKey false by default');
  detailLines.add('consumesKey=' + action.consumesKey(const DoNothingIntent()).toString());
  // With consumesKey true
  final DoNothingAction action2 = DoNothingAction(consumesKey: true);
  check(action2.consumesKey(const DoNothingIntent()), 'consumesKey true when set');
