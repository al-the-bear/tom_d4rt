...
dynamic build(BuildContext context) {
  ...
  check(
    !action.consumesKey(const DoNothingIntent()),
    'consumesKey false by default',
  );
  detailLines.add(
    'consumesKey=' + action.consumesKey(const DoNothingIntent()).toString(),
  );
  // With consumesKey true
  final DoNothingAction action2 = DoNothingAction(consumesKey: true);
  check(
    action2.consumesKey(const DoNothingIntent()),
    'consumesKey true when set',
  );
