// Comprehensive D4rt test script: BorderTween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BorderTween script ===');
  ...
  final Type targetType = BorderTween;
  ...
  detailLines.add('target=BorderTween');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BorderTween'), 'Target type symbol resolves');
