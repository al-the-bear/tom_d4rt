// Comprehensive D4rt test script: AnimatedRotation from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedRotation script ===');
  ...
  final Type targetType = AnimatedRotation;
  ...
  detailLines.add('target=AnimatedRotation');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedRotation'), 'Target type symbol resolves');
