// Comprehensive D4rt test script: EmptyTextSelectionControls from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive EmptyTextSelectionControls script ===');
  ...
  detailLines.add('target=EmptyTextSelectionControls');
  ...
  const String targetTypeName = 'EmptyTextSelectionControls';
  check(targetTypeName.contains('Selection'), 'Name includes Selection');
  detailLines.add('description=TextSelectionControls that builds empty widgets');
  final Widget textField = const TextField();
  check(textField is TextField, 'TextField that can use selection controls created');
