// Comprehensive D4rt test script: DefaultTextStyleTransition from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DefaultTextStyleTransition script ===');
  ...
  final Type targetType = DefaultTextStyleTransition;
  ...
  detailLines.add('target=DefaultTextStyleTransition');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DefaultTextStyleTransition'), 'Target type symbol resolves');
