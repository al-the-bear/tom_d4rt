// Comprehensive D4rt test script: PreferredSizeWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PreferredSizeWidget script ===');
  ...
  detailLines.add('target=PreferredSizeWidget');
  ...
  const String targetTypeName = 'PreferredSizeWidget';
  check(targetTypeName.contains('Size'), 'Name includes Size');
  detailLines.add('description=Interface for widgets with a preferred size');
  final AppBar appBar = AppBar(title: const Text('Title'));
  check(appBar is PreferredSizeWidget, 'AppBar is PreferredSizeWidget');
  detailLines.add('appBarPreferredHeight=' + appBar.preferredSize.height.toString());
