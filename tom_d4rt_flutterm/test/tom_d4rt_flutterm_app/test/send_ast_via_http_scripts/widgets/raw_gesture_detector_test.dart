// Comprehensive D4rt test script: RawGestureDetector from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawGestureDetector script ===');
  ...
  detailLines.add('target=RawGestureDetector');
  ...
  final Widget gd = RawGestureDetector(
    gestures: const <Type, GestureRecognizerFactory>{},
    child: const Text('Raw gesture'),
  );
  check(gd is RawGestureDetector, 'RawGestureDetector created');
  check(gd is StatefulWidget, 'Is StatefulWidget');
