// Comprehensive D4rt test script: PlatformMenuDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformMenuDelegate script ===');
  ...
  detailLines.add('target=PlatformMenuDelegate');
  ...
  const String targetTypeName = 'PlatformMenuDelegate';
  check(targetTypeName.contains('Delegate'), 'Name includes Delegate');
  detailLines.add('description=Abstract delegate for platform menus');
