// Comprehensive D4rt test script: AnimatedPositionedDirectional from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedPositionedDirectional script ===');
  ...
  final Type targetType = AnimatedPositionedDirectional;
  ...
  detailLines.add('target=AnimatedPositionedDirectional');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedPositionedDirectional'), 'Target type symbol resolves');
