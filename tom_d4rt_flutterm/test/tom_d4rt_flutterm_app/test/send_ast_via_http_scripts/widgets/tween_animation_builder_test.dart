// Comprehensive D4rt test script: TweenAnimationBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TweenAnimationBuilder script ===');
  ...
  detailLines.add('target=TweenAnimationBuilder');
  ...
  final TweenAnimationBuilder<double> builder = TweenAnimationBuilder<double>(tween: Tween<double>(begin: 0, end: 1), duration: const Duration(seconds: 1), builder: (BuildContext ctx, double val, Widget? child) { return Opacity(opacity: val, child: child); }, child: const SizedBox(width: 100, height: 100));
  check(builder is Widget, 'Is Widget');
  detailLines.add('tween=0->1');
  detailLines.add('duration=1s');
