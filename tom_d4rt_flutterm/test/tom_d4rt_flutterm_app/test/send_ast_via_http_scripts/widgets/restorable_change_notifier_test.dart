// Comprehensive D4rt test script: RestorableChangeNotifier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableChangeNotifier script ===');
  ...
  detailLines.add('target=RestorableChangeNotifier');
  ...
  const String targetTypeName = 'RestorableChangeNotifier';
  check(targetTypeName.contains('ChangeNotifier'), 'Name includes ChangeNotifier');
  detailLines.add('description=Base for restorable change notifiers');
  final RestorableTextEditingController rc = RestorableTextEditingController(text: 'test');
  check(rc is RestorableChangeNotifier, 'RestorableTextEditingController is RestorableChangeNotifier');
  rc.dispose();
