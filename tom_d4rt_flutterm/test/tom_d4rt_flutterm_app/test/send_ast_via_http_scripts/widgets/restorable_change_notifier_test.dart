...
dynamic build(BuildContext context) {
  ...
  check(
    targetTypeName.contains('ChangeNotifier'),
    'Name includes ChangeNotifier',
  );
  detailLines.add('description=Base for restorable change notifiers');
  final RestorableTextEditingController rc = RestorableTextEditingController(
    text: 'test',
  );
  check(
    rc is RestorableChangeNotifier,
    'RestorableTextEditingController is RestorableChangeNotifier',
  );
  rc.dispose();
