// Comprehensive D4rt test script: AutocompleteNextPageOptionIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutocompleteNextPageOptionIntent script ===');
  ...
  final Type targetType = AutocompleteNextPageOptionIntent;
  ...
  detailLines.add('target=AutocompleteNextPageOptionIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutocompleteNextPageOptionIntent'), 'Target type symbol resolves');
