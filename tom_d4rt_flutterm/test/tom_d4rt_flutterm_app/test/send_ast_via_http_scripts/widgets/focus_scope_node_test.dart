// Comprehensive D4rt test script: FocusScopeNode from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive FocusScopeNode script ===');
  ...
  detailLines.add('target=FocusScopeNode');
  ...
  // FocusScopeNode: defines a focus scope in the tree
  final FocusScopeNode scopeNode = FocusScopeNode(debugLabel: 'test-scope');
  check(scopeNode is FocusScopeNode, 'FocusScopeNode created');
  check(scopeNode is FocusNode, 'FocusScopeNode is a FocusNode');
  check(scopeNode.debugLabel == 'test-scope', 'Debug label set');
  detailLines.add('isFirstFocus=' + scopeNode.isFirstFocus.toString());
  scopeNode.dispose();
