// Comprehensive D4rt test script: PredictiveBackRoute from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PredictiveBackRoute script ===');
  ...
  detailLines.add('target=PredictiveBackRoute');
  ...
  const String targetTypeName = 'PredictiveBackRoute';
  check(targetTypeName.contains('Back'), 'Name includes Back');
  detailLines.add('description=Route mixin for predictive back gestures');
