// Comprehensive D4rt test script: TableRow from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TableRow script ===');
  ...
  detailLines.add('target=TableRow');
  ...
  final TableRow row = TableRow(children: <Widget>[Container(height: 40, color: const Color(0xFF42A5F5)), Container(height: 40, color: const Color(0xFFEF5350)), Container(height: 40, color: const Color(0xFF66BB6A))]);
  check(row.children.length == 3, 'Has 3 children');
