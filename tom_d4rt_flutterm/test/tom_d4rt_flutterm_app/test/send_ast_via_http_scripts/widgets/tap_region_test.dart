// Comprehensive D4rt test script: TapRegion from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TapRegion script ===');
  ...
  detailLines.add('target=TapRegion');
  ...
  final TapRegion region = TapRegion(onTapOutside: (PointerDownEvent e) {}, child: const SizedBox(width: 80, height: 80));
  check(region is Widget, 'Is Widget');
  check(region.onTapOutside != null, 'Has onTapOutside');
  detailLines.add('desc=Detects taps outside this region');
