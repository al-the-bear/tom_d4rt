// Comprehensive D4rt test script: RawMenuAnchor from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawMenuAnchor script ===');
  ...
  detailLines.add('target=RawMenuAnchor');
  ...
  const String targetTypeName = 'RawMenuAnchor';
  check(targetTypeName.contains('Menu'), 'Name includes Menu');
  detailLines.add('description=Low-level menu anchor widget');
  final Widget anchor = MenuAnchor(menuChildren: const <Widget>[MenuItemButton(child: Text('Item'))], child: const Text('Menu'));
  check(anchor is MenuAnchor, 'MenuAnchor (wraps RawMenuAnchor) created');
