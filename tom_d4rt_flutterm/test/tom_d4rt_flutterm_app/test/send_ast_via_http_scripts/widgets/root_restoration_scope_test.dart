// Comprehensive D4rt test script: RootRestorationScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RootRestorationScope script ===');
  ...
  detailLines.add('target=RootRestorationScope');
  ...
  final Widget scope = RootRestorationScope(restorationId: 'root', child: const Text('Restored'));
  check(scope is RootRestorationScope, 'Created');
  check(scope is Widget, 'Is a Widget');
  detailLines.add('restorationId=root');
