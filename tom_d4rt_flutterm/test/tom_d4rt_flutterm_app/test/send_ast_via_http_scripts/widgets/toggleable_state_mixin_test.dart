// D4rt comprehensive test script for ToggleableStateMixin
...
class _ToggleableStateMixinProbe implements ToggleableStateMixin {
  _ToggleableStateMixinProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _ToggleableStateMixinProbe probe,
...
dynamic build(BuildContext context) {
  print('=== ToggleableStateMixin comprehensive script start ===');

  final _ToggleableStateMixinProbe primary = _ToggleableStateMixinProbe(
    'primary',
    seed: 7,
  );
  final _ToggleableStateMixinProbe edge = _ToggleableStateMixinProbe(
    '',
    seed: -3,
  );
  final _ToggleableStateMixinProbe large = _ToggleableStateMixinProbe(
    'large-case',
    seed: 999,
  );
  ...
  print('=== ToggleableStateMixin comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('ToggleableStateMixin Summary'),
