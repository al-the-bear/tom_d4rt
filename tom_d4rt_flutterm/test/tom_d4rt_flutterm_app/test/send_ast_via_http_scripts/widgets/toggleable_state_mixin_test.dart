...
dynamic build(BuildContext context) {
  ...
  final _ToggleableStateMixinProbe primary = _ToggleableStateMixinProbe('primary', seed: 7);
  final _ToggleableStateMixinProbe edge = _ToggleableStateMixinProbe('', seed: -3);
  final _ToggleableStateMixinProbe large = _ToggleableStateMixinProbe('large-case', seed: 999);
