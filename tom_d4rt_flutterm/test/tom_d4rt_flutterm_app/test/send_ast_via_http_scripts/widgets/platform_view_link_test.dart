// Comprehensive D4rt test script: PlatformViewLink from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformViewLink script ===');
  ...
  detailLines.add('target=PlatformViewLink');
  ...
  const String targetTypeName = 'PlatformViewLink';
  check(targetTypeName.contains('Link'), 'Name includes Link');
  detailLines.add('description=Widget that links a platform view to the widget tree');
