// Comprehensive D4rt test script: IOSSystemContextMenuItemCopy from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItemCopy script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItemCopy');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItemCopy';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=Copy');
  detailLines.add('description=iOS system context menu item (Copy)');
