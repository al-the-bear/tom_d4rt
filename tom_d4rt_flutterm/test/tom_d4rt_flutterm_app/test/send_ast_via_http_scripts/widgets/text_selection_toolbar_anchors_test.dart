// Comprehensive D4rt test script: TextSelectionToolbarAnchors from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextSelectionToolbarAnchors script ===');
  ...
  detailLines.add('target=TextSelectionToolbarAnchors');
  ...
  const String targetTypeName = 'TextSelectionToolbarAnchors';
  detailLines.add('category=widgets_text_selection');
  detailLines.add('desc=Anchor positions for text selection toolbar');
  check(targetTypeName.contains('Toolbar'), 'Has Toolbar');
  check(targetTypeName.contains('Anchors'), 'Has Anchors');
