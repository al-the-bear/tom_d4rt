// Comprehensive D4rt test script: DraggableScrollableController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DraggableScrollableController script ===');
  ...
  detailLines.add('target=DraggableScrollableController');
  ...
  // DraggableScrollableController: controls DraggableScrollableSheet
  final DraggableScrollableController controller = DraggableScrollableController();
  check(controller is DraggableScrollableController, 'Controller created');
  check(controller is ChangeNotifier, 'Controller is a ChangeNotifier');
  detailLines.add('controllerType=' + controller.runtimeType.toString());
  controller.dispose();
  detailLines.add('controllerDisposed=true');
