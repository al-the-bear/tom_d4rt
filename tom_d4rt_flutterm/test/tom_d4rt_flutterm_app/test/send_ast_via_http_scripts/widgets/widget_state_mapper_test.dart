// Comprehensive D4rt test script: WidgetStateMapper from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStateMapper script ===');
  ...
  detailLines.add('target=WidgetStateMapper');
  ...
  const String targetTypeName = 'WidgetStateMapper';
  detailLines.add('category=widgets_state');
  detailLines.add('desc=Maps widget states to values');
  check(targetTypeName.contains('Mapper'), 'Has Mapper');
