...
dynamic build(BuildContext context) {
  print(
    '=== Running comprehensive ExtendSelectionToNextWordBoundaryOrCaretLocationIntent script ===',
  );
  ...
  detailLines.add(
    'target=ExtendSelectionToNextWordBoundaryOrCaretLocationIntent',
  );
  ...
  const String targetTypeName =
      'ExtendSelectionToNextWordBoundaryOrCaretLocationIntent';
  check(
    targetTypeName == 'ExtendSelectionToNextWordBoundaryOrCaretLocationIntent',
