// Comprehensive D4rt test script: WindowingOwnerLinux from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WindowingOwnerLinux script ===');
  ...
  detailLines.add('target=WindowingOwnerLinux');
  ...
  const String targetTypeName = 'WindowingOwnerLinux';
  detailLines.add('category=widgets_window');
  detailLines.add('desc=Linux windowing owner implementation');
  check(targetTypeName.contains('Linux'), 'Has Linux');
