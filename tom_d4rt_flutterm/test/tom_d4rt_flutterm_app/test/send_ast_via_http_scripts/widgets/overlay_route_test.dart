// Comprehensive D4rt test script: OverlayRoute from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OverlayRoute script ===');
  ...
  detailLines.add('target=OverlayRoute');
  ...
  const String targetTypeName = 'OverlayRoute';
  check(targetTypeName.contains('Route'), 'Name includes Route');
  detailLines.add('description=Abstract route that provides overlay entries');
  final Route<void> pageRoute = MaterialPageRoute<void>(builder: (BuildContext ctx) => const Text('Page'));
  check(pageRoute is OverlayRoute, 'MaterialPageRoute is an OverlayRoute');
