// Comprehensive D4rt test script: TransitionRoute from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TransitionRoute script ===');
  ...
  detailLines.add('target=TransitionRoute');
  ...
  const String targetTypeName = 'TransitionRoute';
  detailLines.add('category=widgets_navigation');
  detailLines.add('desc=Route with animated transitions');
  check(targetTypeName.contains('Route'), 'Has Route');
