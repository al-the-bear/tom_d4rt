// Comprehensive D4rt test script: UndoHistoryState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UndoHistoryState script ===');
  ...
  detailLines.add('target=UndoHistoryState');
  ...
  const String targetTypeName = 'UndoHistoryState';
  detailLines.add('category=widgets_undo');
  detailLines.add('desc=State for UndoHistory widget');
