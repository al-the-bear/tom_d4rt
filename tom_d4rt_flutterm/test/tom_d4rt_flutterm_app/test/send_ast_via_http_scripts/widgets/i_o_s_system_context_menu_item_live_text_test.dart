// Comprehensive D4rt test script: IOSSystemContextMenuItemLiveText from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItemLiveText script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItemLiveText');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItemLiveText';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=LiveText');
  detailLines.add('description=iOS system context menu item (LiveText)');
