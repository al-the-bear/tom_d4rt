// Comprehensive D4rt test script: DeleteToLineBreakIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DeleteToLineBreakIntent script ===');
  ...
  final Type targetType = DeleteToLineBreakIntent;
  ...
  detailLines.add('target=DeleteToLineBreakIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DeleteToLineBreakIntent'), 'Target type symbol resolves');
