// Comprehensive D4rt test script: LexicalFocusOrder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive LexicalFocusOrder script ===');
  ...
  detailLines.add('target=LexicalFocusOrder');
  ...
  const LexicalFocusOrder order1 = LexicalFocusOrder('a');
  const LexicalFocusOrder order2 = LexicalFocusOrder('b');
  check(order1 is FocusOrder, 'LexicalFocusOrder is a FocusOrder');
  check(order1.compareTo(order2) < 0, 'a < b in lexical order');
  check(order2.compareTo(order1) > 0, 'b > a in lexical order');
  detailLines.add('order1=a, order2=b');
