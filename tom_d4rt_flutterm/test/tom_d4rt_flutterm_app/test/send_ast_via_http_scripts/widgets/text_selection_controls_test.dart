// Comprehensive D4rt test script: TextSelectionControls from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextSelectionControls script ===');
  ...
  detailLines.add('target=TextSelectionControls');
  ...
  const String targetTypeName = 'TextSelectionControls';
  detailLines.add('category=widgets_text_selection');
  detailLines.add('desc=Abstract class for text selection handle controls');
  check(targetTypeName.contains('Selection'), 'Has Selection');
  check(targetTypeName.contains('Controls'), 'Has Controls');
