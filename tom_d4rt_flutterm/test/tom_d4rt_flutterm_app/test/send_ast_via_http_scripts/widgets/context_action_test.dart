// Comprehensive D4rt test script: ContextAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ContextAction script ===');
  ...
  final Type targetType = ContextAction;
  ...
  detailLines.add('target=ContextAction');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ContextAction'), 'Target type symbol resolves');
