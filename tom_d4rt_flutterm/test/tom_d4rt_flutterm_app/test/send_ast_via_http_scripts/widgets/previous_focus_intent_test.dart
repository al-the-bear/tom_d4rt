// Comprehensive D4rt test script: PreviousFocusIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PreviousFocusIntent script ===');
  ...
  detailLines.add('target=PreviousFocusIntent');
  ...
  const PreviousFocusIntent intent = PreviousFocusIntent();
  check(intent is PreviousFocusIntent, 'Created');
  check(intent is Intent, 'Is Intent');
  detailLines.add('intentType=PreviousFocusIntent');
