...
dynamic build(BuildContext context) {
  ...
  runCase('CapturedThemes symbol exists', () {
    final Type t = CapturedThemes;
    return t.toString().contains('CapturedThemes');
  });

  runCase('CapturedThemes type string stable', () {
    final Type t = CapturedThemes;
  ...
  runCase('Theme symbol exists', () {
    final Type t = Theme;
    return t.toString().contains('Theme');
  });

  runCase('Summary string can be generated', () {
    final String summary = 'capturedthemes:'
