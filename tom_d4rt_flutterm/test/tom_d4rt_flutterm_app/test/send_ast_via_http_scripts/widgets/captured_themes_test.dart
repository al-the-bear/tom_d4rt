// Comprehensive D4rt test script: CapturedThemes from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive CapturedThemes script ===');
  ...
  final Type targetType = CapturedThemes;
  ...
  detailLines.add('target=CapturedThemes');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('CapturedThemes'), 'Target type symbol resolves');
