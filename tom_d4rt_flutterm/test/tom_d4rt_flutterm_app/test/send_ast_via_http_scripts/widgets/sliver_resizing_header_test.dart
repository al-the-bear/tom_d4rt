// Comprehensive D4rt test script: SliverResizingHeader from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverResizingHeader script ===');
  ...
  detailLines.add('target=SliverResizingHeader');
  ...
  const String targetTypeName = 'SliverResizingHeader';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=A sliver that resizes its child based on scroll position');
  check(targetTypeName.contains('Resizing'), 'Name has Resizing');
  check(targetTypeName.contains('Header'), 'Name has Header');
