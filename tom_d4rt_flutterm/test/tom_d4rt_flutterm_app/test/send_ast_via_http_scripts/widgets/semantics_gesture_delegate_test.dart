// Comprehensive D4rt test script: SemanticsGestureDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SemanticsGestureDelegate script ===');
  ...
  detailLines.add('target=SemanticsGestureDelegate');
  ...
  const String targetTypeName = 'SemanticsGestureDelegate';
  check(targetTypeName.contains('Semantics'), 'Name includes Semantics');
  detailLines.add('description=Delegate for semantics gestures');
  final Widget semantics = Semantics(label: 'test', child: const Text('Gesture'));
  check(semantics is Semantics, 'Semantics widget created');
