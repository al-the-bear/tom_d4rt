// Comprehensive D4rt test script: WillPopScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WillPopScope script ===');
  ...
  detailLines.add('target=WillPopScope');
  ...
  final WillPopScope wps = WillPopScope(onWillPop: () async => true, child: const SizedBox());
  check(wps is Widget, 'Is Widget');
  check(wps.onWillPop != null, 'Has onWillPop');
  detailLines.add('desc=Deprecated - use PopScope instead');
