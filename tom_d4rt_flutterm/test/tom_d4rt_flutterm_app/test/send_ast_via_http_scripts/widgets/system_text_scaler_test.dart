// Comprehensive D4rt test script: SystemTextScaler from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SystemTextScaler script ===');
  ...
  detailLines.add('target=SystemTextScaler');
  ...
  const String targetTypeName = 'SystemTextScaler';
  detailLines.add('category=widgets_text');
  detailLines.add('desc=Uses system text scale factor');
  // TextScaler.linear is concrete
  const TextScaler scaler = TextScaler.linear(1.5);
  check(scaler.scale(14.0) == 21.0, 'Scale 14 by 1.5');
  check(scaler.scale(10.0) == 15.0, 'Scale 10 by 1.5');
  detailLines.add('scaleFactor=1.5');
