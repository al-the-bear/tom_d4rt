// Comprehensive D4rt test script: ContextMenuController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ContextMenuController script ===');
  ...
  final Type targetType = ContextMenuController;
  ...
  detailLines.add('target=ContextMenuController');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ContextMenuController'), 'Target type symbol resolves');
