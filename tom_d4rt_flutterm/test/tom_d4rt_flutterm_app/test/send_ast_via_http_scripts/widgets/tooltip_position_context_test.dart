// Comprehensive D4rt test script: TooltipPositionContext from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TooltipPositionContext script ===');
  ...
  detailLines.add('target=TooltipPositionContext');
  ...
  const String targetTypeName = 'TooltipPositionContext';
  detailLines.add('category=widgets_tooltip');
  detailLines.add('desc=Position context for tooltip placement');
  check(targetTypeName.contains('Tooltip'), 'Has Tooltip');
