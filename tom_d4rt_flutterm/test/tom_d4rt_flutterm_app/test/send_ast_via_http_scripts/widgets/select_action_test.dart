// Comprehensive D4rt test script: SelectAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectAction script ===');
  ...
  detailLines.add('target=SelectAction');
  ...
  const String targetTypeName = 'SelectAction';
  check(targetTypeName.contains('Select'), 'Name includes Select');
  detailLines.add('description=Action for select intent');
