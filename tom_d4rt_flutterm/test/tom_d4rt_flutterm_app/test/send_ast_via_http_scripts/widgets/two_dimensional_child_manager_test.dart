// Comprehensive D4rt test script: TwoDimensionalChildManager from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalChildManager script ===');
  ...
  detailLines.add('target=TwoDimensionalChildManager');
  ...
  const String targetTypeName = 'TwoDimensionalChildManager';
  detailLines.add('category=widgets_2d');
  detailLines.add('desc=Manages child creation for 2D viewports');
  check(targetTypeName.contains('Manager'), 'Has Manager');
