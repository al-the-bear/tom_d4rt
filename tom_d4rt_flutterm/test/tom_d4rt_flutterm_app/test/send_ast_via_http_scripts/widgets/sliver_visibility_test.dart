// Comprehensive D4rt test script: SliverVisibility from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverVisibility script ===');
  ...
  detailLines.add('target=SliverVisibility');
  ...
  const SliverVisibility vis = SliverVisibility(visible: true, sliver: SliverToBoxAdapter(child: SizedBox(height: 60)));
  check(vis is Widget, 'Is Widget');
  check(vis.visible == true, 'Visible');
  const SliverVisibility hidden = SliverVisibility(visible: false, sliver: SliverToBoxAdapter(child: SizedBox(height: 60)));
  check(hidden.visible == false, 'Hidden');
  detailLines.add('visible=true,false');
