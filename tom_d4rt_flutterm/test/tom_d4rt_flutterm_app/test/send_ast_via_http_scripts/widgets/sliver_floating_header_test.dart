// Comprehensive D4rt test script: SliverFloatingHeader from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverFloatingHeader script ===');
  ...
  detailLines.add('target=SliverFloatingHeader');
  ...
  const SliverFloatingHeader header = SliverFloatingHeader(child: SizedBox(height: 56, child: Center(child: Text('Floating Header'))));
  check(header is Widget, 'Is Widget');
  detailLines.add('desc=Floating header in sliver list');
