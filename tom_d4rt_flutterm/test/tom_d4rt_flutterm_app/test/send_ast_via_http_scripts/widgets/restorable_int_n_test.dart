// Comprehensive D4rt test script: RestorableIntN from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableIntN script ===');
  ...
  detailLines.add('target=RestorableIntN');
  ...
  final RestorableIntN prop = RestorableIntN(null);
  check(prop is RestorableIntN, 'Created');
