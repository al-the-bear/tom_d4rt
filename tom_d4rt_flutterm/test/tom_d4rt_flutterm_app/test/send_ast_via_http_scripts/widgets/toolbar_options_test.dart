// Comprehensive D4rt test script: ToolbarOptions from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ToolbarOptions script ===');
  ...
  detailLines.add('target=ToolbarOptions');
  ...
  const String targetTypeName = 'ToolbarOptions';
  detailLines.add('category=widgets_toolbar');
  detailLines.add('desc=Deprecated toolbar configuration options');
