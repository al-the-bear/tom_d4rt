// Comprehensive D4rt test script: SliverSafeArea from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverSafeArea script ===');
  ...
  detailLines.add('target=SliverSafeArea');
  ...
  const SliverSafeArea safe = SliverSafeArea(sliver: SliverToBoxAdapter(child: SizedBox(height: 100)));
  check(safe is Widget, 'Is Widget');
  check(safe.sliver is Widget, 'Has sliver');
  detailLines.add('desc=Applies safe area padding to a sliver');
