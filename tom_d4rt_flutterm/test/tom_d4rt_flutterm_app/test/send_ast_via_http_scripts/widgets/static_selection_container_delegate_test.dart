// Comprehensive D4rt test script: StaticSelectionContainerDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive StaticSelectionContainerDelegate script ===');
  ...
  detailLines.add('target=StaticSelectionContainerDelegate');
  ...
  const String targetTypeName = 'StaticSelectionContainerDelegate';
  detailLines.add('category=widgets_selection');
  detailLines.add('desc=Static delegate for selection containers');
  check(targetTypeName.contains('Selection'), 'Has Selection');
