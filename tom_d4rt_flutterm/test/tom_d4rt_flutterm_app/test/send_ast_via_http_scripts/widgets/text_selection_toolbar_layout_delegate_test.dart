// Comprehensive D4rt test script: TextSelectionToolbarLayoutDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextSelectionToolbarLayoutDelegate script ===');
  ...
  detailLines.add('target=TextSelectionToolbarLayoutDelegate');
  ...
  const String targetTypeName = 'TextSelectionToolbarLayoutDelegate';
  detailLines.add('category=widgets_text_selection');
  detailLines.add('desc=Layout delegate for toolbar positioning');
  check(targetTypeName.contains('Layout'), 'Has Layout');
