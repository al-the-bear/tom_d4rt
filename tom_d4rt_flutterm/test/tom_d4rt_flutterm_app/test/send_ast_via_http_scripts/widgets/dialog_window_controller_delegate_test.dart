...
class _DialogWindowControllerDelegateProbe
    implements DialogWindowControllerDelegate {
...
dynamic build(BuildContext context) {
  ...
  final _DialogWindowControllerDelegateProbe primary =
      _DialogWindowControllerDelegateProbe('primary', seed: 7);
  final _DialogWindowControllerDelegateProbe edge =
      _DialogWindowControllerDelegateProbe('', seed: -3);
  final _DialogWindowControllerDelegateProbe large =
      _DialogWindowControllerDelegateProbe('large-case', seed: 999);
