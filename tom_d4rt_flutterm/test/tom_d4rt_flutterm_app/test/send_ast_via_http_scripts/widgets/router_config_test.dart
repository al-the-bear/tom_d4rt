// Comprehensive D4rt test script: RouterConfig from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RouterConfig script ===');
  ...
  detailLines.add('target=RouterConfig');
  ...
  const String targetTypeName = 'RouterConfig';
  check(targetTypeName.contains('Router'), 'Name includes Router');
  detailLines.add('description=Configuration for Router widget');
  final Widget app = MaterialApp(home: const Text('Router'));
  check(app is MaterialApp, 'MaterialApp created');
