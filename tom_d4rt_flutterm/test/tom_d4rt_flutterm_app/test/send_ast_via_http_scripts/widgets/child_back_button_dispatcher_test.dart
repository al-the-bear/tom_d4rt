// Comprehensive D4rt test script: ChildBackButtonDispatcher from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ChildBackButtonDispatcher script ===');
  ...
  final Type targetType = ChildBackButtonDispatcher;
  ...
  detailLines.add('target=ChildBackButtonDispatcher');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ChildBackButtonDispatcher'), 'Target type symbol resolves');
