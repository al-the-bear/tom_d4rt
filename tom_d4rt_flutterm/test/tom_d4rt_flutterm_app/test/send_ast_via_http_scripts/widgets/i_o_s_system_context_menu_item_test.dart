// Comprehensive D4rt test script: IOSSystemContextMenuItem from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItem script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItem');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItem';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=Base');
  detailLines.add('description=iOS system context menu item (Base)');
