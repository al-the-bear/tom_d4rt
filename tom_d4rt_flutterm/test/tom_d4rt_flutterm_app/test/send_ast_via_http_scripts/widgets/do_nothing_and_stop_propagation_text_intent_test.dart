// Comprehensive D4rt test script: DoNothingAndStopPropagationTextIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DoNothingAndStopPropagationTextIntent script ===');
  ...
  detailLines.add('target=DoNothingAndStopPropagationTextIntent');
  ...
  const String targetTypeName = 'DoNothingAndStopPropagationTextIntent';
  check(targetTypeName.contains('TextIntent'), 'Intent name includes TextIntent');
  detailLines.add('description=Text-specific do nothing + stop propagation');
  final Widget textField = const TextField();
  check(textField is TextField, 'TextField can use text intents');
