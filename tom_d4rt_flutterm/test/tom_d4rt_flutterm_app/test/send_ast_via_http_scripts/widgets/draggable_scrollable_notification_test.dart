// Comprehensive D4rt test script: DraggableScrollableNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DraggableScrollableNotification script ===');
  ...
  detailLines.add('target=DraggableScrollableNotification');
  ...
  // DraggableScrollableNotification: notifies about sheet changes
  final Widget listener = NotificationListener<DraggableScrollableNotification>(
    onNotification: (DraggableScrollableNotification n) {
      print('extent=' + n.extent.toString());
      return true;
    },
    child: const SizedBox.shrink(),
  );
  check(listener is NotificationListener, 'Notification listener created');
