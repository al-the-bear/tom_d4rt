// Comprehensive D4rt test script: ModalBarrier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ModalBarrier script ===');
  ...
  detailLines.add('target=ModalBarrier');
  ...
  final Widget barrier = ModalBarrier(
    color: const Color(0x80000000),
    dismissible: true,
  );
  check(barrier is ModalBarrier, 'ModalBarrier created');
  check(barrier is Widget, 'ModalBarrier is a Widget');
  detailLines.add('dismissible=true');
  detailLines.add('color=0x80000000');
