// Comprehensive D4rt test script: ShrinkWrappingViewport from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShrinkWrappingViewport script ===');
  ...
  detailLines.add('target=ShrinkWrappingViewport');
  ...
  // ShrinkWrappingViewport requires rendering import
  final ShrinkWrappingViewport viewport = ShrinkWrappingViewport(offset: ViewportOffset.zero(), slivers: <Widget>[const SliverToBoxAdapter(child: SizedBox(height: 100))]);
  check(viewport is Widget, 'Is Widget');
  detailLines.add('sliverCount=1');
