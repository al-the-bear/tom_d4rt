// Comprehensive D4rt test script: View from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive View script ===');
  ...
  const String targetTypeName = 'View';
  detailLines.add('category=widgets_view');
  detailLines.add('desc=Core view widget for rendering');
  // View.of(context) gives the FlutterView
  final ui.FlutterView flView = View.of(context);
  check(flView is ui.FlutterView, 'Got FlutterView');
  check(flView.devicePixelRatio > 0, 'DPR > 0');
  detailLines.add('dpr=\${flView.devicePixelRatio}');
