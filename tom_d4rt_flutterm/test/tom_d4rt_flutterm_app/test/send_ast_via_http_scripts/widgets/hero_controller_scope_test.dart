// Comprehensive D4rt test script: HeroControllerScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive HeroControllerScope script ===');
  ...
  detailLines.add('target=HeroControllerScope');
  ...
  // HeroControllerScope: provides hero controller to descendants
  final HeroController hc = HeroController();
  final Widget scope = HeroControllerScope(
    controller: hc,
    child: const Text('Hero scope'),
  );
  check(scope is HeroControllerScope, 'HeroControllerScope created');
  check(scope is Widget, 'HeroControllerScope is a Widget');
