  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Text('Opacity 0.0 (transparent):', style: TextStyle(fontWeight: FontWeight.bold)),
        Container(
        ...
        opacity50,
        SizedBox(height: 8.0),
        Text('Opacity 1.0 (visible):', style: TextStyle(fontWeight: FontWeight.bold)),
        opacity100,
        SizedBox(height: 8.0),
        Text('Long duration (1000ms):', style: TextStyle(fontWeight: FontWeight.bold)),
        longDuration,
        SizedBox(height: 8.0),
        Text('With easeInOut curve:', style: TextStyle(fontWeight: FontWeight.bold)),
        withCurve,
        SizedBox(height: 8.0),
        Text('With bounceIn curve:', style: TextStyle(fontWeight: FontWeight.bold)),
        withBounceCurve,
        SizedBox(height: 8.0),
        Text('With onEnd callback:', style: TextStyle(fontWeight: FontWeight.bold)),
        withOnEnd,
        SizedBox(height: 8.0),
        Text('With decelerate curve:', style: TextStyle(fontWeight: FontWeight.bold)),
        withDecelerate,
        SizedBox(height: 16.0),
