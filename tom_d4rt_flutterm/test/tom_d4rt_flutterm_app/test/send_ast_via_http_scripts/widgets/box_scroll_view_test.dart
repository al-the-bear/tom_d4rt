// Comprehensive D4rt test script: BoxScrollView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BoxScrollView script ===');
  ...
  final Type targetType = BoxScrollView;
  ...
  detailLines.add('target=BoxScrollView');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BoxScrollView'), 'Target type symbol resolves');
