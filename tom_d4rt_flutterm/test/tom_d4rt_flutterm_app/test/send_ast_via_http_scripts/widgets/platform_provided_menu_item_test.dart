// Comprehensive D4rt test script: PlatformProvidedMenuItem from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformProvidedMenuItem script ===');
  ...
  detailLines.add('target=PlatformProvidedMenuItem');
  ...
  final PlatformProvidedMenuItem item = PlatformProvidedMenuItem(
    type: PlatformProvidedMenuItemType.quit,
  );
  check(item is PlatformProvidedMenuItem, 'Created');
  check(item is PlatformMenuItem, 'Is PlatformMenuItem');
  detailLines.add('type=quit');
