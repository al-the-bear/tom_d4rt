// Comprehensive D4rt test script: ScrollNotificationObserver from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollNotificationObserver script ===');
  ...
  detailLines.add('target=ScrollNotificationObserver');
  ...
  final Widget observer = ScrollNotificationObserver(child: ListView(children: List<Widget>.generate(50, (int i) => Text('Item \$i'))));
  check(observer is ScrollNotificationObserver, 'Created');
  check(observer is Widget, 'Is a Widget');
