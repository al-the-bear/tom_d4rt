// Comprehensive D4rt test script: InheritedElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InheritedElement script ===');
  ...
  detailLines.add('target=InheritedElement');
  ...
  detailLines.add('contextType=' + context.runtimeType.toString());
  // Theme is an InheritedWidget; its element is an InheritedElement
  final ThemeData theme = Theme.of(context);
  check(theme is ThemeData, 'Theme.of(context) works - InheritedElement resolved');
  detailLines.add('brightness=' + theme.brightness.toString());
