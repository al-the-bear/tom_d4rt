// Comprehensive D4rt test script: SnapshotPainter from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SnapshotPainter script ===');
  ...
  detailLines.add('target=SnapshotPainter');
  ...
  const String targetTypeName = 'SnapshotPainter';
  detailLines.add('category=widgets_snapshot');
  detailLines.add('desc=Abstract painter for snapshot widgets');
  check(targetTypeName.contains('Painter'), 'Has Painter');
