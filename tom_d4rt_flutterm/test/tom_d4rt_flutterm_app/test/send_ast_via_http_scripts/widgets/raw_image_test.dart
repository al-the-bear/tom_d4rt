// Comprehensive D4rt test script: RawImage from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawImage script ===');
  ...
  detailLines.add('target=RawImage');
  ...
  final Widget img = RawImage(width: 200, height: 200, scale: 1.0);
  check(img is RawImage, 'RawImage created');
  check(img is Widget, 'Is a Widget');
  detailLines.add('width=200');
