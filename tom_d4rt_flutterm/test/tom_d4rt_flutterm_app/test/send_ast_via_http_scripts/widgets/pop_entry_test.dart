// Comprehensive D4rt test script: PopEntry from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopEntry script ===');
  ...
  detailLines.add('target=PopEntry');
  ...
  const String targetTypeName = 'PopEntry';
  check(targetTypeName.contains('Pop'), 'Name includes Pop');
  detailLines.add('description=Entry for pop scope handling');
  final Widget popScope = PopScope(canPop: false, child: const Text('Cannot pop'));
  check(popScope is PopScope, 'PopScope created');
