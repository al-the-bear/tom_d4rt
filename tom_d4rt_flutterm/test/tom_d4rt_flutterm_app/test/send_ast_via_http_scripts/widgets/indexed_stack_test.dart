// Comprehensive D4rt test script: IndexedStack from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IndexedStack script ===');
  ...
  detailLines.add('target=IndexedStack');
  ...
  final Widget iStack = IndexedStack(
    index: 1,
    children: const <Widget>[Text('Page 0'), Text('Page 1'), Text('Page 2')],
  );
  check(iStack is IndexedStack, 'IndexedStack created');
  check(iStack is Stack, 'IndexedStack is a Stack');
  detailLines.add('index=1');
