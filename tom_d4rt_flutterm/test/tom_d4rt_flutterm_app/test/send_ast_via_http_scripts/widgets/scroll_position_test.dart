// Comprehensive D4rt test script: ScrollPosition from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollPosition script ===');
  ...
  detailLines.add('target=ScrollPosition');
  ...
  const String targetTypeName = 'ScrollPosition';
  check(targetTypeName.contains('Position'), 'Name includes Position');
  detailLines.add('description=Stores scroll position information');
  final ScrollController sc = ScrollController(initialScrollOffset: 100);
  check(sc.initialScrollOffset == 100, 'Initial offset is 100');
  sc.dispose();
