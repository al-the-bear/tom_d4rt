...
dynamic build(BuildContext context) {
  ...
  final Widget nested = NestedScrollView(
    headerSliverBuilder: (BuildContext ctx, bool b) => <Widget>[
      const SliverToBoxAdapter(child: Text('H')),
    ],
    body: const Text('Body'),
  );
  check(
    nested is NestedScrollView,
    'NestedScrollView (contains viewport) created',
  );
