// Comprehensive D4rt test script: DecoratedSliver from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DecoratedSliver script ===');
  ...
  final Type targetType = DecoratedSliver;
  ...
  detailLines.add('target=DecoratedSliver');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DecoratedSliver'), 'Target type symbol resolves');
