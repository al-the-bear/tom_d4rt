// Comprehensive D4rt test script: SliverConstrainedCrossAxis from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverConstrainedCrossAxis script ===');
  ...
  detailLines.add('target=SliverConstrainedCrossAxis');
  ...
  const SliverConstrainedCrossAxis constrained = SliverConstrainedCrossAxis(maxExtent: 200, sliver: SliverToBoxAdapter(child: SizedBox(height: 80)));
  check(constrained is Widget, 'Is Widget');
  check(constrained.maxExtent == 200, 'MaxExtent');
  detailLines.add('maxExtent=200');
