// Comprehensive D4rt test script: PopupWindowController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopupWindowController script ===');
  ...
  detailLines.add('target=PopupWindowController');
  ...
  const String targetTypeName = 'PopupWindowController';
  check(targetTypeName.contains('Popup'), 'Name includes Popup');
  detailLines.add('description=Controller for popup windows');
