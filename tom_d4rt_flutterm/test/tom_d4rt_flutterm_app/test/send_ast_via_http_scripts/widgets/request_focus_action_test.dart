// Comprehensive D4rt test script: RequestFocusAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RequestFocusAction script ===');
  ...
  detailLines.add('target=RequestFocusAction');
  ...
  final RequestFocusAction action = RequestFocusAction();
  check(action is RequestFocusAction, 'Created');
  check(action is Action<RequestFocusIntent>, 'Is Action<RequestFocusIntent>');
  detailLines.add('actionType=RequestFocusAction');
