// Comprehensive D4rt test script: DesktopTextSelectionToolbarLayoutDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DesktopTextSelectionToolbarLayoutDelegate script ===');
  ...
  final Type targetType = DesktopTextSelectionToolbarLayoutDelegate;
  ...
  detailLines.add('target=DesktopTextSelectionToolbarLayoutDelegate');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DesktopTextSelectionToolbarLayoutDelegate'), 'Target type symbol resolves');
