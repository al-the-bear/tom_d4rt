// D4rt comprehensive test script for TooltipWindowControllerDelegate
...
class _TooltipWindowControllerDelegateProbe
    implements TooltipWindowControllerDelegate {
  _TooltipWindowControllerDelegateProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _TooltipWindowControllerDelegateProbe probe,
...
dynamic build(BuildContext context) {
  print('=== TooltipWindowControllerDelegate comprehensive script start ===');

  final _TooltipWindowControllerDelegateProbe primary =
      _TooltipWindowControllerDelegateProbe('primary', seed: 7);
  final _TooltipWindowControllerDelegateProbe edge =
      _TooltipWindowControllerDelegateProbe('', seed: -3);
  final _TooltipWindowControllerDelegateProbe large =
      _TooltipWindowControllerDelegateProbe('large-case', seed: 999);
  ...
  print('=== TooltipWindowControllerDelegate comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('TooltipWindowControllerDelegate Summary'),
