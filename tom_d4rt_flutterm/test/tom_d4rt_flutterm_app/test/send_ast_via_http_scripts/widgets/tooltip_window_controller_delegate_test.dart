...
class _TooltipWindowControllerDelegateProbe implements TooltipWindowControllerDelegate {
...
dynamic build(BuildContext context) {
  ...
  final _TooltipWindowControllerDelegateProbe primary = _TooltipWindowControllerDelegateProbe('primary', seed: 7);
  final _TooltipWindowControllerDelegateProbe edge = _TooltipWindowControllerDelegateProbe('', seed: -3);
  final _TooltipWindowControllerDelegateProbe large = _TooltipWindowControllerDelegateProbe('large-case', seed: 999);
