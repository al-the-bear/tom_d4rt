// Comprehensive D4rt test script: WidgetToRenderBoxAdapter from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetToRenderBoxAdapter script ===');
  ...
  detailLines.add('target=WidgetToRenderBoxAdapter');
  ...
  const String targetTypeName = 'WidgetToRenderBoxAdapter';
  detailLines.add('category=widgets_render');
  detailLines.add('desc=Adapts a RenderBox to a Widget');
  check(targetTypeName.contains('Adapter'), 'Has Adapter');
