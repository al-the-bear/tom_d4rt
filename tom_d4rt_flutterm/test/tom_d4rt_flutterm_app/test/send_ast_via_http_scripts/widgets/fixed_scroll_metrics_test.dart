// Comprehensive D4rt test script: FixedScrollMetrics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive FixedScrollMetrics script ===');
  ...
  detailLines.add('target=FixedScrollMetrics');
  ...
  const String targetTypeName = 'FixedScrollMetrics';
  check(targetTypeName == 'FixedScrollMetrics', 'Target type name set');
  detailLines.add('description=Immutable snapshot of scroll metrics');
  final ScrollController sc = ScrollController();
  check(sc is ScrollController, 'ScrollController for metrics test created');
  sc.dispose();
