// Comprehensive D4rt test script: WidgetStateTextStyle from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStateTextStyle script ===');
  ...
  detailLines.add('target=WidgetStateTextStyle');
  ...
  const String targetTypeName = 'WidgetStateTextStyle';
  detailLines.add('category=widgets_state');
  detailLines.add('desc=Text style resolved from widget states');
  check(targetTypeName.contains('TextStyle'), 'Has TextStyle');
