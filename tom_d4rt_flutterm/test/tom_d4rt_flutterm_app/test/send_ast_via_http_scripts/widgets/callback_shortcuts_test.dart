// Comprehensive D4rt test script: CallbackShortcuts from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive CallbackShortcuts script ===');
  ...
  final Type targetType = CallbackShortcuts;
  ...
  detailLines.add('target=CallbackShortcuts');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('CallbackShortcuts'), 'Target type symbol resolves');
