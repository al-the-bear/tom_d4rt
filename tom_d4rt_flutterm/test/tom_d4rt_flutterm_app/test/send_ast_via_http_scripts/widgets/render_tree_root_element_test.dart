    ...
    return Builder(builder: (context) {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            Text('Root Detection', style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        if (renderObject != null) {
          ...
          if (pipelineOwner != null) {
            print('Semantics enabled: ${pipelineOwner.semanticsOwner != null}');
          }
        }
      });
    ...
    return Builder(builder: (context) {
      ...
      return Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('View Access', style: TextStyle(fontWeight: FontWeight.bold)),
    ...
    return Builder(builder: (context) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        if (renderObject != null) {
          ...
          if (current is RenderBox) {
            print('Root is RenderBox with size: ${current.hasSize ? current.size : "no size"}');
          }
        }
      });
      ...
      return Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('Render Root', style: TextStyle(fontWeight: FontWeight.bold)),
    ...
    return StatefulBuilder(builder: (context, setState) {
      ...
      return Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('Rebuild Demo', style: TextStyle(fontWeight: FontWeight.bold)),
