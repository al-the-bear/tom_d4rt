// Comprehensive D4rt test script: TwoDimensionalScrollable from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalScrollable script ===');
  ...
  detailLines.add('target=TwoDimensionalScrollable');
  ...
  const String targetTypeName = 'TwoDimensionalScrollable';
  detailLines.add('category=widgets_2d');
  detailLines.add('desc=Scrollable in two dimensions');
  check(targetTypeName.contains('Scrollable'), 'Has Scrollable');
