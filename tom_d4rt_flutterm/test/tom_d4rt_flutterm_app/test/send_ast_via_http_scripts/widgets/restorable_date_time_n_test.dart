// Comprehensive D4rt test script: RestorableDateTimeN from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableDateTimeN script ===');
  ...
  detailLines.add('target=RestorableDateTimeN');
  ...
  final RestorableDateTimeN prop = RestorableDateTimeN(null);
  check(prop is RestorableDateTimeN, 'Created');
  check(prop.value == null, 'Initial value is null');
  detailLines.add('initialValue=null');
  prop.dispose();
