// Comprehensive D4rt test script: StatefulElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive StatefulElement script ===');
  ...
  detailLines.add('target=StatefulElement');
  ...
  const String targetTypeName = 'StatefulElement';
  detailLines.add('category=widgets_element');
  detailLines.add('desc=Element backing StatefulWidget');
  check(targetTypeName.contains('Stateful'), 'Has Stateful');
  check(targetTypeName.contains('Element'), 'Has Element');
