// Comprehensive D4rt test script: WindowingOwnerMacOS from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WindowingOwnerMacOS script ===');
  ...
  detailLines.add('target=WindowingOwnerMacOS');
  ...
  const String targetTypeName = 'WindowingOwnerMacOS';
  detailLines.add('category=widgets_window');
  detailLines.add('desc=macOS windowing owner implementation');
  check(targetTypeName.contains('MacOS'), 'Has MacOS');
