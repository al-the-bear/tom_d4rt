// Comprehensive D4rt test script: ImgElementPlatformView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ImgElementPlatformView script ===');
  ...
  detailLines.add('target=ImgElementPlatformView');
  ...
  const String targetTypeName = 'ImgElementPlatformView';
  check(targetTypeName.contains('Platform'), 'Name includes Platform');
  detailLines.add('description=Platform view backed by an img HTML element');
  detailLines.add('platform=web-only');
  final Widget placeholder = Container(child: const Text('Img element placeholder'));
  check(placeholder is Container, 'Web-only placeholder created');
