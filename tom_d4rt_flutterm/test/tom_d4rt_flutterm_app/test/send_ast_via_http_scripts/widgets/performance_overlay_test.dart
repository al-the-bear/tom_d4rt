// Comprehensive D4rt test script: PerformanceOverlay from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PerformanceOverlay script ===');
  ...
  detailLines.add('target=PerformanceOverlay');
  ...
  final Widget overlay = PerformanceOverlay.allEnabled();
  check(overlay is PerformanceOverlay, 'PerformanceOverlay created');
  check(overlay is Widget, 'Is a Widget');
  detailLines.add('mode=allEnabled');
