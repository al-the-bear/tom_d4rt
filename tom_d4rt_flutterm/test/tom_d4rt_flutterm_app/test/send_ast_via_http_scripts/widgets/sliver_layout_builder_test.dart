// Comprehensive D4rt test script: SliverLayoutBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverLayoutBuilder script ===');
  ...
  detailLines.add('target=SliverLayoutBuilder');
  ...
  final SliverLayoutBuilder builder = SliverLayoutBuilder(builder: (BuildContext ctx, SliverConstraints constraints) { return const SliverToBoxAdapter(child: SizedBox(height: 100)); });
  check(builder is Widget, 'Is Widget');
  detailLines.add('desc=Builds sliver based on constraints');
