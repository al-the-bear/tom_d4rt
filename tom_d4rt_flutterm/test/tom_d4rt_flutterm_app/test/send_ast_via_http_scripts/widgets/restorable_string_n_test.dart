// Comprehensive D4rt test script: RestorableStringN from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableStringN script ===');
  ...
  detailLines.add('target=RestorableStringN');
  ...
  final RestorableStringN prop = RestorableStringN(null);
  check(prop is RestorableStringN, 'Created');
