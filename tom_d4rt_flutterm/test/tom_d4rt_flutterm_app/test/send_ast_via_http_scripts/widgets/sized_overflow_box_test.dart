// Comprehensive D4rt test script: SizedOverflowBox from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SizedOverflowBox script ===');
  ...
  detailLines.add('target=SizedOverflowBox');
  ...
  const SizedOverflowBox box = SizedOverflowBox(size: Size(100, 100), child: SizedBox(width: 200, height: 200));
  check(box is Widget, 'Is Widget');
  check(box.size == const Size(100, 100), 'Size matches');
  detailLines.add('size=100x100');
  detailLines.add('childSize=200x200');
