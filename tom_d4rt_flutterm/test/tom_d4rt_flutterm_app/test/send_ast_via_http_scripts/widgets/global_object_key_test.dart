...
dynamic build(BuildContext context) {
  ...
  final GlobalObjectKey<State<StatefulWidget>> key1 =
      GlobalObjectKey<State<StatefulWidget>>(obj);
  final GlobalObjectKey<State<StatefulWidget>> key2 =
      GlobalObjectKey<State<StatefulWidget>>(obj);
  check(key1 == key2, 'Keys from same object are equal');
  check(key1.hashCode == key2.hashCode, 'Hashcodes match');
  final GlobalObjectKey<State<StatefulWidget>> key3 =
      GlobalObjectKey<State<StatefulWidget>>(Object());
