// Comprehensive D4rt test script: GlobalObjectKey from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive GlobalObjectKey script ===');
  ...
  detailLines.add('target=GlobalObjectKey');
  ...
  // GlobalObjectKey: creates a key from an object identity
  final Object obj = Object();
  final GlobalObjectKey<State<StatefulWidget>> key1 = GlobalObjectKey<State<StatefulWidget>>(obj);
  final GlobalObjectKey<State<StatefulWidget>> key2 = GlobalObjectKey<State<StatefulWidget>>(obj);
  check(key1 == key2, 'Keys from same object are equal');
  check(key1.hashCode == key2.hashCode, 'Hashcodes match');
  final GlobalObjectKey<State<StatefulWidget>> key3 = GlobalObjectKey<State<StatefulWidget>>(Object());
  check(key1 != key3, 'Keys from different objects differ');
  detailLines.add('key1==key2=' + (key1 == key2).toString());
