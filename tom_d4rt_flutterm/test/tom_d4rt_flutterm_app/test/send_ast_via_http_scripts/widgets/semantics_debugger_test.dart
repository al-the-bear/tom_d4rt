// Comprehensive D4rt test script: SemanticsDebugger from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SemanticsDebugger script ===');
  ...
  detailLines.add('target=SemanticsDebugger');
  ...
  final Widget debugger = SemanticsDebugger(child: const Text('Debug semantics'));
  check(debugger is SemanticsDebugger, 'SemanticsDebugger created');
  check(debugger is Widget, 'Is a Widget');
  detailLines.add('type=SemanticsDebugger');
