// Comprehensive D4rt test script: DirectionalFocusAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DirectionalFocusAction script ===');
  ...
  final Type targetType = DirectionalFocusAction;
  ...
  detailLines.add('target=DirectionalFocusAction');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DirectionalFocusAction'), 'Target type symbol resolves');
