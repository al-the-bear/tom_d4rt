...
dynamic build(BuildContext context) {
  ...
  final ClipRect clipRect = ClipRect(
    child: Container(width: 100, height: 100, color: const Color(0xFF42A5F5)),
  );
  check(clipRect is Widget, 'ClipRect is Widget');
  final ClipRRect clipRRect = ClipRRect(
    borderRadius: BorderRadius.circular(16),
    child: Container(width: 100, height: 100, color: const Color(0xFFEF5350)),
  );
