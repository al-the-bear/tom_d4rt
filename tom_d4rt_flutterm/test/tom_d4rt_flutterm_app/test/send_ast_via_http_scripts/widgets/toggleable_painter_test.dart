// Comprehensive D4rt test script: ToggleablePainter from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ToggleablePainter script ===');
  ...
  detailLines.add('target=ToggleablePainter');
  ...
  const String targetTypeName = 'ToggleablePainter';
  detailLines.add('category=widgets_paint');
  detailLines.add('desc=Abstract painter for toggleable controls');
  check(targetTypeName.contains('Toggleable'), 'Has Toggleable');
