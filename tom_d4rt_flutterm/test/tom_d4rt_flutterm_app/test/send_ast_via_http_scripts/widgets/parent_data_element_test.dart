// Comprehensive D4rt test script: ParentDataElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ParentDataElement script ===');
  ...
  detailLines.add('target=ParentDataElement');
  ...
  const String targetTypeName = 'ParentDataElement';
  check(targetTypeName.contains('Element'), 'Name includes Element');
  detailLines.add('description=Element for ParentDataWidget');
  final Widget positioned = Positioned(left: 10, top: 20, child: Container());
  check(positioned is ParentDataWidget, 'Positioned is a ParentDataWidget');
