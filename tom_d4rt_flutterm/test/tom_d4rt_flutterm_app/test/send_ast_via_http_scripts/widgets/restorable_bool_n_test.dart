// Comprehensive D4rt test script: RestorableBoolN from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableBoolN script ===');
  ...
  detailLines.add('target=RestorableBoolN');
  ...
  final RestorableBoolN prop = RestorableBoolN(null);
  check(prop is RestorableBoolN, 'Created');
