// Comprehensive D4rt test script: TapRegionSurface from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TapRegionSurface script ===');
  ...
  detailLines.add('target=TapRegionSurface');
  ...
  final TapRegionSurface surface = TapRegionSurface(child: const SizedBox(width: 100, height: 100));
  check(surface is Widget, 'Is Widget');
  detailLines.add('desc=Surface that detects taps outside tap regions');
