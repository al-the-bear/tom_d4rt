// Comprehensive D4rt test script: EdgeInsetsTween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive EdgeInsetsTween script ===');
  ...
  detailLines.add('target=EdgeInsetsTween');
  ...
  // EdgeInsetsTween: interpolates EdgeInsets
  final EdgeInsetsTween tween = EdgeInsetsTween(
    begin: EdgeInsets.zero,
    end: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
  );
  check(tween is EdgeInsetsTween, 'EdgeInsetsTween created');
  final EdgeInsets? mid = tween.lerp(0.5);
  check(mid != null, 'Lerp at 0.5 returns non-null');
  check(mid!.left == 8.0, 'Left is interpolated to 8.0');
  check(mid.top == 4.0, 'Top is interpolated to 4.0');
  detailLines.add('midLeft=' + mid.left.toString());
