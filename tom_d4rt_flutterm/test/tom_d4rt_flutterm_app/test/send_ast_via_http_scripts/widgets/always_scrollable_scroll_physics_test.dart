// Comprehensive D4rt test script: AlwaysScrollableScrollPhysics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AlwaysScrollableScrollPhysics script ===');
  ...
  final Type targetType = AlwaysScrollableScrollPhysics;
  ...
  detailLines.add('target=AlwaysScrollableScrollPhysics');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AlwaysScrollableScrollPhysics'), 'Target type symbol resolves');
