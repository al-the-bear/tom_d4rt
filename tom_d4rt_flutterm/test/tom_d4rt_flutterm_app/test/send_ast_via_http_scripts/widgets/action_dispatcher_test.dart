...
dynamic build(BuildContext context) {
  ...
  runCase('ActionDispatcher symbol check', () {
    final Type t = ActionDispatcher;
    return t.toString().contains('ActionDispatcher');
  });
  ...
  runCase('Action class symbol exists', () {
    final Type t = Action;
    return t.toString().contains('Action');
  });

  runCase('Intent symbol exists', () {
    final Type t = Intent;
    return t.toString().contains('Intent');
  });

  runCase('Summary string can be created', () {
    final String summary = 'actiondispatcher:'
