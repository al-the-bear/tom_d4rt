// Comprehensive D4rt test script: ActionDispatcher from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ActionDispatcher script ===');
  ...
  final Type targetType = ActionDispatcher;
  ...
  detailLines.add('target=ActionDispatcher');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ActionDispatcher'), 'Target type symbol resolves');
