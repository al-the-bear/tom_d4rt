// Comprehensive D4rt test script: LeafRenderObjectElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive LeafRenderObjectElement script ===');
  ...
  detailLines.add('target=LeafRenderObjectElement');
  ...
  const String targetTypeName = 'LeafRenderObjectElement';
  check(targetTypeName.contains('Element'), 'Name includes Element');
  detailLines.add('description=Element for leaf RenderObject widgets');
  final Widget leaf = const SizedBox(width: 10, height: 10);
  check(leaf is SizedBox, 'Leaf widget created (SizedBox)');
