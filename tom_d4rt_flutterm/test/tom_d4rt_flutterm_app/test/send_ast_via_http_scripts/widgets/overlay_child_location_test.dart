...
dynamic build(BuildContext context) {
  ...
  final List<OverlayChildLocation> values = OverlayChildLocation.values.toList(
    growable: false,
  );
  _expect(
    values.isNotEmpty,
    'OverlayChildLocation exposes at least one enum value',
  );
  _expect(
  ...
  final List<OverlayChildLocation> reversed = values.reversed.toList(
    growable: false,
  );
  ...
  final String summary =
      'OverlayChildLocation checks passed: ${values.length} values validated';
  print(summary);
