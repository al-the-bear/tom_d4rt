// Comprehensive D4rt test script: ScrollableDetails from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollableDetails script ===');
  ...
  detailLines.add('target=ScrollableDetails');
  ...
  const String targetTypeName = 'ScrollableDetails';
  check(targetTypeName.contains('Scrollable'), 'Name includes Scrollable');
  detailLines.add('description=Details about a scrollable widget');
