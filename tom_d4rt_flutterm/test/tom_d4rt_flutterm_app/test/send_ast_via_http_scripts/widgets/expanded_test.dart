  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(width: 250.0, child: rowWithExpanded),
        SizedBox(height: 12.0),
        Text(
          'Row with flex 1:2:1:',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12.0),
        ),
        Container(width: 250.0, child: rowWithFlex),
        SizedBox(height: 12.0),
        Text(
          'Column with Expanded:',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12.0),
        ),
        Container(height: 120.0, child: columnWithExpanded),
        SizedBox(height: 12.0),
        Text(
          'Column flex 1:3:',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12.0),
        ),
        Container(height: 100.0, child: columnWithFlex),
      ],
    ),
  );
}
