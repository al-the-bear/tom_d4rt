// Comprehensive D4rt test script: SizeChangedLayoutNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SizeChangedLayoutNotification script ===');
  ...
  detailLines.add('target=SizeChangedLayoutNotification');
  ...
  const String targetTypeName = 'SizeChangedLayoutNotification';
  detailLines.add('category=widgets_notification');
  detailLines.add('desc=Notification when layout size changes');
  final SizeChangedLayoutNotification notification = SizeChangedLayoutNotification();
  check(notification is Notification, 'Is Notification');
  check(notification is LayoutChangedNotification, 'Is LayoutChangedNotification');
