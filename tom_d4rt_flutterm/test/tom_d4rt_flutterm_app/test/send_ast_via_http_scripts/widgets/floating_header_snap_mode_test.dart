...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    values.isNotEmpty,
    'FloatingHeaderSnapMode.values should not be empty',
    logs,
    counters,
  );
  expectCondition(
    values.length >= 2,
    'FloatingHeaderSnapMode should provide multiple values',
    logs,
    counters,
  );
  ...
  for (final FloatingHeaderSnapMode value in values) {
    ...
    final FloatingHeaderSnapMode byName = FloatingHeaderSnapMode.values.byName(
      value.name,
    );
    expectCondition(
      byName == value,
  ...
  final List<FloatingHeaderSnapMode> copied = List<FloatingHeaderSnapMode>.from(
    values,
  );
  expectCondition(
  ...
  final List<FloatingHeaderSnapMode> reversed = values.reversed.toList(
    growable: false,
  );
  expectCondition(
    reversed.first == last,
  ...
  final FloatingHeaderSnapMode edgeByName = FloatingHeaderSnapMode.values
      .byName(edgeName);
  expectCondition(
