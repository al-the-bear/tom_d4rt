...
// D4rt comprehensive test script for FloatingHeaderSnapMode
...
dynamic build(BuildContext context) {
  ...
  print('========== FloatingHeaderSnapMode comprehensive test ==========' );

  final List<FloatingHeaderSnapMode> values = FloatingHeaderSnapMode.values;
  expectCondition(values.isNotEmpty, 'FloatingHeaderSnapMode.values should not be empty', logs, counters);
  expectCondition(values.length >= 2, 'FloatingHeaderSnapMode should provide multiple values', logs, counters);

  final FloatingHeaderSnapMode first = values.first;
  final FloatingHeaderSnapMode last = values.last;
  ...
  for (final FloatingHeaderSnapMode value in values) {
    ...
    final FloatingHeaderSnapMode byName = FloatingHeaderSnapMode.values.byName(value.name);
  ...
  final List<FloatingHeaderSnapMode> copied = List<FloatingHeaderSnapMode>.from(values);
  ...
  final List<FloatingHeaderSnapMode> reversed = values.reversed.toList(growable: false);
  ...
  final FloatingHeaderSnapMode edgeByName = FloatingHeaderSnapMode.values.byName(edgeName);
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Text('FloatingHeaderSnapMode Comprehensive Tests'),
