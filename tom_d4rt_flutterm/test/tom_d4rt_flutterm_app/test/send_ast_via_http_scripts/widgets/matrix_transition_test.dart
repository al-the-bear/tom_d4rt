// Comprehensive D4rt test script: MatrixTransition from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MatrixTransition script ===');
  ...
  detailLines.add('target=MatrixTransition');
  ...
  final Widget mt = MatrixTransition(
    animation: anim,
    onTransform: (double value) => Matrix4.rotationZ(value),
    child: const Text('Rotating'),
  );
  check(mt is MatrixTransition, 'MatrixTransition created');
  anim.dispose();
