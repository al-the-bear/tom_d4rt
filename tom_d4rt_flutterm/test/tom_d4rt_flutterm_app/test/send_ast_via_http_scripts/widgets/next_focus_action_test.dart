// Comprehensive D4rt test script: NextFocusAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NextFocusAction script ===');
  ...
  detailLines.add('target=NextFocusAction');
  ...
  final NextFocusAction action = NextFocusAction();
  check(action is NextFocusAction, 'NextFocusAction created');
  check(action is Action<NextFocusIntent>, 'Is Action<NextFocusIntent>');
  detailLines.add('actionType=NextFocusAction');
