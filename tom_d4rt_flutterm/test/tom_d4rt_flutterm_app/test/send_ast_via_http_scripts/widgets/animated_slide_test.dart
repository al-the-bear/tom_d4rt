// Comprehensive D4rt test script: AnimatedSlide from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedSlide script ===');
  ...
  final Type targetType = AnimatedSlide;
  ...
  detailLines.add('target=AnimatedSlide');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedSlide'), 'Target type symbol resolves');
