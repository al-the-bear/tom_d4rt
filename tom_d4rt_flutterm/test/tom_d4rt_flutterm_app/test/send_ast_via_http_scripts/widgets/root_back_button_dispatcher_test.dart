// Comprehensive D4rt test script: RootBackButtonDispatcher from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RootBackButtonDispatcher script ===');
  ...
  detailLines.add('target=RootBackButtonDispatcher');
  ...
  final RootBackButtonDispatcher dispatcher = RootBackButtonDispatcher();
  check(dispatcher is RootBackButtonDispatcher, 'Created');
  check(dispatcher is BackButtonDispatcher, 'Is BackButtonDispatcher');
  detailLines.add('type=RootBackButtonDispatcher');
