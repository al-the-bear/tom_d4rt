// Comprehensive D4rt test script: TwoDimensionalViewport from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalViewport script ===');
  ...
  detailLines.add('target=TwoDimensionalViewport');
  ...
  const String targetTypeName = 'TwoDimensionalViewport';
  detailLines.add('category=widgets_2d');
  detailLines.add('desc=Abstract 2D viewport rendering widget');
  check(targetTypeName.contains('Viewport'), 'Has Viewport');
