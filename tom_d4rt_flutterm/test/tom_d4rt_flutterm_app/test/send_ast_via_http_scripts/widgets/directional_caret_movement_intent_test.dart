// Comprehensive D4rt test script: DirectionalCaretMovementIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DirectionalCaretMovementIntent script ===');
  ...
  final Type targetType = DirectionalCaretMovementIntent;
  ...
  detailLines.add('target=DirectionalCaretMovementIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DirectionalCaretMovementIntent'), 'Target type symbol resolves');
