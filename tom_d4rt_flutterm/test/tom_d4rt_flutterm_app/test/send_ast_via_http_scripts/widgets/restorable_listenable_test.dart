// Comprehensive D4rt test script: RestorableListenable from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableListenable script ===');
  ...
  detailLines.add('target=RestorableListenable');
  ...
  const String targetTypeName = 'RestorableListenable';
  check(targetTypeName.contains('Listenable'), 'Name includes Listenable');
  detailLines.add('description=Base for restorable listenables');
  final RestorableTextEditingController rc = RestorableTextEditingController();
  check(rc is RestorableListenable, 'RestorableTextEditingController is RestorableListenable');
  rc.dispose();
