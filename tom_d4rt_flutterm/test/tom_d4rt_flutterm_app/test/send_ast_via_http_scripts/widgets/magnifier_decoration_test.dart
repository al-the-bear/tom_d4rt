// Comprehensive D4rt test script: MagnifierDecoration from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MagnifierDecoration script ===');
  ...
  detailLines.add('target=MagnifierDecoration');
  ...
  const MagnifierDecoration decoration = MagnifierDecoration(
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(40))),
  );
  check(decoration is MagnifierDecoration, 'MagnifierDecoration created');
  check(decoration is ShapeDecoration, 'Is a ShapeDecoration');
  detailLines.add('shape=RoundedRectangleBorder');
