// Comprehensive D4rt test script: InheritedModelElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InheritedModelElement script ===');
  ...
  detailLines.add('target=InheritedModelElement');
  ...
  const String targetTypeName = 'InheritedModelElement';
  check(targetTypeName.contains('Model'), 'Name includes Model');
  detailLines.add('description=Element for InheritedModel widgets');
  // InheritedModel allows aspect-dependent rebuilds
  final ThemeData theme = Theme.of(context);
  check(theme is ThemeData, 'InheritedWidget resolution works');
