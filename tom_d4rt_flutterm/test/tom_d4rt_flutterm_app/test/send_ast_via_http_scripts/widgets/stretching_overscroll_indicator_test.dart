// Comprehensive D4rt test script: StretchingOverscrollIndicator from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive StretchingOverscrollIndicator script ===');
  ...
  detailLines.add('target=StretchingOverscrollIndicator');
  ...
  final StretchingOverscrollIndicator indicator = StretchingOverscrollIndicator(axisDirection: AxisDirection.down, child: const SizedBox(height: 200));
  check(indicator is Widget, 'Is Widget');
  check(indicator.axisDirection == AxisDirection.down, 'Axis down');
  detailLines.add('axis=down');
