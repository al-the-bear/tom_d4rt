// Comprehensive D4rt test script: MagnifierController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive MagnifierController script ===');
  ...
  detailLines.add('target=MagnifierController');
  ...
  check(controller is MagnifierController, 'MagnifierController created');
  check(controller.shown == false, 'Initially not shown');
  detailLines.add('shown=' + controller.shown.toString());
  controller.hide();
  check(controller.shown == false, 'Still not shown after hide');
