// Comprehensive D4rt test script: TextSelectionGestureDetector from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextSelectionGestureDetector script ===');
  ...
  detailLines.add('target=TextSelectionGestureDetector');
  ...
  const String targetTypeName = 'TextSelectionGestureDetector';
  detailLines.add('category=widgets_text_selection');
  detailLines.add('desc=Gesture detector for text selection interactions');
  check(targetTypeName.contains('Gesture'), 'Has Gesture');
