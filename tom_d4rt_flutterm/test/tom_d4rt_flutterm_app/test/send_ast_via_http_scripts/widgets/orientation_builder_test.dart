// Comprehensive D4rt test script: OrientationBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OrientationBuilder script ===');
  ...
  detailLines.add('target=OrientationBuilder');
  ...
  final Widget ob = OrientationBuilder(
    builder: (BuildContext ctx, Orientation orientation) {
      return Text('Orientation: ' + orientation.toString());
    },
  );
  check(ob is OrientationBuilder, 'OrientationBuilder created');
  check(ob is StatelessWidget, 'Is a StatelessWidget');
