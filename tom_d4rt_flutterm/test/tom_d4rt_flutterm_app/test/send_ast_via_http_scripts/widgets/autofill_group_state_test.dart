// Comprehensive D4rt test script: AutofillGroupState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutofillGroupState script ===');
  ...
  final Type targetType = AutofillGroupState;
  ...
  detailLines.add('target=AutofillGroupState');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutofillGroupState'), 'Target type symbol resolves');
