// Comprehensive D4rt test script: CompositedTransformTarget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive CompositedTransformTarget script ===');
  ...
  final Type targetType = CompositedTransformTarget;
  ...
  detailLines.add('target=CompositedTransformTarget');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('CompositedTransformTarget'), 'Target type symbol resolves');
