// Comprehensive D4rt test script: ExpandSelectionToLineBreakIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ExpandSelectionToLineBreakIntent script ===');
  ...
  detailLines.add('target=ExpandSelectionToLineBreakIntent');
  ...
  const String targetTypeName = 'ExpandSelectionToLineBreakIntent';
  check(targetTypeName == 'ExpandSelectionToLineBreakIntent', 'Target type name set');
