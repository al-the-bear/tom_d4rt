// Comprehensive D4rt test script: ScrollStartNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollStartNotification script ===');
  ...
  detailLines.add('target=ScrollStartNotification');
  ...
  final Widget listener = NotificationListener<ScrollStartNotification>(
    onNotification: (ScrollStartNotification n) { print('scroll start'); return true; },
    child: const SingleChildScrollView(child: SizedBox(height: 2000)),
  );
  check(listener is NotificationListener, 'ScrollStartNotification listener created');
