// Comprehensive D4rt test script: TreeSliverController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TreeSliverController script ===');
  ...
  detailLines.add('target=TreeSliverController');
  ...
  const String targetTypeName = 'TreeSliverController';
  detailLines.add('category=widgets_tree');
  detailLines.add('desc=Controller for TreeSliver expand/collapse');
  final TreeSliverController ctrl = TreeSliverController();
  check(ctrl is TreeSliverController, 'Created');
