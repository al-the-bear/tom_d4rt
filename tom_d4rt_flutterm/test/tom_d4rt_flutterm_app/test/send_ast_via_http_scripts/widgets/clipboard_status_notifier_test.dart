// Comprehensive D4rt test script: ClipboardStatusNotifier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ClipboardStatusNotifier script ===');
  ...
  final Type targetType = ClipboardStatusNotifier;
  ...
  detailLines.add('target=ClipboardStatusNotifier');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ClipboardStatusNotifier'), 'Target type symbol resolves');
