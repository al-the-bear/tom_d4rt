// Comprehensive D4rt test script: WidgetStateOutlinedBorder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStateOutlinedBorder script ===');
  ...
  detailLines.add('target=WidgetStateOutlinedBorder');
  ...
  const String targetTypeName = 'WidgetStateOutlinedBorder';
  detailLines.add('category=widgets_state');
  detailLines.add('desc=Outlined border resolved from widget states');
  check(targetTypeName.contains('OutlinedBorder'), 'Has OutlinedBorder');
