// Comprehensive D4rt test script: ReadingOrderTraversalPolicy from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ReadingOrderTraversalPolicy script ===');
  ...
  detailLines.add('target=ReadingOrderTraversalPolicy');
  ...
  check(policy is ReadingOrderTraversalPolicy, 'Policy created');
  check(policy is FocusTraversalPolicy, 'Is FocusTraversalPolicy');
  detailLines.add('type=reading-order');
