// Comprehensive D4rt test script: AppLifecycleListener from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AppLifecycleListener script ===');
  ...
  final Type targetType = AppLifecycleListener;
  ...
  detailLines.add('target=AppLifecycleListener');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AppLifecycleListener'), 'Target type symbol resolves');
