...
dynamic build(BuildContext context) {
  ...
  runCase('AppLifecycleListener symbol check', () {
    final Type t = AppLifecycleListener;
    return t.toString().contains('AppLifecycleListener');
  });
  ...
  runCase('AppLifecycleState enum has values', () {
  ...
  runCase('Summary string can be created', () {
    final String summary = 'applifecyclelistener:'
