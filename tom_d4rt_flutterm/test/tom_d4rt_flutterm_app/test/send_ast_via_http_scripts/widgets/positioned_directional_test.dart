// Comprehensive D4rt test script: PositionedDirectional from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PositionedDirectional script ===');
  ...
  detailLines.add('target=PositionedDirectional');
  ...
  final Widget pd = PositionedDirectional(
    start: 10.0,
    top: 20.0,
    child: const Text('Directional'),
  );
  check(pd is PositionedDirectional, 'PositionedDirectional created');
  check(pd is Widget, 'Is a Widget');
  detailLines.add('start=10.0');
  detailLines.add('top=20.0');
