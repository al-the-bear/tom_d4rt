// Comprehensive D4rt test script: RegularWindowController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RegularWindowController script ===');
  ...
  detailLines.add('target=RegularWindowController');
  ...
  const String targetTypeName = 'RegularWindowController';
  check(targetTypeName.contains('Window'), 'Name includes Window');
  detailLines.add('description=cross-platform window controller');
