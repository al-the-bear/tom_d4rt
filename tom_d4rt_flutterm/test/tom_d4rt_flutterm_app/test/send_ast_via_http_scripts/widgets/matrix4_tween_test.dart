// Comprehensive D4rt test script: Matrix4Tween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Matrix4Tween script ===');
  ...
  detailLines.add('target=Matrix4Tween');
  ...
  check(tween is Matrix4Tween, 'Matrix4Tween created');
  check(tween is Tween<Matrix4>, 'Is a Tween<Matrix4>');
  final Matrix4 mid = tween.lerp(0.5);
  check(mid is Matrix4, 'Lerp at 0.5 returns Matrix4');
  detailLines.add('midType=' + mid.runtimeType.toString());
