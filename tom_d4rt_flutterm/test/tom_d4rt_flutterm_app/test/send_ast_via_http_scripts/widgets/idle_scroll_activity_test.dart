// Comprehensive D4rt test script: IdleScrollActivity from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IdleScrollActivity script ===');
  ...
  detailLines.add('target=IdleScrollActivity');
  ...
  const String targetTypeName = 'IdleScrollActivity';
  check(targetTypeName == 'IdleScrollActivity', 'Target type name set');
  detailLines.add('description=Scroll activity when scroll view is idle');
  final ScrollController sc = ScrollController();
  detailLines.add('scrollState=idle initially');
  sc.dispose();
