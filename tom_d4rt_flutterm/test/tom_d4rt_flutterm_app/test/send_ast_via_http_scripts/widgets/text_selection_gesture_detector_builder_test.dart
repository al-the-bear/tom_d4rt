// Comprehensive D4rt test script: TextSelectionGestureDetectorBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextSelectionGestureDetectorBuilder script ===');
  ...
  detailLines.add('target=TextSelectionGestureDetectorBuilder');
  ...
  const String targetTypeName = 'TextSelectionGestureDetectorBuilder';
  detailLines.add('category=widgets_text_selection');
  detailLines.add('desc=Builds gesture detectors for text selection');
  check(targetTypeName.contains('Builder'), 'Has Builder');
