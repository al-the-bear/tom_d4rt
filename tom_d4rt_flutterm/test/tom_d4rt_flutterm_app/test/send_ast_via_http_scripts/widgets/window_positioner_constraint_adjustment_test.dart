// Comprehensive D4rt test script: WindowPositionerConstraintAdjustment from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WindowPositionerConstraintAdjustment script ===');
  ...
  detailLines.add('target=WindowPositionerConstraintAdjustment');
  ...
  const String targetTypeName = 'WindowPositionerConstraintAdjustment';
  detailLines.add('category=widgets_window');
  detailLines.add('desc=Constraint adjustments for window positioning');
  check(targetTypeName.contains('Constraint'), 'Has Constraint');
