// Comprehensive D4rt test script: RootElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RootElement script ===');
  ...
  detailLines.add('target=RootElement');
  ...
  const String targetTypeName = 'RootElement';
  check(targetTypeName.contains('Root'), 'Name includes Root');
  detailLines.add('description=Root element of the element tree');
