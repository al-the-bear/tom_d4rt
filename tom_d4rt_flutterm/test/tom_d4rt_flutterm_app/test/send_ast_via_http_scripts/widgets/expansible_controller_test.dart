// Comprehensive D4rt test script: ExpansibleController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ExpansibleController script ===');
  ...
  detailLines.add('target=ExpansibleController');
  ...
  const String targetTypeName = 'ExpansibleController';
  check(targetTypeName == 'ExpansibleController', 'Target type name set');
  detailLines.add('description=Controller for Expansible widgets');
  // ExpansionTile uses expandable patterns
  final Widget tile = const ExpansionTile(title: Text('Expand me'), children: <Widget>[Text('Content')]);
  check(tile is ExpansionTile, 'ExpansionTile created');
