// Comprehensive D4rt test script: RepeatingAnimationBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RepeatingAnimationBuilder script ===');
  ...
  detailLines.add('target=RepeatingAnimationBuilder');
  ...
  const String targetTypeName = 'RepeatingAnimationBuilder';
  check(targetTypeName.contains('Animation'), 'Name includes Animation');
  detailLines.add('description=Builder for repeating animations');
  final Widget animated = const CircularProgressIndicator();
  check(animated is CircularProgressIndicator, 'Repeating animation widget created');
