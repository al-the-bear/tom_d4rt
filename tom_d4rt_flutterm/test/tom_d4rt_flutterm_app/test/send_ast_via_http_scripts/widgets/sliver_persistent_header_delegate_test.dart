// Comprehensive D4rt test script: SliverPersistentHeaderDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverPersistentHeaderDelegate script ===');
  ...
  detailLines.add('target=SliverPersistentHeaderDelegate');
  ...
  const String targetTypeName = 'SliverPersistentHeaderDelegate';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=Delegate for persistent sliver headers');
  check(targetTypeName.contains('Persistent'), 'Name contains Persistent');
  check(targetTypeName.contains('Delegate'), 'Name contains Delegate');
