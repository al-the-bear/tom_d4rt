// Comprehensive D4rt test script: PlatformMenuBar from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformMenuBar script ===');
  ...
  detailLines.add('target=PlatformMenuBar');
  ...
  final Widget menuBar = PlatformMenuBar(
    menus: const <PlatformMenuItem>[],
    child: const Text('Menu bar child'),
  );
  check(menuBar is PlatformMenuBar, 'PlatformMenuBar created');
  check(menuBar is Widget, 'Is a Widget');
  detailLines.add('menuCount=0');
