// Comprehensive D4rt test script: WidgetStatesConstraint from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStatesConstraint script ===');
  ...
  detailLines.add('target=WidgetStatesConstraint');
  ...
  const String targetTypeName = 'WidgetStatesConstraint';
  detailLines.add('category=widgets_state');
  detailLines.add('desc=Constraint based on widget states');
