// Comprehensive D4rt test script: WidgetStateBorderSide from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetStateBorderSide script ===');
  ...
  detailLines.add('target=WidgetStateBorderSide');
  ...
  const String targetTypeName = 'WidgetStateBorderSide';
  detailLines.add('category=widgets_state');
  detailLines.add('desc=WidgetState-resolved border side');
  check(targetTypeName.contains('BorderSide'), 'Has BorderSide');
