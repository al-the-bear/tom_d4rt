...
// D4rt comprehensive test script for DismissDirection
...
dynamic build(BuildContext context) {
  ...
  print('========== DismissDirection comprehensive test ==========' );

  final List<DismissDirection> values = DismissDirection.values;
  expectCondition(values.isNotEmpty, 'DismissDirection.values should not be empty', logs, counters);
  expectCondition(values.length >= 2, 'DismissDirection should provide multiple values', logs, counters);

  final DismissDirection first = values.first;
  final DismissDirection last = values.last;
  ...
  for (final DismissDirection value in values) {
    ...
    final DismissDirection byName = DismissDirection.values.byName(value.name);
  ...
  final List<DismissDirection> copied = List<DismissDirection>.from(values);
  ...
  final List<DismissDirection> reversed = values.reversed.toList(growable: false);
  ...
  final DismissDirection edgeByName = DismissDirection.values.byName(edgeName);
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Text('DismissDirection Comprehensive Tests'),
