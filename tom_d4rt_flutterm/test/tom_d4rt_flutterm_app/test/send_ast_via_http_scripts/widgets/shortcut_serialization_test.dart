// Comprehensive D4rt test script: ShortcutSerialization from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShortcutSerialization script ===');
  ...
  detailLines.add('target=ShortcutSerialization');
  ...
  const String targetTypeName = 'ShortcutSerialization';
  detailLines.add('category=widgets_shortcuts');
  detailLines.add('desc=Shortcut serialization utilities');
  check(targetTypeName.contains('Serial'), 'Name contains Serial');
