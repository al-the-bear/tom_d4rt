// Comprehensive D4rt test script: GestureRecognizerFactoryWithHandlers from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive GestureRecognizerFactoryWithHandlers script ===');
  ...
  detailLines.add('target=GestureRecognizerFactoryWithHandlers');
  ...
  const String targetTypeName = 'GestureRecognizerFactoryWithHandlers';
  check(targetTypeName.contains('Handlers'), 'Name includes Handlers');
  detailLines.add('description=Concrete GestureRecognizerFactory with handler callbacks');
  final Widget gd = GestureDetector(
    onTap: () {},
    onDoubleTap: () {},
    child: const Text('Multi-gesture'),
  );
  check(gd is GestureDetector, 'GestureDetector with multiple handlers created');
