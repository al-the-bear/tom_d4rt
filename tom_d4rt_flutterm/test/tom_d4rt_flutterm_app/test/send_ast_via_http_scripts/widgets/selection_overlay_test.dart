// Comprehensive D4rt test script: SelectionOverlay from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionOverlay script ===');
  ...
  detailLines.add('target=SelectionOverlay');
  ...
  const String targetTypeName = 'SelectionOverlay';
  check(targetTypeName.contains('Overlay'), 'Name includes Overlay');
  detailLines.add('description=Overlay for selection handles');
  final Widget text = const SelectableText('With overlay');
  check(text is SelectableText, 'SelectableText (uses overlay) created');
