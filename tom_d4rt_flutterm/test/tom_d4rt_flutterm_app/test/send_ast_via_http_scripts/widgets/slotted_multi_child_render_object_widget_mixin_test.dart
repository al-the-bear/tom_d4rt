...
class _SlottedMultiChildRenderObjectWidgetMixinProbe implements SlottedMultiChildRenderObjectWidgetMixin {
  _SlottedMultiChildRenderObjectWidgetMixinProbe(this.label, {required this.seed});
...
dynamic build(BuildContext context) {
  print('=== SlottedMultiChildRenderObjectWidgetMixin comprehensive script start ===');

  final _SlottedMultiChildRenderObjectWidgetMixinProbe primary = _SlottedMultiChildRenderObjectWidgetMixinProbe('primary', seed: 7);
  final _SlottedMultiChildRenderObjectWidgetMixinProbe edge = _SlottedMultiChildRenderObjectWidgetMixinProbe('', seed: -3);
  final _SlottedMultiChildRenderObjectWidgetMixinProbe large = _SlottedMultiChildRenderObjectWidgetMixinProbe('large-case', seed: 999);
  ...
  print('=== SlottedMultiChildRenderObjectWidgetMixin comprehensive script done ===');
