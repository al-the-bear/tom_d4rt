// Comprehensive D4rt test script: RadioGroup from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RadioGroup script ===');
  ...
  detailLines.add('target=RadioGroup');
  ...
  const String targetTypeName = 'RadioGroup';
  check(targetTypeName.contains('Radio'), 'Name includes Radio');
  detailLines.add('description=Groups radio buttons for mutual exclusion');
  int? selected = 0;
  final Widget radio = Radio<int>(value: 0, groupValue: selected, onChanged: (int? v) { selected = v; });
