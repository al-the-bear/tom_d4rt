// Comprehensive D4rt test script: SelectionRegistrarScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionRegistrarScope script ===');
  ...
  detailLines.add('target=SelectionRegistrarScope');
  ...
  const String targetTypeName = 'SelectionRegistrarScope';
  check(targetTypeName.contains('Registrar'), 'Name includes Registrar');
  detailLines.add('description=Scope for selection registrar');
