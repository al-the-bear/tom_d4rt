// Comprehensive D4rt test script: NavigationToolbar from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NavigationToolbar script ===');
  ...
  detailLines.add('target=NavigationToolbar');
  ...
  check(toolbar is NavigationToolbar, 'NavigationToolbar created');
  check(toolbar is Widget, 'NavigationToolbar is a Widget');
  detailLines.add('hasLeading=true');
  detailLines.add('hasMiddle=true');
  detailLines.add('hasTrailing=true');
