// Comprehensive D4rt test script: ColorFiltered from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ColorFiltered script ===');
  ...
  final Type targetType = ColorFiltered;
  ...
  detailLines.add('target=ColorFiltered');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ColorFiltered'), 'Target type symbol resolves');
