// Comprehensive D4rt test script: SelectionListenerNotifier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionListenerNotifier script ===');
  ...
  detailLines.add('target=SelectionListenerNotifier');
  ...
  const String targetTypeName = 'SelectionListenerNotifier';
  check(targetTypeName.contains('Listener'), 'Name includes Listener');
  detailLines.add('description=Notifier for selection changes');
