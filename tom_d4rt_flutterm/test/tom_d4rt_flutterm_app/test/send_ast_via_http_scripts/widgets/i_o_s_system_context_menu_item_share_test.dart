// Comprehensive D4rt test script: IOSSystemContextMenuItemShare from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItemShare script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItemShare');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItemShare';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=Share');
  detailLines.add('description=iOS system context menu item (Share)');
