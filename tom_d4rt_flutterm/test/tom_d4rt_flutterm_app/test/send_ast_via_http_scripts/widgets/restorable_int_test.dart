// Comprehensive D4rt test script: RestorableInt from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableInt script ===');
  ...
  detailLines.add('target=RestorableInt');
  ...
  final RestorableInt prop = RestorableInt(42);
  check(prop is RestorableInt, 'Created');
  check(prop.value == 42, 'Value is 42');
