// Comprehensive D4rt test script: ImplicitlyAnimatedWidgetState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ImplicitlyAnimatedWidgetState script ===');
  ...
  detailLines.add('target=ImplicitlyAnimatedWidgetState');
  ...
  const String targetTypeName = 'ImplicitlyAnimatedWidgetState';
  check(targetTypeName.contains('Animated'), 'Name includes Animated');
  detailLines.add('description=State for ImplicitlyAnimatedWidget subclasses');
  // AnimatedContainer uses ImplicitlyAnimatedWidgetState internally
  ...
  check(ac is AnimatedContainer, 'AnimatedContainer (uses ImplicitlyAnimatedWidgetState) created');
