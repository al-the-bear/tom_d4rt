// Comprehensive D4rt test script: TableCell from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TableCell script ===');
  ...
  detailLines.add('target=TableCell');
  ...
  final TableCell cell = TableCell(verticalAlignment: TableCellVerticalAlignment.middle, child: Container(height: 40, color: const Color(0xFF42A5F5)));
  check(cell is Widget, 'Is Widget');
  check(cell.verticalAlignment == TableCellVerticalAlignment.middle, 'Alignment');
  detailLines.add('alignment=middle');
