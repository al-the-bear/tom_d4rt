// Comprehensive D4rt test script: RestorableNum from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableNum script ===');
  ...
  detailLines.add('target=RestorableNum');
  ...
  const String targetTypeName = 'RestorableNum';
  check(targetTypeName.contains('Num'), 'Name includes Num');
  detailLines.add('description=Restorable num base');
  final RestorableDouble rd = RestorableDouble(2.718);
  check(rd.value == 2.718, 'RestorableDouble value correct');
  rd.dispose();
