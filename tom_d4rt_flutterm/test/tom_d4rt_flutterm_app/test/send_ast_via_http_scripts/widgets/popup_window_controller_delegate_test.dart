...
class _PopupWindowControllerDelegateProbe implements PopupWindowControllerDelegate {
...
dynamic build(BuildContext context) {
  ...
  final _PopupWindowControllerDelegateProbe primary = _PopupWindowControllerDelegateProbe('primary', seed: 7);
  final _PopupWindowControllerDelegateProbe edge = _PopupWindowControllerDelegateProbe('', seed: -3);
  final _PopupWindowControllerDelegateProbe large = _PopupWindowControllerDelegateProbe('large-case', seed: 999);
