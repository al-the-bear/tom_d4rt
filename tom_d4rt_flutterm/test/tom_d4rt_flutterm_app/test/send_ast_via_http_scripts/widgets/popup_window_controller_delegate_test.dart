// D4rt comprehensive test script for PopupWindowControllerDelegate
...
class _PopupWindowControllerDelegateProbe
    implements PopupWindowControllerDelegate {
  _PopupWindowControllerDelegateProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _PopupWindowControllerDelegateProbe probe,
...
dynamic build(BuildContext context) {
  print('=== PopupWindowControllerDelegate comprehensive script start ===');

  final _PopupWindowControllerDelegateProbe primary =
      _PopupWindowControllerDelegateProbe('primary', seed: 7);
  final _PopupWindowControllerDelegateProbe edge =
      _PopupWindowControllerDelegateProbe('', seed: -3);
  final _PopupWindowControllerDelegateProbe large =
      _PopupWindowControllerDelegateProbe('large-case', seed: 999);
  ...
  print('=== PopupWindowControllerDelegate comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('PopupWindowControllerDelegate Summary'),
