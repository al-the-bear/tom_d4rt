// Comprehensive D4rt test script: TextFieldTapRegion from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TextFieldTapRegion script ===');
  ...
  detailLines.add('target=TextFieldTapRegion');
  ...
  final TextFieldTapRegion region = TextFieldTapRegion(child: const SizedBox(width: 60, height: 40));
  check(region is Widget, 'Is Widget');
  check(region is TapRegion, 'Is TapRegion');
  detailLines.add('desc=Tap region for text fields');
