// Comprehensive D4rt test script: SelectionContainerDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionContainerDelegate script ===');
  ...
  detailLines.add('target=SelectionContainerDelegate');
  ...
  const String targetTypeName = 'SelectionContainerDelegate';
  check(targetTypeName.contains('Delegate'), 'Name includes Delegate');
  detailLines.add('description=Delegate for selection containers');
