...
dynamic build(BuildContext context) {
  ...
  final List<AndroidOverscrollIndicator> values =
      AndroidOverscrollIndicator.values;
  expectCondition(
    values.isNotEmpty,
    'AndroidOverscrollIndicator.values should not be empty',
    logs,
    counters,
  );
  expectCondition(
    values.length >= 2,
    'AndroidOverscrollIndicator should provide multiple values',
    logs,
    counters,
  );
  ...
  for (final AndroidOverscrollIndicator value in values) {
    ...
    final AndroidOverscrollIndicator byName = AndroidOverscrollIndicator.values
        .byName(value.name);
    expectCondition(
      byName == value,
  ...
  final List<AndroidOverscrollIndicator> copied =
      List<AndroidOverscrollIndicator>.from(values);
  expectCondition(
  ...
  final List<AndroidOverscrollIndicator> reversed = values.reversed.toList(
    growable: false,
  );
  expectCondition(
    reversed.first == last,
  ...
  final AndroidOverscrollIndicator edgeByName = AndroidOverscrollIndicator
      .values
      .byName(edgeName);
  expectCondition(
