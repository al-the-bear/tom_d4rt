...
// D4rt comprehensive test script for AndroidOverscrollIndicator
...
dynamic build(BuildContext context) {
  ...
  print('========== AndroidOverscrollIndicator comprehensive test ==========' );

  final List<AndroidOverscrollIndicator> values = AndroidOverscrollIndicator.values;
  expectCondition(values.isNotEmpty, 'AndroidOverscrollIndicator.values should not be empty', logs, counters);
  expectCondition(values.length >= 2, 'AndroidOverscrollIndicator should provide multiple values', logs, counters);

  final AndroidOverscrollIndicator first = values.first;
  final AndroidOverscrollIndicator last = values.last;
  ...
  for (final AndroidOverscrollIndicator value in values) {
    ...
    final AndroidOverscrollIndicator byName = AndroidOverscrollIndicator.values.byName(value.name);
  ...
  final List<AndroidOverscrollIndicator> copied = List<AndroidOverscrollIndicator>.from(values);
  ...
  final List<AndroidOverscrollIndicator> reversed = values.reversed.toList(growable: false);
  ...
  final AndroidOverscrollIndicator edgeByName = AndroidOverscrollIndicator.values.byName(edgeName);
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Text('AndroidOverscrollIndicator Comprehensive Tests'),
