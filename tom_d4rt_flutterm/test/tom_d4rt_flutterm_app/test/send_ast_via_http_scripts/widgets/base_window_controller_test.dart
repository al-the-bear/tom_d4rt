// Comprehensive D4rt test script: BaseWindowController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BaseWindowController script ===');
  ...
  const String targetTypeName = 'BaseWindowController';
  ...
  detailLines.add('target=BaseWindowController');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetTypeName);

  check(targetTypeName == 'BaseWindowController', 'Target type symbol resolves');
