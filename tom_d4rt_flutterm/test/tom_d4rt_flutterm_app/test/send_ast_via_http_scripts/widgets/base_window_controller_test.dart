...
dynamic build(BuildContext context) {
  ...
  runCase('WidgetsBindingObserver symbol exists', () {
    final Type t = WidgetsBindingObserver;
    return t.toString().contains('WidgetsBindingObserver');
  });

  runCase('AppLifecycleState enum is available', () {
    return AppLifecycleState.values.isNotEmpty;
  });
  ...
  runCase('Summary string can be generated', () {
    final String summary = 'basewindowcontroller:'
