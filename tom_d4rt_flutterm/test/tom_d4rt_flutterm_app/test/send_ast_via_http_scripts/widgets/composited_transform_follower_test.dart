// Comprehensive D4rt test script: CompositedTransformFollower from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive CompositedTransformFollower script ===');
  ...
  final Type targetType = CompositedTransformFollower;
  ...
  detailLines.add('target=CompositedTransformFollower');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('CompositedTransformFollower'), 'Target type symbol resolves');
