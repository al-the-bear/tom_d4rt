// Comprehensive D4rt test script: AbstractLayoutBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AbstractLayoutBuilder script ===');
  ...
  final Type targetType = AbstractLayoutBuilder;
  ...
  detailLines.add('target=AbstractLayoutBuilder');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AbstractLayoutBuilder'), 'Target type symbol resolves');
