// Comprehensive D4rt test script: SliverOverlapInjector from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverOverlapInjector script ===');
  ...
  detailLines.add('target=SliverOverlapInjector');
  ...
  final SliverOverlapInjector injector = SliverOverlapInjector(handle: handle);
  check(injector is Widget, 'Is Widget');
  check(injector.handle == handle, 'Handle matches');
  detailLines.add('desc=Injects overlap into sliver layout');
