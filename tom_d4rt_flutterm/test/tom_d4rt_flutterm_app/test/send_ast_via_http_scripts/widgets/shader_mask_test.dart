// Comprehensive D4rt test script: ShaderMask from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShaderMask script ===');
  ...
  detailLines.add('target=ShaderMask');
  ...
  final Widget mask = ShaderMask(
    shaderCallback: (Rect bounds) => const LinearGradient(colors: <Color>[Color(0xFF6366F1), Color(0xFFEC4899)]).createShader(bounds),
    child: const Text('Gradient Text', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
  );
  check(mask is ShaderMask, 'ShaderMask created');
  check(mask is SingleChildRenderObjectWidget, 'Is SingleChildRenderObjectWidget');
  detailLines.add('blendMode=default');
