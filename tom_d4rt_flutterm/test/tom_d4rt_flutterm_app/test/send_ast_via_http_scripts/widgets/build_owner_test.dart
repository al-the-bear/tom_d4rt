// Comprehensive D4rt test script: BuildOwner from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BuildOwner script ===');
  ...
  final Type targetType = BuildOwner;
  ...
  detailLines.add('target=BuildOwner');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BuildOwner'), 'Target type symbol resolves');
