// Comprehensive D4rt test script: KeepAliveHandle from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive KeepAliveHandle script ===');
  ...
  detailLines.add('target=KeepAliveHandle');
  ...
  // KeepAliveHandle: a handle that keeps a sliver child alive
  final KeepAliveHandle handle = KeepAliveHandle();
  check(handle is KeepAliveHandle, 'KeepAliveHandle created');
  check(handle is ChangeNotifier, 'KeepAliveHandle is ChangeNotifier');
  detailLines.add('handleType=' + handle.runtimeType.toString());
  handle.dispose();
