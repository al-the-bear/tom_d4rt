// Comprehensive D4rt test script: RawMenuAnchorGroup from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawMenuAnchorGroup script ===');
  ...
  detailLines.add('target=RawMenuAnchorGroup');
  ...
  const String targetTypeName = 'RawMenuAnchorGroup';
  check(targetTypeName.contains('Menu'), 'Name includes Menu');
  detailLines.add('description=Low-level menu anchor grouping');
  final Widget menuAnchor = MenuAnchor(
    menuChildren: const <Widget>[MenuItemButton(child: Text('Item'))],
    child: const Text('Menu'),
  );
  check(menuAnchor is MenuAnchor, 'MenuAnchor created');
