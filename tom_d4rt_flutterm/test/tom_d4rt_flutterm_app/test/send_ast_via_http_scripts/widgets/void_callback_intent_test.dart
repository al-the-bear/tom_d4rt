// Comprehensive D4rt test script: VoidCallbackIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive VoidCallbackIntent script ===');
  ...
  detailLines.add('target=VoidCallbackIntent');
  ...
  final VoidCallbackIntent intent = VoidCallbackIntent(() { triggered = true; });
  check(intent is Intent, 'Is Intent');
  intent.callback();
  check(triggered, 'Callback triggered');
  detailLines.add('triggered=true');
