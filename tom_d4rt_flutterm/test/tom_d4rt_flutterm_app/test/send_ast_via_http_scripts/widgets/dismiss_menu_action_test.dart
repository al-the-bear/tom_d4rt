// Comprehensive D4rt test script: DismissMenuAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DismissMenuAction script ===');
  ...
  detailLines.add('target=DismissMenuAction');
  ...
  // DismissMenuAction: action to dismiss a menu
  const String targetTypeName = 'DismissMenuAction';
  check(targetTypeName == 'DismissMenuAction', 'Target type name set');
  detailLines.add('description=Action that dismisses a menu');
  // Works with the popup menu system
  final Widget menuAnchor = MenuAnchor(
    menuChildren: <Widget>[const MenuItemButton(child: Text('Item'))],
    child: const Text('Menu'),
  );
  check(menuAnchor is MenuAnchor, 'MenuAnchor created for dismiss context');
  detailLines.add('menuAnchorCreated=true');
