// Comprehensive D4rt test script: Viewport from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Viewport script ===');
  ...
  detailLines.add('target=Viewport');
  ...
  final Viewport viewport = Viewport(offset: ViewportOffset.zero(), slivers: <Widget>[const SliverToBoxAdapter(child: SizedBox(height: 200))]);
  check(viewport is Widget, 'Is Widget');
  check(viewport is Widget, 'Viewport is Widget');
