// Comprehensive D4rt test script: ViewCollection from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ViewCollection script ===');
  ...
  detailLines.add('target=ViewCollection');
  ...
  const String targetTypeName = 'ViewCollection';
  detailLines.add('category=widgets_view');
  detailLines.add('desc=Collection of views in the app');
  check(targetTypeName.contains('View'), 'Has View');
  check(targetTypeName.contains('Collection'), 'Has Collection');
