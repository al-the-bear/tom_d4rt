// Comprehensive D4rt test script: AutocompletePreviousPageOptionIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutocompletePreviousPageOptionIntent script ===');
  ...
  final Type targetType = AutocompletePreviousPageOptionIntent;
  ...
  detailLines.add('target=AutocompletePreviousPageOptionIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutocompletePreviousPageOptionIntent'), 'Target type symbol resolves');
