// Comprehensive D4rt test script: UiKitView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UiKitView script ===');
  ...
  detailLines.add('target=UiKitView');
  ...
  const String targetTypeName = 'UiKitView';
  detailLines.add('category=widgets_platform');
  detailLines.add('desc=Embeds iOS UIKit views');
  check(targetTypeName.contains('Kit'), 'Has Kit');
