// Comprehensive D4rt test script: RootWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RootWidget script ===');
  ...
  detailLines.add('target=RootWidget');
  ...
  const String targetTypeName = 'RootWidget';
  check(targetTypeName.contains('Root'), 'Name includes Root');
  detailLines.add('description=Root widget of the app');
  final Widget app = MaterialApp(home: const Text('Root'));
  check(app is MaterialApp, 'MaterialApp (root) created');
