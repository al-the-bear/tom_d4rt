...
class _RegularWindowControllerDelegateProbe implements RegularWindowControllerDelegate {
...
dynamic build(BuildContext context) {
  ...
  final _RegularWindowControllerDelegateProbe primary = _RegularWindowControllerDelegateProbe('primary', seed: 7);
  final _RegularWindowControllerDelegateProbe edge = _RegularWindowControllerDelegateProbe('', seed: -3);
  final _RegularWindowControllerDelegateProbe large = _RegularWindowControllerDelegateProbe('large-case', seed: 999);
