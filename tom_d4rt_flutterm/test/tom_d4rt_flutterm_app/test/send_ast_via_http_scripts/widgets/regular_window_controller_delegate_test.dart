// D4rt comprehensive test script for RegularWindowControllerDelegate
...
class _RegularWindowControllerDelegateProbe
    implements RegularWindowControllerDelegate {
  _RegularWindowControllerDelegateProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _RegularWindowControllerDelegateProbe probe,
...
dynamic build(BuildContext context) {
  print('=== RegularWindowControllerDelegate comprehensive script start ===');

  final _RegularWindowControllerDelegateProbe primary =
      _RegularWindowControllerDelegateProbe('primary', seed: 7);
  final _RegularWindowControllerDelegateProbe edge =
      _RegularWindowControllerDelegateProbe('', seed: -3);
  final _RegularWindowControllerDelegateProbe large =
      _RegularWindowControllerDelegateProbe('large-case', seed: 999);
  ...
  print('=== RegularWindowControllerDelegate comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('RegularWindowControllerDelegate Summary'),
