// Comprehensive D4rt test script: BottomNavigationBarItem from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BottomNavigationBarItem script ===');
  ...
  final Type targetType = BottomNavigationBarItem;
  ...
  detailLines.add('target=BottomNavigationBarItem');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BottomNavigationBarItem'), 'Target type symbol resolves');
