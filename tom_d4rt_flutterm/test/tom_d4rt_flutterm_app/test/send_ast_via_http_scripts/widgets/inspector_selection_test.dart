// Comprehensive D4rt test script: InspectorSelection from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InspectorSelection script ===');
  ...
  detailLines.add('target=InspectorSelection');
  ...
  const String targetTypeName = 'InspectorSelection';
  check(targetTypeName.contains('Selection'), 'Name includes Selection');
  detailLines.add('description=Tracks widget inspector selected widget/RenderObject');
  final Widget target = Container(key: const ValueKey<String>('inspect-me'), child: const Text('Selected'));
  check(target is Container, 'Inspection target created');
