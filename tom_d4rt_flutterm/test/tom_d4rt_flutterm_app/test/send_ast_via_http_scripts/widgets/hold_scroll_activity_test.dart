// Comprehensive D4rt test script: HoldScrollActivity from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive HoldScrollActivity script ===');
  ...
  detailLines.add('target=HoldScrollActivity');
  ...
  const String targetTypeName = 'HoldScrollActivity';
  check(targetTypeName == 'HoldScrollActivity', 'Target type name set');
  detailLines.add('description=Scroll activity when user holds position');
  final ScrollController sc = ScrollController();
  final Widget lv = ListView(controller: sc, children: const <Widget>[Text('Hold test')]);
  check(lv is ListView, 'ListView for hold activity created');
  sc.dispose();
