// Comprehensive D4rt test script: DragBoundaryDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DragBoundaryDelegate script ===');
  ...
  detailLines.add('target=DragBoundaryDelegate');
  ...
  const String targetTypeName = 'DragBoundaryDelegate';
  check(targetTypeName == 'DragBoundaryDelegate', 'Target type name set');
  detailLines.add('description=Delegate for customizing drag boundary behavior');
  // DragBoundaryDelegate is abstract; test via Draggable
  final Widget draggable = Draggable<String>(
    data: 'test',
    feedback: const Text('Dragging'),
    child: const Text('Drag me'),
  );
  check(draggable is Draggable, 'Draggable created');
