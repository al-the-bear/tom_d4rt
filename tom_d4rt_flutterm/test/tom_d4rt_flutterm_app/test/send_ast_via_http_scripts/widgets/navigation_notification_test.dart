// Comprehensive D4rt test script: NavigationNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NavigationNotification script ===');
  ...
  detailLines.add('target=NavigationNotification');
  ...
  final Widget listener = NotificationListener<NavigationNotification>(
    onNotification: (NavigationNotification notification) {
      print('canHandlePop=' + notification.canHandlePop.toString());
      return true;
    },
    child: const SizedBox.shrink(),
  );
  check(listener is NotificationListener, 'NavigationNotification listener created');
