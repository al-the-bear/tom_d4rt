// Comprehensive D4rt test script: NextFocusIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive NextFocusIntent script ===');
  ...
  detailLines.add('target=NextFocusIntent');
  ...
  const NextFocusIntent intent = NextFocusIntent();
  check(intent is NextFocusIntent, 'NextFocusIntent created');
  check(intent is Intent, 'Is an Intent');
  detailLines.add('intentType=NextFocusIntent');
