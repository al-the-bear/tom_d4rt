// Comprehensive D4rt test script: SliverOverlapAbsorberHandle from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverOverlapAbsorberHandle script ===');
  ...
  detailLines.add('target=SliverOverlapAbsorberHandle');
  ...
  const String targetTypeName = 'SliverOverlapAbsorberHandle';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=Handle for overlap absorber coordination');
  final SliverOverlapAbsorberHandle handle = SliverOverlapAbsorberHandle();
  check(handle is Listenable, 'Is Listenable');
  check(handle.layoutExtent == 0.0, 'Initial layoutExtent=0');
  check(handle.scrollExtent == 0.0, 'Initial scrollExtent=0');
