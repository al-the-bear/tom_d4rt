// Comprehensive D4rt test script: TransposeCharactersIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TransposeCharactersIntent script ===');
  ...
  detailLines.add('target=TransposeCharactersIntent');
  ...
  const String targetTypeName = 'TransposeCharactersIntent';
  detailLines.add('category=widgets_intent');
  detailLines.add('desc=Intent to transpose characters');
  const TransposeCharactersIntent intent = TransposeCharactersIntent();
  check(intent is Intent, 'Is Intent');
  detailLines.add('intentType=TransposeCharactersIntent');
