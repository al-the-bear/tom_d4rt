...
dynamic build(BuildContext context) {
  ...
  expectCondition(stateA is TickerProviderStateMixin, 'stateA mixes in TickerProviderStateMixin', logs, counters);
  expectCondition(tickerA1.isActive == false, 'tickerA1 initially inactive', logs, counters);
  expectCondition(tickerA2.isActive == false, 'tickerA2 initially inactive', logs, counters);
  expectCondition(tickerB1.isActive == false, 'tickerB1 initially inactive', logs, counters);
  tickerA1.dispose();
  tickerA2.dispose();
  tickerB1.dispose();
