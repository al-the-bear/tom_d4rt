// Comprehensive D4rt test script: ShortcutActivator from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShortcutActivator script ===');
  ...
  detailLines.add('target=ShortcutActivator');
  ...
  const String targetTypeName = 'ShortcutActivator';
  check(targetTypeName.contains('Shortcut'), 'Name includes Shortcut');
  detailLines.add('description=Interface for keyboard shortcut activators');
  final SingleActivator activator = const SingleActivator(LogicalKeyboardKey.keyA, control: true);
  check(activator is ShortcutActivator, 'SingleActivator is ShortcutActivator');
