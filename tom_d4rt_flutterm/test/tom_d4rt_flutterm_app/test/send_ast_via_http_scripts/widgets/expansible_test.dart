// Comprehensive D4rt test script: Expansible from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Expansible script ===');
  ...
  detailLines.add('target=Expansible');
  ...
  const String targetTypeName = 'Expansible';
  check(targetTypeName == 'Expansible', 'Target type name set');
  detailLines.add('description=Expandable widget abstraction');
  final Widget tile = const ExpansionTile(title: Text('Tile'), children: <Widget>[Text('Body')]);
  check(tile is ExpansionTile, 'ExpansionTile as Expansible proxy');
