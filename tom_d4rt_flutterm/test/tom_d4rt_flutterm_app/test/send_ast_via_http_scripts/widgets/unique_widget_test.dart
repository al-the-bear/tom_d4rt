// Comprehensive D4rt test script: UniqueWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive UniqueWidget script ===');
  ...
  detailLines.add('target=UniqueWidget');
  ...
  const String targetTypeName = 'UniqueWidget';
  detailLines.add('category=widgets_unique');
  detailLines.add('desc=Widget with global key guarantee');
  check(targetTypeName.contains('Unique'), 'Has Unique');
