...
dynamic build(BuildContext context) {
  ...
  _expect(
    secondary.stream != null,
    'secondary StreamBuilder accepts one-shot stream',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    controller.isClosed,
    'edge case close transitions controller to closed state',
    logs,
  );
  assertionCount++;

  final summary =
      'builder:${widget.builder.runtimeType} initial:${widget.initialData}';
