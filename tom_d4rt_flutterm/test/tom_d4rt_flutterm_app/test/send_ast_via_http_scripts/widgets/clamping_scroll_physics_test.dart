// Comprehensive D4rt test script: ClampingScrollPhysics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ClampingScrollPhysics script ===');
  ...
  final Type targetType = ClampingScrollPhysics;
  ...
  detailLines.add('target=ClampingScrollPhysics');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ClampingScrollPhysics'), 'Target type symbol resolves');
