// Comprehensive D4rt test script: ImageFiltered from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ImageFiltered script ===');
  ...
  detailLines.add('target=ImageFiltered');
  ...
  // ImageFiltered: applies an ImageFilter to its child
  final Widget filtered = ImageFiltered(
    imageFilter: ImageFilter.blur(sigmaX: 5.0, sigmaY: 5.0),
    child: Container(width: 200, height: 200, color: const Color(0xFFEF4444)),
  );
  check(filtered is ImageFiltered, 'ImageFiltered created');
  check(filtered is Widget, 'ImageFiltered is a Widget');
  detailLines.add('filter=blur(5.0, 5.0)');
