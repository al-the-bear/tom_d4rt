// Comprehensive D4rt test script: SelectionContainer from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionContainer script ===');
  ...
  detailLines.add('target=SelectionContainer');
  ...
  const String targetTypeName = 'SelectionContainer';
  check(targetTypeName.contains('Selection'), 'Name includes Selection');
  detailLines.add('description=Container for selection areas');
  final Widget disabledSelection = SelectionContainer.disabled(child: const Text('No select'));
  check(disabledSelection is Widget, 'Disabled selection container created');
