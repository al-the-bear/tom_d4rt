// Comprehensive D4rt test script: IOSSystemContextMenuItemCut from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItemCut script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItemCut');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItemCut';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=Cut');
  detailLines.add('description=iOS system context menu item (Cut)');
