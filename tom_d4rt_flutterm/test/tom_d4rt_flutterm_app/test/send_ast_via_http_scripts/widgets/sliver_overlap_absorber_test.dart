// Comprehensive D4rt test script: SliverOverlapAbsorber from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverOverlapAbsorber script ===');
  ...
  detailLines.add('target=SliverOverlapAbsorber');
  ...
  final SliverOverlapAbsorber absorber = SliverOverlapAbsorber(handle: handle, sliver: const SliverToBoxAdapter(child: SizedBox(height: 80)));
  check(absorber is Widget, 'Is Widget');
  check(absorber.handle == handle, 'Handle matches');
  detailLines.add('desc=Absorbs overlap from preceding slivers');
