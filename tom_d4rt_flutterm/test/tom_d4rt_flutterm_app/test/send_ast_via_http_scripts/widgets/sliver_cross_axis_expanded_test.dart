// Comprehensive D4rt test script: SliverCrossAxisExpanded from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverCrossAxisExpanded script ===');
  ...
  detailLines.add('target=SliverCrossAxisExpanded');
  ...
  const SliverCrossAxisExpanded expanded = SliverCrossAxisExpanded(flex: 2, sliver: SliverToBoxAdapter(child: SizedBox(height: 60)));
  check(expanded is Widget, 'Is Widget');
  check(expanded.flex == 2, 'Flex=2');
  detailLines.add('flex=2');
