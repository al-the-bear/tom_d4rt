// Comprehensive D4rt test script: WindowScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WindowScope script ===');
  ...
  detailLines.add('target=WindowScope');
  ...
  const String targetTypeName = 'WindowScope';
  detailLines.add('category=widgets_window');
  detailLines.add('desc=Scope for windowed views');
  check(targetTypeName.contains('Window'), 'Has Window');
  check(targetTypeName.contains('Scope'), 'Has Scope');
