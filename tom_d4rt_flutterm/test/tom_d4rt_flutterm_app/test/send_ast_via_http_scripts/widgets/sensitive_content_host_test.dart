// Comprehensive D4rt test script: SensitiveContentHost from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SensitiveContentHost script ===');
  ...
  detailLines.add('target=SensitiveContentHost');
  ...
  const String targetTypeName = 'SensitiveContentHost';
  check(targetTypeName.contains('Content'), 'Name includes Content');
  detailLines.add('description=Host for sensitive content protection');
