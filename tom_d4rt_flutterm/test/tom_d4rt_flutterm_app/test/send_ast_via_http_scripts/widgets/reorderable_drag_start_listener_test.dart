// Comprehensive D4rt test script: ReorderableDragStartListener from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ReorderableDragStartListener script ===');
  ...
  detailLines.add('target=ReorderableDragStartListener');
  ...
  const String targetTypeName = 'ReorderableDragStartListener';
  check(targetTypeName.contains('Drag'), 'Name includes Drag');
  detailLines.add('description=Drag start listener for reorderable lists');
  final Widget list = ReorderableList(itemBuilder: (BuildContext ctx, int i) => ListTile(key: ValueKey<int>(i), title: Text('Item \$i')), itemCount: 3, onReorder: (int a, int b) {});
