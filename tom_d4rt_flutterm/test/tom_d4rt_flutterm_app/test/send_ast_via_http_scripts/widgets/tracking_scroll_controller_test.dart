// Comprehensive D4rt test script: TrackingScrollController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TrackingScrollController script ===');
  ...
  detailLines.add('target=TrackingScrollController');
  ...
  final TrackingScrollController ctrl = TrackingScrollController();
  check(ctrl is ScrollController, 'Is ScrollController');
  check(ctrl.initialScrollOffset == 0.0, 'Initial offset=0');
  ctrl.dispose();
  detailLines.add('desc=ScrollController that tracks most recent position');
