// Comprehensive D4rt test script: IOSSystemContextMenuItemSearchWeb from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItemSearchWeb script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItemSearchWeb');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItemSearchWeb';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=SearchWeb');
  detailLines.add('description=iOS system context menu item (SearchWeb)');
