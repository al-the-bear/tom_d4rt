// Comprehensive D4rt test script: IOSSystemContextMenuItemPaste from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IOSSystemContextMenuItemPaste script ===');
  ...
  detailLines.add('target=IOSSystemContextMenuItemPaste');
  ...
  const String targetTypeName = 'IOSSystemContextMenuItemPaste';
  check(targetTypeName.startsWith('IOS'), 'Is iOS context menu item');
  detailLines.add('variant=Paste');
  detailLines.add('description=iOS system context menu item (Paste)');
