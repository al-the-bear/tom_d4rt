// Comprehensive D4rt test script: LocalHistoryEntry from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive LocalHistoryEntry script ===');
  ...
  detailLines.add('target=LocalHistoryEntry');
  ...
  bool removed = false;
  final LocalHistoryEntry entry = LocalHistoryEntry(onRemove: () { removed = true; });
  check(entry is LocalHistoryEntry, 'LocalHistoryEntry created');
  check(!removed, 'Not removed initially');
  detailLines.add('onRemove=set');
