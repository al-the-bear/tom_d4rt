// Comprehensive D4rt test script: HeroController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive HeroController script ===');
  ...
  detailLines.add('target=HeroController');
  ...
  // HeroController: controls hero transition animations
  final HeroController controller = HeroController();
  check(controller is HeroController, 'HeroController created');
  check(controller is NavigatorObserver, 'HeroController is a NavigatorObserver');
  detailLines.add('controllerType=' + controller.runtimeType.toString());
  // Custom creation curve
  final HeroController custom = HeroController(createRectTween: (Rect? a, Rect? b) {
    return MaterialRectArcTween(begin: a, end: b);
  });
  check(custom is HeroController, 'Custom HeroController created');
