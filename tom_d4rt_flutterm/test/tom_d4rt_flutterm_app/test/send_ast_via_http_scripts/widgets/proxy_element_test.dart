// Comprehensive D4rt test script: ProxyElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ProxyElement script ===');
  ...
  detailLines.add('target=ProxyElement');
  ...
  const String targetTypeName = 'ProxyElement';
  check(targetTypeName.contains('Proxy'), 'Name includes Proxy');
  detailLines.add('description=Element for ProxyWidget (InheritedWidget base element)');
