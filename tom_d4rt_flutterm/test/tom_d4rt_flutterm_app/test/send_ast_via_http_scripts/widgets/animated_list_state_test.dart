// Comprehensive D4rt test script: AnimatedListState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedListState script ===');
  ...
  final Type targetType = AnimatedListState;
  ...
  detailLines.add('target=AnimatedListState');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedListState'), 'Target type symbol resolves');
