// Comprehensive D4rt test script: PageStorageBucket from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PageStorageBucket script ===');
  ...
  detailLines.add('target=PageStorageBucket');
  ...
  check(bucket is PageStorageBucket, 'Bucket created');
