// Comprehensive D4rt test script: AutocompleteHighlightedOption from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutocompleteHighlightedOption script ===');
  ...
  final Type targetType = AutocompleteHighlightedOption;
  ...
  detailLines.add('target=AutocompleteHighlightedOption');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutocompleteHighlightedOption'), 'Target type symbol resolves');
