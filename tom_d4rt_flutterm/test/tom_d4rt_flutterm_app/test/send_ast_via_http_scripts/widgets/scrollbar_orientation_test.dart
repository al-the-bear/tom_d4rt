...
dynamic build(BuildContext context) {
  ...
  final List<ScrollbarOrientation> values = ScrollbarOrientation.values.toList(growable: false);
  _expect(values.isNotEmpty, 'ScrollbarOrientation exposes at least one enum value');
  _expect(
  ...
  final List<ScrollbarOrientation> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'ScrollbarOrientation checks passed: ${values.length} values validated';
  print(summary);
