...
dynamic build(BuildContext context) {
  print(
    '=== Running comprehensive ReorderableDelayedDragStartListener script ===',
  );
  ...
  detailLines.add(
    'description=Delayed drag start listener for reorderable lists',
  );
  final Widget list = ReorderableList(
    itemBuilder: (BuildContext ctx, int i) =>
        ListTile(key: ValueKey<int>(i), title: Text('Item \$i')),
    itemCount: 5,
