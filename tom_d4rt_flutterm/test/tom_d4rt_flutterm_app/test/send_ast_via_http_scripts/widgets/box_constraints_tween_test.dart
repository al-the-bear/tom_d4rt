...
dynamic build(BuildContext context) {
  ...
  runCase('BoxConstraintsTween symbol exists', () {
    final Type t = BoxConstraintsTween;
    return t.toString().contains('BoxConstraintsTween');
  });

  runCase('BoxConstraintsTween type string stable', () {
    final Type t = BoxConstraintsTween;
  ...
  runCase('BoxConstraints.tightFor creates constraints', () {
    final BoxConstraints c = const BoxConstraints.tightFor(width: 20, height: 30);
    return c.minWidth == 20 && c.minHeight == 30;
  });

  runCase('Summary string can be generated', () {
    final String summary = 'boxconstraintstween:'
