// Comprehensive D4rt test script: BoxConstraintsTween from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BoxConstraintsTween script ===');
  ...
  final Type targetType = BoxConstraintsTween;
  ...
  detailLines.add('target=BoxConstraintsTween');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BoxConstraintsTween'), 'Target type symbol resolves');
