// Comprehensive D4rt test script: TooltipWindow from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TooltipWindow script ===');
  ...
  detailLines.add('target=TooltipWindow');
  ...
  const String targetTypeName = 'TooltipWindow';
  detailLines.add('category=widgets_tooltip');
  detailLines.add('desc=The tooltip window overlay');
