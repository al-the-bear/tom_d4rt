...
dynamic build(BuildContext context) {
  ...
  runCase('BuildScope symbol exists', () {
    final Type t = BuildScope;
    return t.toString().contains('BuildScope');
  });

  runCase('BuildScope type string stable', () {
    final Type t = BuildScope;
  ...
  runCase('BuildOwner symbol exists', () {
    final Type t = BuildOwner;
    return t.toString().contains('BuildOwner');
  });

  runCase('Summary string can be generated', () {
    final String summary = 'buildscope:'
