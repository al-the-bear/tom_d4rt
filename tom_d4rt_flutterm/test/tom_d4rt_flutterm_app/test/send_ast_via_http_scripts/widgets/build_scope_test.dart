// Comprehensive D4rt test script: BuildScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BuildScope script ===');
  ...
  final Type targetType = BuildScope;
  ...
  detailLines.add('target=BuildScope');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BuildScope'), 'Target type symbol resolves');
