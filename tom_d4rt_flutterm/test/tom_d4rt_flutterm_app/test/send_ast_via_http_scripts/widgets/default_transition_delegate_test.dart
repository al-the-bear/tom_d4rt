// Comprehensive D4rt test script: DefaultTransitionDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DefaultTransitionDelegate script ===');
  ...
  final Type targetType = DefaultTransitionDelegate;
  ...
  detailLines.add('target=DefaultTransitionDelegate');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DefaultTransitionDelegate'), 'Target type symbol resolves');
