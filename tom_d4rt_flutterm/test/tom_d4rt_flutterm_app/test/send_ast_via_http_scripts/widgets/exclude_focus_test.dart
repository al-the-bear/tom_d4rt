// Comprehensive D4rt test script: ExcludeFocus from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ExcludeFocus script ===');
  ...
  detailLines.add('target=ExcludeFocus');
  ...
  // ExcludeFocus: prevents focus on descendant widgets
  final Widget excluded = ExcludeFocus(
    excluding: true,
    child: const TextField(),
  );
  check(excluded is ExcludeFocus, 'ExcludeFocus created');
  check(excluded is Widget, 'ExcludeFocus is a Widget');
  detailLines.add('excluding=true');
  // Non-excluding variant
  final Widget notExcluded = ExcludeFocus(
    excluding: false,
    child: const TextField(),
  );
  check(notExcluded is ExcludeFocus, 'Non-excluding ExcludeFocus created');
