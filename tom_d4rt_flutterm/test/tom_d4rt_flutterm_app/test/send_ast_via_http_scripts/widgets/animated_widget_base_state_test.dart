// Comprehensive D4rt test script: AnimatedWidgetBaseState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedWidgetBaseState script ===');
  ...
  final Type targetType = AnimatedWidgetBaseState;
  ...
  detailLines.add('target=AnimatedWidgetBaseState');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedWidgetBaseState'), 'Target type symbol resolves');
