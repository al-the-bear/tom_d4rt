// Comprehensive D4rt test script: IconDataProperty from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IconDataProperty script ===');
  ...
  detailLines.add('target=IconDataProperty');
  ...
  // IconDataProperty: diagnostics property for IconData
  final IconData iconData = Icons.home;
  check(iconData.codePoint > 0, 'IconData has valid codePoint');
  check(iconData.fontFamily != null, 'IconData has fontFamily');
  detailLines.add('codePoint=' + iconData.codePoint.toString());
  detailLines.add('fontFamily=' + (iconData.fontFamily ?? 'null'));
  // Test multiple icon data values
  final IconData star = Icons.star;
  check(star.codePoint != iconData.codePoint, 'Different icons have different codePoints');
