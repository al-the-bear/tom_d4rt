// Comprehensive D4rt test script: SlottedRenderObjectElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SlottedRenderObjectElement script ===');
  ...
  detailLines.add('target=SlottedRenderObjectElement');
  ...
  const String targetTypeName = 'SlottedRenderObjectElement';
  detailLines.add('category=widgets_element');
  detailLines.add('desc=Element for slotted render objects');
