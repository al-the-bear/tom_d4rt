// Comprehensive D4rt test script: AnnotatedRegion from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnnotatedRegion script ===');
  ...
  final Type targetType = AnnotatedRegion;
  ...
  detailLines.add('target=AnnotatedRegion');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnnotatedRegion'), 'Target type symbol resolves');
