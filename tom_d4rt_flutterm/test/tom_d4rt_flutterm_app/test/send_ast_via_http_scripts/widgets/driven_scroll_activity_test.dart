// Comprehensive D4rt test script: DrivenScrollActivity from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DrivenScrollActivity script ===');
  ...
  detailLines.add('target=DrivenScrollActivity');
  ...
  const String targetTypeName = 'DrivenScrollActivity';
  check(targetTypeName == 'DrivenScrollActivity', 'Target type name set');
  detailLines.add('description=Animated scroll activity driven by controller');
  final ScrollController sc = ScrollController(initialScrollOffset: 100.0);
  check(sc.initialScrollOffset == 100.0, 'Initial offset set');
  detailLines.add('initialOffset=' + sc.initialScrollOffset.toString());
  sc.dispose();
