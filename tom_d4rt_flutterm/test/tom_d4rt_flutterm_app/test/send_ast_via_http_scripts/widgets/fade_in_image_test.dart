// Comprehensive D4rt test script: FadeInImage from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive FadeInImage script ===');
  ...
  detailLines.add('target=FadeInImage');
  ...
  // FadeInImage: cross-fades from placeholder to target image
  final Widget fadeIn = FadeInImage(
  ...
  check(fadeIn is FadeInImage, 'FadeInImage created');
  check(fadeIn is Widget, 'FadeInImage is a Widget');
  detailLines.add('fadeInDuration=500ms');
