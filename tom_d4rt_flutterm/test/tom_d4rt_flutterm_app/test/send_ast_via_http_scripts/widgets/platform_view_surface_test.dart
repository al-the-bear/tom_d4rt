// Comprehensive D4rt test script: PlatformViewSurface from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformViewSurface script ===');
  ...
  detailLines.add('target=PlatformViewSurface');
  ...
  const String targetTypeName = 'PlatformViewSurface';
  check(targetTypeName.contains('Surface'), 'Name includes Surface');
  detailLines.add('description=Surface for rendering platform views');
