// Comprehensive D4rt test script: ScrollAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollAction script ===');
  ...
  detailLines.add('target=ScrollAction');
  ...
  const String targetTypeName = 'ScrollAction';
  check(targetTypeName.contains('Scroll'), 'Name includes Scroll');
  detailLines.add('description=Action for scroll intents');
  final Widget scrollView = SingleChildScrollView(child: Column(children: List<Widget>.generate(20, (int i) => Text('Row \$i'))));
  check(scrollView is SingleChildScrollView, 'Scroll view created');
