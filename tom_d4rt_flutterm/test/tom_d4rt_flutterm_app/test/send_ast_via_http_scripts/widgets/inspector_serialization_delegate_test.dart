// Comprehensive D4rt test script: InspectorSerializationDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive InspectorSerializationDelegate script ===');
  ...
  detailLines.add('target=InspectorSerializationDelegate');
  ...
  const String targetTypeName = 'InspectorSerializationDelegate';
  check(targetTypeName.contains('Serialization'), 'Name includes Serialization');
  detailLines.add('description=Delegate for serializing widget inspector data');
  detailLines.add('usedBy=Flutter DevTools');
