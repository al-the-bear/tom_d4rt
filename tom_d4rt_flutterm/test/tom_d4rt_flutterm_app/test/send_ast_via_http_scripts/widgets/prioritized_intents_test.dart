// Comprehensive D4rt test script: PrioritizedIntents from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PrioritizedIntents script ===');
  ...
  detailLines.add('target=PrioritizedIntents');
  ...
  const PrioritizedIntents intents = PrioritizedIntents(orderedIntents: <Intent>[DoNothingIntent()]);
  check(intents is PrioritizedIntents, 'Created');
  check(intents is Intent, 'Is an Intent');
  detailLines.add('orderedIntentsCount=1');
