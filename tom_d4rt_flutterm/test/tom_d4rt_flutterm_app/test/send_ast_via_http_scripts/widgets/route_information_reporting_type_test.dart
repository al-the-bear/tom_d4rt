...
dynamic build(BuildContext context) {
  print('========== RouteInformationReportingType comprehensive test start ==========' );

  final List<RouteInformationReportingType> values = RouteInformationReportingType.values.toList(growable: false);
  _expect(values.isNotEmpty, 'RouteInformationReportingType exposes at least one enum value');
  _expect(
  ...
  final List<RouteInformationReportingType> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'RouteInformationReportingType checks passed: ${values.length} values validated';
  print(summary);
  print('========== RouteInformationReportingType comprehensive test end ==========' );
