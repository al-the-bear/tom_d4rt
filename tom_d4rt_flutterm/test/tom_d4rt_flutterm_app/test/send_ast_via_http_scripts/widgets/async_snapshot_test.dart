// Comprehensive D4rt test script: AsyncSnapshot from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AsyncSnapshot script ===');
  ...
  final Type targetType = AsyncSnapshot;
  ...
  detailLines.add('target=AsyncSnapshot');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AsyncSnapshot'), 'Target type symbol resolves');
