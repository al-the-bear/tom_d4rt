// Comprehensive D4rt test script: ReplaceTextIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ReplaceTextIntent script ===');
  ...
  detailLines.add('target=ReplaceTextIntent');
  ...
  const String targetTypeName = 'ReplaceTextIntent';
  check(targetTypeName.contains('Replace'), 'Name includes Replace');
  detailLines.add('description=Intent to replace text in editing');
  final TextEditingController tec = TextEditingController(text: 'Hello World');
  check(tec.text == 'Hello World', 'Text set');
  tec.dispose();
