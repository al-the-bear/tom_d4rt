// Comprehensive D4rt test script: ScrollEndNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollEndNotification script ===');
  ...
  detailLines.add('target=ScrollEndNotification');
  ...
  final Widget listener = NotificationListener<ScrollEndNotification>(
    onNotification: (ScrollEndNotification n) { print('scroll end'); return true; },
    child: const SingleChildScrollView(child: SizedBox(height: 2000)),
  );
  check(listener is NotificationListener, 'ScrollEndNotification listener created');
