// Comprehensive D4rt test script: RootRenderObjectElement from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RootRenderObjectElement script ===');
  ...
  detailLines.add('target=RootRenderObjectElement');
  ...
  const String targetTypeName = 'RootRenderObjectElement';
  check(targetTypeName.contains('RenderObject'), 'Name includes RenderObject');
  detailLines.add('description=Root element for the render object tree');
