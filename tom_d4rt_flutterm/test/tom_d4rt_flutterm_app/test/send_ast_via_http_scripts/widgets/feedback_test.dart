// Comprehensive D4rt test script: Feedback from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Feedback script ===');
  ...
  detailLines.add('target=Feedback');
  ...
  // Feedback: provides haptic/audio feedback
  check(Feedback.forTap != null, 'Feedback.forTap is accessible');
  check(Feedback.forLongPress != null, 'Feedback.forLongPress is accessible');
  detailLines.add('forTap=accessible');
  detailLines.add('forLongPress=accessible');
  final Widget tapFeedback = GestureDetector(
    onTap: () { Feedback.forTap(context); },
    child: const Text('Tap for feedback'),
  );
  check(tapFeedback is GestureDetector, 'GestureDetector with Feedback created');
