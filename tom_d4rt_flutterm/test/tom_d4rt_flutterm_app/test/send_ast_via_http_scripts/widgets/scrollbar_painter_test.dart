// Comprehensive D4rt test script: ScrollbarPainter from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollbarPainter script ===');
  ...
  detailLines.add('target=ScrollbarPainter');
  ...
  check(painter is ScrollbarPainter, 'Created');
  check(painter is ChangeNotifier, 'Is ChangeNotifier');
  detailLines.add('thickness=6.0');
  painter.dispose();
