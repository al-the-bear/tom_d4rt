// Comprehensive D4rt test script: OverscrollIndicatorNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive OverscrollIndicatorNotification script ===');
  ...
  detailLines.add('target=OverscrollIndicatorNotification');
  ...
  final Widget listener = NotificationListener<OverscrollIndicatorNotification>(
  ...
  check(listener is NotificationListener, 'OverscrollIndicatorNotification listener created');
