// Comprehensive D4rt test script: ObjectKey from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ObjectKey script ===');
  ...
  detailLines.add('target=ObjectKey');
  ...
  final ObjectKey key1 = ObjectKey(obj);
  final ObjectKey key2 = ObjectKey(obj);
  check(key1 == key2, 'Keys from same object are equal');
  check(key1.hashCode == key2.hashCode, 'Hash codes match');
  final ObjectKey key3 = ObjectKey(Object());
  check(key1 != key3, 'Keys from different objects differ');
  detailLines.add('equality=' + (key1 == key2).toString());
