// Comprehensive D4rt test script: RegularWindowControllerLinux from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RegularWindowControllerLinux script ===');
  ...
  detailLines.add('target=RegularWindowControllerLinux');
  ...
  const String targetTypeName = 'RegularWindowControllerLinux';
  check(targetTypeName.contains('Window'), 'Name includes Window');
  detailLines.add('description=Linux window controller');
