// Comprehensive D4rt test script: DeleteCharacterIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DeleteCharacterIntent script ===');
  ...
  final Type targetType = DeleteCharacterIntent;
  ...
  detailLines.add('target=DeleteCharacterIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DeleteCharacterIntent'), 'Target type symbol resolves');
