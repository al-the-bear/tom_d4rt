// Comprehensive D4rt test script: ListWheelChildBuilderDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ListWheelChildBuilderDelegate script ===');
  ...
  detailLines.add('target=ListWheelChildBuilderDelegate');
  ...
  final ListWheelChildBuilderDelegate delegate = ListWheelChildBuilderDelegate(
    builder: (BuildContext ctx, int index) => Text('Item \$index'),
    childCount: 20,
  );
  check(delegate is ListWheelChildDelegate, 'Is ListWheelChildDelegate');
  check(delegate.childCount == 20, 'childCount is 20');
  detailLines.add('childCount=20');
