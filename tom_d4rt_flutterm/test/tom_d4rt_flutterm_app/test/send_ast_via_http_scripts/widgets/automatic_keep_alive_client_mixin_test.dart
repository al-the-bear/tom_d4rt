// D4rt comprehensive test script for AutomaticKeepAliveClientMixin
...
class _AutomaticKeepAliveClientMixinProbe
    implements AutomaticKeepAliveClientMixin {
  _AutomaticKeepAliveClientMixinProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _AutomaticKeepAliveClientMixinProbe probe,
...
dynamic build(BuildContext context) {
  print('=== AutomaticKeepAliveClientMixin comprehensive script start ===');

  final _AutomaticKeepAliveClientMixinProbe primary =
      _AutomaticKeepAliveClientMixinProbe('primary', seed: 7);
  final _AutomaticKeepAliveClientMixinProbe edge =
      _AutomaticKeepAliveClientMixinProbe('', seed: -3);
  final _AutomaticKeepAliveClientMixinProbe large =
      _AutomaticKeepAliveClientMixinProbe('large-case', seed: 999);
  ...
  print('=== AutomaticKeepAliveClientMixin comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('AutomaticKeepAliveClientMixin Summary'),
