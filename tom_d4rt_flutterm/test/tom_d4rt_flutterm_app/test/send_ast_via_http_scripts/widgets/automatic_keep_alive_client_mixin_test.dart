...
class _AutomaticKeepAliveClientMixinProbe implements AutomaticKeepAliveClientMixin {
...
dynamic build(BuildContext context) {
  ...
  final _AutomaticKeepAliveClientMixinProbe primary = _AutomaticKeepAliveClientMixinProbe('primary', seed: 7);
  final _AutomaticKeepAliveClientMixinProbe edge = _AutomaticKeepAliveClientMixinProbe('', seed: -3);
  final _AutomaticKeepAliveClientMixinProbe large = _AutomaticKeepAliveClientMixinProbe('large-case', seed: 999);
