// Comprehensive D4rt test script: RestorableDoubleN from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableDoubleN script ===');
  ...
  detailLines.add('target=RestorableDoubleN');
  ...
  final RestorableDoubleN prop = RestorableDoubleN(null);
  check(prop is RestorableDoubleN, 'Created');
