// Comprehensive D4rt test script: FixedExtentScrollController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive FixedExtentScrollController script ===');
  ...
  detailLines.add('target=FixedExtentScrollController');
  ...
  // FixedExtentScrollController: controls fixed-extent scroll views
  final FixedExtentScrollController ctrl = FixedExtentScrollController(initialItem: 3);
  check(ctrl is FixedExtentScrollController, 'Controller created');
  check(ctrl.initialItem == 3, 'Initial item is 3');
  check(ctrl is ScrollController, 'Is a ScrollController');
  detailLines.add('initialItem=' + ctrl.initialItem.toString());
  ctrl.dispose();
  detailLines.add('disposed=true');
