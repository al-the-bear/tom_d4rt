// Comprehensive D4rt test script: ScrollableState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollableState script ===');
  ...
  detailLines.add('target=ScrollableState');
  ...
  const String targetTypeName = 'ScrollableState';
  check(targetTypeName.contains('State'), 'Name includes State');
  detailLines.add('description=State for Scrollable widget');
  final Widget scrollable = const SingleChildScrollView(child: SizedBox(height: 1000));
  check(scrollable is SingleChildScrollView, 'Scrollable created');
