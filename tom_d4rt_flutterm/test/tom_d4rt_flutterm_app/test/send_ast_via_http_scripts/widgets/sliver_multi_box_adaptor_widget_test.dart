// Comprehensive D4rt test script: SliverMultiBoxAdaptorWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverMultiBoxAdaptorWidget script ===');
  ...
  detailLines.add('target=SliverMultiBoxAdaptorWidget');
  ...
  const String targetTypeName = 'SliverMultiBoxAdaptorWidget';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=Base for multi-box adaptor sliver widgets');
  // SliverList extends SliverMultiBoxAdaptorWidget
  final SliverList sliverList = SliverList(delegate: SliverChildListDelegate(const <Widget>[SizedBox(height: 40)]));
  check(sliverList is Widget, 'SliverList is Widget');
  detailLines.add('example=SliverList');
