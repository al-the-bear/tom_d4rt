// Comprehensive D4rt test script: Title from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Title script ===');
  ...
  final Title title = Title(title: 'My App', color: const Color(0xFF42A5F5), child: const SizedBox());
  check(title is Widget, 'Is Widget');
  check(title.title == 'My App', 'Title text');
  check(title.color == const Color(0xFF42A5F5), 'Color');
  detailLines.add('title=My App');
