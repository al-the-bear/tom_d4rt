// Comprehensive D4rt test script: EnableWidgetInspectorScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive EnableWidgetInspectorScope script ===');
  ...
  detailLines.add('target=EnableWidgetInspectorScope');
  ...
  const String targetTypeName = 'EnableWidgetInspectorScope';
  check(targetTypeName.contains('Inspector'), 'Name includes Inspector');
  detailLines.add('description=Scopes widget inspector enable state');
  // Inspector-related but not directly importable
  final Widget inspectorTarget = Container(child: const Text('Inspector scope'));
  check(inspectorTarget is Container, 'Container for inspector scope created');
