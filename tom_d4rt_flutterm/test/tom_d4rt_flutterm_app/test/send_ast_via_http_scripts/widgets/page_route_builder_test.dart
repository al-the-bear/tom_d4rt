// Comprehensive D4rt test script: PageRouteBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PageRouteBuilder script ===');
  ...
  detailLines.add('target=PageRouteBuilder');
  ...
  final PageRouteBuilder<void> route = PageRouteBuilder<void>(
    pageBuilder: (BuildContext ctx, Animation<double> anim, Animation<double> secAnim) {
      return const Text('Page route');
    },
    transitionsBuilder: (BuildContext ctx, Animation<double> anim, Animation<double> secAnim, Widget child) {
      return FadeTransition(opacity: anim, child: child);
    },
  );
  check(route is PageRouteBuilder, 'PageRouteBuilder created');
  check(route is PageRoute, 'Is a PageRoute');
