// Comprehensive D4rt test script: SnapshotWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SnapshotWidget script ===');
  ...
  detailLines.add('target=SnapshotWidget');
  ...
  const String targetTypeName = 'SnapshotWidget';
  detailLines.add('category=widgets_snapshot');
  detailLines.add('desc=Widget that rasterizes its child');
  final SnapshotController ctrl = SnapshotController();
  final SnapshotWidget snap = SnapshotWidget(controller: ctrl, child: const SizedBox(width: 100, height: 100));
  check(snap is Widget, 'Is Widget');
  ctrl.dispose();
