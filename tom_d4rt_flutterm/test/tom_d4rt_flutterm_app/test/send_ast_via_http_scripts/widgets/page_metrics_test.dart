// Comprehensive D4rt test script: PageMetrics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PageMetrics script ===');
  ...
  detailLines.add('target=PageMetrics');
  ...
  const String targetTypeName = 'PageMetrics';
  check(targetTypeName.contains('Metrics'), 'Name includes Metrics');
  detailLines.add('description=Scroll metrics for PageView');
  final PageController pc = PageController(initialPage: 2);
  check(pc.initialPage == 2, 'Initial page is 2');
  pc.dispose();
