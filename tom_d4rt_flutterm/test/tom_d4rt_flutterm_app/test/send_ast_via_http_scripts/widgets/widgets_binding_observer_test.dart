...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    observerA is WidgetsBindingObserver,
    'observerA implements WidgetsBindingObserver',
    logs,
    counters,
  );
  expectCondition(
    observerB is WidgetsBindingObserver,
    'observerB implements WidgetsBindingObserver',
    logs,
    counters,
  );
  expectCondition(
    binding is WidgetsBinding,
    'binding available for observer lifecycle',
    logs,
    counters,
  );
