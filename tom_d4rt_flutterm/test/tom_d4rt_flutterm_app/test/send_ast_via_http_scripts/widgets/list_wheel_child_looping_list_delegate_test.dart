// Comprehensive D4rt test script: ListWheelChildLoopingListDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ListWheelChildLoopingListDelegate script ===');
  ...
  detailLines.add('target=ListWheelChildLoopingListDelegate');
  ...
  final ListWheelChildLoopingListDelegate delegate = ListWheelChildLoopingListDelegate(
    children: const <Widget>[Text('X'), Text('Y'), Text('Z')],
  );
  check(delegate is ListWheelChildDelegate, 'Is ListWheelChildDelegate');
  detailLines.add('type=looping');
