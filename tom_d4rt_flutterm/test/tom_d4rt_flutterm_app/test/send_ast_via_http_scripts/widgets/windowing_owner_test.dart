// Comprehensive D4rt test script: WindowingOwner from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WindowingOwner script ===');
  ...
  detailLines.add('target=WindowingOwner');
  ...
  const String targetTypeName = 'WindowingOwner';
  detailLines.add('category=widgets_window');
  detailLines.add('desc=Abstract windowing owner');
  check(targetTypeName.contains('Windowing'), 'Has Windowing');
