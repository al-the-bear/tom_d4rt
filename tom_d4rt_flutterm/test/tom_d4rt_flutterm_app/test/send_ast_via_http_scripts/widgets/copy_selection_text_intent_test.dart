// Comprehensive D4rt test script: CopySelectionTextIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive CopySelectionTextIntent script ===');
  ...
  final Type targetType = CopySelectionTextIntent;
  ...
  detailLines.add('target=CopySelectionTextIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('CopySelectionTextIntent'), 'Target type symbol resolves');
