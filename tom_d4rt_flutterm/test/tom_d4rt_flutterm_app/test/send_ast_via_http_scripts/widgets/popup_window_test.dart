// Comprehensive D4rt test script: PopupWindow from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopupWindow script ===');
  ...
  detailLines.add('target=PopupWindow');
  ...
  const String targetTypeName = 'PopupWindow';
  check(targetTypeName.contains('Popup'), 'Name includes Popup');
  detailLines.add('description=Popup window widget');
