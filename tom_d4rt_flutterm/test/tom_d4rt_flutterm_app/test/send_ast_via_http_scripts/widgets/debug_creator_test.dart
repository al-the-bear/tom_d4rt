// Comprehensive D4rt test script: DebugCreator from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DebugCreator script ===');
  ...
  final Type targetType = DebugCreator;
  ...
  detailLines.add('target=DebugCreator');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DebugCreator'), 'Target type symbol resolves');
