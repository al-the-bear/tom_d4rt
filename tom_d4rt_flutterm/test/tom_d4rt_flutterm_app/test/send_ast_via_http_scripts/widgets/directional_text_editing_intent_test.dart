// Comprehensive D4rt test script: DirectionalTextEditingIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DirectionalTextEditingIntent script ===');
  ...
  final Type targetType = DirectionalTextEditingIntent;
  ...
  detailLines.add('target=DirectionalTextEditingIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DirectionalTextEditingIntent'), 'Target type symbol resolves');
