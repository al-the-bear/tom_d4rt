// Comprehensive D4rt test script: Spacer from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive Spacer script ===');
  ...
  check(spacer is Widget, 'Is Widget');
  check(spacer.flex == 1, 'Default flex=1');
  const Spacer spacer2 = Spacer(flex: 3);
  check(spacer2.flex == 3, 'Custom flex=3');
  detailLines.add('flex=1,3');
