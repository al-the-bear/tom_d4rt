// Comprehensive D4rt test script: VoidCallbackAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive VoidCallbackAction script ===');
  ...
  detailLines.add('target=VoidCallbackAction');
  ...
  check(action is Action<VoidCallbackIntent>, 'Is Action');
  action.invoke(VoidCallbackIntent(() { called = true; }));
  check(called, 'Callback invoked');
  detailLines.add('invoked=true');
