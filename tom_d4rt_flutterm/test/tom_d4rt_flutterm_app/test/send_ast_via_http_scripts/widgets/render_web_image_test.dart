...
const String _targetClassName = 'RenderWebImage';

class RenderWebImageScenario {
  RenderWebImageScenario({
    required this.label,
  ...
  RenderWebImageScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return RenderWebImageScenario(
...
List<String> _runScenarioChecks(RenderWebImageScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = RenderWebImageScenario(
  ...
  _expect(_targetClassName == 'RenderWebImage', 'target class identifier should match filename');
