// Comprehensive D4rt test script: ProxyWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ProxyWidget script ===');
  ...
  detailLines.add('target=ProxyWidget');
  ...
  const String targetTypeName = 'ProxyWidget';
  check(targetTypeName.contains('Proxy'), 'Name includes Proxy');
  detailLines.add('description=Base for InheritedWidget and similar');
  // Theme is an InheritedWidget which extends ProxyWidget
  final ThemeData theme = Theme.of(context);
  check(theme is ThemeData, 'Theme resolved through ProxyWidget chain');
