// Comprehensive D4rt test script: ExtendSelectionToLineBreakIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ExtendSelectionToLineBreakIntent script ===');
  ...
  detailLines.add('target=ExtendSelectionToLineBreakIntent');
  ...
  const String targetTypeName = 'ExtendSelectionToLineBreakIntent';
  check(targetTypeName == 'ExtendSelectionToLineBreakIntent', 'Target type name set');
  detailLines.add('boundary=lineBreak');
