// Comprehensive D4rt test script: ChildVicinity from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ChildVicinity script ===');
  ...
  final Type targetType = ChildVicinity;
  ...
  detailLines.add('target=ChildVicinity');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ChildVicinity'), 'Target type symbol resolves');
