// Comprehensive D4rt test script: IgnoreBaseline from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IgnoreBaseline script ===');
  ...
  detailLines.add('target=IgnoreBaseline');
  ...
  // IgnoreBaseline: child won't contribute to parent's baseline
  final Widget ignored = IgnoreBaseline(child: const Text('Baseline ignored'));
  check(ignored is IgnoreBaseline, 'IgnoreBaseline created');
  check(ignored is Widget, 'IgnoreBaseline is a Widget');
