// Comprehensive D4rt test script: LiveTextInputStatusNotifier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive LiveTextInputStatusNotifier script ===');
  ...
  detailLines.add('target=LiveTextInputStatusNotifier');
  ...
  const String targetTypeName = 'LiveTextInputStatusNotifier';
  check(targetTypeName.contains('LiveText'), 'Name includes LiveText');
  detailLines.add('description=Notifier for live text input status');
  final Widget textField = const TextField();
  check(textField is TextField, 'TextField (uses LiveText) created');
