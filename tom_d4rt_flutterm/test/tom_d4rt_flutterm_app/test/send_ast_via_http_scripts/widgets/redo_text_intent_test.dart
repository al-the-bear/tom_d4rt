// Comprehensive D4rt test script: RedoTextIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RedoTextIntent script ===');
  ...
  detailLines.add('target=RedoTextIntent');
  ...
  const String targetTypeName = 'RedoTextIntent';
  check(targetTypeName.contains('Redo'), 'Name includes Redo');
  detailLines.add('description=Intent to redo text editing');
  final TextEditingController tec = TextEditingController(text: 'redo test');
  check(tec.text == 'redo test', 'Controller text set');
  tec.dispose();
