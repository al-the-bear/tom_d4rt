...
dynamic build(BuildContext context) {
  print('========== SelectableRegionSelectionStatus comprehensive test start ==========' );

  final List<SelectableRegionSelectionStatus> values = SelectableRegionSelectionStatus.values.toList(growable: false);
  _expect(values.isNotEmpty, 'SelectableRegionSelectionStatus exposes at least one enum value');
  _expect(
  ...
  final List<SelectableRegionSelectionStatus> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'SelectableRegionSelectionStatus checks passed: ${values.length} values validated';
  print(summary);
  print('========== SelectableRegionSelectionStatus comprehensive test end ==========' );
