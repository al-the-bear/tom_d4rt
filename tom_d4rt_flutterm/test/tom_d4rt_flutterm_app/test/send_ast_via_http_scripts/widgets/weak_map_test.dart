// Comprehensive D4rt test script: WeakMap from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WeakMap script ===');
  ...
  detailLines.add('target=WeakMap');
  ...
  const String targetTypeName = 'WeakMap';
  detailLines.add('category=widgets_util');
  detailLines.add('desc=Map with weak key references');
  check(targetTypeName.contains('Weak'), 'Has Weak');
