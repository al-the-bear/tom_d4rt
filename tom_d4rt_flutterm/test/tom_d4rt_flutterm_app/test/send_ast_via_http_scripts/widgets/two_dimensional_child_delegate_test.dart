// Comprehensive D4rt test script: TwoDimensionalChildDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalChildDelegate script ===');
  ...
  detailLines.add('target=TwoDimensionalChildDelegate');
  ...
  const String targetTypeName = 'TwoDimensionalChildDelegate';
  detailLines.add('category=widgets_2d');
  detailLines.add('desc=Abstract delegate for 2D scrollable children');
  check(targetTypeName.contains('TwoDimensional'), 'Has TwoDimensional');
