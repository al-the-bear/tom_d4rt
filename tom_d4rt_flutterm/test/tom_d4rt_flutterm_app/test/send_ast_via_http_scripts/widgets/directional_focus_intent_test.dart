// Comprehensive D4rt test script: DirectionalFocusIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DirectionalFocusIntent script ===');
  ...
  final Type targetType = DirectionalFocusIntent;
  ...
  detailLines.add('target=DirectionalFocusIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DirectionalFocusIntent'), 'Target type symbol resolves');
