// Comprehensive D4rt test script: AnimatedPhysicalModel from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedPhysicalModel script ===');
  ...
  final Type targetType = AnimatedPhysicalModel;
  ...
  detailLines.add('target=AnimatedPhysicalModel');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedPhysicalModel'), 'Target type symbol resolves');
