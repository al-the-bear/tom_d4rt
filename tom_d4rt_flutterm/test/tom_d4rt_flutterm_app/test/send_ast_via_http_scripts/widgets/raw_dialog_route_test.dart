// Comprehensive D4rt test script: RawDialogRoute from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawDialogRoute script ===');
  ...
  detailLines.add('target=RawDialogRoute');
  ...
  check(route is RawDialogRoute, 'RawDialogRoute created');
  check(route is PopupRoute, 'Is a PopupRoute');
