// Comprehensive D4rt test script: ConstrainedLayoutBuilder from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ConstrainedLayoutBuilder script ===');
  ...
  final Type targetType = ConstrainedLayoutBuilder;
  ...
  detailLines.add('target=ConstrainedLayoutBuilder');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ConstrainedLayoutBuilder'), 'Target type symbol resolves');
