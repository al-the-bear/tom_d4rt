// Comprehensive D4rt test script: BannerPainter from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive BannerPainter script ===');
  ...
  final Type targetType = BannerPainter;
  ...
  detailLines.add('target=BannerPainter');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('BannerPainter'), 'Target type symbol resolves');
