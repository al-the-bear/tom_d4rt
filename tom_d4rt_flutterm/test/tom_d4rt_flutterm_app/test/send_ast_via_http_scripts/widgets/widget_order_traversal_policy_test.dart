// Comprehensive D4rt test script: WidgetOrderTraversalPolicy from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WidgetOrderTraversalPolicy script ===');
  ...
  detailLines.add('target=WidgetOrderTraversalPolicy');
  ...
  final WidgetOrderTraversalPolicy policy = WidgetOrderTraversalPolicy();
  check(policy is FocusTraversalPolicy, 'Is FocusTraversalPolicy');
  detailLines.add('desc=Traverses focus in widget order');
