// Comprehensive D4rt test script: ShortcutRegistryEntry from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ShortcutRegistryEntry script ===');
  ...
  detailLines.add('target=ShortcutRegistryEntry');
  ...
  const String targetTypeName = 'ShortcutRegistryEntry';
  check(targetTypeName == 'ShortcutRegistryEntry', 'Name matches');
  detailLines.add('category=widgets_shortcuts');
  detailLines.add('desc=Entry in the shortcut registry');
