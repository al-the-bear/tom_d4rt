// Comprehensive D4rt test script: SliverSemantics from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverSemantics script ===');
  ...
  detailLines.add('target=SliverSemantics');
  ...
  const String targetTypeName = 'SliverSemantics';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=Semantics node applied to sliver');
  check(targetTypeName.contains('Semantics'), 'Has Semantics');
