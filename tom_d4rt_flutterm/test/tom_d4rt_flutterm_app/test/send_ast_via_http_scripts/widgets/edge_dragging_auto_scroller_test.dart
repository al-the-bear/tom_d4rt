// Comprehensive D4rt test script: EdgeDraggingAutoScroller from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive EdgeDraggingAutoScroller script ===');
  ...
  detailLines.add('target=EdgeDraggingAutoScroller');
  ...
  const String targetTypeName = 'EdgeDraggingAutoScroller';
  check(targetTypeName == 'EdgeDraggingAutoScroller', 'Target type name set');
  detailLines.add('description=Auto-scrolls when dragging near edges');
  final ScrollController sc = ScrollController();
  final Widget lv = ListView(controller: sc, children: const <Widget>[Text('Edge scroll test')]);
  check(lv is ListView, 'ListView for edge scroll created');
  sc.dispose();
