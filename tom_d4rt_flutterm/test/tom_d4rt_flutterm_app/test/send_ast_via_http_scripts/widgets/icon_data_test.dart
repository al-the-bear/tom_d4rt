// Comprehensive D4rt test script: IconData from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive IconData script ===');
  ...
  detailLines.add('target=IconData');
  ...
  // IconData: describes an icon
  const IconData customIcon = IconData(0xe800, fontFamily: 'CustomIcons');
  check(customIcon.codePoint == 0xe800, 'Custom icon codePoint correct');
  check(customIcon.fontFamily == 'CustomIcons', 'Font family correct');
  detailLines.add('codePoint=0xe800');
  // Test built-in icon data
  final IconData homeIcon = Icons.home;
  check(homeIcon is IconData, 'Icons.home is IconData');
  check(homeIcon == Icons.home, 'Icons.home equality');
  check(homeIcon != customIcon, 'Different icons are not equal');
