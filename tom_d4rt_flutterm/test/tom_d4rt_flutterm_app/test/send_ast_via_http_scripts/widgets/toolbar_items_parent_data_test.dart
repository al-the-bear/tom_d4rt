// Comprehensive D4rt test script: ToolbarItemsParentData from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ToolbarItemsParentData script ===');
  ...
  detailLines.add('target=ToolbarItemsParentData');
  ...
  const String targetTypeName = 'ToolbarItemsParentData';
  detailLines.add('category=widgets_toolbar');
  detailLines.add('desc=Parent data for toolbar item layout');
  check(targetTypeName.contains('Toolbar'), 'Has Toolbar');
  check(targetTypeName.contains('ParentData'), 'Has ParentData');
