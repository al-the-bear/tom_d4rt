// Comprehensive D4rt test script: TickerMode from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TickerMode script ===');
  ...
  detailLines.add('target=TickerMode');
  ...
  const TickerMode tm = TickerMode(enabled: true, child: SizedBox());
  check(tm is Widget, 'Is Widget');
  check(tm.enabled == true, 'Enabled');
  const TickerMode tmOff = TickerMode(enabled: false, child: SizedBox());
  check(tmOff.enabled == false, 'Disabled');
  detailLines.add('enabled=true,false');
