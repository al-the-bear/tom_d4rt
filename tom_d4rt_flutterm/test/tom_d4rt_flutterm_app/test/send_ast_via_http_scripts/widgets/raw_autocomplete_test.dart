// Comprehensive D4rt test script: RawAutocomplete from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawAutocomplete script ===');
  ...
  detailLines.add('target=RawAutocomplete');
  ...
  final Widget raw = RawAutocomplete<String>(
    textEditingController: tec,
    focusNode: FocusNode(),
    optionsBuilder: (TextEditingValue value) async => <String>['a', 'b', 'c'],
    optionsViewBuilder: (BuildContext ctx, AutocompleteOnSelected<String> onSelected, Iterable<String> options) {
      return ListView(children: options.map((String o) => Text(o)).toList());
    },
    fieldViewBuilder: (BuildContext ctx, TextEditingController tc, FocusNode fn, VoidCallback onSubmitted) {
      return TextField(controller: tc, focusNode: fn);
    },
  );
  check(raw is RawAutocomplete, 'RawAutocomplete created');
  tec.dispose();
