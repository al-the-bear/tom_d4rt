// Comprehensive D4rt test script: AnimatedGridState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedGridState script ===');
  ...
  final Type targetType = AnimatedGridState;
  ...
  detailLines.add('target=AnimatedGridState');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedGridState'), 'Target type symbol resolves');
