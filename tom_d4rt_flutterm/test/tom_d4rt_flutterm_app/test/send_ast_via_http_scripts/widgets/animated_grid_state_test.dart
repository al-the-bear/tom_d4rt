...
dynamic build(BuildContext context) {
  ...
  runCase('AnimatedGridState symbol check', () {
    final Type t = AnimatedGridState;
    return t.toString().contains('AnimatedGridState');
  });
  ...
  runCase('AnimatedGrid symbol exists', () {
    final Type t = AnimatedGrid;
    return t.toString().contains('AnimatedGrid');
  });

  runCase('GlobalKey<AnimatedGridState> can be declared', () {
    final GlobalKey<AnimatedGridState> key = GlobalKey<AnimatedGridState>();
    return key.toString().contains('GlobalKey');
  });

  runCase('Summary string can be created', () {
    final String summary = 'animatedgridstate:'
