// Comprehensive D4rt test script: AppKitView from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AppKitView script ===');
  ...
  final Type targetType = AppKitView;
  ...
  detailLines.add('target=AppKitView');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AppKitView'), 'Target type symbol resolves');
