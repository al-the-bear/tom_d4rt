// Comprehensive D4rt test script: DeleteToNextWordBoundaryIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DeleteToNextWordBoundaryIntent script ===');
  ...
  final Type targetType = DeleteToNextWordBoundaryIntent;
  ...
  detailLines.add('target=DeleteToNextWordBoundaryIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DeleteToNextWordBoundaryIntent'), 'Target type symbol resolves');
