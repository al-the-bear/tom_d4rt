...
dynamic build(BuildContext context) {
  ...
  print('AutocompleteLastOptionIntent test executing');
  print('=' * 50);

  runCase('AutocompleteLastOptionIntent symbol check', () {
    final Type t = AutocompleteLastOptionIntent;
    return t.toString().contains('AutocompleteLastOptionIntent');
  });
  ...
  runCase('AutocompleteLastOptionIntent const constructor available', () {
    const AutocompleteLastOptionIntent intent = AutocompleteLastOptionIntent();
    return intent.runtimeType.toString().contains('AutocompleteLastOptionIntent');
  });

  runCase('Summary string can be created', () {
    final String summary = 'autocompletelastoptionintent:'
  ...
  return Column(
    ...
    children: <Widget>[
      const Text(
        'AutocompleteLastOptionIntent Tests',
