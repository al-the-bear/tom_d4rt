// Comprehensive D4rt test script: AutocompleteLastOptionIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AutocompleteLastOptionIntent script ===');
  ...
  final Type targetType = AutocompleteLastOptionIntent;
  ...
  detailLines.add('target=AutocompleteLastOptionIntent');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AutocompleteLastOptionIntent'), 'Target type symbol resolves');
