// Comprehensive D4rt test script: SliverAnimatedGridState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverAnimatedGridState script ===');
  ...
  detailLines.add('target=SliverAnimatedGridState');
  ...
  const String targetTypeName = 'SliverAnimatedGridState';
  detailLines.add('category=widgets_sliver');
  detailLines.add('desc=State object for SliverAnimatedGrid');
  check(targetTypeName.contains('State'), 'Name contains State');
