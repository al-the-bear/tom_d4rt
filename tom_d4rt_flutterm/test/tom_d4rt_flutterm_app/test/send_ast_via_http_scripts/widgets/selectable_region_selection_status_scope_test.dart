// Comprehensive D4rt test script: SelectableRegionSelectionStatusScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectableRegionSelectionStatusScope script ===');
  ...
  detailLines.add('target=SelectableRegionSelectionStatusScope');
  ...
  const String targetTypeName = 'SelectableRegionSelectionStatusScope';
  check(targetTypeName.contains('Selection'), 'Name includes Selection');
  detailLines.add('description=Scope for selectable region status');
  final Widget text = const SelectableText('Selectable');
  check(text is SelectableText, 'SelectableText created');
