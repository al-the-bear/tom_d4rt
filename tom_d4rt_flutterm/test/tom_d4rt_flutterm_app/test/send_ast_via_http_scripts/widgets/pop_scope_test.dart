// Comprehensive D4rt test script: PopScope from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PopScope script ===');
  ...
  detailLines.add('target=PopScope');
  ...
  final Widget popScope = PopScope(
    ...
    child: const Text('Pop scope content'),
  );
  check(popScope is PopScope, 'PopScope created');
  check(popScope is Widget, 'Is a Widget');
  detailLines.add('canPop=false');
