// Comprehensive D4rt test script: GestureRecognizerFactory from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive GestureRecognizerFactory script ===');
  ...
  detailLines.add('target=GestureRecognizerFactory');
  ...
  const String targetTypeName = 'GestureRecognizerFactory';
  check(targetTypeName == 'GestureRecognizerFactory', 'Target type name set');
  detailLines.add('description=Abstract factory for gesture recognizers');
  // GestureDetector uses factories internally
  final Widget gd = GestureDetector(onTap: () {}, child: const Text('Tap'));
  check(gd is GestureDetector, 'GestureDetector created (uses GestureRecognizerFactory)');
