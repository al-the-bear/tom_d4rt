// Comprehensive D4rt test script: TwoDimensionalChildBuilderDelegate from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive TwoDimensionalChildBuilderDelegate script ===');
  ...
  detailLines.add('target=TwoDimensionalChildBuilderDelegate');
  ...
  final TwoDimensionalChildBuilderDelegate delegate = TwoDimensionalChildBuilderDelegate(builder: (BuildContext ctx, ChildVicinity vicinity) { return const SizedBox(width: 50, height: 50); }, maxXIndex: 3, maxYIndex: 3);
  check(delegate is TwoDimensionalChildDelegate, 'Is TwoDimensionalChildDelegate');
  check(delegate.maxXIndex == 3, 'MaxX=3');
  check(delegate.maxYIndex == 3, 'MaxY=3');
  detailLines.add('grid=4x4');
