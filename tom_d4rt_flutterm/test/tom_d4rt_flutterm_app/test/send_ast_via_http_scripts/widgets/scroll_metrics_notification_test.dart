// Comprehensive D4rt test script: ScrollMetricsNotification from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollMetricsNotification script ===');
  ...
  detailLines.add('target=ScrollMetricsNotification');
  ...
  final Widget listener = NotificationListener<ScrollMetricsNotification>(
    onNotification: (ScrollMetricsNotification n) { print('metrics changed'); return true; },
    child: const SingleChildScrollView(child: SizedBox(height: 2000)),
  );
  check(listener is NotificationListener, 'ScrollMetricsNotification listener created');
