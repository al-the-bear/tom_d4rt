// Comprehensive D4rt test script: ScrollIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollIntent script ===');
  ...
  detailLines.add('target=ScrollIntent');
  ...
  const String targetTypeName = 'ScrollIntent';
  check(targetTypeName.contains('Intent'), 'Name includes Intent');
  detailLines.add('description=Intent to scroll');
  final Widget scrollView = const SingleChildScrollView(child: SizedBox(height: 2000, child: Text('Long')));
  check(scrollView is SingleChildScrollView, 'ScrollView created');
