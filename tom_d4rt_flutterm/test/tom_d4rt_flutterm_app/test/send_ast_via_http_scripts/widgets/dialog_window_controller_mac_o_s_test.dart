// Comprehensive D4rt test script: DialogWindowControllerMacOS from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DialogWindowControllerMacOS script ===');
  ...
  const String targetTypeName = 'DialogWindowControllerMacOS';
  ...
  detailLines.add('target=DialogWindowControllerMacOS');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetTypeName);

  check(targetTypeName == 'DialogWindowControllerMacOS', 'Target type symbol resolves');
