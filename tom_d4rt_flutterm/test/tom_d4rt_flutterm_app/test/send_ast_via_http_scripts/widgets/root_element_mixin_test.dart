...
dynamic build(BuildContext context) {
  ...
  final _RootElementMixinProbe primary = _RootElementMixinProbe('primary', seed: 7);
  final _RootElementMixinProbe edge = _RootElementMixinProbe('', seed: -3);
  final _RootElementMixinProbe large = _RootElementMixinProbe('large-case', seed: 999);
