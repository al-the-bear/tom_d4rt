// D4rt comprehensive test script for RootElementMixin
...
class _RootElementMixinProbe implements RootElementMixin {
  _RootElementMixinProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _RootElementMixinProbe probe,
...
dynamic build(BuildContext context) {
  print('=== RootElementMixin comprehensive script start ===');

  final _RootElementMixinProbe primary = _RootElementMixinProbe(
    'primary',
    seed: 7,
  );
  final _RootElementMixinProbe edge = _RootElementMixinProbe('', seed: -3);
  final _RootElementMixinProbe large = _RootElementMixinProbe(
    'large-case',
    seed: 999,
  );
  ...
  print('=== RootElementMixin comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('RootElementMixin Summary'),
