// Comprehensive D4rt test script: RestorableDateTime from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RestorableDateTime script ===');
  ...
  detailLines.add('target=RestorableDateTime');
  ...
  final RestorableDateTime prop = RestorableDateTime(DateTime(2026, 3, 15));
  check(prop is RestorableDateTime, 'Created');
  check(prop.value.year == 2026, 'Year is 2026');
  check(prop.value.month == 3, 'Month is 3');
  detailLines.add('year=' + prop.value.year.toString());
  prop.dispose();
