// Comprehensive D4rt test script: ActivateAction from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ActivateAction script ===');
  ...
  final Type targetType = ActivateAction;
  ...
  detailLines.add('target=ActivateAction');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('ActivateAction'), 'Target type symbol resolves');
