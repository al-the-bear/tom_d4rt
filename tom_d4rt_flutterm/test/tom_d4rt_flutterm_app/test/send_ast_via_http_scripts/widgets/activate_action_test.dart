...
dynamic build(BuildContext context) {
  ...
  runCase('ActivateAction symbol check', () {
    final Type t = ActivateAction;
    return t.toString().contains('ActivateAction');
  });
  ...
  runCase('ActivateAction type string is non-empty', () {
    final Type t = ActivateAction;
    return t.toString().isNotEmpty;
  });

  runCase('Summary string can be created', () {
    final String summary = 'activateaction:'
