...
dynamic build(BuildContext context) {
  print('========== ScrollPositionAlignmentPolicy comprehensive test start ==========' );

  final List<ScrollPositionAlignmentPolicy> values = ScrollPositionAlignmentPolicy.values.toList(growable: false);
  _expect(values.isNotEmpty, 'ScrollPositionAlignmentPolicy exposes at least one enum value');
  _expect(
  ...
  final List<ScrollPositionAlignmentPolicy> reversed = values.reversed.toList(growable: false);
  ...
  final String summary = 'ScrollPositionAlignmentPolicy checks passed: ${values.length} values validated';
  print(summary);
  print('========== ScrollPositionAlignmentPolicy comprehensive test end ==========' );
