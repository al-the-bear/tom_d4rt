// Comprehensive D4rt test script: SpellCheckConfiguration from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SpellCheckConfiguration script ===');
  ...
  detailLines.add('target=SpellCheckConfiguration');
  ...
  const String targetTypeName = 'SpellCheckConfiguration';
  detailLines.add('category=widgets_text');
  detailLines.add('desc=Configuration for spell check in text fields');
  check(targetTypeName.contains('SpellCheck'), 'Has SpellCheck');
