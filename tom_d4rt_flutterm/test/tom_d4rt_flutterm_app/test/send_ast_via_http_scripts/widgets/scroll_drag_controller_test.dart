// Comprehensive D4rt test script: ScrollDragController from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ScrollDragController script ===');
  ...
  detailLines.add('target=ScrollDragController');
  ...
  const String targetTypeName = 'ScrollDragController';
  check(targetTypeName.contains('Drag'), 'Name includes Drag');
  detailLines.add('description=Controller for scroll drag interactions');
