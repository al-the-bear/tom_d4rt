// Comprehensive D4rt test script: DefaultTextEditingShortcuts from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DefaultTextEditingShortcuts script ===');
  ...
  final Type targetType = DefaultTextEditingShortcuts;
  ...
  detailLines.add('target=DefaultTextEditingShortcuts');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('DefaultTextEditingShortcuts'), 'Target type symbol resolves');
