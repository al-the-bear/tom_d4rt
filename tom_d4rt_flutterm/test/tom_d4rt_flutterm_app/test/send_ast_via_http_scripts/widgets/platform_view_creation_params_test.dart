// Comprehensive D4rt test script: PlatformViewCreationParams from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformViewCreationParams script ===');
  ...
  detailLines.add('target=PlatformViewCreationParams');
  ...
  const String targetTypeName = 'PlatformViewCreationParams';
  check(targetTypeName.contains('View'), 'Name includes View');
  detailLines.add('description=Parameters for creating a platform view');
