// Comprehensive D4rt test script: SliverCrossAxisGroup from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverCrossAxisGroup script ===');
  ...
  detailLines.add('target=SliverCrossAxisGroup');
  ...
  const SliverCrossAxisGroup group = SliverCrossAxisGroup(slivers: <Widget>[SliverCrossAxisExpanded(flex: 1, sliver: SliverToBoxAdapter(child: SizedBox(height: 80))), SliverCrossAxisExpanded(flex: 2, sliver: SliverToBoxAdapter(child: SizedBox(height: 80)))]);
  check(group is Widget, 'Is Widget');
  check(group is Widget, 'Has slivers');
  detailLines.add('sliverCount=2');
