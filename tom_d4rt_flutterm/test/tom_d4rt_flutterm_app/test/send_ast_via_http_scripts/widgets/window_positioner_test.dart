// Comprehensive D4rt test script: WindowPositioner from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive WindowPositioner script ===');
  ...
  detailLines.add('target=WindowPositioner');
  ...
  const String targetTypeName = 'WindowPositioner';
  detailLines.add('category=widgets_window');
  detailLines.add('desc=Controls window position on screen');
  check(targetTypeName.contains('Positioner'), 'Has Positioner');
