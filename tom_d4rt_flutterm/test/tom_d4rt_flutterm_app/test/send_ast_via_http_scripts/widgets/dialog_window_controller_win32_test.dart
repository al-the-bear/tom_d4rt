// Comprehensive D4rt test script: DialogWindowControllerWin32 from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DialogWindowControllerWin32 script ===');
  ...
  const String targetTypeName = 'DialogWindowControllerWin32';
  ...
  detailLines.add('target=DialogWindowControllerWin32');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetTypeName);

  check(targetTypeName == 'DialogWindowControllerWin32', 'Target type symbol resolves');
