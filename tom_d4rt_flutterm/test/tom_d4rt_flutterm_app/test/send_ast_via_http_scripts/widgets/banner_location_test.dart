...
dynamic build(BuildContext context) {
  ...
  runCase('BannerLocation symbol exists', () {
    final Type t = BannerLocation;
    return t.toString().contains('BannerLocation');
  });

  runCase('BannerLocation type string stable', () {
    final Type t = BannerLocation;
  ...
  runCase('BannerLocation has topStart', () {
    return BannerLocation.values.contains(BannerLocation.topStart);
  });

  runCase('Summary string can be generated', () {
    final String summary = 'bannerlocation:'
