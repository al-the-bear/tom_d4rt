// Comprehensive D4rt test script: StatusTransitionWidget from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive StatusTransitionWidget script ===');
  ...
  detailLines.add('target=StatusTransitionWidget');
  ...
  const String targetTypeName = 'StatusTransitionWidget';
  detailLines.add('category=widgets_animation');
  detailLines.add('desc=Widget rebuilt on animation status changes');
  check(targetTypeName.contains('Transition'), 'Has Transition');
  check(targetTypeName.contains('Status'), 'Has Status');
