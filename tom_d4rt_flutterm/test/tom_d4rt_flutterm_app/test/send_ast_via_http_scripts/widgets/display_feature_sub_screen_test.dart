// Comprehensive D4rt test script: DisplayFeatureSubScreen from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DisplayFeatureSubScreen script ===');
  ...
  detailLines.add('target=DisplayFeatureSubScreen');
  ...
  // DisplayFeatureSubScreen: positions child to avoid display features
  final Widget subScreen = DisplayFeatureSubScreen(
    anchorPoint: const Offset(100, 200),
    child: const Text('Sub screen content'),
  );
  check(subScreen is DisplayFeatureSubScreen, 'DisplayFeatureSubScreen created');
  check(subScreen is Widget, 'DisplayFeatureSubScreen is a Widget');
  detailLines.add('anchorPoint=Offset(100, 200)');
