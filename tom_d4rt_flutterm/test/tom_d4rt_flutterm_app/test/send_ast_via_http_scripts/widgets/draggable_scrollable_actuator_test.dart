// Comprehensive D4rt test script: DraggableScrollableActuator from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive DraggableScrollableActuator script ===');
  ...
  detailLines.add('target=DraggableScrollableActuator');
  ...
  // DraggableScrollableActuator: resets DraggableScrollableSheet
  final GlobalKey<State> sheetKey = GlobalKey<State>();
  final Widget actuator = DraggableScrollableActuator(
    child: Container(key: sheetKey, child: const Text('Sheet content')),
  );
  check(actuator is DraggableScrollableActuator, 'Actuator created');
  check(actuator is Widget, 'Actuator is a Widget');
