// Comprehensive D4rt test script: ExtendSelectionByPageIntent from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive ExtendSelectionByPageIntent script ===');
  ...
  detailLines.add('target=ExtendSelectionByPageIntent');
  ...
  const String targetTypeName = 'ExtendSelectionByPageIntent';
  check(targetTypeName == 'ExtendSelectionByPageIntent', 'Target type name set');
