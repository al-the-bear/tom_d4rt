// Comprehensive D4rt test script: SelectionDetails from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SelectionDetails script ===');
  ...
  detailLines.add('target=SelectionDetails');
  ...
  const String targetTypeName = 'SelectionDetails';
  check(targetTypeName.contains('Details'), 'Name includes Details');
  detailLines.add('description=Details about text selection state');
