// Comprehensive D4rt test script: SliverAnimatedOpacity from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive SliverAnimatedOpacity script ===');
  ...
  detailLines.add('target=SliverAnimatedOpacity');
  ...
  final SliverAnimatedOpacity opacity = SliverAnimatedOpacity(opacity: 0.5, duration: const Duration(milliseconds: 300), sliver: const SliverToBoxAdapter(child: SizedBox(height: 100)));
  check(opacity is Widget, 'Is Widget');
  check(opacity.opacity == 0.5, 'Opacity=0.5');
  detailLines.add('opacity=0.5');
  detailLines.add('duration=300ms');
