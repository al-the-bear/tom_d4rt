// Comprehensive D4rt test script: AnimatedModalBarrier from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive AnimatedModalBarrier script ===');
  ...
  final Type targetType = AnimatedModalBarrier;
  ...
  detailLines.add('target=AnimatedModalBarrier');
  detailLines.add('package=widgets');
  detailLines.add('buildContextType=' + context.runtimeType.toString());
  detailLines.add('targetType=' + targetType.toString());

  check(targetType.toString().contains('AnimatedModalBarrier'), 'Target type symbol resolves');
