// Comprehensive D4rt test script: LayoutId from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive LayoutId script ===');
  ...
  detailLines.add('target=LayoutId');
  ...
  final Widget lid = LayoutId(id: 'header', child: const Text('Header'));
  check(lid is LayoutId, 'LayoutId created');
  check(lid is ParentDataWidget, 'LayoutId is a ParentDataWidget');
  detailLines.add('layoutId=header');
