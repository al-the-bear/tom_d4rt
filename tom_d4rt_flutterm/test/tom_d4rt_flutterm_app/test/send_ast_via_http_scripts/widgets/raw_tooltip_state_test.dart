// Comprehensive D4rt test script: RawTooltipState from widgets
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive RawTooltipState script ===');
  ...
  detailLines.add('target=RawTooltipState');
  ...
  const String targetTypeName = 'RawTooltipState';
  check(targetTypeName.contains('Tooltip'), 'Name includes Tooltip');
  detailLines.add('description=State for Tooltip widget');
  final Widget tip = Tooltip(message: 'Hello', child: const Icon(Icons.info));
  check(tip is Tooltip, 'Tooltip created');
