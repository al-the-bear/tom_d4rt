// D4rt comprehensive test script for RenderAbstractLayoutBuilderMixin
...
class _RenderAbstractLayoutBuilderMixinProbe
    implements RenderAbstractLayoutBuilderMixin {
  _RenderAbstractLayoutBuilderMixinProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _RenderAbstractLayoutBuilderMixinProbe probe,
...
dynamic build(BuildContext context) {
  print('=== RenderAbstractLayoutBuilderMixin comprehensive script start ===');

  final _RenderAbstractLayoutBuilderMixinProbe primary =
      _RenderAbstractLayoutBuilderMixinProbe('primary', seed: 7);
  final _RenderAbstractLayoutBuilderMixinProbe edge =
      _RenderAbstractLayoutBuilderMixinProbe('', seed: -3);
  final _RenderAbstractLayoutBuilderMixinProbe large =
      _RenderAbstractLayoutBuilderMixinProbe('large-case', seed: 999);
  ...
  print('=== RenderAbstractLayoutBuilderMixin comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('RenderAbstractLayoutBuilderMixin Summary'),
