...
// D4rt comprehensive test script for AutofillContextAction
...
dynamic build(BuildContext context) {
  ...
  print('========== AutofillContextAction comprehensive test ==========' );

  final List<AutofillContextAction> values = AutofillContextAction.values;
  expectCondition(values.isNotEmpty, 'AutofillContextAction.values should not be empty', logs, counters);
  expectCondition(values.length >= 2, 'AutofillContextAction should provide multiple values', logs, counters);

  final AutofillContextAction first = values.first;
  final AutofillContextAction last = values.last;
  ...
  for (final AutofillContextAction value in values) {
    ...
    final AutofillContextAction byName = AutofillContextAction.values.byName(value.name);
  ...
  final List<AutofillContextAction> copied = List<AutofillContextAction>.from(values);
  ...
  final List<AutofillContextAction> reversed = values.reversed.toList(growable: false);
  ...
  final AutofillContextAction edgeByName = AutofillContextAction.values.byName(edgeName);
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Text('AutofillContextAction Comprehensive Tests'),
