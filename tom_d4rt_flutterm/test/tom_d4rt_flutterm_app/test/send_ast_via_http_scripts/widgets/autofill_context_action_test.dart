...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    values.isNotEmpty,
    'AutofillContextAction.values should not be empty',
    logs,
    counters,
  );
  expectCondition(
    values.length >= 2,
    'AutofillContextAction should provide multiple values',
    logs,
    counters,
  );
  ...
  for (final AutofillContextAction value in values) {
    ...
    final AutofillContextAction byName = AutofillContextAction.values.byName(
      value.name,
    );
    expectCondition(
      byName == value,
  ...
  final List<AutofillContextAction> copied = List<AutofillContextAction>.from(
    values,
  );
  expectCondition(
  ...
  final List<AutofillContextAction> reversed = values.reversed.toList(
    growable: false,
  );
  expectCondition(
    reversed.first == last,
  ...
  final AutofillContextAction edgeByName = AutofillContextAction.values.byName(
    edgeName,
  );
  expectCondition(
