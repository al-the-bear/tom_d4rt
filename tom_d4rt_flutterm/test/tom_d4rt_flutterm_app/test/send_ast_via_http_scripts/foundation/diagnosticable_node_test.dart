...
dynamic build(BuildContext context) {
  ...
  final nodeA = DiagnosticableNode<TextStyle>(
    name: 'styleA',
    value: styleA,
    style: DiagnosticsTreeStyle.singleLine,
  );
  final nodeB = DiagnosticableNode<TextStyle>(
    name: 'styleB',
    value: styleB,
    style: DiagnosticsTreeStyle.dense,
  );
  expectCondition(
    nodeA is DiagnosticableNode<TextStyle>,
    'nodeA instantiated',
    logs,
    counters,
  );
  expectCondition(
    nodeB is DiagnosticsNode,
    'nodeB is also a DiagnosticsNode',
    logs,
    counters,
  );
  expectCondition(
    nodeA.toString().contains('styleA'),
    'nodeA string references name',
    logs,
    counters,
  );
  expectCondition(
    nodeB.toString().contains('styleB'),
    'nodeB string references name',
    logs,
    counters,
  );
