...
const String _targetClassName = 'Summary';
...
List<String> _runScenarioChecks(SummaryScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = SummaryScenario(
  ...
  _expect(_targetClassName == 'Summary', 'target class identifier should match filename');
