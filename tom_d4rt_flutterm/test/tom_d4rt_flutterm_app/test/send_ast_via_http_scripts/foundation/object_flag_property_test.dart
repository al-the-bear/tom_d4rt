// D4rt comprehensive test script for ObjectFlagProperty
...
dynamic build(BuildContext context) {
  const targetClassName = 'ObjectFlagProperty';
  const testLabel = 'ObjectFlagProperty';
  final logs = <String>[];
  ...
  final propA = ObjectFlagProperty<Function>('callback', () {}, ifPresent: 'callback-present');
  final propB = ObjectFlagProperty<Function>.has('onTap', () {});
  final propEdge = ObjectFlagProperty<Function>.has('onLongPress', null);
  expectCondition(propA is ObjectFlagProperty<Function>, 'propA created via constructor', logs, counters);
  expectCondition(propB is ObjectFlagProperty<Function>, 'propB created via .has constructor', logs, counters);
  expectCondition(propEdge.level != null, 'edge instance exposes diagnostics level', logs, counters);
  details['constructorA'] = propA.toString();
  details['constructorB'] = propB.toString();
  details['edgeToString'] = propEdge.toString();
