...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    nodeA is DiagnosticsNode,
    'nodeA is diagnostics node',
    logs,
    counters,
  );
  expectCondition(
    nodeB.toDescription().contains('traceB'),
    'nodeB description includes provided label',
    logs,
    counters,
  );
  expectCondition(
    nodeA.level != null,
    'nodeA exposes diagnostics level',
    logs,
    counters,
  );
  expectCondition(
    nodeB.level != null,
    'nodeB exposes diagnostics level',
    logs,
    counters,
  );
