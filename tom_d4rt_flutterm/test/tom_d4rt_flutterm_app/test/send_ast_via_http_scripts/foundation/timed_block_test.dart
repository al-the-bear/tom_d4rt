...
const String _targetClassName = 'TimedBlock';

class TimedBlockScenario {
  TimedBlockScenario({
    required this.label,
  ...
  TimedBlockScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return TimedBlockScenario(
...
List<String> _runScenarioChecks(TimedBlockScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = TimedBlockScenario(
  ...
  _expect(_targetClassName == 'TimedBlock', 'target class identifier should match filename');
