...
dynamic build(BuildContext context) {
  ...
  expectCondition(
    childA.parent == root,
    'ChildA parent is root',
    logs,
    counters,
  );
  expectCondition(
    childB.parent == root,
    'ChildB parent is root',
    logs,
    counters,
  );
  ...
  expectCondition(
    childB.parent == null,
    'ChildB parent is cleared after removal',
    logs,
    counters,
  );
  expectCondition(
    childB.attached == false,
    'ChildB detaches after removal from attached root',
    logs,
    counters,
  );
  root.detach();
  expectCondition(
    root.attached == false,
    'Root detaches cleanly',
    logs,
    counters,
  );
  expectCondition(
    childA.attached == false,
    'Remaining child detaches with root',
    logs,
    counters,
  );
