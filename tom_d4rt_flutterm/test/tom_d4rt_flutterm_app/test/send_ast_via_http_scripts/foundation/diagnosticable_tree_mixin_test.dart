...
const String _targetClassName = 'DiagnosticableTreeMixin';

class DiagnosticableTreeMixinScenario {
  DiagnosticableTreeMixinScenario({
    required this.label,
  ...
  DiagnosticableTreeMixinScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return DiagnosticableTreeMixinScenario(
...
List<String> _runScenarioChecks(DiagnosticableTreeMixinScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = DiagnosticableTreeMixinScenario(
  ...
  _expect(_targetClassName == 'DiagnosticableTreeMixin', 'target class identifier should match filename');
