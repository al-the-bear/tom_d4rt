...
dynamic build(BuildContext context) {
  ...
  _expect(
    empty['alpha'] == null,
    'empty map should return null for unknown key',
  );
  _expect(
    empty['beta'] == null,
    'empty map should return null for unknown key beta',
  );
  ...
  print(
    'mapC alpha=${mapC['alpha']} beta=${mapC['beta']} gamma=${mapC['gamma']}',
  );
  ...
  _expect(
    identical(mapNoOp, mapOverwrite),
    'put with same value should return identical instance',
  );
  ...
  _expect(
    lookupChecks['alpha@mapOverwrite'] == 100,
    'alpha@mapOverwrite expected 100',
  );
