...
const String _targetClassName = 'DocumentationIcon';

class DocumentationIconScenario {
  DocumentationIconScenario({
    required this.label,
  ...
  DocumentationIconScenario copyWith({
    String? label,
    List<double>? sampleValues,
    List<bool>? flags,
    Map<String, String>? metadata,
  }) {
    return DocumentationIconScenario(
...
List<String> _runScenarioChecks(DocumentationIconScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = DocumentationIconScenario(
  ...
  _expect(_targetClassName == 'DocumentationIcon', 'target class identifier should match filename');
