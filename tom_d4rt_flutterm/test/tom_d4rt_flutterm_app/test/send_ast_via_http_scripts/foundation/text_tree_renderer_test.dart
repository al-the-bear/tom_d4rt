...
dynamic build(BuildContext context) {
  ...
  print('Render output (first 80): ${output.substring(0, output.length > 80 ? 80 : output.length)}');

  // Render with different level
  final renderer2 = TextTreeRenderer(minLevel: DiagnosticLevel.fine, maxDescendentsTruncatableNode: 5);
  ...
  return Column(mainAxisSize: MainAxisSize.min, children: [
    Text('TextTreeRenderer Tests', style: TextStyle(fontWeight: FontWeight.bold)),
