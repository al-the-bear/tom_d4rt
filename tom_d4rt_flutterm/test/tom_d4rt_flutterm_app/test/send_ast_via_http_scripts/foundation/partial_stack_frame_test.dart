...
dynamic build(BuildContext context) {
  ...
  log(
    'partial package=${partial.package} class=${partial.className} method=${partial.method}',
  );
  log(
    'partialTwo package=${partialTwo.package} class=${partialTwo.className} method=${partialTwo.method}',
  );
  expectCheck(
    partial.package.contains('flutter'),
    'package should include flutter',
  );
  expectCheck(partial.className == 'Element', 'className should be Element');
  expectCheck(
    partial.method == 'rebuild',
    'method should match constructor input',
  );
  ...
  final frame = StackFrame(
    ...
    method: 'rebuild',
    source:
        '#0 Element.rebuild (package:flutter/src/widgets/framework.dart:120:5)',
  );
  ...
  expectCheck(
    parsed.first.className == 'Element',
    'first parsed class should be Element',
  );
