...
const String _targetClassName = 'Category';
...
List<String> _runScenarioChecks(CategoryScenario scenario) {
  final output = <String>[];
...
dynamic build(BuildContext context) {
  ...
  final scenario = CategoryScenario(
  ...
  _expect(_targetClassName == 'Category', 'target class identifier should match filename');
