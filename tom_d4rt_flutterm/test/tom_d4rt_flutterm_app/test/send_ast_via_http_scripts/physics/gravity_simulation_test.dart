...
dynamic build(BuildContext context) {
  ...
  results.add(
    'Test 1: Constructor with acceleration=9.8, distance=0, endDistance=100, velocity=0',
  );
  print(
    'Created GravitySimulation: acceleration=9.8, distance=0, endDistance=100, velocity=0',
  );
  ...
  assert(
    posWithVel > posAtOne,
    'Position should be greater with initial velocity',
  );
  ...
  assert(
    negVelAtOne < 0.0,
    'Velocity should be negative with negative acceleration',
  );
  ...
  return Column(
    ...
    children: [
      Text(
        'GravitySimulation Tests (${results.length} tests)',
