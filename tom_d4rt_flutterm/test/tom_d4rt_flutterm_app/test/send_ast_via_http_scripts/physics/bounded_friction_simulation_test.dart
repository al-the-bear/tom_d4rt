...
dynamic build(BuildContext context) {
  ...
  results.add(
    'Test 1: BoundedFrictionSimulation(drag=0.5, pos=50, vel=100, minX=0, maxX=100)',
  );
  ...
  results.add(
    'Velocity comparison: highDrag=$highDragVel, lowDrag=$lowDragVel',
  );
  ...
  assert(
    zeroVelPos == 50.0,
    'Position should remain constant with zero velocity',
  );
  ...
  return Column(
    ...
    children: [
      Text(
        'BoundedFrictionSimulation Tests (${results.length} tests)',
