...
dynamic build(BuildContext context) {
  ...
  _expect(
    layerA is ui.ClipPathEngineLayer,
    'pushClipPath returns ClipPathEngineLayer',
    logs,
  );
  assertionCount++;
  _expect(
    layerA.runtimeType.toString().contains('ClipPathEngineLayer'),
    'runtime type includes ClipPathEngineLayer',
    logs,
  );
  assertionCount++;
  ...
  final pathB = ui.Path()
    ...
    ..lineTo(15, 30)
    ..close();
  final layerB = builder.pushClipPath(
    pathB,
  ...
  _expect(
    layerB is ui.ClipPathEngineLayer,
    'pushClipPath with oldLayer returns layer',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    edgeLayer is ui.ClipPathEngineLayer,
    'edge empty path still returns layer',
    logs,
  );
  assertionCount++;
