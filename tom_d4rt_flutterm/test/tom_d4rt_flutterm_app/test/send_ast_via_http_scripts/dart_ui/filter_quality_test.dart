          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 12),
                    Text('FilterQuality Deep Demo',
                      style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold,
                        color: Colors.white)),
                    SizedBox(height: 6),
                    Text('Image sampling quality levels',
              ...
              Padding(
                ...
                child: Text('Simulated quality difference when scaling images',
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Container(width: 12, height: 12, color: Color(0xFFFFCDD2)),
                            SizedBox(width: 4),
                        ...
                        Row(
                          children: [
                            Container(width: 12, height: 12, color: Color(0xFFC8E6C9)),
                            SizedBox(width: 4),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _algorithmRow('none', 'Nearest Neighbor',
                      'Picks closest pixel. No interpolation.',
                      Icons.grid_4x4, Color(0xFFC62828)),
                    Divider(height: 20),
                    _algorithmRow('low', 'Bilinear',
                      'Weighted average of 4 nearest pixels.',
                      Icons.blur_linear, Color(0xFFE65100)),
                    Divider(height: 20),
                    _algorithmRow('medium', 'Bilinear + Mipmaps',
                      'Pre-computed reduced versions for downscaling.',
                      Icons.blur_on, Color(0xFF1565C0)),
                    Divider(height: 20),
                    _algorithmRow('high', 'Bicubic',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _useCaseRow(Icons.videogame_asset, 'Pixel Art',
                      'none — preserves sharp pixel edges', Color(0xFFC62828)),
                    Divider(height: 16),
                    _useCaseRow(Icons.list, 'List Thumbnails',
                      'low — fast rendering for many items', Color(0xFFE65100)),
                    Divider(height: 16),
                    _useCaseRow(Icons.photo_library, 'Photo Gallery',
                      'medium — good balance for images', Color(0xFF1565C0)),
                    Divider(height: 16),
                    _useCaseRow(Icons.zoom_in, 'Image Zoom/Detail',
                      'high — maximum quality for key visuals', Color(0xFF2E7D32)),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _equalityRow('none == none', none == ui.FilterQuality.none, true),
                    SizedBox(height: 8),
...
Widget _qualityCard(ui.FilterQuality quality, String name, String desc,
    IconData icon, Color color, double qualityLevel, double speedLevel) {
  return Container(
      ...
      children: [
        Row(
          children: [
            ...
            SizedBox(width: 12),
            Text('FilterQuality.$name', style: TextStyle(
          ...
          children: [
            ...
            Expanded(
              child: Container(
                height: 6,
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(3), color: Color(0xFFEEEEEE)),
            ...
            Expanded(
              child: Container(
                ...
                child: FractionallySizedBox(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(3), color: Color(0xFF78909C)),
                  ),
                ),
              ),
            ),
    ...
    child: Column(
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(8),
            gradient: pixelated ? null : LinearGradient(
    ...
    children: [
      ...
      Expanded(
        child: Container(
          height: 16,
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(8), color: Color(0xFFFFCDD2)),
          child: FractionallySizedBox(
            widthFactor: speed, alignment: Alignment.centerLeft,
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(8), color: color.withValues(alpha: 0.6)),
            ),
          ),
        ),
      ),
      ...
      Expanded(
        child: Container(
          height: 16,
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(8), color: Color(0xFFC8E6C9)),
          child: FractionallySizedBox(
            widthFactor: quality, alignment: Alignment.centerLeft,
            child: Container(
              decoration: BoxDecoration(
...
Widget _algorithmRow(String name, String algo, String desc, IconData icon, Color color) {
  return Row(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Container(
...
Widget _indexRow(ui.FilterQuality q) {
  return Padding(
    ...
    child: Row(
      children: [
        Text(q.name, style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13)),
        Spacer(),
        Container(
          padding: EdgeInsets.symmetric(horizontal: 10, vertical: 4),
          decoration: BoxDecoration(
            color: Color(0xFFF5F5F5), borderRadius: BorderRadius.circular(8)),
          child: Text('index: ${q.index}',
