...
dynamic build(BuildContext context) {
  ...
  _expectCondition(FilterQuality.values.byName(first.name) == first, 'byName resolves first value');
  _expectCondition(FilterQuality.values.byName(last.name) == last, 'byName resolves last value');
  ...
  _expectCondition(first == FilterQuality.values[first.index], 'First value round-trips from index');
  _expectCondition(last == FilterQuality.values[last.index], 'Last value round-trips from index');
  ...
  _expectCondition(invalidNameThrows, 'Invalid byName lookup throws for FilterQuality');
