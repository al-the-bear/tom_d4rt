...
dynamic build(BuildContext context) {
  ...
  for (final flag in values) {
    ...
    expectCheck(
      identical(byName, flag),
      'byName should return identical enum value',
    );
  }
  ...
  expectCheck(
    ...
    'enum names should be unique',
  );
  expectCheck(
    uniqueIndices.length == values.length,
    'enum indices should be unique',
  );
