...
dynamic build(BuildContext context) {
  ...
  expectCheck(
    ui.FragmentProgram.toString().contains('FragmentProgram'),
    'type string should include FragmentProgram',
  );
  expectCheck(
    ui.FragmentShader.toString().contains('FragmentShader'),
    'type string should include FragmentShader',
  );

  final assetFuture = ui.FragmentProgram.fromAsset(
    'shaders/non_existing_shader.frag',
  );
  log('fromAsset future runtimeType=${assetFuture.runtimeType}');
  expectCheck(
    assetFuture is Future<ui.FragmentProgram>,
    'fromAsset should return Future<FragmentProgram>',
  );
