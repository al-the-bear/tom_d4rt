...
dynamic build(BuildContext context) {
  ...
  _expectCondition(values.isNotEmpty, 'SemanticsInputType has at least one value');
  ...
  print('First SemanticsInputType value: $first (${first.name}, ${first.index})');
  print('Last SemanticsInputType value: $last (${last.name}, ${last.index})');

  _expectCondition(SemanticsInputType.values.byName(first.name) == first, 'byName resolves first value');
  _expectCondition(SemanticsInputType.values.byName(last.name) == last, 'byName resolves last value');
  ...
  _expectCondition(first == SemanticsInputType.values[first.index], 'First value round-trips from index');
  _expectCondition(last == SemanticsInputType.values[last.index], 'Last value round-trips from index');
  ...
  _expectCondition(invalidNameThrows, 'Invalid byName lookup throws for SemanticsInputType');
