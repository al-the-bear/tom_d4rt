...
class FrameDataCaseStudy {
  ...
  List<String> run() {
    ...
    assert(
      first.runtimeType.toString().contains('FrameData'),
      'Expected FrameData runtime type',
    );
...
dynamic build(BuildContext context) {
  ...
  assert(
    logs.any((line) => line.startsWith('first-frame:')),
    'Expected first frame log',
  );
  assert(
    logs.any((line) => line.startsWith('second-frame:')),
    'Expected second frame log',
  );
