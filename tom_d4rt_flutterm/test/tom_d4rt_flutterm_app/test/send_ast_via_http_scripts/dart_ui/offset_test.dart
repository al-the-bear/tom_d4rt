...
dynamic build(BuildContext context) {
  ...
  print('fromDirection(pi/4, 100): dx=${fromDir.dx.toStringAsFixed(2)}, dy=${fromDir.dy.toStringAsFixed(2)}');
  ...
  for (final entry in compassOffsets.entries) {
    print('${entry.key}: dx=${entry.value.dx.toStringAsFixed(1)}, dy=${entry.value.dy.toStringAsFixed(1)}');
  }
  ...
  final lerpPoints = lerpSteps.map((t) =>
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text('zero', style: TextStyle(
                          color: Colors.white, fontSize: 10)),
                      ),
                    ),
                    // fromDirection point
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      left: 10,
                      top: 80,
                      child: Container(width: a.dx, height: 4, color: Color(0xFF1565C0)),
                    ),
                    Positioned(
                      left: 10 + a.dx + 4,
                      top: 74,
                    ...
                    Positioned(
                      left: 10 + a.dx,
                      top: 80,
                      child: Container(width: b.dx, height: 4, color: Color(0xFF00838F)),
                    ),
                    Positioned(
                      left: 10 + a.dx + b.dx + 4,
                      top: 74,
                      child: Text('B', style: TextStyle(
                        color: Color(0xFF00838F), fontWeight: FontWeight.bold, fontSize: 12,
                      )),
                    ),
                    // Result A+B (green)
                    Positioned(
                      left: 10,
                      top: 100,
                      child: Container(width: sum.dx, height: 4, color: Color(0xFF2E7D32)),
                    ),
                    Positioned(
                      left: 10 + sum.dx + 4,
                      top: 94,
                      child: Text('A+B', style: TextStyle(
                    ...
                    Positioned(
                      left: 10, top: 130,
                      child: Container(width: diff.dx, height: 4, color: Color(0xFFE65100)),
                    ),
                    Positioned(
                      left: 10 + diff.dx + 4, top: 124,
                      child: Text('A-B', style: TextStyle(
                ...
                child: Stack(
                  children: [
                    ...
                    ...compassOffsets.entries.map((entry) {
                      ...
                      final hue = (compassOffsets.keys.toList().indexOf(entry.key) * 45.0);
                      return Positioned(
                        left: cx - 16, top: cy - 16,
                        child: Container(
                          width: 32, height: 32,
                          decoration: BoxDecoration(
                            color: HSVColor.fromAHSV(1.0, hue, 0.7, 0.9).toColor(),
                            shape: BoxShape.circle,
                            boxShadow: [BoxShadow(color: Colors.black12, blurRadius: 3, offset: Offset(1, 1))],
                          ),
                          child: Center(
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    // Start-end line
                    Positioned(
                      left: startOffset.dx, top: startOffset.dy + 40,
                      child: Container(
                    ...
                    ...lerpPoints.asMap().entries.map((entry) {
                      ...
                      final t = lerpSteps[i];
                      return Positioned(
                        left: pt.dx - 12, top: pt.dy + 28,
                        child: Column(
                          children: [
                            Container(
                              width: 24, height: 24,
                              decoration: BoxDecoration(
                                color: Color.lerp(Color(0xFF1565C0), Color(0xFFC62828), t),
                                shape: BoxShape.circle,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _propertyTile(Icons.straighten, 'distance',
                      '${p.distance.toStringAsFixed(2)}',
                      'sqrt(dx^2 + dy^2) = sqrt(${p.dx}^2 + ${p.dy}^2)',
                      Color(0xFF1565C0)),
                    Divider(height: 1),
                    _propertyTile(Icons.crop_square, 'distanceSquared',
                      '${p.distanceSquared.toStringAsFixed(0)}',
                      'dx^2 + dy^2 (no sqrt)', Color(0xFF00838F)),
                    Divider(height: 1),
                    _propertyTile(Icons.explore, 'direction',
                      '${p.direction.toStringAsFixed(4)} rad',
                      'atan2(dy, dx) in radians', Color(0xFF6A1B9A)),
                    Divider(height: 1),
                    _propertyTile(Icons.check_circle, 'isFinite',
                      '${p.isFinite}',
                      'Both dx and dy are finite', Color(0xFF2E7D32)),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    _offsetDot(a.dx * 0.5, a.dy * 0.5, 'original', Color(0xFF1565C0)),
                    _offsetDot(scaleResult.dx * 0.5, scaleResult.dy * 0.25,
                      'scale(2,0.5)', Color(0xFF6A1B9A)),
                    _offsetDot(translateResult.dx * 0.5, translateResult.dy * 0.5,
                      'translate(10,-10)', Color(0xFF2E7D32)),
                    Positioned(
                      left: 10, top: 155,
                      child: Text(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: _specialValueCard('Offset.zero', '(0.0, 0.0)',
                        Icons.gps_fixed, Color(0xFF00838F)),
                    ),
                    SizedBox(width: 12),
                    Expanded(
                      child: _specialValueCard('Offset.infinite', '(inf, inf)',
                        Icons.all_inclusive, Color(0xFFC62828)),
                    ),
                  ],
                ),
              ),
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        SizedBox(width: 8),
        Text('dx=${offset.dx.toStringAsFixed(1)}, dy=${offset.dy.toStringAsFixed(1)}',
          style: TextStyle(fontSize: 13, fontFamily: 'monospace')),
        Spacer(),
        Container(
          width: (offset.dx.abs() / 2).clamp(4.0, 100.0), height: 8,
          decoration: BoxDecoration(
...
Widget _propertyTile(IconData icon, String name, String value, String description, Color color) {
  return ListTile(
    leading: Container(
      width: 40, height: 40,
      decoration: BoxDecoration(
...
Widget _specialValueCard(String title, String value, IconData icon, Color color) {
  return Container(
    padding: EdgeInsets.all(16),
    decoration: BoxDecoration(
