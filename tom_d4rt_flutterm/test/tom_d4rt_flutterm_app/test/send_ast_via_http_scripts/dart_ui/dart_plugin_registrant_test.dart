              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 6),
                    Text(
                      'Plugin registration for Dart-only environments',
                      style: TextStyle(
                        fontSize: 14,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _propertyBullet(
                      'Idempotent',
                      'Safe to call ensureInitialized() multiple times',
                    ),
                    _propertyBullet(
                      'Build-tool generated',
                      'Registration code is generated automatically',
                    ),
                    _propertyBullet(
                      'Dart-only focus',
                      'For contexts without platform channels',
                    ),
                    _propertyBullet(
                      'Transparent',
                      'User typically does not interact directly',
                    ),
                  ],
                ),
              ),
