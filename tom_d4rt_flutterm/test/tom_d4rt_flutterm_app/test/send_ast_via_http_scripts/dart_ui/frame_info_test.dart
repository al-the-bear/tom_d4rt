...
dynamic build(BuildContext context) {
  ...
  print('FrameInfo direct constructor is intentionally unavailable in public API.');
  print('FrameInfo instances are obtained from Codec.getNextFrame().');
  print('Future<FrameInfo> prepared: $futureFrameInfo');
  print('Invalid decode catch registered: $invalidDecodeThrows (may resolve async).');
