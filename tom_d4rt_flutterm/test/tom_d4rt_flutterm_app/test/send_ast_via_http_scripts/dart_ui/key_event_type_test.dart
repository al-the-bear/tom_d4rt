...
${_formatEnumValues(values)}');
  ...
  _expectCondition(KeyEventType.values.byName(first.name) == first, 'byName resolves first value');
  _expectCondition(KeyEventType.values.byName(last.name) == last, 'byName resolves last value');
  ...
  _expectCondition(first == KeyEventType.values[first.index], 'First value round-trips from index');
  _expectCondition(last == KeyEventType.values[last.index], 'Last value round-trips from index');
  ...
  _expectCondition(invalidNameThrows, 'Invalid byName lookup throws for KeyEventType');
