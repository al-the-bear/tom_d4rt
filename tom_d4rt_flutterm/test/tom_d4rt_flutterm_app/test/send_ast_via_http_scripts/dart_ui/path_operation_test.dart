...
dynamic build(BuildContext context) {
  ...
  _expectCondition(
    PathOperation.values.byName(first.name) == first,
    'byName resolves first value',
  );
  _expectCondition(
    PathOperation.values.byName(last.name) == last,
  ...
  _expectCondition(
    first == PathOperation.values[first.index],
    'First value round-trips from index',
  );
  _expectCondition(
    last == PathOperation.values[last.index],
  ...
  _expectCondition(
    invalidNameThrows,
    'Invalid byName lookup throws for PathOperation',
  );
