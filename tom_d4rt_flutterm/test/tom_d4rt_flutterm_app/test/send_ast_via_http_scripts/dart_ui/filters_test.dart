...
dynamic build(BuildContext context) {
  ...
  final blurClamp = ui.ImageFilter.blur(sigmaX: 5, sigmaY: 5, tileMode: TileMode.clamp);
  final blurRepeat = ui.ImageFilter.blur(sigmaX: 5, sigmaY: 5, tileMode: TileMode.repeated);
  final blurMirror = ui.ImageFilter.blur(sigmaX: 5, sigmaY: 5, tileMode: TileMode.mirror);
  final blurDecal = ui.ImageFilter.blur(sigmaX: 5, sigmaY: 5, tileMode: TileMode.decal);
  print('Blur tile modes: clamp=$blurClamp, repeat=$blurRepeat, mirror=$blurMirror, decal=$blurDecal');
  ...
  final rotFilter = ui.ImageFilter.matrix(rotated.storage,
  ...
  final cfBlue = ColorFilter.mode(Colors.blue.withValues(alpha: 0.5), BlendMode.srcATop);
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: Colors.cyan.withValues(alpha: 0.3),
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 12),
                    Text('ImageFilter & ColorFilter',
                      style: TextStyle(fontSize: 19, fontWeight: FontWeight.bold,
                        color: Colors.white)),
                    SizedBox(height: 6),
                    Text('Visual effects: blur, dilate, erode, matrix, compose, '
                      'color modes, gamma',
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 10, color: Color(0xFF006064))),
                    ),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _tileModeTile('clamp', 'Edge pixels extend outward',
                      Icons.border_outer, Color(0xFF0D47A1)),
                    _tileModeTile('repeated', 'Image tiles/repeats',
                      Icons.grid_on, Color(0xFF2E7D32)),
                    _tileModeTile('mirror', 'Image mirrors at edges',
                      Icons.flip, Color(0xFF6A1B9A)),
                    _tileModeTile('decal', 'Transparent beyond edges',
                      Icons.crop_free, Color(0xFFBF360C)),
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    Expanded(child: Container(
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.zoom_out_map, size: 28, color: Color(0xFF2E7D32)),
                          SizedBox(height: 8),
                          Text('dilate', style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF2E7D32))),
                          SizedBox(height: 4),
                          Text('Expands bright regions\nGrows edges outward',
                            textAlign: TextAlign.center,
                    ...
                    Expanded(child: Container(
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.zoom_in_map, size: 28, color: Color(0xFFBF360C)),
                          SizedBox(height: 8),
                          Text('erode', style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFFBF360C))),
                          SizedBox(height: 4),
                          Text('Shrinks bright regions\nErodes edges inward',
                            textAlign: TextAlign.center,
                            style: TextStyle(fontSize: 10, color: Colors.grey[600])),
                          SizedBox(height: 8),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _colorFilterRow('Red + colorBurn', Colors.red, BlendMode.colorBurn),
                    _colorFilterRow('Blue + srcATop', Colors.blue, BlendMode.srcATop),
                    _colorFilterRow('Green + overlay', Colors.green, BlendMode.overlay),
                    _colorFilterRow('Orange + multiply', Colors.orange, BlendMode.multiply),
                    _colorFilterRow('Purple + screen', Colors.purple, BlendMode.screen),
                    SizedBox(height: 8),
                    Text('ColorFilter.mode(color, blendMode) applies a color '
                ...
                child: Row(
                  children: [
                    Expanded(child: Container(
                      ...
                      child: Column(
                        children: [
                          Text('Grayscale', style: TextStyle(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [Colors.grey[800]!, Colors.grey[400]!, Colors.grey[200]!]),
                              borderRadius: BorderRadius.circular(8)),
                          ),
                          SizedBox(height: 6),
                          Text('R,G,B → 0.2126R + 0.7152G + 0.0722B',
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [Color(0xFF8B7355), Color(0xFFD2B48C), Color(0xFFF5DEB3)]),
                              borderRadius: BorderRadius.circular(8)),
                          ),
                          SizedBox(height: 6),
                          Text('5×4 matrix for warm toning',
                            style: TextStyle(fontSize: 8, fontFamily: 'monospace')),
                        ],
                      ),
                    )),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        _gammaBox('Linear', 'linearToSrgbGamma()', Color(0xFF0D47A1)),
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 6),
                          child: Icon(Icons.swap_horiz, color: Colors.grey[400], size: 18)),
                        _gammaBox('sRGB', 'srgbToLinearGamma()', Color(0xFF2E7D32)),
                      ],
                    ),
                    SizedBox(height: 16),
                    Text('COMPLETE FILTER API MAP', style: TextStyle(
                      fontWeight: FontWeight.bold, fontSize: 11, color: Color(0xFF455A64))),
                    SizedBox(height: 8),
                    _apiRow('ImageFilter', 'blur, dilate, erode, matrix, compose', Color(0xFF006064)),
                    _apiRow('ColorFilter', 'mode, matrix, linearToSrgb, srgbToLinear', Color(0xFFBF360C)),
                    SizedBox(height: 8),
                    Container(
                      padding: EdgeInsets.all(8),
                      decoration: BoxDecoration(
    ...
    child: Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.blur_on, size: 20, color: color.withValues(alpha: 0.3 + sigma / 20)),
            SizedBox(height: 4),
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        SizedBox(width: 10),
        SizedBox(width: 70,
          child: Text(name, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: color))),
    ...
    child: Row(
      children: [
        Container(
          width: 20, height: 20,
          decoration: BoxDecoration(
            color: filterColor, borderRadius: BorderRadius.circular(4))),
        SizedBox(width: 8),
        ...
        Container(
          ...
          child: Text(mode.name, style: TextStyle(fontSize: 9, color: filterColor)),
        ),
      ],
    ),
  );
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          Text(api, style: TextStyle(fontSize: 9, fontFamily: 'monospace', color: color)),
        ],
      ),
    ),
  );
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        SizedBox(width: 80,
          child: Text(name, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: color))),
        Expanded(child: Text(methods, style: TextStyle(fontSize: 10, color: Colors.grey[600]))),
      ],
    ),
  );
}
