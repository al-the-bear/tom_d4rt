...
dynamic build(BuildContext context) {
  ...
  _expectCondition(
    ImageByteFormat.values.byName(first.name) == first,
    'byName resolves first value',
  );
  _expectCondition(
    ImageByteFormat.values.byName(last.name) == last,
  ...
  _expectCondition(
    first == ImageByteFormat.values[first.index],
    'First value round-trips from index',
  );
  _expectCondition(
    last == ImageByteFormat.values[last.index],
  ...
  _expectCondition(
    invalidNameThrows,
    'Invalid byName lookup throws for ImageByteFormat',
  );
