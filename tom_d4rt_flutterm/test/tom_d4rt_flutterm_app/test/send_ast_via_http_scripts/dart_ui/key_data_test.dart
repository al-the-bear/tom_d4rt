// Comprehensive D4rt test script: KeyData from dart_ui
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive KeyData script ===');
  ...
  detailLines.add('target=KeyData');
  ...
  const String targetTypeName = 'KeyData';
  check(targetTypeName == 'KeyData', 'Name matches');
  detailLines.add('category=dart_ui_input');
  detailLines.add('desc=Raw keyboard event data from the platform');
  check(targetTypeName.contains('Key'), 'Name contains Key');
