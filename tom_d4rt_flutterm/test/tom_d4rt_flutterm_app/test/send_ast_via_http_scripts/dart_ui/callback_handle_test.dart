...
dynamic build(BuildContext context) {
  ...
  expectCheck(
    handle1 != handle3,
    'different raw values should create different handles',
  );
  expectCheck(
    handle1.hashCode == handle2.hashCode,
  ...
  expectCheck(
    maxLikeHandle.toRawHandle() == 999999999,
    'large handle should roundtrip',
  );

  final handleSet = <ui.CallbackHandle>{
    handle1,
    handle2,
    handle3,
    zeroHandle,
