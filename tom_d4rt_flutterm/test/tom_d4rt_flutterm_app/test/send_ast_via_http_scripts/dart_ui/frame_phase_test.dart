...
dynamic build(BuildContext context) {
  ...
  _expectCondition(
    FramePhase.values.byName(first.name) == first,
    'byName resolves first value',
  );
  _expectCondition(
    FramePhase.values.byName(last.name) == last,
  ...
  _expectCondition(
    first == FramePhase.values[first.index],
    'First value round-trips from index',
  );
  _expectCondition(
    last == FramePhase.values[last.index],
  ...
  _expectCondition(
    invalidNameThrows,
    'Invalid byName lookup throws for FramePhase',
  );
