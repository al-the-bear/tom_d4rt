...
Map<int, PlaceholderAlignment> _buildIndexMap(List<PlaceholderAlignment> values) {
...
dynamic build(BuildContext context) {
  ...
  _expectCondition(values.isNotEmpty, 'PlaceholderAlignment has at least one value');
  ...
  print('First PlaceholderAlignment value: $first (${first.name}, ${first.index})');
  print('Last PlaceholderAlignment value: $last (${last.name}, ${last.index})');

  _expectCondition(PlaceholderAlignment.values.byName(first.name) == first, 'byName resolves first value');
  _expectCondition(PlaceholderAlignment.values.byName(last.name) == last, 'byName resolves last value');
  ...
  _expectCondition(first == PlaceholderAlignment.values[first.index], 'First value round-trips from index');
  _expectCondition(last == PlaceholderAlignment.values[last.index], 'Last value round-trips from index');
  ...
  try {
    PlaceholderAlignment.values.byName('__not_a_valid_placeholderalignment_name__');
  } catch (error) {
    invalidNameThrows = true;
    print('Expected byName failure captured for PlaceholderAlignment: $error');
  }
  _expectCondition(invalidNameThrows, 'Invalid byName lookup throws for PlaceholderAlignment');
