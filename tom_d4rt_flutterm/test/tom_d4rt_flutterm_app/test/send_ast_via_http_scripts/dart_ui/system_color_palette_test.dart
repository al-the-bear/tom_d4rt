...
dynamic build(BuildContext context) {
  ...
  _expect(
    typeName.contains('SystemColorPalette'),
    'type name should include class name',
  );
  ...
  _expect(
    darkPalette.runtimeType == lightPalette.runtimeType,
    'palette types should match',
  );
  _expect(darkPalette.hashCode != 0, 'dark hash should be non-zero');
  _expect(lightPalette.hashCode != 0, 'light hash should be non-zero');
  _expect(
    darkPalette.brightness == Brightness.dark,
    'dark palette brightness mismatch',
  );
  _expect(
    lightPalette.brightness == Brightness.light,
    'light palette brightness mismatch',
  );
  ...
  _expect(
    (metadata['darkType'] as String).contains('SystemColorPalette'),
    'dark type check',
  );
  _expect(
    (metadata['lightType'] as String).contains('SystemColorPalette'),
    'light type check',
  );
