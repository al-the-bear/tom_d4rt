...
dynamic build(BuildContext context) {
  ...
  _expectCondition(FontStyle.values.byName(first.name) == first, 'byName resolves first value');
  _expectCondition(FontStyle.values.byName(last.name) == last, 'byName resolves last value');
  ...
  _expectCondition(first == FontStyle.values[first.index], 'First value round-trips from index');
  _expectCondition(last == FontStyle.values[last.index], 'Last value round-trips from index');
  ...
  _expectCondition(invalidNameThrows, 'Invalid byName lookup throws for FontStyle');
