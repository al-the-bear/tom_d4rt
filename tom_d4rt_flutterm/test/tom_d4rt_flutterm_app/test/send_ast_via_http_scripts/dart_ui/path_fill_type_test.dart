...
dynamic build(BuildContext context) {
  ...
  _expectCondition(PathFillType.values.byName(first.name) == first, 'byName resolves first value');
  _expectCondition(PathFillType.values.byName(last.name) == last, 'byName resolves last value');
  ...
  _expectCondition(first == PathFillType.values[first.index], 'First value round-trips from index');
  _expectCondition(last == PathFillType.values[last.index], 'Last value round-trips from index');
  ...
  _expectCondition(invalidNameThrows, 'Invalid byName lookup throws for PathFillType');
