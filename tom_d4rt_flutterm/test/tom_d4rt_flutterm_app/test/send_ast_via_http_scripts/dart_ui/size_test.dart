...
dynamic build(BuildContext context) {
  ...
  _expect(
    s1.width == 100 && s1.height == 50,
    'primary constructor sets width/height',
    logs,
  );
  assertionCount++;
  _expect(
    s2.width == 40 && s2.height == 40,
    'square constructor sets equal sides',
    logs,
  );
  assertionCount++;
  _expect(
    s3.width == 120 && s3.height == 0,
    'fromWidth behavior validated',
    logs,
  );
  assertionCount++;
  _expect(
    s4.height == 90 && s4.width == 0,
    'fromHeight behavior validated',
    logs,
  );
  assertionCount++;
  ...
  print(
    'added=$added subtracted=$subtracted multiplied=$multiplied divided=$divided',
  );
