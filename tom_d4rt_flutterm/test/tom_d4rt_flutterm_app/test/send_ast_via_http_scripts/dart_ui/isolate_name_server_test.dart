...
dynamic build(BuildContext context) {
  ...
  final registered = ui.IsolateNameServer.registerPortWithName(sendPort, 'd4rt_test_port');
  log('registered=$registered');
  expectCheck(registered, 'first registration should succeed');

  final duplicateRegister = ui.IsolateNameServer.registerPortWithName(sendPort, 'd4rt_test_port');
  ...
  final removedAgain = ui.IsolateNameServer.removePortNameMapping('d4rt_test_port');
