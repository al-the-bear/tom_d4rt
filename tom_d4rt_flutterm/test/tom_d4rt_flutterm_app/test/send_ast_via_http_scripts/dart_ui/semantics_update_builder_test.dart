...
class SemanticsUpdateBuilderCaseStudy {
  ...
  List<String> run() {
    ...
    assert(
      builder.runtimeType.toString().contains('SemanticsUpdateBuilder'),
      'Builder type mismatch',
    );
    ...
    assert(
      ...
      'Build should create SemanticsUpdate',
    );
    ...
    if (includeEdgeCases) {
      ...
      assert(
        secondUpdate.runtimeType == update.runtimeType,
        'Updates should share runtime type',
      );
...
dynamic build(BuildContext context) {
  ...
  assert(
    logs.any((line) => line.startsWith('builder-type:')),
    'Expected builder type log',
  );
  assert(
