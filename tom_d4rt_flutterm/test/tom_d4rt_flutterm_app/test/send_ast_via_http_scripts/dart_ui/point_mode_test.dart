...
dynamic build(BuildContext context) {
  ...
  _expectCondition(
    PointMode.values.byName(first.name) == first,
    'byName resolves first value',
  );
  _expectCondition(
    PointMode.values.byName(last.name) == last,
  ...
  _expectCondition(
    first == PointMode.values[first.index],
    'First value round-trips from index',
  );
  _expectCondition(
    last == PointMode.values[last.index],
  ...
  _expectCondition(
    invalidNameThrows,
    'Invalid byName lookup throws for PointMode',
  );
