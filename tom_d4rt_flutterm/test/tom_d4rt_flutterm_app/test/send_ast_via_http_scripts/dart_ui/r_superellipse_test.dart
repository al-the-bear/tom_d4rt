...
dynamic build(BuildContext context) {
  ...
  _expect(
    a.width == 120 && a.height == 80,
    'fromLTRBXY dimensions are correct',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    b.outerRect.width == 60 && b.outerRect.height == 40,
    'fromRectAndRadius tracks outerRect',
    logs,
  );
  assertionCount++;
  _expect(
    c.center == const ui.Offset(25, 15),
    'fromRectAndCorners center computed correctly',
    logs,
  );
  assertionCount++;
  ...
  print(
    'a=$a b=$b c=$c shifted=$shifted inflated=$inflated deflated=$deflated lerped=$lerped edge=$edge',
  );
