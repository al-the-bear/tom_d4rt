...
dynamic build(BuildContext context) {
  ...
  _expectCondition(
    SemanticsRole.values.byName(first.name) == first,
    'byName resolves first value',
  );
  _expectCondition(
    SemanticsRole.values.byName(last.name) == last,
  ...
  _expectCondition(
    first == SemanticsRole.values[first.index],
    'First value round-trips from index',
  );
  _expectCondition(
    last == SemanticsRole.values[last.index],
  ...
  _expectCondition(
    invalidNameThrows,
    'Invalid byName lookup throws for SemanticsRole',
  );
