...
dynamic build(BuildContext context) {
  ...
  _expectCondition(
    PaintingStyle.values.byName(first.name) == first,
    'byName resolves first value',
  );
  _expectCondition(
    PaintingStyle.values.byName(last.name) == last,
  ...
  _expectCondition(
    first == PaintingStyle.values[first.index],
    'First value round-trips from index',
  );
  _expectCondition(
    last == PaintingStyle.values[last.index],
  ...
  _expectCondition(
    invalidNameThrows,
    'Invalid byName lookup throws for PaintingStyle',
  );
