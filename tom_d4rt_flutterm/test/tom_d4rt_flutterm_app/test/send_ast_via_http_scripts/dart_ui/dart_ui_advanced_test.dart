          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 12),
                    Text('dart:ui Advanced APIs',
                      style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,
                        color: Colors.white)),
                    SizedBox(height: 6),
                    Text('AccessibilityFeatures, ChannelBuffers, PlatformDispatcher',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _featureRow('accessibleNavigation', features.accessibleNavigation,
                      'Navigation aids enabled', Icons.navigation),
                    _featureRow('boldText', features.boldText,
                      'System bold text preference', Icons.format_bold),
                    _featureRow('disableAnimations', features.disableAnimations,
                      'Animations should be minimized', Icons.animation),
                    _featureRow('highContrast', features.highContrast,
                      'High contrast mode active', Icons.contrast),
                    _featureRow('invertColors', features.invertColors,
                      'Color inversion enabled', Icons.invert_colors),
                    _featureRow('onOffSwitchLabels', features.onOffSwitchLabels,
                      'Switch labels should show ON/OFF', Icons.toggle_on),
                    _featureRow('reduceMotion', features.reduceMotion,
                      'Reduce motion preference', Icons.slow_motion_video),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          ...
                          child: Icon(Icons.message, color: Color(0xFF1565C0), size: 22),
                        ),
                        SizedBox(width: 12),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('ChannelBuffers', style: TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 14)),
                              Text('Singleton via ui.channelBuffers',
                    ...
                    SizedBox(height: 16),
                    _infoBox('Buffers platform channel messages until a listener registers. '
                      'Critical for plugin initialization ordering.',
                      Color(0xFF1565C0)),
                    SizedBox(height: 12),
                    _apiRow('push(name, data, callback)', 'Queue a message'),
                    _apiRow('setListener(name, handler)', 'Register channel listener'),
                    _apiRow('clearListener(name)', 'Remove channel listener'),
                    _apiRow('drain(name, callback)', 'Process buffered messages'),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _dispatcherProp('locale', '${dispatcher.locale}',
                      Icons.language, Color(0xFF6A1B9A)),
                    _dispatcherProp('locales', '${dispatcher.locales.length} locales',
                      Icons.translate, Color(0xFF1565C0)),
                    _dispatcherProp('textScaleFactor', '${dispatcher.textScaleFactor}',
                      Icons.format_size, Color(0xFF2E7D32)),
                    _dispatcherProp('semanticsEnabled', '${dispatcher.semanticsEnabled}',
                      Icons.accessibility, Color(0xFFE65100)),
                    _dispatcherProp('defaultRouteName', '${dispatcher.defaultRouteName}',
                      Icons.route, Color(0xFFC62828)),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _layerArrow(),
                    _layerBox('Flutter Framework (Widgets, Rendering)', Color(0xFF1565C0), false),
                    _layerArrow(),
                    _layerBox('dart:ui (PlatformDispatcher, etc.)', Color(0xFF6A1B9A), true),
                    _layerArrow(),
                    _layerBox('Engine (C++/Skia/Impeller)', Color(0xFFC62828), false),
                    _layerArrow(),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _dispatcherProp('views count',
                      '${dispatcher.views.length}',
                      Icons.window, Color(0xFF1565C0)),
                      ...
                      ...dispatcher.views.take(3).map((v) {
                        return Padding(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.monitor, size: 18, color: Colors.grey[600]),
                                SizedBox(width: 8),
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      ...
                                      Text('${v.physicalSize.width.toInt()}×${v.physicalSize.height.toInt()} '
    ...
    child: Row(
      children: [
        Container(
          width: 30, height: 30,
          decoration: BoxDecoration(
            color: (value ? Color(0xFF2E7D32) : Color(0xFFBDBDBD)).withValues(alpha: 0.1),
            borderRadius: BorderRadius.circular(6)),
          child: Icon(icon, color: value ? Color(0xFF2E7D32) : Color(0xFFBDBDBD), size: 16),
        ),
        SizedBox(width: 10),
        Expanded(
          child: Column(
  ...
  return Padding(
    ...
    child: Row(
      children: [
        Container(
          width: 6, height: 6,
          decoration: BoxDecoration(color: Color(0xFF1565C0), shape: BoxShape.circle),
        ),
        SizedBox(width: 8),
        Expanded(
          child: RichText(
            text: TextSpan(children: [
              TextSpan(text: method, style: TextStyle(fontSize: 11,
                fontFamily: 'monospace', color: Colors.black87)),
              TextSpan(text: ' — $desc', style: TextStyle(fontSize: 11,
    ...
    child: Column(
      ...
      children: [
        ...
        ...callbacks.map((cb) => Padding(
          ...
          child: Text('  $cb', style: TextStyle(fontSize: 11, fontFamily: 'monospace',
...
Widget _layerBox(String label, Color color, bool active) {
  return Container(
    ...
    decoration: BoxDecoration(
      color: active ? color.withValues(alpha: 0.15) : color.withValues(alpha: 0.05),
      borderRadius: BorderRadius.circular(8),
