...
dynamic build(BuildContext context) {
  ...
  _expectCondition(
    values.isNotEmpty,
    'KeyEventDeviceType has at least one value',
  );
  _expectCondition(
  ...
  print(
    'First KeyEventDeviceType value: $first (${first.name}, ${first.index})',
  );
  print('Last KeyEventDeviceType value: $last (${last.name}, ${last.index})');

  _expectCondition(
    KeyEventDeviceType.values.byName(first.name) == first,
    'byName resolves first value',
  );
  _expectCondition(
    KeyEventDeviceType.values.byName(last.name) == last,
  ...
  _expectCondition(
    first == KeyEventDeviceType.values[first.index],
    'First value round-trips from index',
  );
  _expectCondition(
    last == KeyEventDeviceType.values[last.index],
  ...
  _expectCondition(
    invalidNameThrows,
    'Invalid byName lookup throws for KeyEventDeviceType',
  );
