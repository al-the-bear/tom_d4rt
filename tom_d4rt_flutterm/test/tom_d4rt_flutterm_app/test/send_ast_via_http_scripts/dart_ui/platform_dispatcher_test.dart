// Comprehensive D4rt test script: PlatformDispatcher from dart_ui
...
dynamic build(BuildContext context) {
  print('=== Running comprehensive PlatformDispatcher script ===');
  ...
  detailLines.add('target=PlatformDispatcher');
  ...
  const String targetTypeName = 'PlatformDispatcher';
  check(targetTypeName == 'PlatformDispatcher', 'Name matches');
  detailLines.add('category=dart_ui_platform');
  detailLines.add('desc=Primary interface to the platform');
  // Access via WidgetsBinding
  check(targetTypeName.contains('Platform'), 'Name contains Platform');
