...
dynamic build(BuildContext context) {
  ...
  expectCheck(
    layerA is ui.ImageFilterEngineLayer,
    'layerA should be ImageFilterEngineLayer',
  );
  builder.pop();

  final layerB = builder.pushImageFilter(
    blurFilter,
    offset: const Offset(12, 24),
  );
  log('layerB runtimeType=${layerB.runtimeType}');
  expectCheck(
    layerB is ui.ImageFilterEngineLayer,
    'layerB should be ImageFilterEngineLayer',
  );
  builder.pop();

  final layerC = builder.pushImageFilter(
    strongFilter,
    offset: const Offset(-4, 6),
  );
  log('layerC runtimeType=${layerC.runtimeType}');
  expectCheck(
    layerC is ui.ImageFilterEngineLayer,
    'layerC should be ImageFilterEngineLayer',
  );
  builder.pop();
  ...
  expectCheck(
    layerD is ui.ImageFilterEngineLayer,
    'layerD should be ImageFilterEngineLayer',
  );
  builder.pop();
