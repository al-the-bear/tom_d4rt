...
dynamic build(BuildContext context) {
  ...
  _expectCondition(
    PixelFormat.values.byName(first.name) == first,
    'byName resolves first value',
  );
  _expectCondition(
    PixelFormat.values.byName(last.name) == last,
  ...
  _expectCondition(
    first == PixelFormat.values[first.index],
    'First value round-trips from index',
  );
  _expectCondition(
    last == PixelFormat.values[last.index],
  ...
  _expectCondition(
    invalidNameThrows,
    'Invalid byName lookup throws for PixelFormat',
  );
