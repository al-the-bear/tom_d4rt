...
dynamic build(BuildContext context) {
  ...
  final weights = [
    ui.FontWeight.w100, ui.FontWeight.w200, ui.FontWeight.w300,
    ui.FontWeight.w400, ui.FontWeight.w500, ui.FontWeight.w600,
    ui.FontWeight.w700, ui.FontWeight.w800, ui.FontWeight.w900,
  ];
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Text('dart:ui Enums',
                      style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,
                        color: Colors.white)),
                    SizedBox(height: 6),
                    Text('AppLifecycleState, Brightness, BoxHeight/WidthStyle, '
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _lifecycleRow(ui.AppLifecycleState.detached, 'App not yet attached',
                      Icons.power_off, Color(0xFF9E9E9E)),
                    _lifecycleArrow(),
                    _lifecycleRow(ui.AppLifecycleState.resumed, 'Fully visible & interactive',
                      Icons.play_circle_fill, Color(0xFF2E7D32)),
                    _lifecycleArrow(),
                    _lifecycleRow(ui.AppLifecycleState.inactive, 'Visible but losing focus',
                      Icons.pause_circle, Color(0xFFE65100)),
                    _lifecycleArrow(),
                    _lifecycleRow(ui.AppLifecycleState.hidden, 'Not visible to user',
                      Icons.visibility_off, Color(0xFF1565C0)),
                    _lifecycleArrow(),
                    _lifecycleRow(ui.AppLifecycleState.paused, 'Suspended in background',
                      Icons.bedtime, Color(0xFF6A1B9A)),
                    SizedBox(height: 10),
                    Container(
                      ...
                      child: Text('detached → resumed → inactive → hidden → paused → resumed ...',
                        textAlign: TextAlign.center,
                  ...
                  children: [
                    Expanded(child: Container(
                      ...
                      child: Column(children: [
                        Icon(Icons.wb_sunny, size: 32, color: Color(0xFFF57F17)),
                        SizedBox(height: 8),
                        Text('Brightness.light', style: TextStyle(
                    ...
                    Expanded(child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12)),
                      child: Column(children: [
                        Icon(Icons.dark_mode, size: 32, color: Color(0xFFB0BEC5)),
                        SizedBox(height: 8),
                        Text('Brightness.dark', style: TextStyle(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('BoxHeightStyle', style: TextStyle(
                      fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF0D47A1))),
                    SizedBox(height: 8),
                    Wrap(
                      spacing: 6, runSpacing: 6,
                      children: ui.BoxHeightStyle.values.map((s) =>
                        _enumChip(s.name, Color(0xFF0D47A1))).toList(),
                    ),
                    SizedBox(height: 16),
                    Text('BoxWidthStyle', style: TextStyle(
                      fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF2E7D32))),
                    SizedBox(height: 8),
                    Wrap(
                      spacing: 6, runSpacing: 6,
                      children: ui.BoxWidthStyle.values.map((s) =>
                        _enumChip(s.name, Color(0xFF2E7D32))).toList(),
                    ),
                    SizedBox(height: 12),
                    Container(
                      padding: EdgeInsets.all(8),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _clipRow(ui.Clip.none, 'No clipping applied',
                      'Fastest — content may overflow', Color(0xFF9E9E9E)),
                    _clipRow(ui.Clip.hardEdge, 'Hard pixel boundary clip',
                      'Fast — no anti-aliasing', Color(0xFFE65100)),
                    _clipRow(ui.Clip.antiAlias, 'Smooth-edge clipping',
                      'Moderate — anti-aliased edges', Color(0xFF0D47A1)),
                    _clipRow(ui.Clip.antiAliasWithSaveLayer, 'AA + save layer',
                      'Slow — full compositing', Color(0xFFC62828)),
                    SizedBox(height: 12),
                    Row(
                    ...
                    SizedBox(height: 4),
                    Text('Performance (higher = faster)',
              ...
              Container(
                ...
                child: Column(
                  children: weights.map((w) {
                    final names = {100: 'Thin', 200: 'ExtraLight', 300: 'Light',
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          SizedBox(width: 35,
                            child: Text('w${w.value}', style: TextStyle(
                              fontSize: 10, fontFamily: 'monospace',
                              fontWeight: FontWeight.bold, color: Color(0xFF4A148C)))),
                          SizedBox(width: 70,
                            child: Text(names[w.value] ?? '', style: TextStyle(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _summaryRow('AppLifecycleState', ui.AppLifecycleState.values.length, Color(0xFF2E7D32)),
                    _summaryRow('Brightness', ui.Brightness.values.length, Color(0xFFF57F17)),
                    _summaryRow('BoxHeightStyle', ui.BoxHeightStyle.values.length, Color(0xFF0D47A1)),
                    _summaryRow('BoxWidthStyle', ui.BoxWidthStyle.values.length, Color(0xFF2E7D32)),
                    _summaryRow('Clip', ui.Clip.values.length, Color(0xFFE65100)),
                    _summaryRow('BlendMode', ui.BlendMode.values.length, Color(0xFF6A1B9A)),
...
Widget _lifecycleRow(ui.AppLifecycleState state, String desc, IconData icon, Color color) {
  return Padding(
    ...
    child: Row(
      children: [
        ...
        Expanded(child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(state.name, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: color)),
...
Widget _enumChip(String name, Color color) {
  return Container(
    ...
    child: Text(name, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: color)),
  );
}
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        SizedBox(width: 8),
        SizedBox(width: 80,
          child: Text(clip.name, style: TextStyle(
            fontWeight: FontWeight.bold, fontSize: 11, color: color))),
        Expanded(child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(desc, style: TextStyle(fontSize: 10)),
            Text(perf, style: TextStyle(fontSize: 9, color: Colors.grey[500])),
          ],
        )),
      ],
    ),
    ...
    children: [
      Row(
        children: List.generate(5, (i) => Container(
          width: 6, height: 12, margin: EdgeInsets.only(right: 1),
          decoration: BoxDecoration(
...
Widget _blendModeGroup(String group, List<String> modes, Color color) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text('$group (${modes.length})', style: TextStyle(
        fontWeight: FontWeight.bold, fontSize: 11, color: color)),
      SizedBox(height: 4),
      Wrap(
    ...
    child: Row(
      children: [
        Container(width: 6, height: 6,
          decoration: BoxDecoration(color: color, shape: BoxShape.circle)),
        SizedBox(width: 8),
        Expanded(child: Text(name, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500))),
        Container(
          padding: EdgeInsets.symmetric(horizontal: 8, vertical: 2),
          decoration: BoxDecoration(
            color: color.withValues(alpha: 0.1),
            borderRadius: BorderRadius.circular(8)),
          child: Text('$count values',
