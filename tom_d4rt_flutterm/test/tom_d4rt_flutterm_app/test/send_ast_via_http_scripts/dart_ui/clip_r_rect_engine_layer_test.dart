...
dynamic build(BuildContext context) {
  ...
  expectCheck(
    layerA is ui.ClipRRectEngineLayer,
    'layerA should be ClipRRectEngineLayer',
  );
  builder.pop();
  ...
  expectCheck(
    layerB is ui.ClipRRectEngineLayer,
    'layerB should be ClipRRectEngineLayer',
  );
  builder.pop();
  ...
  expectCheck(
    layerC is ui.ClipRRectEngineLayer,
    'layerC should be ClipRRectEngineLayer',
  );
  builder.pop();
