...
dynamic build(BuildContext context) {
  ...
  print('Feature 1 (hinge): bounds=${feature1.bounds}, type=${feature1.type}, state=${feature1.state}');
  ...
  print('feature1.hashCode == feature1Copy.hashCode: ${feature1.hashCode == feature1Copy.hashCode}');
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Text('DisplayFeature',
                      style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,
                        color: Colors.white)),
                    SizedBox(height: 6),
                    Text('Physical display feature with bounds, type, and state',
              ...
              ...features.asMap().entries.map((e) => _featureCard(e.key + 1, e.value)),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _paramRow('bounds', 'Rect', 'Physical area of the feature on screen',
                      Color(0xFF1A237E)),
                    _paramRow('type', 'DisplayFeatureType', 'Category: fold, hinge, cutout, unknown',
                      Color(0xFF2E7D32)),
                    _paramRow('state', 'DisplayFeatureState', 'Posture: flat, halfOpened, unknown',
                      Color(0xFFE65100)),
                    SizedBox(height: 12),
                    Container(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _equalityRow('feature1 == feature1Copy', feature1 == feature1Copy),
                    _equalityRow('feature1 == feature2', feature1 == feature2),
                    _equalityRow('feature1 == feature3', feature1 == feature3),
                    _equalityRow('hashCode match', feature1.hashCode == feature1Copy.hashCode),
                    SizedBox(height: 12),
                    Container(
                      padding: EdgeInsets.all(10),
                      decoration: BoxDecoration(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text('Bounds in physical pixels',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _integrationStep(1, 'Query features',
                      'MediaQuery.displayFeaturesOf(context)',
                      Icons.search, Color(0xFF1A237E)),
                    _arrow(),
                    _integrationStep(2, 'Filter by type',
                      'features.where((f) => f.type == hinge)',
                      Icons.filter_list, Color(0xFF2E7D32)),
                    _arrow(),
                    _integrationStep(3, 'Read bounds',
                      'feature.bounds → Rect of feature area',
                      Icons.crop, Color(0xFFE65100)),
                    _arrow(),
                    _integrationStep(4, 'Adapt layout',
                      'Split panes, add padding, avoid cutouts',
                      Icons.dashboard, Color(0xFF6A1B9A)),
                    SizedBox(height: 16),
                    Container(
                      padding: EdgeInsets.all(10),
                      decoration: BoxDecoration(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.lightbulb, color: Color(0xFFF57F17), size: 16),
                          SizedBox(width: 8),
                          Expanded(
                            child: Text(
...
Color _typeColor(ui.DisplayFeatureType type) {
  switch (type) {
    case ui.DisplayFeatureType.fold: return Color(0xFF2E7D32);
    case ui.DisplayFeatureType.hinge: return Color(0xFF1A237E);
    case ui.DisplayFeatureType.cutout: return Color(0xFFBF360C);
            ...
            children: [
              Row(children: [
                ...
                Container(
                  ...
                  child: Text(feature.state.name,
                    style: TextStyle(fontSize: 10, color: Colors.grey[700])),
                ),
              ]),
              SizedBox(height: 4),
              Text('Bounds: ${feature.bounds.left.toInt()},${feature.bounds.top.toInt()} → '
...
Widget _equalityRow(String expr, bool result) {
  return Padding(
    ...
    child: Row(
      children: [
        Expanded(child: Text(expr, style: TextStyle(fontSize: 12, fontFamily: 'monospace'))),
        Container(
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        Expanded(child: Center(child: Text('unknown',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 10)))),
        Expanded(child: Center(child: Text('flat',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 10)))),
        Expanded(child: Center(child: Text('halfOpen',
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 10)))),
      ],
    ),
  );
...
Widget _matrixDataRow(String type, List<bool> values) {
  final color = type == 'fold' ? Color(0xFF2E7D32)
    : type == 'hinge' ? Color(0xFF1A237E)
    : type == 'cutout' ? Color(0xFFBF360C) : Color(0xFF757575);
  return Padding(
    padding: EdgeInsets.symmetric(vertical: 3),
    child: Row(
      children: [
        ...
        ...values.map((v) => Expanded(
          child: Center(child: Icon(
            ...
            color: v ? Color(0xFF2E7D32) : Color(0xFFBDBDBD), size: 18)),
        )),
      ],
    ),
  );
...
Widget _boundsBar(String label, Rect bounds, Color color) {
  return Row(
    children: [
      ...
      SizedBox(width: 8),
      Text('${bounds.width.toInt()}×${bounds.height.toInt()}',
        style: TextStyle(fontSize: 10, fontFamily: 'monospace', color: color)),
    ],
  );
}

Widget _integrationStep(int step, String label, String code, IconData icon, Color color) {
  return Row(
    children: [
      Container(
        width: 28, height: 28,
