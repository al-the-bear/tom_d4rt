          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Text('FlutterView',
                      style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,
                        color: Colors.white)),
                    SizedBox(height: 6),
                    Text('Rendering surface: size, padding, insets, display linkage',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _propRow('viewId', '${view.viewId}', 'Unique identifier',
                      Icons.fingerprint, Color(0xFF1B5E20)),
                    _propRow('physicalSize', '${view.physicalSize.width.toInt()}×${view.physicalSize.height.toInt()}',
                      'Size in physical pixels', Icons.aspect_ratio, Color(0xFF0D47A1)),
                    _propRow('devicePixelRatio', '${view.devicePixelRatio}',
                      'Physical px / logical px', Icons.zoom_in, Color(0xFFE65100)),
                    _propRow('logicalSize', '${logicalW.round()}×${logicalH.round()}',
                      'Calculated logical size', Icons.crop, Color(0xFF6A1B9A)),
                    _propRow('gestureSettings', '${view.gestureSettings}',
                      'Touch slop settings', Icons.touch_app, Color(0xFF00695C)),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _sizeBar('Physical', view.physicalSize.width, view.physicalSize.width, Color(0xFF0D47A1)),
                    SizedBox(height: 6),
                    _sizeBar('Logical', logicalW, view.physicalSize.width, Color(0xFF2E7D32)),
                    SizedBox(height: 12),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        _sizeBox('${view.physicalSize.width.toInt()} px', 'Physical', Color(0xFF0D47A1)),
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 8),
                          child: Text('÷ ${view.devicePixelRatio}x →',
                            style: TextStyle(fontSize: 11, color: Colors.grey[500]))),
                        _sizeBox('${logicalW.round()} lp', 'Logical', Color(0xFF2E7D32)),
                      ],
                    ),
                  ],
                ),
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text(
                            ...
                            style: TextStyle(fontSize: 9, color: Color(0xFF1B5E20)))),
                        ),
                      ),
                      // Bottom padding
                      Positioned(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: RotatedBox(
                            ...
                            child: Center(child: Text(
                              'L: ${view.padding.left}',
                              style: TextStyle(fontSize: 8, color: Color(0xFF0D47A1)))),
                          ),
                        ),
                      ),
                      // Right padding
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _insetRow('padding', 'System UI overlay area',
                      'Status bar, notch, nav bar',
                      Color(0xFF1B5E20)),
                    _insetRow('viewPadding', 'Always full system insets',
                      'Does not reduce when keyboard appears',
                      Color(0xFF0D47A1)),
                    _insetRow('viewInsets', 'Occluded by input methods',
                      'Keyboard, bottom sheet',
                      Color(0xFFE65100)),
                    _insetRow('systemGestureInsets', 'System gesture zones',
                  ...
                  children: [
                    Expanded(child: Container(
                      ...
                      child: Column(children: [
                        Icon(Icons.window, color: Color(0xFF1B5E20), size: 24),
                        SizedBox(height: 6),
                        Text('FlutterView', style: TextStyle(
                          fontWeight: FontWeight.bold, fontSize: 12, color: Color(0xFF1B5E20))),
                        SizedBox(height: 4),
                        Text('viewId: ${view.viewId}', style: TextStyle(fontSize: 9, fontFamily: 'monospace')),
                      ]),
                    )),
                    Column(
                      children: [
                        Icon(Icons.arrow_forward, color: Colors.grey[400], size: 16),
                        Text('.display', style: TextStyle(fontSize: 8, color: Colors.grey[500])),
                      ],
                    ),
                    Expanded(child: Container(
                      padding: EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(10)),
                      child: Column(children: [
                        Icon(Icons.monitor, color: Color(0xFF0D47A1), size: 24),
                        SizedBox(height: 6),
                        Text('Display', style: TextStyle(
                          fontWeight: FontWeight.bold, fontSize: 12, color: Color(0xFF0D47A1))),
                        SizedBox(height: 4),
                        Text('id: ${display.id}', style: TextStyle(fontSize: 9, fontFamily: 'monospace')),
                        Text('${display.refreshRate.toInt()} Hz', style: TextStyle(fontSize: 9)),
                      ]),
                    )),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _archLayer('Widget Tree', 'build() methods', Color(0xFF1B5E20)),
                    _archArrow(),
                    _archLayer('RenderObject', 'layout & paint', Color(0xFF0D47A1)),
                    _archArrow(),
                    _archLayer('Scene → FlutterView', 'view.render(scene)', Color(0xFFE65100)),
                    _archArrow(),
                    _archLayer('Engine → Display', 'GPU compositing', Color(0xFF6A1B9A)),
                  ],
                ),
              ),
              SizedBox(height: 24),
...
Widget _propRow(String name, String value, String desc, IconData icon, Color color) {
  return Padding(
    ...
    child: Row(
      children: [
        ...
        Expanded(child: Column(
          ...
          children: [
            Text(value, style: TextStyle(fontSize: 10, fontFamily: 'monospace', color: color)),
...
Widget _sizeBar(String label, double value, double max, Color color) {
  return Row(
    children: [
      SizedBox(width: 60, child: Text(label, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600))),
      Expanded(
        child: Stack(
          children: [
      ...
      SizedBox(width: 8),
      Text('${value.round()}', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: color)),
    ],
  );
}
