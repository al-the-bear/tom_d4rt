...
dynamic build(BuildContext context) {
  ...
  expectCheck(
    layerA is ui.BackdropFilterEngineLayer,
    'layerA should be BackdropFilterEngineLayer',
  );
  expectCheck(layerA is ui.EngineLayer, 'layerA should be EngineLayer');
  builder.pop();

  final layerB = builder.pushBackdropFilter(
    filterA,
    blendMode: BlendMode.multiply,
  );
  log('layerB runtimeType=${layerB.runtimeType}');
  expectCheck(
    layerB is ui.BackdropFilterEngineLayer,
    'layerB should be BackdropFilterEngineLayer',
  );
  builder.pop();

  final layerC = builder.pushBackdropFilter(
    filterB,
    blendMode: BlendMode.srcOver,
  );
  log('layerC runtimeType=${layerC.runtimeType}');
  expectCheck(
    layerC is ui.BackdropFilterEngineLayer,
    'layerC should be BackdropFilterEngineLayer',
  );
  builder.pop();
