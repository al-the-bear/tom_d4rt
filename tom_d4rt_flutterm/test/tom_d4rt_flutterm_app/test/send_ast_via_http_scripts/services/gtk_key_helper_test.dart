...
dynamic build(BuildContext context) {
  ...
  print('\nSection: services');
  print('Target symbol: GtkKeyHelper');
  ...
  print('\nExtended notes:');
  print('- Naming consistency checked for GtkKeyHelper');
  ...
  return Column(
    ...
    children: const [
      Text('GtkKeyHelper Tests', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
      SizedBox(height: 8),
