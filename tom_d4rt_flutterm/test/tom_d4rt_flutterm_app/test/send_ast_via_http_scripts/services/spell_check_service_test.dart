...
dynamic build(BuildContext context) {
  ...
  runCase('SpellCheckService symbol exists', () {
    final Type t = SpellCheckService;
    return t.toString().contains('SpellCheckService');
  });

  runCase('SpellCheckService type string is stable', () {
    final Type t = SpellCheckService;
    return t.toString().isNotEmpty;
  });

  runCase('SpellCheckService type hashCode is stable', () {
    final Type t = SpellCheckService;
  ...
  runCase('SpellCheckConfiguration symbol exists', () {
    final Type t = SpellCheckConfiguration;
    return t.toString().contains('SpellCheckConfiguration');
  });

  runCase('SuggestionSpan symbol exists', () {
    final Type t = SuggestionSpan;
    return t.toString().contains('SuggestionSpan');
  });

  runCase('Summary string can be produced', () {
    final String summary = 'spellcheckservice:'
