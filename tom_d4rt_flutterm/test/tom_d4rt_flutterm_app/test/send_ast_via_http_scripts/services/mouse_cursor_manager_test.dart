...
dynamic build(BuildContext context) {
  ...
  runCase('MouseCursorManager symbol exists', () {
    final Type t = MouseCursorManager;
    return t.toString().contains('MouseCursorManager');
  });

  runCase('MouseCursorManager type string is stable', () {
    final Type t = MouseCursorManager;
    return t.toString().isNotEmpty;
  });

  runCase('MouseCursorManager type hashCode is stable', () {
    final Type t = MouseCursorManager;
  ...
  runCase('MouseCursorSession symbol exists', () {
    final Type t = MouseCursorSession;
    return t.toString().contains('MouseCursorSession');
  });

  runCase('System mouse cursor basic has description', () {
    return SystemMouseCursors.basic.toString().isNotEmpty;
  });

  runCase('Summary string can be produced', () {
    final String summary = 'mousecursormanager:'
