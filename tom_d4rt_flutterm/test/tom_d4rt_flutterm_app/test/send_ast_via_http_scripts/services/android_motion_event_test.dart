...
dynamic build(BuildContext context) {
  ...
  try {
    final coords = <AndroidPointerCoords>[
      AndroidPointerCoords(
        orientation: 0.0, pressure: 1.0, size: 0.5, toolMajor: 10.0,
        toolMinor: 10.0, touchMajor: 15.0, touchMinor: 15.0, x: 100.0, y: 200.0,
      ),
      AndroidPointerCoords(
        orientation: 0.5, pressure: 0.8, size: 0.4, toolMajor: 8.0,
        toolMinor: 8.0, touchMajor: 12.0, touchMinor: 12.0, x: 300.0, y: 400.0,
      ),
    ];
    ...
    final event = AndroidMotionEvent(
      downTime: 2000, eventTime: 2001, action: 5, pointerCount: 2,
      pointerProperties: props, pointerCoords: coords, metaState: 0,
      buttonState: 0, xPrecision: 1.0, yPrecision: 1.0, deviceId: 0,
      edgeFlags: 0, source: 0x1002, flags: 0, motionEventId: 456,
    );
  ...
  try {
    final coords = <AndroidPointerCoords>[
      AndroidPointerCoords(
        orientation: 0.0, pressure: 1.0, size: 0.5, toolMajor: 10.0,
        toolMinor: 10.0, touchMajor: 15.0, touchMinor: 15.0, x: 50.0, y: 50.0,
      ),
    ];
    final props = <AndroidPointerProperties>[
      AndroidPointerProperties(id: 0, toolType: 1),
    ...
    final downEvent = AndroidMotionEvent(
      downTime: 3000, eventTime: 3001, action: 0, pointerCount: 1,
      pointerProperties: props, pointerCoords: coords, metaState: 0,
      buttonState: 0, xPrecision: 1.0, yPrecision: 1.0, deviceId: 0,
      edgeFlags: 0, source: 0x1002, flags: 0, motionEventId: 789,
    );
    ...
    final upEvent = AndroidMotionEvent(
      downTime: 3000, eventTime: 3100, action: 1, pointerCount: 1,
      pointerProperties: props, pointerCoords: coords, metaState: 0,
      buttonState: 0, xPrecision: 1.0, yPrecision: 1.0, deviceId: 0,
      edgeFlags: 0, source: 0x1002, flags: 0, motionEventId: 790,
    );
  ...
  try {
    final coords = <AndroidPointerCoords>[
      AndroidPointerCoords(
        orientation: 0.0, pressure: 1.0, size: 0.5, toolMajor: 10.0,
        toolMinor: 10.0, touchMajor: 15.0, touchMinor: 15.0, x: 150.0, y: 250.0,
      ),
    ];
    final props = <AndroidPointerProperties>[
      AndroidPointerProperties(id: 0, toolType: 1),
    ...
    final event = AndroidMotionEvent(
      downTime: 4000, eventTime: 4001, action: 2, pointerCount: 1,
      pointerProperties: props, pointerCoords: coords, metaState: 65, // SHIFT + ALT
      buttonState: 1, xPrecision: 1.0, yPrecision: 1.0, deviceId: 1,
      edgeFlags: 0, source: 0x1002, flags: 0, motionEventId: 1000,
    );
  ...
  try {
    final coords = <AndroidPointerCoords>[
      AndroidPointerCoords(
        orientation: 0.0, pressure: 1.0, size: 0.5, toolMajor: 10.0,
        toolMinor: 10.0, touchMajor: 15.0, touchMinor: 15.0, x: 200.0, y: 300.0,
      ),
    ];
    final props = <AndroidPointerProperties>[
      AndroidPointerProperties(id: 0, toolType: 1),
    ...
    final event = AndroidMotionEvent(
      downTime: 5000, eventTime: 5001, action: 0, pointerCount: 1,
      pointerProperties: props, pointerCoords: coords, metaState: 0,
      buttonState: 0, xPrecision: 2.0, yPrecision: 2.0, deviceId: 5,
      edgeFlags: 3, source: 0x1002, flags: 128, motionEventId: 2000,
    );
  ...
  try {
    final coords = <AndroidPointerCoords>[
      AndroidPointerCoords(
        orientation: 0.0, pressure: 1.0, size: 0.5, toolMajor: 10.0,
        toolMinor: 10.0, touchMajor: 15.0, touchMinor: 15.0, x: 250.0, y: 350.0,
      ),
    ];
    final props = <AndroidPointerProperties>[
      AndroidPointerProperties(id: 0, toolType: 1),
    ...
    final event = AndroidMotionEvent(
      downTime: 6000, eventTime: 6001, action: 2, pointerCount: 1,
      pointerProperties: props, pointerCoords: coords, metaState: 0,
      buttonState: 0, xPrecision: 3.5, yPrecision: 4.5, deviceId: 0,
      edgeFlags: 0, source: 0x1002, flags: 0, motionEventId: 3000,
    );
  ...
  return Column(
    ...
    children: [
      Text('AndroidMotionEvent Test Results',
