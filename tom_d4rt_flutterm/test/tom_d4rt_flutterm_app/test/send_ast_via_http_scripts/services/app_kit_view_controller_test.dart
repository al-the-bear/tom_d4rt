...
dynamic build(BuildContext context) {
  ...
  print('\nSection: services');
  print('Target symbol: AppKitViewController');
  ...
  print('\nExtended notes:');
  print('- Naming consistency checked for AppKitViewController');
  ...
  return Column(
    ...
    children: const [
      Text('AppKitViewController Tests', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
      SizedBox(height: 8),
