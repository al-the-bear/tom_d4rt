...
dynamic build(BuildContext context) {
  ...
  runCase('SurfaceAndroidViewController type string is stable', () {
    final Type t = SurfaceAndroidViewController;
    return t.toString().isNotEmpty;
  });

  runCase('SurfaceAndroidViewController type hashCode is stable', () {
    final Type t = SurfaceAndroidViewController;
  ...
  runCase('Summary string can be produced', () {
    final String summary = 'surfaceandroidviewcontroller:'
