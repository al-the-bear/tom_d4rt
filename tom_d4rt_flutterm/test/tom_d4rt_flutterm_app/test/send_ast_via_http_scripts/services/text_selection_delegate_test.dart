...
dynamic build(BuildContext context) {
  ...
  final _TextSelectionDelegateProbe primary = _TextSelectionDelegateProbe('primary', seed: 7);
  final _TextSelectionDelegateProbe edge = _TextSelectionDelegateProbe('', seed: -3);
  final _TextSelectionDelegateProbe large = _TextSelectionDelegateProbe('large-case', seed: 999);
