// D4rt comprehensive test script for TextSelectionDelegate
...
class _TextSelectionDelegateProbe implements TextSelectionDelegate {
  _TextSelectionDelegateProbe(this.label, {required this.seed});
...
Map<String, dynamic> _runProbeCase({
  ...
  required _TextSelectionDelegateProbe probe,
...
dynamic build(BuildContext context) {
  print('=== TextSelectionDelegate comprehensive script start ===');

  final _TextSelectionDelegateProbe primary = _TextSelectionDelegateProbe(
    'primary',
    seed: 7,
  );
  final _TextSelectionDelegateProbe edge = _TextSelectionDelegateProbe(
    '',
    seed: -3,
  );
  final _TextSelectionDelegateProbe large = _TextSelectionDelegateProbe(
    'large-case',
    seed: 999,
  );
  ...
  print('=== TextSelectionDelegate comprehensive script done ===');
  ...
  return Directionality(
    ...
    child: Column(
      ...
      children: <Widget>[
        const Text('TextSelectionDelegate Summary'),
