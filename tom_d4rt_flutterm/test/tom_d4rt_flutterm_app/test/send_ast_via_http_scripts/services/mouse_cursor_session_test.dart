...
dynamic build(BuildContext context) {
  ...
  print('\nSection: services');
  print('Target symbol: MouseCursorSession');
  ...
  print('\nExtended notes:');
  print('- Naming consistency checked for MouseCursorSession');
  ...
  return Column(
    ...
    children: const [
      Text('MouseCursorSession Tests', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
      SizedBox(height: 8),
