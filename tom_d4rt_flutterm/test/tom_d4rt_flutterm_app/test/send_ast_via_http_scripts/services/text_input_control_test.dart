...
dynamic build(BuildContext context) {
  ...
  final _TextInputControlProbe primary = _TextInputControlProbe('primary', seed: 7);
  final _TextInputControlProbe edge = _TextInputControlProbe('', seed: -3);
  final _TextInputControlProbe large = _TextInputControlProbe('large-case', seed: 999);
