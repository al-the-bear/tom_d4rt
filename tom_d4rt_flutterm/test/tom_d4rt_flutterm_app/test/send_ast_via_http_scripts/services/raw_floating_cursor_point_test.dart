...
dynamic build(BuildContext context) {
  final start = RawFloatingCursorPoint(
    state: FloatingCursorDragState.Start,
    offset: const Offset(30, 20),
  );
  final update = RawFloatingCursorPoint(
    state: FloatingCursorDragState.Update,
    offset: const Offset(120, 45),
  );
  final end = RawFloatingCursorPoint(
    state: FloatingCursorDragState.End,
    offset: const Offset(180, 28),
  );
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        const Text(
          'RawFloatingCursorPoint Visual Test',
