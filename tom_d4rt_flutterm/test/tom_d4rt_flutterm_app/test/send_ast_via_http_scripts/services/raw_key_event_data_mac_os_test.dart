...
dynamic build(BuildContext context) {
  ...
  print('\nSection: services');
  print('Target symbol: RawKeyEventDataMacOs');
  ...
  print('\nExtended notes:');
  print('- Naming consistency checked for RawKeyEventDataMacOs');
  ...
  return Column(
    ...
    children: const [
      Text('RawKeyEventDataMacOs Tests', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
      SizedBox(height: 8),
