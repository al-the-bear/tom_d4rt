...
dynamic build(BuildContext context) {
  print('╔════════════════════════════════════════════════════════════════════╗');
  print('║                    SAW TOOTH DEEP DEMO                            ║');
  print('║            Repeating Linear Pattern Animation                     ║');
  print('╚════════════════════════════════════════════════════════════════════╝');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 1: SAW TOOTH FUNDAMENTALS                                 │');
  print('│ Understanding the repeating pattern                               │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 2: SAWTOOTH(1) - SINGLE CYCLE                             │');
  print('│ Identity transformation (same as linear)                          │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 3: SAWTOOTH(2) - TWO CYCLES                               │');
  print('│ Pattern repeats twice                                             │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  for (var i = 0; i <= 20; i++) {
    ...
    print('│ ${t.toStringAsFixed(2)}  │     ${out.toStringAsFixed(4).padLeft(6)}      │    ${cycle + 1}    │ $bar │');
  }
  print('└───────┴─────────────────┴─────────┴────────────────────────────────┘');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 4: SAWTOOTH(3) - THREE CYCLES                             │');
  print('│ Pattern repeats three times                                       │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  print('');
  print('┌───────┬─────────────────┬─────────┬────────────────────────────────┐');
  print('│   t   │     Output      │  Cycle  │   Wave Pattern                 │');
  print('├───────┼─────────────────┼─────────┼────────────────────────────────┤');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 5: FORMULA VERIFICATION                                   │');
  print('│ Checking: output = (t * count) % 1.0                              │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  for (final t in tValues) {
    ...
    formulaResults.add({'t': t, 'saw': sawVal, 'formula': formulaVal, 'diff': diff});
    print('│ ${t.toStringAsFixed(1)}   │     ${sawVal.toStringAsFixed(6).padLeft(8)}    │     ${formulaVal.toStringAsFixed(6).padLeft(8)}    │  ${diff.toStringAsFixed(8).padLeft(10)}   │');
  }
  print('└───────┴─────────────────┴─────────────────┴───────────────┘');
  print('');
  print('Result: ${formulaValid ? '✓ Formula verified!' : '✗ Mismatch detected'}');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 6: CYCLE COUNT COMPARISON                                 │');
  print('│ Different counts at same t values                                 │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  for (final t in tValues) {
    ...
    print('│ ${t.toStringAsFixed(1)}   │  ${s1.toStringAsFixed(2).padLeft(5)}   │  ${s2.toStringAsFixed(2).padLeft(5)}   │  ${s3.toStringAsFixed(2).padLeft(5)}   │  ${s4.toStringAsFixed(2).padLeft(5)}   │  ${s5.toStringAsFixed(2).padLeft(5)}   │');
  }
  print('└───────┴──────────┴──────────┴──────────┴──────────┴──────────┘');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 7: DISCONTINUITY POINTS                                   │');
  print('│ Where the pattern resets                                          │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  for (final t in [0.24, 0.249, 0.25, 0.251, 0.26, 0.49, 0.5, 0.51, 0.74, 0.75, 0.76]) {
    final out = saw4.transform(t);
    String status;
    if ((t * 4) % 1.0 < 0.1) status = '↓ Just reset';
    else if ((t * 4) % 1.0 > 0.9) status = '↑ About to reset';
    else status = '  Mid-cycle';
    discontinuityResults.add({'t': t, 'out': out, 'status': status});
    print('│  ${t.toStringAsFixed(3).padLeft(5)}  │     ${out.toStringAsFixed(4).padLeft(6)}      │ ${status.padRight(38)} │');
  }
  print('└─────────┴─────────────────┴────────────────────────────────────────┘');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 8: PRACTICAL APPLICATIONS                                 │');
  print('│ Common use cases for SawTooth                                     │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 9: FREQUENCY ANALYSIS                                     │');
  print('│ Cycle duration and frequency                                      │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  for (final count in [1, 2, 3, 4, 5, 10]) {
    ...
    print('│     ${count.toString().padLeft(2)}      │       ${duration.toStringAsFixed(4).padLeft(6)}         │           ${freq.toStringAsFixed(1).padLeft(4)}              │');
  }
  print('└─────────────┴────────────────────┴─────────────────────────────┘');
  print('');
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  print('┌────────────────────────────────────────────────────────────────────┐');
  print('│ SECTION 10: HIGH FREQUENCY DEMO                                   │');
  print('│ SawTooth(10) - rapid pulsing                                      │');
  print('└────────────────────────────────────────────────────────────────────┘');
  print('');
  ...
  print('┌───────┬─────────────────┬─────────┬────────────────────────────────┐');
  print('│   t   │     Output      │  Cycle  │   Rapid Pattern                │');
  print('├───────┼─────────────────┼─────────┼────────────────────────────────┤');
  ...
  for (var i = 0; i <= 20; i++) {
    ...
    final barWidth = (out * 24).round().clamp(0, 24);
    final bar = '█' * barWidth + '░' * (24 - barWidth);
    print('│ ${t.toStringAsFixed(2)}  │     ${out.toStringAsFixed(4).padLeft(6)}      │   ${cycle.toString().padLeft(2)}    │ $bar │');
  }
  print('└───────┴─────────────────┴─────────┴────────────────────────────────┘');
  print('');
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Text('output = (t × count) mod 1.0', style: TextStyle(fontFamily: 'monospace', fontSize: 14, fontWeight: FontWeight.bold)),
                      SizedBox(height: 8),
                      Text('Each cycle: 0 → 1 → 0 → 1 ...', style: TextStyle(fontSize: 11, color: Color(0xFF757575))),
                    ],
                  ),
                ),
              ],
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12.0),
                ...compResults.where((r) => [0.0, 0.25, 0.5, 0.75, 1.0].contains(r['t'])).map((r) => _buildComparisonRow(r)),
              ],
            ),
          ),
          SizedBox(height: 16.0),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildUseCaseItem('Pulse Effect', 'Attention-grabbing animation'),
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    _buildSummaryStat('Saw2(0.3)', saw2.transform(0.3).toStringAsFixed(2)),
                    _buildSummaryStat('Saw3(0.5)', saw3.transform(0.5).toStringAsFixed(2)),
                    _buildSummaryStat('Saw4(0.7)', saw4.transform(0.7).toStringAsFixed(2)),
                  ],
                ),
              ],
            ),
...
Widget _buildSawtoothGraph(String label, SawTooth curve, Color color) {
  return Row(
    children: [
      Container(width: 65, child: Text(label, style: TextStyle(color: Colors.white70, fontSize: 11))),
      Expanded(
        child: Container(
          height: 30,
          child: CustomPaint(
      ...
      children: [
        ...
        Expanded(
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              _buildSmallValue((r['s1'] as double).toStringAsFixed(2), Color(0xFF4CAF50)),
              _buildSmallValue((r['s2'] as double).toStringAsFixed(2), Color(0xFF2196F3)),
              _buildSmallValue((r['s3'] as double).toStringAsFixed(2), Color(0xFFFF9800)),
              _buildSmallValue((r['s4'] as double).toStringAsFixed(2), Color(0xFFE91E63)),
              _buildSmallValue((r['s5'] as double).toStringAsFixed(2), Color(0xFF9C27B0)),
            ],
          ),
        ),
      ],
...
Widget _buildFrequencyRow(Map<String, dynamic> r) {
  return Padding(
    ...
    child: Row(
      children: [
        Container(width: 60, child: Text('Count: ${r['count']}', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w500))),
        Expanded(
          child: Container(
            height: 16,
            decoration: BoxDecoration(
        ...
        Container(
          ...
          child: Text('${(r['duration'] as double).toStringAsFixed(3)}s/cycle', style: TextStyle(fontSize: 9, fontFamily: 'monospace')),
        ),
      ],
    ),
  );
...
Widget _buildUseCaseItem(String title, String description) {
  return Padding(
    ...
    child: Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('• ', style: TextStyle(color: Color(0xFFF57C00), fontWeight: FontWeight.bold)),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
