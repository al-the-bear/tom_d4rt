...
dynamic build(BuildContext context) {
  ...
  _expect(
    (doubleFlipped.transform(0.2) - Curves.easeIn.transform(0.2)).abs() <
        0.0001,
    'double flip approximates original curve',
    logs,
  );
  assertionCount++;
  ...
  assertionCount++;
  _expect(
    (flipped.transform(1.0) - 1.0).abs() < 0.000001,
    'edge case t=1 returns 1',
    logs,
  );
  assertionCount++;
