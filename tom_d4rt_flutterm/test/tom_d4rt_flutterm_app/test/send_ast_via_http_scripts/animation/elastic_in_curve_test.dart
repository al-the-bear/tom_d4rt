...
dynamic build(BuildContext context) {
  ...
  _expect(
    curveDefault.transform(0.0) == 0.0,
    'transform(0.0) equals 0.0',
    logs,
  );
  assertionCount++;
  _expect(
    curveDefault.transform(1.0) == 1.0,
    'transform(1.0) equals 1.0',
    logs,
  );
  assertionCount++;
  ...
  _expect(
    nearZero.isFinite && nearOne.isFinite,
  ...
  _expect(
    hasNegativeOvershoot || valuesCustom.every((v) => v.isFinite),
    'behavior includes expected elastic characteristics',
    logs,
  );
  assertionCount++;
