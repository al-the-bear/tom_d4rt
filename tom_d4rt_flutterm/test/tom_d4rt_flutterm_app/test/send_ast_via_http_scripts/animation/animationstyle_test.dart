...
dynamic build(BuildContext context) {
  ...
  print('AnimationStyle(duration=500ms, reverseDuration=250ms, curve=easeIn, reverseCurve=easeOut):');
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.0),
                Text('• Controls duration and curve of animations',
                    style: TextStyle(fontSize: 11.0)),
                Text('• Can specify reverse duration/curve separately',
                    style: TextStyle(fontSize: 11.0)),
                Text('• AnimationStyle.noAnimation disables animation',
                    style: TextStyle(fontSize: 11.0)),
                Text('• Used with AnimatedContainer, ExpansionTile, etc.',
                    style: TextStyle(fontSize: 11.0)),
              ],
            ),
          ),
