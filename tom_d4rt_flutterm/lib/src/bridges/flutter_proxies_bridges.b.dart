...
class FlutterProxiesBridge {
  ...
  static Map<String, String> classSourceUris() {
    return {
      'D4rtCustomPainter':
          'package:tom_d4rt_flutterm/src/bridges/flutter_proxies.b.dart',
      'D4rtCustomClipper':
          'package:tom_d4rt_flutterm/src/bridges/flutter_proxies.b.dart',
      'D4rtFlowDelegate':
          'package:tom_d4rt_flutterm/src/bridges/flutter_proxies.b.dart',
  ...
  static List<String> subPackageBarrels() {
    return ['package:flutter/rendering.dart'];
  }
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final onPaintRaw = D4.getRequiredNamedArg<Object>(
          named,
          'onPaint',
          'D4rtCustomPainter',
        );
        final onShouldRepaintRaw = D4.getRequiredNamedArg<Object>(
          named,
          'onShouldRepaint',
          'D4rtCustomPainter',
        );
        return D4rtCustomPainter(
          ...
          onShouldRepaint: (CustomPainter oldDelegate) {
            return D4.callInterpreterCallback(visitor, onShouldRepaintRaw, [
                  oldDelegate,
                ])
                as bool;
          },
    ...
    getters: {
      'onPaint': (visitor, target) => D4
          .validateTarget<D4rtCustomPainter>(target, 'D4rtCustomPainter')
          .onPaint,
      'onShouldRepaint': (visitor, target) => D4
          .validateTarget<D4rtCustomPainter>(target, 'D4rtCustomPainter')
          .onShouldRepaint,
    },
    methods: {
      'paint': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<D4rtCustomPainter>(
          target,
          'D4rtCustomPainter',
        );
        D4.requireMinArgs(positional, 2, 'paint');
        final canvas = D4.getRequiredArg<Canvas>(
          positional,
          0,
          'canvas',
          'paint',
      ...
      'shouldRepaint': (visitor, target, positional, named, typeArgs) {
        ...
        final oldDelegate = D4.getRequiredArg<CustomPainter>(
          positional,
          0,
          'oldDelegate',
          'shouldRepaint',
...
BridgedClass _createD4rtCustomClipperBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final onGetClipRaw = D4.getRequiredNamedArg<Object>(
          named,
          'onGetClip',
          'D4rtCustomClipper',
        );
        final onShouldReclipRaw = D4.getRequiredNamedArg<Object>(
          named,
          'onShouldReclip',
          'D4rtCustomClipper',
        );
        return D4rtCustomClipper<Rect>(
          ...
          onShouldReclip: (CustomClipper<Rect> oldClipper) {
            return D4.callInterpreterCallback(visitor, onShouldReclipRaw, [
                  oldClipper,
                ])
                as bool;
          },
    ...
    getters: {
      'onGetClip': (visitor, target) => D4
          .validateTarget<D4rtCustomClipper>(target, 'D4rtCustomClipper')
          .onGetClip,
      'onShouldReclip': (visitor, target) => D4
          .validateTarget<D4rtCustomClipper>(target, 'D4rtCustomClipper')
          .onShouldReclip,
    },
    methods: {
      'getClip': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<D4rtCustomClipper>(
          target,
          'D4rtCustomClipper',
        );
      ...
      'shouldReclip': (visitor, target, positional, named, typeArgs) {
        ...
        final oldClipper = D4.getRequiredArg<CustomClipper>(
          positional,
          0,
          'oldClipper',
          'shouldReclip',
    ...
    constructorSignatures: {
      ...
      'rect':
          'D4rtCustomClipper.rect({required Rect Function(Size) onGetClip, required bool Function(CustomClipper<Rect>) onShouldReclip})',
      'path':
          'D4rtCustomClipper.path({required Path Function(Size) onGetClip, required bool Function(CustomClipper<Path>) onShouldReclip})',
    },
    methodSignatures: {
...
BridgedClass _createD4rtFlowDelegateBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final onPaintChildrenRaw = D4.getRequiredNamedArg<Object>(
          named,
          'onPaintChildren',
          'D4rtFlowDelegate',
        );
    ...
    getters: {
      'onPaintChildren': (visitor, target) => D4
          .validateTarget<D4rtFlowDelegate>(target, 'D4rtFlowDelegate')
          .onPaintChildren,
      'onShouldRepaint': (visitor, target) => D4
          .validateTarget<D4rtFlowDelegate>(target, 'D4rtFlowDelegate')
          .onShouldRepaint,
    ...
    methods: {
      'paintChildren': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<D4rtFlowDelegate>(
          target,
          'D4rtFlowDelegate',
        );
        D4.requireMinArgs(positional, 1, 'paintChildren');
        final context = D4.getRequiredArg<FlowPaintingContext>(
          positional,
          0,
          'context',
          'paintChildren',
      ...
      'shouldRepaint': (visitor, target, positional, named, typeArgs) {
        ...
        D4.requireMinArgs(positional, 1, 'shouldRepaint');
        final oldDelegate = D4.getRequiredArg<FlowDelegate>(
          positional,
          0,
          'oldDelegate',
          'shouldRepaint',
    ...
    getterSignatures: {
      'onPaintChildren':
          'void Function(FlowPaintingContext) get onPaintChildren',
...
BridgedClass _createD4rtMultiChildLayoutDelegateBridge() {
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        final onPerformLayoutRaw = D4.getRequiredNamedArg<Object>(
          named,
          'onPerformLayout',
          'D4rtMultiChildLayoutDelegate',
        );
        final onShouldRelayoutRaw = D4.getRequiredNamedArg<Object>(
          named,
          'onShouldRelayout',
          'D4rtMultiChildLayoutDelegate',
        );
    ...
    getters: {
      'onPerformLayout': (visitor, target) => D4
          .validateTarget<D4rtMultiChildLayoutDelegate>(
            target,
            'D4rtMultiChildLayoutDelegate',
          )
          .onPerformLayout,
      'onShouldRelayout': (visitor, target) => D4
          .validateTarget<D4rtMultiChildLayoutDelegate>(
            target,
            'D4rtMultiChildLayoutDelegate',
          )
    ...
    methods: {
      'performLayout': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<D4rtMultiChildLayoutDelegate>(
          target,
          'D4rtMultiChildLayoutDelegate',
        );
      ...
      'shouldRelayout': (visitor, target, positional, named, typeArgs) {
        ...
        final oldDelegate = D4.getRequiredArg<MultiChildLayoutDelegate>(
          positional,
          0,
          'oldDelegate',
          'shouldRelayout',
    ...
    getterSignatures: {
      ...
      'onShouldRelayout':
          'bool Function(MultiChildLayoutDelegate) get onShouldRelayout',
    },
  );
}
  ...
  return BridgedClass(
    ...
    methods: {
      'shouldRelayout': (visitor, target, positional, named, typeArgs) {
        ...
        D4.requireMinArgs(positional, 1, 'shouldRelayout');
        final oldDelegate = D4.getRequiredArg<SingleChildLayoutDelegate>(
          positional,
          0,
          'oldDelegate',
          'shouldRelayout',
