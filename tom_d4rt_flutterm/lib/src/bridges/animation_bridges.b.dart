...
// Sources: 11 files
// Generated: 2026-03-03T11:56:00.927165
  ...
  return BridgedClass(
    ...
    methods: {
      ...
      'then': (visitor, target, positional, named, typeArgs) {
        ...
        return t.then((void p0) {
          return D4.callInterpreterCallback(visitor, onValueRaw, [null])
              as FutureOr<Object>;
        }, onError: onError);
      },
      'timeout': (visitor, target, positional, named, typeArgs) {
        ...
        return t.timeout(
          ...
          onTimeout: onTimeoutRaw == null
              ? null
              : () {
                  return D4.callInterpreterCallback(visitor, onTimeoutRaw, [])
                      as FutureOr<void>;
                },
        );
      },
      'whenComplete': (visitor, target, positional, named, typeArgs) {
        ...
        return t.whenComplete(() {
          return D4.callInterpreterCallback(visitor, actionRaw, []) as dynamic;
        });
      },
    ...
    constructors: {
      'fromCallback': (visitor, positional, named) {
        ...
        return $flutter_7.Animatable.fromCallback((double p0) {
          return D4.callInterpreterCallback(visitor, callbackRaw, [p0])
              as dynamic;
        });
      },
    },
  ...
  return BridgedClass(
    ...
    setters: {
      'begin': (visitor, target, value) =>
          D4
              .validateTarget<$flutter_7.ReverseTween>(target, 'ReverseTween')
              .begin = D4.extractBridgedArgOrNull<Object?>(
            value,
            'begin',
          ),
      'end': (visitor, target, value) =>
          D4
              .validateTarget<$flutter_7.ReverseTween>(target, 'ReverseTween')
              .end = D4.extractBridgedArgOrNull<Object?>(
            value,
            'end',
          ),
    },
...
BridgedClass _createColorTweenBridge() {
  return BridgedClass(
    ...
    setters: {
      'begin': (visitor, target, value) =>
          D4.validateTarget<$flutter_7.ColorTween>(target, 'ColorTween').begin =
              D4.extractBridgedArgOrNull<dynamic>(value, 'begin'),
      'end': (visitor, target, value) =>
          D4.validateTarget<$flutter_7.ColorTween>(target, 'ColorTween').end =
              D4.extractBridgedArgOrNull<dynamic>(value, 'end'),
    },
    methods: {
      'transform': (visitor, target, positional, named, typeArgs) {
    ...
    setters: {
      ...
      'end': (visitor, target, value) =>
          D4.validateTarget<$flutter_7.SizeTween>(target, 'SizeTween').end = D4
              .extractBridgedArgOrNull<dynamic>(value, 'end'),
    },
    methods: {
      'transform': (visitor, target, positional, named, typeArgs) {
    ...
    setters: {
      'begin': (visitor, target, value) =>
          D4.validateTarget<$flutter_7.IntTween>(target, 'IntTween').begin = D4
              .extractBridgedArgOrNull<dynamic>(value, 'begin'),
      'end': (visitor, target, value) =>
  ...
  return BridgedClass(
    ...
    setters: {
      'begin': (visitor, target, value) =>
          D4
              .validateTarget<$flutter_7.ConstantTween>(target, 'ConstantTween')
              .begin = D4.extractBridgedArgOrNull<dynamic>(
            value,
            'begin',
          ),
      'end': (visitor, target, value) =>
          D4
              .validateTarget<$flutter_7.ConstantTween>(target, 'ConstantTween')
              .end = D4.extractBridgedArgOrNull<dynamic>(
            value,
            'end',
          ),
    },
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        switch (value) {
          ...
          case Color _:
            return $flutter_4.AlwaysStoppedAnimation<Color>(value);
          case Offset _:
            return $flutter_4.AlwaysStoppedAnimation<Offset>(value);
          case Size _:
            return $flutter_4.AlwaysStoppedAnimation<Size>(value);
          case Rect _:
            return $flutter_4.AlwaysStoppedAnimation<Rect>(value);
          default:
    ...
    setters: {
      'onSwitchedTrain': (visitor, target, value) =>
          D4
              ...
              .onSwitchedTrain = D4.extractBridgedArgOrNull<dynamic>(
            value,
            'onSwitchedTrain',
          ),
    },
