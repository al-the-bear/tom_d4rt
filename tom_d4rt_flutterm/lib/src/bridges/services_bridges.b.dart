...
// Sources: 43 files
// Generated: 2026-04-23T11:01:28.000132
...
BridgedClass _createBasicMessageChannelBridge() {
  return BridgedClass(
    ...
    methods: {
      ...
      'setMessageHandler': $tom_d4rt_flutterm_1.BasicMessageChannelUserBridge.overrideMethodSetMessageHandler,
    },
    constructorSignatures: {
  ...
  return BridgedClass(
    ...
    setters: {
      'pointTransformer': (visitor, target, value) {
        ...
        D4.validateTarget<$flutter_33.AndroidViewController>(target, 'AndroidViewController').pointTransformer = (Offset p0) { return D4.extractBridgedArg<Offset>(D4.callInterpreterCallback(visitor!, pointTransformerRaw, [p0]), 'callback', visitor); };
      },
    },
    methods: {
