...
// Sources: 5 files
// Generated: 2026-04-28T01:11:48.001984
  ...
  return BridgedClass(
    ...
    setters: {
      'schedulingStrategy': (visitor, target, value) {
        ...
        D4.validateTarget<$flutter_4.SchedulerBinding>(target, 'SchedulerBinding').schedulingStrategy = ({required int priority, required $flutter_4.SchedulerBinding scheduler}) { return D4.extractBridgedArg<bool>(D4.callInterpreterCallback(visitor!, schedulingStrategyRaw, [], {'priority': priority, 'scheduler': scheduler}), 'callback', visitor); };
      },
    },
    methods: {
