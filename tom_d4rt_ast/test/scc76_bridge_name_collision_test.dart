...
//
// It would decay. F-SCC76-3 drives it from `AstModuleLoader.stdlibModuleNames`,
...
void main() {
  ...
  test('F-SCC76-3: this file registers every module the loader can '
    ...
    final missing =
        AstModuleLoader.stdlibModuleNames
    ...
    expect(
      ...
      isEmpty,
      reason:
          'AstModuleLoader can register these `dart:` modules and this file '
          'does '
