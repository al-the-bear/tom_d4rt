...
Object? runIs(SExpression value, STypeAnnotation type, {bool isNot = false}) =>
    D4rtRunner().executeBundle(bundleReturning(
      SIsExpression(
        offset: 0,
        length: 0,
        expression: value,
...
void main() {
  ...
  group('DGUB8: record type annotation resolution — named fields', () {
    ...
    test(
      'F-DGUB8-AST-2: swapped named/positional field types are rejected '
      '[2026-07-28] (PASS)',
      () {
        expect(
          runIs(
    ...
    test(
      'F-DGUB8-AST-3: a differently NAMED field is rejected even when the '
    ...
    test(
      'F-DGUB8-AST-4: named-field count must agree [2026-07-28] (PASS)',
      () {
        expect(
          runIs(
            answerRecord(),
  ...
  group('DGUB8: record type annotation resolution — positional fields', () {
    ...
    test(
      'F-DGUB8-AST-5: a positional-only record matches its own field types '
      '[2026-07-28] (PASS)',
      () {
        expect(runIs(pair(), recordType(positional: [
          namedType('int'),
          namedType('String'),
        ])), isTrue);
      },
    ...
    test(
      'F-DGUB8-AST-6: positional field types are checked, not just arity '
      '[2026-07-28] (PASS)',
      () {
  ...
  group('DGUB8: record type annotation resolution — as casts', () {
    test(
      'F-DGUB8-AST-10: a matching record cast succeeds and keeps its fields '
      '[2026-07-28] (PASS)',
      () {
    ...
    test(
      'F-DGUB8-AST-11: a mismatched record cast now throws instead of being '
