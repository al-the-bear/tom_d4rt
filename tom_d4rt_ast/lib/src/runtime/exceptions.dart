...
/// Opt-in per-phase timing profiler for D4rt execution.
///
...
///
/// Mirror of `D4rtProfile` in the analyzer-based `tom_d4rt` package, kept in
/// sync per the quest mirror rule. The class is provided here for symmetry of
/// the runtime surface; wiring the AST-driven runner's execute path with
/// `time()` call sites is a deferred follow-up (the Flutter test app currently
/// profiles via the analyzer-based `D4rt`).
class D4rtProfile {
