  ...
  static BridgedClass get definition => BridgedClass(
          ...
          'fromList': (visitor, positionalArgs, namedArgs) {
            if (positionalArgs.length == 1 && positionalArgs[0] is List) {
              ...
              final intList = sourceList.toNativeList().map((e) {
                ...
                throw RuntimeD4rtException("Uint16List.fromList expects a List<int>.");
              }).toList();
        ...
        methods: {
          ...
          'setRange': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            final iterable = coerceElements<int>(
                positionalArgs[2], 'Uint16List.setRange');
            final skipCount =
          ...
          'setAll': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            final iterable = coerceElements<int>(
                positionalArgs[1], 'Uint16List.setAll');
        ...
        getters: {
          ...
          'first': (visitor, target) {
            ...
            throw RuntimeD4rtException("Target is not an Uint16List for getter 'first'");
          },
          'last': (visitor, target) {
            if (target is Uint16List) return target.last;
            throw RuntimeD4rtException("Target is not an Uint16List for getter 'last'");
          },
