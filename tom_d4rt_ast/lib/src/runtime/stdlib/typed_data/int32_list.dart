  ...
  static BridgedClass get definition => BridgedClass(
      ...
      'fromList': (visitor, positionalArgs, namedArgs) {
        if (positionalArgs.length == 1 && positionalArgs[0] is List) {
          ...
          final intList = sourceList.toNativeList().map((e) {
            ...
            throw RuntimeD4rtException(
              "Int32List.fromList expects a List<int>.",
            );
          }).toList();
    ...
    methods: {
      ...
      'sublist': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Int32List.sublist', atMost: 2);
      ...
      'getRange': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Int32List.getRange', atMost: 2);
      ...
      'setRange': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Int32List.setRange', atMost: 4);
        final start = positionalArgs[0] as int;
        final end = positionalArgs[1] as int;
      ...
      'setAll': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Int32List.setAll', atMost: 2);
      ...
      'fillRange': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Int32List.fillRange', atMost: 3);
        final start = positionalArgs[0] as int;
        final end = positionalArgs[1] as int;
      ...
      'asUint8ListView': (visitor, target, positionalArgs, namedArgs, _) {
        ...
        final length = positionalArgs.length > 1
            ? positionalArgs[1] as int?
            : null;
        return (target as Int32List).buffer.asUint8List(
          offsetInBytes ?? 0,
          length,
        );
      },
      ...
      '==': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Int32List.==', atMost: 1);
    ...
    getters: {
      ...
      'first': (visitor, target) {
        ...
        throw RuntimeD4rtException(
          "Target is not an Int32List for getter 'first'",
        );
      },
      'last': (visitor, target) {
        if (target is Int32List) return target.last;
        throw RuntimeD4rtException(
          "Target is not an Int32List for getter 'last'",
        );
      },
      ...
      ...inheritedListGetters<int>((t) => t as Int32List),
    },
  );
}
