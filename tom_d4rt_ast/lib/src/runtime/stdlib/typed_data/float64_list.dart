  ...
  static BridgedClass get definition => BridgedClass(
      ...
      'fromList': (visitor, positionalArgs, namedArgs) {
        if (positionalArgs.length == 1 && positionalArgs[0] is List) {
          ...
          final doubleList = sourceList.toNativeList().map((e) {
            ...
            throw RuntimeD4rtException(
              "Float64List.fromList expects a List<num>.",
            );
          }).toList();
    ...
    methods: {
      ...
      'sublist': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Float64List.sublist', atMost: 2);
      ...
      'getRange': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Float64List.getRange', atMost: 2);
      ...
      'setRange': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Float64List.setRange', atMost: 4);
        final start = positionalArgs[0] as int;
        final end = positionalArgs[1] as int;
        final iterable = coerceElements<double>(
          positionalArgs[2],
          'Float64List.setRange',
        );
      ...
      'setAll': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Float64List.setAll', atMost: 2);
      ...
      'fillRange': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Float64List.fillRange', atMost: 3);
        final start = positionalArgs[0] as int;
        final end = positionalArgs[1] as int;
      ...
      'asUint8ListView': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Float64List.asUint8ListView', atMost: 2);
      ...
      '==': (visitor, target, positionalArgs, namedArgs, _) {
        D4.checkArity(positionalArgs, 'Float64List.==', atMost: 1);
    ...
    getters: {
      ...
      'last': (visitor, target) {
        ...
        throw RuntimeD4rtException(
          "Target is not a Float64List for getter 'last'",
        );
      },
