  ...
  static BridgedClass get definition => BridgedClass(
          ...
          'fromList': (visitor, positionalArgs, namedArgs) {
            if (positionalArgs.length == 1 && positionalArgs[0] is List) {
              ...
              final intList = sourceList.toNativeList().map((e) {
                ...
                throw RuntimeD4rtException("Uint32List.fromList expects a List<int>.");
              }).toList();
        ...
        methods: {
          ...
          'setRange': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            final iterable = coerceElements<int>(
                positionalArgs[2], 'Uint32List.setRange');
            final skipCount =
          ...
          'setAll': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            final iterable = coerceElements<int>(
                positionalArgs[1], 'Uint32List.setAll');
          ...
          ...inheritedListMethods<int>((t) => t as Uint32List,
        ...
        getters: {
          ...
          'first': (visitor, target) {
            ...
            throw RuntimeD4rtException("Target is not an Uint32List for getter 'first'");
          },
          'last': (visitor, target) {
            if (target is Uint32List) return target.last;
            throw RuntimeD4rtException("Target is not an Uint32List for getter 'last'");
          },
