  ...
  static BridgedClass get definition => BridgedClass(
        ...
        methods: {
          ...
          'containsValue': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            return _view(target, 'containsValue')
          ...
          'map': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            return _view(target, 'map').map((key, value) =>
                _asMapEntry(convert.call(visitor, [key, value])));
          },
          ...
          'putIfAbsent': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            return _view(target, 'putIfAbsent').putIfAbsent(
                positionalArgs[0], () => ifAbsent.call(visitor, []));
          },
