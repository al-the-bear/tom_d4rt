...
Object? _runCallback(
    InterpreterVisitor visitor, Object? fn, List<Object?> args, String where) {
  ...
  static BridgedClass get definition => BridgedClass(
        ...
        methods: {
          ...
          'removeWhere': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            (target as DoubleLinkedQueue).removeWhere((e) =>
          ...
          'retainWhere': (visitor, target, positionalArgs, namedArgs, _) {
            final test = positionalArgs.firstOrNull;
            (target as DoubleLinkedQueue).retainWhere((e) =>
          ...
          'forEachEntry': (visitor, target, positionalArgs, namedArgs, _) {
            ...
            (target as DoubleLinkedQueue).forEachEntry((entry) =>
                _runCallback(
                    visitor, action, [entry], 'DoubleLinkedQueue.forEachEntry'));
            return null;
          },
        ...
        getters: {
          ...
          'single': (visitor, target) {
            final queue = target as DoubleLinkedQueue;
            if (queue.length != 1) {
              throw RuntimeD4rtException(queue.isEmpty
