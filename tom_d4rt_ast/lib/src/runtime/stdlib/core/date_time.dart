    ...
    constructors: {
      ...
      '': (visitor, positionalArgs, namedArgs) {
        if (positionalArgs.isNotEmpty) {
          ...
          final month = positionalArgs.length > 1
              ? positionalArgs[1] as int
              : 1;
          final day = positionalArgs.length > 2 ? positionalArgs[2] as int : 1;
          final hour = positionalArgs.length > 3 ? positionalArgs[3] as int : 0;
          final minute = positionalArgs.length > 4
              ? positionalArgs[4] as int
              : 0;
          final second = positionalArgs.length > 5
              ? positionalArgs[5] as int
              : 0;
          final millisecond = positionalArgs.length > 6
              ? positionalArgs[6] as int
              : 0;
          final microsecond = positionalArgs.length > 7
      ...
      'utc': (visitor, positionalArgs, namedArgs) {
        final year = positionalArgs[0] as int;
        final month = positionalArgs.length > 1 ? positionalArgs[1] as int : 1;
        final day = positionalArgs.length > 2 ? positionalArgs[2] as int : 1;
        final hour = positionalArgs.length > 3 ? positionalArgs[3] as int : 0;
        final minute = positionalArgs.length > 4 ? positionalArgs[4] as int : 0;
        final second = positionalArgs.length > 5 ? positionalArgs[5] as int : 0;
        final millisecond = positionalArgs.length > 6
            ? positionalArgs[6] as int
            : 0;
        final microsecond = positionalArgs.length > 7
