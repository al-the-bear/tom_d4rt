...
class InvocationCore {
  static BridgedClass get definition => BridgedClass(
    ...
    constructors: {
      ...
      'method': (visitor, positionalArgs, namedArgs) {
        ...
        final named = positionalArgs.length > 2
            ? (positionalArgs[2] as Map?)?.cast<Symbol, Object?>() ??
                  <Symbol, Object?>{}
            : <Symbol, Object?>{};
      ...
      'genericMethod': (visitor, positionalArgs, namedArgs) {
        ...
        final named = positionalArgs.length > 3
            ? (positionalArgs[3] as Map?)?.cast<Symbol, Object?>() ??
                  <Symbol, Object?>{}
            : <Symbol, Object?>{};
    ...
    getters: {
      ...
      'positionalArguments': (visitor, target) =>
          (target as Invocation).positionalArguments,
      'namedArguments': (visitor, target) =>
          (target as Invocation).namedArguments,
      'typeArguments': (visitor, target) =>
          (target as Invocation).typeArguments,
