  ...
  static BridgedClass get definition => BridgedClass(
    ...
    constructors: {
      'fromString': (visitor, positionalArgs, namedArgs) {
        ...
        return UriData.fromString(
          ...
          parameters: namedArgs.get<Map?>('parameters')?.cast<String, String>(),
      ...
      'fromBytes': (visitor, positionalArgs, namedArgs) {
        ...
        return UriData.fromBytes(
          ...
          mimeType:
              namedArgs.get<String?>('mimeType') ?? 'application/octet-stream',
          parameters: namedArgs.get<Map?>('parameters')?.cast<String, String>(),
    ...
    methods: {
      ...
      'isEncoding': (visitor, target, positionalArgs, namedArgs, _) {
        ...
        return (target as UriData).isEncoding(positionalArgs[0] as Encoding);
      },
