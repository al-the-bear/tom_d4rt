  ...
  static BridgedClass get definition => BridgedClass(
    ...
    methods: {
      ...
      'getRawOption': (visitor, target, positionalArgs, namedArgs, _) {
        ...
        return (target as Socket).getRawOption(
          positionalArgs[0] as RawSocketOption,
        );
      },
      'setRawOption': (visitor, target, positionalArgs, namedArgs, _) {
        ...
        (target as Socket).setRawOption(positionalArgs[0] as RawSocketOption);
        return null;
      },
    ...
    getters: {
      ...
      'remoteAddress': (visitor, target) => (target as Socket).remoteAddress,
  ...
  static BridgedClass get definition => BridgedClass(
    ...
    staticMethods: {
      'lookup': (visitor, positionalArgs, namedArgs, _) {
        ...
        final type =
            namedArgs['type'] as InternetAddressType? ??
    ...
    getters: {
      ...
      'rawAddress': (visitor, target) => (target as InternetAddress).rawAddress,
      'isLoopback': (visitor, target) => (target as InternetAddress).isLoopback,
...
class RawSocketIo {
  static BridgedClass get definition => BridgedClass(
    ...
    getters: {
      ...
      'remoteAddress': (visitor, target) => (target as RawSocket).remoteAddress,
...
class ConnectionTaskIo {
  static BridgedClass get definition => BridgedClass(
    ...
    getters: {'socket': (visitor, target) => (target as ConnectionTask).socket},
  );
}
  ...
  static BridgedClass get definition => BridgedClass(
    ...
    staticMethods: {
      'list': (visitor, positionalArgs, namedArgs, _) async {
        final includeLoopback = namedArgs['includeLoopback'] as bool? ?? false;
    ...
    getters: {
      ...
      'addresses': (visitor, target) => (target as NetworkInterface).addresses,
    },
  );
}
