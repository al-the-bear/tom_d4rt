    ...
    methods: {
      'readLineSync': (visitor, target, positionalArgs, namedArgs, _) =>
          (target as Stdin).readLineSync(
            encoding: namedArgs['encoding'] as Encoding? ?? systemEncoding,
            retainNewlines: namedArgs['retainNewlines'] as bool? ?? false,
          ),
...
class StdoutIo {
  static BridgedClass get definition => BridgedClass(
    ...
    getters: {
      ...
      'terminalLines': (visitor, target) => (target as Stdout).terminalLines,
