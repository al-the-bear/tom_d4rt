...
class D4 {
  ...
  ///
  /// Wired into the runtime reset API ([D4rtRunner.resetScriptDeclarations] /
  /// `D4rt.resetScriptDeclarations`) so an embedder's `/clear` actually frees
  /// the native→interpreted entries pinned by the previous build's framework
  /// objects, instead of leaking them until process recycle.
  ///
