...
class AsyncExecutionState {
  ...
  final Map<SCascadeExpression, Object?> cascadeTargets =
      Map<SCascadeExpression, Object?>.identity();
  ...
  final Set<SAstNode> completedCascadeSections = Set<SAstNode>.identity();
