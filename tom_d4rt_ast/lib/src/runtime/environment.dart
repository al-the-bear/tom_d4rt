...
class Environment {
  ...
  void _markAmbiguousBridgeName(
    ...
    Logger.warn(
      "Bridged name '$name' is declared by more than one library; "
  ...
  void _collectAmbiguityCandidate(
    ...
    qualified.putIfAbsent(
      qualifier,
      () => (sourceUri: sourceUri, bridge: bridge),
    );
  }
  ...
  ///
  /// Used by the warm-parent / baseline registration so importing a bridge
  /// package registers the type baseline without forcing every one of the
  /// package's classes to build up front (import-optimization plan step #17).
