...
> A change to one side without the other is incomplete. The verified
> line-by-line map lives in
> `tom_d4rt_generator/doc/mci_step0_review_baseline.md` (§0a/§0b).
...
(The full leaf walk is documented in
`tom_d4rt_generator/doc/step0_review_baseline.md` §0b.)
...
The canonical, line-referenced version of this map is §0b of
