...
// Sources: 6 files
// Generated: 2026-02-13T23:31:34.593717
...
import 'package:path/path.dart' as $pkg;
import 'package:path/src/internal_style.dart' as $aux_path;
...
class PathBridge {
  ...
  static void registerGlobalVariables(D4rt interpreter, String importPath) {
    ...
    try {
      interpreter.registerGlobalVariable('posix', $pkg.posix, importPath, sourceUri: 'package:path/path.dart');
    } catch (e) {
      errors.add('Failed to register variable "posix": $e');
    }
    try {
      interpreter.registerGlobalVariable('windows', $pkg.windows, importPath, sourceUri: 'package:path/path.dart');
    } catch (e) {
      errors.add('Failed to register variable "windows": $e');
    }
    try {
      interpreter.registerGlobalVariable('url', $pkg.url, importPath, sourceUri: 'package:path/path.dart');
    } catch (e) {
      errors.add('Failed to register variable "url": $e');
    }
    try {
      interpreter.registerGlobalVariable('context', $pkg.context, importPath, sourceUri: 'package:path/path.dart');
    } catch (e) {
      errors.add('Failed to register variable "context": $e');
    }
    interpreter.registerGlobalGetter('style', () => $pkg.style, importPath, sourceUri: 'package:path/path.dart');
    interpreter.registerGlobalGetter('current', () => $pkg.current, importPath, sourceUri: 'package:path/path.dart');
    interpreter.registerGlobalGetter('separator', () => $pkg.separator, importPath, sourceUri: 'package:path/path.dart');
  ...
  static Map<String, NativeFunctionImpl> globalFunctions() {
    return {
      'absolute': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.absolute(part1, part2, part3, part4, part5, part6, part7, part8, part9, part10, part11, part12, part13, part14, part15);
      },
      ...
      'basenameWithoutExtension': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.basenameWithoutExtension(path);
      },
      ...
      'extension': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.extension(path, level);
      },
      ...
      'isRootRelative': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.isRootRelative(path);
      },
      'join': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.join(part1, part2, part3, part4, part5, part6, part7, part8, part9, part10, part11, part12, part13, part14, part15, part16);
      },
      ...
      'relative': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.relative(path, from: from);
      },
      'isWithin': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.isWithin(parent, child);
      },
      ...
      'withoutExtension': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.withoutExtension(path);
      },
      'setExtension': (visitor, positional, named, typeArgs) {
        ...
        return $pkg.setExtension(path, extension);
      },
...
BridgedClass _createContextBridge() {
  return BridgedClass(
    nativeType: $pkg.Context,
    name: 'Context',
    constructors: {
      '': (visitor, positional, named) {
        final style = D4.getOptionalNamedArg<$pkg.Style?>(named, 'style');
        final current = D4.getOptionalNamedArg<String?>(named, 'current');
        return $pkg.Context(style: style, current: current);
      },
    },
    getters: {
      'style': (visitor, target) => D4.validateTarget<$pkg.Context>(target, 'Context').style,
      'current': (visitor, target) => D4.validateTarget<$pkg.Context>(target, 'Context').current,
      'separator': (visitor, target) => D4.validateTarget<$pkg.Context>(target, 'Context').separator,
    },
    methods: {
      'absolute': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.Context>(target, 'Context');
        D4.requireMinArgs(positional, 1, 'absolute');
        final part1 = D4.getRequiredArg<String>(positional, 0, 'part1', 'absolute');
...
BridgedClass _createPathExceptionBridge() {
  return BridgedClass(
    nativeType: $pkg.PathException,
    name: 'PathException',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'PathException');
        final message = D4.getRequiredArg<String>(positional, 0, 'message', 'PathException');
        return $pkg.PathException(message);
      },
    },
    getters: {
      'message': (visitor, target) => D4.validateTarget<$pkg.PathException>(target, 'PathException').message,
    },
    setters: {
      'message': (visitor, target, value) => 
        D4.validateTarget<$pkg.PathException>(target, 'PathException').message = value as String,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.PathException>(target, 'PathException');
        return t.toString();
      },
    },
    constructorSignatures: {
...
BridgedClass _createPathMapBridge() {
  return BridgedClass(
    nativeType: $pkg.PathMap,
    name: 'PathMap',
    constructors: {
      '': (visitor, positional, named) {
        final context = D4.getOptionalNamedArg<$pkg.Context?>(named, 'context');
        return $pkg.PathMap(context: context);
      },
      'of': (visitor, positional, named) {
        ...
        final context = D4.getOptionalNamedArg<$pkg.Context?>(named, 'context');
        return $pkg.PathMap.of(other, context: context);
      },
    },
    getters: {
      'isEmpty': (visitor, target) => D4.validateTarget<$pkg.PathMap>(target, 'PathMap').isEmpty,
      'isNotEmpty': (visitor, target) => D4.validateTarget<$pkg.PathMap>(target, 'PathMap').isNotEmpty,
      'length': (visitor, target) => D4.validateTarget<$pkg.PathMap>(target, 'PathMap').length,
      'keys': (visitor, target) => D4.validateTarget<$pkg.PathMap>(target, 'PathMap').keys,
      'values': (visitor, target) => D4.validateTarget<$pkg.PathMap>(target, 'PathMap').values,
      'entries': (visitor, target) => D4.validateTarget<$pkg.PathMap>(target, 'PathMap').entries,
    },
    methods: {
      'cast': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.PathMap>(target, 'PathMap');
        return t.cast();
      },
      ...
      'putIfAbsent': (visitor, target, positional, named, typeArgs) {
        ...
        return t.putIfAbsent(key, () { return (ifAbsentRaw as InterpretedFunction).call(visitor, []) as dynamic; });
      },
      ...
      'forEach': (visitor, target, positional, named, typeArgs) {
        ...
        t.forEach((dynamic p0, dynamic p1) { (actionRaw as InterpretedFunction).call(visitor, [p0, p1]); });
        return null;
      },
      ...
      'map': (visitor, target, positional, named, typeArgs) {
        ...
        return t.map((dynamic p0, dynamic p1) { return (transformRaw as InterpretedFunction).call(visitor, [p0, p1]) as MapEntry<dynamic, dynamic>; });
      },
      'update': (visitor, target, positional, named, typeArgs) {
        ...
        return t.update(key, (dynamic p0) { return (updateRaw as InterpretedFunction).call(visitor, [p0]) as dynamic; }, ifAbsent: ifAbsentRaw == null ? null : () { return (ifAbsentRaw as InterpretedFunction).call(visitor, []) as dynamic; });
      },
      'updateAll': (visitor, target, positional, named, typeArgs) {
        ...
        t.updateAll((dynamic p0, dynamic p1) { return (updateRaw as InterpretedFunction).call(visitor, [p0, p1]) as dynamic; });
        return null;
      },
      'removeWhere': (visitor, target, positional, named, typeArgs) {
        ...
        t.removeWhere((dynamic p0, dynamic p1) { return (testRaw as InterpretedFunction).call(visitor, [p0, p1]) as bool; });
        return null;
      },
...
BridgedClass _createPathSetBridge() {
  return BridgedClass(
    nativeType: $pkg.PathSet,
    name: 'PathSet',
    constructors: {
      '': (visitor, positional, named) {
        final context = D4.getOptionalNamedArg<$pkg.Context?>(named, 'context');
        return $pkg.PathSet(context: context);
      },
      'of': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'PathSet');
        final other = D4.getRequiredArg<Iterable<String>>(positional, 0, 'other', 'PathSet');
        final context = D4.getOptionalNamedArg<$pkg.Context?>(named, 'context');
        return $pkg.PathSet.of(other, context: context);
      },
    },
    getters: {
      'iterator': (visitor, target) => D4.validateTarget<$pkg.PathSet>(target, 'PathSet').iterator,
      'length': (visitor, target) => D4.validateTarget<$pkg.PathSet>(target, 'PathSet').length,
      'isEmpty': (visitor, target) => D4.validateTarget<$pkg.PathSet>(target, 'PathSet').isEmpty,
      'isNotEmpty': (visitor, target) => D4.validateTarget<$pkg.PathSet>(target, 'PathSet').isNotEmpty,
      'first': (visitor, target) => D4.validateTarget<$pkg.PathSet>(target, 'PathSet').first,
      'last': (visitor, target) => D4.validateTarget<$pkg.PathSet>(target, 'PathSet').last,
      'single': (visitor, target) => D4.validateTarget<$pkg.PathSet>(target, 'PathSet').single,
    },
    methods: {
      'add': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.PathSet>(target, 'PathSet');
      ...
      'removeWhere': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        t.removeWhere((String? p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; });
        return null;
      },
      ...
      'retainWhere': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        t.retainWhere((String? p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; });
        return null;
      },
      ...
      'map': (visitor, target, positional, named, typeArgs) {
        ...
        return t.map((dynamic p0) { return (toElementRaw as InterpretedFunction).call(visitor, [p0]) as dynamic; });
      },
      'where': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        return t.where((dynamic p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; });
      },
      ...
      'expand': (visitor, target, positional, named, typeArgs) {
        ...
        return t.expand((dynamic p0) { return (toElementsRaw as InterpretedFunction).call(visitor, [p0]) as Iterable<dynamic>; });
      },
      'forEach': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.PathSet>(target, 'PathSet');
        D4.requireMinArgs(positional, 1, 'forEach');
        ...
        final actionRaw = positional[0];
        t.forEach((dynamic p0) { (actionRaw as InterpretedFunction).call(visitor, [p0]); });
        return null;
      },
      'reduce': (visitor, target, positional, named, typeArgs) {
        ...
        return t.reduce((dynamic p0, dynamic p1) { return (combineRaw as InterpretedFunction).call(visitor, [p0, p1]) as dynamic; });
      },
      'fold': (visitor, target, positional, named, typeArgs) {
        ...
        return t.fold(initialValue, (dynamic p0, dynamic p1) { return (combineRaw as InterpretedFunction).call(visitor, [p0, p1]) as dynamic; });
      },
      'every': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        return t.every((dynamic p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; });
      },
      'join': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.PathSet>(target, 'PathSet');
      ...
      'any': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        return t.any((dynamic p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; });
      },
      ...
      'takeWhile': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        return t.takeWhile((dynamic p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; });
      },
      ...
      'skipWhile': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        return t.skipWhile((dynamic p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; });
      },
      'firstWhere': (visitor, target, positional, named, typeArgs) {
        ...
        return t.firstWhere((dynamic p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; }, orElse: orElseRaw == null ? null : () { return (orElseRaw as InterpretedFunction).call(visitor, []) as dynamic; });
      },
      'lastWhere': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        final orElseRaw = named['orElse'];
        return t.lastWhere((dynamic p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; }, orElse: orElseRaw == null ? null : () { return (orElseRaw as InterpretedFunction).call(visitor, []) as dynamic; });
      },
      'singleWhere': (visitor, target, positional, named, typeArgs) {
        ...
        final testRaw = positional[0];
        final orElseRaw = named['orElse'];
        return t.singleWhere((dynamic p0) { return (testRaw as InterpretedFunction).call(visitor, [p0]) as bool; }, orElse: orElseRaw == null ? null : () { return (orElseRaw as InterpretedFunction).call(visitor, []) as dynamic; });
      },
...
BridgedClass _createStyleBridge() {
  return BridgedClass(
    nativeType: $pkg.Style,
    name: 'Style',
    constructors: {
    },
    getters: {
      'name': (visitor, target) => D4.validateTarget<$pkg.Style>(target, 'Style').name,
      'context': (visitor, target) => D4.validateTarget<$pkg.Style>(target, 'Style').context,
      'separator': (visitor, target) => D4.validateTarget<$pkg.Style>(target, 'Style').separator,
      'separatorPattern': (visitor, target) => D4.validateTarget<$pkg.Style>(target, 'Style').separatorPattern,
      'needsSeparatorPattern': (visitor, target) => D4.validateTarget<$pkg.Style>(target, 'Style').needsSeparatorPattern,
      'rootPattern': (visitor, target) => D4.validateTarget<$pkg.Style>(target, 'Style').rootPattern,
      'relativeRootPattern': (visitor, target) => D4.validateTarget<$pkg.Style>(target, 'Style').relativeRootPattern,
    },
    methods: {
      'getRoot': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$pkg.Style>(target, 'Style');
    ...
    staticGetters: {
      'posix': (visitor) => $pkg.Style.posix,
      'windows': (visitor) => $pkg.Style.windows,
      'url': (visitor) => $pkg.Style.url,
      'platform': (visitor) => $pkg.Style.platform,
    },
    methodSignatures: {
