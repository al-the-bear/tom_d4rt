...
// Generated: 2026-06-07T15:53:20.754095

// ignore_for_file: avoid_print

//
// Usage:
//   dart run bin/d4rtrun_tester.b.dart <script.dart|.d4rt>  Run a D4rt script file
//   dart run bin/d4rtrun_tester.b.dart "<expression>"      Evaluate an expression
//   dart run bin/d4rtrun_tester.b.dart --eval-file <file>  Evaluate file content with eval()
//   dart run bin/d4rtrun_tester.b.dart --init-eval         Validate bridge registrations
//   dart run bin/d4rtrun_tester.b.dart --test <file>       Test script (structured JSON output)
//   dart run bin/d4rtrun_tester.b.dart --test-eval <init> <expr>  Test eval (structured JSON output)
...
Future<void> main(List<String> args) async {
  if (args.isEmpty) {
    ...
    stderr.writeln('  dart run bin/d4rtrun_tester.b.dart <script.dart|.d4rt>  Run a D4rt script file');
    stderr.writeln('  dart run bin/d4rtrun_tester.b.dart "<expression>"      Evaluate an expression');
    stderr.writeln('  dart run bin/d4rtrun_tester.b.dart --eval-file <file>  Evaluate file content with eval()');
    stderr.writeln('  dart run bin/d4rtrun_tester.b.dart --init-eval         Validate bridge registrations');
    stderr.writeln('  dart run bin/d4rtrun_tester.b.dart --test <file>       Test script (structured JSON output)');
    stderr.writeln('  dart run bin/d4rtrun_tester.b.dart --test-eval <init> <expr>  Test eval (structured JSON)');
    exit(1);
  }
