/// D4rt super-constructor-argument capture emitter (MCI#7 / B2).
///
...
/// One super-constructor formal a B2 capture-factory forwards.
///
...
/// Emits the shared `_readSuperArg<T>` helper every B2 capture-factory calls.
///
...
String generateReadSuperArgHelper() {
  ...
  b.writeln('/// defaults. Generated by the d4rtgen proxy generator (MCI#7 superArgDefaults).');
