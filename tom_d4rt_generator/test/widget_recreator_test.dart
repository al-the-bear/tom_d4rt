...
void main() {
  group('generateWidgetReCreator', () {
    ...
    test(
      'G-RCR-1: DropdownMenuItem matches the hand-written re-creator byte-for-byte. [2026-06-07 00:00] (PASS)',
      () {
...
''';
    ...
    test(
      'G-RCR-2: DropdownMenuEntry casts a required value to a non-null type. [2026-06-07 00:00] (PASS)',
      () {
        final block = generateWidgetReCreator(
          'DropdownMenuEntry',
          dropdownMenuEntry,
    ...
    test(
      'G-RCR-3: ButtonSegment re-creator carries every constructor parameter through. [2026-06-07 00:00] (PASS)',
      () {
        final block = generateWidgetReCreator(
          'ButtonSegment',
          buttonSegment,
    ...
    test(
      'G-RCR-4: custom inner types limit the emitted switch arms. [2026-06-07 00:00] (PASS)',
      () {
        final block = generateWidgetReCreator(
          'ButtonSegment',
          buttonSegment,
    ...
    test(
      'G-RCR-5: bails when the class has more than one type parameter. [2026-06-07 00:00] (PASS)',
      () {
    ...
    test(
      'G-RCR-6: bails when there is no default constructor. [2026-06-07 00:00] (PASS)',
      () {
    ...
    test(
      'G-RCR-7: bails when a constructor parameter has no matching getter. [2026-06-07 00:00] (PASS)',
      () {
    ...
    test(
      'G-RCR-8: bails when a parameter references the type parameter in a non-bare form. [2026-06-07 00:00] (PASS)',
      () {
