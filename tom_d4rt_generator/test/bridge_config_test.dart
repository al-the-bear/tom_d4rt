...
void main() {
  group('ModuleConfig', () {
    group('fromJson', () {
      test(
        'G-CFG-2: Parses basic module config. [2026-02-10 06:37] (PASS)',
        () {
          final json = {
            'name': 'test_module',
          ...
          expect(
            config.outputPath,
            equals('lib/src/bridges/test_bridges.dart'),
          );
        },
      );
      ...
      test('G-CFG-11: Parses excludeClasses. [2026-02-10 06:37] (PASS)', () {
        ...
        expect(
          ...
          equals(['ExcludedClass', 'AnotherExcluded']),
        );
      });
      ...
      test('G-CFG-13: Parses excludeFunctions. [2026-02-10 06:37] (PASS)', () {
        ...
        expect(
          ...
          equals(['helperFunction', 'internalFunc']),
        );
      });
      ...
      test(
        'G-CFG-15: Parses all exclude fields together. [2026-02-10 06:37] (PASS)',
        () {
          final json = {
            'name': 'comprehensive',
      ...
      test(
        'G-CFG-16: Defaults to empty lists when fields not provided. [2026-02-10 06:37] (PASS)',
        () {
          final json = {
            'name': 'minimal',
    ...
    group('toJson', () {
      ...
      test(
        'G-CFG-3: Serializes excludeClasses when non-empty. [2026-02-10 06:37] (PASS)',
        () {
          final config = ModuleConfig(
            name: 'test',
            barrelFiles: ['lib/test.dart'],
      ...
      test(
        'G-CFG-4: Serializes excludeEnums when non-empty. [2026-02-10 06:37] (PASS)',
        () {
          final config = ModuleConfig(
            name: 'test',
            barrelFiles: ['lib/test.dart'],
      ...
      test(
        'G-CFG-5: Serializes excludeFunctions when non-empty. [2026-02-10 06:37] (PASS)',
        () {
          final config = ModuleConfig(
            name: 'test',
            barrelFiles: ['lib/test.dart'],
      ...
      test(
        'G-CFG-6: Serializes excludeVariables when non-empty. [2026-02-10 06:37] (PASS)',
        () {
          final config = ModuleConfig(
            name: 'test',
            barrelFiles: ['lib/test.dart'],
      ...
      test(
        'G-CFG-7: Omits empty lists in serialization. [2026-02-10 06:37] (PASS)',
        () {
          final config = ModuleConfig(
            name: 'minimal',
            barrelFiles: ['lib/minimal.dart'],
      ...
      test(
        'G-CFG-8: Round-trip preserves all fields. [2026-02-10 06:37] (PASS)',
        () {
          ...
          expect(
            restored.excludeSourcePatterns,
            equals(original.excludeSourcePatterns),
          );
      ...
      test(
        'G-CFG-9: ExcludeSourcePatterns serialization and deserialization. [2026-02-10 06:37] (PASS)',
        () {
          final config = ModuleConfig(
          ...
          expect(
            restored.excludeSourcePatterns,
            equals(config.excludeSourcePatterns),
          );
        },
      );
    });
  ...
  group('BridgeConfig', () {
    test(
      'G-CFG-10: Parses config with modules containing exclude fields. [2026-02-10 06:37] (PASS)',
      () {
        final json = {
          'name': 'test_project',
          'modules': [
  ...
  group('BridgeConfig relaxer reduction knobs', () {
    ...
    group('fromJson', () {
      test(
        'G-CFG-17: generateAllRelaxers defaults to true when absent. [2026-06-07 00:00] (PASS)',
        () {
      ...
      test(
        'G-CFG-18: Parses generateAllRelaxers false. [2026-06-07 00:00] (PASS)',
        () {
          final config = BridgeConfig.fromJson(
            baseJson()..['generateAllRelaxers'] = false,
          );
      ...
      test(
        'G-CFG-19: Parses relaxerClasses from bare strings. [2026-06-07 00:00] (PASS)',
        () {
          final config = BridgeConfig.fromJson(
          ...
          expect(
            config.relaxerClasses.map((r) => r.className),
      ...
      test(
        'G-CFG-20: Parses relaxerClasses from maps. [2026-06-07 00:00] (PASS)',
        () {
          final config = BridgeConfig.fromJson(
            baseJson()
              ..['relaxerClasses'] = [
      ...
      test(
        'G-CFG-21: Parses mixed bare-string and map relaxerClasses. [2026-06-07 00:00] (PASS)',
        () {
          final config = BridgeConfig.fromJson(
            baseJson()
              ..['relaxerClasses'] = [
      ...
      test(
        'G-CFG-22: Parses additionalRelaxerTypes. [2026-06-07 00:00] (PASS)',
        () {
          final config = BridgeConfig.fromJson(
            baseJson()
    ...
    group('toJson', () {
      test(
        'G-CFG-23: Omits generateAllRelaxers when true (default). [2026-06-07 00:00] (PASS)',
        () {
          final config = BridgeConfig.fromJson(baseJson());
      ...
      test(
        'G-CFG-24: Serializes generateAllRelaxers when false. [2026-06-07 00:00] (PASS)',
        () {
          final config = BridgeConfig.fromJson(
            baseJson()..['generateAllRelaxers'] = false,
          );
      ...
      test(
        'G-CFG-25: Serializes relaxerClasses as className maps. [2026-06-07 00:00] (PASS)',
        () {
          final config = BridgeConfig.fromJson(
      ...
      test(
        'G-CFG-26: Round-trip preserves reduction knobs. [2026-06-07 00:00] (PASS)',
        () {
          ...
          expect(
            restored.relaxerClasses.map((r) => r.className),
            equals(['AlertDialog', 'SnackBar']),
          );
    ...
    group('copyWith', () {
      test(
        'G-CFG-27: copyWith overrides reduction knobs. [2026-06-07 00:00] (PASS)',
        () {
          final original = BridgeConfig.fromJson(baseJson());

          final updated = original.copyWith(
            generateAllRelaxers: false,
            relaxerClasses: const [
              RelaxerClassConfig(className: 'AlertDialog'),
            ],
          ...
          expect(
            updated.relaxerClasses.single.className,
            equals('AlertDialog'),
          );
      ...
      test(
        'G-CFG-28: copyWith preserves reduction knobs when not overridden. [2026-06-07 00:00] (PASS)',
        () {
          final original = BridgeConfig.fromJson(
            baseJson()
              ..['generateAllRelaxers'] = false
  ...
  group('BridgeConfig.recreatorClasses', () {
    ...
    test(
      'G-CFG-29: recreatorClasses defaults to empty when absent. [2026-06-07 00:00] (PASS)',
      () {
        final config = BridgeConfig.fromJson(baseJson());
    ...
    test(
      'G-CFG-30: Parses recreatorClasses from bare strings with default inner types. [2026-06-07 00:00] (PASS)',
      () {
        final config = BridgeConfig.fromJson(
          baseJson()
            ..['recreatorClasses'] = ['DropdownMenuItem', 'ButtonSegment'],
        );
        expect(
          config.recreatorClasses.map((r) => r.className),
          equals(['DropdownMenuItem', 'ButtonSegment']),
        );
        expect(
          config.recreatorClasses.first.innerTypes,
    ...
    test(
      'G-CFG-31: Parses recreatorClasses from maps with custom inner types. [2026-06-07 00:00] (PASS)',
      () {
        final config = BridgeConfig.fromJson(
          baseJson()
            ..['recreatorClasses'] = [
    ...
    test(
      'G-CFG-32: toJson omits recreatorClasses when empty. [2026-06-07 00:00] (PASS)',
      () {
    ...
    test(
      'G-CFG-33: toJson emits bare className map when inner types are default. [2026-06-07 00:00] (PASS)',
      () {
        final config = BridgeConfig.fromJson(
          baseJson()..['recreatorClasses'] = ['DropdownMenuItem'],
        );
        expect(
          config.toJson()['recreatorClasses'],
          equals([
    ...
    test(
      'G-CFG-34: toJson includes innerTypes only when non-default. [2026-06-07 00:00] (PASS)',
      () {
        final config = BridgeConfig.fromJson(
          baseJson()
            ..['recreatorClasses'] = [
    ...
    test(
      'G-CFG-35: Round-trip preserves recreatorClasses. [2026-06-07 00:00] (PASS)',
      () {
        final original = BridgeConfig.fromJson(
          baseJson()
            ..['recreatorClasses'] = [
        ...
        final restored = BridgeConfig.fromJson(original.toJson());
        expect(
          restored.recreatorClasses.map((r) => r.className),
          equals(['DropdownMenuItem', 'ButtonSegment']),
        );
        expect(
          restored.recreatorClasses[0].innerTypes,
          equals(RecreatorClassConfig.defaultInnerTypes),
        );
        expect(
          restored.recreatorClasses[1].innerTypes,
          equals(['String', 'int']),
        );
      },
    );
    ...
    test(
      'G-CFG-36: copyWith overrides and preserves recreatorClasses. [2026-06-07 00:00] (PASS)',
      () {
        final original = BridgeConfig.fromJson(baseJson());
        final updated = original.copyWith(
          recreatorClasses: const [
            RecreatorClassConfig(className: 'DropdownMenuItem'),
          ],
        );
        expect(
          updated.recreatorClasses.single.className,
          equals('DropdownMenuItem'),
        );

        final renamed = updated.copyWith(name: 'renamed');
        expect(
          renamed.recreatorClasses.single.className,
          equals('DropdownMenuItem'),
        );
      },
    );
