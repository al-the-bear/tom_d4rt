...
void main() {
  ...
  setUpAll(() async {
    ...
    // binary names so it can run in parallel with d4rt_coverage_test.dart
    ...
    // `Process.start(bin/d4)` in the other suite's tests. Same pattern and
    // fix as Cluster K #32 in tom_d4rt_exec.
    tester = D4rtTester(
