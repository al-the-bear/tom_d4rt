...
void main() {
  ...
  setUpAll(() {
    ...
    tempOutputDir = Directory.systemTemp.createTempSync('callback_test_').path;
  });
  ...
  group('Callback Wrapping Generation', () {
    ...
    group('Simple Void Callbacks', () {
      test(
        'G-CB-1a: VoidCallback parameter generates wrapper. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-CB-2a: Void Function() callback correct wrapper. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Callbacks with Parameters', () {
      test(
        'G-CB-9: Void Function(int) generates wrapper with parameter. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-CB-10: Void Function(int, String) generates wrapper with multiple params. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Callbacks with Return Values', () {
      test(
        'G-CB-11: Bool Function(int) generates wrapper with return. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-CB-12: String Function(String) generates wrapper with return. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-CB-13 (B3b): generic method whose callback returns the method '
    ...
    group('Nullable Callbacks', () {
      test(
        'G-CB-1b: Nullable callback generates null check wrapper. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Named Function Parameters', () {
      test(
        'G-CB-2b: Named callback parameter generates wrapper. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Multiple Callbacks', () {
      test(
        'G-CB-3a: Multiple callbacks generates all wrappers. [2026-02-10 06:37] (PASS)',
        () {
    ...
    test(
      'G-CB-3b: Generated code compiles without errors. [2026-02-10 06:37] (PASS)',
      () async {
        // Run dart analyze on the generated code
        // ignore: unused_local_variable
        final _ = await Process.run('dart', [
          'analyze',
          '--fatal-infos',
    ...
    group('Custom Typedef Resolution', () {
      test(
        'G-CB-4: Custom typedef callback is resolved from source file. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-CB-5: Custom typedef with string parameter generates correct wrapper. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'G-CB-6: Typedef with multiple parameters generates correct wrapper. [2026-02-10 06:37] (PASS)',
        () {
          ...
          expect(
            ...
            reason:
                'ItemProcessor wrapper should have int and String parameters',
          );
        },
      );

      test(
        'G-CB-7: Typedef with return value generates correct wrapper. [2026-02-10 06:37] (PASS)',
        () {
  ...
  group('Warnings', () {
    test(
      'G-CB-8: No function type warnings for bridgeable callbacks. [2026-02-10 06:37] (PASS)',
      () async {
        final generator = BridgeGenerator(
          workspacePath: testFixturesDir,
          skipPrivate: true,
        ...
        final unbridgeableWarnings = result.warnings
            ...
            .where(
              (w) => !w.contains('List<') && !w.contains('Map<'),
            ) // List/Map of functions still unbridgeable
            .toList();
