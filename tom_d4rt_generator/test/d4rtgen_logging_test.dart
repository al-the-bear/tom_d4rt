...
void main() {
  group('d4rtgen invocation logging', () {
    test('G-DLOG-01: Source carries no hardcoded developer log path. '
        '[2026-06-28] (PASS)', () {
      ...
      final source = File('lib/src/d4rtgen_logging.dart').readAsStringSync();
      expect(source, isNot(contains('/Users/')));
    });

    test('G-DLOG-02: Logging is disabled (no-op) when the env var is unset. '
        '[2026-06-28] (PASS)', () {
