// REPO-WIDE GUARD (tom_d4rt_generator) — the committed corpus relaxer allowlist still reconciles against the corpus.
//
// Its subject reaches OUTSIDE this package, so it runs only when tom_d4rt_generator's suite
