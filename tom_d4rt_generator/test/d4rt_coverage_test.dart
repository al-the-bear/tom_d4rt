...
void main() {
  ...
  group('dart_overview coverage', () {
    ...
    setUpAll(() async {
      ...
      // Cluster M #34: give this suite its own runner-source and compiled-
      // binary names so it can run in parallel with d4rt_tester_test.dart
      // without ETXTBSY ("Text file busy") on bin/d4. Both suites share the
      // same `example/d4` project, so without distinct names dart's
      // `compile exe -o bin/d4` in one suite's setUpAll races against
      // `Process.start(bin/d4)` in the other suite's tests. Same pattern
      // and fix as Cluster K #32 in tom_d4rt_exec.
      tester = D4rtTester(
        projectPath: projectPath,
        defaultTimeout: const Duration(seconds: 30),
        runnerExecutable: 'd4rtrun_coverage.b',
        compiledBinaryName: 'd4_coverage',
      );
    ...
    group('TOP: Top-Level Exportables', () {
      test(
        'G-COV-42: TOP01: concrete class. [2026-02-10 06:37] (PASS)',
        () async {
      ...
      test(
        'G-COV-51: TOP02: abstract class. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-60: TOP03: sealed class. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-69: TOP05: interface class. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-2: TOP08: simple enum (GEN-044: .values not bridged). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-3: TOP09: enhanced enum fields. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-4: TOP10: enhanced enum methods. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-5: TOP11: enhanced enum implements. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-TOP-12: Enhanced enum with mixin. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-TOP-13: Generic enum N/A Dart limit. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-8: TOP16: named extension (not supported). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-9: TOP17: anonymous extension (not supported). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-10: TOP18: extension type (not supported). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-TOP-19: Typedef function not needed. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-11: TOP20: typedef (type alias, not needed). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-12: TOP21: typedef (generic, not needed). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-13: TOP22: top-level function. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-14: TOP25: top-level variable. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-15: TOP26: top-level const. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-16: TOP27: top-level getter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-17: TOP23: top-level generic function. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-TOP-24: Top-level async function. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-18: TOP29: mixin application (class = with). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
    ...
    group('CLS: Class Members', () {
      test(
        'G-COV-19: CLS01: instance field getter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-20: CLS02: instance field setter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-22: CLS04: private field with public getter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-23: CLS07: static field (mutable). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-24: CLS08: static const field (not in barrel). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-25: CLS09: computed getter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-26: CLS10: explicit setter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-27: CLS11: static method. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-28: CLS14: instance method. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-29: CLS15: abstract method. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-30: CLS16: toString override. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-31: CLS05: nullable instance field. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-32: CLS12: static getter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-33: CLS13: static setter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-34: CLS17: call() method (callable class). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
    ...
    group('CTOR: Constructors', () {
      test(
        'G-COV-35: CTOR01: unnamed constructor. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-36: CTOR02: implicit default constructor (GEN-042). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-37: CTOR03: named constructor. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-38: CTOR04: factory-like constructor (fromMap). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-39: CTOR05: const constructor. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-40: CTOR06: redirecting constructor. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-41: CTOR07: private constructor + factory. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-43: CTOR08: super parameters. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
    ...
    group('PAR: Parameters', () {
      test(
        'G-COV-44: PAR01: required positional. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-45: PAR02: optional positional. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-46: PAR03: named parameters (not in barrel). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-47: PAR04: required named. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-48: PAR05: default values. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-PAR-6: Function-typed parameter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
    ...
    group('GNRC: Generics', () {
      test(
        'G-COV-49: GNRC01: single type parameter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-50: GNRC02: two type parameters. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-52: GNRC04: generic method. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-53: GNRC06: generic collection (Stack/Queue, GEN-042). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-54: GNRC03: upper bound constraint. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-55: GNRC05: generic static factory. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-GNRC-7: F-bounded polymorphism. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
    ...
    group('INH: Inheritance', () {
      test(
        'G-COV-56: INH01: single-level extends. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-57: INH02: multi-level extends. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-58: INH03: implements (interface). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-61: INH05: super constructor call. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-62: INH06: method override. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        ...
        () async {
          ...
          expect(
            ...
            isTrue,
            reason:
                'GEN-045: Expected BLOCKED message due to barrel name collision. '
    ...
    group('OP: Operators', () {
      test(
        'G-COV-63: OP05: operator / (divide). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-64: OP06: operator ~/ (integer divide). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-65: OP07: operator % (modulo). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-66: OP09: comparison operators (compareTo). [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-67: OP12: bitwise operators. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
    ...
    group('ASYNC: Async Features', () {
      test(
        'G-ASYNC-1: Async function Future. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-ASYNC-2: Async* generator Stream. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-ASYNC-3: Sync* generator Iterable. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-ASYNC-4: Callback parameter Function. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-ASYNC-5: Instance async method Future. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-ASYNC-6: Instance sync* method Iterable. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-ASYNC-7: Instance async* method Stream. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-ASYNC-8: Static sync*/async* method. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
    ...
    group('TYPE: Type Features', () {
      ...
      test(
        'G-COV-70: TYPE03: nullable parameter. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-71: TYPE04: nullable return type. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
      ...
      test(
        'G-COV-72: TYPE05: dynamic type. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
    ...
    group('VIS: Visibility', () {
      test(
        'G-COV-73: VIS03: show/hide combinators. [2026-02-10 06:37] (PASS)',
        () async {
          final result = await tester.runScriptOnly(
            config,
