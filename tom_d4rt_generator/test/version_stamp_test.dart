...
//
// `D4rtGenVersionInfo.version` is written by `buildkit :versioner` into
// `lib/src/version.versioner.dart` and printed by `d4rtgen --version`. Nothing ties it to
...
void main() {
  test(
    'G-STAMP-01: the version stamp matches pubspec.yaml [2026-09-11] (PASS)',
    () {
      ...
      expect(
        ...
        declared,
        reason:
            'lib/src/version.versioner.dart says ${D4rtGenVersionInfo.version} but '
