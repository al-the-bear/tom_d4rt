/// Tests for the MCI#8 / B4 generic method/static interceptor re-dispatch
...
/// emitter templates that re-dispatch half; the R5 ancestor-walk fallback stays
/// hand-written (supplied via `fallbackExpr`, retired later by MCI#11).
///
...
/// by hand before MCI#8.
const _radioGroupGolden =
    r'''  // MCI#8 — re-dispatch RadioGroup.maybeOf<T> over the declared
