...
void main() {
  group('BridgeGenerator._getPackageUri', () {
    test('G-PURI-01: Unresolved host paths fall back to POSIX separators. '
        '[2026-06-15] (PASS)', () {
    ...
    test('G-PURI-02: Windows lib paths resolve to package URIs. '
        '[2026-06-15] (PASS)', () {
    ...
    test('G-PURI-03: A relative source path still resolves to a package URI '
    ...
    test('G-PURI-04: Already-resolved URIs are passed through unrooted. '
        '[2026-08-12] (PASS)', () {
