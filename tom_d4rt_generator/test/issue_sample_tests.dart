...
void main() {
  ...
  group('Fixed Issues', () {
    ...
    group('GEN-028: export filtering params passed to generator', () {
      test('G-ISS-9: ExcludeSourcePatterns filters source files correctly. [2026-02-10 06:37] (PASS)', () async {
...
''',
      ...
      test('G-ISS-13: ExcludeClasses filters classes correctly. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-028',
          sourceFiles: {
...
''',
    ...
    group('GEN-029: global export filtering', () {
      test('G-ISS-1: Global functions are generated when exported. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-029',
          sourceFiles: {
...
''',
    ...
    group('GEN-030: multi-barrel registration', () {
      test('G-ISS-2: Generated bridge contains sourceUri for deduplication. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-030',
          sourceFiles: {
...
''',
  ...
  group("Won't Fix Issues", () {
    ...
    group('GEN-001: generic type erasure', () {
      test('G-ISS-3: Generic method type parameter is erased to dynamic. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-001',
          sourceFiles: {
...
''',
    ...
    group('GEN-003: complex default values', () {
      test('G-ISS-4: Non-wrappable defaults use combinatorial dispatch. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-003',
          sourceFiles: {
...
''',
    ...
    group('GEN-004: combinatorial dispatch cap', () {
      test('G-ISS-5: 3 non-wrappable defaults generate combinatorial dispatch. [2026-02-10 06:37] (PASS)',
          () async {
        final result = await runGenerationTest(
          issueId: 'GEN-004',
          sourceFiles: {
...
''',
    ...
    group('GEN-006: syntactic fallback', () {
      test('G-ISS-6: Resolved path produces typed parameters (not dynamic). [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-006',
          sourceFiles: {
...
''',
    ...
    group('GEN-014: this.x parameter types', () {
      test('G-ISS-7: Resolved path correctly types this.x parameters. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-014',
          sourceFiles: {
...
''',
  ...
  group('TODO Issues', () {
    ...
    group('GEN-002: recursive type bound dispatch', () {
      test('G-ISS-8: Dispatches to num, String, DateTime, Duration, BigInt for Comparable<T>. [2026-02-10 06:37] (PASS)', () async {
...
''',
    ...
    group('GEN-005: function types in collections', () {
      test('G-ISS-10: List<Function> parameter triggers UnimplementedError. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-005',
          sourceFiles: {
...
''',
    ...
    group('GEN-011: global counts always 0', () {
      test('G-ISS-11: Global functions are generated despite count being 0. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-011',
          sourceFiles: {
...
''',
    ...
    group('GEN-017: missing barrel export downgrade', () {
      test('G-ISS-12: Type not in barrel may fall back to dynamic. [2026-02-10 06:37] (PASS)', () async {
        final result = await runGenerationTest(
          issueId: 'GEN-017',
          sourceFiles: {
