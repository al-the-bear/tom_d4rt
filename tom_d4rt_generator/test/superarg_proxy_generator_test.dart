/// Tests for the MCI#7 / B2 super-constructor-argument capture emitter
...
/// defaults. Generated by the d4rtgen proxy generator (MCI#7 superArgDefaults).
T? _readSuperArg<T>(
  InterpretedInstance instance,
  String name, [
  InterpreterVisitor? visitor,
...
void main() {
  group('generateSuperArgCaptureFactory (MCI#7)', () {
  ...
  group('generateSuperArgEntry (MCI#7)', () {
  ...
  group('generateReadSuperArgHelper (MCI#7)', () {
  ...
  group('applySuperArgDefaults (MCI#7)', () {
  ...
  group('ProxyClassConfig.superArgDefaults round-trip (MCI#7)', () {
