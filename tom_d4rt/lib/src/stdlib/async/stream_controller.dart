...
class StreamControllerAsync {
  static BridgedClass get definition => BridgedClass(
    ...
    getters: {
      ...
      'isClosed': (visitor, target) => (target as StreamController).isClosed,
      'isPaused': (visitor, target) => (target as StreamController).isPaused,
      'hasListener': (visitor, target) =>
          (target as StreamController).hasListener,
      'onListen': (visitor, target) => (target as StreamController).onListen,
      'onPause': (visitor, target) => (target as StreamController).onPause,
      'onResume': (visitor, target) => (target as StreamController).onResume,
      'onCancel': (visitor, target) => (target as StreamController).onCancel,
    },
    setters: {
