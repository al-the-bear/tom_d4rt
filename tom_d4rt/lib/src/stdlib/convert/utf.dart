  ...
  static BridgedClass get definition => BridgedClass(
    ...
    constructors: {
      '': (visitor, positionalArgs, namedArgs) {
        final allowMalformed = namedArgs['allowMalformed'] as bool? ?? false;
      ...
      'decode': (visitor, target, positionalArgs, namedArgs, _) {
        if (positionalArgs.length != 1 || positionalArgs[0] is! List) {
          throw RuntimeD4rtException(
            'Utf8Codec.decode requires a List argument.',
          );
        }
...
class Utf8EncoderConvert {
  static BridgedClass get definition => BridgedClass(
    ...
    constructors: {
      '': (visitor, positionalArgs, namedArgs) {
        if (positionalArgs.isNotEmpty || namedArgs.isNotEmpty) {
          throw RuntimeD4rtException(
            'Utf8Encoder constructor takes no arguments.',
          );
        }
        return Utf8Encoder();
      },
    ...
    methods: {
      ...
      'startChunkedConversion':
          (visitor, target, positionalArgs, namedArgs, _) {
            ...
            return (target as Utf8Encoder).startChunkedConversion(
    ...
    getters: {
      ...
      'runtimeType': (visitor, target) => (target as Utf8Encoder).runtimeType,
    },
  );
}
...
class Utf8DecoderConvert {
  static BridgedClass get definition => BridgedClass(
    ...
    methods: {
      ...
      'startChunkedConversion':
          (visitor, target, positionalArgs, namedArgs, _) {
            ...
            return (target as Utf8Decoder).startChunkedConversion(
    ...
    getters: {
      ...
      'runtimeType': (visitor, target) => (target as Utf8Decoder).runtimeType,
    },
  );
}
