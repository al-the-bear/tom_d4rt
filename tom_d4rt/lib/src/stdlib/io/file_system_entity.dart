  ...
  static BridgedClass get definition => BridgedClass(
    ...
    staticMethods: {
      ...
      'isDirectorySync': (visitor, positionalArgs, namedArgs, _) {
        ...
        return FileSystemEntity.isDirectorySync(positionalArgs[0] as String);
      },
    ...
    methods: {
      ...
      'deleteSync': (visitor, target, positionalArgs, namedArgs, _) {
        ...
        entity.deleteSync(recursive: namedArgs['recursive'] as bool? ?? false);
        return null;
      },
    ...
    getters: {
      'absolute': (visitor, target) => (target as FileSystemEntity).absolute,
