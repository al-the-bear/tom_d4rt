  ...
  static BridgedClass get definition => BridgedClass(
    ...
    constructors: {
      '': (visitor, positionalArgs, namedArgs) {
        final contents = positionalArgs.isNotEmpty
            ? positionalArgs[0] as Object
            : '';
    ...
    getters: {
      ...
      'isNotEmpty': (visitor, target) => (target as StringBuffer).isNotEmpty,
      'hashCode': (visitor, target) => (target as StringBuffer).hashCode,
      'runtimeType': (visitor, target) => (target as StringBuffer).runtimeType,
    },
  );
}
