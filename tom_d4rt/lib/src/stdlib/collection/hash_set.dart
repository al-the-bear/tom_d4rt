  ...
  static BridgedClass get definition => BridgedClass(
    ...
    methods: {
      ...
      'any': (visitor, target, positionalArgs, namedArgs, _) {
        if (target is HashSet && positionalArgs.length == 1) {
          ...
          throw RuntimeD4rtException(
            "Argument to HashSet.any must be a function.",
          );
        }
      ...
      'map': (visitor, target, positionalArgs, namedArgs, _) {
        if (target is HashSet && positionalArgs.length == 1) {
          ...
          throw RuntimeD4rtException(
            "Argument to HashSet.map must be a function.",
          );
        }
    ...
    getters: {
      'length': (visitor, target) {
        ...
        throw RuntimeD4rtException(
          "Target is not a HashSet for getter 'length'",
        );
      },
      'isEmpty': (visitor, target) {
        if (target is HashSet) return target.isEmpty;
        throw RuntimeD4rtException(
          "Target is not a HashSet for getter 'isEmpty'",
        );
      },
      ...
      'iterator': (visitor, target) {
        ...
        throw RuntimeD4rtException(
          "Target is not a HashSet for getter 'iterator'",
        );
      },
      'hashCode': (visitor, target) {
        if (target is HashSet) return target.hashCode;
        throw RuntimeD4rtException(
          "Target is not a HashSet for getter 'hashCode'",
        );
      },
