...
/// interpreter is constructed and prepared for a run — bridge finalization,
/// warm-parent environment assembly, stdlib registration, module-loader
/// construction, source parsing, and the declaration/registration passes that
/// precede the actual `main()` call. It is **not** a profiler for the
/// interpreter's hot path; instrumentation deliberately stops at the point
/// where script interpretation begins.
///
