...
void main() {
  ...
  Object? run(String body) => d4rt.execute(source: '''
  ...
  group('SC7: DoubleLinkedQueue deque surface', () {
    test('F-SC7-4: add/addFirst/addLast and removeFirst/removeLast [2026-07-27]',
        () {
      final result = run('''
        main() {
          final q = DoubleLinkedQueue();
    ...
    test('F-SC7-5: is Queue and is Iterable, but not is ListQueue [2026-07-27]',
        () {
    ...
    test('F-SC7-9: first/last/single/clear and the empty guards [2026-07-27]',
        () {
      final result = run('''
        main() {
    ...
    test('F-SC7-10: addAll appends and rejects a non-Iterable [2026-07-27]',
        () {
      final result = run('''
        main() {
  ...
  group('SC7: DoubleLinkedQueueEntry cursor', () {
    ...
    test('F-SC7-14: entry.remove() unlinks, and element is settable [2026-07-27]',
        () {
      final result = run('''
        main() {
          final q = DoubleLinkedQueue.from([1, 2, 3]);
    ...
    test('F-SC7-15: forEachEntry, empty-queue null, standalone entry [2026-07-27]',
        () {
  ...
  group('SC7: queue hierarchy realignment', () {
    test('F-SC7-16: ListQueue regains its inherited Iterable surface [2026-07-27]',
        () {
    ...
    test('F-SC7-17: Queue() keeps working and gains the same surface [2026-07-27]',
        () {
