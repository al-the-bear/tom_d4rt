...
void main() {
  group('eval() method', () {
    ...
    group('Basic expressions', () {
      test(
        'I-MISC-4: Should evaluate arithmetic expressions. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'I-MISC-13: Should evaluate boolean expressions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-22: Should evaluate string expressions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-30: Should evaluate null-aware expressions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
      ...
      test(
        'I-MISC-37: Should evaluate conditional expressions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
    ...
    group('Variable access and modification', () {
      test(
        'I-MISC-38: Should access existing variables. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          var counter = 42;
      ...
      test(
        'I-MISC-39: Should modify mutable variables. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          var x = 10;
      ...
      test(
        'I-MISC-1: Should create new variables. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-2: Should handle variable shadowing in new scope. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          var x = 10;
      ...
      test(
        'I-MISC-3: Should handle list variables. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          var numbers = [1, 2, 3];
      ...
      test(
        'I-MISC-5: Should handle map variables. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
    ...
    group('Function calls', () {
      test(
        'I-MISC-6: Should call existing functions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
      ...
      test(
        'I-MISC-7: Should call functions with named arguments. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
      ...
      test(
        'I-MISC-8: Should call chained functions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
        ...
        ''',
          ...
          expect(
            d4rt.eval('addOne(square(double(2)))'),
            equals(17),
          ); // ((2*2)^2)+1
        },
      );
      ...
      test(
        'I-MISC-9: Should define and call new functions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-10: Should call recursive functions defined in eval. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-11: Should call async functions. [2026-02-10 06:37] (PASS)',
        () async {
          d4rt.execute(
            source: '''
    ...
    group('Class interaction', () {
      test(
        'I-MISC-12: Should access existing classes. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          class Point {
      ...
      test(
        'I-MISC-14: Should modify class instance properties. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          class Counter {
      ...
      test(
        'I-MISC-15: Should work with multiple class instances. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          class Account {
      ...
      test(
        'I-MISC-16: Should define new classes through eval. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-17: Should work with class inheritance. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          class Animal {
      ...
      test(
        'I-MISC-18: Should work with static members. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          class MathUtils {
    ...
    group('Complex control flow', () {
      test(
        'I-MISC-19: Should handle if expressions in eval. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          var score = 75;
      ...
      test(
        'I-MISC-20: Should handle loops through function calls. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
      ...
      test(
        'I-MISC-21: Should handle while loops in functions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
    ...
    group('State persistence', () {
      test(
        'I-MISC-23: Should persist state across multiple eval calls. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          var history = <String>[];
      ...
      test(
        'I-MISC-24: Should build complex state over multiple calls. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          class ShoppingCart {
      ...
      test(
        'I-MISC-25: Should maintain function definitions across calls. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
    ...
    group('Error handling', () {
      test(
        'I-MISC-26: Should throw error when called before execute. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'I-MISC-27: Should throw error for undefined variables. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-28: Should throw error for undefined functions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-29: Should throw error for type mismatches. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          int add(int a, int b) => a + b;
      ...
      test(
        'I-MISC-31: Should handle division by zero. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(source: 'void init() {}', name: 'init');
      ...
      test(
        'I-MISC-32: Should throw error for null pointer on non-nullable. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
          String? nullable;
        ...
        ''',
          ...
          expect(() => d4rt.eval('nullable!.length'), throwsA(anything));
        },
      );
    });
    ...
    group('Collection operations', () {
      test(
        'I-MISC-33: Should work with list comprehensions through functions. [2026-02-10 06:37] (PASS)',
        () {
          d4rt.execute(
            source: '''
    ...
    group('Multiple D4rt instances', () {
      test(
        'I-MISC-36: Eval contexts should be independent. [2026-02-10 06:37] (PASS)',
        () {
          final d4rt1 = D4rt();
          final d4rt2 = D4rt();
