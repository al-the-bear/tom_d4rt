...
void main() {
  group('Introspection API - analyze()', () {
    ...
    group('Function Analysis', () {
      test(
        'I-FILE-10: Should detect simple function declarations. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          void doNothing() {}
          int returnFive() => 5;
      ...
      test(
        'I-FILE-18: Should extract function parameters. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-25: Should extract function return types. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          int getInt() => 0;
        ...
        ''',
          ...
          final getString = result.functions.firstWhere(
            (f) => f.name == 'getString',
          );
          expect(getString.returnType, equals('String'));

          final doNothing = result.functions.firstWhere(
            (f) => f.name == 'doNothing',
          );
      ...
      test(
        'I-FILE-39: Should detect async/generator functions. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
        ...
        ''',
          ...
          final asyncFunc = result.functions.firstWhere(
            (f) => f.name == 'asyncFunc',
          );
          expect(asyncFunc.isAsync, isTrue);
          expect(asyncFunc.isGenerator, isFalse);

          final streamFunc = result.functions.firstWhere(
            (f) => f.name == 'streamFunc',
          );
          expect(streamFunc.isAsync, isTrue);
          expect(streamFunc.isGenerator, isTrue);

          final iterableFunc = result.functions.firstWhere(
            (f) => f.name == 'iterableFunc',
          );
      ...
      test(
        'I-FILE-43: Should detect generic functions. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-44: Should detect external functions. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
    ...
    group('Class Analysis', () {
      test(
        'I-FILE-7: Should detect simple class. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          class Person {
      ...
      test(
        'I-FILE-8: Should detect class with all member types. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          class FullClass {
      ...
      test(
        'I-FILE-9: Should detect abstract class. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
        ...
        ''',
          ...
          expect(
            result.classes.first.methods,
            containsAll(['area', 'perimeter']),
          );
        },
      );

      test(
        'I-FILE-11: Should detect class inheritance. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          class Animal {}
      ...
      test(
        'I-FILE-12: Should detect class implementing interfaces. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-13: Should detect class with mixins. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          mixin Swimming {
      ...
      test(
        'I-FILE-14: Should detect generic class. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          class Container<T> {
      ...
      test(
        'I-FILE-15: Should detect sealed/final/base class modifiers. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-16: Should detect complex inheritance hierarchy. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-17: Should detect nested classes. [2026-02-10 06:37] (PASS)',
        () {
    ...
    group('Enum Analysis', () {
      test(
        'I-FILE-19: Should detect simple enum. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-20: Should detect multiple enums. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-21: Should detect enhanced enum with fields and methods. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          enum Planet {
      ...
      test(
        'I-FILE-22: Should detect enum implementing interface. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
        ...
        ''',
          ...
          expect(result.enums.length, equals(1));
          expect(
            result.enums.first.values,
            containsAll(['car', 'bike', 'truck']),
          );
        },
      );
    });
    ...
    group('Variable Analysis', () {
      test(
        'I-FILE-23: Should detect top-level variables. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          var mutableVar = 10;
        ...
        ''',
          ...
          expect(
            result.variables.any((v) => v.name == 'compiletimeConst'),
            isTrue,
          );
      ...
      test(
        'I-FILE-24: Should detect variable types. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          int explicitInt = 42;
        ...
        ''',
          ...
          final intVar = result.variables.firstWhere(
            (v) => v.name == 'explicitInt',
          );
          expect(intVar.declaredType, equals('int'));

          final stringVar = result.variables.firstWhere(
            (v) => v.name == 'explicitString',
          );
      ...
      test(
        'I-FILE-26: Should detect const expressions. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-27: Should detect complex type annotations. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
        ...
        ''',
          ...
          final complexList = result.variables.firstWhere(
            (v) => v.name == 'complexList',
          );
    ...
    group('Extension Analysis', () {
      test(
        'I-FILE-28: Should detect simple extension. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-29: Should detect multiple extensions. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
        ...
        ''',
          ...
          expect(
            result.extensions.any((e) => e.name == 'IntExtension'),
            isTrue,
          );
          expect(
            result.extensions.any((e) => e.name == 'ListExtension'),
            isTrue,
          );
          expect(
            result.extensions.any((e) => e.name == 'DateTimeExtension'),
            isTrue,
          );
        },
      );
      ...
      test(
        'I-FILE-30: Should detect generic extension. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-31: Should detect unnamed extension. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          extension on String {
    ...
    group('AnalysisResult API', () {
      test(
        'I-FILE-32: GetByName should return correct declaration type. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          class MyClass {}
      ...
      test(
        'I-FILE-33: GetByName should return null for non-existent names. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          class Existing {}
      ...
      test(
        'I-FILE-34: Contains should work correctly. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          class ExistingClass {}
      ...
      test(
        'I-FILE-35: All should iterate all types. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          class C {}
      ...
      test(
        'I-FILE-36: Should handle empty source. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'I-FILE-37: Should handle source with only comments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          // This is a comment
      ...
      test(
        'I-FILE-38: Should handle source with imports only. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          import 'dart:core';
    ...
    group('Complex scenarios', () {
      test(
        'I-FILE-40: Should analyze full application structure. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          // Constants
        ...
        ''',
          ...
          // Extensions
          expect(
            result.extensions.any((e) => e.name == 'StringValidation'),
            isTrue,
          );
      ...
      test(
        'I-FILE-41: Should handle code with syntax that might be tricky. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
      ...
      test(
        'I-FILE-42: Should handle mixin declarations. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.analyze(
            source: '''
          mixin Walkable {
        ...
        ''',
          ...
          expect(
            duck.superTypes,
            containsAll(['Walkable', 'Swimmable', 'Flyable']),
          );
        },
      );
    });
