...
void main() {
  group('GlobalGetter Wrapper', () {
    test(
      'I-MISC-46: GlobalGetter can wrap a function. [2026-02-10 06:37] (PASS)',
      () {
        var callCount = 0;
        ...
        expect(
          callCount,
          equals(0),
          reason: 'Function not called until invoked',
        );
    ...
    test(
      'I-MISC-50: GlobalGetter evaluates each time it is called. [2026-02-10 06:37] (PASS)',
      () {
        var counter = 0;
    ...
    test(
      'I-MISC-51: GlobalGetter can return null. [2026-02-10 06:37] (PASS)',
      () {
  ...
  group('Environment GlobalGetter Unwrapping', () {
    ...
    test(
      'I-MISC-52: Environment.get unwraps GlobalGetter automatically. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-MISC-53: Regular values are returned directly without wrapping. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-MISC-54: GlobalGetter reflects changes in underlying value. [2026-02-10 06:37] (PASS)',
      () {
  ...
  group('D4rt registerGlobalGetter', () {
    ...
    test(
      'I-MISC-55: RegisterGlobalGetter makes getter accessible via import. [2026-02-10 06:37] (PASS)',
      () {
        var counter = 0;
        interpreter.registerGlobalGetter('counter', () => ++counter, testLib);

        final result1 = interpreter.execute(
          source:
              '''
        import '$testLib';
        main() {
      ...
      ''',
        ...
        final result2 = interpreter.execute(
          source:
              '''
        import '$testLib';
        main() {
    ...
    test(
      'I-MISC-45: RegisterGlobalGetter evaluates lazily not at registration. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-MISC-47: RegisterGlobalVariable vs registerGlobalGetter difference. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-MISC-48: Getter returning object instance works correctly. [2026-02-10 06:37] (PASS)',
      () {
  ...
  group('D4rt eval with GlobalGetter', () {
    ...
    test(
      'I-MISC-49: Eval can access global getters via import. [2026-02-10 06:37] (PASS)',
      () {
