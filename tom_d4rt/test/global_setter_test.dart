...
void main() {
  group('INTER-002: Top-level setter assignment', () {
    ...
    test(
      'I-COLL-8: Read top-level getter returns native value. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-COLL-9: Assign to top-level setter updates native value. [2026-02-10 06:37] (PASS)',
      () {
        d4rt.execute(
          library: 'package:main/main.dart',
          sources: {
    ...
    test(
      'I-COLL-10: Read after assignment returns new value. [2026-02-10 06:37] (PASS)',
      () {
        final result = d4rt.execute(
          library: 'package:main/main.dart',
          sources: {
    ...
    test(
      'I-COLL-11: Compound assignment works with getter/setter. [2026-02-10 06:37] (PASS)',
      () {
        _counter = 10;
        final result = d4rt.execute(
          library: 'package:main/main.dart',
    ...
    test(
      'I-COLL-12: String setter works correctly. [2026-02-10 06:37] (PASS)',
      () {
        final result = d4rt.execute(
          library: 'package:main/main.dart',
          sources: {
    ...
    test(
      'I-COLL-7: Read-only getter without setter throws on assignment. [2026-02-10 06:37] (PASS)',
      () {
        final d4rtReadOnly = D4rt()..setDebug(false);
        d4rtReadOnly.registerGlobalGetter(
          'readOnly',
          () => 42,
          'package:test_lib/test_lib.dart',
        );
