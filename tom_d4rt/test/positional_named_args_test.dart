...
void main() {
  group('positionalArgs and namedArgs', () {
    ...
    group('Basic positional arguments', () {
      test(
        'I-FUNC-4: Should pass single positional argument. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'I-FUNC-8: Should pass multiple positional arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-14: Should handle positional arguments with different types. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-24: Should handle null in positional arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
    ...
    group('Basic named arguments', () {
      test(
        'I-FUNC-33: Should pass single named argument. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-34: Should pass multiple named arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-35: Should use default values for omitted named arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
            String formatDate({
      ...
      test(
        'I-FUNC-1: Should handle named arguments with complex default values. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
    ...
    group('Mixed positional and named arguments', () {
      test(
        'I-FUNC-2: Should handle positional followed by named arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-3: Should handle multiple positional and multiple named arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
            String buildQuery(
      ...
      test(
        'I-FUNC-5: Should handle complex business logic with mixed args. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
    ...
    group('Complex data types as arguments', () {
      test(
        'I-FUNC-6: Should handle List argument. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-7: Should handle nested List argument. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-9: Should handle Map argument. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-10: Should handle deeply nested Map argument. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-11: Should handle function callback in list (as values). [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
    ...
    group('Optional positional arguments', () {
      ...
      test(
        'I-FUNC-12: Should handle all optional parameters via named args. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-13: Should handle no optional arguments provided. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
    ...
    group('Error handling', () {
      test(
        'I-FUNC-15: Should throw error when required positional argument is missing. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            () => d4rt.execute(
              source: '''
      ...
      test(
        'I-FUNC-16: Should throw error when too many positional arguments provided. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            () => d4rt.execute(
              source: '''
      ...
      test(
        'I-FUNC-17: Should throw error when required named argument is missing. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            () => d4rt.execute(
              source: '''
      ...
      test(
        'I-FUNC-18: Should throw error when unknown named argument is provided. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            () => d4rt.execute(
              source: '''
      ...
      test(
        'I-FUNC-19: Should throw error when function does not exist. [2026-02-10 06:37] (PASS)',
        () {
          expect(
            () => d4rt.execute(
              source: '''
    ...
    group('Special cases', () {
      test(
        'I-FUNC-20: Should handle empty string argument. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-21: Should handle very long string argument. [2026-02-10 06:37] (PASS)',
        () {
      ...
      test(
        'I-FUNC-22: Should handle negative numbers. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-23: Should handle floating point precision. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-25: Should handle unicode strings. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
      ...
      test(
        'I-FUNC-26: Should handle recursive function with arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
            int factorial(int n) {
      ...
      test(
        'I-FUNC-27: Should handle async function with arguments. [2026-02-10 06:37] (PASS)',
        () async {
    ...
    group('Interaction with classes', () {
      test(
        'I-FUNC-28: Should handle class creation and method calls with arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
            class Point {
      ...
      test(
        'I-FUNC-29: Should handle class with named constructor and arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
            class Rectangle {
      ...
      test(
        'I-FUNC-30: Should handle static method call with arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
            class Calculator {
      ...
      test(
        'I-FUNC-31: Should handle class with getters and setters. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
            class Counter {
      ...
      test(
        'I-FUNC-32: Should handle inheritance with arguments. [2026-02-10 06:37] (PASS)',
        () {
          final result = d4rt.execute(
            source: '''
            class Animal {
