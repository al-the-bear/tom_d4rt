...
void main() {
  ...
  group('IMP-OPT-9: warm parent + package pool (analyzer D4rt)', () {
    ...
    test('IMP-OPT-9a: two consecutive executes reuse one warm parent (legacy)',
        () {
    ...
    test(
        'IMP-OPT-9d: legacy instances do NOT share a warm parent across '
        'interpreters', () {
      final first = D4rt();
      final second = D4rt();
