...
void main() {
  group('SCF26: precise nativeNames beats a fuzzy suffix in a nearer frame', () {
    test('F-SCF26-1: the enclosing PRECISE match wins over the nearer FUZZY '
        'one [2026-09-23]', () {
    ...
    test('F-SCF26-2 (control): the hazard is real — the suffix bridge DOES '
    ...
    test('F-SCF26-3 (control): proximity still decides between two equally '
    ...
    test('F-SCF26-4: the MAP shape resolves the same way, and was never '
