...
void main() {
  group('Re-export Deduplication', () {
    ...
    test(
      'I-FILE-3: Registering same function from same source twice is silently skipped. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-FILE-4: Registering different functions with same name throws error. [2026-02-10 06:37] (PASS)',
      () async {
        // Register a function with source URI
        interpreter.registertopLevelFunction(
          'conflictFunc',
    ...
    test(
      'I-FILE-5: Registering same class from same source twice is silently skipped. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-FILE-6: Registering same enum from same source twice is silently skipped. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-FILE-1: Registering same variable from same source twice is silently skipped. [2026-02-10 06:37] (PASS)',
      () {
    ...
    test(
      'I-FILE-2: Registering same getter from same source twice is silently skipped. [2026-02-10 06:37] (PASS)',
      () {
