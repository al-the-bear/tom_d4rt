...
void main() {
  group('INTER-004: Late field setter on bridged instances', () {
    ...
    test(
      'I-LATE-10: Late field setter on bridged instance assigns value. [2026-02-10] (PASS)',
      () {
        d4rt.execute(
    ...
    test(
      'I-LATE-11: Late field getter after setter returns correct value. [2026-02-10] (PASS)',
      () {
    ...
    test(
      'I-LATE-12: Named constructor with late final fields. [2026-02-10] (PASS)',
      () {
        final result = d4rt.execute(
          library: 'package:main/main.dart',
          sources: {
