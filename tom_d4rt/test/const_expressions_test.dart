...
''';
    ...
    test('I-EXPR-31: Const Set literal canonicalizes to one instance (T3). [2026-06-09 00:00] (PASS)', () {
...
''';
    ...
    test('I-EXPR-32: Const Map literal canonicalizes to one instance (T3). [2026-06-09 00:00] (PASS)', () {
      const code = '''
...
''';
    ...
    test('I-EXPR-33: Non-const set literal still allocates fresh instances (T3). [2026-06-09 00:00] (PASS)', () {
...
''';
    ...
    test('I-EXPR-34: Cached const set remains unmodifiable (T3). [2026-06-09 00:00] (PASS)', () {
