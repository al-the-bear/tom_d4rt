...
>>>>>>> Stashed changes
  ...
  static List<BridgedEnumDefinition> bridgedEnums() {
    return [
      BridgedEnumDefinition<$tom_d4rt_dcli_3.SymbolKind>(
        name: 'SymbolKind',
        values: $tom_d4rt_dcli_3.SymbolKind.values,
      ),
      BridgedEnumDefinition<$tom_d4rt_dcli_6.MultilineMode>(
        name: 'MultilineMode',
        values: $tom_d4rt_dcli_6.MultilineMode.values,
      ),
    ];
  }
  ...
  static Map<String, String> enumSourceUris() {
    return {
      'SymbolKind': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_result_types.dart',
      'MultilineMode': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\execution_context.dart',
    };
  }
  ...
  static void registerGlobalVariables(D4rt interpreter, String importPath) {
    ...
    try {
      interpreter.registerGlobalVariable('cliLibrary', cliLibrary, importPath, sourceUri: 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_bridge.dart');
    } catch (e) {
      errors.add('Failed to register variable "cliLibrary": $e');
    }
    try {
      interpreter.registerGlobalVariable('cliGlobalHolder', cliGlobalHolder, importPath, sourceUri: 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_bridge.dart');
    } catch (e) {
      errors.add('Failed to register variable "cliGlobalHolder": $e');
    }
    interpreter.registerGlobalGetter('verificationFailures', () => verificationFailures, importPath, sourceUri: 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart');
  ...
  static Map<String, String> globalFunctionSourceUris() {
    return {
      'registerCliBridge': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_bridge.dart',
      'registerCliShortcuts': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_bridge.dart',
      'clearVerificationFailures': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verify': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verifyEquals': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verifyNotNull': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verifyNull': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verifyContains': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verifyMatches': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verifyNotEmpty': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verifyLength': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'verifyThrows': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'testSummary': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
    };
  }
  ...
  static List<String> sourceLibraries() {
    return [
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_api.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_bridge.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_controller.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_exceptions.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_result_types.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_runtime.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_state.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\cli_test_utils.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_d4rt_dcli\lib\src\api\execution_context.dart',
      'C:\Users\alexi\AppData\Local\Pub\Cache\hosted\pub.dev\tom_d4rt-1.8.11\lib\src\d4rt_base.dart',
    ];
  }
...
<<<<<<< Updated upstream
=======
    isAssignable: (v) => v is $tom_d4rt_dcli_1.D4rtCliController,
>>>>>>> Stashed changes
    constructors: {
      '': (visitor, positional, named) {
        final d4rt = D4.getRequiredNamedArg<$tom_d4rt_4.D4rt>(named, 'd4rt', 'D4rtCliController');
        final state = D4.getRequiredNamedArg<$tom_d4rt_dcli_5.CliState>(named, 'state', 'D4rtCliController');
        final toolName = D4.getRequiredNamedArg<String>(named, 'toolName', 'D4rtCliController');
        final runtime = D4.getOptionalNamedArg<$tom_d4rt_dcli_4.CliRuntime?>(named, 'runtime');
        return $tom_d4rt_dcli_1.D4rtCliController(d4rt: d4rt, state: state, toolName: toolName, runtime: runtime);
      },
    },
    getters: {
      'd4rt': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').d4rt,
      'dataDirectory': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').dataDirectory,
      'toolName': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').toolName,
      'currentSessionId': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').currentSessionId,
      'configuration': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').configuration,
      'runtime': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').runtime,
      'isMultilineMode': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').isMultilineMode,
      'multilineMode': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').multilineMode,
      'multilineBuffer': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController').multilineBuffer,
    },
    methods: {
      'processPrompt': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_d4rt_dcli_1.D4rtCliController>(target, 'D4rtCliController');
        D4.requireMinArgs(positional, 1, 'processPrompt');
        final line = D4.getRequiredArg<String>(positional, 0, 'line', 'processPrompt');
        return t.processPrompt(line);
      },
...
BridgedClass _createCliGlobalHolderBridge() {
  return BridgedClass(
    nativeType: $tom_d4rt_dcli_1.CliGlobalHolder,
...
<<<<<<< Updated upstream
=======
    isAssignable: (v) => v is $tom_d4rt_dcli_2.CliException,
>>>>>>> Stashed changes
    constructors: {
      '': (visitor, positional, named) {
        ...
        return $tom_d4rt_dcli_2.CliException(message, command: command, stackTrace: stackTrace);
      },
    },
    getters: {
      'command': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_2.CliException>(target, 'CliException').command,
      'stackTrace': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_2.CliException>(target, 'CliException').stackTrace,
      'message': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_2.CliException>(target, 'CliException').message,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_d4rt_dcli_2.CliException>(target, 'CliException');
        return t.toString();
      },
...
>>>>>>> Stashed changes
    constructors: {
      '': (visitor, positional, named) {
        ...
        final cause = D4.getRequiredArg<$tom_d4rt_dcli_2.CliException>(positional, 2, 'cause', 'ReplayException');
...
<<<<<<< Updated upstream
=======
    isAssignable: (v) => v is $tom_d4rt_dcli_3.ImportInfo,
>>>>>>> Stashed changes
    constructors: {
      '': (visitor, positional, named) {
        ...
        final variables = named.containsKey('variables') && named['variables'] != null
            ...
            : const <String>[];
        return $tom_d4rt_dcli_3.ImportInfo(path: path, classes: classes, enums: enums, functions: functions, variables: variables);
      },
    },
    getters: {
      'path': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_3.ImportInfo>(target, 'ImportInfo').path,
      'classes': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_3.ImportInfo>(target, 'ImportInfo').classes,
      'enums': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_3.ImportInfo>(target, 'ImportInfo').enums,
      'functions': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_3.ImportInfo>(target, 'ImportInfo').functions,
      'variables': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_3.ImportInfo>(target, 'ImportInfo').variables,
    },
    methods: {
      'toString': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_d4rt_dcli_3.ImportInfo>(target, 'ImportInfo');
        return t.toString();
      },
    },
    constructorSignatures: {
...
BridgedClass _createSymbolInfoBridge() {
  return BridgedClass(
    nativeType: $tom_d4rt_dcli_3.SymbolInfo,
    name: 'SymbolInfo',
<<<<<<< Updated upstream
=======
...
<<<<<<< Updated upstream
=======
    isAssignable: (v) => v is $tom_d4rt_dcli_4.CliRuntime,
>>>>>>> Stashed changes
    constructors: {
    },
    getters: {
      'processDirectory': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').processDirectory,
      'processDirectoryObject': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').processDirectoryObject,
      'pid': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').pid,
      'executable': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').executable,
      'resolvedExecutable': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').resolvedExecutable,
      'executableArguments': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').executableArguments,
      'script': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').script,
      'version': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').version,
      'environment': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').environment,
      'operatingSystem': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').operatingSystem,
      'operatingSystemVersion': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').operatingSystemVersion,
      'numberOfProcessors': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').numberOfProcessors,
      'localHostname': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').localHostname,
      'pathSeparator': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').pathSeparator,
      'isLinux': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').isLinux,
      'isMacOS': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').isMacOS,
      'isWindows': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').isWindows,
      'isAndroid': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').isAndroid,
      'isIOS': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_4.CliRuntime>(target, 'CliRuntime').isIOS,
    },
    setters: {
...
<<<<<<< Updated upstream
=======
    isAssignable: (v) => v is $tom_d4rt_dcli_5.CliState,
>>>>>>> Stashed changes
    constructors: {
      '': (visitor, positional, named) {
        ...
        return $tom_d4rt_dcli_5.CliState(dataDirectory: dataDirectory, initialDirectory: initialDirectory);
      },
    },
    getters: {
      'dataDirectory': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').dataDirectory,
      'contextStack': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').contextStack,
      'sessionFile': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').sessionFile,
      'currentSessionId': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').currentSessionId,
      'cwd': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').cwd,
      'defines': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').defines,
      'hasActiveSession': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').hasActiveSession,
      'multilineMode': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').multilineMode,
      'isMultilineMode': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').isMultilineMode,
      'multilineBuffer': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_5.CliState>(target, 'CliState').multilineBuffer,
    },
    setters: {
...
BridgedClass _createExecutionContextBridge() {
  return BridgedClass(
    nativeType: $tom_d4rt_dcli_6.ExecutionContext,
...
<<<<<<< Updated upstream
=======
    isAssignable: (v) => v is $tom_d4rt_dcli_6.ContextStack,
>>>>>>> Stashed changes
    constructors: {
      '': (visitor, positional, named) {
        ...
        return $tom_d4rt_dcli_6.ContextStack(initialWorkingDirectory);
      },
    },
    getters: {
      'current': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').current,
      'root': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').root,
      'cwd': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').cwd,
      'silent': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').silent,
      'recordToSession': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').recordToSession,
      'multilineMode': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').multilineMode,
      'isMultilineMode': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').isMultilineMode,
      'multilineBuffer': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').multilineBuffer,
      'depth': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').depth,
      'isRoot': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').isRoot,
      'length': (visitor, target) => D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack').length,
    },
    methods: {
      'push': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<$tom_d4rt_dcli_6.ContextStack>(target, 'ContextStack');
        D4.requireMinArgs(positional, 1, 'push');
        final context = D4.getRequiredArg<$tom_d4rt_dcli_6.ExecutionContext>(positional, 0, 'context', 'push');
        t.push(context);
        return null;
      },
    ...
    staticGetters: {
      'maxDepth': (visitor) => $tom_d4rt_dcli_6.ContextStack.maxDepth,
    },
    constructorSignatures: {
