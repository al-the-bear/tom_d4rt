...
// `lib/src/version.versioner.dart` and printed by the `dcli` REPL banner. Nothing ties it to
...
void main() {
  test(
    'DCLI-STAMP-01: the version stamp matches pubspec.yaml [2026-09-11] (PASS)',
    () {
