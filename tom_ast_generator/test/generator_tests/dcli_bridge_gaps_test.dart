...
void main() {
  ...
  group('DCli Bridge Gaps', () {
    ...
    group('Extension Callback Wrapping', () {
      ...
      test('DCL-EXT-003: Extension method callback should wrap InterpretedFunction [2026-02-11] (PASS)',
          () {
      ...
      test('DCL-EXT-004: Extension callback should use InterpretedFunction wrapper [2026-02-11] (PASS)',
          () {
        final section = _extractSection(generatedCode, 'bridgedExtensions');
        expect(section, isNotNull);
