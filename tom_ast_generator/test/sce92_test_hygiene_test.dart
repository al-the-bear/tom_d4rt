...
// the todo did not mention. 38 of those were here. 77% of the rot was in the
...
//
// THE CORPUS IS CLEAN TODAY — SCD53 removed all 38 — so both rules are
// RATCHETS, which is the right shape for them: they stop the pattern
// reappearing rather than cleaning anything up, and the 38 are the evidence
...
/// at 62 files and about 730 names; the floors sit far below, so adding or
...
void main() {
  ...
  group('SCE92: this package keeps its own test hygiene', () {
    test('F-SCE92-1: no test is declared to fail [2026-09-21] (PASS)', () {
      // The rule SCD50 wrote for `tom_d4rt`, and the one this package had 38
    ...
    test('F-SCE92-3 (control): the scan read a real corpus [2026-09-21] '
      ...
      // That is not hypothetical here — the reason this package went 38
