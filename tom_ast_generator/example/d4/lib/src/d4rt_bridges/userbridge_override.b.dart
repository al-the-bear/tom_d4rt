...
// Sources: 2 files
<<<<<<< Updated upstream
// Generated: 2026-02-21T15:07:43.937586
=======
// Generated: 2026-03-12T17:02:34.428173
>>>>>>> Stashed changes
...
class UserbridgeOverrideBridge {
  ...
  static Map<String, String> classSourceUris() {
    return {
      'MyList': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\my_list.dart',
    };
  }
...
>>>>>>> Stashed changes
  ...
  static void registerGlobalVariables(D4rt interpreter, String importPath) {
    ...
    try {
      interpreter.registerGlobalVariable('appName', appName, importPath, sourceUri: 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\globals.dart');
    } catch (e) {
      errors.add('Failed to register variable "appName": $e');
    }
    try {
      interpreter.registerGlobalVariable('maxRetries', maxRetries, importPath, sourceUri: 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\globals.dart');
    } catch (e) {
      errors.add('Failed to register variable "maxRetries": $e');
    }
    try {
      interpreter.registerGlobalVariable('version', version, importPath, sourceUri: 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\globals.dart');
    } catch (e) {
      errors.add('Failed to register variable "version": $e');
    }
    interpreter.registerGlobalGetter('currentTime', () => currentTime, importPath, sourceUri: 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\globals.dart');
  ...
  static Map<String, String> globalFunctionSourceUris() {
    return {
      'greet': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\globals.dart',
      'calculate': 'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\globals.dart',
    };
  }
  ...
  static List<String> sourceLibraries() {
    return [
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\globals.dart',
      'C:\Code\al_the_bear\inhouse\second_wind\enterprise_flutter\tom_agent_container\tom_ai\d4rt\tom_ast_generator\example\d4\lib\src\userbridge_override\my_list.dart',
    ];
  }
