...
//
// Draws (in order) a background panel, the attractor as a small
// cross, then every particle as a filled circle. The painter
// receives world-space coordinates and scales them into its canvas
// so the model stays decoupled from the on-screen size.
//
// NOTE: copied verbatim from the `particle_field` sample so this
// profiling harness stays self-contained.
