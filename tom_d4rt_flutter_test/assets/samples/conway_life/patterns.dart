...
//
// Each pattern is expressed as a list of `(dx, dy)` offsets relative
// to an anchor cell. `stampAt(anchorX, anchorY)` returns the set of
// live cells the pattern would occupy if dropped at that anchor.
//
// Offsets are deliberately written in "human" coordinates with the
// anchor at the visual centre of the pattern — that way callers can
// just say "drop blinker at (30, 20)" and the pattern lands centred
// on the board.
import 'board.dart';
...
class LifePattern {
  ...
  /// Default anchor is the centre cell of the board.
  Set<Cell> stampAt([int? anchorX, int? anchorY]) {
