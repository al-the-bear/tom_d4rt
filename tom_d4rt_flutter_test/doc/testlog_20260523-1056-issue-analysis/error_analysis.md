...
| # | script | suites |
|---|---|---|
| S1 | `rendering/render_custom_paint_test.dart` | secondary, timeout |
| S2 | `dart_ui/opacity_engine_layer_test.dart` | hardly_1 |
| S3 | `rendering/render_app_kit_view_test.dart` | hardly_3 |
| S4 | `widgets/tree_sliver_state_mixin_test.dart` | hardly_5 |
| S5 | `retest/widgets/app_kit_view_test.dart` | timeout (+ retest as F5) |
| S6 | `retest/rendering/render_animated_size_state_test.dart` | retest |
